...
let procJsx = fs.readFileSync(path.join(__dirname, 'src', 'pages', 'HrmsDetailed.jsx'), 'utf8');
...
if (!procJsx.includes('isClickable')) {
    ...
    fs.writeFileSync(path.join(__dirname, 'src', 'pages', 'HrmsDetailed.jsx'), procJsx, 'utf8');
    console.log('HrmsDetailed.jsx updated.');
}
