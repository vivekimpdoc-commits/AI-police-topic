...
// Update PoliceKnowledge92Detailed.jsx
let procJsx = fs.readFileSync(path.join(__dirname, 'src', 'pages', 'PoliceKnowledge92Detailed.jsx'), 'utf8');
...
fs.writeFileSync(path.join(__dirname, 'src', 'pages', 'PoliceKnowledge92Detailed.jsx'), procJsx, 'utf8');
console.log('PoliceKnowledge92Detailed.jsx updated.');
