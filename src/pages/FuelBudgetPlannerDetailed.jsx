...
const aiExperts = [
  "GPS/Telematics Mileage Tracker AI",
  "Dynamic Fuel Allotment Optimizer",
  "Pilferage/Siphoning Detection Bot",
  "Authorized Fuel Pump/Card Integrator",
  "Vehicle-wise Efficiency (KMPL) Scorer",
  "VIP/Emergency Duty Fuel Apportionment",
  "Geo-Spatial Patrol Route/Fuel Usage Mapper",
  "Idle Time/AC Usage Fuel Drain Analyzer",
  "Fuel Budget Dashboard",
  "Voice-Command Fleet Fuel Query Bot",
  "Automated Monthly Consumption Report",
  "Motor Transport (MT) Section Sync",
  "Sudden Mileage Drop Anomaly Detector",
  "Private Usage/Off-Route Alert AI",
  "Fake Fuel Bill/Receipt Identifier",
  "Old/Guzzler Vehicle Condemnation Suggester",
  "AI Evaluator for Fleet Fuel Efficiency",
  "Audit/Refueling Log Generator",
  "Data Privacy/Patrol Route Scrubber",
  "Finance/Accounts Sync",
  "Driver Refueling/Log Mobile App",
  "Historical Fuel Price/Hike Correlator",
  "SP (Motor Transport) Briefing AI",
  "Pump Vendor Allocation/Payment Engine",
  "Blockchain Immutable Refuel Hash",
  "Anti-Tamper Telematics Shield",
  "Mobile App for Fleet Managers",
  "Station-wise Fuel Efficiency Benchmarker",
  "Automated Alert for Budget Exhaustion",
  "Historical Fuel Expenditure Trend Analyzer",
  "Fleet Management/Fuel SOP Trainer",
  "Telematics Gateway Health Monitor",
  "Imminent Fuel Dry-Out (During Riot) Alert",
  "Habitual Fuel Thief/Driver Profiler",
  "High-Priority (Escort/QRT) Vehicle Classifier",
  "AI Assisted Condemnation Proposal Drafter",
  "Telematics Data Storage Forecaster",
  "Secure VIP Escort Route Protector",
  "Integration with State Petroleum Dealers",
  "Carbon Footprint/Green Portal Sync",
  "Election Intensive Patrolling Fuel Modeler",
  "Disaster Rescue Operations Fuel Coordinator",
  "Fuel/Petroleum Budget Tracker",
  "Custom Workflow for Emergency Cash Refuel",
  "AI Driven Monthly Fuel Predictor",
  "Predictive Need for EV/Hybrid Transition",
  "Custom Alert Trigger for IG Provisioning",
  "Vehicle Fuel/Efficiency Lifecycle Tracker"
];
...
const FuelBudgetPlannerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI FUEL BUDGET PLANNER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI FUEL BUDGET <span>PLANNER</span></h1>
...
export default FuelBudgetPlannerDetailed;
