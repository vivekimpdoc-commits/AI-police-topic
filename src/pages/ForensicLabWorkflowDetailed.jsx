...
const aiExperts = [
  "Lab Case Registration/Intake Manager AI",
  "Sample Processing Queue Optimizer Bot",
  "Analyst/Expert Case Assignment Engine AI",
  "Lab Instrument Scheduling/Booking Sync",
  "Quality Control (QC) Checkpoint Tracker",
  "Report Drafting/Template Auto-Filler AI",
  "Lab Director Review Workflow Approval Bot",
  "Sample Backlog Prioritization Algorithm",
  "Forensic Lab Workflow Command Dashboard",
  "Voice-Command Lab Status Query Bot",
  "Automated Lab Performance KPI Generator",
  "Cross-Lab (CFSL/SFSL) Workflow Sync Engine",
  "NABL Accreditation Compliance Checker AI",
  "Lab Equipment Calibration Scheduler Bot",
  "Chemical Reagent Expiry/Inventory Tracker",
  "Lab Safety/MSDS Protocol Enforcer AI",
  "AI Evaluator for Lab Turnaround Time",
  "Audit/Sample Movement Chain-of-Custody Log",
  "Data Privacy/Case Sensitive Data Masker",
  "Police-FSL Joint Case Priority Sync Bot",
  "IO Case Tracking via Lab Portal App",
  "Cold Case Evidence Re-Examination Queue",
  "Senior Officer (Lab Director) Briefing Bot",
  "Public Case Status Transparency Portal",
  "Blockchain Immutable Lab Result Record",
  "Anti-Contamination Protocol Enforcer AI",
  "Mobile App for IO Sample Submission Sync",
  "Lab Waste Disposal Compliance Tracker",
  "Multi-Lingual Lab Report Translator Bot",
  "Historical Lab Error Pattern Analyzer",
  "Staff Analyst Competency Tracker AI",
  "Lab IT Infrastructure Health Monitor Bot",
  "Urgent/Priority Sample Fast-Track Workflow",
  "Traffic Accident Blood Sample Queue AI",
  "Cyber Crime Digital Device Queue Manager",
  "VIP Case Priority Lab Lane Manager AI",
  "AI Assisted Post-Report Quality Audit Gen",
  "Lab Consumable Procurement Planner AI",
  "Inter-Disciplinary Case Routing Engine",
  "Integration with NFSU/University Labs",
  "Citizen Case Lab Status Query Portal",
  "Extreme Sample Volume Surge Modeler AI",
  "Disaster Mass-Casualty Sample Processor",
  "Lab Budget/Expense Tracker AI",
  "Custom Workflow/Approval for Re-Examination",
  "AI Driven Lab Bottleneck Predictor",
  "Predictive Need for Staff Recruitment",
  "Custom Alert Trigger for Lab Supervisor"
];
...
const ForensicLabWorkflowDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI FORENSIC LABORATORY WORKFLOW
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI FORENSIC LABORATORY WORKFLOW</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in lab case assignment, sample processing queue & report generation automation.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI FORENSIC LABORATORY <span>WORKFLOW</span></h1>
            <p className="cyber-subtitle">Lab Case Assignment, Sample Processing Queue & Report Generation Automation</p>
          </div>
        </div>
      </header>
...
export default ForensicLabWorkflowDetailed;
