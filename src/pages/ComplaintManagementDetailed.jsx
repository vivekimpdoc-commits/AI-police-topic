...
const aiExperts = [
"Omni-Channel (Web/App/SMS) Intake Router",
  "Voice-to-Text Complaint Transcriber AI",
  "Multi-Lingual Complaint Translator Bot",
  "Complaint Deduplication & Merger AI",
  "Fact-Checking & Contradiction Flag Bot",
  "Urgency/Severity Scoring Engine AI",
  "Fake/Prank Complaint Detector Bot",
  "Historical Repeat-Complainant Tracker",
  "Anonymous Tip/Whistleblower Vault AI",
  "Sentiment & Panic Emotion Assessor",
  "CCTV/Media Evidence Auto-Linker Bot",
  "Keyword-Based Crime Categorization AI",
  "Jurisdiction/PS Boundary Mapper AI",
  "Automated Acknowledgment & Ref No Gen",
  "Missing Person Complaint Priority Router",
  "Women/Child Abuse Rapid Escalation AI",
  "Cyber Fraud Intake & Bank Nodal Sync",
  "Traffic/Parking Dispute Auto-Resolver",
  "Noise/Nuisance Complaint Batching Bot",
  "Domestic Violence Whisper/Silent Alert AI",
  "Property/Land Dispute Civil vs Criminal Flag",
  "Animal Cruelty/Wildlife Incident Router",
  "RTI/Legal Query Segregation Bot",
  "VIP/High-Profile Name Flagging AI",
  "Communal/Caste Tension Early Warning",
  "Riot/Mob Violence Incident Aggregator",
  "Automated Victim Support/Counseling Link",
  "Officer Misconduct/Bribery Complaint Vault",
  "Hospital/Medico-Legal Intake Sync Bot",
  "Court/Warrant Related Complaint Matcher",
  "Jansunwai (Grievance Portal) API Sync",
  "Social Media Tag/Mention to Complaint AI",
  "Cross-District/Interstate Complaint Router",
  "Complaint Escalation SLA Tracker Bot",
  "Automated Status Update SMS/WhatsApp AI",
  "Voice-Command Complaint Search Bot",
  "Complaint to FIR Conversion Predictor",
  "Public Trust & Satisfaction Survey Auto-Gen",
  "Investigating Officer (IO) Workload Balancer",
  "Cyber-Bullying/Harassment Evidence Scraper",
  "Financial Fraud/Scam Loss Estimator AI",
  "Lost & Found Article Matching Engine",
  "Stolen Vehicle Database Cross-Checker",
  "Tenant/Servant Verification Dispute Router",
  "Automated PDF/Printable Summary Gen",
  "Handwritten Complaint OCR & Digitization",
  "Digital Signature/Aadhar Authentication AI",
  "Complaint Modification/Tamper Alert Bot",
  "Senior Officer (SP/SSP) Escalation Dashboard",
  "Blockchain Immutable Log of Complaints",
  "Inter-Agency (Civic/Health) Complaint Sync",
  "Predictive Crime Hotspot Mapper from Intake",
  "NGO/Civil Society Actionable Intel Sync",
  "AI Generated Response Draft for IO",
  "Automated Call-Back/Verification Scheduler",
  "Language/Dialect Slang Decoder AI",
  "Threat/Extortion Call Audio Analyzer Bot",
  "Mass-Casualty/Disaster Incident Triage AI",
  "Undercover/Confidential Informant Sync",
  "Election Code Violation Complaint Router"
];
...
const ComplaintManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI COMPLAINT MANAGEMENT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI COMPLAINT MANAGEMENT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in omni-channel intake, automated deduplication & initial fact-checking.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI COMPLAINT <span>MANAGEMENT</span></h1>
            <p className="cyber-subtitle">Omni-Channel Intake, Automated Deduplication & Initial Fact-Checking</p>
          </div>
        </div>
      </header>
...
export default ComplaintManagementDetailed;
