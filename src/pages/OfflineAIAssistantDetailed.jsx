...
const aiExperts = [
  "Offline FIR/GD Drafting Assistant AI",
  "Offline Suspect Photo Matcher (Face AI)",
  "Offline BNS/BNSS Section Lookup Engine",
  "Offline Translator (Hindi/Local Language) Bot",
  "Offline Voice-to-Text Field Notes AI",
  "Offline Warrant/Summons Template Filler",
  "Offline Crime Scene Photo Tagger Bot",
  "Offline First-Aid/Emergency Protocol Guide",
  "Offline AI Assistant Command Dashboard",
  "Voice-Command Offline Query Assistant",
  "Automated Data Sync on Reconnection AI",
  "Cross-Device Offline Data Merge Engine",
  "Lightweight ML Model Compression (TinyML)",
  "Offline Maps/GPS Navigation for Patrols",
  "Encrypted Offline Data Storage Vault AI",
  "Offline Forensic Evidence Cataloger",
  "AI Evaluator for Offline Model Accuracy",
  "Audit/Sync Conflict Resolution Logger",
  "Data Privacy/Offline Data Auto-Expiry AI",
  "Police-HQ Offline Queue Upload Sync",
  "Offline Cyber Crime Evidence Collector",
  "Offline Financial Crime Calculator Bot",
  "Senior Officer (Remote Station) Briefing",
  "Public Complaint Offline Kiosk Bot",
  "Offline Blockchain Hash Generator (Lite)",
  "Offline Device Anti-Theft/Wipe AI",
  "Mobile App Offline Mode Manager",
  "Satellite Phone Integration for Alerts",
  "Multi-Lingual Offline Dictionary/Glossary",
  "Historical Case Offline Reference Library",
  "Staff Offline AI Training Simulator",
  "Device Storage Optimization AI",
  "Temporary Naka Offline Reporting Kit",
  "Traffic Challan Offline Generator Bot",
  "Accident Report Offline Template Filler",
  "Biometric Offline Verification Bot",
  "AI Assisted Post-Reconnect Data Audit",
  "Battery Saver Mode for Extended Ops",
  "VIP Security Offline Protocol Guide AI",
  "Integration with State Offline Data Hub",
  "Citizen Complaint Offline Form Generator",
  "Extreme Weather Offline Resilience AI",
  "Disaster Response Offline Toolkit Bot",
  "Offline Kit Cost/Budget Tracker AI",
  "Custom Workflow/Approval for Offline Ops",
  "AI Driven Connectivity Predictor",
  "Predictive Need for Satellite Uplink",
  "Custom Alert Trigger for Remote Station SHO"
];
...
const OfflineAIAssistantDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI OFFLINE AI ASSISTANT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI OFFLINE AI ASSISTANT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in lightweight on-device ai for remote areas with no internet connectivity.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI OFFLINE <span>AI ASSISTANT</span></h1>
            <p className="cyber-subtitle">Lightweight On-Device AI for Remote Areas with No Internet Connectivity</p>
          </div>
        </div>
      </header>
...
export default OfflineAIAssistantDetailed;
