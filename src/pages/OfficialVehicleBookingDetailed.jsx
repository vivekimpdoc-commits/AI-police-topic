...
const aiExperts = [
  "Pool Car Dispatch Auto-Allocator Engine",
  "Vehicle Route Optimizer Algorithm Bot",
  "Fuel Consumption Anomaly Detector Engine",
  "Driver Duty Assignment Matcher Bot AI",
  "Vehicle Maintenance Predictive Planner Bot",
  "Driver Fatigue/Safety Monitoring Sensor Sync",
  "Vehicle Booking Priority Allocation Bot",
  "GPS Real-time Vehicle Path Tracker Bot",
  "Vehicle Booking Command Dashboard Portal",
  "Voice-Command Vehicle Availability Query Bot",
  "Automated Daily Booking Run-Sheet Report",
  "Cross-District Fleet Dispatch Sync Engine",
  "Vehicle Speed Limit Geofence Alarm Engine",
  "Suspicious Vehicle Usage Alert Monitor Bot",
  "Driver Logbook Verification OCR Assistant",
  "Vehicle Insurance Expiry Auto-Notifier Bot",
  "AI Evaluator for Fleet Utilization Score %",
  "Audit/Vehicle Booking History Log Creator",
  "Data Privacy/Officer Travel Path Masker AI",
  "Police-Transport Wing Database Sync Engine",
  "Driver Booking Status Notification Mobile App",
  "Cold Case Vehicle Log Discrepancy Linker",
  "Senior Officer (SP Motor Transport) Briefing",
  "Public VIP Convoy Transit Route Alert Portal",
  "Blockchain Immutable Vehicle Log Book Hasher",
  "Anti-Fuel Theft OBD Sensor Shield Security",
  "Mobile App for Quick Booking Request Submitter",
  "Bluetooth Keyless Vehicle Access Authenticator",
  "Multi-Lingual Driver Instruction Translator",
  "Historical Vehicle Demand Seasonality Matcher",
  "Staff Vehicle Handling SOP Compliance Auditor",
  "Fleet Tracking API Server Health Monitor",
  "Urgent Operational Pursuit Vehicle Dispatch AI",
  "Traffic Transit Corridor Route Congestion Monitor",
  "Carbon Emission Level Vehicle Auditor Bot",
  "VIP Route Security Escort Vehicle Planner",
  "AI Assisted Post-Trip Vehicle Performance Draft",
  "Fleet Fuel Purchase/Refill Order Optimizer",
  "Eco-Friendly Route Dispatch Coordinator Bot",
  "Integration with National Vahan Database API",
  "Citizen Emergency Vehicle Dispatch Router Bot",
  "Extreme Weather Vehicle Navigation Safety AI",
  "Disaster Evacuation Vehicle Dispatch Coordinator",
  "Fleet Ops Operations Budget/Cost Tracker AI",
  "Custom Workflow/Approval for Premium Vehicle",
  "AI Driven Emerging Fleet Demand Predictor AI",
  "Predictive Need for Additional Vehicle Purchase",
  "Custom Alert Trigger for Transport Nodal Officer"
];
...
const OfficialVehicleBookingDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI OFFICIAL VEHICLE BOOKING
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI OFFICIAL VEHICLE BOOKING</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in pool car dispatch, route optimizer, fuel consumption logs & driver assignment engine.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI OFFICIAL VEHICLE <span>BOOKING</span></h1>
            <p className="cyber-subtitle">Pool Car Dispatch, Route Optimizer, Fuel Consumption Logs & Driver Assignment Engine</p>
          </div>
        </div>
      </header>
...
export default OfficialVehicleBookingDetailed;
