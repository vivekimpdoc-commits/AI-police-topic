...
const aiExperts = [
"Strong Room 3-Tier Security Allocator",
  "24/7 CCTV Motion Detection Analytics AI",
  "Unauthorized Entry/Face Matcher Bot",
  "Fire/Smoke/Temperature Alert Engine",
  "CAPF/Armed Police Guard Roster Sync",
  "Double-Lock/Seal Integrity Verification AI",
  "Power Failure/CCTV Blackout Alert Bot",
  "Political Agent Tent/Camp Monitor AI",
  "Command Center Strong Room Dashboard",
  "Voice-Command Room Status Query Assistant",
  "Automated Logbook/Entry Register Digitizer",
  "Inter-Agency (Police/CAPF) Guard Sync",
  "Biometric/Iris Scan Access Control AI",
  "Weapon/Contraband Scanner at Perimeter",
  "Night-Vision/Thermal Camera Sync Bot",
  "Perimeter Boundary/Wall Breach Alert",
  "AI Evaluator for Strong Room Compliance",
  "Audit/Incident Log Auto-Generator",
  "Data Privacy/Authorized Staff Face Blur",
  "Police-Returning Officer Joint Access Linker",
  "Jammer/Telecom Signal Blockage Monitor",
  "Rodent/Pest Damage Alert Engine",
  "Senior Officer (Observer) Briefing Bot",
  "Public/Agent Transparency Stream Extractor",
  "Blockchain Immutable Log of Room Access",
  "Drone Anti-Aircraft/Restricted Zone AI",
  "Mobile App for Guard Shift Handover Sync",
  "Security Lighting/Floodlight Failure Alert",
  "Multi-Lingual Alert Broadcast Bot",
  "Historical Strong Room Breach Precedent",
  "Counting Day Pre-Opening Security Sync",
  "Guard Sleep/Fatigue Detection via CCTV",
  "Temporary Barricade/Checkpost Locator AI",
  "Traffic/Parking Control near Strong Room",
  "Rain/Water-logging Leakage Alert Bot",
  "Armed Insurgency Attack Predictor",
  "AI Assisted Post-Election Security Audit",
  "Security Eqp (Metal Detector) Health Alert",
  "Media/Press Enclosure Security Modeler",
  "Integration with ECI Webcasting Server",
  "Citizen/Agent Complaint Verification AI",
  "Heatwave/Cooling System Failure Alert",
  "Post-Counting EVM Dispatch Security Sync",
  "Strong Room Logistics Expense Tracker",
  "Custom Workflow/Approval for Room Open",
  "AI Driven Sabotage Sabotage Predictor",
  "Predictive Need for Additional Force",
  "Custom Alert Trigger for Guard Commander"
];
...
const StrongRoomMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI STRONG ROOM MONITORING
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI STRONG ROOM MONITORING</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in 3-tier security, 24/7 cctv analytics, unauthorized entry & fire alerts.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI STRONG ROOM <span>MONITORING</span></h1>
            <p className="cyber-subtitle">3-Tier Security, 24/7 CCTV Analytics, Unauthorized Entry & Fire Alerts</p>
          </div>
        </div>
      </header>
...
export default StrongRoomMonitoringDetailed;
