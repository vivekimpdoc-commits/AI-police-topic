...
const aiExperts = [
"Digital Entry Logging & Time-Stamping AI",
  "Duty Roster Serialization & Assignment Bot",
  "Tamper-Proof Blockchain Record Logger",
  "Automated Shift Handover Order Entry",
  "Officer Leave/Absentee Digital Sync",
  "Weapon/Armoury Issue Log Verifier",
  "Malkhana (Evidence) Key Handover Log",
  "Police Vehicle/Keys Dispatch Order AI",
  "Night Patrol Beat Assignment Digital Log",
  "VIP Escort Duty Order Generator",
  "Automated CCTNS Sync for Order Book",
  "Digital Signature & Biometric Verifier",
  "Order Book Multi-Lingual Translator",
  "Voice-to-Text Order Book Dictation AI",
  "Handwritten General Diary OCR Scanner",
  "Smart Search for Past Order Entries",
  "Pending Investigation Duty Assign AI",
  "Court Summons Delivery Duty Order Bot",
  "Traffic Naka/Checkpost Duty Roster AI",
  "Festival/Event Force Deployment Entry",
  "Riot/Protest Control Duty Order Gen",
  "Daily Briefing Instruction Auto-Logger",
  "Suspension/Disciplinary Duty Alert AI",
  "Officer Fatigue & Over-Duty Predictor",
  "Cross-District Duty Assignment Router",
  "Order Book Alteration/Tamper Alert Bot",
  "Automated PDF Report/Extract Generator",
  "Legal/Court Evidence Admissibility AI",
  "Command Center Real-Time Order Sync",
  "Inspector/SHO Approval Workflow Router",
  "Jansunwai (Grievance) Duty Allocation Log",
  "Social Media Monitoring Duty Roster AI",
  "Cyber Cell Duty & Shift Allocator",
  "Intelligence/Special Branch Duty Logger",
  "Prison/Jail Guard Duty Rotation AI",
  "Hospital Medico-Legal Duty Assign Bot",
  "Interrogation Room Schedule Entry AI",
  "Drone/CCTV Operator Duty Roster Log",
  "Public Alert System Duty Allocation",
  "Media/Press Spokesperson Duty Log",
  "VIP Route Sanitization Duty Order",
  "Election Security Duty Deployment Entry",
  "Disaster Relief Standby Duty Logger",
  "Inter-Agency Co-ordination Duty Order",
  "Daily Order Book Cloud Backup/Sync",
  "Offline Mode Order Book Entry Cacher",
  "Order Book Keyword Cloud & Analytics",
  "Force Optimization & Load Balancer AI",
  "Automated Read-Receipt for Duty Orders",
  "SMS/WhatsApp Duty Order Dispatcher",
  "Officer Mobile App Sync for Duty Orders",
  "Geofence Check-in/Check-out for Duty",
  "Duty Roster Clash/Overlap Detector AI",
  "Female Officer Specific Duty Allocator",
  "Senior Citizen Help Desk Duty Roster",
  "Tourist Police Deployment Order Gen",
  "Historical Duty Pattern Modeler AI",
  "Daily Order Book Audit & QA Scorer",
  "Departmental Promotion/Transfer Log AI",
  "AI Action Plan to Duty Order Converter"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DAILY ORDER BOOK
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI DAILY ORDER BOOK</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in digital entry logging, duty roster serialization & tamper-proof blockchain records.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DAILY ORDER <span>BOOK</span></h1>
            <p className="cyber-subtitle">Digital Entry Logging, Duty Roster Serialization & Tamper-Proof Blockchain Records</p>
          </div>
        </div>
      </header>
...
export default DailyOrderBookDetailed;
