...
const aiExperts = [
  ...
  "Superseded/Amended Order Alert Bot",
  "Cross-Reference Linker AI",
  "OCR/Digitization Engine",
  "Topic Clustering/Categorization Bot",
  "Keyword/Clause Extraction AI",
  "Geo-Spatial Applicability Mapper",
  "Compliance/Deadline Tracker",
  "GO Repository Dashboard",
  "Voice-Command Order Query Bot",
  "Automated Monthly Update Report",
  "State Secretariat/MHA Sync",
  "Multi-Lingual Translation (State/English)",
  "Contradiction/Conflict Detector",
  "Fake/Forged Order Identifier",
  "Impact Abstract/Summary Generator",
  "AI Evaluator for Implementation Rate",
  "Audit/Search Log Generator",
  "Data Privacy/Classification Scrubber",
  "Law/Legal Department Sync",
  "Field Officer Mobile Access App",
  "Historical Policy Shift Correlator",
  "DGP/Home Secretary Briefing AI",
  "Branch Task/Compliance Allocator",
  "Blockchain Immutable GO Hash",
  "Anti-Tamper Official Record Shield",
  "Mobile App for Quick Reference",
  "Unit-wise Compliance Benchmarker",
  "Automated Reminder for New Orders",
  "Historical Order Frequency Analyzer",
  "Policy/Legal SOP Trainer",
  "Repository DB Server Health Monitor",
  "Imminent Compliance Deadline Alert",
  "Non-Compliance/Defaulter Profiler",
  "High-Priority/Court Directed GO Classifier",
  "AI Assisted Clarification Drafter",
  "Document Storage/Archive Forecaster",
  "Secure Classified Order Protector",
  "Integration with E-Courts/Tribunals",
  "Public RTI Portal Sync (for unclassified GOs)",
  "Election Code of Conduct Order Modeler",
  "Disaster/Emergency Decree Coordinator",
  "Digitization/Archive Budget Tracker",
  "Custom Workflow for Restricted Orders",
  "AI Driven Policy Impact Predictor",
  "Predictive Need for Standing Order Revision",
  "Custom Alert Trigger for Nodal Officers",
  "Order Lifecycle/Validity Timeline Tracker"
];
...
const GovernmentOrderRepositoryDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI GOVERNMENT ORDER REPOSITORY
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI GOVERNMENT ORDER <span>REPOSITORY</span></h1>
...
export default GovernmentOrderRepositoryDetailed;
