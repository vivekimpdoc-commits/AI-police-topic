...
const aiExperts = [
  "Escort Force Requirement Calculator",
  "Safe Route (Traffic/Threat Aware) Optimizer",
  "Prisoner Escape/Ambush Risk Scorer",
  "Guard Duty Roster & Fatigue Analyzer",
  "Vehicle GPS/Telematics Tracker Bot",
  "Medical Emergency Diversion Planner",
  "CCTNS/Court Production Sync Engine",
  "Multi-Prisoner Pooling/Batching AI",
  "Escort Command Dashboard",
  "Voice-Command Convoy Status Bot",
  "Automated Daily Escort Roster",
  "Inter-District/State Border Sync",
  "Geo-Spatial Threat Hotspot Mapper",
  "CCTV/ANPR Route Surveillance Integrator",
  "Fake Breakdown/Delay Predictor",
  "Weapon/Ammunition Requisition Bot",
  "AI Evaluator for Guard Performance",
  "Audit/Escort Handover Log Gen",
  "Data Privacy/Prisoner Medical Scrubber",
  "State Prisons Department Sync",
  "Field Guard Convoy Mobile App",
  "Historical Escape/Ambush Pattern Matcher",
  "Command Center Briefing AI",
  "Tactical Vehicle (Bulletproof) Allocator",
  "Blockchain Immutable Handover Hash",
  "Anti-Tamper Route Plan Shield",
  "Mobile App for Live GPS Tracking",
  "Jurisdiction Boundary Matcher",
  "Multi-Lingual Emergency Broadcast Translator",
  "Historical Escort Safety Analyzer",
  "Escort Protocol SOP Trainer",
  "Escort DB Server Health Monitor",
  "Imminent Route Deviation/Ambush Alert",
  "Syndicate Rescue Attempt Profiler",
  "High-Risk/Terrorist Escort Classifier",
  "AI Assisted Contingency Route Drafter",
  "Telematics Data Storage Forecaster",
  "Secure Radio Comm Frequency Protector",
  "Integration with Highway Patrol/Toll",
  "Citizen Traffic Advisory Broadcaster",
  "Riot/Protest Route Interception Modeler",
  "Disaster Evacuation Escort Coordinator",
  "Escort Travel/TA Budget Tracker",
  "Custom Workflow for Air/Train Transit",
  "AI Driven Ambush Probability Predictor",
  "Predictive Need for SWAT/QRT Backup",
  "Custom Alert Trigger for Nodal Officers",
  "Escort Lifecycle Timeline Tracker"
];
...
const PrisonerEscortManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI PRISONER ESCORT MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI PRISONER ESCORT <span>MANAGEMENT</span></h1>
...
export default PrisonerEscortManagementDetailed;
