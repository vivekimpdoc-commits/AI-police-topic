...
const aiExperts = [
  "Equipment Lifecycle & Depreciation AI",
  "Obsolescence/End-of-Life Predictor Engine",
  "Next-Gen Tech (Drones/Robotics) Forecaster",
  "Procurement Phasing/Budget Optimizer",
  "Maintenance/AMC Cost Correlator",
  "Vendor Performance & Reliability Scorer",
  "Geo-Spatial Equipment Distribution Mapper",
  "Spare Parts/Consumables Predictor",
  "Equipment Planning Dashboard",
  "Voice-Command Asset Query Bot",
  "Automated 5-Year Modernization Plan",
  "Finance/Procurement Department Sync",
  "Weapons/Ammunition Phase-out Modeler",
  "Vehicle Fleet (EV Transition) Planner",
  "Fake/Substandard Quality Detector AI",
  "Tech Interoperability/Integration Scorer",
  "AI Evaluator for Vendor Bids",
  "Audit/Procurement Log Generator",
  "Data Privacy/Classified Asset Scrubber",
  "State Police Housing & Logistics Sync",
  "Field Quartermaster Needs App",
  "Historical Procurement Delay Correlator",
  "DGP/Logistics IG Briefing Bot",
  "Fund Allocation/Phasing Optimizer",
  "Blockchain Immutable Procurement Hash",
  "Anti-Tamper Equipment Plan Shield",
  "Mobile App for Inventory Scans",
  "National Standard (BIS/BPR&D) Matcher",
  "Multi-Lingual Tender Document Generator",
  "Historical ROI/Lifespan Analyzer",
  "Procurement/Planning SOP Trainer",
  "Planning DB Server Health Monitor",
  "Imminent Asset Obsolescence Alert",
  "Cyber-Warfare Hardware Deficit Profiler",
  "High-Priority/Critical Asset Classifier",
  "AI Assisted Tender/RFP Drafter",
  "Asset Documentation Storage Forecaster",
  "Secure Classified Tech Specs Protector",
  "Integration with GeM (Government e-Marketplace)",
  "Citizen Transparency on Police Spending Sync",
  "Riot/Protest Gear Scalability Modeler",
  "Disaster Resilience Equipment Coordinator",
  "Capital Expenditure/CAPEX Budget Tracker",
  "Custom Workflow for Emergency Purchase",
  "AI Driven Tech Evolution Predictor",
  "Predictive Need for Foreign Procurement",
  "Custom Alert Trigger for Home Secretary",
  "Equipment Lifecycle Timeline Tracker"
];
...
const LongTermEquipmentPlanningDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI LONG-TERM EQUIPMENT PLANNING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI LONG-TERM EQUIPMENT <span>PLANNING</span></h1>
...
export default LongTermEquipmentPlanningDetailed;
