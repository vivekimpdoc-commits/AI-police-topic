...
const aiExperts = [
"NGO Credibility & Background Verifier AI",
  "Joint Rescue Mission (Human Trafficking) Bot",
  "Child Labor/Beggary Rescue Coordinator",
  "Women Shelter/Nari Niketan Sync AI",
  "Relief Material Distribution Optimizer Bot",
  "Disaster Response (NDRF/NGO) Router AI",
  "Animal Cruelty/Wildlife Rescue NGO Link",
  "Drug Rehabilitation/De-addiction Center Sync",
  "NGO Activity & Impact ROI Scorer AI",
  "Mental Health/Suicide Helpline Bridger Bot",
  "Missing Person NGO Network Broadcaster",
  "Public Protest/Activist NGO Tracker AI",
  "Legal Aid/Human Rights NGO Co-ordinator",
  "NGO Fund Misuse/FCRA Violation Alert Bot",
  "Automated NGO NOC & Clearance Generator",
  "NGO Volunteer Mobilization Router AI",
  "Senior Citizen Support NGO Linker Bot",
  "Domestic Violence Counseling NGO Sync",
  "Cyber Crime Victim Support NGO Router",
  "Slum/Street-Dweller Outreach Co-ordinator",
  "Transgender/LGBTQ+ Rights NGO Link AI",
  "Medical/Blood-Bank NGO Emergency Sync",
  "NGO Event/Camp Security Assessor Bot",
  "Food Distribution/Hunger Relief Map AI",
  "NGO Grievance & Feedback Tracker AI",
  "Multi-Lingual NGO Communication Bot",
  "Cross-District NGO Resource Sharer AI",
  "NGO Training & Sensitization Scheduler Bot",
  "Automated Joint Operation Report Gen AI",
  "Historical NGO Partnership Correlator",
  "Police-NGO Trust & Friction Modeler AI",
  "NGO Broadcast/Alert Relay System Bot",
  "Prisoner Reformation/Rehab NGO Link AI",
  "Juvenile Justice Board (JJB) NGO Sync",
  "Prostitution/Red-Light Area Rescue AI",
  "Environmental/Green NGO Activity Tracker",
  "Election Watchdog NGO Coordination Bot",
  "NGO Social Media Campaign Sync AI",
  "Informant Tip-off via NGO Verification Bot",
  "Voice-Command NGO Directory Assistant",
  "Disaster Relief Supply Chain Modeler AI",
  "AI Generated NGO Partnership Strategy",
  "NGO Fake/Shell Company Flag Bot",
  "Community Risk Reduction via NGOs AI",
  "Orphanage/Adoption Fraud Detection Link",
  "Women/Child Helpline (1090/1098) Integrator",
  "NGO Asset/Vehicle Tracking for Rescue AI",
  "Corporate CSR Fund matching with NGOs",
  "Command Center Real-time NGO Dashboard",
  "Blockchain Immutable Log of NGO Joint Ops",
  "NGO Satisfaction/Survey Scorer AI",
  "Inter-Agency (Police/Health/NGO) Sync Bot",
  "NGO Conflict/Rivalry Early Warning AI",
  "Refugee/Migrant Worker Support NGO Link",
  "Public Trust Index Booster via NGO Ops",
  "NGO Legal Dispute / PIL Tracker Bot",
  "Undercover Rescue Ops NGO Sanitizer",
  "AI Protocol for Safe Victim Handoff",
  "NGO Driven Crime Prevention ROI Analyzer",
  "Mega Event (Kumbh/Mela) NGO Allocator AI"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI NGO COORDINATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI NGO COORDINATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in joint rescue missions, relief material distribution & civil society partnerships.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI NGO <span>COORDINATION</span></h1>
            <p className="cyber-subtitle">Joint Rescue Missions, Relief Material Distribution & Civil Society Partnerships</p>
          </div>
        </div>
      </header>
...
export default NGOCoordinationDetailed;
