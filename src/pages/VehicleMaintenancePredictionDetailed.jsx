...
const aiExperts = [
  "OBD-II/CAN Bus Real-time Diagnostic Reader",
  "Engine Oil Life Prediction Algorithm AI",
  "Brake Pad/Disc Wear Estimation Engine",
  "Battery Health & Replacement Predictor",
  "Transmission Fluid Change Scheduler AI",
  "Coolant System Overheating Alert Bot",
  "Air Filter Clogging Prediction Engine",
  "Suspension/Shock Absorber Wear Tracker",
  "Vehicle Maintenance Command Dashboard",
  "Voice-Command Vehicle Health Query Bot",
  "Automated Service Reminder Generator AI",
  "Cross-Fleet Maintenance Comparison Engine",
  "Clutch Plate Wear Prediction (Manual Cars)",
  "AC Compressor Failure Prediction Bot",
  "Power Steering Fluid Level Monitor AI",
  "Wiper/Headlight Replacement Scheduler",
  "AI Evaluator for Maintenance Compliance %",
  "Audit/Maintenance Cost Log Auto-Generator",
  "Data Privacy/Vehicle Usage Data Masker",
  "Police-Authorized Workshop Sync Bot",
  "Patrol Car Breakdown Prevention Planner",
  "Armored Vehicle Heavy-Duty Maintenance AI",
  "Senior Officer (Transport Wing) Briefing",
  "Public Vehicle Requisition Fitness Check",
  "Blockchain Immutable Maintenance Record",
  "Anti-Theft/GPS Tamper Alert Integration",
  "Mobile App for Driver Pre-Trip Inspection",
  "Siren/Light Bar Electrical Check Bot",
  "Multi-Lingual Maintenance Alert Bot",
  "Historical Vehicle Failure Pattern Matcher",
  "Staff Driver Vehicle Condition Feedback",
  "Workshop Vendor SLA/Turnaround Tracker",
  "Temporary Naka Vehicle Health Check Bot",
  "Traffic Patrol Bike Maintenance Scheduler",
  "Accident Recovery Vehicle Fitness Alert",
  "VIP Fleet Priority Servicing Queue AI",
  "AI Assisted Post-Service Quality Audit",
  "Warranty Claim/Coverage Expiry Tracker AI",
  "Eco-Mode/Fuel Efficiency Maintenance Link",
  "Integration with Vahan/RTO Fitness Portal",
  "Citizen Police Vehicle Complaint Router",
  "Extreme Climate Vehicle Impact Modeler",
  "Disaster Vehicle Fleet Readiness Checker",
  "Maintenance Budget/Expense Tracker AI",
  "Custom Workflow/Approval for Major Repair",
  "AI Driven Catastrophic Failure Predictor",
  "Predictive Need for Vehicle Replacement",
  "Custom Alert Trigger for Workshop Incharge"
];
...
const VehicleMaintenancePredictionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI VEHICLE MAINTENANCE PREDICTION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI VEHICLE MAINTENANCE PREDICTION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in predictive servicing, obd-ii diagnostics & breakdown prevention analytics.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI VEHICLE MAINTENANCE <span>PREDICTION</span></h1>
            <p className="cyber-subtitle">Predictive Servicing, OBD-II Diagnostics & Breakdown Prevention Analytics</p>
          </div>
        </div>
      </header>
...
export default VehicleMaintenancePredictionDetailed;
