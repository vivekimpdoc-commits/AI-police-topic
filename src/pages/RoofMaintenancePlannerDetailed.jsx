...
const aiExperts = [
  "Pre-Monsoon Leakage Predictor AI",
  "Drone-assisted Waterproofing Auditor",
  "Debris/Dry Leaf Accumulation Alert Bot",
  "Terrace Security/Unauthorized Access Detector",
  "Thermal Seepage/Dampness Mapper",
  "Solar Panel/Terrace Equipment Interference AI",
  "Geo-Spatial High-Risk Roof Mapper",
  "Gutter/Drain Blockage Predictor",
  "Roof Maintenance Dashboard",
  "Voice-Command Roof Health Bot",
  "Automated Pre-Monsoon Readiness Report",
  "State Meteorology/Weather Sync Bot",
  "Heritage/Tile Roof Specific Assessment",
  "Wind-Damage/Cyclone Vulnerability Scorer",
  "Substandard Tar/Waterproofing Predictor",
  "Rooftop Antenna/Telecom Tower Structural Scorer",
  "AI Evaluator for Repair Urgency",
  "Audit/Maintenance Log Generator",
  "Data Privacy/Security Camera Sync",
  "PWD/Estate Department Sync",
  "Field Worker Maintenance App",
  "Historical Leakage/Damage Correlator",
  "Station House Officer (SHO) Briefing AI",
  "Waterproofing Vendor Task Allocator",
  "Blockchain Immutable Inspection Hash",
  "Anti-Tamper Maintenance Shield",
  "Mobile App for Seepage Reporting",
  "District-wise Roof Health Benchmarker",
  "Automated Reminder for Annual Coating",
  "Historical Repair ROI Analyzer",
  "Roof Maintenance SOP Trainer",
  "IoT Moisture Sensor Server Monitor",
  "Imminent Roof Collapse/Severe Leak Alert",
  "Contractor Warranty/Defect Profiler",
  "High-Priority Server/Armory Roof Classifier",
  "AI Assisted Emergency Tarp Request Drafter",
  "Drone Image/Sensor Data Storage Forecaster",
  "Secure Armory/Data Center Layout Protector",
  "Integration with Fire Safety Department",
  "Record Room Protection Sync",
  "Heavy Rainfall/Cyclone Impact Modeler",
  "Post-Storm Damage Assessment Coordinator",
  "Waterproofing/Repair Budget Tracker",
  "Custom Workflow for Rooftop Helipad Maintenance",
  "AI Driven Waterproofing Lifespan Predictor",
  "Predictive Need for Complete Reroofing",
  "Custom Alert Trigger for Estate Officer",
  "Roof Coating/Repair Timeline Tracker"
];
...
const RoofMaintenancePlannerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ROOF MAINTENANCE PLANNER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ROOF MAINTENANCE <span>PLANNER</span></h1>
...
export default RoofMaintenancePlannerDetailed;
