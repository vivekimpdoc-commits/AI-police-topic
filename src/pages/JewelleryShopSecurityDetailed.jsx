...
const aiExperts = [
  "Shop Vulnerability/Threat Scorer AI",
  "CCTV Coverage/Blindspot Mapper",
  "Panic Button/Alarm Integration Bot",
  "Guard Verification & Arms License Auditor",
  "Locker/Strong-Room Standard Compliance AI",
  "Historical Heist/Robbery Precedent Matcher",
  "Geo-Spatial High-Risk Cluster Mapper",
  "Opening/Closing Time Movement Monitor",
  "Security Audit Command Dashboard",
  "Voice-Command Shop Status Bot",
  ...
  "AI Evaluator for Shop Preparedness",
  "Audit/Inspection Log Generator",
  "Data Privacy/Customer Scrubber",
  "State Private Security Regulation Dept Sync",
  "Field IO Security Checklist App",
  "Cold Case Heist Correlator AI",
  "SHO/Supervisory Officer Briefing",
  "Beat Officer/Patrol Allocator",
  "Blockchain Immutable Audit Hash",
  "Anti-Tamper Security Rating Shield",
  "Mobile App for Shop Owners (Panic/Upload)",
  "Jurisdiction/Market Polygon Matcher",
  "Multi-Lingual Advisory Translator",
  "Historical Robbery Trend Analyzer",
  "Security Audit SOP Trainer",
  "Audit Server Health Monitor",
  "Imminent Threat/Recce Alert Bot",
  "Organized Armed Robbery Syndicate Profiler",
  "High-Inventory Value Target Classifier",
  "AI Assisted Security Advisory Drafter",
  "Audit Image/Video Storage Forecaster",
  "Secure Security Flaw Data Protector",
  "Integration with Jewelers Association",
  "Citizen/Owner Suspicious Person Reporting",
  "Festival Season Heist Modeler",
  "Disaster/Riot Shop Security Coordinator",
  "Audit/Patrol Expense Budget Tracker",
  "Custom Workflow for License Suspension",
  "AI Driven Heist Probability Predictor",
  "Predictive Need for Armed Picket",
...
const JewelleryShopSecurityDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI JEWELLERY SHOP SECURITY AUDIT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI JEWELLERY SHOP SECURITY <span>AUDIT</span></h1>
...
export default JewelleryShopSecurityDetailed;
