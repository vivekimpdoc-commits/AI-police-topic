...
const aiExperts = [
  "Secure API Gateway/Testbed Manager",
  "Synthetic Crime/FIR Data Generator AI",
  "Automated Vulnerability/Penetration Scanner",
  "Third-Party App Isolation/Containerization Bot",
  "Data Leak/Exfiltration Detector (Sandbox out)",
  "Resource/Compute Quota Enforcer AI",
  "Geo-Spatial API Call/Load Mapper",
  "Compliance/Security Policy Auto-Checker",
  "Sandbox Operations Dashboard",
  "Voice-Command Environment Query Bot",
  "Automated Weekly Sandbox Security Report",
  "State Cyber Security/IT Sync",
  "Container Escape/Zero-Day Risk Predictor",
  "Malicious Payload/Injection Alert",
  "API Rate Limit/DDoS Abuse Analyzer",
  "Synthetic Data Bias/Realism Scorer",
  "AI Evaluator for API Security Index",
  "Audit/API Access Log Generator",
  "Data Privacy/PII Masking Engine",
  "CCTNS/Core Database Architecture Sync",
  "Sandbox Admin/Developer Mobile App",
  "Historical Vulnerability Exploit Correlator",
  "Chief Information Security Officer (CISO) Briefing",
  "API Key Revocation/Reset Allocator",
  "Blockchain Immutable API Log Hash",
  "Anti-Tamper Sandbox Config Shield",
  "Mobile App for Quick Dev Approval",
  "Vendor-wise API Integration Speed Benchmarker",
  "Automated Alert for Unauthorized Production Access",
  "Historical Cloud Compute Cost Analyzer",
  "Secure Coding/API Integration SOP Trainer",
  "Cloud/Server Health & Load Monitor",
  "Imminent Production Database Breach Alert",
  "Careless/Insecure Developer Profiler",
  "Classified (Intelligence/Biometric) API Classifier",
  "AI Assisted Vendor Security Warning Drafter",
  "Synthetic Data/Log Storage Forecaster",
  "Secure Production API Key Protector",
  "Integration with National API Exchange (NDEAR)",
  "Digital Forensics/Cyber Cell Sync",
  "Election Data Integration Sandbox Modeler",
  "Disaster Real-time API Load Coordinator",
  "Cloud/Sandbox Infrastructure Budget Tracker",
  "Custom Workflow for Hackathon/External Devs",
  "AI Driven Peak API Load Predictor",
  "Predictive Need for Cloud Auto-Scaling",
  "Custom Alert Trigger for SP Cyber",
  "Dev Onboarding to Production Go-Live Timeline"
];
...
const SandboxEnvironmentManagerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SANDBOX ENVIRONMENT MANAGER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SANDBOX ENVIRONMENT <span>MANAGER</span></h1>
...
export default SandboxEnvironmentManagerDetailed;
