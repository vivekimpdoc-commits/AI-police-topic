...
const aiExperts = [
  "FIR Narrative NLP Extractor",
  "Modus Operandi (MO) Clustering Engine",
  "Evidence Signature Overlap Detector",
  "Weapon/Vehicle Matcher Bot AI",
  "Victimology Pattern Correlator",
  "Temporal/Spatial Crime Series Linker",
  "Suspect Description Aggregator",
  "Stolen Property Trajectory Analyzer",
  "Cross-Case Link Command Dashboard",
  "Voice-Command Link Query Bot",
  "Automated Serial Crime Report Gen",
  "Inter-District Case Coordination Bot",
  "Geospatial Crime Spree Mapper",
  "Financial Fraud MO Matcher AI",
  "Cyber Crime Attack Vector Linker",
  "Cold Case vs Active Case Linker AI",
  "AI Evaluator for Link Probability",
  "Audit/Link Analysis Log Generator",
  "Data Privacy/Victim Info Scrubber",
  "National Crime Database (CCTNS) Sync",
  "Field Officer Linked Case Alert App",
  "Cold Case Breakthrough Analyzer AI",
  "Senior Officer Serial Crime Briefing",
  "Task Force Resource Allocator Bot",
  "Blockchain Immutable Link Hash",
  "Anti-Tamper Evidence Link Shield",
  "Mobile App for Linked Case View",
  "Cell Tower Serial Co-location Matcher",
  "Multi-Lingual FIR Translation Linker",
  "Historical Serial Crime Evolution Analyzer",
  "Serial Investigation SOP Trainer AI",
  "Link Analysis Graph DB Monitor",
  "Imminent Serial Attack Alert Bot",
  "Organized Crime Spree Profiler",
  "VIP Serial Threat Classifier Bot",
  "AI Assisted Task Force Strategy Draft",
  "Link Database Storage Forecaster",
  "Secure Witness Overlap Protector",
  "Integration with Forensic Lab DB",
  "Citizen Multi-Tip Correlation Analyzer",
  "Serial Riot/Arson Pattern Modeler",
  "Disaster Serial Looting Coordinator",
  "Serial Crime Investigation Budget Tracker",
  "Custom Workflow for Case Merging",
  "AI Driven Next Target Predictor",
  "Predictive Need for Special Task Force",
  "Custom Alert Trigger for Nodal Officers",
  "Serial Crime Timeline Tracker AI"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CROSS-CASE LINK ANALYSIS
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CROSS-CASE LINK <span>ANALYSIS</span></h1>
...
export default CrossCaseLinkDetailed;
