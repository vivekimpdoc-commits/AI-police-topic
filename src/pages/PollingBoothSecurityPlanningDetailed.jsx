...
const aiExperts = [
"Booth Capturing/Rigging Threat Predictor",
  "CCTV/Webcasting Real-time Video Analytics",
  "Voter Queue/Crowd Density Modeler AI",
  "Bogus Voting/Face Recognition Flagging Bot",
  "Armed Guard Placement Optimizer at Booths",
  "Shadow Area/Blind-Spot Detection in CCTV",
  "Booth Perimeter/Boundary Breach Alert AI",
  "EVM Vandalism/Smashing Predictive Alert",
  "Command Center Booth Security Dashboard",
  "Voice-Command Booth Status Query Bot",
  "Automated Hourly Voting % Stat Sender",
  "Inter-Booth Communication Sync (VHF/UHF)",
  "Vulnerable Voter Intimidation Alert Engine",
  "Political Party Agent Verification Sync AI",
  "Micro-Observer Incident Report Tagger",
  "Power Failure/Generator Backup Alert Bot",
  "AI Evaluator for Peaceful Polling %",
  "Audit/Incident Log Auto-Generator",
  "Data Privacy/Voter Identity Masker in CCTV",
  "Police-Presiding Officer Sync Bot",
  "Weapon Carrying/Firearm Detection at Booth",
  "Riot/Stampede Predictor near Polling Station",
  "Senior Officer (Sector Magistrate) Briefing",
  "Public Announcement/Loudspeaker Drafter",
  "Blockchain Immutable Log of Polling Events",
  "Drone Aerial Overwatch for Clustered Booths",
  "Mobile App for Sector Officer Route Sync",
  "Disabled/Elderly Voter Priority Access AI",
  "Multi-Lingual Booth Instruction Bot",
  "Historical Booth Violence Precedent Matcher",
  "Medical Emergency First-Aid Sync at Booth",
  "Guard Fatigue/Stress Monitor AI",
  "Temporary Barricade/Zig-Zag Queue Planner",
  "Traffic Parking Management for Voters",
  "Shadow Zone (No Network) Offline Sync Bot",
  "Pink Booth (All-Women) Security Linker",
  "AI Assisted Post-Poll Booth Sealing Audit",
  "Security Eqp (Metal Detector) Health Check",
  "Media/Press Entry Pass Verifier Bot",
  "Integration with ECI Webcasting Portal",
  "Citizen SOS for Polling Violence Router",
  "Heatwave/Tent/Drinking Water Guarding AI",
  "Post-Poll Clash/Victory Rally Security Modeler",
  "Booth Security Logistics Expense Tracker",
  "Custom Workflow/Approval for Re-Polling",
  "AI Driven Threat De-escalation Predictor",
  "Predictive Need for QRT/Striking Force",
  "Custom Alert Trigger for Zonal Officer"
];
...
const PollingBoothSecurityPlanningDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI POLLING BOOTH SECURITY PLANNING
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI POLLING BOOTH SECURITY PLANNING</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in crowd control, preventing booth capturing & cctv/webcasting integration.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI POLLING BOOTH <span>SECURITY PLANNING</span></h1>
            <p className="cyber-subtitle">Crowd Control, Preventing Booth Capturing & CCTV/Webcasting Integration</p>
          </div>
        </div>
      </header>
...
export default PollingBoothSecurityPlanningDetailed;
