...
const aiExperts = [
  ...
  "Law Commission Report Summarizer",
  "Overruled/Upheld Citation Tracker",
  "Statute/Amendment Version Control AI",
  "Legal Argument Topic Correlator",
  "International Precedent Matcher",
  "Gazette Notification Indexer Bot",
  "Legal Research Dashboard",
  "Voice-Command Precedent Query Bot",
  "Automated Citation Relevance Report",
  "Inter-Department Legal Sync Bot",
  "NLP Case Synopsis Generator",
  "Paragraph/Headnote Specific Search",
  "Pending Bill/Legislation Impact AI",
  "Legal Dictionary/Lexicon Bot",
  "AI Evaluator for Citation Validity",
  "Audit/Research Query Log Gen",
  "Data Privacy/Confidential Memo Scrubber",
  "State Law Department Sync",
  "Field Officer Quick-Law App",
  "Historical Case Precedent Correlator",
  "Senior Legal Advisor Briefing AI",
  "Legal Researcher Workload Allocator",
  "Blockchain Immutable Citation Hash",
  "Anti-Tamper Legal DB Shield",
  "Mobile App for Offline Reading",
  "Jurisdiction-Specific Law Matcher",
  "Multi-Lingual Judgment Translator",
  "Historical Jurisprudence Trend Analyzer",
  "Legal Research Methodology Trainer",
  "Research Server Health Monitor",
  "Imminent Law Change/Amendment Alert",
  "Organized Crime Law Loophole Profiler",
  "Constitutional Bench Ruling Classifier",
  "AI Assisted Legal Opinion Drafter",
  "Document Digitization Storage Forecaster",
  "Secure Internal Legal Strategy Protector",
  "Integration with SCC Online/Manupatra APIs",
  "Citizen Legal Awareness Extractor",
  "Emergency/Martial Law Precedent Modeler",
  "Disaster Relief Legal Provision Coordinator",
  "Legal Research Subscription Tracker",
  "Custom Workflow for Opinion Approval",
  "AI Driven Legal Outcome Predictor",
  "Predictive Need for Ordinance",
  "Custom Alert Trigger for Law Officers",
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI LEGAL RESEARCH
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI LEGAL <span>RESEARCH</span></h1>
...
export default LegalResearchDetailed;
