...
const aiExperts = [
  "Isolated/Off-Site ATM Vulnerability Scorer",
  "Skimming/Cloning Device Audit AI",
  "CCTV/Hidden Camera Tamper Detector",
  "Guard Duty/Sleep Anomaly Analyzer",
  "Gas-Cutter/Physical Breach Predictor Bot",
  "Cash Replenishment Time Anomalies",
  "Geo-Spatial High-Risk ATM Mapper",
  "Helmet/Mask Detection in Kiosk AI",
  "ATM Security Command Dashboard",
  "Voice-Command ATM Status Bot",
  "Automated Monthly Compliance Report",
  "Cyber Cell (Card Fraud) Sync Bot",
  "Suspicious Loitering/Long-Stay Detector",
  "Repeat Unsuccessful Transaction Alert",
  "Private Guard (PSARA) Verification AI",
  "Alarm/Siren Link Tester Bot",
  "AI Evaluator for Kiosk Preparedness",
  "Audit/Inspection Log Generator",
  "Data Privacy/Cardholder Scrubber",
  "State Lead Bank/RBI Guideline Sync",
  "Field IO Spot-Check Mobile App",
  "Historical ATM Theft/Uprooting Correlator",
  "SHO/Supervisory Officer Briefing",
  "Beat Patrol Route Optimizer",
  "Blockchain Immutable Audit Hash",
  "Anti-Tamper Security Rating Shield",
  "Mobile App for Quick Beat Updates",
  "Jurisdiction/Route Polygon Matcher",
  "Multi-Lingual Safety Advisory Translator",
  "Historical Fraud/Theft Trend Analyzer",
  "ATM Security Audit SOP Trainer",
  "Audit DB Server Health Monitor",
  "Imminent Gas-Cutter/Uprooting Alert",
  "Organized ATM Theft/Skimming Syndicate Profiler",
  "High-Cash Volume Target Classifier",
  "AI Assisted Rectification Notice Drafter",
  "Audit Image/Video Storage Forecaster",
  "Secure Vulnerability Data Protector",
  "Integration with Managed Service Providers (MSP)",
  "Citizen ATM Fraud Reporting Portal",
  "Night-Time Highway Theft Modeler",
  "Disaster/Riot ATM Security Coordinator",
  "Audit/Patrol Expense Budget Tracker",
  "Custom Workflow for ATM Closure Notice",
  "AI Driven Attack Probability Predictor",
  "Predictive Need for Increased Patrol",
...
const ATMSecurityComplianceDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ATM SECURITY COMPLIANCE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ATM SECURITY <span>COMPLIANCE</span></h1>
...
export default ATMSecurityComplianceDetailed;
