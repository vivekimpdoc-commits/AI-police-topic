...
const aiExperts = [
"Legal Narrative Auto-Drafter AI",
  "New Law (BNS/BNSS/BSA) Section Suggester",
  "Court Admissibility & Loophole Checker",
  "Complaint to FIR Text Converter AI",
  "Modus Operandi (MO) Keyword Extractor",
  "Suspect Name & Alias Cross-Checker",
  "Stolen Property/Value Estimator Bot",
  "Weapon/Firearms Act Section Matcher",
  "Narcotics/NDPS Quantity to Section AI",
  "Cyber Crime (IT Act) Clause Recommender",
  "Women/Child Protection Act (POCSO) Sync",
  "SC/ST Atrocities Act Trigger Flag AI",
  "Historical Precedent & Case Law Linker",
  "FIR Translation (Local to English/Hindi) AI",
  "Voice-Dictated FIR Transcriber Bot",
  "Automated FIR Structuring/Formatting",
  "Cross-FIR Deduplication & Linking AI",
  "Zero-FIR Jurisdiction Router Bot",
  "Cognizable vs Non-Cognizable Flag AI",
  "FIR Modification/Tamper Audit Logger",
  "Digital Signature & Timestamp Verifier",
  "Investigating Officer (IO) Assignment Router",
  "Arrest Warrant Pre-Requisite Checker",
  "Bail/Non-Bailable Offense Categorizer",
  "Media/Press Release Auto-Drafter from FIR",
  "Automated CCTNS Data Entry Sync Bot",
  "Victim Protection & Anonymity Scrubber AI",
  "Witness Statement to FIR Correlator",
  "Forensic/Medico-Legal Request Auto-Gen",
  "Accident/Traffic (MV Act) Clause Matcher",
  "Financial/Economic Offense (PMLA) Linker",
  "Terror/UAPA/MCOCA Act Suggester AI",
  "Wildlife/Forest Act Section Matcher",
  "Excise/Liquor Act Integration Bot",
  "Riot/Unlawful Assembly Act Correlator",
  "Election Offense (RP Act) Clause Sync",
  "FIR Tone & Objective Language Scorer",
  "Plagiarism/Copy-Paste FIR Detector AI",
  "Automated Charge-Sheet Foundation Gen",
  "Legal Lexicon/Terminology Spell Checker",
  "Supervisory Officer (SHO/CO) Approval Router",
  "Automated SMS/Email to Complainant AI",
  "Court Summons/Notice Drafter Bot",
  "Interstate Extradition Prep from FIR",
  "Interpol Red-Corner Notice Data Extractor",
  "AI Generated Investigation Action Plan",
  "Timeline/Alibi Contradiction Flag AI",
  "Blockchain Hash Generator for FIR Veracity",
  "Secure Encrypted Vault for Sensitive FIRs",
  "Voice-Command FIR Search & Retrieval",
  "AI Chatbot for IO Legal Queries",
  "Juvenile Justice Act Compliance Checker",
  "Missing Person to Kidnapping Auto-Escalate",
  "Suicide Abetment Clause Analyzer Bot",
  "Dowry/Cruelty Fact-Pattern Matcher AI",
  "Medical Negligence Section Recommender",
  "Industrial/Labor Law Violation Linker",
  "Copyright/Trademark Piracy Act Sync",
  "Defamation/Hate Speech Context Analyzer",
  "Environmental/Pollution Control Act Flag"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI FIR ASSISTANT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI FIR ASSISTANT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in drafting legal narratives, ipc/bns section suggestion & court admissibility.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI FIR <span>ASSISTANT</span></h1>
            <p className="cyber-subtitle">Drafting Legal Narratives, IPC/BNS Section Suggestion & Court Admissibility</p>
          </div>
        </div>
      </header>
...
export default FIRAssistantDetailed;
