...
const aiExperts = [
  "Vehicle Daily Usage Heatmap Generator AI",
  "Idle/Parked Time Analysis per Vehicle Bot",
  "Optimal Fleet Size Modeling Algorithm",
  "Under-Utilized Vehicle Flagging Engine",
  "Over-Utilized/Worn Vehicle Alert Bot AI",
  "GPS Trip Log vs Duty Allocation Matcher",
  "Department-wise Vehicle Demand Forecaster",
  "Peak/Off-Peak Hour Fleet Demand Modeler",
  "Fleet Utilization Command Dashboard",
  "Voice-Command Fleet Status Query Bot",
  "Automated Monthly Fleet Report Generator",
  "Cross-Station Fleet Comparison Engine",
  "Vehicle Age vs Utilization Correlation AI",
  "Night Shift Vehicle Usage Optimizer Bot",
  "Patrol vs Administrative Vehicle Ratio AI",
  "Requisitioned Vehicle Tracking Engine",
  "AI Evaluator for Fleet ROI/Value",
  "Audit/Vehicle Log Discrepancy Detector",
  "Data Privacy/Officer Travel Data Masker",
  "Police-Finance Dept Fleet Budget Sync",
  "Patrol Car Beat Coverage Optimizer AI",
  "Armored Vehicle Deployment Frequency Bot",
  "Senior Officer (DGP Admin) Briefing Bot",
  "Public Vehicle Requisition Dashboard",
  "Blockchain Immutable Trip Record Hasher",
  "Anti-Misuse Personal Trip Detector AI",
  "Mobile App for Fleet Manager Overview",
  "Electric Vehicle Charging Schedule Optimizer",
  "Multi-Lingual Fleet Report Translator Bot",
  "Historical Fleet Growth Trend Analyzer",
  "Staff Vehicle Allotment Fairness AI",
  "Vendor/Hired Vehicle Usage Comparator",
  "Temporary Naka Vehicle Redeployment Bot",
  "Traffic Crane/Tow Vehicle Utilization AI",
  "Accident Probe Vehicle Dispatch Frequency",
  "VIP Fleet Availability Guarantor AI",
  "AI Assisted Post-Quarter Fleet Audit Gen",
  "Depreciation vs Maintenance Cost Modeler",
  "Green Fleet (EV/CNG) Transition Planner",
  "Integration with State Asset Register",
  "Citizen Patrol Frequency Visibility App",
  "Extreme Weather Vehicle Grounding Alert",
  "Disaster Fleet Mobilization Speed Tracker",
  "Fleet Procurement Budget Tracker AI",
  "Custom Workflow/Approval for New Vehicle",
  "AI Driven Vehicle Retirement Predictor",
  "Predictive Need for Fleet Expansion",
  "Custom Alert Trigger for Fleet Commander"
];
...
const FleetUtilizationAnalyticsDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI FLEET UTILIZATION ANALYTICS
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI FLEET UTILIZATION ANALYTICS</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in vehicle usage heatmaps, idle time analysis & optimal fleet size modeling.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI FLEET UTILIZATION <span>ANALYTICS</span></h1>
            <p className="cyber-subtitle">Vehicle Usage Heatmaps, Idle Time Analysis & Optimal Fleet Size Modeling</p>
          </div>
        </div>
      </header>
...
export default FleetUtilizationAnalyticsDetailed;
