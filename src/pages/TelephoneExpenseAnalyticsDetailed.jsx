...
const aiExperts = [
  "CUG (Closed User Group) Plan Optimizer AI",
  "ISD/Premium/Spam Call Cost Alert Bot",
  "Data Limit/Overage Monitoring Engine",
  "Telecom Vendor Billing Audit AI",
  "Landline vs Mobile Cost Analyzer",
  "Unused/Dormant SIM Card Detector",
  "Geo-Spatial Roaming/Tower Usage Mapper",
  "Personal vs Official Usage Profiler",
  "Telephone Expense Dashboard",
  "Voice-Command Telecom Query Bot",
  "Automated Monthly Telecom Audit Report",
  "Telecom Provider (BSNL/Jio/Airtel) API Sync",
  "Billing Anomaly/Double Charge Detector",
  "Plan Downgrade/Upgrade Suggester AI",
  "Lost/Stolen Device Usage Identifier",
  "Inter-District/State STD Cost Correlator",
  "AI Evaluator for Telecom ROI",
  "Audit/Payment Log Generator",
  "Data Privacy/Call Record (CDR) Scrubber",
  "Finance/Accounts Sync",
  "Officer Data/Plan Usage Mobile App",
  "Historical Election/VIP Duty Surge Correlator",
  "SP/Communications Officer Briefing AI",
  "Bill Payment/Clearance Allocator",
  "Blockchain Immutable Bill/Payment Hash",
  "Anti-Tamper Telecom Billing Shield",
  "Mobile App for SIM Request/Block",
  "Rank-wise Usage/Limit Benchmarker",
  "Automated Alert for Data Exhaustion",
  "Historical Telecom Expenditure Trend Analyzer",
  "Telecom/CUG Usage SOP Trainer",
  "Telecom API/Gateway Health Monitor",
  "Imminent Plan Cap/Disconnection Alert",
  "Habitual Limit Exceeder (Frivolous Use) Profiler",
  "High-Priority (Control Room/Helpline) Line Classifier",
  "AI Assisted Disputed Bill Drafter",
  "Billing Data/Analytics Storage Forecaster",
  "Secure Officer Contact Number Protector",
  "Integration with Cyber Cell/Lawful Intercept (for lost SIMs)",
  "Internal Directory Sync",
  "Election Special Control Room Cost Modeler",
  "Disaster Satellite Phone (Satphone) Cost Coordinator",
  "Telecom/CUG Budget Tracker",
  "Custom Workflow for Bulk SIM Procurement",
  "AI Driven Next-Month Cost Predictor",
  "Predictive Need for Broadband/Wi-Fi offload",
  "Custom Alert Trigger for IG Communications",
  "Telecom Asset/Number Lifecycle Tracker"
];
...
const TelephoneExpenseAnalyticsDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI TELEPHONE EXPENSE ANALYTICS
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI TELEPHONE EXPENSE <span>ANALYTICS</span></h1>
...
export default TelephoneExpenseAnalyticsDetailed;
