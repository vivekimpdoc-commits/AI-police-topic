...
const aiExperts = [
  "SOP PDF Semantic Search Indexer AI",
  "Legal Precedent & High Court Case Matcher",
  "Criminal Case Study Auto-Summarizer Bot",
  "State Police Manual Query Assistant Bot",
  "NDPS/IPC Section Recommender Engine AI",
  "Cyber Law/IT Act Compliance Checker Bot",
  "Investigation SOP Verification Checklist Generator",
  "Police Manual updates Auto-Notifier Engine",
  "Knowledge Base Command Dashboard Portal",
  "Voice-Command SOP Manual Query Bot",
  "Automated Weekly Legal Update Digest Gen",
  "Cross-Force Knowledge Library Sync Engine",
  "Court Case Outcome Predictor Algorithm AI",
  "Drafting Assistant for Legal Notices (CrPC)",
  "Historical Judgements Legal Semantic Analyzer",
  "Police Training Academy Lesson Generator Bot",
  "AI Evaluator for Case File SOP Compliance",
  "Audit/Knowledge Base Read Access Log Generator",
  "Data Privacy/Case Study Witness Name Masker AI",
  "Police-National Law University Database Sync",
  "Field Investigator Legal Helpline Mobile App Sync",
  "Cold Case Unsolved MO Legal Precedent Linker",
  "Senior Officer (IG Training Wing) Briefing Bot",
  "Public Citizen Rights & SOP Information Portal",
  "Blockchain Immutable SOP Revision Hash Registry",
  "Anti-Leak Case File Security/RBAC Shield AI",
  "Mobile App for Quick CrPC/IPC Section Search",
  "Expert Witness Directory Recommendation Engine",
  "Multi-Lingual Legal Terminology Translator Bot",
  "Historical Legal Loophole Strategy Analyzer Bot",
  "Staff Academy Training Mark Tracker Engine AI",
  "Knowledge Server Cluster Health Monitor Bot",
  "Urgent Procedural Error In Investigation Alert AI",
  "Traffic/Transit Law SOP Compliance Auditor Bot",
  "Cybercrime Forensic Protocol SOP Assistant Bot",
  "VIP Protocol security Guide Query Assistant",
  "AI Assisted Case Diary Legal Compliance Check",
  "Knowledge Base Document Priority Optimizer Bot",
  "Forensic Lab SOP Reference Document Linker AI",
  "Integration with National Digital Law Library",
  "Citizen Legal Rights Helpline Voice Assistant Bot",
  "Extreme Case Law Volume Search Query Allocator",
  "Disaster Emergency Protocol Reference Guide AI",
  "Knowledge Library Maintenance Budget Tracker AI",
  "Custom Workflow/Approval for SOP Update Publish",
  "AI Driven Legal Argument Success Rate Predictor",
  "Predictive Need for Specialized Legal Counsel",
  "Custom Alert Trigger for Police Academy Director"
];
...
const IntelligenceKnowledgeBaseDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI KNOWLEDGE BASE
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI KNOWLEDGE BASE</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in department sops, legal precedents, criminal case studies & searchable intel archive.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI KNOWLEDGE <span>BASE</span></h1>
            <p className="cyber-subtitle">Department SOPs, Legal Precedents, Criminal Case Studies & Searchable Intel Archive</p>
          </div>
        </div>
      </header>
...
export default IntelligenceKnowledgeBaseDetailed;
