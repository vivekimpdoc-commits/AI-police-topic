...
const aiExperts = [
  "Reserve Force Turnout/Readiness Scorer",
  "Quarter Guard Protocol Audit AI",
  "Mess/Canteen Hygiene & Ration Validator",
  "Armory/Magazine Safety Compliance Bot",
  "Barrack Sanitation/Living Standard Analyzer",
  "MT (Motor Transport) Fleet Readiness Scorer",
  "Geo-Spatial Police Line Layout Mapper",
  "Welfare Activity/Hospital Audit Engine",
  "Police Line Inspection Dashboard",
  "Voice-Command Line Status Bot",
  "Automated Monthly Reserve Audit Report",
  "Lines Officer/Reserve Inspector (RI) Sync",
  "Ammunition Discrepancy/Shortage Predictor",
  "Food Quality/Ration Pilferage Alert",
  "Vehicle Breakdown/Unreadiness Detector",
  "Sickness/Leave Spike Analyzer",
  "AI Evaluator for Reserve Force Health Index",
  "Audit/Line Inspection Log Generator",
  "Data Privacy/Force Roster Scrubber",
  "Armed Police/Battalion HQ Sync",
  "Inspecting Commandant/SP App",
  "Historical Discipline Breach Correlator",
  "DGP (Armed/Reserve) Briefing AI",
  "Maintenance/Repair Task Allocator",
  "Blockchain Immutable Armory Audit Hash",
  "Anti-Tamper Ration Ledger Shield",
  "Mobile App for Quick Parade Grading",
  "Battalion-wise Readiness Benchmarker",
  "Automated Alert for Armory Security Breach",
  "Historical Mess/Ration Subsidy Analyzer",
  "Police Line/Quarter Guard SOP Trainer",
  "CCTV/Armory Sensor Health Monitor",
  "Imminent Riot/Mob Deployment Unreadiness Alert",
  "Substandard Ration Vendor Profiler",
  "Critical (Quick Response Team) Readiness Classifier",
  "AI Assisted Welfare Grant Proposal Drafter",
  "Inspection Image/Data Storage Forecaster",
  "Secure Armory Inventory Protector",
  "Integration with HRMS/Leave Portal",
  "State Health Department (Camp Hospital) Sync",
  "Election Reserve Force Turnout Modeler",
  "Disaster Relief Equipment Readiness Coordinator",
  "Line Maintenance/Welfare Budget Tracker",
  "Custom Workflow for Mounted Police (Cavalry)",
  "AI Driven Equipment Replacement Predictor",
  "Predictive Need for Mess Upgrades",
  "Custom Alert Trigger for ADG Armed Police",
  "Inspection Start to Rectification Timeline"
];
...
const PoliceLineInspectionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI POLICE LINE INSPECTION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI POLICE LINE <span>INSPECTION</span></h1>
...
export default PoliceLineInspectionDetailed;
