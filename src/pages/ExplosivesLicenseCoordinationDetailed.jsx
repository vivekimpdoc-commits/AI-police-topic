...
const aiExperts = [
  "PESO (Petroleum & Explosives Safety Org) Data Sync AI",
  "Magazine Site Security/Vulnerability Auditor",
  "Transit Route Risk Mapping Engine",
  "Hazard Zone/Blast Radius Analyzer",
  "Quantity/Capacity Compliance Tracker",
  "Fire NOC/Emergency Access Validator",
  "Geo-Spatial Explosive Storage Density Mapper",
  "Automated Renewal/Inspection Alert Bot",
  "Explosives License Dashboard",
  "Voice-Command Magazine Query Bot",
  "Automated Quarterly Hazard/Compliance Report",
  "State Disaster Management Authority Sync",
  "Pilferage/Black-Market Diversion Predictor",
  "Unauthorized Expansion/Storage Alert",
  "Urban Encroachment (near Magazine) Analyzer",
  "Transit Delay/Hijack Risk Estimator",
  "AI Evaluator for Explosives Safety Index",
  "Audit/Inspection Log Generator",
  "Data Privacy/Transporter Identity Scrubber",
  "Fire Brigade/Emergency Services Sync",
  "Explosives Inspector/SHO Mobile App",
  "Historical Accidental Blast Correlator",
  "District Magistrate (DM)/SP Briefing AI",
  "Joint Inspection (Police + Fire + Admin) Allocator",
  "Blockchain Immutable Site Audit Hash",
  "Anti-Tamper NOC/Approval Shield",
  "Mobile App for On-Site Perimeter Video Upload",
  "District-wise Explosives Safety Benchmarker",
  "Automated Alert for Approaching Storage Limit",
  "Historical Inspection/Travel Cost Analyzer",
  "Explosives Rules Compliance SOP Trainer",
  "PESO API/Database Health Monitor",
  "Imminent Heatwave/Weather Hazard Alert (for Magazines)",
  "Habitual Compliance Defaulter Profiler",
  "High-Risk (Detonators/Gelatin) Storage Classifier",
  "AI Assisted Cancellation/Seizure Order Drafter",
  "Mining/Construction Explosive Demand Forecaster",
  "Secure Transport Route/Schedule Protector",
  "Integration with Mining/Geology Department Data",
  "Highway Patrol/Traffic Control Room Sync",
  "Election Strict Monitoring/Audit Modeler",
  "Disaster (Fire/Earthquake) Magazine Evacuation Coordinator",
  "Specialized Hazmat Training Budget Tracker",
  "Custom Workflow for Ammonium Nitrate Storage",
  "AI Driven Blast/Accident Vulnerability Predictor",
  "Predictive Need for Relocation of Aging Magazines",
  "Custom Alert Trigger for DGP/Chief Secretary",
  "Application/NOC Request to Final Clearance Timeline"
];
...
const ExplosivesLicenseCoordinationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI EXPLOSIVES LICENSE COORDINATION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI EXPLOSIVES LICENSE <span>COORDINATION</span></h1>
...
export default ExplosivesLicenseCoordinationDetailed;
