...
const aiExperts = [
  "RFID/Barcode Physical File Tracker AI",
  "Automated Weeding Out/Destruction Scheduler",
  "Central Archival Indexing Engine",
  "Legacy Data Digitization/OCR Sync",
  "File Movement/Pendency Tracker",
  "Category (A/B/C/D) Recommender AI",
  "Geo-Spatial Rack/Shelf Mapper",
  "Missing/Misplaced File Detector",
  "PHQ File Room Dashboard",
  "Voice-Command File Query Bot",
  "Automated Monthly Weeding Report",
  "E-Office/Dak System Sync",
  "Multi-Lingual File Noting OCR",
  "Pest/Moisture Damage Predictor",
  "Unauthorized Access/Check-out Detector",
  ...
  "State Archives Sync",
  "Record Keeper Mobile Scanning App",
  "Historical File Retrieval Frequency Correlator",
  "Head Clerk/Superintendent Briefing AI",
  "Filing/Retrieval Task Allocator",
  "Blockchain Immutable Movement Hash",
  "Anti-Tamper Archival Index Shield",
  "Mobile App for Rapid Audit",
  "Branch-wise Archival Discipline Benchmarker",
  "Automated Reminder for Expired Files",
  "Historical Storage/Digitization Cost Analyzer",
  "Record Management SOP Trainer",
  "RFID Gateway Health Monitor",
  "Imminent Space Exhaustion Alert",
  "Habitual File Hoarder (Officer) Profiler",
  ...
  "Secure Top-Secret File Protector",
  "Integration with State IT/Digitization Portals",
  "RTI Information Retrieval Sync",
  "Election Old Record Retrieval Modeler",
  ...
  "Predictive Need for High-Density Storage",
  "Custom Alert Trigger for Nodal Officer",
  "File Archival to Destruction Timeline"
];
...
const PoliceHeadquartersFileRoomDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI PHQ FILE ROOM
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI PHQ FILE <span>ROOM</span></h1>
...
export default PoliceHeadquartersFileRoomDetailed;
