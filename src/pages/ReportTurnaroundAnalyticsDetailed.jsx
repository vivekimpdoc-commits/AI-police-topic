...
const aiExperts = [
  "Pendency/Bottleneck Identification AI",
  "Analyst Efficiency/Throughput Scorer",
  "Fast-Track Court Prioritization Engine",
  "Predictive Delay/Overdue Modeler",
  "Case Complexity vs Time-Taken Analyzer",
  "Inter-Division Dependency/Delay Mapper",
  "Geo-Spatial Regional FSL TAT (Turnaround Time) Mapper",
  "Automated Report Drafting/Template Assistant",
  "Turnaround Analytics Dashboard",
  "Voice-Command Pendency Query Bot",
  "Automated Monthly TAT/Efficiency Report",
  "Directorate of Prosecution Sync",
  "Imminent Court Deadline/Contempt Predictor",
  "Systemic Delay/Inefficiency Alert",
  "Analyst Burnout/Overwork Flagging AI",
  "Equipment Breakdown Impact/Delay Estimator",
  "AI Evaluator for Lab Agility Index",
  "Audit/Workflow Log Generator",
  "Data Privacy/Officer Appraisal Scrubber",
  "HRMS/Performance Review Sync",
  "FSL Director/Division Head Mobile App",
  "Historical Delay-to-Acquittal/Bail Correlator",
  "Home Secretary/DGP Briefing AI",
  "Workload Re-balancing/Re-assignment Allocator",
  "Blockchain Immutable TAT/Timestamp Hash",
  "Anti-Tamper Performance Report Shield",
  "Mobile App for Quick Pendency Overview",
  "Analyst-to-Analyst Efficiency Benchmarker",
  "Automated Alert for Approaching Statutory Deadline (e.g., POCSO/NDPS)",
  "Historical Overtime/Incentive Cost Analyzer",
  "Time Management/Workflow Optimization SOP Trainer",
  "LIMS/Reporting API Health Monitor",
  "Imminent Mass Bail (Due to Missing FSL Report) Alert",
  "Chronically Slow/Inefficient Analyst Profiler",
  "High-Priority (Heinous Crime/Media Highlighted) Classifier",
  "AI Assisted Delay Explanation/Affidavit Drafter",
  "Future Workload/TAT Trend Forecaster",
  "Secure Performance Appraisal Protector",
  "Integration with E-Courts/ICJS",
  "State Crime Records Bureau (SCRB) Sync",
  "Election Fast-Track Case TAT Modeler",
  "Disaster Mass-Casualty DNA Report Expeditor",
  "Performance Incentive/Overtime Budget Tracker",
  "Custom Workflow for Inter-State/CBI Cases",
  "AI Driven Estimated Dispatch Date Predictor",
  "Predictive Need for Staff Augmentation",
  "Custom Alert Trigger for Home Minister",
  "Case Assignment to Final Report Dispatch Timeline"
];
...
const ReportTurnaroundAnalyticsDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI REPORT TURNAROUND ANALYTICS
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI REPORT TURNAROUND <span>ANALYTICS</span></h1>
...
export default ReportTurnaroundAnalyticsDetailed;
