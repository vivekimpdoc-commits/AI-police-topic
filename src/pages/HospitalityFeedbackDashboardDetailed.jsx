...
const aiExperts = [
  "Guest Sentiment/NLP Analysis AI",
  "Automated Complaint/Grievance Router",
  "Vendor/Caterer Rating & Scorecard Engine",
  "Continuous Improvement (Kaizen) Metric Bot",
  "QR Code/Tablet Feedback Aggregator",
  "Fake/Biased Review Detector AI",
  "Geo-Spatial Guest House/Lounge Satisfaction Mapper",
  "Recurring Issue/Root Cause Identifier",
  "Hospitality Feedback Dashboard",
  "Voice-Command Sentiment Query Bot",
  "Automated Monthly Hospitality Quality Report",
  "State Tourism/Estate Department Sync",
  "Unresolved Complaint Escalation Alert",
  "Vague/Generic Feedback Categorizer",
  "Drop in Quality/Service Predictor",
  "Cost vs Satisfaction (ROI) Analyzer",
  "AI Evaluator for Hospitality Excellence Index",
  "Audit/Resolution Log Generator",
  "Data Privacy/VIP Guest ID Scrubber",
  "Admin/Lines Department Sync",
  "Hospitality Manager Resolution App",
  "Historical Event/Conference Feedback Correlator",
  "SP (Protocol/Admin) Briefing AI",
  "Maintenance/Service Task Allocator",
  "Blockchain Immutable Feedback Hash",
  "Anti-Tamper Guest Review Shield",
  "Mobile App for Instant Action Taken (ATR)",
  "Facility-wise Satisfaction Benchmarker",
  "Automated Alert for Critical Negative Feedback",
  "Historical Vendor Rating Trend Analyzer",
  "Customer Service/Hospitality SOP Trainer",
  "Feedback Kiosk/Tablet Health Monitor",
  "Imminent VIP Escalation/Embarrassment Alert",
  "Habitual Complainer/Frivolous Profiler",
  "High-Priority (Foreign Delegate) Feedback Classifier",
  "AI Assisted Vendor Warning Notice Drafter",
  "Sentiment Analytics Storage Forecaster",
  "Secure Dignitary Feedback Protector",
  "Integration with HRMS (for staff rewards)",
  "Public/Civilian Guest Portal Sync",
  "Election Observer Feedback Modeler",
  "Disaster Relief Staff Satisfaction Coordinator",
  "Hospitality Training/Upgrade Budget Tracker",
  "Custom Workflow for Service Recovery (Apology)",
  "AI Driven Future Rating Predictor",
  "Predictive Need for Staff Soft-Skills Training",
  "Custom Alert Trigger for DGP/ADG Admin",
  "Feedback Receipt to Resolution Timeline"
];
...
const HospitalityFeedbackDashboardDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI HOSPITALITY FEEDBACK DASHBOARD
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI HOSPITALITY FEEDBACK <span>DASHBOARD</span></h1>
...
export default HospitalityFeedbackDashboardDetailed;
