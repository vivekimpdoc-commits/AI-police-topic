...
const aiExperts = [
  "Pole Structural/Rust Integrity AI",
  "UPS/Battery Backup Health Monitor",
  "Tree Branch/Line-of-Sight Blockage Detector",
  "Anti-Vandalism/Tamper Alert Bot",
  "Junction Box/Wiring Weatherproofing Auditor",
  "Optical Fiber/Network Connectivity Predictor",
  "Geo-Spatial Camera/Pole Mapper",
  "Blind-Spot/Coverage Overlap Analyzer",
  "CCTV Infrastructure Dashboard",
  "Voice-Command Camera Status Bot",
  "Automated Weekly Downtime Report",
  "Smart City/Municipal Corporation Sync",
  "PTZ (Pan-Tilt-Zoom) Calibration Checker",
  "Lens Dirt/Fogging Auto-Detector",
  "Vendor SLA/Penalty Calculator",
  "Lightning/Surge Protection Scorer",
  "AI Evaluator for Surveillance Uptime",
  "Audit/Repair Log Generator",
  "Data Privacy/Camera Field-of-View Scrubber",
  "State Command & Control Center Sync",
  "Field Technician Routing App",
  "Historical Vandalism Hotspot Correlator",
  "Traffic/Control Room Briefing AI",
  "Maintenance Vendor Task Allocator",
  "Blockchain Immutable Uptime Hash",
  "Anti-Tamper Infrastructure Shield",
  "Mobile App for Rapid Issue Reporting",
  "Vendor-wise Repair Speed Benchmarker",
  "Automated Reminder for Preventive Maintenance",
  "Historical Infrastructure ROI Analyzer",
  "Surveillance Maintenance SOP Trainer",
  "IoT Health Check Server Monitor",
  "Imminent Pole Collapse/Blind-Spot Alert",
  "Organized Syndicate Sabotage Profiler",
  "High-Priority/Strategic Junction Classifier",
  "AI Assisted Tree Trimming Request Drafter",
  "Diagnostic Log Storage Forecaster",
  "Secure Camera IP/Network Diagram Protector",
  "Integration with Traffic Management System",
  "Public Safety/Deterrence Index Sync",
  "Riot/Protest Infrastructure Damage Modeler",
  "Cyclone/Storm Wind-Load Coordinator",
  "Surveillance AMC/Expansion Budget Tracker",
  "Custom Workflow for Covert Camera Setup",
  "AI Driven Hardware Upgrade Predictor",
  "Predictive Need for Wireless/Solar Cameras",
  "Custom Alert Trigger for SP/SSP (Traffic)",
  "CCTV Infrastructure Lifecycle Tracker"
];
...
const CCTVPoleMaintenanceDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CCTV POLE MAINTENANCE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CCTV POLE <span>MAINTENANCE</span></h1>
...
export default CCTVPoleMaintenanceDetailed;
