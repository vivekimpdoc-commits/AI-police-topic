...
const aiExperts = [
  "Automated Escalation/Hierarchy Engine AI",
  "Multi-Channel (SMS/Email) Alert Bot",
  "DO (Demi-Official) Letter Reminder Optimizer",
  "Pendency/Delay Heatmap Generator",
  "Priority/Deadline Based Scheduler",
  "Read-Receipt/Acknowledgment Tracker",
  "Geo-Spatial Delay Mapper",
  "Custom Frequency/Interval Manager AI",
  "Reminder Management Dashboard",
  "Voice-Command Pendency Query Bot",
  "Automated Weekly Defaulter Report",
  "E-Office/Dak System Sync",
  "Multi-Lingual Reminder Translation",
  "Vague/Evasive Reply Detector AI",
  "Spam/Ignored Message Predictor",
  "Next Action Item Suggester",
  "AI Evaluator for Responsiveness Index",
  "Audit/Reminder Sent Log Generator",
  "Data Privacy/Contact Detail Scrubber",
  "State Command Center Sync",
  "Officer Pending Task Mobile App",
  "Historical Defaulter/Delay Correlator",
  "Supervisory Officer Briefing AI",
  "Intervention/Show-Cause Allocator",
  "Blockchain Immutable Reminder Hash",
  "Anti-Tamper Alert Log Shield",
  "Mobile App for Task Update/Snooze",
  "Unit-wise Responsiveness Benchmarker",
  "Automated Reminder for High-Level Meetings",
  "Historical Reminder Efficacy Analyzer",
  "Time Management SOP Trainer",
  "Messaging Gateway Health Monitor",
  "Imminent Statutory Deadline Alert",
  "Serial Defaulter/Procrastinator Profiler",
  "Court/Assembly Reminder Classifier",
  "AI Assisted Show-Cause Notice Drafter",
  "Alert Log Storage Forecaster",
  "Secure Communication Channel Protector",
  "Integration with HRMS (for Appraisals)",
  "Citizen Grievance Resolution Reminder Sync",
  "Election Task Deadline Modeler",
  "Disaster Response Critical Alert Coordinator",
  "SMS/Email Gateway Budget Tracker",
  "Custom Workflow for Final Warning",
  "AI Driven Task Completion Predictor",
  "Predictive Need for Task Reallocation",
  "Custom Alert Trigger for SP/SSP",
  "Reminder Escalation Timeline Tracker"
];
...
const ReminderManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI REMINDER MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI REMINDER <span>MANAGEMENT</span></h1>
...
export default ReminderManagementDetailed;
