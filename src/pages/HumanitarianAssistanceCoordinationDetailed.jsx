...
const aiExperts = [
"NGO/Civil Society Registration & Verification AI",
  "Foreign Aid/International Red Cross Sync",
  "Relief Material Duplication/Overlap Preventer",
  "Community Kitchen (Langar) Crowd Modeler",
  "Food/Water/Medicine Deficit Heatmap AI",
  "Volunteer/NGO Security Escort Allocator",
  "Airdrop/Helicopter Aid Drop-Zone Mapper",
  "VIP/Celebrity Charity Visit Security AI",
  "Fake NGO/Donation Fraud Detector Bot",
  "Orphan/Unaccompanied Child Protection AI",
  "Command Center Humanitarian Dashboard",
  "Voice-Command Aid Distribution Query",
  "Automated Aid Distribution Tally/Logger",
  "Inter-Agency (UN/State/NGO) Comm Sync",
  "Medical Camp/Mobile Clinic Security Allocator",
  "Sanitation/Hygiene Supply Tracker Bot",
  "Religious/Communal Sensitivity Analyzer",
  "Disability/Elderly Aid Prioritization AI",
  "Hoarding/Black-Market Sales Alert Engine",
  "Shelter Material (Tents) Distribution Sync",
  "AI Evaluator for Aid Distribution Equity",
  "Audit/Transparency Log Auto-Generator",
  "Data Privacy/Beneficiary Aadhar Masker",
  "Police-NGO Joint Distribution Sync Bot",
  "Riot/Stampede Predictor at Aid Centers",
  "Fuel/Logistics Optimizer for NGO Trucks",
  "Senior Officer (Relief Comm) Briefing Bot",
  "Public Announcement/Aid Location Broadcaster",
  "Blockchain Immutable Log of Foreign Aid",
  "Warehouse/Storage Security Guard Deployer",
  "Mobile App for NGO Field Worker Sync",
  "Mental Health/Trauma Counselor Routing AI",
  "Multi-Lingual Translator for Foreign NGOs",
  "Historical Aid Distribution Precedent Matcher",
  "Vaccine/Cold-Chain Logistics Security AI",
  "NGO Worker Fatigue/Safety Monitor",
  "Temporary Relief Kiosk Location Optimizer",
  "Traffic Management for Aid Distribution",
  "Flood/Earthquake Isolated Village Mapper",
  "Gender-Specific (Sanitary) Aid Tracker",
  "AI Assisted Post-Relief Operation Audit",
  "Security Eqp for Aid Workers Alert",
  "Media/Press Coverage Escort Modeler",
  "Integration with NDMA/State Relief Portal",
  "Citizen SOS for Specific Aid Router",
  "Heatwave/Cooling Relief Distribution AI",
  "Post-Disaster Rehabilitation Sync Bot",
  "NGO Contribution/Expense Tracker Sync",
  "Custom Workflow/Approval for Foreign Aid",
...
const HumanitarianAssistanceCoordinationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI HUMANITARIAN ASSISTANCE COORDINATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI HUMANITARIAN ASSISTANCE COORDINATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in ngo alignment, foreign aid security & community kitchen management.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI HUMANITARIAN ASSISTANCE <span>COORDINATION</span></h1>
            <p className="cyber-subtitle">NGO Alignment, Foreign Aid Security & Community Kitchen Management</p>
          </div>
        </div>
      </header>
...
export default HumanitarianAssistanceCoordinationDetailed;
