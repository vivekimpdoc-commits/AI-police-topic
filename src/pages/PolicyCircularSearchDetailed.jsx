...
const aiExperts = [
  "Semantic Circular Search Engine",
  "Natural Language Directive Query Bot",
  "Version Control & Deprecation Tracker",
  "Policy Contradiction Detector AI",
  "Department-Specific Router Bot",
  "Gazette Notification Indexer",
  "Urgent Circular Broadcast Coordinator",
  "Acknowledgment/Read-Receipt Tracker",
  "Circular Search Dashboard",
  "Voice-Command Policy Query Bot",
  "Automated Policy Impact Report Gen",
  "Inter-District Directive Sync Bot",
  "Pending Compliance Alert System",
  "Historical Circular Precedent Matcher",
  "Financial/Budget Policy Analyzer AI",
  "Leave/HR Circular Clarification Bot",
  "AI Evaluator for Policy Adherence",
  "Audit/Search Query Log Generator",
  "Data Privacy/Confidential Circular Scrubber",
  "State Secretariat Policy Sync Bot",
  "Field Officer Notification App",
  "Cold Case Policy Reference Matcher",
  "Senior Officer Review Briefing AI",
  "Policy Drafting Resource Allocator",
  "Blockchain Immutable Circular Hash",
  "Anti-Tamper Directive Shield AI",
  "Mobile App for Offline Policy Read",
  "Geo-Spatial Policy Impact Matcher",
  "Multi-Lingual Circular Translator",
  "Historical Policy Evolution Analyzer",
  "Policy Drafting/Formatting Assistant",
  "Circular DB Server Health Monitor",
  "Urgent Immediate-Action Circular Alert",
  "Organized Crime Policy Takedown Profiler",
  "VIP Protocol Circular Classifier",
  "AI Assisted Policy Brief Drafter",
  "Document Digitization Storage Forecaster",
  "Secure Internal Memo Protector",
  "Integration with eOffice/Govt Portals",
  "Citizen Relevant Circular Extractor",
  "Election/Model Code Circular Modeler",
  "Disaster Relief Directive Coordinator",
  "Policy Implementation Budget Tracker",
  "Custom Workflow for Circular Approval",
  "AI Driven Policy Overlap Predictor",
  "Predictive Need for Clarification Memo",
  "Custom Alert Trigger for Nodal Officers",
  "Circular Lifecycle & Expiry Tracker"
];
...
const PolicyCircularSearchDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI POLICY & CIRCULAR SEARCH
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI POLICY & CIRCULAR <span>SEARCH</span></h1>
...
export default PolicyCircularSearchDetailed;
