...
const aiExperts = [
  "Digital General Diary (GD) Logger AI",
  "NLP Daily Event Summarizer",
  "Tamper-Proof Timestamping Engine",
  "Semantic Search for Historical GDs",
  "Voice-to-Text Dictation Bot",
  "Auto-Categorization (Crime/Law & Order/Admin)",
  "Geo-Spatial Event Mapper",
  "Cross-Reference with FIR/CCTNS AI",
  "Official Diary Dashboard",
  "Voice-Command Diary Query Bot",
  "Automated Daily/Weekly Summary Report",
  "CCTNS/ICJS Sync Bot",
  "Multi-Lingual Translation (Local to English)",
  "Attachment/Photo Verification Bot",
  "Fake/Backdated Entry Predictor",
  "Pending Action Item Extractor",
  "AI Evaluator for Entry Accuracy",
  "Audit/Edit History Log Generator",
  "Data Privacy/Victim Detail Scrubber",
  "State Crime Records Bureau Sync",
  "Officer Voice Dictation Mobile App",
  "Historical Event Precedent Correlator",
  "SHO/Supervisory Officer Briefing AI",
  "Follow-up Task Allocator",
  "Blockchain Immutable GD Hash",
  "Anti-Tamper Digital Shield",
  "Mobile App for Quick Reference",
  "Police Station-wise Workload Benchmarker",
  "Automated Reminder for Pending Tasks",
  "Historical GD Volume Analyzer",
  "GD Writing SOP/Legal Trainer",
  "GD Server Health Monitor",
  "Imminent Unreported Crime Alert",
  "Incomplete/Vague Entry Profiler",
  "High-Priority/Heinous Crime Classifier",
  "AI Assisted Clarification Request Drafter",
  "Archival Storage Forecaster",
  "Secure Official Secrets Protector",
  "Integration with E-Courts",
  "RTI Portal (for public GD excerpts) Sync",
  "Election Incident GD Modeler",
  "Disaster Log/Response Coordinator",
  "Digital Infrastructure Budget Tracker",
  "Custom Workflow for Expunging Entries (Court Order)",
  "AI Driven Crime Trend Predictor (from GD)",
  "Predictive Need for Supervisory Intervention",
  "Custom Alert Trigger for SP/SSP",
  "Diary Entry Lifecycle Timeline Tracker"
];
...
const OfficialDiaryManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI OFFICIAL DIARY MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI OFFICIAL DIARY <span>MANAGEMENT</span></h1>
...
export default OfficialDiaryManagementDetailed;
