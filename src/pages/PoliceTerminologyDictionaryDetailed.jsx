...
const aiExperts = [
  "Regional Slang/Dialect Translation AI",
  "Penal Code (BNS/BNSS) Glossary Mapper",
  "Dark-Web/Cyber Jargon Decoding Engine",
  "Cross-State/Linguistic Standardization Bot",
  "Underworld/Syndicate Code-Word NLP Analyzer",
  "Legal Jargon Simplifier/Explainer AI",
  "Geospatial Dialect/Slang Origin Mapper",
  "Audio Interrogation Transcript Translator",
  "Terminology Dictionary Dashboard",
  "Voice-Command Slang Query Bot",
  "Automated Monthly New Jargon Update Report",
  "State Cyber Crime/Intelligence Sync",
  "Misinterpretation/Translation Error Predictor",
  "Emerging Syndicate Code-Word Alert AI",
  "Court Rejection (Due to Ambiguity) Analyzer",
  "Cross-Border Linguistic Friction Scorer",
  "AI Evaluator for Linguistic Standardization Index",
  "Audit/Query Log Generator",
  "Data Privacy/Interrogation Transcript Scrubber",
  "Directorate of Prosecution Sync",
  "Investigating Officer/Translator Mobile App",
  "Historical Miscommunication Correlator",
  "SP (Training/Cyber) Briefing AI",
  "Dictionary Update/Review Task Allocator",
  "Blockchain Immutable Terminology Hash",
  "Anti-Tamper Legal Definition Shield",
  "Mobile App for Real-Time Audio Translation",
  "District-wise Linguistic Accuracy Benchmarker",
  "Automated Alert for New Threat/Dark-Web Jargon",
  "Historical Translation Outsourcing Cost Analyzer",
  "Legal Drafting/Interrogation Linguistics SOP Trainer",
  "Translation API/Model Health Monitor",
  "Imminent Intelligence Failure (Due to Mis-translation) Alert",
  "Habitual Slang-User/Suspect Linguistic Profiler",
  "High-Priority (Terror/Narcotics Code) Classifier",
  "AI Assisted Translation Certification Drafter",
  "Linguistic Trend/Evolution Forecaster",
  "Secure Classified Code-Word Protector",
  "Integration with Inter-operable Criminal Justice System (ICJS)",
  "Central Forensic Science Lab (Linguistics) Sync",
  "Election Regional Sloganeering/Hate-Speech Modeler",
  "Disaster Local Distress Call Dialect Coordinator",
  "Linguistics/Translation Tech Budget Tracker",
  "Custom Workflow for Inter-State Gang Intercepts",
  "AI Driven NLP Model Accuracy Predictor",
  "Predictive Need for New Dialect Training Data",
  "Custom Alert Trigger for IG Cyber/Intel",
  "New Jargon Intercept to Dictionary Update Timeline"
];
...
const PoliceTerminologyDictionaryDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI POLICE TERMINOLOGY DICTIONARY
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI POLICE TERMINOLOGY <span>DICTIONARY</span></h1>
...
export default PoliceTerminologyDictionaryDetailed;
