...
const aiExperts = [
"7-Day Crime Trend Pattern Analyzer",
  "Weekly Hotspot Shift Tracker AI",
  "Weekly Crime Clearance/Solved Rate Bot",
  "Repeat Offender Weekly Alert Sync",
  "Weekly Cyber Crime Surge Modeler",
  "Traffic Accident/Fatality Weekly Map",
  "Weekly VIP Security Deployment Cost AI",
  "Women/Child Abuse Weekly Heatmap",
  "Weekly Narcotics/Liquor Seizure Tally",
  "Stolen Vehicle Weekly Recovery Correlator",
  "Missing Person Weekly Status Tracker",
  "Weekly Media Sentiment vs Crime AI",
  "Social Media Threat Weekly Digest AI",
  "Weekly Jansunwai (Grievance) Redressal",
  "Officer Weekly Performance Scorer Bot",
  "Weekly Arrests/Bail Outcome Analyzer",
  "Court Conviction Rate Weekly Sync",
  "Interstate Border Crime Weekly Modeler",
  "Weekly Intelligence/Special Branch Digest",
  "Election Violation Weekly Wrap-up AI",
  "Festival/Event Security Weekly Review",
  "Police Station-wise Weekly Comparison",
  "Weekly E-Challan Revenue Analytics",
  "Armoury/Malkhana Weekly Audit AI",
  "Vehicle Fleet Maintenance Weekly Log",
  "Police Welfare/Sick Leave Weekly Tally",
  "Weekly Drone/CCTV Surveillance Summary",
  "Automated Weekly Digest PDF/PPT Gen",
  "Weekly Crime Digest Voice Briefing",
  "Senior Officer (DGP/IG) Weekly Dashboard",
  "Weekly Crime Prediction for Next 7 Days",
  "Burglary/Theft Weekly Pattern AI",
  "Murder/Violent Crime Weekly Analysis",
  "Organized Crime/Gang Weekly Tracker",
  "Weekly Cyber Fraud Modus Operandi (MO)",
  "Traffic Congestion Weekly Bottleneck AI",
  "Riot/Protest Weekly Escalation Matrix",
  "Public Trust / Feedback Weekly Index",
  "Weekly Resource/Budget Utilization AI",
  "Weekly Training/Drill Performance Log",
  "Prison/Jail Incident Weekly Wrap",
  "Parole Jumpers Weekly Tracker AI",
  "Illegal Mining Weekly Seizure Tally",
  "Wildlife/Forest Poaching Weekly Log",
  "Weekly Informant/Source Tip ROI AI",
  "Weekly CCTNS Data Entry Compliance Bot",
  "Weekly Digest Multi-Lingual Translator",
  "Automated Weekly Digest Email Dispatch",
  "Weekly Digest Readership/Action Tracker",
  "Cross-District Weekly Crime Sync Bot",
  "Weekly Digest Keyword/Tag Cloud Gen",
  "Historical Weekly Trend Correlator AI",
  "Command Center Weekly Operation Review",
  "Weekly Media Press-Release Impact AI",
  "Weekly Cyber Attack/DDoS Summary",
  "Weekly Disaster/Rescue Operations Log",
  "Tourist Police Weekly Assistance Digest",
  "VIP/MLA Escort Weekly Resource Log",
  "Weekly Digest Blockchain Immutable Hash",
  "AI Generated Weekly Action Plan Drafter"
];
...
const WeeklyCrimeDigestDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI WEEKLY CRIME DIGEST
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI WEEKLY CRIME DIGEST</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in 7-day crime trends, hotspot shift analysis & weekly clearance rates.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI WEEKLY CRIME <span>DIGEST</span></h1>
            <p className="cyber-subtitle">7-Day Crime Trends, Hotspot Shift Analysis & Weekly Clearance Rates</p>
          </div>
        </div>
      </header>
...
export default WeeklyCrimeDigestDetailed;
