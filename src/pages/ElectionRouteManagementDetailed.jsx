...
const aiExperts = [
"Polling Party Safe Route Optimizer AI",
  "EVM Transport Bus GPS Tracker Bot",
  "Sector Magistrate/QRT Patrol Route Engine",
  "VIP/Star Campaigner Route Deconfliction AI",
  "Ambush/Naxal Threat Route Avoider AI",
  "Bridge/Road Load Capacity Verifier Bot",
  "Convoy Green-Corridor/Traffic Clear Bot",
  "Real-Time Route Deviation Alert Engine",
  "Command Center Election Route Dashboard",
  "Voice-Command Route Security Query",
  "Automated Departure/Arrival Logger",
  "Inter-District Border Checkpost Clearance",
  "Breakdown/Accident Quick Response (QRT) AI",
  "Weather/Visibility (Fog/Rain) Modeler",
  "Night Travel Security Enforcer Bot",
  "Multi-Vehicle Convoy Pacing & Spacing AI",
  "AI Evaluator for Route Security Threat Level",
  "Incident/Blockade Log Generator",
  "Data Privacy/Polling Party Manifest Masker",
  "Police-Transport Dept Joint Ops Linker",
  "Riot/Mob Congregation Heatmap Avoider",
  "Fuel/Rest Stop Security Planning Bot",
  "Senior Officer (Traffic DGP) Briefing",
  "Public Alert for VIP Movement Drafter",
  "Blockchain Immutable Log of EVM Movement",
  "Drone Aerial Overwatch Sync for Convoys",
  "Mobile App for Bus Driver/Escort Sync",
  "Airlift/Helicopter Route Mapper for EVMs",
  "Multi-Lingual Driver Communication Bot",
  "Historical Ambush Precedent Matcher",
  "Medical Emergency/Ambulance Route AI",
  ...
  "Armed Insurgency/Shadow Zone Route Modeler",
  "AI Assisted Post-Election Route Audit",
  "Vehicle Repair/Tow-Truck Standby Alert",
  "Foreign Observer Secure Escort Route AI",
  "Integration with ECI GPS Tracking Portal",
  "Citizen Social Media Roadblock Scraper",
  "Extreme Weather Driver Safety Modeler",
  "Empty Bus Return Journey Security AI",
  "Election Route Fuel/Logistics Expense AI",
  "Custom Workflow/Approval for Route Change",
  "AI Driven Traffic Bottleneck Predictor",
  "Predictive Need for Road Clearance Force",
  "Custom Alert Trigger for Route Commander"
];
...
const ElectionRouteManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ELECTION ROUTE MANAGEMENT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI ELECTION ROUTE MANAGEMENT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in safe routes for polling parties, gps tracking & vip route deconfliction.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ELECTION ROUTE <span>MANAGEMENT</span></h1>
            <p className="cyber-subtitle">Safe Routes for Polling Parties, GPS Tracking & VIP Route Deconfliction</p>
          </div>
        </div>
      </header>
...
export default ElectionRouteManagementDetailed;
