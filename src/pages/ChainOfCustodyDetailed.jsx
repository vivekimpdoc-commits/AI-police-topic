...
const aiExperts = [
"Blockchain Immutable Custody Ledger AI",
  "Physical Evidence to Digital Twin Sync",
  "Biometric/MFA Handover Verification AI",
  "Tamper/Seal Breakage Instant Alert Bot",
  "Automated Court Admissibility Certificate Gen",
  "Officer Possession Time-Limit Tracker AI",
  "Evidence Room/Malkhana GPS Geofencing",
  "RFID/Barcode Scanning Integration Engine",
  "Chain Gap/Missing Link Anomaly Detector",
  "Cross-District/State Transfer Escort Tracker",
  "Third-Party (FSL/Lab) Handoff Verification",
  "Evidence Viewing/Checkout Authorization AI",
  "Command Center Real-time Custody Dashboard",
  "Voice-Command Evidence Location Query Bot",
  "Historical Custody Trail Visualizer AI",
  "Suspect/Defense Tamper Claim Rebuttal Gen",
  "Temperature/Climate Sensor Sync for Bio-Evidence",
  "Weapon/Firearm Ballistics Lab Tracking AI",
  "Narcotics/Drug Sample Weight Verification AI",
  "Cyber/Digital Drive Seizure Bag Tracker",
  "AI Evaluator for Legal Compliance (BNS)",
  "Inter-Agency (Court/Prosecution) Handover Sync",
  "Lost/Misplaced Evidence Predictive Alert",
  "Unauthorized Access/Movement Flag Bot",
  "Automated Return-to-Owner/Disposal Protocol AI",
  "Officer Accountability/Negligence Scorer",
  "Disaster/Fire Evidence Evacuation Log AI",
  "VIP/High-Profile Case Custody Lock-Down",
  "AI Assisted Chain of Custody Report Drafter",
  "Data Privacy & Confidentiality Enforcer",
  "Mobile App for Field Seizure Tagging AI",
  "Senior Officer (SP/Judge) Audit Briefing Bot",
  "Video/Body-Cam Link to Physical Seizure",
  "Public/RTI Query Custody Status Masker",
  "Integration with CCTNS/State Data Center",
  "AI Driven Batch Evidence Transfer Router",
  "Custom Approval/Sign-off Hierarchy Definer",
  "Predictive Bottleneck Analysis at FSL",
  "Election Duty EVM Chain of Custody Tracker",
  "Custom Alert Trigger for High-Value Evidence"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CHAIN OF CUSTODY
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI CHAIN OF CUSTODY</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in blockchain immutable logs, tracking physical handovers & court admissibility.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CHAIN OF <span>CUSTODY</span></h1>
            <p className="cyber-subtitle">Blockchain Immutable Logs, Tracking Physical Handovers & Court Admissibility</p>
          </div>
        </div>
      </header>
...
export default ChainOfCustodyDetailed;
