...
const aiExperts = [
  "CCTV Crowd Density Estimator AI",
  "Drone/UAV Aerial Recon Integrator",
  "Bottleneck/Chokepoint Predictor",
  "Panic/Stampede Risk Scoring Engine",
  "Cell Tower (CDR) Mass Gathering Mapper",
  "Public Transit Overload Correlator",
  "Social Media Rally Organizer Tracker",
  "Acoustic/Noise Anomaly Detector",
  "Crowd Analytics Dashboard",
  "Voice-Command Density Query Bot",
  "Automated Surge Probability Report",
  "Rapid Action Force (RAF) Sync Bot",
  "Geo-Fenced Perimeter Breach Alert",
  "Evacuation Route Optimizer AI",
  "Face Recognition in Dense Crowds",
  "Weapon/Contraband Visual Scanner",
  "AI Evaluator for Force Deployment",
  "Audit/Crowd Video Log Generator",
  "Data Privacy/Face Blur Engine AI",
  "Traffic/Transit Authority Sync Bot",
  "Field Patrol Density Alert App",
  "Historical Stampede Pattern Matcher",
  "Command Center Briefing Bot",
  "Barricade/Riot Gear Resource Allocator",
  "Blockchain Immutable Video Hash",
  "Anti-Tamper Evidence Shield AI",
  "Mobile App for Field Commanders",
  "Protest Route Geolocation Matcher",
  "Multi-Lingual PA System Translator",
  "Historical Crowd Dynamics Analyzer",
  "Crowd Control SOP Trainer AI",
  "Analytics Server Health Monitor",
  "Imminent Stampede Alert Bot",
  "Mob Instigator Profiler Engine",
  "VIP Movement Disruption Classifier",
  "AI Assisted Tactical Plan Drafter",
  "Video Stream Storage Forecaster",
  "Secure Informant Link Protector",
  "Integration with Metro/Railways",
  "Citizen Safety Alert Broadcasting",
  "Communal Riot Escalation Modeler",
  "Disaster Evacuation Crowd Coordinator",
  "Crowd Management Expense Tracker",
  "Custom Workflow for Tear Gas/Lathi Charge",
  "AI Driven Escalation Predictor",
  "Predictive Need for Medical Camps",
  "Custom Alert Trigger for Riot Police",
  "Crowd Dispersal Timeline Tracker"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CROWD MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CROWD <span>MANAGEMENT</span></h1>
...
export default CrowdManagementDetailed;
