...
import { 
  ...
  CheckCircle, ShieldAlert, PieChart, Vote, Navigation, Users
} from 'lucide-react';
...
const ElectionManagementDetailed = () => {
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            ...
            <p className="cyber-subtitle">Force Allocation, EVM Transport & Polling Security</p>
          </div>
        </div>
      </header>
...
export default ElectionManagementDetailed;
