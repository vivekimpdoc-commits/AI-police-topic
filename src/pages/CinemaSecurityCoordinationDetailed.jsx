...
const aiExperts = [
  "Multiplex Fire Safety/Exit Auditor AI",
  "Controversial Film/Release Threat Assessor",
  "Crowd Management/Queue Routing Modeler",
  "Midnight/Late Show Compliance Tracker",
  "Ticketing/Black-Marketing Fraud Detector",
  "Parking/Traffic Congestion Analyzer",
  "Geo-Spatial Cinema Hall Vulnerability Mapper",
  "Automated Show-time/Beat Patrol Scheduler",
  "Cinema Security Dashboard",
  "Voice-Command Hall Query Bot",
  "Automated Weekly Multiplex Safety Report",
  "Fire Department/Entertainment Tax Sync",
  "Protest/Vandalism Risk Predictor (for Controversial Films)",
  "Blocked Emergency Exit Alert",
  "Overcrowding/Stampede Flagging AI",
  "Public Nuisance/Brawl Estimator",
  "AI Evaluator for Cinema Safety Index",
  "Audit/Inspection Log Generator",
  "Data Privacy/Viewer/CCTV Scrubber",
  "Local Intelligence Unit (LIU) Sync",
  "Beat Constable/Fire Inspector Mobile App",
  "Historical Cinema Protest/Clash Correlator",
  "Entertainment Tax Officer/SP Briefing Interface",
  "Surprise Check/Night Patrol Task Allocator",
  "Blockchain Immutable Safety Audit Hash",
  "Anti-Tamper NOC/Clearance Shield",
  "Mobile App for Quick Fire-Exit Video Upload",
  "Multiplex-wise Security Compliance Benchmarker",
  "Automated Alert for Flash Protests/Mob Gathering",
  "Historical Law & Order Deployment Cost Analyzer",
  "Multiplex Regulation/Safety SOP Trainer",
  "Entertainment/Ticketing Portal API Monitor",
  "Imminent Riot/Vandalism Emergency Alert",
  "Habitual Defaulter (Cinema Owner) Profiler",
  "High-Sensitivity (Political/Religious Movie) Classifier",
  "AI Assisted Show-Cancellation/Notice Drafter",
  "Blockbuster Weekend Crowd Forecaster",
  "Secure Intelligence/Threat Input Protector",
  "Integration with Safe City/CCTV Network",
  "Traffic Police Sync (for Mall Intersections)",
  "Election (Propaganda Film) Code of Conduct Modeler",
  "Disaster (Fire in Mall) Evacuation Coordinator",
  "Multiplex Safety Drill Budget Tracker",
  "Custom Workflow for Film Festivals/Premiere Shows",
  "AI Driven Vandalism/Protest Probability Predictor",
  "Predictive Need for Riot Gear/QRT Deployment",
  "Custom Alert Trigger for SP City/DM",
  "Routine Audit Expiry to Renewal Timeline"
];
...
const CinemaSecurityCoordinationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CINEMA SECURITY COORDINATION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CINEMA SECURITY <span>COORDINATION</span></h1>
...
export default CinemaSecurityCoordinationDetailed;
