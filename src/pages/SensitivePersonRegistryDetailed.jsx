...
const aiExperts = [
  "Extremist/Agitator Threat Scorer AI",
  "Hate-Speech/Social Media NLP Monitor",
  "Movement/Travel Geo-Fence Alert Engine",
  "Financial/Hawala Transaction Linker",
  "Associates/Syndicate Network Mapper",
  "Bail/Parole Violation Detector",
  "Geo-Spatial Sensitive Person Heatmapper",
  "Radicalization Trajectory Analyzer",
  "Sensitive Person Intelligence Dashboard",
  "Voice-Command Dossier Query Bot",
  "Automated Weekly Threat Assessment Report",
  "State CID/Intelligence Sync",
  "Absconding/Underground Risk Predictor",
  "Imminent Protest/Riot Instigation Alert",
  "Weapon Procurement/Smuggling Predictor",
  "Inter-State Movement/Coordination Analyzer",
  "AI Evaluator for Individual Threat Index",
  "Audit/Surveillance Log Generator",
  "Data Privacy/Classified Dossier Scrubber",
  "Special Task Force (STF) Sync",
  "Field Intelligence Officer Mobile App",
  "Historical Modus Operandi Correlator",
  "IG (Law & Order) Briefing AI",
  "Surveillance/Shadowing Task Allocator",
  "Blockchain Immutable Dossier Hash",
  "Anti-Tamper Surveillance Log Shield",
  "Mobile App for Beat Constable Sighting",
  "District-wise Agitator Density Benchmarker",
  "Automated Alert for Red-Corner/Lookout Notice Match",
  "Historical Protest/Damage Cost Analyzer",
  "Surveillance/Tail SOP Trainer",
  "Telecom/CDR (Call Detail Record) API Monitor",
  "Imminent Assassination/Terror Attack Alert",
  "Mastermind/Financier Profiler",
  "High-Priority (Sleeper Cell/Radical) Classifier",
  "AI Assisted Preventive Detention Drafter",
  "Threat Evolution/Radicalization Forecaster",
  "Secure Informant/Surveillance Protector",
  "Integration with National Intelligence Grid (NATGRID)",
  "Immigration/Airport Security Sync",
  "Election Booth-Capturing Suspect Modeler",
  "Disaster Looting/Hoarding Suspect Coordinator",
  "Covert Surveillance/Tech Budget Tracker",
  "Custom Workflow for VIP Threat Suspects",
  "AI Driven Preventive Arrest Predictor",
  "Predictive Need for Inter-Agency Task Force",
  "Custom Alert Trigger for DGP",
  "Sighting/Intelligence to Action Timeline"
];
...
const SensitivePersonRegistryDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SENSITIVE PERSON REGISTRY
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SENSITIVE PERSON <span>REGISTRY</span></h1>
...
export default SensitivePersonRegistryDetailed;
