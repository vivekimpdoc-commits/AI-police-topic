...
const aiExperts = [
  "Semantic Enterprise Search/Query AI",
  "Data Silo-Busting/Integration Engine",
  "Institutional History Timeline Generator",
  "Entity/Relationship Knowledge Graph AI",
  "Unstructured Data (PDF/Image) OCR & NLP",
  "Cross-Departmental Data Correlation AI",
  "Geo-Spatial Institutional Asset Mapper",
  "Expertise/Subject Matter Expert Finder Bot",
  "Organizational Memory Dashboard",
  "Voice-Command Enterprise Search Bot",
  "Automated Monthly Data Integration Report",
  "State Data Center/IT Department Sync",
  "Institutional Amnesia/Knowledge Loss Predictor",
  "Data Hoarding/Silo Identification Alert",
  "Redundant/Duplicative Effort Analyzer",
  "Search Relevancy/Accuracy Scorer",
  "AI Evaluator for Knowledge Liquidity Index",
  "Audit/Search Query Log Generator",
  "Data Privacy/Role-Based Access Control Scrubber",
  "All State Police Directorates Sync",
  "Investigating/Planning Officer Mobile App",
  "Historical Inefficiency/Duplication Correlator",
  "DGP/Chief Information Officer Briefing AI",
  "Data Digitization/Indexing Task Allocator",
  "Blockchain Immutable Data Provenance Hash",
  "Anti-Tamper Enterprise Data Shield",
  "Mobile App for On-the-Go Record Retrieval",
  "Department-wise Knowledge Sharing Benchmarker",
  "Automated Alert for Severed Knowledge Links",
  "Historical Data Silo/Inefficiency Cost Analyzer",
  "Data Management/Digital Archiving SOP Trainer",
  "Enterprise Search/Graph API Health Monitor",
  "Imminent Crucial Data Loss (Legacy System) Alert",
  "Information Silo/Gatekeeper Profiler",
  "Mission-Critical (Crime/Intelligence) Data Classifier",
  "AI Assisted Comprehensive Background/History Drafter",
  "Data Growth/Storage Forecaster",
  "Secure Enterprise Knowledge Graph Protector",
  "Integration with Inter-operable Criminal Justice System (ICJS)",
  "National Crime Records Bureau (NCRB) Sync",
  "Election Historical Trend/Vulnerability Knowledge Modeler",
  "Disaster Historical Response Capability Coordinator",
  "IT Infrastructure/Cloud Storage Budget Tracker",
  "Custom Workflow for Declassified/Historical Records",
  "AI Driven Search Relevancy Predictor",
  "Predictive Need for Legacy System Migration",
  "Custom Alert Trigger for DGP (Modernization)",
  "Data Ingestion to Searchable Knowledge Graph Timeline"
];
...
const OrganizationalMemoryPlatformDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ORGANIZATIONAL MEMORY PLATFORM
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ORGANIZATIONAL MEMORY <span>PLATFORM</span></h1>
...
export default OrganizationalMemoryPlatformDetailed;
