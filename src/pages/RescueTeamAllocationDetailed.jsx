...
const aiExperts = [
"Specialized Team (Diver/Mountaineer) Matcher",
  "Terrain/Topography Difficulty Analyzer AI",
  "Rescue Personnel Fatigue/Heart-Rate Monitor",
  "GPS/Off-Road Route Optimizer for Teams",
  "Helicopter/Airlift Drop-Zone Evaluator",
  "Flood/Boat Rescue Grid Allocation AI",
  "Earthquake/Rubble K9 Sniffer Dog Router",
  "Chemical/HazMat Suit Team Deployment AI",
  "Command Center Rescue Ops Dashboard",
  "Voice-Command Rescue Status Query Bot",
  "Automated Shift Rotation/Relief Gen",
  "Inter-Agency (NDRF/Army/SDRF) Sync Bot",
  "Weather/Visibility Sync for Safe Rescue",
  "Equipment (Cutter/Rope) vs Task Matcher",
  "Medical/Paramedic Embed Allocator AI",
  "Avalanche/Snow Rescue Team Predictor",
  "AI Evaluator for Rescue Mission Success Probability",
  "Action/Incident Log Auto-Generator",
  "Data Privacy/Rescuer Bio-metric Masker",
  "Police-Civil Defence Joint Ops Linker",
  "Night-Vision/Thermal Gear Allocator AI",
  "Rescue Team Supply Burn-Rate Predictor",
  "Senior Officer (Rescue Cmdr) Briefing Bot",
  "Media/Press Rescue Update Drafter AI",
  "Blockchain Immutable Log of Rescue Orders",
  "Drone Aerial Overwatch Sync for Teams",
  "Mobile App for Offline Map Sync AI",
  "High-Altitude Acclimatization Monitor Bot",
  "Multi-Lingual Interpreter for Rescue Teams",
  "Historical Rescue Strategy Precedent Matcher",
  "Mass Fatality/Body Recovery Team Router",
  "Diver/Scuba Tank Air Depletion Modeler",
  "Temporary Base-Camp Setup Router AI",
  "Traffic Green-Corridor for Rescue Convoys",
  "Tsunami/Coastal Swift-Water Team Allocator",
  "Armed Insurgency/Naxal Zone Escort Modeler",
  "AI Assisted Post-Rescue Debriefing Gen",
  "Equipment Breakdown/Repair Urgent Alert",
  "VIP/Priority Evacuee Rescue Team Router",
  "Integration with NDMA/SDMA Dashboards",
  "Citizen SOS to Nearest Team Router AI",
  "Extreme Temp (Heat/Cold) Safety Modeler",
  "Demobilization/RTB (Return to Base) AI",
  "Rescue Mission Expense/Fuel Tracker",
  "Custom Workflow/Approval for Air Support",
  "AI Driven Reinforcement Predictor",
...
const RescueTeamAllocationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI RESCUE TEAM ALLOCATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI RESCUE TEAM ALLOCATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in deploying specialized teams based on terrain, fatigue monitoring & gps routing.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI RESCUE TEAM <span>ALLOCATION</span></h1>
            <p className="cyber-subtitle">Deploying Specialized Teams based on Terrain, Fatigue Monitoring & GPS Routing</p>
          </div>
        </div>
      </header>
...
export default RescueTeamAllocationDetailed;
