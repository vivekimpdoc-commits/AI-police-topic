...
const aiExperts = [
"Real-Time Public Trust Index (PTI) Scorer",
  "Social Media Sentiment/Emotion Analyzer",
  "Jansunwai (Grievance) Satisfaction Correlator",
  "News/Media Coverage Tone Assessor AI",
  "Police Brutality/Misconduct Outrage Predictor",
  "Automated Citizen Feedback SMS Surveyor",
  "Police Station Visit Experience Scorer AI",
  "Traffic E-Challan Public Frustration Modeler",
  "Emergency 112 Response Trust Metric AI",
  "Minority/Marginalized Trust Gap Analyzer",
  "Women/Child Safety Perception Scorer Bot",
  "Cyber Fraud Victim Satisfaction Index AI",
  "Officer Commendation Public Impact Rater",
  "Corruption/Bribery Whisper Flag AI",
  "Community Outreach Event ROI Analyzer",
  "Police-Mitra/Volunteer Trust Multiplier Bot",
  "Historical Trust Trend (MoM/YoY) Correlator",
  "Election-Time Police Neutrality Perception AI",
  "Riot/Mob Control Public Approval Scorer",
  "Fake News/Rumor Impact on Trust Modeler",
  "Multi-Lingual Sentiment Extraction Bot",
  "Voice-Emotion Analysis of Helpdesk Calls",
  "Command Center Public Trust Dashboard",
  "Predictive Trust Deficit Warning AI",
  "AI Generated Trust Building Strategy Drafter",
  "Cross-District Trust Index Ranker Bot",
  "Senior Officer (SP/SSP) Popularity Scorer",
  "Police PR/Newsletter Effectiveness Rater",
  "Informant/Tip-Off Volume vs Trust AI",
  "NGO/Civil Society Partnership Trust Link",
  "RWA/Gated Community Satisfaction Index",
  "Rural/Gram Chaupal Trust Penetration AI",
  "Police Welfare/Health Camp PR Scorer",
  "Court Acquittal/Conviction Public Reaction AI",
  "VIP Security Disruption Frustration Scorer",
  "Disaster/Rescue Heroics Sentiment Booster AI",
  "Keyword/Slang Cloud Generator for Trust",
  "Automated Apology/Clarification Drafter Bot",
  "Public Trust Blockchain Audit Trail",
  "AI Protocol for Reputation Damage Control",
  "Beat Constable Local Popularity Rater AI",
  "Youth/Student Police Perception Modeler",
  "Festival/Event Security Public Approval Bot",
  "Tourist/Foreigner Safety Perception Index",
  "Social Media Influencer Police Support Rater",
  "Public Alert/Broadcast Believability Scorer",
  "Data Privacy/Surveillance Fear Modeler AI",
  "Inter-Agency Trust Comparison Index Bot",
  "Police Infrastructure/Cleanliness PR Impact",
  "RTI/Transparency Satisfaction Scorer AI",
  "Custodial Death/Injury Trust Crash Alert",
  "AI Strategy for Brand/Image Overhaul",
  "Corporate/Business Community Trust Index",
  "Police Action Movie/Pop-Culture Sentiment AI",
  "AI Driven Focus Group Survey Planner",
  "Actionable Insight Extractor from Complaints",
  "Public Trust vs Crime Rate Correlation Modeler",
  "AI Evaluator for Community Policing Awards",
  "Media Press-Briefing Tone Analyzer Bot",
  "Officer Tone/Empathy Scorer via Body-Cam"
];
...
const PublicTrustIndexDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI PUBLIC TRUST INDEX
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI PUBLIC TRUST INDEX</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in sentiment analysis, public feedback scoring & measuring police-public relationship.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI PUBLIC TRUST <span>INDEX</span></h1>
            <p className="cyber-subtitle">Sentiment Analysis, Public Feedback Scoring & Measuring Police-Public Relationship</p>
          </div>
        </div>
      </header>
...
export default PublicTrustIndexDetailed;
