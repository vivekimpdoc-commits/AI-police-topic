...
const aiExperts = [
  "Smart Meter Consumption Sync Engine",
  "AC/Lighting Idle Wastage Detector",
  "Solar Panel/Inverter Output Tracker",
  "Electricity Bill Audit/Anomaly Finder",
  "Peak Load/Demand Charge Optimizer",
  "Appliance Health/Degradation Scorer",
  "Geo-Spatial District Energy Mapper",
  "Power Cut/Diesel Generator Sync AI",
  "Station Energy Dashboard",
  "Voice-Command Energy Query Bot",
  "Automated Monthly Station Bill Report",
  "State Electricity Board (DISCOM) Sync",
  "Power Theft/Tamper Predictor",
  "Equipment Left On After-Hours Alert",
  "Solar Panel Dust/Cleaning Prompt AI",
  "Energy Efficiency vs Sanctioned Load Analyzer",
  "AI Evaluator for Station Green Index",
  "Audit/Billing Log Generator",
  "Data Privacy/Station Roster Scrubber",
  "Finance/Accounts Department Sync",
  "SHO/Station Manager Mobile App",
  "Historical Summer Peak Load Correlator",
  "SP (Headquarters) Briefing AI",
  "Electrician Task Allocator",
  "Blockchain Immutable Meter Hash",
  "Anti-Tamper Smart Meter Shield",
  "Mobile App for Outage Reporting",
  "Station-wise Energy Efficiency Benchmarker",
  "Automated Alert for Budget/Load Exceedance",
  "Historical DISCOM Tariff Analyzer",
  "Energy Conservation SOP Trainer",
  "Smart Meter/Solar Inverter Gateway Monitor",
  "Imminent Short Circuit/Overload Alert",
  "Habitual Energy Wasting Station Profiler",
  "High-Load (Server Room/AC) Classifier",
  "AI Assisted Bill Dispute Drafter",
  "Energy Consumption Data Forecaster",
  "Secure Station Network Protector",
  "Integration with Renewable Energy Nodal Agency",
  "Smart City Grid Sync",
  "Election Control Room 24x7 Load Modeler",
  "Disaster Power Resilience/Backup Coordinator",
  "Station Electricity Budget Tracker",
  "Custom Workflow for Solar Upgrade Approval",
  "AI Driven Monthly Bill Predictor",
  "Predictive Need for Wiring Upgrades",
  "Custom Alert Trigger for SP Admin",
  "Wastage Detection to Mitigation Timeline"
];
...
const PoliceStationEnergyMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI POLICE STATION ENERGY MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI POLICE STATION ENERGY <span>MONITORING</span></h1>
...
export default PoliceStationEnergyMonitoringDetailed;
