...
const aiExperts = [
  "Factional/Caste Feud NLP & Sentiment Tracker",
  "Illicit Liquor/Arms Manufacturing Geo-Predictor",
  "Land Dispute Escalation/Violence Scorer",
  "Rural Intelligence (Chowkidar) Network Analyzer",
  "Agrarian/Crop-Failure Distress Modeler",
  "Absconder/History-Sheeter Density Heatmapper",
  "Geo-Spatial Village Vulnerability Mapper",
  "Panchayat/Local Election Rivalry Tracker",
  "High-Risk Village Intelligence Dashboard",
  "Voice-Command Village Query Bot",
  "Automated Monthly Rural Threat Report",
  "State Revenue/Land Record Department Sync",
  "Imminent Mass Clash/Riot Predictor",
  "Honor Killing/Khap Panchayat Alert AI",
  "Illegal Sand/Coal Mining Syndicate Linker",
  "Beat Constable Visit/Negligence Detector",
  "AI Evaluator for Village Peace Index",
  "Audit/Rural Intel Log Generator",
  "Data Privacy/Informant Identity Scrubber",
  "Local Intelligence Unit (LIU) Sync",
  "SHO/Circle Officer Rural App",
  "Historical Caste-Violence Correlator",
  "SP (Rural) Briefing AI",
  "Preventive Action/Patrol Task Allocator",
  "Blockchain Immutable Land/Dispute Intel Hash",
  "Anti-Tamper Beat Diary Shield",
  "Mobile App for Village Chowkidar Reporting",
  "Tehsil/Block-wise Village Risk Benchmarker",
  "Automated Alert for Armed Mob Mobilization",
  "Historical Riot Control/Deployment Cost Analyzer",
  "Rural Policing/Community Outreach SOP Trainer",
  "Drone/Satellite Imagery (Mining/Liquor) API Monitor",
  "Imminent Caste/Communal Massacre Alert",
  "Habitual Riot-Instigator/Mafia Profiler",
  "High-Priority (Dacoit/Naxal-affected) Village Classifier",
  "AI Assisted Preventive Arrest (CrPC 107/116) Drafter",
  "Rural Crime/Distress Trend Forecaster",
  "Secure Informant/Chowkidar Network Protector",
  "Integration with Agrarian/Weather Distress Portals",
  "Panchayati Raj/Rural Development Sync",
  "Election Booth-Capturing/Violence Modeler",
  "Disaster (Flood/Drought) Relief Mismanagement Coordinator",
  "Rural Informant/Patrol Fuel Budget Tracker",
  "Custom Workflow for Cross-Border Smuggling Villages",
  "AI Driven Peace-Committee Efficacy Predictor",
  "Predictive Need for Armed Picket Deployment",
  "Custom Alert Trigger for Range DIG",
  "Intel Receipt to Preventive Raid Timeline"
];
...
const HighRiskVillageMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI HIGH-RISK VILLAGE MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI HIGH-RISK VILLAGE <span>MONITORING</span></h1>
...
export default HighRiskVillageMonitoringDetailed;
