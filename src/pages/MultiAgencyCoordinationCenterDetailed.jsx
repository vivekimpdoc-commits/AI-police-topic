...
const aiExperts = [
  "Unified Common Operational Picture (COP) AI",
  "Inter-Agency Intel Deduplication/Fusion Engine",
  "Joint Task Force (JTF) Milestone Tracker",
  "Secure Data Silo/Access Control Bot",
  "Threat Level/Alert Synchronization AI",
  "Resource/Asset De-confliction Analyzer",
  "Geo-Spatial Joint Operation Mapper",
  "Customs/Financial Intel (FIU) Cross-Linker",
  "Multi-Agency Coordination Dashboard",
  "Voice-Command Joint Ops Query Bot",
  "Automated Weekly Intelligence Fusion Report",
  "Central Intelligence (IB/RAW/NIA) Sync",
  "Friendly-Fire/Operation Clash Predictor",
  "Intelligence Hoarding/Silo Alert",
  "Communication Breakdown/Latency Analyzer",
  "Suspect Alias/Identity Resolution Engine",
  "AI Evaluator for Inter-Agency Synergy Index",
  "Audit/Intel-Sharing Log Generator",
  "Data Privacy/Need-to-Know Scrubber",
  "Enforcement Directorate (ED)/Income Tax Sync",
  "Nodal Liaison Officer Secure App",
  "Historical Inter-Agency Success Correlator",
  "Multi-Agency Center (MAC) Director Briefing AI",
  "Joint Surveillance/Raid Task Allocator",
  "Blockchain Immutable Intel Fusion Hash",
  "Anti-Tamper Classified Ops Shield",
  "Mobile App for Secure Field Liaison",
  "Agency-wise Intel Contribution Benchmarker",
  "Automated Alert for Conflicting Agency Actions",
  "Historical Joint Task Force Cost Analyzer",
  "Inter-Agency Protocol/SOP Trainer",
  "Multi-Network/Encrypted Comms API Monitor",
  "Imminent National Security Threat Alert",
  "Transnational Syndicate/Terror Profiler",
  "Top-Secret/Classified (Level 4) Intel Classifier",
  "AI Assisted Joint Ops Protocol Drafter",
  "Strategic Threat/Geopolitical Forecaster",
  "Secure Source/Informant Identity Protector",
  "Integration with National Security Council (NSCS)",
  "Coast Guard/Navy (Coastal Security) Sync",
  "Election Multi-Agency (ECI, Police, IT) Modeler",
  "Disaster (CBRN) Multi-Agency Coordinator",
  "Joint Operations/MAC Budget Tracker",
  "Custom Workflow for Hijacking/Hostage Crisis",
  "AI Driven Terror Attack Probability Predictor",
  "Predictive Need for specialized JTF",
  "Custom Alert Trigger for Home Secretary/NSA",
  "Intel Fusion to Joint Action Timeline"
];
...
const MultiAgencyCoordinationCenterDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI MULTI-AGENCY COORDINATION CENTER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI MULTI-AGENCY COORDINATION <span>CENTER</span></h1>
...
export default MultiAgencyCoordinationCenterDetailed;
