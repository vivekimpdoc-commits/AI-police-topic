...
const aiExperts = [
  "Riot Control/Crowd Dispersal Formation AI",
  "VIP/VVIP Security Route & Drill Optimizer",
  "Hostage/Crisis Negotiation Decision-Tree Bot",
  "Active Shooter/Terror Response Tactics Engine",
  "Quick-Reference Mobile UI/UX Optimizer",
  "Geospatial Operational Zone/Chokepoint Mapper",
  "Force Multiplier/Logistics Allocation Analyzer",
  "Weather/Terrain Impact on Operations Predictor",
  "Operational Playbook Dashboard",
  "Voice-Command Tactical Query Bot",
  "Automated Post-Operation After-Action Report (AAR)",
  "State Armed Police/Task Force Sync",
  "Tactical Failure/Vulnerability Predictor",
  "Communication Breakdown/Radio Silence Analyzer",
  "Fatigue/Resource Depletion Estimator",
  "Civilian Casualty/Collateral Damage Risk Scorer",
  "AI Evaluator for Tactical Readiness Index",
  "Audit/Playbook Access Log Generator",
  "Data Privacy/Classified Ops Scrubber",
  "National Security Guard (NSG/Greyhounds) Sync",
  "Field Commander/QRT Tactical App",
  "Historical Tactical Success/Failure Correlator",
  "ADG (Law & Order/Operations) Briefing AI",
  "Mock-Drill/Simulation Task Allocator",
  "Blockchain Immutable Playbook Version Hash",
  "Anti-Tamper Classified Playbook Shield",
  "Mobile App for Offline Tactical Diagrams",
  "Unit-wise Tactical Proficiency Benchmarker",
  "Automated Alert for Obsolete/Flawed Tactics",
  "Historical Operational Deployment Cost Analyzer",
  "Tactical Operations/CQB SOP Trainer",
  "Playbook Cloud Sync/API Monitor",
  "Imminent Tactical Blunder/Ambush Alert",
  "Poorly Trained/Unprepared Unit Profiler",
  "Mission-Critical (Anti-Terror/Hostage) Playbook Classifier",
  "AI Assisted Rules of Engagement (RoE) Drafter",
  "Operational Resource/Ammunition Forecaster",
  "Secure Tactical Blueprint Protector",
  "Integration with Drone/UAV Live Feed Analytics",
  "State/District Control Room Sync",
  "Election Flash-Riot/Booth Capture Playbook Modeler",
  "Disaster Mass-Panic/Stampede Control Coordinator",
  "Tactical Training/Simulation Budget Tracker",
  "Custom Workflow for Aviation/Helicopter Ops",
  "AI Driven Operation Success Probability Predictor",
  "Predictive Need for Specialized Gear",
  "Custom Alert Trigger for DGP (Operations)",
  "Incident Breakout to Playbook Deployment Timeline"
];
...
const OperationalPlaybookManagerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI OPERATIONAL PLAYBOOK MANAGER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI OPERATIONAL PLAYBOOK <span>MANAGER</span></h1>
...
export default OperationalPlaybookManagerDetailed;
