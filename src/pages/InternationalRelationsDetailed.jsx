...
const aiExperts = [
"Intl Training Coordinator", "Exchange Program Bot", "Delegation Manager AI", "UN Standards Tracker", "Bilateral Cooperation AI", "Diplomacy Dashboard Bot", "Conference Manager AI", "Foreign Study Visit AI", "Research Hub Bot", "Global Best Practices AI", "Police Attaché Bot"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> INTERNATIONAL RELATIONS
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>INTERNATIONAL RELATIONS</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in officer exchange, un compliance & delegation management.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">INTERNATIONAL <span>RELATIONS</span></h1>
            <p className="cyber-subtitle">Officer Exchange, UN Compliance & Delegation Management</p>
          </div>
        </div>
      </header>
