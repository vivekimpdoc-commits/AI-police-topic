...
const aiExperts = [
  "Judicial Order/Judgment Parsing NLP",
  "Disposal Protocol (CrPC/BNSS) Validator",
  "Malkhana Decongestion Optimizer AI",
  "Automated Destruction Certificate Generator",
  "Hazardous/Bio-Waste Disposal Tracker",
  "Cross-Reference with Appeal/Higher Court Status",
  "Geo-Spatial Malkhana Capacity Mapper",
  "Pending Disposal Priority Scorer",
  "Property Disposal Dashboard",
  "Voice-Command Disposal Query Bot",
  "Automated Monthly Malkhana Decongestion Report",
  "Directorate of Prosecution Sync",
  "Illegal/Premature Disposal Risk Predictor",
  "Court Contempt (Due to Delay) Alert",
  "Environmental Hazard (Chemical/Drug Burn) Analyzer",
  "Missing/Misplaced Property Flagging AI",
  "AI Evaluator for Malkhana Efficiency Index",
  "Audit/Disposal Log Generator",
  "Data Privacy/Victim PII Scrubber",
  "Pollution Control Board Sync",
  "Malkhana Officer/Magistrate Mobile App",
  "Historical Decongestion Success Correlator",
  "District Judge/SP Briefing AI",
  "Destruction/Handover Task Allocator",
  "Blockchain Immutable Disposal/Destruction Hash",
  "Anti-Tamper Judicial Order Shield",
  "Mobile App for Video-Recording Destruction",
  "Station-wise Disposal Rate Benchmarker",
  "Automated Alert for Overdue Disposals (Post-Judgment)",
  "Historical Storage/Maintenance Cost Analyzer",
  "Property Destruction/Handover SOP Trainer",
  "E-Courts API Health Monitor",
  "Imminent Malkhana Collapse (Due to Overcrowding) Alert",
  "Negligent Malkhana In-charge Profiler",
  "High-Security (Arms/Explosives) Property Classifier",
  "AI Assisted Compliance Report Drafter",
  "Malkhana Space Recovery Forecaster",
  "Secure Video/Photographic Evidence Protector",
  "Integration with Inter-operable Criminal Justice System (ICJS)",
  "State Crime Records Bureau (SCRB) Sync",
  "Election Seizure (Liquor/Arms) Mass Disposal Modeler",
  "Disaster Bio-Hazard Evidence Disposal Coordinator",
  "Disposal/Incinerator Vendor Budget Tracker",
  "Custom Workflow for Counterfeit Currency Destruction",
  "AI Driven Next Congestion Crisis Date Predictor",
  "Predictive Need for Specialized Disposal Units",
  "Custom Alert Trigger for High Court Registrar",
  "Judgment Date to Actual Disposal Timeline"
];
...
const CourtPropertyDisposalMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI COURT PROPERTY DISPOSAL MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI COURT PROPERTY DISPOSAL <span>MONITORING</span></h1>
...
export default CourtPropertyDisposalMonitoringDetailed;
