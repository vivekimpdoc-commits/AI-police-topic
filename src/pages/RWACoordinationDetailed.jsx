...
const aiExperts = [
"RWA Office-Bearer Database Auto-Updater",
  "Domestic Help/Maid Verification Router AI",
  "Tenant Verification Status Tracker Bot",
  "Gated Community Private Guard Sync AI",
  "Urban Neighborhood Watch Patrol Planner",
  "RWA Incident/Grievance Live Sync AI",
  "CCTV Integration from RWA to Police Hub",
  "Visitor Management System (VMS) Link Bot",
  "Delivery Agent/Courier Verification AI",
  "Senior Citizen Living Alone Monitor Bot",
  "RWA WhatsApp Group Official Broadcast Link",
  "Suspicious Vehicle/Parking Alert AI",
  "Stray Dog/Animal Menace Tracker Bot",
  "Noise Pollution/Late Party Complaint Router",
  "RWA Meeting/Interaction Calendar Sync AI",
  "Urban Slum vs Gated Comm Border Patrol",
  "Cyber Fraud Awareness Drive for RWA AI",
  "Women/Child Safety Audit in Societies",
  "Fire Safety/Evacuation Drill Scheduler AI",
  "RWA Fund Fraud/Embezzlement Alert Bot",
  "Automated FIR/Complaint from RWA Portal",
  "RWA Dispute/Internal Faction Early Warning",
  "RWA Performance & Cooperation Rater AI",
  "Emergency 112 Route Optimizer for Societies",
  "Private Guard Arms License Verification AI",
  "Police Verification Certificate Auto-Gen",
  "RWA Mass Alert/Panic Button Broadcaster",
  "Multi-Lingual RWA Communication Bot",
  "Burglary/Theft Pattern Analyzer in RWAs",
  "Car Theft/Vandalism Hotspot Predictor AI",
  "Domestic Violence Whisper Flag from RWA",
  "RWA Security Audit & Gap Analyzer AI",
  "Society Lift/Infrastructure Failure Alert",
  "RWA Green/Clean Initiative Police Sync",
  "Disaster/Earthquake Society Resilience Rater",
  "RWA Election Dispute Violence Predictor",
  "Historical RWA Crime Trend Correlator",
  "AI Generated Security Guideline Drafter",
  "RWA Officer Handover Briefing Sync Bot",
  "Urban Beat Constable Duty Allocation AI",
  "Public Trust Index (Urban) Scorer AI",
  "VIP Resident Security Protocol Sync Bot",
  "RWA Event/Festival NOC Automation AI",
  "Voice-Command RWA Query Assistant",
  "RWA/Police Joint Night Patrol Scheduler",
  "Missing Child Quick Relay to Society Guards",
  "Rogue/Fake Tenant Document Flag AI",
  "Corporate/PG Accommodation Monitor Bot",
  "RWA Dispute Resolution/Mediation Tracker",
  "AI Feedback Survey for RWA Residents",
  "Water/Parking Dispute Escalation Modeler",
  "Inter-RWA Coordination for Mega Events AI",
  "Blockchain Immutable Log for Verification",
  "Command Center RWA Dashboard Sync",
  "RWA Emergency Response Time Scorer",
  "Society Ambulance/Medical Evac Route AI",
  "RWA Cybersecurity & Phishing Alert Bot",
  "RWA Volunteer (Police Mitra) Mobilizer",
  "AI Strategy for High-Rise Building Security",
  "Urban Traffic Congestion around RWAs AI"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI RWA COORDINATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI RWA COORDINATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in urban neighborhood watch, domestic help verification & gated community security.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI RWA <span>COORDINATION</span></h1>
            <p className="cyber-subtitle">Urban Neighborhood Watch, Domestic Help Verification & Gated Community Security</p>
          </div>
        </div>
      </header>
...
export default RWACoordinationDetailed;
