...
const aiExperts = [
"Complaint Volume & Trend Predictor AI",
  "Geographical Crime Hotspot Mapper",
  "Resolution SLA (Service Level) Tracker Bot",
  "Officer/PS Performance & Clearance Scorer",
  "MoM/YoY Crime Categorization Analytics",
  "Cyber Fraud Peak-Hour Analyzer AI",
  "Women/Child Abuse Seasonal Trend Modeler",
  "Traffic/Accident Geolocation Cluster AI",
  "Pending/Overdue Complaint Backlog AI",
  "Automated Daily/Weekly Digest Generator",
  "Sentiment & Public Outrage Trend AI",
  "Fake/Malicious Complaint Volume Tracker",
  "Interstate/Cross-Border Crime Correlator",
  "Financial Scam Modus Operandi (MO) Modeler",
  "Burglary/Theft Heatmap & Prediction Bot",
  "Narcotics/Drug Seizure Correlation AI",
  "Response Time (112 vs FIR) Analytics",
  "Conviction vs Complaint Ratio Modeler",
  "Jansunwai (Grievance) Satisfaction Scorer",
  "Social Media Complaint Virality Tracker",
  "VIP/High-Profile Case Status Analytics",
  "Election-time Violence/Violation Modeler",
  "Festival/Event Impact on Complaint Volume",
  "Weather/Seasonality Impact on Crime AI",
  "Predictive Deployment Recommender AI",
  "Resource & Budget Allocation Optimizer",
  "CCTNS Data Entry Compliance Analytics",
  "Court Case Pendency Correlator AI",
  "Officer Workload vs Burnout Analytics",
  "Command Center Real-time Dashboard Sync",
  "Interactive Data Visualization/Graph Gen",
  "Voice-Command Analytics Query Assistant",
  "Multi-Lingual Complaint Topic Extractor",
  "Public Trust Index vs Crime Rate AI",
  "NGO/Civil Society Intervention ROI Scorer",
  "RWA/Gated Community Crime Analytics",
  "Rural/Gram Chaupal Complaint Modeler",
  "Missing Person Recovery Rate Analytics",
  "Stolen Vehicle/Property Recovery Scorer",
  "Cyber Attack/Breach Attempt on Portal",
  "AI Generated Heatmap Video/Animation",
  "Blockchain Audit Trail of Analytics Data",
  "Senior Officer (DGP/SP) Executive Summary",
  "Media/Press Release Analytics Drafter",
  "Inter-Agency (Health/Civic) Overlap AI",
  "Legal Loophole/Acquittal Reason Analyzer",
  "Bail/Parole Repeat Offender Analytics",
  "Extortion/Organized Crime Network Linker",
  "Juvenile Crime Trend/Age Demographic AI",
  "Suicide/Mental Health Crisis Analytics",
  "Hate Speech/Communal Tension Modeler",
  "Traffic E-Challan vs Accident Rate AI",
  "Environmental/Wildlife Crime Analytics",
  "Industrial/Labor Dispute Trend Modeler",
  "Automated Anomaly/Spike Alert Bot",
  "Post-Incident Mitigation ROI Scorer",
  "AI Evaluator for Station of the Month",
  "Predictive Victim Demographic Risk AI",
  "Suspect/Alias Link Analysis Modeler",
  "Data Privacy & Anonymization Engine AI"
];
...
const ComplaintAnalyticsDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI COMPLAINT ANALYTICS
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI COMPLAINT ANALYTICS</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in analyzing crime trends, geographical hotspots & resolution sla tracking.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI COMPLAINT <span>ANALYTICS</span></h1>
            <p className="cyber-subtitle">Analyzing Crime Trends, Geographical Hotspots & Resolution SLA Tracking</p>
          </div>
        </div>
      </header>
...
export default ComplaintAnalyticsDetailed;
