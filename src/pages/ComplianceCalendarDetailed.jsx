...
const aiExperts = [
"Court Summons/Warrant Expiry Alert AI",
  "Station Audit/Inspection Deadline Tracker",
  "Police Vehicle Fitness/Insurance Renewal Bot",
  "Weapon/Armory Cleaning & Audit Scheduler",
  "Charge-sheet Filing Deadline (60/90 Days) AI",
  "Bail/Parole Expiry Monitoring Engine",
  "RTI (Right to Information) Reply Deadline Bot",
  "Annual Property/Malkhana Disposal Audit",
  "Command Center Compliance Calendar Dashboard",
  "Voice-Command Deadline Query Assistant",
  "Automated SMS/Email Reminder Generator",
  "Inter-Station Compliance Ranking Engine",
  "Pension/Retirement Paperwork Deadline AI",
  "AMC (Annual Maintenance) Renewal Alert",
  "Software/Antivirus License Expiry Tracker",
  "Staff Medical/Fitness Checkup Scheduler",
  "AI Evaluator for Compliance Success Rate",
  "Audit/Penalty Log for Missed Deadlines",
  "Data Privacy/Confidential Deadline Masker",
  "Police-Prosecution Joint Calendar Sync",
  "Human Rights Commission Reply Deadline AI",
  "Station Building Lease/Rent Renewal Bot",
  "Senior Officer (SP/DIG) Compliance Briefing",
  "Public Grievance Redressal SLA Tracker",
  "Blockchain Immutable Log of Completed Tasks",
  "Evidence Submission to FSL Deadline AI",
  "Mobile App for IO Deadline Sync",
  "Gun License/Explosive License Renewal Alert",
  "Multi-Lingual Calendar Alert Bot",
  "Historical Deadline Miss Precedent Matcher",
  "Departmental Enquiry (DE) Timeline Tracker",
  "Staff Leave/Deputation Expiry Monitor",
  "Temporary Naka/Post License Expiry Sync",
  "Traffic Camera/Radar Calibration Deadline",
  "Accident Compensation Report Deadline",
  "Post-Mortem/Viscera Report Follow-up AI",
  "AI Assisted Post-Deadline Extension Drafter",
  "Critical Infrastructure Audit Deadline Alert",
  "VIP Security Clearance Renewal Tracker",
  "Integration with State Govt Calendar/Holiday",
  "Citizen Passport Verification SLA Monitor",
  "Foreigner Visa Expiry Alert Tracker",
  "Election Duty Force Deployment Timeline AI",
  "Compliance Budget/Fine Avoidance Tracker",
  "Custom Workflow/Approval for Extension",
  "AI Driven Overdue Penalty Predictor",
  "Predictive Need for Additional Manpower",
  "Custom Alert Trigger for Head Clerk"
];
...
const ComplianceCalendarDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI COMPLIANCE CALENDAR
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI COMPLIANCE CALENDAR</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in tracking due dates for summons, audits, renewals & inspections.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI COMPLIANCE <span>CALENDAR</span></h1>
            <p className="cyber-subtitle">Tracking Due Dates for Summons, Audits, Renewals & Inspections</p>
          </div>
        </div>
      </header>
...
export default ComplianceCalendarDetailed;
