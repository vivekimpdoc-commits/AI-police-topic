...
const aiExperts = [
  "Patrol Vehicle On-Board AI Processor",
  "Bodycam Real-time Face Recognition Edge AI",
  "Checkpost ANPR Edge Processing Unit",
  "CCTV Camera Edge Analytics Engine",
  "Drone On-Board Object Detection Chip",
  "Mobile Phone Offline AI Model Loader",
  "IoT Sensor Edge Data Aggregator Bot",
  "Gunshot Detection Edge Audio Processor",
  "Edge Computing Command Dashboard",
  "Voice-Command Edge Status Query Bot",
  "Automated Model Update/OTA Push Engine",
  "Cross-Device Edge Model Sync Manager",
  "NVIDIA Jetson/Coral TPU Fleet Manager",
  "Edge AI Inference Latency Optimizer",
  "Encrypted Edge-to-Cloud Data Sync AI",
  "Forensic Scanner Edge Processing Unit",
  "AI Evaluator for Edge Model Accuracy",
  "Audit/Edge Device Health Log Generator",
  "Data Privacy/On-Device Data Deletion AI",
  "Police-Vendor Edge Hardware Procurement Sync",
  "Cyber Crime Lab Edge Malware Scanner",
  "Financial Crime POS Terminal Edge AI",
  "Senior Officer (Tech SP) Briefing Bot",
  "Public Kiosk Edge AI Face Verification",
  "Blockchain Edge Node Lightweight Client",
  "Edge Device Tamper/Physical Security AI",
  "Mobile App for Edge Device Remote Config",
  "Satellite Uplink Edge Failover AI",
  "Multi-Lingual Edge AI Voice Translator",
  "Historical Edge Performance Analytics",
  "Staff Edge Device Training Simulator",
  "Edge Hardware Lifecycle/Warranty Tracker",
  "Temporary Naka Edge Kit Deployment AI",
  "Traffic Signal Edge AI Controller",
  "Accident Detection Edge Dashcam AI",
  "Biometric Attendance Edge Terminal Bot",
  "AI Assisted Post-Deployment Edge Audit",
  "Battery/Power Management Optimizer AI",
  "VIP Escort Vehicle Edge AI Suite",
  "Integration with State Data Center/NIC",
  "Citizen Complaint Kiosk Edge AI Bot",
  "Extreme Temperature Edge Device Cooler AI",
  "Disaster Recovery Edge Data Backup Sync",
  "Edge Infrastructure Budget Tracker AI",
  "Custom Workflow/Approval for Firmware Update",
  "AI Driven Edge Device Failure Predictor",
  "Predictive Need for Hardware Upgrade",
  "Custom Alert Trigger for IT Admin"
];
...
const EdgeComputingPlatformDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI EDGE COMPUTING PLATFORM
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI EDGE COMPUTING PLATFORM</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in running ai models locally on patrol vehicles, bodycams & checkpost devices.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI EDGE COMPUTING <span>PLATFORM</span></h1>
            <p className="cyber-subtitle">Running AI Models Locally on Patrol Vehicles, Bodycams & Checkpost Devices</p>
          </div>
        </div>
      </header>
...
export default EdgeComputingPlatformDetailed;
