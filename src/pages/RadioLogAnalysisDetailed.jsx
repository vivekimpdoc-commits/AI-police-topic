...
const aiExperts = [
"Real-Time Radio Voice-to-Text AI",
  "Slang/Code-Word Decoder Bot",
  "High-Stress/Panic Voice Emotion Scorer",
  "Gunshot/Explosion Acoustic Flag AI",
  "Officer Distress Whisper Amplifier",
  "Automated Radio Protocol Breach Detector",
  "Profanity/Unprofessional Chatter Flag",
  "Cross-Talk/Over-Talk Interference AI",
  "Keyword Trigger Alert (e.g. 'Officer Down')",
  "Multi-Lingual Radio Translation Bot",
  "Radio Silence/No-Response Alert AI",
  "Fake/Spoofed Radio Transmission Detector",
  "Automated Incident Timeline Reconstructor",
  "Call-Sign/ID Mismatch Flag AI",
  "Radio Chatter Sentiment/Morale Modeler",
  "VIP Movement Mention Tracker AI",
  "Election/Riot Keyword Frequency Analyzer",
  "Hostage/Extortion Audio Snippet Extractor",
  "Background Noise Context AI (Sirens/Screams)",
  "Drunk/Impaired Officer Voice Flag AI",
  "Automated Shift Handover Log Generator",
  "Radio Log to FIR Auto-Drafting Bot",
  "Court-Admissible Audio Hash Logger",
  "Inter-Departmental Chatter Sync AI",
  "Radio Channel Occupancy/Talk-Time Scorer",
  "Automated Dispatch Response Time AI",
  "Officer Interruption/Override Modeler",
  "Radio Etiquette & Training Scorer AI",
  "Classified/Secret Information Leak Alert",
  "Suspect Name/Vehicle Number Matcher",
  "Stolen Handset Unauthorized Chatter Flag",
  "Audio Log Search & Retrieval Engine",
  "Radio Log Keyword Cloud Generator",
  "Daily Radio Chatter Summary Report AI",
  "Historical Incident Audio Comparison AI",
  "Dispatcher Clarity/Articulation Scorer",
  "Women/Child Distress Keyword Alert Bot",
  "Narcotics/Smuggling Slang Decoder",
  "Riot/Mob Coordination Chatter Analyzer",
  "Traffic/Accident Pile-up Keyword Sync",
  "Fire/Disaster Mayday Call Prioritizer",
  "Marine/Coastguard Radio Chatter Link",
  "Border Patrol Enemy Chatter Scraper",
  "Railway Police Radio Log Sync AI",
  "Undercover Officer Check-in Tracker",
  "Prison/Jail Radio Log Anomaly Detector",
  "Automated Audit of Mandatory Check-ins",
  "Radio Log Blockchain Immutable Storage",
  "Command Center Real-Time Audio Feed AI",
  "Voice Biometric Speaker Identification AI",
  "AI-Generated Radio Transcript PDF",
  "Unidentified Signal Audio Analyzer",
  "Crowdsourced Public Scanner Leak Alert",
  "Radio PTT (Push-To-Talk) Latency Scorer",
  "Automated Debrief/Post-Mortem Audio Sync",
  "Offline Mode Radio Log Cacher AI",
  "Inter-Agency Joint Ops Chatter Analyzer",
  "Media/Press Eavesdropping Predictor",
  "VIP Security Escort Audio Log Rater",
  "Special Forces Tactical Comms Sync"
];
...
const RadioLogAnalysisDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI RADIO LOG ANALYSIS
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI RADIO LOG ANALYSIS</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in voice-to-text transcription of radio chatter, keyword threat flagging & protocol breach.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI RADIO LOG <span>ANALYSIS</span></h1>
            <p className="cyber-subtitle">Voice-to-Text Transcription of Radio Chatter, Keyword Threat Flagging & Protocol Breach</p>
          </div>
        </div>
      </header>
...
export default RadioLogAnalysisDetailed;
