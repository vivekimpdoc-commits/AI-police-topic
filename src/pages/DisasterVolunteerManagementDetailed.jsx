...
const aiExperts = [
"Volunteer Credential/ID Verification AI",
  "Skill-Based (Medical/Plumber) Task Matcher",
  "Shift Rotation & Fatigue Monitor Bot",
  "Background Check/Criminal Record Sync",
  "GPS Tracking/Field Location Heatmap AI",
  "NGO/Corporate CSR Volunteer Integration",
  "SMS/WhatsApp Mass Deployment Alert Bot",
  "First-Aid/CPR Certified Volunteer Router",
  "Command Center Volunteer Dashboard",
  "Voice-Command Volunteer Query Assistant",
  "Automated Certificate/Award Generator AI",
  "Inter-District/State Volunteer Pooling",
  "Food/Water/Accommodation Logistics for Vols",
  "Crowd Control/Traffic Marshal Allocator",
  "Missing Person Search Grid Volunteer Deployer",
  "Language/Dialect Matcher for Local Relief",
  "AI Evaluator for Volunteer Efficiency",
  "Disciplinary/No-Show Log Auto-Generator",
  "Data Privacy/Volunteer Personal Info Masker",
  "Police-Volunteer Joint Patrol Sync AI",
  "Fake/Rogue Volunteer Impersonation Alert",
  "Psychological Trauma/Stress Counselor for Vols",
  "Senior Officer (Nodal) Volunteer Briefing",
  "Public/Social Media Recruitment Drafter",
  "Blockchain Immutable Log of Volunteer Hours",
  "Safety Eqp (Jacket/Helmet) Issue Tracker",
  "Mobile App for Volunteer Check-in/Selfie",
  "Women/Elderly Care Volunteer Allocator",
  "Multi-Lingual Instruction Translator Bot",
  "Historical Volunteer Turnout Precedent",
  "Heavy Equipment Operator (JCB) Verification",
  "Medical/Fitness Clearance Checker AI",
  "Temporary Relief Camp Staffing Modeler",
  ...
  "Media/Press Liaison Volunteer Assignor",
  "Integration with National Volunteer Portal",
  "Citizen SOS to Nearest Volunteer Router",
  "Heatwave/Water Distribution Station AI",
  "Election/Festival Repurposing of Volunteers",
  "Stipend/Travel Expense Tracker for Vols",
  "Custom Workflow/Approval for External NGOs",
...
const DisasterVolunteerManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DISASTER VOLUNTEER MANAGEMENT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI DISASTER VOLUNTEER MANAGEMENT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in credential verification, skill-based task assignment & shift rotations.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DISASTER VOLUNTEER <span>MANAGEMENT</span></h1>
            <p className="cyber-subtitle">Credential Verification, Skill-based Task Assignment & Shift Rotations</p>
          </div>
        </div>
      </header>
...
export default DisasterVolunteerManagementDetailed;
