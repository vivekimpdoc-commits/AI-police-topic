...
const aiExperts = [
  "Digital Remand/Extension Request AI",
  "Section 164 (BNSS) Statement Scheduler",
  "Autopsy/Inquest Authorization Router",
  "Fast-Track Digital Signature (DSC) Verifier",
  "Statutory 24-Hour Production Tracker",
  "Magisterial Jurisdiction/Duty Roster Mapper",
  "Geo-Spatial Police Station to Court Distance Estimator",
  "Automated Case Summary/Brief Generator",
  "Magistrate Communication Dashboard",
  "Voice-Command Request Status Bot",
  "Automated Daily Remand/Production Report",
  "District Judiciary/E-Courts Sync",
  "Imminent 24-Hour Expiry (Illegal Detention) Alert",
  "Jurisdictional Dispute/Routing Error Predictor",
  "Incomplete/Defective Remand Paper Flagging AI",
  "Magistrate Unavailability/Leave Conflict Analyzer",
  "AI Evaluator for Magisterial Coordination Index",
  "Audit/Communication Log Generator",
  "Data Privacy/Accused Rights Scrubber",
  "Directorate of Prosecution Sync",
  "Investigating Officer/Court Munshi App",
  "Historical Remand Rejection/Bail Correlator",
  "Chief Judicial Magistrate (CJM) Briefing Interface",
  "Duty Magistrate Allocation/Roster Sync",
  "Blockchain Immutable Remand Request Hash",
  "Anti-Tamper Digital Signature Shield",
  "Mobile App for Urgent Night-Duty Approvals",
  "Station-wise Remand Acceptance Benchmarker",
  "Automated Alert for Impending Habeas Corpus Risk",
  "Historical Travel/Escort Cost Analyzer (to Court)",
  "Remand Drafting/CrPC Compliance SOP Trainer",
  "E-Courts/DSC API Health Monitor",
  "Imminent Illegal Custody/Rights Violation Alert",
  "Habitual Defective-Drafter (IO) Profiler",
  "High-Stakes (Terror/Murder) Remand Classifier",
  "AI Assisted Application for Police Custody Drafter",
  "Magisterial Workload/Pending Request Forecaster",
  "Secure Confidential Confession (Sec 164) Protector",
  "Integration with Inter-operable Criminal Justice System (ICJS)",
  "Prison/Jail Management System Sync",
  "Election Preventive Arrest (151 CrPC) Mass Approval Modeler",
  "Disaster Mass-Inquest/Autopsy Approval Coordinator",
  "Legal/IT Infrastructure Budget Tracker",
  "Custom Workflow for Juvenile Justice Board (JJB) Routing",
  "AI Driven Remand Approval Probability Predictor",
  "Predictive Need for Additional Duty Magistrates (Festivals/Elections)",
  "Custom Alert Trigger for SP City",
  "Arrest to Magisterial Production Timeline"
];
...
const MagistrateCommunicationPortalDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI MAGISTRATE COMMUNICATION PORTAL
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI MAGISTRATE COMMUNICATION <span>PORTAL</span></h1>
...
export default MagistrateCommunicationPortalDetailed;
