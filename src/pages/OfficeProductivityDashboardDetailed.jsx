...
const aiExperts = [
  "Clerical/Desk Output Measuring Engine",
  "Pendency/Backlog Heatmap Generator",
  "Leave vs Workload Correlator AI",
  "Workflow/Process Bottleneck Optimizer",
  "Dak/Receipt Processing Speed Tracker",
  "Typing/Drafting Efficiency Scorer",
  "Geo-Spatial Office Workload Mapper",
  "Overtime/Burnout Predictor AI",
  "Productivity Executive Dashboard",
  "Voice-Command Metric Query Bot",
  "Automated Weekly Efficiency Report",
  "HRMS/Payroll Sync Bot",
  "Computer Usage/Idle Time Monitor",
  "Error/Correction Rate Analyzer",
  "Fake Output/Manipulated Log Detector",
  "Skill-to-Task Matcher AI",
  "AI Evaluator for Staff Appraisals (ACR)",
  "Audit/Productivity Log Generator",
  "Data Privacy/Personal Metric Scrubber",
  "State Police Headquarters Sync",
  "Staff Self-Assessment Mobile App",
  "Historical Inefficiency Correlator",
  "Supervisory Officer Briefing AI",
  "Task Reallocation/Load Balancing Engine",
  "Blockchain Immutable Appraisal Hash",
  "Anti-Tamper Productivity Shield",
  "Mobile App for Task Updates",
  "Inter-Branch Efficiency Benchmarker",
  "Automated Reminder for Stalled Tasks",
  "Historical Seasonal Workload Analyzer",
  "Office Procedure SOP Trainer",
  "Productivity DB Server Health Monitor",
  "Imminent Systemic Backlog Alert",
  "Chronic Underperformer Profiler",
  "High-Value/Critical Desk Classifier",
  "AI Assisted Reward/Reprimand Drafter",
  "Productivity Data Storage Forecaster",
  "Secure Appraisal Protector",
  "Integration with E-Office",
  "Citizen Grievance Resolution Speed Sync",
  "Election Duty Staff Shortage Modeler",
  "Disaster Emergency Desk Setup Coordinator",
  "Overtime/Incentive Budget Tracker",
  "Custom Workflow for Process Re-engineering",
  "AI Driven Burnout/Attrition Predictor",
  "Predictive Need for Additional Staff/Automation",
  "Custom Alert Trigger for IG/ADG",
  "Task Completion Lifecycle Tracker"
];
...
const OfficeProductivityDashboardDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI OFFICE PRODUCTIVITY DASHBOARD
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI OFFICE PRODUCTIVITY <span>DASHBOARD</span></h1>
...
export default OfficeProductivityDashboardDetailed;
