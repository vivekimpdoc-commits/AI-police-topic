...
const aiExperts = [
"UPI/QR Code Fraud Transaction Tracer AI",
  "Fake Loan App (Chinese App) Network Mapper",
  "Credit/Debit Card Skimming Hotspot AI",
  "Cryptocurrency Laundering/Tornado Cash Tracer",
  "Bank Account Mule/Drop-Account Predictor",
  "OTP/SIM Swap Fraud Early Warning Bot",
  "KYC Forgery/Aadhar Misuse Detector",
  "E-Commerce/Refund Fraud Pattern AI",
  "Jamtara/Mewat Calling Module Geolocation",
  "Investment/Ponzi Scheme Downline Analyzer",
  "Romance/Dating App Scam Tracker AI",
  "Lottery/KBC Fraud SMS Origin Tracer",
  "Work-from-Home/Part-time Job Scam Bot",
  "Customs/FedEx Parcel Extortion Scam AI",
  "Insurance Claim Fraud/Deepfake Detector",
  "Corporate Email Compromise (BEC) Tracer",
  "Command Center Real-time Fraud Dashboard",
  "Voice-Command Fraud Modus Operandi Search",
  "Automated Bank Account Freeze Router AI",
  "Inter-Agency (RBI/NPCI) Data Sync Bot",
  "Financial Flow/Graph Visualization AI",
  "Suspicious Cross-Border Wire Transfer Bot",
  "ATM Cash Trapping/Jackpotting Alert AI",
  "Fake Customer Care Toll-Free Tracer",
  "Crypto Exchange Subpoena Auto-Generator",
  "IPDR to Bank Login Sync Analyzer",
  "Social Media Marketplace/Olx Fraud Linker",
  "AI Evaluator for Fraud Recovery Probability",
  "Blockchain Immutable Log of Fraud Cases",
  "Telecom Operator Nodal Officer Sync Bot",
  "AI Driven Public Advisory/Alert Drafter",
  "Senior Officer (EOW) Executive Briefing",
  "Fraud Syndicate Shell Company Tracker",
  "AI Assisted Legal Charge-Sheet (PMLA) Gen",
  "Victim Demographic (Elderly) Fraud Modeler",
  "Refund/Chargeback Dispute Legal Scorer",
  "Hawala/Underground Banking Link AI",
  "Fake Payment App (Spoof Paytm) Detector",
  "Tax/ITR Refund Phishing Campaign Tracker",
  "Real Estate/Crypto Token Scam Analyzer",
  "AI Protocol for International Extradition",
  "Data Privacy & Victim Identity Protection",
  "Mule Account Velocity/Threshold Alert AI",
  "Biometric/Fingerprint Cloning Fraud Bot",
  "AI Driven Trend Analysis of New Scams",
  "Call Center Scam IP/VoIP Server Locator",
  "Digital Wallet (MobiKwik/Amazon) Fraud AI",
  "Prepaid Gift Card/Gaming Token Laundering"
];
...
const DigitalFraudDetectionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DIGITAL FRAUD DETECTION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI DIGITAL FRAUD DETECTION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in financial scams, upi/bank fraud tracking, fake loan apps & crypto laundering.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DIGITAL FRAUD <span>DETECTION</span></h1>
            <p className="cyber-subtitle">Financial Scams, UPI/Bank Fraud Tracking, Fake Loan Apps & Crypto Laundering</p>
          </div>
        </div>
      </header>
...
export default DigitalFraudDetectionDetailed;
