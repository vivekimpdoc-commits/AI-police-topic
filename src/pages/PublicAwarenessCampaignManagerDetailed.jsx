...
const aiExperts = [
"Anti-Drug/Narcotics Campaign Drafter AI",
  "Cyber-Security/Phishing Awareness Bot",
  "Traffic Rules & Road Safety Education AI",
  "Women/Child Safety Rights Campaigner",
  "Target Audience Demographic Matcher",
  "Campaign Content (Text/Image) Auto-Gen",
  "Multi-Lingual Campaign Translator Bot",
  "Social Media ROI & Reach Analyzer AI",
  "Automated SMS/WhatsApp Blast Router",
  "Fake News/Rumor Busting Campaign Gen",
  "School/Youth Sensitization Drive Planner",
  "Senior Citizen Anti-Scam Campaign AI",
  "Disaster/Earthquake Readiness Educator",
  "Festival/Event Crowd Safety Campaign AI",
  "RTI/Legal Rights Public Awareness Bot",
  "Campaign Sentiment & Engagement Scorer",
  "Police-Mitra/Volunteer Mobilization Link",
  "Historical Campaign Effectiveness Correlator",
  "Public Trust Index Impact Modeler AI",
  "NGO/Civil Society Partnership Campaigner",
  "Digital Billboard/PA System Sync Bot",
  "Election Code of Conduct Awareness AI",
  "Environmental/Green Police Campaign Drafter",
  "Stray Animal/Wildlife Protection Campaign",
  "Voice/Audio Podcast/Radio Ad Generator AI",
  "Campaign Budget vs Reach ROI Analyzer",
  "Predictive Crime Drop Modeler Post-Campaign",
  "Automated Post-Campaign Feedback Surveyor",
  "Command Center Campaign Dashboard Link",
  "Interactive Quiz/Gamification Campaign Bot",
  "Cyber-Bullying/Online Harassment Drive AI",
  "Domestic Violence Helpline Promotor AI",
  "Emergency 112/SOS App Download Driver",
  "Traffic E-Challan Process Explainer Bot",
  "Neighborhood Watch Enrollment Campaigner",
  "Tenant/Servant Verification Drive Auto-Gen",
  "Lost & Found/Stolen Vehicle Portal Promotor",
  "Missing Person/Amber Alert Campaign Link",
  "AI Generated Monthly Campaign Strategy",
  "Blockchain Immutable Log of Campaign Data",
  "Inter-Agency Joint Awareness Campaign AI",
  "Local Slang/Dialect Content Optimizer",
  "Campaign Plagiarism & Policy Checker Bot",
  "VIP/Influencer Endorsement Tracker AI",
  "Rural/Gram Chaupal Awareness Campaigner",
  "RWA/Gated Community Direct Push AI",
  "Mass Transit (Railway/Bus) Safety Drive",
  "Tourist/Foreigner Safety Guideline Gen",
  "Hospital/Health Camp Police Partnership AI",
  "Weapon License/Ammunition Rules Educator",
  "Industrial Area Worker Rights Campaign Bot",
  "Protest/Mob Violence Legal Consequence AI",
  "Cyber-Mitra/Digital Volunteer Recruiter",
  "AI Evaluator for Campaign Awards",
  "Voice-Command Campaign Query Assistant",
  "Campaign Resource (Pamphlet/Banner) Allocator",
  "AI Protocol for Rapid Emergency Campaign",
  "Community Risk Survey Issue Targeter AI",
  "Public Sentiment Trend vs Campaign Topic",
  "Central PHQ Master Campaign Synchronizer"
];
...
const PublicAwarenessCampaignManagerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI PUBLIC AWARENESS CAMPAIGN MANAGER
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI PUBLIC AWARENESS CAMPAIGN MANAGER</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in anti-drug drives, cyber-security awareness & traffic rules education.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI PUBLIC AWARENESS <span>CAMPAIGN MANAGER</span></h1>
            <p className="cyber-subtitle">Anti-Drug Drives, Cyber-Security Awareness & Traffic Rules Education</p>
          </div>
        </div>
      </header>
...
export default PublicAwarenessCampaignManagerDetailed;
