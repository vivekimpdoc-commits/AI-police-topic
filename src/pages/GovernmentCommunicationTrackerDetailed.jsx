...
const aiExperts = [
  "MHA/DGP Directive Tracking Engine",
  "Assembly/Parliament Question Monitor",
  "VIP Reference (DO Letter) Priority AI",
  "Inter-Departmental (Revenue/Health) Sync Bot",
  "Deadline/Session Timeline Tracker",
  "Previous Assembly Question Matcher",
  "Geo-Spatial Issue Relevance Mapper",
  "Policy Change/Gazette Notification Extractor",
  "Govt Communication Dashboard",
  "Voice-Command Query Bot",
  "Automated Session/Weekly Pendency Report",
  "State Secretariat Sync Bot",
  "Multi-Lingual Translation (State Language to English)",
  "Draft Reply Auto-Generator AI",
  "Contradictory Policy Detector",
  "Media/Public Interest Correlator",
  "AI Evaluator for Reply Quality/Timeliness",
  "Audit/Action Log Generator",
  "Data Privacy/Classified Info Scrubber",
  "Law/Legal Department Sync",
  "Nodal Officer Alert Mobile App",
  "Historical Delay/Privilege Motion Correlator",
  "DGP/Home Secretary Briefing AI",
  "Branch/District Task Allocator",
  "Blockchain Immutable Communication Hash",
  "Anti-Tamper Policy Document Shield",
  "Mobile App for Draft Approval",
  "Department-wise Responsiveness Benchmarker",
  "Automated Reminder for Imminent Deadlines",
  "Historical Legislative Interest Analyzer",
  "Government Protocol SOP Trainer",
  "Tracker DB Server Health Monitor",
  "Imminent Privilege Motion/Contempt Alert",
  "Defaulter Branch/Unit Profiler",
  "Top-Secret/Cabinet Memo Classifier",
  "AI Assisted Extension Request Drafter",
  "Policy/Archive Storage Forecaster",
  "Secure Official Secrets Protector",
  "Integration with E-Vidhaan/E-Assembly",
  "Public Information Portal Sync",
  "Election Commission Directive Modeler",
  "Disaster/NDMA Guideline Coordinator",
  "Legal/Consultation Budget Tracker",
  "Custom Workflow for Cabinet Note Approval",
  "AI Driven Assembly Question Predictor",
  "Predictive Need for Policy Review",
  "Custom Alert Trigger for Chief Secretary",
  "Govt Directive Implementation Timeline"
];
...
const GovernmentCommunicationTrackerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI GOVERNMENT COMMUNICATION TRACKER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI GOVERNMENT COMMUNICATION <span>TRACKER</span></h1>
...
export default GovernmentCommunicationTrackerDetailed;
