...
const aiExperts = [
  "Logbook vs GPS Telemetry Reconciler",
  "Maintenance/Service Schedule Auditor",
  "Mileage/Fuel Efficiency (KMPL) Tracker",
  "Vehicle Condemnation/Auction Modeler",
  "Tire Wear/Battery Health Scorer AI",
  "Unauthorized Detour/Personal Use Detector",
  "Geo-Spatial Fleet Movement Mapper",
  "Accident/Damage Assessment Engine",
  "Vehicle Inspection Dashboard",
  "Voice-Command Fleet Status Bot",
  "Automated Monthly MT (Motor Transport) Report",
  "State Transport/RTO Sync",
  "Fuel Pilferage/Siphoning Predictor",
  "Fake Run-Kilometer Entry Alert",
  "Imminent Engine Seizure/Failure Predictor",
  "Driver Rash-Driving/Harsh Braking Analyzer",
  "AI Evaluator for Fleet Readiness Index",
  "Audit/Inspection Log Generator",
  "Data Privacy/Officer Movement Scrubber",
  "Finance/Audit Department Sync",
  "MT Officer/Inspector Mobile App",
  "Historical Breakdown Trend Correlator",
  "SP (Motor Transport) Briefing AI",
  "Workshop/Repair Task Allocator",
  "Blockchain Immutable Logbook Hash",
  "Anti-Tamper GPS/Telemetry Shield",
  "Mobile App for Pre-Trip Inspection (PTI)",
  "Vehicle-Make Efficiency Benchmarker",
  "Automated Alert for Overdue Servicing",
  "Historical Fuel/Maintenance Cost Analyzer",
  "Fleet Management/Safety SOP Trainer",
  "OBD-II (On-Board Diagnostics) API Monitor",
  "Imminent Highway Breakdown/Accident Alert",
  "Careless/Rash Driver Profiler",
  "Mission-Critical (VIP Escort/Ambulance) Classifier",
  "AI Assisted Condemnation Board Drafter",
  "Telemetry/Log Data Storage Forecaster",
  "Secure VIP Convoy Route Protector",
  "Integration with E-Challan/Vahan Database",
  "Approved Workshop/Vendor Portal Sync",
  "Election Fleet Mass Deployment Modeler",
  "Disaster Rescue Boat/Vehicle Coordinator",
  "POL (Petrol, Oil, Lubricants) Budget Tracker",
  "Custom Workflow for Armored/Bulletproof Vehicles",
  "AI Driven Monthly Fuel Indent Predictor",
  "Predictive Need for Fleet Replacement",
  "Custom Alert Trigger for IG Provisioning",
  "Defect Logging to Workshop Release Timeline"
];
...
const VehicleInspectionRegisterDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI VEHICLE INSPECTION REGISTER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI VEHICLE INSPECTION <span>REGISTER</span></h1>
...
export default VehicleInspectionRegisterDetailed;
