...
const aiExperts = [
  "District SOP Compliance Scoring Engine",
  "Infrastructure (Building/Lockup) Auditor AI",
  "Emergency Response Time Benchmarker",
  "Historical Crime Vulnerability Mapper",
  "Training/Firing Practice Backlog Tracker",
  "Community Policing/Informant Network Scorer",
  "Geo-Spatial District Threat Heatmapper",
  "Cyber Security/Data Protection Auditor",
  "Preparedness Audit Dashboard",
  "Voice-Command Audit Query Bot",
  "Automated Quarterly Audit Report",
  "State Crime Records Bureau (SCRB) Sync",
  "CCTV/Command Center Efficiency Scorer",
  "Traffic/Highway Fatality Reduction Tracker",
  "Pending Investigation/Charge-sheet Benchmarker",
  "Public Grievance Resolution Scorer",
  "AI Evaluator for SP/SSP Performance",
  "Audit/Inspection Log Generator",
  "Data Privacy/Confidential Audit Scrubber",
  "State Home Department Sync",
  "Field Audit/Inspection Mobile App",
  "Historical Riot/Failure Correlator AI",
  "DGP/ADG Level Audit Briefing Bot",
  "Remedial Resource/Fund Allocator",
  "Blockchain Immutable Audit Hash",
  "Anti-Tamper Audit Score Shield",
  "Mobile App for Audit Compliance Uploads",
  "Inter-District Peer Comparison Matcher",
  "Multi-Lingual Audit Report Generator",
  "Historical Audit Improvement Analyzer",
  "District Policing SOP Trainer",
  "Audit DB Server Health Monitor",
  "Imminent Systemic Failure Alert Bot",
  "Organized Crime/Syndicate Dominance Profiler",
  "High-Risk/Sensitive District Classifier",
  "AI Assisted Remedial Action Plan Drafter",
  "Audit Image/Video Storage Forecaster",
  "Secure Whistleblower/Flaw Protector",
  "Integration with National Crime Records Bureau",
  "Citizen Satisfaction Survey Sync",
  "Election Preparedness Risk Modeler",
  "Disaster Resilience/Evacuation Coordinator",
  "Audit Remediation Budget Tracker",
  "Custom Workflow for Audit Re-evaluation",
  "AI Driven Crisis Probability Predictor",
  "Predictive Need for State Intervention",
  "Custom Alert Trigger for Chief Secretary",
  "Audit Cycle Timeline Tracker"
];
...
const DistrictPreparednessAuditDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DISTRICT PREPAREDNESS AUDIT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DISTRICT PREPAREDNESS <span>AUDIT</span></h1>
...
export default DistrictPreparednessAuditDetailed;
