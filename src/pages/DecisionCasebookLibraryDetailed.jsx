...
const aiExperts = [
  "Public-Order Dilemma/Scenario Simulator AI",
  "Use-of-Force Justification/Proportionality Scorer",
  "Human Rights (NHRC) Precedent Linker Engine",
  "Scenario-Based Decision Tree Generator",
  "De-escalation/Conflict Resolution NLP Analyzer",
  "Crowd Psychology/Mob Mentality Predictor",
  "Geospatial Riot/Flashpoint Context Mapper",
  "Legal Liability/Indemnity Analyzer AI",
  "Decision Casebook Dashboard",
  "Voice-Command Precedent Query Bot",
  "Automated Monthly Training Impact Report",
  "State Human Rights Commission Sync",
  "Excessive Force/Brutality Risk Predictor",
  "Media/Public Backlash Fallout Analyzer",
  "Officer Panic/Stress Response Estimator",
  "Split-Second Decision Error Flagging AI",
  "AI Evaluator for Restraint & Judgment Index",
  "Audit/Simulation Attempt Log Generator",
  "Data Privacy/Officer Identity Scrubber",
  "Judicial/Magistracy Liaison Sync",
  "Police Trainee/Cadet Simulation App",
  "Historical Riot Escalation Correlator",
  "IG (Training/Human Rights) Briefing AI",
  "Remedial Judgment Training Allocator",
  "Blockchain Immutable Casebook Version Hash",
  "Anti-Tamper Training Record Shield",
  "Mobile App for VR/AR Scenario Training",
  "District-wise Use-of-Force Restraint Benchmarker",
  "Automated Alert for Severe Rights Violations",
  "Historical Litigation/Compensation Cost Analyzer",
  "Use-of-Force/De-escalation SOP Trainer",
  "Simulation/VR Platform API Health Monitor",
  "Imminent Custodial Death/Firing Backlash Alert",
  "Trigger-Happy/Aggressive Officer Profiler",
  "High-Sensitivity (Communal/Student Protest) Classifier",
  "AI Assisted Magisterial Inquiry Report Drafter",
  "Public Trust/Sentiment Trend Forecaster",
  "Secure Internal Inquiry File Protector",
  "Integration with Police Academy Curriculum",
  "Civil Society/NGO Outreach Sync",
  "Election Mob Control/Firing Decision Modeler",
  "Disaster Looting/Panic Control Decision Coordinator",
  "Simulation Tech/VR Hardware Budget Tracker",
  "Custom Workflow for Armed/Naxal Encounters",
  "AI Driven Officer Decision-Making Score Predictor",
  "Predictive Need for Psychological Counseling",
  "Custom Alert Trigger for DGP",
  "Training Simulation to Field Application Timeline"
];
...
const DecisionCasebookLibraryDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DECISION CASEBOOK LIBRARY
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DECISION CASEBOOK <span>LIBRARY</span></h1>
...
export default DecisionCasebookLibraryDetailed;
