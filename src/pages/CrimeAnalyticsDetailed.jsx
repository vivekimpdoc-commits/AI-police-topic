...
const aiExperts = [
"Crime Trend & Variance Statistical Modeler",
  "Victim Demographic (Age/Gender) Analyzer",
  "Perpetrator Socio-Economic Profiler AI",
  "Day/Time Temporal Crime Spike Predictor",
  "MoM/YoY Crime Rate Fluctuation Tracker",
  "Seasonal/Weather Impact on Crime Scorer",
  "Violent vs Non-Violent Crime Ratio Analyzer",
  "Cyber Crime Escalation Modeler AI",
  "Weapon Involvement Probability Scorer",
  "Financial Fraud Loss Estimation AI",
  "Geospatial Shift of Crime Syndicates AI",
  "Arrest vs Conviction Rate (Clearance) AI",
  "Bail/Parole Violation Trend Analytics",
  "Juvenile Crime Demographic Surge Modeler",
  "Women/Child Abuse Under-Reporting Predictor",
  "Festival/Event Related Crime Spike AI",
  "Election Cycle Violence Correlator",
  "Traffic/Accident Fatality Demographic AI",
  "Narcotics/Substance Abuse Trend Mapper",
  "Urban vs Rural Crime Typology Analyzer",
  "Automated Monthly Crime Review (MCR) Gen",
  "Command Center Real-time Crime Dashboard",
  "Interactive Data Visualization & Charting Bot",
  "Voice-Command Crime Stat Query Assistant",
  "AI Generated Heatmap & Scatter Plot Gen",
  "Outlier/Anomaly Detection in FIR Data",
  "CCTNS Raw Data Cleansing & Normalization",
  "Predictive Deployment Resource Allocator AI",
  "Beat Officer Performance vs Crime Rate AI",
  "Public Trust Index vs Crime Stats Correlator",
  "Socio-Political Event Impact Modeler",
  "Property Crime/Burglary Value Analytics",
  "Stolen Vehicle Make/Model Preference AI",
  "Modus Operandi (MO) Clustering Engine",
  "Suspicious Suicide/Accident Analytics AI",
  "Missing Person Recovery Rate Scorer",
  "Inter-District/State Border Crime Analytics",
  "Prison Overcrowding vs Arrest Rate AI",
  "Court Pendency Impact on Crime Rate AI",
  "AI Driven NLP Extractor for FIR Narratives",
  "Historical Crime Data Precedent Matcher",
  "Senior Officer (SP/DGP) Executive Briefing AI",
  "Media/Press Briefing Stat Generator Bot",
  "Fake/Prank Call Volume Analytics AI",
  "Cyber-Bullying/Harassment Trend Analyzer",
  "Hate Speech/Communal Tension Sentiment AI",
  "Industrial/Labor Dispute Crime Analytics",
  "Economic Offenses/White-Collar Crime AI",
  "Riot/Mob Violence Participant Demographics",
  "AI Protocol for Automated Crime Bulletins",
  "Blockchain Immutable Log of Crime Stats",
  "Data Privacy & Victim Anonymization Engine",
  "Predictive Bail-Jumper Identification AI",
  "Forensic Delay Impact on Conviction AI",
  "AI Evaluator for Station House Officer (SHO)",
  "NGO/Civil Society Intervention Impact Scorer",
  "Tourist/Foreigner Crime Victim Analytics",
  "Caste/Tribe Specific Crime Analytics",
  "AI Driven Root Cause Analysis for Crime Spikes",
  "Dynamic Dashboard Personalization Bot"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CRIME ANALYTICS
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI CRIME ANALYTICS</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in statistical breakdowns, victim/perpetrator demographics & temporal trends.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CRIME <span>ANALYTICS</span></h1>
            <p className="cyber-subtitle">Statistical Breakdowns, Victim/Perpetrator Demographics & Temporal Trends</p>
          </div>
        </div>
      </header>
...
export default CrimeAnalyticsDetailed;
