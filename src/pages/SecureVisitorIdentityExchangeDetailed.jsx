...
const aiExperts = [
  "DigiLocker/Aadhaar API Integrator AI",
  "Instant Background/CCTNS Verification Engine",
  "Pre-Approved QR Code Generator",
  "Escort Handover/Chain of Custody Bot",
  "Visitor Face-Match/Liveness Detection AI",
  "Overstay/Unauthorized Wandering Alert",
  "Geo-Spatial Visitor Path Mapper",
  "Purpose of Visit Categorizer",
  "Visitor Identity Exchange Dashboard",
  "Voice-Command Visitor Query Bot",
  "Automated Daily Visitor Vetting Report",
  "PHQ Security/Reception Sync",
  "Fake/Forged ID Document Predictor",
  "Wanted Person/Suspect Match Alert",
  "Repeat/Vexatious Visitor Identifier",
  "Reception Desk Congestion Optimizer",
  "AI Evaluator for Reception Security Index",
  "Audit/Verification Log Generator",
  "Data Privacy/Visitor PII Scrubber",
  "State Intelligence/CID Sync",
  "Receptionist/Sentry Verification App",
  "Historical Security Incident Correlator",
  "Chief Security Officer Briefing AI",
  "Escort/Liaison Task Allocator",
  "Blockchain Immutable Verification Hash",
  "Anti-Tamper Visitor Log Shield",
  "Mobile App for Escort Acknowledgment",
  "Gate-wise Vetting Speed Benchmarker",
  "Automated Reminder for Visitor Check-out",
  "Historical Verification Cost Analyzer",
  "Visitor Management/Courtesy SOP Trainer",
  "API/Gateway Connectivity Health Monitor",
  "Imminent Infiltration/Breach Alert",
  "Suspicious Intermediary/Broker Profiler",
  "High-Security Area Visitor Classifier",
  "AI Assisted Barring/Blacklist Order Drafter",
  "Visitor Data/Image Storage Forecaster",
  "Secure VIP Guest Itinerary Protector",
  "Integration with State Grievance Portal (CM Helpline)",
  "Zero Public Exposure Policy Sync (for restricted zones)",
  "Election Media/Observer Vetting Modeler",
  "Disaster Relief Volunteer Vetting Coordinator",
  "Security Kiosk/Hardware Budget Tracker",
  "Custom Workflow for Media/Press Accreditation",
  "AI Driven Peak Visitor Volume Predictor",
  "Predictive Need for Extra Reception Staff",
  "Custom Alert Trigger for SP Security",
  "Visitor Check-in to Escorted Exit Timeline"
];
...
const SecureVisitorIdentityExchangeDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SECURE VISITOR IDENTITY EXCHANGE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SECURE VISITOR IDENTITY <span>EXCHANGE</span></h1>
...
export default SecureVisitorIdentityExchangeDetailed;
