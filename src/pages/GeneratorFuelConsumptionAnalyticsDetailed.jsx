...
const aiExperts = [
  "Load-to-Fuel Efficiency Correlator AI",
  "Diesel Pilferage/Siphoning Detector",
  "Engine Run-Hour/Maintenance Tracker",
  "Multi-DG Synchronization Optimizer",
  "Grid Outage vs DG Run-Time Validator",
  "Carbon Emission/Smoke Analyzer",
  "Geo-Spatial Generator Fleet Mapper",
  "Battery/Self-Starter Health Scorer",
  "Generator Fuel Analytics Dashboard",
  "Voice-Command DG Query Bot",
  "Automated Weekly Fuel Audit Report",
  "State Electricity Board (DISCOM) Sync",
  "Sudden Fuel Drop/Theft Predictor",
  "Engine Seizure/Overheating Alert",
  "Optimal Load Allocation Analyzer",
  "Substandard Fuel/Adulteration Detector",
  "AI Evaluator for Backup Power Reliability",
  "Audit/Refueling Log Generator",
  "Data Privacy/Station Outage Data Scrubber",
  "Finance/Audit Department Sync",
  "DG Operator/Mechanic Mobile App",
  "Historical Power Cut Trend Correlator",
  "SP (Infrastructure) Briefing AI",
  "Refueling/Servicing Task Allocator",
  "Blockchain Immutable Fuel Log Hash",
  "Anti-Tamper DG Telemetry Shield",
  "Mobile App for QR Fuel Indent",
  "DG-wise Efficiency (KWH/Liter) Benchmarker",
  "Automated Alert for Critical Fuel Level",
  "Historical Diesel Expenditure Analyzer",
  "Generator Safety/Operations SOP Trainer",
  "IoT Fuel/Vibration Sensor Monitor",
  "Imminent Total Power Failure Alert",
  "Habitual Fuel Pilferer Profiler",
  "High-Capacity (Headquarters) DG Classifier",
  "AI Assisted Fuel Supply Tender Drafter",
  "Fuel Consumption/Price Trend Forecaster",
  "Secure Generator Controller Network Protector",
  "Integration with Approved Fuel Vendors",
  "Pollution Control Board Sync",
  "Election Uninterrupted Power Fuel Modeler",
  "Disaster Mobile DG Deployment Coordinator",
  "Diesel/Maintenance Budget Tracker",
  "Custom Workflow for Remote Checkpost DG Sets",
  "AI Driven Monthly Fuel Budget Predictor",
  "Predictive Need for Engine Overhaul",
  "Custom Alert Trigger for Reserve Inspector",
  "Grid Failure to Auto-Start Timeline"
];
...
const GeneratorFuelConsumptionAnalyticsDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI GENERATOR FUEL CONSUMPTION ANALYTICS
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI GENERATOR FUEL CONSUMPTION <span>ANALYTICS</span></h1>
...
export default GeneratorFuelConsumptionAnalyticsDetailed;
