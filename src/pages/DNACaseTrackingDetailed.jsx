...
const aiExperts = [
  "DNA Sample Collection Protocol Advisor AI",
  "Chain-of-Custody DNA Sample Tracker Bot",
  "CODIS/National DNA Index Search Engine AI",
  "DNA Profile Match/No-Match Report Gen",
  "Familial DNA Searching Algorithm Bot",
  "Degraded/Mixed DNA Sample Analyzer AI",
  "Mitochondrial DNA (mtDNA) Specialist Bot",
  "Y-STR Male Lineage DNA Tracker AI",
  "DNA Case Tracking Command Dashboard",
  "Voice-Command DNA Status Query Bot",
  "Automated DNA Lab Queue Priority Engine",
  "Cross-State DNA Database Sync Engine AI",
  "DNA Contamination Prevention Protocol Bot",
  "Rapid DNA (PCR) Machine Status Monitor",
  "DNA Evidence Storage Temperature Tracker",
  "Touch DNA (Low Copy Number) Analyzer AI",
  "AI Evaluator for DNA Match Probability",
  "Audit/DNA Sample Movement Log Generator",
  "Data Privacy/Genetic Data Encryption AI",
  "Police-FSL DNA Division Joint Sync Bot",
  "IO DNA Evidence Submission Mobile App",
  "Cold Case DNA Re-Testing Queue Manager",
  "Senior Officer (DNA Division Head) Briefing",
  "Public Missing Person DNA Match Portal",
  "Blockchain Immutable DNA Profile Record",
  "Anti-Swap/Mislabel DNA Sample Verifier",
  "Mobile App for DNA Collection Kit Sync",
  "CRISPR/Gene Editing Forensic Tracker AI",
  "Multi-Lingual DNA Report Translator Bot",
  "Historical DNA Exoneration Case Analyzer",
  "Staff DNA Analyst Competency Tracker AI",
  "DNA Sequencer Machine Health Monitor Bot",
  "Urgent Rape/Murder DNA Priority Queue",
  "Traffic Hit-and-Run Blood DNA Matcher",
  "Unidentified Body DNA Profile Generator",
  "VIP Threat Suspect DNA Database AI",
  "AI Assisted Post-Match Court Expert Report",
  "DNA Lab Consumable/Kit Expiry Tracker",
  "Elimination DNA Database (Police Staff)",
  "Integration with National DNA Database (NDNAD)",
  "Citizen Missing Person DNA Submission App",
  "Extreme Degraded Sample Recovery AI",
  "Disaster Victim ID (DVI) Mass DNA Matcher",
  "DNA Lab Budget/Expense Tracker AI",
  "Custom Workflow/Approval for DNA Access",
  "AI Driven DNA Backlog Reduction Predictor",
  "Predictive Need for DNA Machine Upgrade",
  "Custom Alert Trigger for DNA Lab Head"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DNA CASE TRACKING
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI DNA CASE TRACKING</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in dna sample chain-of-custody, codis/national dna index & paternity verification.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DNA CASE <span>TRACKING</span></h1>
            <p className="cyber-subtitle">DNA Sample Chain-of-Custody, CODIS/National DNA Index & Paternity Verification</p>
          </div>
        </div>
      </header>
...
export default DNACaseTrackingDetailed;
