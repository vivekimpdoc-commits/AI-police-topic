...
const aiExperts = [
  "Vulnerability Assessment Matrix Calculator AI",
  "Secure Data Leak Warning Alert Notification Bot",
  "IT Infrastructure Risk Monitor Engine AI",
  "Mitigation Plan Recommender Algorithm Bot",
  "Risk Severity Level Auto-Classifier Engine AI",
  "Internal Network Traffic Anomaly Detector Bot",
  "Data Access Pattern Intrusion Detector Engine",
  "Threat Intelligence Update Tracker Engine AI",
  "Risk Register Command Dashboard Portal",
  "Voice-Command Risk Status Search Query Bot",
  "Automated Weekly Risk Audit Report Generator",
  "Cross-Office Risk Management Sync Engine AI",
  "Risk Certificate QR Pass Verification Engine",
  "Suspicious Server Access Log Alert Monitor Bot",
  "IT Network Hardware Device Health Monitor Bot",
  "Risk Mitigation Action Progress Tracker Bot",
  "AI Evaluator for Office Risk Mitigation Score %",
  "Audit/Risk Modification History Log Generator",
  "Data Privacy/IT Server Log User Identity Masker",
  "Police-Cyber Security Command Center Sync Bot",
  "IT Security Admin Mobile App Alert Portal Sync",
  "Cold Case Network Incident Signature Matcher AI",
  "Senior Officer (ADG Cyber Security) Briefing",
  "Public Department System Uptime Status Portal",
  "Blockchain Immutable Risk Mitigation Log Hasher",
  "Anti-DDoS Attack Virtual Perimeter Shield AI",
  "Mobile App for Quick IT Asset Inventory Scan",
  "Bluetooth Beacon Server Room Access Auditor Bot",
  "Multi-Lingual IT Security Manual Translation Bot",
  "Historical Cyber Attack Pattern Trend Matcher",
  "Staff IT Security SOP Compliance Trainer Engine",
  "Risk Database Server Node Cluster Health Monitor",
  "Urgent Severe Data Breach Emergency Alert AI",
  "Traffic/Transit Network Segment Load Balancer",
  "Cyber Malware Signature Database Matcher Bot AI",
  "VIP High-Security Data Communication Linker Bot",
  "AI Assisted Post-Incident Risk Analysis Report",
  "Risk Dashboard Queue Priority Load Balancer AI",
  "Mitigation System Efficacy Scorer Algorithm Bot",
  "Integration with National Cyber Security Database",
  "Citizen Data Privacy Complaint Voice Assistant",
  "Extreme Network Event Peak Traffic Load Modeler",
  "Disaster Emergency Backup Power System Monitor",
  "Risk Management System Maintenance Budget Tracker",
  "Custom Workflow/Approval for Risk Category Change",
  "AI Driven Emerging Cyber Threat Trend Predictor",
  "Predictive Need for Specialized Security Patch",
  "Custom Alert Trigger for Cyber Security Chief"
];
...
const InternalRiskRegisterDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INTERNAL RISK REGISTER
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI INTERNAL RISK REGISTER</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in vulnerability assessment matrix, secure data leak alarms, it infrastructure risk & mitigation plans.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INTERNAL RISK <span>REGISTER</span></h1>
            <p className="cyber-subtitle">Vulnerability Assessment Matrix, Secure Data Leak Alarms, IT Infrastructure Risk & Mitigation Plans</p>
          </div>
        </div>
      </header>
...
export default InternalRiskRegisterDetailed;
