...
const aiExperts = [
  ...
  "Legal Precedent Correlator Bot",
  "Investigative Best Practice Summarizer",
  "Knowledge Tagging & Indexing Engine",
  "Cross-Department Query Router",
  "Historical Case Studies Analyzer",
  "SOP vs Real-world Action Comparer",
  "Subject Matter Expert (SME) Matcher",
  "Knowledge Hub Command Dashboard",
  "Voice-Command Library Assistant Bot",
  "Automated Daily Knowledge Brief",
  "Inter-State Policy Sync Bot",
  "Legal Update Alert System AI",
  "Forensic Procedure Knowledge Bot",
  "Cyber Crime Case Study Aggregator",
  "Crowdsourced Officer Tip Validator",
  "AI Evaluator for Document Relevance",
  "Audit/Knowledge Access Log Gen",
  "Data Privacy/Sensitive Case Scrubber",
  "National Police Academy Repo Sync",
  "Field IO Quick-Reference App",
  "Cold Case Methodology Extractor AI",
  "Senior Officer Research Briefing",
  "Knowledge Transfer Resource Allocator",
  "Blockchain Immutable Document Hash",
  "Anti-Tamper Knowledge Vault Shield",
  "Mobile App for Offline Reading",
  "Jurisdictional Law Variation Matcher",
  "Multi-Lingual Document Translator",
  "Historical Legal Evolution Analyzer",
  "Legal Drafting Training Assistant",
  "Knowledge DB Server Monitor",
  "Urgent Supreme Court Ruling Alert",
  "Organized Crime Takedown SOP Profiler",
  "VIP/High-Profile Case Best Practices",
  "AI Assisted Case Prep Outline Drafter",
  "Document Storage & Archival Forecaster",
  "Secure Whistleblower Method Protector",
  "Integration with Judicial e-Library",
  "Citizen Legal Rights Portal Sync",
  "Riot Control Case Studies Modeler",
  "Disaster Response SOP Coordinator",
  "Knowledge Hub Maintenance Budget Tracker",
  "Custom Workflow for Document Approval",
  "AI Driven Training Needs Predictor",
  "Predictive Need for SOP Update",
  "Custom Alert Trigger for Nodal Training",
  "Document Lifespan & Deprecation Tracker"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI KNOWLEDGE HUB
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI KNOWLEDGE <span>HUB</span></h1>
...
export default KnowledgeHubDetailed;
