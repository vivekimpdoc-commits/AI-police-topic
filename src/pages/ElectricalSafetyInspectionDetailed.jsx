...
const aiExperts = [
  "IoT Short-Circuit/Arc Fault Predictor AI",
  "Thermal Imaging Panel/Breaker Analyzer",
  "Phase Load Balancing/Overload Monitor",
  "Fire Hazard/Spark Detection Bot",
  "DG (Diesel Generator) Health/Sync AI",
  "Earth/Grounding Resistance Checker",
  "Geo-Spatial Electrical Layout/Grid Mapper",
  "Harmonics/Power Quality Analyzer",
  "Electrical Safety Dashboard",
  "Voice-Command Power Status Bot",
  "Automated Monthly Safety Audit Report",
  "State Electricity Board Sync Bot",
  "Old Wiring/Insulation Degradation Scorer",
  "Server Room Power Redundancy Monitor",
  "Substandard/Fake Cable Detector",
  "Energy Waste/Vampire Draw Identifier",
  "AI Evaluator for Fire Risk Index",
  "Audit/Inspection Log Generator",
  "Data Privacy/Usage Pattern Scrubber",
  "Fire/Emergency Services Sync",
  "Electrician Dispatch/AR App",
  "Historical Fire/Short-Circuit Correlator",
  "Estate/Fire Officer Briefing AI",
  "Maintenance/Rewiring Task Allocator",
  "Blockchain Immutable Safety Audit Hash",
  "Anti-Tamper Compliance Shield",
  "Mobile App for Tripping/Fault Reporting",
  "Station-wise Power Efficiency Benchmarker",
  "Automated Reminder for Panel Servicing",
  "Historical Maintenance Cost Analyzer",
  "Electrical Safety SOP/Code Trainer",
  "Smart Meter/IoT Gateway Monitor",
  "Imminent Fire/Meltdown Alert",
  "Vendor Negligence/Poor Wiring Profiler",
  "High-Risk/Armory Electrical Zone Classifier",
  "AI Assisted Rewiring Proposal Drafter",
  "Thermal Scan/Telemetry Storage Forecaster",
  "Secure Grid/Network Blueprint Protector",
  "Integration with Building Fire Alarms",
  "Green Energy/Solar Integration Sync",
  "Summer Overload/Heatwave Modeler",
  "Flood/Water-Logging Electrocution Coordinator",
  "Electrical Upgrade/Maintenance Budget Tracker",
  "Custom Workflow for Emergency Power Cut",
  "AI Driven Lifespan/Rewiring Predictor",
  "Predictive Need for Substation Upgrade",
  "Custom Alert Trigger for Quartermaster",
  "Electrical Infrastructure Lifecycle Tracker"
];
...
const ElectricalSafetyInspectionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ELECTRICAL SAFETY INSPECTION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ELECTRICAL SAFETY <span>INSPECTION</span></h1>
...
export default ElectricalSafetyInspectionDetailed;
