...
const aiExperts = [
  "Barcode/RFID Physical File Tracker",
  "Delay/Bottleneck Detection AI",
  "E-Office (Digital File) Integrator",
  "Lost/Misplaced File Predictor",
  "Desk-by-Desk Transit Time Analyzer",
  "Urgency/Priority Routing Engine",
  "Geo-Spatial File Location Mapper",
  "File Content/Metadata NLP Extractor",
  "File Movement Dashboard",
  "Voice-Command File Query Bot",
  "Automated Daily Pending File Report",
  "Departmental Record Room Sync",
  "Multi-Lingual File Noting Translator",
  "Physical-to-Digital Discrepancy Checker",
  "Fake/Tampered Noting Predictor",
  "Automated Forwarding Suggestion Bot",
  ...
  "Officer Pending File Mobile App",
  "Historical Bottleneck Correlator AI",
  "Supervisory Officer Briefing AI",
  "Re-routing/Escalation Allocator",
  "Blockchain Immutable Transit Hash",
  "Anti-Tamper Noting Shield",
  "Mobile App for File Handover/Takeover",
  "Section-wise Efficiency Benchmarker",
  "Automated Reminder for Stalled Files",
  "Historical File Loss Rate Analyzer",
  "File Handling SOP Trainer",
  "Tracking DB Server Health Monitor",
  "Imminent Deadline/Default Alert",
  "Habitual File Hoarder Profiler",
  "High-Priority/Court-Bound File Classifier",
  "AI Assisted Explanation Call Drafter",
  "Physical Storage/Compactor Forecaster",
  "Secure Classified File Protector",
  "Integration with National E-Vidhaan/E-Office",
  "RTI Applicant Portal Sync",
  "Election Related File Modeler",
  "Disaster Relief Fund File Coordinator",
  "File Digitization Budget Tracker",
  "Custom Workflow for Reconstructing Lost Files",
  "AI Driven Approval Time Predictor",
  "Predictive Need for Additional Staff (Clerical)",
  "Custom Alert Trigger for Nodal Officers",
  "File Lifecycle Timeline Tracker"
];
...
const FileMovementTrackerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI FILE MOVEMENT TRACKER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI FILE MOVEMENT <span>TRACKER</span></h1>
...
export default FileMovementTrackerDetailed;
