...
const aiExperts = [
"Relief Truck Anti-Looting Threat Predictor",
  "Armed Escort/Guard Allocation Engine AI",
  "GPS Route Optimization for Heavy Trucks",
  "Convoy Green-Corridor/Traffic Clear Bot",
  "High-Value (Medicine/Cash) Escort Prioritizer",
  "Bridge/Road Load Capacity Verifier AI",
  "Fuel/Rest Stop Security Planning Bot",
  "Real-Time Convoy GPS Tracking Dashboard",
  "Ambush/Blockade Early Warning System",
  "Drone Aerial Overwatch Sync for Convoys",
  "Command Center Convoy Escort Dashboard",
  "Voice-Command Convoy Location Query",
  "Automated Convoy Dispatch/Arrival Logger",
  "Inter-District Border Checkpost Clearance Sync",
  "Breakdown/Accident Quick Response (QRT) AI",
  "Weather/Visibility (Fog/Rain) Modeler",
  "Night Travel Security Enforcer Bot",
  "Multi-Truck Convoy Pacing & Spacing AI",
  "NGO/Private Relief Truck Integration Bot",
  "Driver Background/Verification Check AI",
  "AI Evaluator for Escort Threat Level",
  "Incident/Looting Attempt Log Generator",
  "Data Privacy/Convoy Manifest Info Masker",
  "Police-Army Joint Escort Sync Engine",
  "Riot/Mob Congregation Heatmap Avoider",
  "Fuel/Ration Burn-Rate for Escort Team",
  "Senior Officer (Traffic/Security DGP) Briefing",
  "Public Alert for Convoy Movement Drafter",
  "Blockchain Immutable Log of Relief Delivery",
  "Weapon/Ammo Inventory Tracker for Escorts",
  "Mobile App for Escort Commander Sync",
  "Airdrop/Helicopter Relief Escort Sync",
  "Multi-Lingual Driver Communication Bot",
  "Historical Convoy Ambush Precedent Matcher",
  "Medical Emergency/Ambulance Escort AI",
  "Escort Personnel Fatigue Monitor Bot",
  "Temporary Route Diversion/Naka Sync",
  "Toll-Plaza Auto-Clearance/FASTag Sync",
  "Landslide/Flood Route Blockage Alert",
  "Armed Insurgency/Naxal Zone Escort Modeler",
  "AI Assisted Post-Convoy Debriefing Gen",
  "Vehicle Repair/Tow-Truck Standby Alert",
  "VIP/Foreign Dignitary Relief Escort AI",
  "Integration with State Transport Dept",
  "Citizen SOS for Relief Router AI",
  "Heatwave/Cold-Wave Driver Safety Modeler",
  "Empty Convoy Return Journey Security AI",
  "Convoy Fuel/Logistics Expense Tracker",
  "Custom Workflow/Approval for Route Change",
  "AI Driven Threat De-escalation Predictor",
  "Predictive Need for Additional Force",
  "Custom Alert Trigger for Convoy Commander"
];
...
const ReliefConvoyEscortManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI RELIEF CONVOY ESCORT MANAGEMENT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI RELIEF CONVOY ESCORT MANAGEMENT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in preventing looting, armed escort scheduling & gps route optimization.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI RELIEF CONVOY <span>ESCORT MANAGEMENT</span></h1>
            <p className="cyber-subtitle">Preventing Looting, Armed Escort Scheduling & GPS Route Optimization</p>
          </div>
        </div>
      </header>
...
export default ReliefConvoyEscortManagementDetailed;
