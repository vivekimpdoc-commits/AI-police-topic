...
const aiExperts = [
  "Festival Shop Location Risk Assessor",
  "Fire Safety/Clearance Compliance Tracker",
  "Green Cracker (NEERI) Validation Engine",
  "Temporary License/Stall Routing AI",
  "Crowd Density/Congestion Analyzer",
  "Distance from Hazardous Site (Petrol Pumps) Calculator",
  "Geo-Spatial Fireworks Market Mapper",
  "Automated Police/Fire/Traffic NOC Router",
  "Fireworks Permission Dashboard",
  "Voice-Command Application Query Bot",
  "Automated Diwali/Festival Readiness Report",
  "Fire Department/Chief Fire Officer Sync",
  "Illegal Storage/Stockpiling Risk Predictor",
  "Fake Green-Cracker Certification Alert",
  "Traffic Chokepoint (Near Market) Estimator",
  "Application Bottleneck/Pendency Analyzer",
  "AI Evaluator for Festival Safety Index",
  "Audit/Approval Log Generator",
  "Data Privacy/Vendor Details Scrubber",
  "Pollution Control Board Sync",
  "Beat Officer/Fire Inspector Mobile App",
  "Historical Fire Accident/Casualty Correlator",
  "City Magistrate/SP City Briefing Interface",
  "Joint Physical Verification Task Allocator",
  "Blockchain Immutable Approval/NOC Hash",
  "Anti-Tamper Temporary License Shield",
  "Mobile App for Geo-tagged Stall Verification",
  "Station-wise Safety Clearance Benchmarker",
  "Automated Alert for Unlicensed/Roadside Sales",
  "Historical Festival Deployment Cost Analyzer",
  "Explosives/Fireworks SOP Trainer",
  "E-District/Citizen Portal API Monitor",
  "Imminent AQI/Pollution Emergency Alert",
  "Habitual Illegal Vendor/Stockist Profiler",
  "High-Congestion (Wholesale Market) Classifier",
  "AI Assisted Seizure/Cancellation Order Drafter",
  "Fireworks Sales Volume/Stall Demand Forecaster",
  "Secure Whistleblower (Illegal Stock) Protector",
  "Integration with Local Municipality/Corporation",
  "Traffic Police Sync (for Market Diversions)",
  "Election (Victory Celebration) Rapid NOC Modeler",
  "Disaster (Market Fire) Emergency Response Coordinator",
  "Fire Tender/Emergency Equipment Deployment Tracker",
  "Custom Workflow for Permanent Magazine/Godowns",
  "AI Driven Fire Incident Probability Predictor",
  "Predictive Need for Decentralized Sale Venues",
  "Custom Alert Trigger for District Magistrate",
  "Application Receipt to Final NOC Issuance Timeline"
];
...
const FireworksPermissionManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI FIREWORKS PERMISSION MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI FIREWORKS PERMISSION <span>MANAGEMENT</span></h1>
...
export default FireworksPermissionManagementDetailed;
