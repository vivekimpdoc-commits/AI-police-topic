...
const aiExperts = [
  "Automated Handover/Relieving Note Generator AI",
  "Succession Planning/Competency Analytics Engine",
  "Desk-Specific SOP/Routine Extractor NLP",
  "Minimal Disruption Transition Modeler",
  "Pending Task/File Flagging Bot",
  "Critical Contact/Network Handover AI",
  "Geo-Spatial Jurisdiction Familiarity Mapper",
  "Role-to-Skill Fitment Scorer",
  "Knowledge Continuity Dashboard",
  "Voice-Command Handover Query Bot",
  "Automated Transfer/Posting Transition Report",
  "HRMS/Personnel Department Sync",
  "Transition Disruption/Vulnerability Predictor",
  "Incomplete Handover/Missing File Alert",
  "Steep Learning Curve/Skill Gap Analyzer",
  "Loss of Informant/Source Network Predictor",
  "AI Evaluator for Transition Smoothness Index",
  "Audit/Handover Log Generator",
  "Data Privacy/Confidential File Scrubber",
  "State Police Establishment Board Sync",
  "Transferred/Incoming Officer Mobile App",
  "Historical Post-Transfer Inefficiency Correlator",
  "IG (Personnel/Administration) Briefing AI",
  "Handover Briefing/Overlap Task Allocator",
  "Blockchain Immutable Handover Hash",
  "Anti-Tamper Relieving Note Shield",
  "Mobile App for Quick Desk Familiarization",
  "Unit-wise Transition Efficiency Benchmarker",
  "Automated Alert for Abrupt/Unplanned Transfers",
  "Historical Transition/Training Cost Analyzer",
  "Transfer/Relieving Protocol SOP Trainer",
  "HRMS/Database Sync API Health Monitor",
  "Imminent Operational Halt (Due to Bad Handover) Alert",
  "Habitual Poor-Documenter/Hoarder Profiler",
  "High-Stakes (SHO/SP/Intelligence) Role Classifier",
  "AI Assisted Formal Charge Assumption Drafter",
  "Retirement/Transfer Wave Forecaster",
  "Secure Classified Desk Note Protector",
  "Integration with E-Office/File Tracking System",
  "State Secretariat/Home Department Sync",
  "Election Sudden Transfer Disruption Modeler",
  "Disaster Nodal Officer Transition Coordinator",
  "Training/Onboarding Budget Tracker",
  "Custom Workflow for Suspended/Dismissed Officers",
  "AI Driven Competency Mastery Time Predictor",
  "Predictive Need for Shadowing/Overlap Period",
  "Custom Alert Trigger for DGP",
  "Transfer Order to Full Operational Control Timeline"
];
...
const KnowledgeContinuityManagerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI KNOWLEDGE CONTINUITY MANAGER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI KNOWLEDGE CONTINUITY <span>MANAGER</span></h1>
...
export default KnowledgeContinuityManagerDetailed;
