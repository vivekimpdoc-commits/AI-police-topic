...
const aiExperts = [
  "Auto Outward Number/Barcode Generator",
  "Postage/Weight Calculator AI",
  "Courier/India Post API Integrator",
  "Delivery Acknowledgment/RTO Tracker",
  "Bulk Dispatch Optimizer",
  "Sender/Branch Cost Apportionment",
  "Geo-Spatial Dispatch Destination Mapper",
  "Address Verification/Correction AI",
  "Dispatch Register Dashboard",
  "Voice-Command Dispatch Query Bot",
  "Automated Daily Dispatch/Cost Report",
  "Postal Department Sync Bot",
  "Multi-Lingual Address Translation",
  "Delay in Transit Predictor",
  "Fake/Wrong Address Detector",
  "Postage Stamp Inventory Monitor",
  "AI Evaluator for Dispatch Efficiency",
  "Audit/Dispatch Log Generator",
  ...
  "Urgent/Court Notice Classifier",
  "AI Assisted Reminder/Resend Drafter",
  "Dispatch Log Storage Forecaster",
  "Secure Confidential Dispatch Protector",
  ...
  "Dispatch to Delivery Timeline Tracker"
];
...
const DispatchRegisterDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DISPATCH REGISTER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DISPATCH <span>REGISTER</span></h1>
...
export default DispatchRegisterDetailed;
