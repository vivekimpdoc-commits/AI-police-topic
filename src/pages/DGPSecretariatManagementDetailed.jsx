...
const aiExperts = [
  "DGP Executive Dashboard Engine",
  "VIP/DO Letter Priority Tracker",
  "State-Wide Law & Order Heatmap AI",
  "CM/Home Minister Directive Sync",
  "Confidential/Top-Secret File Router",
  "Appointment/Visitor Vetting Bot",
  "Geo-Spatial Critical Incident Mapper",
  "Media/Sentiment Briefing Generator",
  "Secretariat Workflow Dashboard",
  "Voice-Command Executive Query Bot",
  "Automated Daily Morning Briefing Report",
  "MHA/IB (Intelligence Bureau) Sync",
  "Multi-Lingual Dak Translation",
  "Vague/Delayed Reply Detector AI",
  "Unauthorized Access Predictor",
  "Executive Summary/Abstract Generator",
  "AI Evaluator for Responsiveness",
  "Audit/Approval Log Generator",
  "Data Privacy/Classified Info Scrubber",
  "State Intelligence Department Sync",
  "DGP Mobile Briefing App",
  "Historical Crisis/Event Correlator",
  "Staff Officer (SO to DGP) Briefing AI",
  "Task/Delegation Engine",
  "Blockchain Immutable Secretariat Hash",
  "Anti-Tamper Top-Secret Shield",
  "Mobile App for Immediate Approval",
  "Branch-wise Pendency Benchmarker",
  "Automated Alert for CM/PM Deadlines",
  "Historical VIP Reference Analyzer",
  "Secretariat Protocol SOP Trainer",
  "Executive Server Health Monitor",
  "Imminent Privilege Motion/Contempt Alert",
  "Serial Defaulter (ADG/IG level) Profiler",
  "High-Priority Election/Disaster File Classifier",
  "AI Assisted Speaking Notes Drafter",
  "Classified Data Storage Forecaster",
  "Secure Vault/SCIF Layout Protector",
  "Integration with E-Courts/Tribunals",
  "Zero Public Exposure Policy Sync",
  "Election Code of Conduct Directive Modeler",
  "Disaster Emergency Command Coordinator",
  "Secretariat/Contingency Budget Tracker",
  "Custom Workflow for Cabinet Note Approval",
  "AI Driven Policy Impact Predictor",
  "Predictive Need for High-Level Review",
  "Custom Alert Trigger for DGP",
  "Secretariat File Lifecycle Timeline"
];
...
const DGPSecretariatManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DGP SECRETARIAT MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DGP SECRETARIAT <span>MANAGEMENT</span></h1>
...
export default DGPSecretariatManagementDetailed;
