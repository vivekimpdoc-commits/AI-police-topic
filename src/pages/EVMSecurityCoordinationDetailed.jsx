...
const aiExperts = [
"EVM/VVPAT Tamper/Shock Sensor Alert AI",
  "Armed Escort & Guard Allocation Engine",
  "GPS Route Optimization for EVM Trucks",
  "EVM Dispatch/Receipt Geo-Fencing Bot",
  "Barcode/RFID Scanning Sync for EVMs",
  "Sector Officer EVM Handover Logger AI",
  "EVM Storage/Warehouse Pre-Poll Security",
  "EVM Replacement/Defect Tracking Security AI",
  "Command Center EVM Security Dashboard",
  "Voice-Command EVM Location Query",
  "Automated EVM Transit Time Logger",
  "Inter-District EVM Transfer Security Sync",
  "Vehicle Breakdown Quick Response (QRT) AI",
  "Multi-Tier EVM Security Cordon Allocator",
  "Night Storage at Polling Booth Security AI",
  "EVM Seal Verification Video Analytics",
  "AI Evaluator for EVM Protocol Compliance",
  "Audit/Tamper Attempt Log Auto-Generator",
  "Data Privacy/Officer ID Masker Protocol",
  "Police-Election Commission Joint Sync",
  "Fake EVM/Rumor Debunking Social Media Bot",
  "Fuel/Rest Stop EVM Guarding Planner",
  "Senior Officer (Returning Officer) Briefing",
  "Public Transparency Video Stream Linker",
  "Blockchain Immutable Log of EVM Custody",
  "Drone Overwatch for EVM Convoys",
  "Mobile App for Sector Magistrate Sync",
  "Helicopter EVM Airlift Security Coordinator",
  "Multi-Lingual Instruction Bot for Escorts",
  "Historical EVM Theft Precedent Matcher",
  "Mock-Poll EVM Clearance Security Tracker",
  "Escort Guard Fatigue/Alertness Monitor",
  "Temporary Checkpost EVM Clearance Bot",
  "Traffic Green-Corridor for EVM Dispatch",
  "Shadow Zone Offline Barcode Sync Engine",
  "Naxal/Insurgency Area EVM Escort Modeler",
  "AI Assisted Post-Poll EVM Sealing Audit",
  "Weapon/Ammo Check for EVM Guards Alert",
  "Political Agent Escort Tracking Linker",
  "Integration with ECI EVM Tracking System (ETS)",
  "Citizen Complaint of EVM Tampering Router",
  "Extreme Weather Protection for EVMs AI",
  "Post-Counting EVM Return Journey Security",
  "EVM Transport Logistics/Expense Tracker",
  "Custom Workflow/Approval for EVM Swap",
  "AI Driven Threat Predictive Modeler",
  "Predictive Need for Additional Escorts",
  "Custom Alert Trigger for Returning Officer"
];
...
const EVMSecurityCoordinationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI EVM SECURITY COORDINATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI EVM SECURITY COORDINATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in secure transport of evms/vvpats, armed escort sync & anti-tamper alerts.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI EVM SECURITY <span>COORDINATION</span></h1>
            <p className="cyber-subtitle">Secure Transport of EVMs/VVPATs, Armed Escort Sync & Anti-Tamper Alerts</p>
          </div>
        </div>
      </header>
...
export default EVMSecurityCoordinationDetailed;
