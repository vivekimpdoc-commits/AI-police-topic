...
const aiExperts = [
  "Zone/Branch Command Dashboard AI",
  "Policy Implementation Tracker Bot",
  "DGP Directive Compliance Monitor",
  "Specialized (L&O/Admin/Intel) Workflow Engine",
  "Subordinate (IG/DIG) Performance Scorer",
  "Cross-Branch Coordination Linker",
  "Geo-Spatial Zonal Crime Mapper",
  "Budget/Fund Allocation Optimizer",
  "ADG Office Management Dashboard",
  "Voice-Command Branch Query Bot",
  "Automated Weekly Zonal Briefing Report",
  "DGP Secretariat Sync",
  "Multi-Lingual Circular Translation",
  "Bottleneck/Delay Detector AI",
  "Favoritism/Bias in Allocation Predictor",
  "Summary/Abstract of Subordinate Reports Generator",
  "AI Evaluator for Zonal Efficiency",
  "Audit/Routing Log Generator",
  "Data Privacy/Internal Branch Scrubber",
  "Finance/Accounts Sync",
  "ADG Mobile Command App",
  "Historical Zonal Crime/Event Correlator",
  "Staff Officer Briefing AI",
  "Task/Investigation Delegation Engine",
  "Blockchain Immutable Branch Hash",
  "Anti-Tamper Zonal Record Shield",
  "Mobile App for Field Approvals",
  "Range-wise (IG) Performance Benchmarker",
  "Automated Alert for DGP Deadlines",
  "Historical Zonal Expenditure Analyzer",
  "Branch-specific SOP/Rule Trainer",
  "Zonal Database Server Health Monitor",
  "Imminent L&O Breakdown Alert",
  "Non-Performing IG/DIG Profiler",
  "High-Priority Court/NHRC File Classifier",
  "AI Assisted Zonal Circular Drafter",
  "Zonal Data Storage Forecaster",
  "Secure Branch File Protector",
  "Integration with CCTNS/ICJS",
  "Internal Grievance Portal Sync",
  "Election Zonal Deployment Modeler",
  "Disaster Zonal Resource Coordinator",
  "Zonal Allocation Budget Tracker",
  "Custom Workflow for Inter-Zone Transfers",
  "AI Driven Crime Trend Predictor",
  "Predictive Need for Force Reallocation",
  "Custom Alert Trigger for ADG",
  "Branch Policy Lifecycle Timeline Tracker"
];
...
const ADGOfficeManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ADG OFFICE MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ADG OFFICE <span>MANAGEMENT</span></h1>
...
export default ADGOfficeManagementDetailed;
