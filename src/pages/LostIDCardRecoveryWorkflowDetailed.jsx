...
const aiExperts = [
  "Automated Card Blacklisting/Deactivation AI",
  "FIR/General Diary (GD) Entry Sync Bot",
  "Remote Wipe/Digital Revocation Engine",
  "Re-issuance Progress/Tracking AI",
  "Fraud/Misuse Attempt Detector",
  "Penalty/Fine Calculation Engine",
  "Geo-Spatial Loss Location Mapper",
  "Duplicate Request/Hoarding Analyzer",
  "Lost ID Recovery Dashboard",
  "Voice-Command Status Query Bot",
  "Automated Monthly Lost Asset Report",
  "HRMS/Personnel Department Sync",
  "Suspicious Frequency of Loss Predictor",
  "Found/Recovered Card Alert AI",
  "Identity Theft Risk Scorer",
  "Temporary/Provisional Pass Issuer",
  "AI Evaluator for Recovery/Replacement Speed",
  "Audit/Blacklist Log Generator",
  "Data Privacy/Compromised ID Scrubber",
  "State Intelligence/Security Sync",
  "Officer Loss Reporting Mobile App",
  "Historical Loss/Theft Correlator (by Area)",
  "SP (Administration) Briefing AI",
  "Printing/Dispatch Task Allocator",
  "Blockchain Immutable Blacklist Hash",
  "Anti-Tamper Revocation Record Shield",
  "Mobile App for Found Card Scanning",
  "Re-issuance Turnaround Time Benchmarker",
  "Automated Alert for Unauthorized Use Attempt",
  "Historical Replacement Cost/Penalty Analyzer",
  "Lost Asset Reporting/Security SOP Trainer",
  "Blacklist Database Sync Monitor",
  "Imminent Impersonation/Breach Alert",
  "Habitual Loser/Careless Officer Profiler",
  "High-Security (Commando/Intel) ID Classifier",
  "AI Assisted Show-Cause Notice Drafter",
  "Blacklist Data Storage Forecaster",
  "Secure Master Access Control Protector",
  "Integration with CCTNS (for Lost Article Report)",
  "Public Found Item Portal Sync",
  "Election Duty Lost ID Rapid Replacement Modeler",
  "Disaster Deployment Lost ID Coordinator",
  "Smart Card/Printing Budget Tracker",
  "Custom Workflow for Stolen Wallet/Badge",
  "AI Driven Monthly Replacement Predictor",
  "Predictive Need for Lanyard/Holder Redesign",
  "Custom Alert Trigger for IG Security",
  "Report of Loss to New Card Issuance Timeline"
];
...
const LostIDCardRecoveryWorkflowDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI LOST ID CARD RECOVERY WORKFLOW
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI LOST ID CARD RECOVERY <span>WORKFLOW</span></h1>
...
export default LostIDCardRecoveryWorkflowDetailed;
