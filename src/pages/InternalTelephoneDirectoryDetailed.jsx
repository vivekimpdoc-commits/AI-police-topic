...
const aiExperts = [
  "Intercom Extension/Desk Mapper AI",
  "EPABX/PBX System Integrator Bot",
  "Call Routing/Forwarding Rule Engine",
  "VoIP/Softphone Directory Services AI",
  "Auto-Attendant/IVR Menu Optimizer",
  "Desk Relocation/Shift Sync Bot",
  "Geo-Spatial Desk/Extension Mapper",
  "Conference Bridge/Meeting Number Manager",
  "Telephone Directory Dashboard",
  "Voice-Command Extension Query Bot",
  "Automated Call Volume/Analytics Report",
  "IT/Telecom Department Sync",
  "Multi-Lingual IVR Generation",
  "Dead/Inactive Extension Detector",
  "Unauthorized Toll/ISD Call Predictor",
  "Call Recording/Transcription Indexer (where legal)",
  "AI Evaluator for Call Routing Efficiency",
  "Audit/Update Log Generator",
  "Data Privacy/Personal Number Scrubber",
  "State Police Control Room Sync",
  "Officer Intercom Search Mobile App",
  "Historical Call Bottleneck Correlator",
  "Telecom/IT Officer Briefing AI",
  "Maintenance/Repair Task Allocator",
  "Blockchain Immutable Extension Hash",
  "Anti-Tamper Routing Rule Shield",
  "Mobile App for Softphone Calling",
  "Department-wise Call Volume Benchmarker",
  "Automated Reminder for Faulty Lines",
  "Historical Call Peak Trend Analyzer",
  "Internal Communication SOP Trainer",
  "EPABX Server Health Monitor",
  "Imminent Switchboard Overload Alert",
  "Faulty Line/Hardware Failure Profiler",
  "Emergency/Hotline Classifier",
  "AI Assisted Telecom Upgrade Proposal Drafter",
  "Call Log/Database Storage Forecaster",
  "Secure Hotline/Encrypted Line Protector",
  "Integration with National Police Telecom Network",
  "Public Helpline Routing Sync",
  "Election Control Room Extension Modeler",
  "Disaster Emergency Helpline Coordinator",
  "Telecom/Intercom Maintenance Budget Tracker",
  "Custom Workflow for Encrypted Line Setup",
  "AI Driven Call Wait Time Predictor",
  "Predictive Need for Switchboard Upgrade",
  "Custom Alert Trigger for IT/Telecom SP",
  "Extension Allocation Lifecycle Tracker"
];
...
const InternalTelephoneDirectoryDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INTERNAL TELEPHONE DIRECTORY
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INTERNAL TELEPHONE <span>DIRECTORY</span></h1>
...
export default InternalTelephoneDirectoryDetailed;
