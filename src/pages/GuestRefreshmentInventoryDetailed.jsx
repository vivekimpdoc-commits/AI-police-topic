...
const aiExperts = [
  "Smart Pantry/Stock Depletion Tracker",
  "Perishable Expiry/Spoilage Alert Bot",
  "Automated Reorder/Indent Generator",
  "Pilferage/Siphoning Detection AI",
  "Seasonal Demand/Beverage Optimizer",
  "Brand/Quality Specification Validator",
  "Geo-Spatial Pantry/Store Mapper",
  "Cost-Per-Serving Analytics Engine",
  "Refreshment Inventory Dashboard",
  "Voice-Command Stock Query Bot",
  "Automated Monthly Consumption Audit",
  "Quartermaster/Stores Department Sync",
  "Unusual Consumption Surge Detector",
  "Rodent/Pest Vulnerability Predictor",
  "Fake/Substandard Supply Identifier",
  "Shelf-Life/FIFO (First-In-First-Out) Enforcer",
  "AI Evaluator for Pantry Efficiency",
  "Audit/Stock-Out Log Generator",
  "Data Privacy/Indent Log Scrubber",
  "Finance/Accounts (Audit) Sync",
  "Pantry Manager/Steward Mobile App",
  "Historical Summer/Winter Demand Correlator",
  "Estate Officer/SP Admin Briefing AI",
  "Restocking Task Allocator",
  "Blockchain Immutable Supply Hash",
  "Anti-Tamper Inventory Ledger Shield",
  "Mobile App for Delivery Barcode Scan",
  "Pantry-wise Efficiency Benchmarker",
  "Automated Alert for Critical Low Stock",
  "Historical Refreshment Expenditure Analyzer",
  "Pantry Hygiene/Stocking SOP Trainer",
  "Cold Storage/Fridge Health Monitor",
  "Imminent Stock Exhaustion (VIP Visit) Alert",
  "Habitual Pilferer/Wastage Profiler",
  "Premium/VIP (Imported) Goods Classifier",
  "AI Assisted Vendor Replenishment Drafter",
  "Inventory Ledger Storage Forecaster",
  "Secure Vendor Pricing Protector",
  "Integration with Police Canteen (CSD)",
  "E-Tendering/Procurement Sync",
  "Election Control Room 24x7 Stock Modeler",
  "Disaster Emergency Ration Coordinator",
  "Hospitality/Refreshment Budget Tracker",
  "Custom Workflow for Bulk Procurement",
  "AI Driven Monthly Indent Predictor",
  "Predictive Need for Deep Cleaning",
  "Custom Alert Trigger for IG Provisioning",
  "Stock Receipt to Consumption Timeline"
];
...
const GuestRefreshmentInventoryDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI GUEST REFRESHMENT INVENTORY
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI GUEST REFRESHMENT <span>INVENTORY</span></h1>
...
export default GuestRefreshmentInventoryDetailed;
