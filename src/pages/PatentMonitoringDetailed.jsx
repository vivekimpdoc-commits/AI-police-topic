...
const aiExperts = [
  "Security Tech Patent Scraper AI",
  "Patent Infringement/Prior Art Detector",
  "Indigenous R&D Intellectual Property Protector",
  "Tech Transfer/Licensing Tracker",
  "Patent Expiry/Public Domain Alert Bot",
  "Rival Nation/Adversary Patent Mapper",
  "Geo-Spatial IP Origin/Filing Mapper",
  "Make-in-India/Indigenization Analyzer",
  "Patent Intelligence Dashboard",
  "Voice-Command IP Query Bot",
  "Automated Monthly IP Landscape Report",
  "Legal/Prosecution Department Sync",
  "Patent Troll/Litigation Risk Predictor",
  "Dual-Use Tech (Civil/Military) Detector",
  "Blocking Patent/Monopoly Identifier",
  "Innovation Gap/White-Space Analyzer",
  "AI Evaluator for Tech Sovereignty",
  "Audit/Scraping Log Generator",
  "Data Privacy/Legal Strategy Scrubber",
  "State IT/Industry Department Sync",
  "Legal Officer/Researcher App",
  "Historical IP Litigation Correlator",
  "DGP (Modernization) Briefing AI",
  "Patent Drafting/Filing Task Allocator",
  "Blockchain Immutable Prior-Art Hash",
  "Anti-Tamper Patent Record Shield",
  "Mobile App for Quick Idea IP Check",
  "OEM-wise IP Dominance Benchmarker",
  "Automated Alert for Threatening Tech Patents",
  "Historical Licensing/Royalty Cost Analyzer",
  "Intellectual Property/Patent SOP Trainer",
  "Global Patent Database API Monitor",
  "Imminent Tech Embargo/Licensing Denial Alert",
  "Aggressive IP Litigator Profiler",
  "Strategic (Encryption/Drone) Patent Classifier",
  "AI Assisted Legal Opposition Drafter",
  "Patent Document/Diagram Storage Forecaster",
  "Secure R&D Invention Disclosure Protector",
  "Integration with Indian Patent Office (IPO)",
  "DRDO/Academic Institute Sync",
  "Election Security IP (EVM Tech) Modeler",
  "Disaster Rescue Equipment IP Coordinator",
  "Legal/Patent Filing Budget Tracker",
  "Custom Workflow for Police-Owned Patents",
  "AI Driven Technology Monopoly Predictor",
  "Predictive Need for Indigenous Development",
  "Custom Alert Trigger for IG Tech",
  "Invention Disclosure to Grant Timeline"
];
...
const PatentMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI PATENT MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI PATENT <span>MONITORING</span></h1>
...
export default PatentMonitoringDetailed;
