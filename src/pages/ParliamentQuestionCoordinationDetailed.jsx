...
const aiExperts = [
  "Parliament Question NLP Extractor",
  "Lok/Rajya Sabha Priority Sorter",
  "National Level Precedent Matcher",
  "State vs Center Data Aggregation AI",
  "Ministry of Home Affairs (MHA) Router",
  "Draft Reply Formatting Assistant",
  "NCRB Data Sync & Verification Bot",
  "Center-State Contradiction Detector",
  "Parliament Coordination Dashboard",
  "Voice-Command Parliament Query Bot",
  "Automated Session Summary Report",
  "Inter-State Data Comparison Bot",
  "Supplementary Question Predictor AI",
  "National Political Sensitivity Scorer",
  "Federal Crime Stat Auto-Updater",
  "Pending Parliament Assurance Tracker",
  "AI Evaluator for Reply Accuracy",
  "Audit/Parliament Reply Access Log Gen",
  "Data Privacy/National Security Scrubber",
  "MHA Secretariat Sync Bot",
  "Field IO Data Request Alert App",
  "Past Parliament Session Matcher",
  "DGP/Chief Secretary Briefing AI",
  "Central Liaison Resource Allocator",
  "Blockchain Immutable Reply Hash",
  "Anti-Tamper Parliament Record Shield",
  "Mobile App for Session Alerts",
  "National Geographic Focus Matcher",
  "Multi-Lingual Question Translator",
  "Historical Parliament Trend Analyzer",
  "Parliamentary Procedure Trainer",
  "Parliament Coordination DB Monitor",
  "Urgent Session Deadline Alert Bot",
  "Organized Crime/Terror Question Profiler",
  "VIP/National Security Classifier",
  "AI Assisted Debate Prep Drafter",
  "Parliament Record Storage Forecaster",
  "Secure Informant Info Excluder",
  "Integration with Lok Sabha Portal",
  "National Media Coverage Analytics",
  "National Security Protest Modeler",
  "Disaster Relief Parliament Query Coordinator",
  "Parliament Cell Expense Tracker",
  "Custom Workflow for CM/Home Minister Approval",
  "AI Driven Follow-Up Question Predictor",
  "Predictive Need for National Press Briefing",
  "Custom Alert Trigger for Nodal Officers",
  "Session Lifecycle Timeline Tracker"
];
...
const ParliamentQuestionCoordinationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI PARLIAMENT QUESTION COORDINATION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI PARLIAMENT QUESTION <span>COORDINATION</span></h1>
...
export default ParliamentQuestionCoordinationDetailed;
