...
const aiExperts = [
  "Fire Exit Obstruction Vision AI",
  "Panic Bar/Door Hardware Health Monitor",
  "Emergency Lighting/Signage Status Tracker",
  "Automated Mock Drill/Evacuation Logger",
  "Stairwell Smoke Infiltration Predictor",
  "Fire Door Propped-Open Alert",
  "Geo-Spatial Exit Route Mapper",
  "Occupancy vs Exit Capacity Analyzer",
  "Fire Readiness Dashboard",
  "Voice-Command Exit Status Bot",
  "Automated Weekly Exit Compliance Report",
  "State Fire Service Sync",
  "Chokepoint/Bottleneck Predictor",
  "Corridor Combustible Load Detector",
  "Emergency Power/UPS Failure Alert",
  "Evacuation Time Optimizer",
  "AI Evaluator for Evacuation Efficiency",
  "Audit/Drill Log Generator",
  "Data Privacy/Occupancy Data Scrubber",
  "Estate/Infrastructure Sync",
  "Fire Safety Warden Mobile App",
  "Historical Evacuation Delay Correlator",
  "Chief Security Officer Briefing AI",
  "Clearance/Maintenance Task Allocator",
  "Blockchain Immutable Drill Hash",
  "Anti-Tamper Fire Safety Shield",
  "Mobile App for Obstruction Reporting",
  "Floor-wise Evacuation Speed Benchmarker",
  "Automated Alert for Blocked Fire Exits",
  "Historical Fire Upgrade Cost Analyzer",
  "Fire Safety/Evacuation SOP Trainer",
  "IoT Exit Sensor Health Monitor",
  "Imminent Trap Hazard Alert",
  "Habitual Rule-Breaker (Obstruction) Profiler",
  "High-Occupancy (Conference/Barrack) Exit Classifier",
  "AI Assisted Disciplinary Notice Drafter",
  "Drill Video/Data Forecaster",
  "Secure Evacuation Plan Protector",
  "Integration with Building Management System (BMS)",
  "Municipal Fire NOC Sync",
  "Election Mass Briefing Evacuation Modeler",
  "Disaster Rapid Evacuation Coordinator",
  "Fire Safety Equipment Budget Tracker",
  "Custom Workflow for Underground/Basement Exits",
  "AI Driven Evacuation Time Predictor",
  "Predictive Need for Additional Stairwells",
  "Custom Alert Trigger for SP Headquarters",
  "Obstruction Detection to Clearance Timeline"
];
...
const FireExitReadinessMonitorDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI FIRE EXIT READINESS MONITOR
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI FIRE EXIT READINESS <span>MONITOR</span></h1>
...
export default FireExitReadinessMonitorDetailed;
