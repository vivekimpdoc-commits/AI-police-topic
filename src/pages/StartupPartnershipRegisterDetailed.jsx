...
const aiExperts = [
  "GovTech Startup Onboarding/Vetting AI",
  "Problem-Statement to Startup Capability Matcher",
  "Funding/Grant Disbursement Tracker",
  "Procurement/GeM Compliance Auditor",
  "Startup Financial/Burn-Rate Analyzer",
  "Founder Background/Security Vetting Bot",
  "Geo-Spatial Startup Hub/Incubator Mapper",
  "Pilot to Scale-up Viability Scorer",
  "Startup Partnership Dashboard",
  "Voice-Command Startup Query Bot",
  "Automated Quarterly Ecosystem Report",
  "State Startup Nodal Agency Sync",
  "Startup Bankruptcy/Failure Predictor",
  "IP Conflict/Exclusivity Clause Detector",
  "Milestone/Deliverable Delay Alert",
  "Foreign Funding/Influence Analyzer",
  "AI Evaluator for GovTech Ecosystem Index",
  "Audit/Vetting Log Generator",
  "Data Privacy/NDA Compliance Scrubber",
  "Finance/Procurement Sync",
  "Nodal Officer/Incubator Manager App",
  "Historical Startup Success/Failure Correlator",
  "DGP (Modernization) Briefing AI",
  "Mentorship/Evaluation Task Allocator",
  "Blockchain Immutable NDA/Contract Hash",
  "Anti-Tamper Vetting Record Shield",
  "Mobile App for Startup Progress Pitch",
  "Incubator-wise Success Rate Benchmarker",
  "Automated Alert for Critical Milestone Miss",
  "Historical Startup Grant ROI Analyzer",
  "Startup Procurement/Exemption SOP Trainer",
  "GeM (Government e-Marketplace) API Monitor",
  "Imminent Startup Collapse/Abandonment Alert",
  "Fly-by-Night/Shell Startup Profiler",
  "High-Priority (Cyber/Drones) Startup Classifier",
  "AI Assisted Grant Disbursement Drafter",
  "Startup Pitch Deck/Code Storage Forecaster",
  "Secure Proprietary Algorithm Protector",
  "Integration with DPIIT (Dept for Promotion of Industry)",
  "Academic/IIT Incubation Cell Sync",
  "Election Tech (Voter Crowd Control) Startup Modeler",
  "Disaster Tech (UAV/Comms) Startup Coordinator",
  "Innovation Grant/Seed Fund Budget Tracker",
  "Custom Workflow for Equity/Revenue Sharing",
  "AI Driven Product Market Fit (for Police) Predictor",
  "Predictive Need for Policy/Procurement Exemption",
  "Custom Alert Trigger for IG Modernization",
  "Pitch to Procurement/Scale-up Timeline"
];
...
const StartupPartnershipRegisterDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI STARTUP PARTNERSHIP REGISTER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI STARTUP PARTNERSHIP <span>REGISTER</span></h1>
...
export default StartupPartnershipRegisterDetailed;
