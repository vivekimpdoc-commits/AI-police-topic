...
const aiExperts = [
"Image De-blurring & Enhancement AI",
  "Deepfake/AI-Generated Image Detector",
  "Facial Recognition in Crowds Engine",
  "Image Morphing/Manipulation (Photoshop) Analyzer",
  "Low-Light/Night-Vision Image Enhancer",
  "Weapon/Firearm Identification from Photos",
  "Tattoo/Scar/Birthmark Matcher AI",
  "Vehicle Make/Model/Color Classifier Bot",
  "License Plate (ANPR) Extraction from Still",
  "CCTV Snapshot Resolution Upscaler",
  "Blood-Spatter Pattern Preliminary Rater",
  "Footprint/Tire-Mark Database Matcher AI",
  "Command Center Real-time Image Dashboard",
  "Voice-Command Image Tag Query Bot",
  "Automated Facial Age Progression/Regression AI",
  "Suspect/Alias Image Clustering Engine",
  "Missing Person to Unidentified Body Matcher",
  "Emotion/Micro-Expression Baseline Analyzer",
  "Crowd Density/Riot Participant Counter",
  "Gang Sign/Graffiti/Logo Recognition AI",
  "Stolen Artwork/Antiquities Matcher",
  "Counterfeit Currency Watermark Scanner",
  "Forged Document/Stamp Image Analyzer",
  "Child Abuse (CSAM) Hash Flagging Protocol",
  "Object/Contraband (Drugs/Gold) Identifier",
  "AI Evaluator for Image Admissibility in Court",
  "Blockchain Immutable Hash of Enhanced Image",
  "Inter-Agency (Interpol/CBI) Face Sync Bot",
  "Social Media Scraped Image Authenticator",
  "Background/Location Geo-Estimator AI",
  "Lighting/Shadow Inconsistency Detector",
  "Pixel-Level Error Level Analysis (ELA) Bot",
  "Camera Sensor/Noise Fingerprint Matcher",
  "Reflection/Mirror Image Extractor AI",
  "Drone/UAV Aerial Recon Image Stitcher",
  "Suspect Gait/Posture Analysis from Stills",
  "Traffic Accident Damage/Impact Rater AI",
  "Wildlife/Poaching Animal Pelt Identifier",
  "Illegal Mining/Deforestation Satellite Matcher",
  "Fire/Arson Origin Point Image Rater",
  "AI Assisted Mugshot 3D Reconstructor",
  "Mobile App Field Photo Enhancer AI",
  "Data Privacy/Bystander Face Blurring",
  "Fake/Spoofed ID Card Template Matcher",
  "Victim Bruise/Injury Severity Classifier",
  "Terrorist/Insurgent Uniform/Insignia AI",
  "Riot/Protest Disguise/Mask Penetration AI",
  "Senior Officer (SP/DGP) Briefing Image Gen",
  "Custom Object Training/Definition Tool",
  "Integration with National Face DB (CCTNS)",
  "AI Driven Batch Image Categorization",
  "Predictive Linkage to Serial Offenses AI",
  "Disaster/Building Collapse Structural Rater",
  "Election Rally/Crowd Sentiment Visualizer",
  "Public Open-Data CCTV Image Scrubber",
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI IMAGE ANALYSIS
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI IMAGE ANALYSIS</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in deepfake detection, de-blurring, facial recognition & morphing analysis.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI IMAGE <span>ANALYSIS</span></h1>
            <p className="cyber-subtitle">Deepfake Detection, De-blurring, Facial Recognition & Morphing Analysis</p>
          </div>
        </div>
      </header>
...
export default ImageAnalysisDetailed;
