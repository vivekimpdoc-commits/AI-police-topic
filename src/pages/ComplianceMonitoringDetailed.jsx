...
const aiExperts = [
  "NHRC/SHRC Guideline Compliance Checker",
  "DK Basu Arrest Guidelines Auditor AI",
  "Custodial Death/Violence Risk Scorer",
  "Internal Police Circular Tracker",
  "RTI Query/Response Deadline Monitor",
  "Departmental Inquiry (DE) Milestone Tracker",
  "Women/Child Rights SOP Enforcer",
  "CCTNS/Internal HRMS Sync Engine",
  "Compliance Command Dashboard",
  "Voice-Command Guideline Query Bot",
  "Automated Daily Audit Report",
  "Inter-District Compliance Sync Bot",
  "Geo-Spatial Rights Violation Hotspot Mapper",
  "CCTV Police Station Feed Analyzer",
  "Fake/Fabricated Record Predictor AI",
  "Whistleblower/Complaint Sentiment Scorer",
  "AI Evaluator for Station House Officer (SHO)",
  "Audit/Override Access Log Gen",
  "Data Privacy/Victim Detail Scrubber",
  "State Human Rights Commission Sync",
  "Field IO Rights Checklist App",
  "Historical Violation Precedent Matcher",
  "DGP/IG Range Briefing AI",
  "Supervisory Review Resource Allocator",
  "Blockchain Immutable Audit Hash",
  "Anti-Tamper Log Shield AI",
  "Mobile App for Spot Inspections",
  "Jurisdiction/Zone Comparison Matcher",
  "Multi-Lingual Guideline Translator",
  "Historical Compliance Trend Analyzer",
  "Human Rights SOP Trainer",
  "Compliance DB Server Health Monitor",
  "Imminent Gross Violation Alert Bot",
  "Organized Crime False Complaint Profiler",
  "High-Profile/Media Sensitive Case Classifier",
  "AI Assisted Departmental Reply Drafter",
  "Audit Video/Document Storage Forecaster",
  "Secure Whistleblower Protector",
  "Integration with CVC/Lokayukta DB",
  "Citizen Human Rights Portal Sync",
  "Riot/Encounter Extra-Judicial Modeler",
  "Disaster Relief Fund Compliance Coordinator",
  "Compensation/Penalty Budget Tracker",
  "Custom Workflow for External Inquiries",
  "AI Driven Suspension/Transfer Predictor",
  "Predictive Need for Sensitization Training",
  "Custom Alert Trigger for Nodal Officers",
  "Compliance Issue Lifecycle Timeline Tracker"
];
...
const ComplianceMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI COMPLIANCE MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI COMPLIANCE <span>MONITORING</span></h1>
...
export default ComplianceMonitoringDetailed;
