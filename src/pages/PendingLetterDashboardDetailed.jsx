...
const aiExperts = [
  "Desk-wise Pendency/Workload Analyzer",
  "Ageing Analysis (0-7, 7-15, >30 days) AI",
  "Bottleneck/Choke-point Identifier",
  "Officer Responsiveness Scorecard Generator",
  "Category-wise (Court/VIP/Public) Pendency Splitter",
  "Volume vs Manpower Correlator",
  "Geo-Spatial District-wise Pendency Mapper",
  "Leave/Absence Impact Correlator",
  "Executive Pendency Dashboard",
  "Voice-Command Desk Status Bot",
  "Automated Monthly Performance Report",
  "E-Office/Dak Register Sync",
  "Root Cause Analysis (RCA) Bot",
  "Workload Re-distribution Suggester AI",
  "Data Manipulation/Fake Disposal Detector",
  "Critical File Highlight Engine",
  "AI Evaluator for Desk Efficiency",
  "Audit/Clearance Rate Log Generator",
  "Data Privacy/Classified File Scrubber",
  "HRMS/Appraisal System Sync",
  "Supervisory Dashboard Mobile App",
  "Historical Seasonal Workload Correlator",
  "DGP/IG Administration Briefing AI",
  "Task Force/Additional Staff Allocator",
  "Blockchain Immutable Pendency Hash",
  "Anti-Tamper Performance Record Shield",
  "Mobile App for Quick Approvals",
  "Inter-Desk Efficiency Benchmarker",
  "Automated Alert for 30+ Days Pendency",
  "Historical Clearance Trend Analyzer",
  "File Processing SOP Trainer",
  "Dashboard Database Health Monitor",
  "Imminent Systemic Paralysis Alert",
  "Habitual File Hoarder Profiler",
  "High-Stakes Pending File Classifier",
  "AI Assisted Remedial Action Plan Drafter",
  "Analytics Data Storage Forecaster",
  "Secure Officer Appraisal Protector",
  "Integration with State Secretariat",
  "Citizen Grievance Pendency Sync",
  "Election Duty Impact on Pendency Modeler",
  "Disaster Duty Impact on Pendency Coordinator",
  "Performance Incentive Budget Tracker",
  "Custom Workflow for Mass Disposal Drives",
  "AI Driven Backlog Clearance Predictor",
  "Predictive Need for Overtime/Camp",
  "Custom Alert Trigger for Chief Secretary",
  "Pendency Ageing Timeline Tracker"
];
...
const PendingLetterDashboardDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI PENDING LETTER DASHBOARD
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI PENDING LETTER <span>DASHBOARD</span></h1>
...
export default PendingLetterDashboardDetailed;
