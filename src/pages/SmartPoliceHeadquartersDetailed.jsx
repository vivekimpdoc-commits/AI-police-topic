...
const aiExperts = [
  "IoT HVAC/Climate Control Optimizer",
  "Smart Lighting/Occupancy Sensor AI",
  "Automated PA (Public Address) System Router",
  "Carbon Footprint/Sustainability Tracker",
  "Smart Parking Space Allocator (ANPR Sync)",
  "Lift/Elevator Health & Traffic AI",
  "Geo-Spatial PHQ Floorplan Mapper",
  "Energy vs Occupancy Correlation Engine",
  "Smart HQ Central Dashboard",
  "Voice-Command Facility Query Bot",
  "Automated Monthly Energy/Green Report",
  "State IT/Smart City Sync",
  "Energy Wastage/Leak Predictor",
  "Unauthorized VIP Parking Alert",
  "Emergency Evacuation Route Optimizer",
  "Peak Hour Congestion Analyzer",
  "AI Evaluator for Green Building Index",
  "Audit/IoT Log Generator",
  "Data Privacy/Officer Movement Scrubber",
  "Estate/PWD Department Sync",
  "Facility Manager Mobile App",
  "Historical Power/HVAC Failure Correlator",
  "DGP (Admin) Briefing AI",
  "Maintenance Task Allocator",
  "Blockchain Immutable Energy Log Hash",
  "Anti-Tamper Facility Control Shield",
  "Mobile App for Desk/Parking Booking",
  "Floor-wise Energy Efficiency Benchmarker",
  "Automated Alert for Critical System Failure",
  "Historical Utility Savings Analyzer",
  "Smart Building Evacuation SOP Trainer",
  "IoT Gateway/Sensor Health Monitor",
  "Imminent Fire/Gas Leak Alert",
  "Habitual Energy Waster (Branch) Profiler",
  "Classified (SCIF/Server Room) Zone Classifier",
  "AI Assisted Carbon Credit Claim Drafter",
  "IoT Telemetry Data Forecaster",
  "Secure BMS (Building Management System) Protector",
  "Integration with National Smart Grid",
  "Solar/Renewable Energy Portal Sync",
  "Election 24x7 Control Room HVAC Modeler",
  "Disaster Command Center Power Resilience Coordinator",
  "Smart Infrastructure Budget Tracker",
  "Custom Workflow for DGP/CM Arrival Override",
  "AI Driven Utility Bill Predictor",
  "Predictive Need for Sensor Calibration",
  "Custom Alert Trigger for Nodal Officer",
  "Issue Detection to Automated Correction Timeline"
];
...
const SmartPoliceHeadquartersDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SMART POLICE HEADQUARTERS
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SMART POLICE <span>HEADQUARTERS</span></h1>
...
export default SmartPoliceHeadquartersDetailed;
