...
const aiExperts = [
"Real-Time Evacuation Zone Heatmap AI",
  "Safe-Route/Green-Corridor Mapping Engine",
  "Stranded Citizen SOS/GPS Tracker Bot",
  "Flood Inundation vs Route Blockage Modeler",
  "Traffic Bottleneck/Stampede Predictor AI",
  "Public Transport (Bus/Train) Requisition Sync",
  "Vulnerable (Hospital/School) Evac Prioritizer",
  "Shelter Capacity vs Evacuee Count Matcher",
  "Drone/Aerial Footage Route Verification",
  "Weather/Cyclone Landfall Timeline Sync",
  "Command Center Evacuation Dashboard",
  "Voice-Command Evacuation Status Query",
  "Automated Evacuation Order (SMS) Broadcasting",
  "Inter-District Safe-Zone Allocation Engine",
  "Bridge/Road Collapse Re-Routing AI",
  "Telecom/Cell-Tower Congestion Modeler",
  "Pet/Livestock Evacuation Tracking Bot",
  "Chemical/Gas Leak Plume Evac Optimizer",
  "Door-to-Door Search Grid Clearance AI",
  "Disability/Wheelchair Evac Assistance Locator",
  "AI Evaluator for Evacuation Completion %",
  "Incident/Delay Log Generator for Audit",
  "Data Privacy/Stranded Person Info Masker",
  "Police-NDRF-Army Evacuation Sync Bot",
  "Fake News/Panic Rumor Containment AI",
  "Fuel Station Capacity along Evac Route AI",
  "Senior Officer (Collector/SP) Briefing Bot",
  "Public Announcement/Siren Trigger System",
  "Blockchain Immutable Log of Evac Orders",
  "Anti-Looting Patrol Route Generator AI",
  "Mobile App for Field Rescue Team Sync",
  "Helicopter/Airlift Evacuation Zone Mapper",
  "Multi-Lingual Evacuation Instruction Bot",
  "Historical Evacuation Precedent Matcher",
  "Medical/Ambulance Convoy Routing AI",
  "Driver/Pilot Fatigue Monitor AI",
  "Temporary Checkpost/Naka Evac Tracking",
  "Traffic Contra-flow/One-Way Enforcer AI",
  "Avalanche/Landslide Re-Routing Engine",
  "Tsunami Coastal Evacuation Wave Modeler",
  "AI Assisted Post-Evacuation Debriefing",
  "Rescue Equipment (Boats) Location Alert",
  "VIP/Prisoner Secure Evacuation Escort AI",
  "Integration with National Highway Authority",
  "Citizen Social Media SOS Scraper & Router",
  "Heatwave/Cold-Wave Evac Temp Modeler",
  "Return-to-Home Clearance Broadcaster",
  "Evacuation Transport Expense Tracker",
  "Custom Workflow/Approval for Forced Evac",
  "AI Driven Bottleneck Resolution Predictor",
  "Predictive Need for Air/Water Rescue",
  "Custom Alert Trigger for Evac Commander"
];
...
const EmergencyEvacuationStatusBoardDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI EMERGENCY EVACUATION STATUS BOARD
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI EMERGENCY EVACUATION STATUS BOARD</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in real-time heatmaps, safe-route mapping & stranded citizen sos tracking.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI EMERGENCY EVACUATION <span>STATUS BOARD</span></h1>
            <p className="cyber-subtitle">Real-time Heatmaps, Safe-Route Mapping & Stranded Citizen SOS Tracking</p>
          </div>
        </div>
      </header>
...
export default EmergencyEvacuationStatusBoardDetailed;
