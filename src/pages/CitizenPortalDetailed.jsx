...
const aiExperts = [
"Single-Window Clearance Router",
  "Automated Document OCR Scanner",
  "Fake ID/Aadhar Forgery Detector",
  "Tenant/Servant Verification AI",
  "Passport Police Clearance Bot",
  "Event/Protest Permission Analyzer",
  "Loudspeaker License Validator",
  "Cyber Crime Reporting Triage AI",
  "Lost Article E-Report Auto-Filer",
  "Stolen Vehicle DB Matcher",
  "Unidentified Corpse Face-Match AI",
  "Missing Person Portal Sync AI",
  "RTI Application NLP Router",
  "Character Certificate Generator",
  "Arms License Application Auditor",
  "Private Security Agency Validator",
  "Domestic Help Background Checker",
  "Foreigner Registration (FRO) Bot",
  "Hotel/Guest House Occupancy Sync",
  "Digital Payment Fraud Checker",
  "Citizen Digital Footprint Modeler",
  "Portal Traffic & DDoS Analyzer",
  "Automated Application Status Predictor",
  "Citizen Profile Risk Scorer",
  "User Session Behavior Analytics",
  "Chatbot Query Intent Modeler",
  "E-Challan Payment Gateway Sync",
  "Automated Refund Discrepancy Bot",
  "Blockchain Citizen Document Vault",
  "Biometric/Face-ID Login Validator",
  "Portal Downtime Predictor AI",
  "Multi-Lingual Portal UI Adjuster",
  "Accessibility/Screen-Reader AI",
  "Citizen Feedback NLP Analyzer",
  "Automated Helpdesk Ticket Router",
  "Inter-Departmental NOC Sync Bot",
  "Traffic Route Advisory Broadcaster",
  "Weather/Disaster Alert Sync",
  "Most-Wanted Criminal Display Bot",
  "Public Awareness Campaign Optimizer",
  "Citizen Volunteer Registry AI",
  "Community Policing Group Sync",
  "CCTNS FIR Copy Retrieval Bot",
  "Court Hearing Schedule Sync AI",
  "Bail/Parole Reporting Validator",
  "E-Summons Delivery Tracker",
  "Anonymous Informant Tip Valuator",
  "Drug Abuse Reporting Flag AI",
  "Wildlife Crime Tip-off Analyzer",
  "Child Labor Report Triage Bot",
  "Prostitution/Trafficking Tip Router",
  "Citizen Portal Load Balancer",
  "Automated FAQ Content Generator",
  "Search Query Trend Analyzer",
  "Portal Security Vulnerability Bot",
  "Data Privacy & Consent Auditor",
  "Digital Signature Verifier AI",
  "Cross-State Police Portal Link",
  "Emergency SOS Web-Trigger AI",
  "Command Center Portal Analytics AI"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CITIZEN PORTAL
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI CITIZEN PORTAL</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in single-window clearance, document verification & digital footprint analytics.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CITIZEN <span>PORTAL</span></h1>
            <p className="cyber-subtitle">Single-Window Clearance, Document Verification & Digital Footprint Analytics</p>
          </div>
        </div>
      </header>
...
export default CitizenPortalDetailed;
