...
const aiExperts = [
  "Dial 112 Audio Sentiment/Urgency Scorer",
  "NLP Caller Intent Extraction AI",
  "Automated Call Triaging/Sorting Engine",
  "First Responder GPS Dispatcher Bot",
  "Prank/Fake Call Identifying AI",
  "Multi-Incident Link/Overlap Detector",
  "Best Route (Traffic Aware) Optimizer",
  "Caller Geolocation Triangulator",
  "Emergency Command Dashboard",
  "Voice-Command Dispatch Query Bot",
  "Automated Response Time (SLA) Report",
  "Fire/Ambulance/Police Sync Bot",
  "Geo-Spatial Crime Heatmap Overlay",
  "Live CCTV Feed Integrator AI",
  "Gunshot/Scream Acoustic Anomaly Matcher",
  "Repeat Caller/Victim History Analyzer",
  "AI Evaluator for Unit Deployment",
  "Audit/Call Recording Log Generator",
  "Data Privacy/Caller Identity Scrubber",
  "National Emergency Number Sync",
  "Field PCR Van Alert App",
  "Historical Emergency Precedent Matcher",
  "Command Center Supervisor Briefing",
  "Emergency Vehicle Fleet Allocator",
  "Blockchain Immutable Call Hash",
  "Anti-Tamper Dispatch Record Shield",
  "Mobile App for First Responders",
  "Cell Tower vs Stated Location Matcher",
  "Multi-Lingual Caller Translator",
  "Historical Response Time Analyzer",
  "Dispatcher SOP Compliance Trainer",
  "112 Server/Telecom Health Monitor",
  "Imminent Mass Casualty Alert Bot",
  "Organized Crime Ambush Profiler",
  "VIP/VVIP Emergency Classifier",
  "AI Assisted Tactical Response Drafter",
  "Audio Storage Size Forecaster",
  "Secure Whistleblower Call Protector",
  "Integration with Smart City Sensors",
  "Citizen Feedback & Rating Analytics",
  "Communal Clash Emergency Modeler",
  "Disaster SOS Overload Coordinator",
  "Emergency Ops Expense Tracker",
  "Custom Workflow for SWAT Deployment",
  "AI Driven Escalation Predictor",
  "Predictive Need for Multi-Jurisdiction Aid",
  "Custom Alert Trigger for ERV Leads",
  "Emergency Resolution Timeline Tracker"
];
...
const EmergencyManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI EMERGENCY MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI EMERGENCY <span>MANAGEMENT</span></h1>
...
export default EmergencyManagementDetailed;
