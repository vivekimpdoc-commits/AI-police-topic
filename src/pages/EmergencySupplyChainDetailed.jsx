...
const aiExperts = [
"MRE (Meals Ready-to-Eat) Burn-Rate Predictor",
  "Tent/Tarpaulin Procurement Optimizer AI",
  "Life-Saving Medicine/Vaccine Supply Router",
  "Drinking Water Tanker Dispatch Algorithm",
  "Supplier/Vendor Inventory Sync Bot",
  "Warehouse/Storage Capacity Predictor",
  "Cold-Chain Temp Monitoring for Vaccines",
  "Fuel (Diesel/Petrol) Reserve Depletion AI",
  "Command Center Supply Chain Dashboard",
  "Voice-Command Supply Query Assistant",
  "Automated Purchase Order (PO) Generator",
  "Inter-District Supply Pooling Engine",
  "Last-Mile Delivery Route Optimizer AI",
  "Airdrop/Helicopter Payload Weight Calculator",
  "Perishable Goods Expiry/Rot Alert Bot",
  "Heavy Machinery (JCB/Crane) Logistics AI",
  "AI Evaluator for Vendor Delivery Reliability",
  "Audit/Procurement Log Auto-Generator",
  "Data Privacy/Vendor Pricing Info Masker",
  "Police-SDRF-NDRF Supply Deconfliction",
  "Emergency Fund/Budget Utilization Modeler",
  "Transport/Truck Fleet Availability Sync",
  "Senior Officer (Relief Comm) Briefing",
  "Public Donation/Sourcing Request Drafter",
  "Blockchain Immutable Log of Transactions",
  "Asset GPS Tagging & Location Tracker",
  "Mobile App for Field Store-Keeper Sync",
  "Customs/Import Clearance Sync for Foreign Aid",
  "Multi-Lingual Supplier Comm Bot",
  "Historical Disaster Burn-Rate Precedent",
  "Helipad/Aviation Fuel Tanker Logistics AI",
  "Supply Convoy Armed Escort Allocator",
  "Temporary Relief Camp Supply Router",
  "Water-Pump/De-Watering Eqp Supply Sync",
  "Avalanche/Snow-Cutter Eqp Procurement",
  "Cyclone/Chainsaw Tree-Cutting Eqp Sync",
  "AI Assisted Post-Disaster Audit Report",
  "Weapon/Security Gear for Convoy Alert",
  "VIP/High-Profile Rescue Supply Router",
  "Integration with National Disaster Dash (NDEM)",
  "Citizen/NGO Contribution Logger AI",
  "Heatwave/ORs/Cooler Supply Chain Bot",
  "Election/Fair Repurposing of Supplies",
  "Disaster Fund/Budget Deficit Alert AI",
  "Custom Workflow/Approval for Emergency PO",
  "AI Driven Predictive Restocking Engine",
  "Predictive Need for Specialized Medical Supply",
...
const EmergencySupplyChainDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI EMERGENCY SUPPLY CHAIN
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI EMERGENCY SUPPLY CHAIN</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in procurement of tents, medicines, mres & predictive burn-rates.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI EMERGENCY <span>SUPPLY CHAIN</span></h1>
            <p className="cyber-subtitle">Procurement of Tents, Medicines, MREs & Predictive Burn-Rates</p>
          </div>
        </div>
      </header>
...
export default EmergencySupplyChainDetailed;
