...
const aiExperts = [
"Dynamic Flood/Landslide Rerouting Engine",
  "One-Way/Contraflow Traffic Enforcer AI",
  "Ambulance/Emergency Green-Corridor Router",
  "Bridge/Road Load Capacity Verifier Bot",
  "Traffic Bottleneck/Stampede Predictor AI",
  "Public Transport (Bus/Train) Evac Sync",
  "Vulnerable (Hospital/School) Route Prioritizer",
  "Shelter Capacity vs Route Destination Matcher",
  "Command Center Evacuation Route Dashboard",
  "Voice-Command Route Query Assistant",
  "Automated Evacuation Map/SMS Broadcasting",
  "Inter-District Safe-Zone Allocation Engine",
  "Drone/Aerial Footage Route Verification AI",
  "Telecom/Cell-Tower Congestion Modeler",
  "Pet/Livestock Evacuation Tracking Bot",
  "Chemical/Gas Leak Plume Wind Rerouter AI",
  "AI Evaluator for Evacuation Speed/Efficiency",
  "Incident/Delay Log Generator for Audit",
  "Data Privacy/Stranded Person Info Masker",
  "Police-Traffic-NDRF Route Sync Bot",
  "Fake News/Panic Route Blockage Containment",
  "Fuel Station Capacity along Evac Route AI",
  "Senior Officer (Traffic DGP) Briefing Bot",
  "Public Announcement/PA System Drafter",
  "Blockchain Immutable Log of Route Changes",
  "Anti-Looting Patrol Route Generator AI",
  "Mobile App for Traffic Marshal Sync",
  "Helicopter/Airlift Evacuation Zone Mapper",
  "Multi-Lingual Evacuation Instruction Bot",
  "Historical Evacuation Precedent Matcher",
  "Night Travel/Visibility (Fog) Route Modeler",
  ...
  "Armed Insurgency/Naxal Zone Rerouting AI",
  "AI Assisted Post-Evacuation Route Audit",
  "Vehicle Repair/Tow-Truck Standby Alert",
  "VIP/Prisoner Secure Evacuation Escort AI",
  "Integration with Google Maps/Waze API",
  "Citizen Social Media SOS Scraper & Router",
  "Extreme Weather Route Washout Predictor",
  ...
  "Predictive Need for Heavy Earth-Movers",
...
const EvacuationRoutePlannerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI EVACUATION ROUTE PLANNER
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI EVACUATION ROUTE PLANNER</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in dynamic rerouting, landslide avoidance, one-way traffic & green corridors.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI EVACUATION ROUTE <span>PLANNER</span></h1>
            <p className="cyber-subtitle">Dynamic Rerouting, Landslide Avoidance, One-Way Traffic & Green Corridors</p>
          </div>
        </div>
      </header>
...
export default EvacuationRoutePlannerDetailed;
