...
const aiExperts = [
"Sandbag/Embankment Material Tracker AI",
  "Diesel/Petrol Reserve Depletion Predictor",
  "Heavy Machinery (JCB/Crane) Locator Bot",
  "Water Pump/De-Watering Eqp Inventory",
  "Tent/Tarpaulin/Camp Supply Stock Modeler",
  "Emergency Medical Kit/Life-Saving Drug Tracker",
  "Ration/Food-Packet/Water Bottle Predictor",
  "Life-Jacket/Rescue Boat Inventory Bot",
  "Command Center Stock Monitoring Dashboard",
  "Voice-Command Stock Query Assistant",
  "Automated Re-order/Purchase Alert Gen",
  "Private Contractor/Vendor Requisition Bot",
  "Inter-District Stock Pooling Engine",
  "Communication (Satphone/Batteries) Tracker",
  "Fire-Extinguisher/Foam Stock Modeler",
  "Drone/UAV/Thermal Camera Availability AI",
  "AI Evaluator for Stock Sufficiency/Deficit",
  "Audit/Procurement Log Auto-Generator",
  "Data Privacy/Vendor Pricing Info Masker",
  "Police-SDRF-NDRF Stock Deconfliction",
  "Perishable Goods Expiry/Rot Alert Bot",
  "Transport/Truck Logistics for Stock AI",
  "Senior Officer (Relief Comm) Briefing Bot",
  "Public Donation/Sourcing Request Drafter",
  "Blockchain Immutable Log of Stock Issue",
  "Asset GPS Tagging & Location Tracker AI",
  "Mobile App for Field Store-Keeper Sync",
  "Cold-Chain/Vaccine Storage Temperature Bot",
  "Multi-Lingual/Regional Stock Naming AI",
  "Historical Disaster Burn-Rate Precedent",
  "Helipad/Aviation Fuel Tanker Readiness AI",
  "Stock Repair/Maintenance Due Alert",
  ...
  "Election/Fair Repurposing of Stock",
...
const EmergencyStockMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI EMERGENCY STOCK MONITORING
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI EMERGENCY STOCK MONITORING</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in tracking sandbags, heavy machinery, diesel reserves & predicting shortages.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI EMERGENCY STOCK <span>MONITORING</span></h1>
            <p className="cyber-subtitle">Tracking Sandbags, Heavy Machinery, Diesel Reserves & Predicting Shortages</p>
          </div>
        </div>
      </header>
...
export default EmergencyStockMonitoringDetailed;
