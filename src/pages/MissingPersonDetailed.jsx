...
const aiExperts = [
  "Missing Profile NLP Extractor AI",
  "Social Media Image/Activity Scanner",
  "CCTNS Inter-State Data Matcher",
  "Geo-Fenced Amber Alert Broadcaster",
  "Cell Tower (CDR) Last Location Analyzer",
  "Runaway vs Kidnapping Risk Scorer",
  "Hospital/Shelter Admission Sync Bot",
  "Railway/Bus Station CCTV Correlator",
  "Missing Person Command Dashboard",
  "Voice-Command Profile Query Bot",
  "Automated Daily Match Report",
  "NGO/Childline Coordination Sync",
  "Geo-Spatial Disappearance Mapper",
  "Vehicle (Cab/Auto) ANPR Tracker",
  "Fake Ransom/Extortion Call Predictor",
  "Historical Runaway Route Matcher",
  "AI Evaluator for Search Efficiency",
  "Audit/Search Action Log Gen",
  "Data Privacy/Victim Info Scrubber",
  "State Anti-Human Trafficking Unit Sync",
  "Field IO Search Checklist App",
  "Cold Case Missing Person Correlator",
  "SHO/Supervisory Officer Briefing AI",
  "Search Party Resource Allocator",
  "Blockchain Immutable Report Hash",
  "Anti-Tamper Profile Shield",
  "Mobile App for Family (Live Updates)",
  "Jurisdiction Boundary Matcher",
  "Multi-Lingual Missing Poster Generator",
  "Historical Recovery Rate Analyzer",
  "Missing Person SOP Trainer",
  "Missing DB Server Health Monitor",
  "Imminent Border Crossing Alert Bot",
  "Organized Trafficking Syndicate Profiler",
  "High-Risk (Minor/Elderly) Classifier",
  "AI Assisted Search Warrant Drafter",
  "CCTV/Image Storage Forecaster",
  "Secure Tip-Off/Informant Protector",
  "Integration with National Missing DB",
  "Citizen Tip/Sighting Reporting Portal",
  "Human Trafficking Route Modeler",
  "Disaster/Mass Casualty Separation Coordinator",
  "Search Operation Budget Tracker",
  "Custom Workflow for Interpol Yellow Notice",
  "AI Driven Survival/Harm Probability Predictor",
  "Predictive Need for Sniffer Dogs",
  "Custom Alert Trigger for SP/SSP",
  "Search & Recovery Lifecycle Timeline Tracker"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI MISSING PERSON
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI MISSING <span>PERSON</span></h1>
...
export default MissingPersonDetailed;
