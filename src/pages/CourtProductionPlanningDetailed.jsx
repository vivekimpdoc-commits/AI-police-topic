...
const aiExperts = [
  "Physical vs VC Production Triage AI",
  "Video Conferencing (VC) Slot Scheduler",
  "IO Court Appearance Roster Optimizer",
  "Evidence/Exhibit Transit Planner",
  "Court Hearing Delay/Adjournment Predictor",
  "Prison/Jail Capacity & Transit Coordinator",
  "CCTNS/E-Courts Daily Roster Sync",
  "Missing Exhibit/Malkhana Alert Bot",
  "Production Command Dashboard",
  "Voice-Command Hearing Status Bot",
  "Automated Daily Production Plan",
  "Prosecution/Law Officer Sync Bot",
  "Geo-Spatial Court Route Mapper",
  "Secure VC Link/Bandwidth Monitor",
  "Fake Medical Certificate Predictor",
  "Witness Sync & Coordination AI",
  "AI Evaluator for IO Attendance",
  "Audit/Production Log Generator",
  "Data Privacy/Juvenile Hearing Scrubber",
  "Directorate of Prosecution Sync",
  "Field IO Hearing Schedule App",
  "Historical Adjournment Pattern Matcher",
  "SHO/Supervisory Officer Briefing",
  "Court Pairi Officer/Escort Allocator",
  "Blockchain Immutable VC Recording Hash",
  "Anti-Tamper Exhibit Chain Shield",
  "Mobile App for Quick Status Updates",
  "Jurisdiction Court Matcher",
  "Multi-Lingual Court Order Translator",
  "Historical Production Success Analyzer",
  "Court Etiquette/SOP Trainer",
  "Production DB Server Health Monitor",
  "Imminent Non-Production Contempt Alert",
  "Syndicate Witness Tampering Profiler",
  "High-Profile/Sensitive Production Classifier",
  "AI Assisted Remand Extension Drafter",
  "VC Video Storage Forecaster",
  "Secure Witness Identity Protector",
  "Integration with National Judicial Data Grid",
  "Citizen/Family Hearing Portal Sync",
  "Mass Arrest Production Batching Modeler",
  "Disaster Disrupted Court Coordinator",
  "Transit/Escort Ops Budget Tracker",
  "Custom Workflow for Out-of-State Production",
  "AI Driven Conviction Delay Predictor",
  "Predictive Need for Additional Force",
  "Custom Alert Trigger for Nodal Officers",
  "Trial Production Lifecycle Tracker"
];
...
const CourtProductionPlanningDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI COURT PRODUCTION PLANNING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI COURT PRODUCTION <span>PLANNING</span></h1>
...
export default CourtProductionPlanningDetailed;
