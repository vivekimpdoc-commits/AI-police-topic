...
const aiExperts = [
"NLP Grievance Categorization AI",
  "Automated Department Router",
  "Grievance Severity Scorer",
  "Duplicate Complaint Merger AI",
  "Citizen Sentiment Analyzer",
  "Vernacular Language Translator Bot",
  "SLA Breach Predictor AI",
  "Officer Escalation Matrix Bot",
  "Fake/Spam Grievance Filter AI",
  "Voice-to-Text Jansunwai Converter",
  "CM-Helpline Sync Coordinator",
  "Anonymous Tip Validator",
  "Geospatial Grievance Heatmap AI",
  "Public Harassment Pattern Modeler",
  "Civic Issue to Police Router",
  "Domestic Violence Keyword Alert",
  "Corruption Allegation Flag Bot",
  "Repeat Complainant Profiler",
  "Automated Resolution Drafter",
  "Pending Grievance Alert Bot",
  "Social Media Grievance Scraper AI",
  "Whatsapp Jansunwai Bot Sync",
  "Photo/Video Evidence Analyzer",
  "Citizen Satisfaction Scorer",
  "Automated Follow-up Call Bot",
  "Police Station Jurisdiction Finder",
  "Right to Information (RTI) Sync AI",
  "Public Dispute Pattern Predictor",
  "Land Dispute Keyword Tracker AI",
  "Cyber Fraud Grievance Router",
  "FIR vs Grievance Discrepancy Finder",
  "Women Safety Priority Alert Bot",
  "Child Abuse Keyword Flag AI",
  "Senior Citizen Help-Desk AI",
  "Scheduled Caste/Tribe Act Flag AI",
  "Police Inaction Predictor",
  "Court Order Sync for Grievances",
  "VIP/MLA Grievance Tracker Bot",
  "Mass Protest Grievance Modeler",
  "Automated Acknowledgement Sender",
  "Citizen Portal Outage Alert",
  "Audio Attachment Emotion Analyzer",
  "Handwritten Letter OCR AI",
  "Bulk Grievance Signature Matcher",
  "E-Daakhil (Consumer) Sync Bot",
  "Panchayat Level Issue Router",
  "Inter-Departmental Handoff AI",
  "Officer Performance via Resolution AI",
  "Automated Show-Cause for Delay",
  "Citizen Grievance Lifecycle Predictor",
  "Public Policy Impact Analyzer",
  "Smart Search for Past Precedents",
  "NGO/Activist Mass Complaint Filter",
  "Grievance Redressal Audit Bot",
  "Blockchain Tamper-Proof Log AI",
  "Citizen Profile Builder AI",
  "Automated Monthly Grievance Report",
  "AI-Powered Live Chat Assistant",
  "Multi-Modal Channel Aggregator",
  "Command Center Dashboard Sync AI"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI JANSUNWAI PORTAL
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI JANSUNWAI PORTAL</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in public grievance routing, nlp analysis & automated resolution tracking.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI JANSUNWAI <span>PORTAL</span></h1>
            <p className="cyber-subtitle">Public Grievance Routing, NLP Analysis & Automated Resolution Tracking</p>
          </div>
        </div>
      </header>
...
export default JansunwaiDetailed;
