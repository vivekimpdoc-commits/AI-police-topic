...
const aiExperts = [
  "NIC E-Office API Integrator AI",
  "Auto-Drafting File Noting Bot",
  "Digital Signature/DSC Tracker",
  "Legacy Physical Data Migration Engine",
  "Attachment OCR & Indexing AI",
  "Cross-Department Routing Rules",
  "Geo-Spatial Access Log Mapper",
  "Version Control/Revision History Monitor",
  "E-Office Integration Dashboard",
  "Voice-Command File Query Bot",
  "Automated Weekly E-Office Usage Report",
  "State IT Department/NIC Sync",
  "Multi-Lingual Noting Translation",
  "Duplicate/Redundant File Detector",
  "Unauthorized Access Predictor",
  "Summary/Abstract Generator",
  "AI Evaluator for Paperless Compliance",
  "Audit/Approval Log Generator",
  "Data Privacy/Classified File Scrubber",
  "State Secretariat Sync",
  "Officer Pending File Mobile App",
  "Historical File Delay Correlator",
  "DGP/IG Briefing AI",
  "Task Delegation Engine",
  "Blockchain Immutable Noting Hash",
  "Anti-Tamper Digital File Shield",
  "Mobile App for Quick DSC Approval",
  "Branch-wise Paperless Benchmarker",
  "Automated Reminder for Pending E-Files",
  "Historical Processing Speed Analyzer",
  "E-Office SOP/Training Bot",
  "E-Office API Gateway Health Monitor",
  "Imminent File Deadlock Alert",
  "Digital Illiteracy/Reluctance Profiler",
  "High-Priority Court File Classifier",
  "AI Assisted Clarification Drafter",
  "Digital Storage Cost Forecaster",
  "Secure Top-Secret File Protector",
  "Integration with State Treasury (IFMS)",
  "RTI Public Information Portal Sync",
  "Election Transfer File Modeler",
  "Disaster Emergency Fund File Coordinator",
  "E-Office Licensing Budget Tracker",
  "Custom Workflow for Top-Secret E-Files",
  "AI Driven Approval Time Predictor",
  "Predictive Need for IT Training",
  "Custom Alert Trigger for Nodal Officer",
  "Digital File Lifecycle Timeline Tracker"
];
...
const EOfficeIntegrationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI E-OFFICE INTEGRATION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI E-OFFICE <span>INTEGRATION</span></h1>
...
export default EOfficeIntegrationDetailed;
