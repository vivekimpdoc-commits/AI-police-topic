...
const aiExperts = [
  "Multi-Variable Threat Modeler (Crime/Communal)",
  "Force-to-Population/Area Optimizer AI",
  "Vulnerability/Flashpoint Heatmapper",
  "Demographic Shift/Migration Analyzer",
  "Industrial/Labor Unrest Risk Scorer",
  "Terrain/Geography (Forest/Border) Challenge Mapper",
  "Geo-Spatial Strategic Asset/Vital Inst. Mapper",
  "Historical Riot/Election Violence Correlator",
  "District Security Assessment Dashboard",
  "Voice-Command District Query Bot",
  "Automated Quarterly Security Audit Report",
  "State Intelligence Bureau Sync",
  "Communal Tension/Polarization Predictor",
  "Force Depletion/Fatigue Risk Analyzer",
  "Inadequate Response Time (Remote Area) Alert",
  "Organized Crime Syndicate Encroachment Detector",
  "AI Evaluator for District Safe-City Index",
  "Audit/Assessment Log Generator",
  "Data Privacy/Demographic Scrubber",
  "Armed Police/Reserve Battalion Sync",
  "SP/SSP (Superintendent) Mobile App",
  "Historical Budget vs Crime Drop Correlator",
  "IG (Zone) Briefing AI",
  "Force Reallocation/Deployment Task Allocator",
  "Blockchain Immutable Assessment Hash",
  "Anti-Tamper Security Audit Shield",
  "Mobile App for Field Vulnerability Upload",
  "District-to-District Security Benchmarker",
  "Automated Alert for Critical Force Shortfall",
  "Historical Policing/Deployment Cost Analyzer",
  "Strategic Deployment/Riot Control SOP Trainer",
  "Crime/CCTNS Data Ingestion API Monitor",
  "Imminent Breakdown of Law & Order Alert",
  "High-Risk/Volatile District Profiler",
  "Mission-Critical (Naxal/Border District) Classifier",
  "AI Assisted Force Augmentation Proposal Drafter",
  "Crime Rate/Demographic Trend Forecaster",
  "Secure Vital Installation Blueprint Protector",
  "Integration with Census/Municipal Data",
  "Central Armed Police Force (CAPF) Sync",
  "Election Hyper-Sensitive District Modeler",
  "Disaster Proneness (Flood/Seismic) Coordinator",
  "District Modernization/Equipment Budget Tracker",
  "Custom Workflow for Tourist/Pilgrimage Districts",
  "AI Driven Next-Year Force Requirement Predictor",
  "Predictive Need for New Police Stations",
  "Custom Alert Trigger for DGP/Chief Minister",
  "Assessment Generation to Deployment Timeline"
];
...
const DistrictSecurityAssessmentDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DISTRICT SECURITY ASSESSMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DISTRICT SECURITY <span>ASSESSMENT</span></h1>
...
export default DistrictSecurityAssessmentDetailed;
