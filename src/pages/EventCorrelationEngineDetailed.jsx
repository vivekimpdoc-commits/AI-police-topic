...
const aiExperts = [
  "Multi-Source Threat Matcher Engine AI",
  "Cross-Incident Pattern Discovery Bot",
  "Trigger Keyword Semantic Association Bot",
  "Unusual Call/CDR Association Detector AI",
  "Social Media Riot Spark Predictor Bot",
  "Financial Transfer vs Event Linkage Analyzer",
  "Suspicious Travel Grouping Detection Engine",
  "Precursor Event Alert Warning Engine AI",
  "Event Correlation Command Dashboard Portal",
  "Voice-Command Correlation Query Bot",
  "Automated Incident Threat Alert Report Gen",
  "Cross-Agency Operation Alert Sync Engine",
  "Weapon Sales vs Crime Rate Correlator AI",
  "Protest Event Location Clustering Tracker Bot",
  "Historical Crime Wave Sequence Modeler Bot",
  "Unrelated Case MO Similarity Matcher Bot",
  "AI Evaluator for Threat Escalation Risk Score",
  "Audit/Correlation Query Logging System Bot",
  "Data Privacy/Incidental Target Name Masker",
  "Police-State Security Wing Intelligence Sync",
  "Field Alert Notification Mobile App Sync Portal",
  "Cold Case Modus Operandi Linkage Matcher AI",
  "Senior Officer (ADG Intelligence) Briefing Bot",
  "Public Local Incident Threat Index Board Portal",
  "Blockchain Immutable Alert Trigger Log Hasher",
  "Anti-False Alarm Filtering Security Engine AI",
  "Mobile App for Field Threat Incident Tagging",
  "Tower Dump Mutual Intersection Event Finder",
  "Multi-Lingual Event Summary Semantic Matcher",
  "Historical Crisis Escalation Model Analyzer Bot",
  "Staff Threat Analysis SOP Training Tracker AI",
  "Correlation Engine CPU Cluster Health Monitor",
  "Urgent Riot Threat Clashing Alert Generator AI",
  "Traffic Highway Corridor Mega-Congestion Correlation",
  "Cyber-Attack Vector Event Correlation Monitor",
  "VIP Event Path Threat Matrix Correlation Bot",
  "AI Assisted Post-Incident Correlation Report",
  "Correlation Engine Database Load Scheduler AI",
  "Narcotics Cargo vs Event Pattern Linker AI",
  "Integration with NATGRID National Threat Database",
  "Citizen Local Threat Tip-Off Reporting Mobile Portal",
  "Extreme Weather Crowd Panic Threat Modeler AI",
  "Disaster Situation Chain Event Damage Tracker",
  "Correlation Center Operation Budget Tracker AI",
  "Custom Workflow/Approval for Alert Escalation",
  "AI Driven New Modus Operandi Trend Predictor",
  "Predictive Need for Preventative Force Mobilization",
  "Custom Alert Trigger for Intelligence Chief"
];
...
const EventCorrelationEngineDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CORRELATION ENGINE
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI CORRELATION ENGINE</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in multi-source threat linkage, trigger matching, cross-incident analysis & warning alerts.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CORRELATION <span>ENGINE</span></h1>
            <p className="cyber-subtitle">Multi-source Threat Linkage, Trigger Matching, Cross-incident Analysis & Warning Alerts</p>
          </div>
        </div>
      </header>
...
export default EventCorrelationEngineDetailed;
