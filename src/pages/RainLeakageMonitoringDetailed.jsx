...
const aiExperts = [
  "Moisture/Humidity Sensor AI",
  "Roof Seepage/Crack Predictor",
  "Waterproofing Lifecycle Tracker",
  "Archival/Malkhana Protection Bot",
  "Gutter/Drain Blockage Detector",
  "Basement Flooding/Sump Pump Monitor",
  "Geo-Spatial Seepage Vulnerability Mapper",
  "Weather Forecast Sync & Alert Engine",
  "Rain Leakage Dashboard",
  "Voice-Command Moisture Status Bot",
  "Automated Pre-Monsoon Readiness Report",
  "State PWD/Civil Maintenance Sync",
  "Electrical Short-Circuit Risk Predictor",
  "Mold/Mildew Growth Analyzer",
  "Wall Dampness/Plaster Peel Alert",
  "Preventive Waterproofing Optimizer",
  "AI Evaluator for Building Weatherproofing Index",
  "Audit/Repair Log Generator",
  "Data Privacy/Evidence Room Layout Scrubber",
  "Record/Evidence Room Sync",
  "Maintenance Staff Mobile App",
  "Historical Monsoon Damage Correlator",
  "Estate Officer Briefing AI",
  "Waterproofing/Plumbing Task Allocator",
  "Blockchain Immutable Repair Hash",
  "Anti-Tamper Sensor Log Shield",
  "Mobile App for Leak Reporting",
  "Station-wise Waterproofing Benchmarker",
  "Automated Alert for Archival Room Leakage",
  "Historical Waterproofing Cost Analyzer",
  "Monsoon Preparedness SOP Trainer",
  "IoT Moisture Sensor Health Monitor",
  "Imminent Evidence/Record Destruction Alert",
  "Substandard Waterproofing Vendor Profiler",
  "High-Value (Server Room/Armory) Classifier",
  "AI Assisted Roof Repair Tender Drafter",
  "Moisture Trend Data Forecaster",
  "Secure Facility Layout Protector",
  "Integration with Meteorological Department",
  "E-Tendering Portal Sync",
  "Election Monsoon Deployment Damage Modeler",
  "Disaster Flash Flood Inundation Coordinator",
  "Waterproofing/Maintenance Budget Tracker",
  "Custom Workflow for Heritage Roofs",
  "AI Driven Repair Budget Predictor",
  "Predictive Need for Roof Overhaul",
  "Custom Alert Trigger for SP Admin",
  "Leak Detection to Patching Timeline"
];
...
const RainLeakageMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI RAIN LEAKAGE MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI RAIN LEAKAGE <span>MONITORING</span></h1>
...
export default RainLeakageMonitoringDetailed;
