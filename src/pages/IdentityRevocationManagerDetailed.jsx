...
const aiExperts = [
  "Rapid Offboarding/Disablement Engine",
  "Cross-System (Active Directory/Apps) Terminator",
  "Physical Pass/RFID Invalidation Bot",
  "Asset/Device Return Tracking AI",
  "Suspension/Dismissal Trigger Integrator",
  "Data Exfiltration/Download Alert (Pre-Departure)",
  "Geo-Spatial Facility Lockout Mapper",
  "Pending Investigation/Clearance Linker",
  "Identity Revocation Dashboard",
  "Voice-Command Status Query Bot",
  "Automated Daily Offboarding Report",
  "HRMS/Personnel Department Sync",
  "Incomplete Disablement/Lingering Access Detector",
  "Ghost Account/Post-Termination Login Alert",
  "Unauthorized Email Forwarding Predictor",
  "Final Settlement/NOC (No Objection) Automator",
  "AI Evaluator for Offboarding Security",
  "Audit/Revocation Trail Generator",
  "Data Privacy/Former Employee Data Scrubber",
  "IT/Cyber Security Department Sync",
  "Clearance/NOC Processing Mobile App",
  "Historical Post-Termination Breach Correlator",
  "SP (Admin) / CISO Briefing AI",
  "Asset Recovery/Quartermaster Task Allocator",
  "Blockchain Immutable Revocation Hash",
  "Anti-Tamper Offboarding Record Shield",
  "Mobile App for Exit Interview/Clearance",
  "Department-wise Offboarding Speed Benchmarker",
  "Automated Alert for Unreturned Assets (Laptop/Weapon)",
  "Historical Asset Loss/Write-off Analyzer",
  "Offboarding/Exit Protocol SOP Trainer",
  "IAM/Directory Server Health Monitor",
  "Imminent Sabotage/Revenge Attack Alert",
  "High-Risk Departing Employee Profiler",
  "Critical Access (Database/Intel) Revocation Classifier",
  "AI Assisted Legal/Recovery Notice Drafter",
  "Revocation Log/Audit Storage Forecaster",
  "Secure Master Directory Protector",
  "Integration with State Pension/Treasury Sync",
  "Police Welfare/Alumni Portal Sync",
  "Election Deputation End Reversion Modeler",
  "Disaster Volunteer Demobilization Coordinator",
  "Asset Recovery/Replacement Budget Tracker",
  "Custom Workflow for Deceased Personnel Settlement",
  "AI Driven Asset Recovery Delay Predictor",
  "Predictive Need for Legal Intervention",
  "Custom Alert Trigger for IG Admin",
  "Termination Trigger to Complete Lockout Timeline"
];
...
const IdentityRevocationManagerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI IDENTITY REVOCATION MANAGER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI IDENTITY REVOCATION <span>MANAGER</span></h1>
...
export default IdentityRevocationManagerDetailed;
