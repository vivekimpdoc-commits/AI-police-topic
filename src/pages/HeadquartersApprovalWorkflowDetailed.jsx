...
const aiExperts = [
  "Dynamic Hierarchy/Matrix Routing Engine",
  "Financial Delegation of Power (DOP) Validator",
  "DSC (Digital Signature Certificate) Integrator",
  "Bottleneck/Delay Alert Bot",
  "Rule/Policy Citation Checker AI",
  "Automated Escalation/Bypass Engine",
  "Geo-Spatial File Origin/Branch Mapper",
  "Cross-Department (Finance/Law) Linker",
  "Approval Workflow Dashboard",
  "Voice-Command File Tracking Bot",
  "Automated Weekly Pendency/Clearance Report",
  "E-Office/NIC System Sync",
  "Multi-Lingual Noting/Comment Translation",
  "Contradictory/Vague Comment Detector",
  "Unauthorized Approval/Bypass Predictor",
  "Summary of Objections Generator",
  "AI Evaluator for Processing Speed",
  "Audit/Approval Trail Log Generator",
  "Data Privacy/Classified File Scrubber",
  "Finance/Establishment Department Sync",
  "Officer Approval Mobile App",
  "Historical Red-Tape/Query Loop Correlator",
  "Supervisory Officer Briefing AI",
  "Task/Clarification Delegation Engine",
  "Blockchain Immutable Approval Hash",
  "Anti-Tamper Digital File Shield",
  "Mobile App for Quick DSC Sign",
  "Desk-wise Approval Speed Benchmarker",
  "Automated Reminder for Urgent Files",
  "Historical Approval/Rejection Rate Analyzer",
  "Secretariat/Noting SOP Trainer",
  "E-Office Gateway Health Monitor",
  "Imminent Fund Lapse/Deadline Alert",
  "Habitual File Delayer (Queries) Profiler",
  "High-Priority/Cabinet Memo Classifier",
  "AI Assisted Standard Objection Drafter",
  "Digital File/Noting Storage Forecaster",
  "Secure Top-Secret Approval Protector",
  "Integration with State Treasury/IFMS",
  "Citizen Portal Sync (for public services)",
  "Election Urgent Financial Approval Modeler",
  "Disaster Emergency Procurement Approval Coordinator",
  "E-Office/DSC Licensing Budget Tracker",
  "Custom Workflow for Top-Secret Clearances",
  "AI Driven Approval Outcome/Time Predictor",
  "Predictive Need for Committee Formation",
  "Custom Alert Trigger for Nodal Officer",
  "Initiation to Final Approval Timeline"
];
...
const HeadquartersApprovalWorkflowDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI HEADQUARTERS APPROVAL WORKFLOW
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI HEADQUARTERS APPROVAL <span>WORKFLOW</span></h1>
...
export default HeadquartersApprovalWorkflowDetailed;
