...
const aiExperts = [
  "Guest List/ID Automated Scraper AI",
  "Foreigner (C-Form/FRRO) Stay Flagging Engine",
  "CCTNS/Criminal Database Cross-Matcher",
  "CCTV/Physical Security Compliance Auditor",
  "Frequent Room-Changer/Suspicious Stay Analyzer",
  "Fake ID/Forged Aadhaar Detector",
  "Geo-Spatial Hotel/Lodge Mapping Bot",
  "Automated Daily Guest Upload Verifier",
  "Hotel Verification Dashboard",
  "Voice-Command Guest Query Bot",
  "Automated Daily Suspicious Stay Report",
  "Foreigners Regional Registration Office (FRRO) Sync",
  "Criminal Hideout/Safe-house Predictor",
  "Unreported/Off-the-Books Stay Alert",
  "Human Trafficking/Escort Ring Flagging AI",
  "Non-Compliance/Data Delay Estimator",
  "AI Evaluator for Hotel Compliance Index",
  "Audit/Verification Log Generator",
  "Data Privacy/Innocent Guest Identity Scrubber",
  "State Intelligence Bureau Sync",
  "Beat Officer/LIU Agent Mobile App",
  "Historical Arrest/Raid (in Hotels) Correlator",
  "SP (City)/LIU In-Charge Briefing AI",
  "Surprise Raid/Inspection Task Allocator",
  "Blockchain Immutable Guest Entry Hash",
  "Anti-Tamper Digital Register Shield",
  "Mobile App for Instant ID/Face Scanning",
  "Hotel-wise Compliance & Reporting Benchmarker",
  "Automated Alert for Wanted Criminal Check-in",
  "Historical Surveillance/Intelligence Cost Analyzer",
  "Sarai Act/Hotel Regulation SOP Trainer",
  "Hotel Booking/FRRO API Health Monitor",
  "Imminent Terror/Underworld Meeting Alert",
  "Habitual Non-Compliant Lodge Owner Profiler",
  "High-Risk (Near Airport/Border) Hotel Classifier",
  "AI Assisted License Cancellation/Seizure Drafter",
  "Tourist/Guest Influx (Festival/Season) Forecaster",
  "Secure Confidential Informant Protector",
  "Integration with Inter-operable Criminal Justice System (ICJS)",
  "Cyber Crime Cell Sync (for online booking frauds)",
  "Election (Cash/Liquor Distribution Hub) Modeler",
  "Disaster (Earthquake) Guest Accountability Coordinator",
  "Surveillance/Analytics Software Budget Tracker",
  "Custom Workflow for Homestays/Airbnb Verification",
  "AI Driven Illicit Activity Probability Predictor",
  "Predictive Need for Plainclothes Surveillance",
  "Custom Alert Trigger for IG/ADG Intelligence",
  "Guest Check-in to Police Verification Timeline"
];
...
const HotelVerificationManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI HOTEL VERIFICATION MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI HOTEL VERIFICATION <span>MANAGEMENT</span></h1>
...
export default HotelVerificationManagementDetailed;
