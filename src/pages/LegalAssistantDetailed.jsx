...
const aiExperts = [
  "FIR Drafting/Formatting AI",
  "BNS/IPC Section Recommender Engine",
  "Legal Precedent Search Bot",
  "Language Translation & Legal Lexicon",
  "Draft Charge-Sheet Reviewer AI",
  "Bail Objection Argument Drafter",
  "Evidence Admissibility Checker",
  "Contradiction/Loophole Identifier Bot",
  "Legal Assistant Dashboard",
  "Voice-Command Legal Query Bot",
  "Automated Daily Legal Brief",
  "Prosecution/Law Officer Sync Bot",
  "Document Summarization AI",
  "OCR for Handwritten Legal Notes",
  "Similar Past Case Matcher",
  "Recent Supreme Court Ruling Alert",
  "AI Evaluator for Document Accuracy",
  "Audit/Query Access Log Generator",
  "Data Privacy/Victim Detail Scrubber",
  "State Legal Dept Sync Bot",
  "Field IO Legal Reference App",
  "Historical Case Acquittal Correlator",
  "SHO/Supervisory Officer Briefing AI",
  "Legal Resource/Lawyer Allocator",
  "Blockchain Immutable Draft Hash",
  "Anti-Tamper Legal Document Shield",
  "Mobile App for Quick IPC Reference",
  "Jurisdictional Rule Matcher AI",
  "Multi-Lingual Deposition Translator",
  "Historical Conviction Rate Analyzer",
  "Legal Procedure SOP Trainer AI",
  "Legal DB Server Health Monitor",
  "Imminent Statutory Deadline Alert",
  "Organized Crime Legal Defense Profiler",
  "High-Profile Case Legal Strategy Classifier",
  "AI Assisted Appeal Drafter",
  "Legal Precedent Storage Forecaster",
  "Secure Witness Identity Protector",
  "Integration with E-Courts API",
  "Citizen Legal Rights Explanation Bot",
  "Riot/Mass Arrest Legal Strategy Modeler",
  "Disaster Relief Legal Compliance Coordinator",
  "Legal Expense/Counsel Budget Tracker",
  "Custom Workflow for Law Dept Approval",
  "AI Driven Acquittal Risk Predictor",
  "Predictive Need for Special Counsel",
  "Custom Alert Trigger for Nodal Officers",
  "Legal Document Lifecycle Tracker"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI LEGAL ASSISTANT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI LEGAL <span>ASSISTANT</span></h1>
...
export default LegalAssistantDetailed;
