...
const aiExperts = [
  "DA/Arrears Calculation Engine",
  "Annual Increment Forecaster AI",
  "Retirement/Gratuity Settlement Predictor",
  "Tax Deduction (TDS) Optimizer",
  "Pay Commission Impact Modeler",
  "Suspension/Half-Pay Calculator",
  "Geo-Spatial District Salary Apportionment",
  "Recruitment Batch Cost Analyzer",
  "Salary Projection Dashboard",
  "Voice-Command Pay Query Bot",
  "Automated Monthly Payroll Forecast",
  "State Treasury/IFMS Sync",
  "Anomaly/Duplicate Pay Detector",
  "Leave Without Pay (LWP) Adjuster",
  "Fake/Ghost Employee Identifier",
  "Budget Shortfall/Deficit Predictor",
  "AI Evaluator for Payroll Accuracy",
  "Audit/Disbursement Log Generator",
  "Data Privacy/Financial Data Scrubber",
  "HRMS/Personnel Department Sync",
  "Employee Pay-Slip Mobile App",
  "Historical DA Hike Correlator",
  "DGP/IG Finance Briefing AI",
  "Accounts Clerk Task Allocator",
  "Blockchain Immutable Payroll Hash",
  "Anti-Tamper Salary Disbursement Shield",
  "Mobile App for Tax Declaration",
  "District-wise Per-Capita Cost Benchmarker",
  "Automated Reminder for Tax Filings",
  "Historical Payroll Growth Analyzer",
  "Financial Code/Treasury SOP Trainer",
  "Payroll Database Server Health Monitor",
  "Imminent Budget Exhaustion Alert",
  "Salary Delay/Grievance Profiler",
  "High-Priority Retiree Settlement Classifier",
  "AI Assisted Finance Department Request Drafter",
  "Payroll Data Storage Forecaster",
  "Secure Bank Account Detal Protector",
  "Integration with PF/NPS Portals",
  "Grievance Portal Sync (for pay anomalies)",
  "Election Duty Honorarium Modeler",
  "Disaster Hazard Pay Coordinator",
  "Overall Establishment Budget Tracker",
  "Custom Workflow for Stop-Payment (Suspension)",
  "AI Driven Budget Requirement Predictor",
  "Predictive Need for Supplementary Demands",
  "Custom Alert Trigger for Finance Secretary",
  "Employee Salary/Pension Lifecycle Timeline"
];
...
const SalaryProjectionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SALARY PROJECTION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SALARY <span>PROJECTION</span></h1>
...
export default SalaryProjectionDetailed;
