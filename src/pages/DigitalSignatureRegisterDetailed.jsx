...
const aiExperts = [
"DSC Token Inventory & Custody Tracker AI",
  "Automated Expiry & Renewal Alert Bot",
  "Signing Authority Level Verification AI",
  "Suspicious/Multiple Location Sign Alert",
  "Officer Transfer/Retirement DSC Revocation Bot",
  "Lost/Stolen Token Immediate Block AI",
  "Biometric/OTP Secondary Authentication Sync",
  "e-FIR/CCTNS Signature Validation Linker",
  "DSC Usage Frequency & Workload Modeler",
  "Automated Renewal Application Auto-Gen AI",
  "Class 2/Class 3 DSC Categorization Bot",
  "Voice-Command DSC Status/Expiry Query",
  "Command Center Real-time DSC Dashboard",
  "Blockchain Immutable Log of All Signatures",
  "Inter-Agency (Court/Bank) Signature Matcher",
  "AI Evaluator for DSC Policy Compliance",
  "Rogue/Unauthorized Sign Attempt Predictor",
  "Vendor/Certifying Authority (CA) Sync Bot",
  "Automated Handover/Takeover Log Gen",
  "DSC USB Dongle Hardware Health Tracker",
  "Multi-Lingual DSC Usage Instruction Bot",
  "VIP/Senior Officer High-Priority Support AI",
  "Cyber Security/Malware Threat to DSC AI",
  "AI Generated Monthly DSC Utilization Report",
  "Court Summons/Warrant e-Sign Verification",
  "Financial/Budget Approval Sign Linker AI",
  "Election Duty DSC Re-assignment Tracker",
  "Central PHQ Master DSC Database Sync",
  "AI Protocol for Emergency DSC Override",
  "Suspended Officer Auto-Revoke Trigger AI",
  "DSC Password Reset/Unlock Secure Router",
  "RTI/Legal Document e-Sign Tracker",
  "Geo-Fenced Signing Location Enforcer AI",
  "AI Driven Audit of DSC Procurement Cost",
  "Traffic E-Challan Bulk Signing Optimizer",
  "Mobile App for DSC Status & Alerts",
  "AI Assisted Dispute Resolution for Signatures",
  "Old/Revoked DSC Token Destruction Logger",
  "Integration with Government e-Marketplace (GeM)",
  "AI Driven Shift-wise Signing Analytics",
  "Cross-District DSC Verification Sync Bot",
  "AI Protocol for Remote/Work-from-Home Signing",
  "DSC Token Duplication/Cloning Detection AI",
  "Automated Notification to CA for Revocation",
  "Officer Accountability/Non-Repudiation Scorer",
  "AI Evaluator for e-Sign vs Wet-Sign ROI",
  "Document Tamper Post-Signature Alert Bot",
  "AI Assisted Training for New DSC Users",
  "DSC Inventory vs Active Officer Matcher",
  "AI Driven Hardware Token Upgrade Recommender",
  "Subpoena/Legal Challenge to Signature Defender",
  "AI Generated Compliance Audit for IT Act"
];
...
const DigitalSignatureRegisterDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DIGITAL SIGNATURE REGISTER
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI DIGITAL SIGNATURE REGISTER</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in dsc token tracking, automated expiry renewal alerts & signing authority.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DIGITAL SIGNATURE <span>REGISTER</span></h1>
            <p className="cyber-subtitle">DSC Token Tracking, Automated Expiry Renewal Alerts & Signing Authority</p>
          </div>
        </div>
      </header>
...
export default DigitalSignatureRegisterDetailed;
