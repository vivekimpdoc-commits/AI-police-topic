...
const aiExperts = [
  "Consumption vs Billing Discrepancy AI",
  "Underground Leakage Waste Costing Engine",
  "Commercial vs Residential Tariff Validator",
  "Pending Arrears/Surcharge Tracker",
  "Smart Flow-Meter/IoT Usage Insights",
  "Borewell vs Municipal Supply Cost Analyzer",
  "Geo-Spatial Water Usage/Scarcity Mapper",
  "Rainwater Harvesting Offset Scorer",
  "Water Bill Dashboard",
  "Voice-Command Utility Query Bot",
  "Automated Monthly Water Audit Report",
  "Municipal Corporation/Jal Board Sync",
  "Estimated vs Actual Reading Conflict Detector",
  "Faulty/Tampered Water Meter Predictor",
  "Unauthorized Tapping/Theft Identifier",
  "Per-Capita Consumption Correlator",
  "AI Evaluator for Water Conservation",
  "Audit/Payment Log Generator",
  "Data Privacy/Barrack Usage Scrubber",
  "Finance/Accounts Sync",
  "Quartermaster/Estate Mobile App",
  "Historical Summer/Drought Cost Correlator",
  "SP/Estate Officer Briefing AI",
  "Bill Payment/Clearance Allocator",
  "Blockchain Immutable Bill/Payment Hash",
  "Anti-Tamper Smart Meter Shield",
  "Mobile App for Meter Image Upload",
  "Station-wise Water Efficiency Benchmarker",
  "Automated Alert for Disconnection/Penalty",
  "Historical Water Expenditure Trend Analyzer",
  "Water Conservation/Plumbing SOP Trainer",
  "IoT Flow Sensor Gateway Monitor",
  "Imminent Budget Exhaustion/Water Cut Alert",
  "Water Wasting Unit/Colony Profiler",
  "High-Consumption (Training Academy/Lines) Classifier",
  "AI Assisted Disputed Bill Drafter",
  "Sensor Telemetry Storage Forecaster",
  "Secure Water Supply Infrastructure Protector",
  "Integration with Public Health Engineering Dept",
  "Welfare Portal Sync (for colony supply)",
  "Election Force Mobilization Usage Modeler",
  "Disaster Relief Camp Water Cost Coordinator",
  "Water Utility Budget Tracker",
  "Custom Workflow for STP (Sewage Treatment) Tender",
  "AI Driven Summer Usage/Cost Predictor",
  "Predictive Need for New Borewell/Tank",
  "Custom Alert Trigger for IG Provisioning",
  "Water Cost/Usage Lifecycle Timeline Tracker"
];
...
const WaterBillAnalyticsDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI WATER BILL ANALYTICS
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI WATER BILL <span>ANALYTICS</span></h1>
...
export default WaterBillAnalyticsDetailed;
