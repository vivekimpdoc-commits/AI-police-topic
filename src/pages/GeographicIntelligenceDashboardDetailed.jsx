...
const aiExperts = [
  "Spatial Crime Clustering Engine AI",
  "Regional Threat Index Auto-Calculator Bot",
  "Real-Time Patrol Force Geolocation Matcher",
  "Terrain Analysis (Forest/Urban) Covert Path AI",
  "Cross-Border Infiltration Geographic Modeler AI",
  "Resource Allocation Optimizer Dashboard Bot",
  "Emergency Route Traffic Flow Optimizer Bot",
  "CCTV Camera Placement Spatial Auditor Bot",
  "Geographic Intel Command Dashboard Portal",
  "Voice-Command Map Layer Query Bot",
  "Automated Daily Spatial Intel Report Generator",
  "Cross-Department GIS Database Sync Engine",
  "Suspect Path GPS Overlay Tracker Engine AI",
  "Crime Hotspot Density Heatmap Generator Bot",
  "State/District Border Checkpost GPS Sync Bot",
  "Waterbody Encroachment Geo-Spatial Analyzer AI",
  "AI Evaluator for Route Vulnerability Index %",
  "Audit/Geographic Layer Change Log Generator",
  "Data Privacy/Patrol Officer Route Masker AI",
  "Police-Municipal Map Server Database Sync",
  "Patrol Officer Geo-Track Mobile App Sync Portal",
  "Cold Case Location Signature Chrono Linker",
  "Senior Officer (SP Intelligence Command) Briefing",
  "Public Missing Person Last-Seen Map Portal",
  "Blockchain Immutable Location Evidence Log Hasher",
  "Anti-Tamper GPS Tracker Position Shield AI",
  "Mobile App for Offline Map Navigation System",
  "Landslide/Road Blockage GIS Predictor Bot",
  "Multi-Lingual Location Label Translator Engine",
  "Historical Spatial Crime Trend Matcher Bot",
  "Staff Map Tool Operation Training Tracker AI",
  "Map Server Node Cluster Health Monitor Bot",
  "Urgent Area Lockdown Route Planner Alert AI",
  "Traffic Intersection Congestion Spatial Overlay",
  "Terror Safehouse Geographic Spatial Matcher AI",
  "VIP Escort Convoy Route Planner Dashboard",
  "AI Assisted Spatial Damage Valuation Report Draft",
  "GIS Bandwidth Priority Resource Optimizer Bot",
  "Anti-Poaching Tiger Corridor GPS Monitor Bot",
  "Integration with National Spatial Data Infrastructure",
  "Citizen Geo-Tagged Infrastructure Complaint App",
  "Extreme Weather Navigation Safety Route Advisor",
  "Disaster Safe Zone Evacuation Crowd Simulator",
  "Geographic Wing Center Budget/Cost Tracker AI",
  "Custom Workflow/Approval for Geo-Layer Modification",
  "AI Driven Crime Cluster Migration Predictor AI",
  "Predictive Need for New Police Outpost Location",
  "Custom Alert Trigger for GIS Nodal Officer"
];
...
const GeographicIntelligenceDashboardDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI GEOGRAPHIC DASHBOARD
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI GEOGRAPHIC DASHBOARD</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in spatial crime intel maps, regional threat levels, heatmaps & patrol resource allocation.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI GEOGRAPHIC <span>DASHBOARD</span></h1>
            <p className="cyber-subtitle">Spatial Crime Intel Maps, Regional Threat Levels, Heatmaps & Patrol Resource Allocation</p>
          </div>
        </div>
      </header>
...
export default GeographicIntelligenceDashboardDetailed;
