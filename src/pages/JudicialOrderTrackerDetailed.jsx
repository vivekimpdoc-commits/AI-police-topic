...
const aiExperts = [
  "Court Order NLP Extraction/Summarizer",
  "Actionable Direction Parsing Engine",
  "Contempt of Court Risk Scorer",
  "Compliance Deadline/Milestone Tracker",
  "Department-Specific Task Router AI",
  "Stay Order/Injunction Geo-Mapper",
  "CCTNS/E-Courts Judgment Sync",
  "Non-Compliance Escalation Analyzer",
  "Order Tracker Command Dashboard",
  "Voice-Command Compliance Status Bot",
  "Automated Pending Order Report",
  "Inter-Department (Civic/Revenue) Sync",
  "Geo-Spatial Dispute Hotspot Modeler",
  "Attachment/Seizure Warrant Monitor",
  "Ambiguous Order Clarification Predictor",
  "Precedent/Past Compliance Matcher",
  "AI Evaluator for Department Response",
  "Audit/Compliance Action Log Gen",
  "Data Privacy/Sensitive Order Scrubber",
  "State Legal Dept Sync Bot",
  "Field IO Compliance Task App",
  "Historical Contempt Case Correlator",
  "DGP/Home Secretary Briefing AI",
  "Nodal Officer/Task Allocator",
  "Blockchain Immutable Compliance Hash",
  "Anti-Tamper Judicial Record Shield",
  "Mobile App for Eviction/Seizure Updates",
  "Jurisdiction Polygon Matcher",
  "Multi-Lingual Judgment Translator",
  "Historical Compliance Rate Analyzer",
  "Judicial Etiquette SOP Trainer",
  "Tracker DB Server Health Monitor",
  "Imminent Contempt Deadline Alert Bot",
  "Syndicate Asset Attachment Profiler",
  "Supreme Court/High Court Directive Classifier",
  "AI Assisted Compliance Affidavit Drafter",
  "Judgment Document Storage Forecaster",
  "Secure Protected Witness Protector",
  "Integration with E-Courts API",
  "Citizen Grievance Order Portal Sync",
  "Riot/Mass Violence Directive Modeler",
  "Disaster Relief Court Order Coordinator",
  "Legal Compensation Budget Tracker",
  "Custom Workflow for Multi-Agency Orders",
  "AI Driven Penalty Predictor",
  "Predictive Need for Specialized Counsel",
  "Custom Alert Trigger for Chief Secretary",
  "Judicial Order Lifecycle Timeline Tracker"
];
...
const JudicialOrderTrackerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI JUDICIAL ORDER TRACKER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI JUDICIAL ORDER <span>TRACKER</span></h1>
...
export default JudicialOrderTrackerDetailed;
