...
const aiExperts = [
  "Tip Reliability/Credibility Scorer AI",
  "Secret Service (SS) Fund Auditor",
  "Source/Informant Track-Record Analyzer",
  "Anonymous Identity/Alias Protector",
  "Bounty/Reward ROI Estimator",
  "Cross-District Informant De-duplicator",
  "Geo-Spatial Tip Origin Mapper",
  "False-Flag/Disinformation Detector",
  "Informant/Reward Dashboard",
  "Voice-Command Fund Query Bot",
  "Automated Monthly SS Fund Audit Report",
  "State Intelligence Department Sync",
  "Informant Burn/Exposure Risk Predictor",
  "Extortion/Double-Cross Risk Analyzer",
  "Delayed Payment/Grievance Alert",
  "Value-of-Intelligence (VoI) Scorer",
  "AI Evaluator for Source Network Health",
  "Audit/Disbursement Log Generator",
  "Data Privacy/Top-Secret Scrubber",
  "Finance/Accounts (Confidential) Sync",
  "Handling Officer (HO) Secure App",
  "Historical Tip-to-Arrest Correlator",
  "SP (Intelligence) Briefing AI",
  "Reward Disbursement/Approval Allocator",
  "Blockchain Immutable Disbursement Hash",
  "Anti-Tamper Identity Shield",
  "Mobile App for Secure Tip Upload",
  "District-wise Informant Yield Benchmarker",
  "Automated Alert for High-Value (Terror/Narco) Tip",
  "Historical Reward Efficacy Analyzer",
  "Source Handling/Tradecraft SOP Trainer",
  "Dark-Web/Encrypted Comms API Monitor",
  "Imminent Source Compromise/Assassination Alert",
  "Fabricated Tip/Rogue Informant Profiler",
  "High-Stakes (Underworld/Naxal) Source Classifier",
  "AI Assisted Reward Sanction Drafter",
  "Intelligence Yield/Trend Forecaster",
  "Secure Source Dossier Protector",
  "Integration with NIA/IB Watchlists",
  "Anti-Terrorism Squad (ATS) Sync",
  "Election Money/Liquor Distribution Tip Modeler",
  "Disaster Hoax/Panic Tip Coordinator",
  "Secret Service Fund Budget Tracker",
  "Custom Workflow for Surrendered Militants",
  "AI Driven Next Quarter Fund Requirement Predictor",
  "Predictive Need for Source Relocation",
  "Custom Alert Trigger for DGP (Intel)",
  "Tip Receipt to Reward Disbursement Timeline"
];
...
const PoliceInformantRewardManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI POLICE INFORMANT REWARD MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI POLICE INFORMANT REWARD <span>MANAGEMENT</span></h1>
...
export default PoliceInformantRewardManagementDetailed;
