...
const aiExperts = [
  "Structural Crack/Fissure Vision AI",
  "Vibration/Seismic Anomaly Detector",
  "Load-Bearing Stress Analyzer",
  "Lifecycle Degradation Scorer",
  "Foundation Settlement Monitor",
  "Corrosion/Rust Detection AI",
  "Geo-Spatial Estate Structural Mapper",
  "Non-Destructive Testing (NDT) Integrator",
  "Structural Health Dashboard",
  "Voice-Command Building Safety Bot",
  "Automated Quarterly Inspection Report",
  "State PWD/Engineering Sync",
  "Imminent Collapse Risk Predictor",
  "Overcrowding Stress Alert",
  "Material Fatigue Analyzer",
  "Maintenance Priority Router",
  "AI Evaluator for Estate Safety Index",
  "Audit/Inspection Log Generator",
  "Data Privacy/Facility Blueprint Scrubber",
  "Infrastructure Planning Department Sync",
  "Civil Engineer Field Inspection App",
  "Historical Structural Failure Correlator",
  "SP (Infrastructure) Briefing AI",
  "Repair Task Allocator",
  "Blockchain Immutable Structural Hash",
  "Anti-Tamper Safety Record Shield",
  "Mobile App for Quick Snag Upload",
  "Station-wise Structural Integrity Benchmarker",
  "Automated Alert for Critical Weakness",
  "Historical Civil Work Cost Analyzer",
  "Building Safety SOP Trainer",
  "IoT Strain Gauge Health Monitor",
  "Imminent Roof/Wall Collapse Alert",
  "Substandard Material Vendor Profiler",
  "High-Priority (Headquarters/Armory) Assessment Classifier",
  "AI Assisted Condemnation Notice Drafter",
  "Structural Scan/Image Forecaster",
  "Secure Facility Layout Protector",
  "Integration with E-Tendering/Procurement",
  "Building Renovation Portal Sync",
  "Election Mass Deployment Load Modeler",
  "Disaster Post-Earthquake Assessment Coordinator",
  "Civil Maintenance Budget Tracker",
  "Custom Workflow for Heritage Police Buildings",
  "AI Driven Structural Lifespan Predictor",
  "Predictive Need for Deep Retrofitting",
...
const BuildingStructuralHealthIndexDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI BUILDING STRUCTURAL HEALTH INDEX
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI BUILDING STRUCTURAL HEALTH <span>INDEX</span></h1>
...
export default BuildingStructuralHealthIndexDetailed;
