...
const aiExperts = [
  "VIP Reference NLP Extractor",
  "CMO/HMO Priority Routing Engine",
  "Directive Fulfillment Timeline AI",
  "Inter-Department Circular Sync Bot",
  "Grievance/Reference Deduplication AI",
  "Reference Sentiment/Urgency Scorer",
  "Action Taken Report (ATR) Generator",
  "Delay Escalation Matrix Bot",
  "Govt Reference Dashboard",
  "Voice-Command Reference Query Bot",
  "Automated Daily Pending Report",
  "Cross-District Execution Sync Bot",
  "Political Sensitivity Analyzer AI",
  "Policy Change Impact Predictor",
  "Routine vs Urgent Reference Sorter",
  "Feedback Loop Verification Bot",
  "AI Evaluator for Response Adequacy",
  "Audit/Reference Access Log Gen",
  "Data Privacy/Citizen Detail Scrubber",
  "CMO/HMO Dashboard Sync Bot",
  "Field IO Directive Execution App",
  "Historical VIP Reference Matcher",
  "DGP/IG Level Review Briefing AI",
  "Reference Execution Resource Allocator",
  "Blockchain Immutable Reference Hash",
  "Anti-Tamper Directive Shield AI",
  "Mobile App for VIP Alerts",
  "Reference Geographic Focus Matcher",
  "Multi-Lingual Reference Translator",
  "Historical Reference Trend Analyzer",
  "Protocol/Reference SOP Trainer",
  "Reference DB Server Health Monitor",
  "Imminent VIP Deadline Alert Bot",
  "Organized Crime Reference Profiler",
  "VIP/High-Priority Classifier Bot",
  "AI Assisted Interim Reply Drafter",
  "Reference Document Forecaster",
  "Secure Whistleblower Reference Protector",
  "Integration with eOffice/Govt Portals",
  "Citizen Satisfaction Feedback Analytics",
  "Media Escalation Risk Modeler",
  "Disaster Relief VIP Directive Coordinator",
  "Directive Execution Budget Tracker",
  "Custom Workflow for Final Approval",
  "AI Driven Next Directive Predictor",
  "Predictive Need for Field Deployment",
  "Custom Alert Trigger for Nodal Officers",
  "Reference Lifecycle Timeline Tracker"
];
...
const GovernmentReferenceMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI GOVERNMENT REFERENCE MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI GOVERNMENT REFERENCE <span>MONITORING</span></h1>
...
export default GovernmentReferenceMonitoringDetailed;
