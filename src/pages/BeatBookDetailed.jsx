...
const aiExperts = [
"Digital Beat Book Analytics",
  "Local Informant Reliability Scorer",
  "Historical Criminal Mapping AI",
  "Repeat Offender Address Sync",
  "Gang Territory Overlap Analyzer",
  "Automated Beat Report Generator",
  "Missing Persons Beat Correlation",
  "Suspicious Vehicle Log Analyzer",
  "Community Demographics Integration",
  "Beat-Level Sentiment Tracker",
  "Drug Hotspot Predictive Modeler",
  "Night-Shift Vulnerability AI",
  "Licensed Weapon Holder Sync",
  "Elderly/Vulnerable Citizen Tracker",
  "School & Hospital Proximity Sync",
  "CCTV Camera Location Mapping AI",
  "ATMs & Bank Security Status Sync",
  "Liquor Shop & Bar Disturbance Modeler",
  "Pawn Shop Stolen Goods Cross-Checker",
  "Rented Property Tenant Verification AI",
  "Hotel/Lodge Guest Log Sync AI",
  "Automated Show-Cause for Missing Entries",
  "Beat Book Digital Signature Authenticator",
  "Inter-Beat Criminal Migration Modeler",
  "Beat Officer Workload Analytics",
  "Local Festival & Event Threat Sync",
  "Industrial/Factory Shift Sync AI",
  "Cyber-Cafe User Log Integrator",
  "Scrap Dealer (Kabaadi) Stolen Metal Sync",
  "Vehicle Service Center Damage Checker",
  "Unverified Servant/Driver Alert AI",
  "Private Security Guard Roster Sync",
  "Abandoned Property Squatter Alert",
  "Traffic Bottleneck Beat Impact AI",
  "Public Transport Route Vulnerability AI",
  "Beat History Succession Handoff AI",
  "Officer Familiarity & Language Sync",
  "Neighborhood Watch Coordinator AI",
  "Stray Animal Attack Hotspot Sync",
  "Open Manhole & Hazard Mapping AI",
  "Streetlight Outage Safety Modeler",
  "Political Rally Impact Analyzer",
  "Protest Origin Predictive Mapping",
  "Local VIP Residence Security Sync",
  "Beat Book Blockchain Integrity Ledger",
  "Voice-to-Text Field Entry AI",
  "Multilingual Beat Book Translator",
  "Offline Mobile Sync for Remote Beats",
  "Facial Recognition Suspect Tagging",
  "Fingerprint Verification Sync AI",
  "Wanted Criminal Facial Match Alert",
  "Beat Level Budget & Resource Request AI",
  "Drone Aerial Beat Mapping Sync",
  "Local Business Extortion Risk AI",
  "Commendation Tracker for Beat Constables",
  "Disciplinary Action Trend Analyzer",
  "Community Trust Index Scorer AI",
  "Real-Time Beat Readiness Dashboard",
  "Next-Gen Holographic Beat Mapping AI",
  "Predictive Crime Hotspot AI"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> BEAT BOOK AI
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>BEAT BOOK AI</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in digital intelligence & record ledger.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">BEAT BOOK <span>AI</span></h1>
            <p className="cyber-subtitle">Digital Intelligence & Record Ledger</p>
          </div>
        </div>
      </header>
...
export default BeatBookDetailed;
