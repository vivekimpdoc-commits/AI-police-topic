...
const aiExperts = [
"Overnight Crime/Incident Summarizer",
  "Night Shift Handover Log Sync AI",
  "Priority Task Assignment Auto-Router",
  "Morning VIP Movement Briefing AI",
  "Pending FIRs / Unsolved Cases Alert",
  "Overnight 112 Distress Call Scorer",
  "Hospital Medico-Legal Night Log",
  "Night Patrol GPS Coverage Analyzer",
  "Stolen Vehicle Overnight Tally Bot",
  "Missing Person Overnight Alert Sync",
  "Traffic/Accident Overnight Summary AI",
  "Weather/Fog Impact on Morning Route",
  "Court Hearing Schedule Morning Sync",
  "Cyber Crime Overnight Surge Alert",
  "Social Media Viral Threat Morning Log",
  "Border/Checkpost Overnight Seizures",
  "Jail/Prison Incident Overnight Sync",
  "Armoury Weapon Return Morning Audit",
  "Officer Leave/Absentee Morning Tally",
  "Morning Briefing Voice-Over Bot AI",
  "Automated Morning Briefing PDF Gen",
  "SHO/Inspector Priority Focus AI",
  "Senior Officer (SP/SSP) Dashboard Sync",
  "Overnight Riot/Protest Flash Alert",
  "Women/Child Safety Overnight Log",
  "Drunk Driving Naka Overnight Tally",
  "Inter-State Smuggling Overnight Alert",
  "Intelligence/Special Branch Morning Sync",
  "Media Headline Sentiment Morning Brief",
  "Morning Brief Multi-Lingual Translator",
  "Automated Task Follow-up Morning Bot",
  "Pending Warrants/Summons Morning AI",
  "Bail/Parole Reporting Morning Check",
  "CCTNS Server Uptime Morning Status",
  "Police Station Cleanliness Morning Log",
  "Vehicle Fleet Availability Morning Sync",
  "Fuel/Ammunition Stock Morning Alert",
  "Morning Brief Action Item Extractor",
  "Command Center Handover Brief AI",
  "Overnight Fire/Disaster Rescue Log",
  "Railway/Metro Police Overnight Sync",
  "Tourist Incident Overnight Briefing",
  "Election Campaign Overnight Log AI",
  "Morning Brief Read/Acknowledge Tracker",
  "Historical Morning Brief Comparison AI",
  "Unidentified Body Found Overnight Log",
  "Ransom/Extortion Overnight Tip Sync",
  "Informant/Source Tip Morning Brief",
  "Morning Briefing Presentation (PPT) Gen",
  "Automated Email/WhatsApp Morning Dispatch",
  "Night Beat Constable Performance AI",
  "Morning Brief Urgency Scorer Bot",
  "Overnight Drone/CCTV Anomaly Alert",
  "Public Event Setup Morning Status",
  "VIP Route Sanitization Morning Check",
  "Police Hospital/Sick Officer Morning Log",
  "Suspicious Person Check Overnight Tally",
  "Morning Brief Cryptographic Signer",
  "Overnight Network/Cyber Attack Brief",
  "Morning Brief Blockchain Immutable Log"
];
...
const MorningBriefGeneratorDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI MORNING BRIEF GENERATOR
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI MORNING BRIEF GENERATOR</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in overnight incident summaries, shift handover logs & priority task assignment.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI MORNING BRIEF <span>GENERATOR</span></h1>
            <p className="cyber-subtitle">Overnight Incident Summaries, Shift Handover Logs & Priority Task Assignment</p>
          </div>
        </div>
      </header>
...
export default MorningBriefGeneratorDetailed;
