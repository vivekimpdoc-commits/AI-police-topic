...
const aiExperts = [
  "Perimeter Intrusion Detection System (PIDS) AI",
  "ANPR (Number Plate) Gate Access Engine",
  "Sentry Alertness/Duty Monitor Vision",
  "Drone/UAV Surveillance Feed Integrator",
  "Tailgating/Unauthorized Vehicle Detector",
  "Facial Recognition Blacklist Matcher",
  "Geo-Spatial Campus Perimeter Mapper",
  "Night-Vision/Thermal Anomaly Detector",
  "Campus Security Command Dashboard",
  "Voice-Command Threat Query Bot",
  "Automated Daily Perimeter Breach Report",
  "District Control Room Sync",
  "Fence Tamper/Cut Predictor",
  "Unattended Baggage/Object Alert",
  "Sentry Sleep/Absence Detector",
  "Visitor/Contractor Loitering Analyzer",
  "AI Evaluator for Campus Vulnerability Index",
  "Audit/Access Log Generator",
  "Data Privacy/Resident Plate Scrubber",
  "State Intelligence/ATS Sync",
  "Quick Response Team (QRT) Mobile App",
  "Historical Mob Protest/Attack Correlator",
  "Chief Security Officer Briefing AI",
  "Patrol/Sentry Task Allocator",
  "Blockchain Immutable Breach Hash",
  "Anti-Tamper CCTV/ANPR Log Shield",
  "Mobile App for Sentry Check-In/SOS",
  "Gate-wise Security Speed Benchmarker",
  "Automated Alert for Perimeter Breach",
  "Historical Security Infrastructure Cost Analyzer",
  "Base Security/Sentry SOP Trainer",
  "PIDS/Camera Health Monitor",
  "Imminent Mob Attack/Infiltration Alert",
  "Suspicious Reconnaissance/Scout Profiler",
  "High-Security (Armory/Magazine) Zone Classifier",
  "AI Assisted Security Upgrade Drafter",
  "Video Feed/ANPR Storage Forecaster",
  "Secure Campus Blueprint Protector",
  "Integration with City Safe City Project",
  "Dial 112/Emergency Sync",
  "Election Counting Center Perimeter Modeler",
  "Disaster Refugee Camp Security Coordinator",
  "Security Tech/CCTV Budget Tracker",
  "Custom Workflow for VIP Convoy Entry",
  "AI Driven Threat Vector Predictor",
  "Predictive Need for Extra Perimeter Lighting",
  "Custom Alert Trigger for SP/Commandant",
  "Threat Detection to Interception Timeline"
];
...
const PoliceCampusSecurityDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI POLICE CAMPUS SECURITY
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI POLICE CAMPUS <span>SECURITY</span></h1>
...
export default PoliceCampusSecurityDetailed;
