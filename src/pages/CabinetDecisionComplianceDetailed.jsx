...
const aiExperts = [
  "Cabinet Decision NLP Extractor",
  "Policy Implementation Router Engine",
  "Mandate Execution Timeline Predictor",
  "Fund Allocation/Utilization Tracker",
  "Gazette Notification Draft Assistant",
  "Inter-Department Compliance Sync",
  "Delay/Bottleneck Root Cause Analyzer",
  "Rules & Regulations Formulation AI",
  "Cabinet Compliance Dashboard",
  "Voice-Command Compliance Query Bot",
  "Automated Execution Progress Report",
  "District Level Implementation Sync",
  "Legal Vetting Assistant Engine",
  "Impact Assessment Modeler AI",
  "Recruitment/Procurement Tracker Bot",
  "Cabinet Note Reference Correlator",
  "AI Evaluator for Compliance Quality",
  "Audit/Execution Action Log Gen",
  "Data Privacy/Draft Policy Scrubber",
  "Cabinet Secretariat Sync Bot",
  "Field Execution Verification App",
  "Historical Cabinet Precedent Matcher",
  "DGP/Chief Secretary Briefing AI",
  "Implementation Resource Allocator",
  "Blockchain Immutable Compliance Hash",
  "Anti-Tamper Execution Shield AI",
  "Mobile App for Deadline Alerts",
  "Policy Geographic Impact Matcher",
  "Multi-Lingual Notification Translator",
  "Historical Policy Success Analyzer",
  "Policy Implementation SOP Trainer",
  "Compliance DB Server Health Monitor",
  "Urgent Implementation Delay Alert",
  "Organized Crime Impact Profiler",
  "VIP/Flagship Policy Classifier",
  "AI Assisted Status Report Drafter",
  "Policy Document Storage Forecaster",
  "Secure Inter-Department Comms Protector",
  "Integration with Finance/HR Portals",
  "Citizen Policy Impact Analytics",
  "Public Resistance/Protest Modeler",
  "Disaster Relief Cabinet Directive Coordinator",
  "Policy Execution Budget Tracker",
  "Custom Workflow for Status Approval",
  "AI Driven Policy Outcome Predictor",
  "Predictive Need for Cabinet Revision",
  "Custom Alert Trigger for Nodal Leads",
  "Policy Lifecycle Timeline Tracker"
];
...
const CabinetDecisionComplianceDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CABINET DECISION COMPLIANCE TRACKER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CABINET DECISION COMPLIANCE <span>TRACKER</span></h1>
...
export default CabinetDecisionComplianceDetailed;
