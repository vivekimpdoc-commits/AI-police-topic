...
const aiExperts = [
  "Leased Line (ILL) Bandwidth Utilization AI",
  "SLA/Downtime Penalty Calculator Bot",
  "Bandwidth Hoarding/Streaming Detection Engine",
  "Branch-wise Cost Apportionment Mapper",
  "Redundant/Backup Link ROI Analyzer",
  "Data Overuse/FUP (Fair Usage) Alert AI",
  "Geo-Spatial Network Node Mapper",
  "Unauthorized Tethering/Hotspot Identifier",
  "Internet Expense Dashboard",
  "Voice-Command Bandwidth Query Bot",
  "Automated Monthly Network Audit Report",
  "ISP (Internet Service Provider) NMS Sync",
  "Billing Anomaly/Hidden Charge Detector",
  "Speed Downgrade/Upgrade Suggester AI",
  "Crypto-Mining/Torrent Bandwidth Drain Predictor",
  "Peak vs Off-Peak Usage Correlator",
  "AI Evaluator for Network Cost-Efficiency",
  "Audit/Payment Log Generator",
  "Data Privacy/Browsing History Scrubber",
  "Finance/Accounts & IT Dept Sync",
  "Network Admin Dashboard Mobile App",
  "Historical VVIP Visit/Event Surge Correlator",
  "SP (Computer/IT) Briefing AI",
  "Bill Payment/Clearance Allocator",
  "Blockchain Immutable SLA/Uptime Hash",
  "Anti-Tamper Network Log Shield",
  "Mobile App for Downtime Reporting",
  "Station-wise Connectivity Cost Benchmarker",
  "Automated Alert for Sustained Outage",
  "Historical IT/Network Expenditure Analyzer",
  "Cyber Security/Bandwidth Usage SOP Trainer",
  "Router/Firewall SNMP Health Monitor",
  "Imminent Budget Exhaustion Alert",
  "Bandwidth Abuser (Non-Official) Profiler",
  "Critical (CCTNS/Data Center) Link Classifier",
  "AI Assisted Vendor Penalty Notice Drafter",
  "Network Flow/Log Storage Forecaster",
  "Secure IT Infrastructure Topology Protector",
  "Integration with State Wide Area Network (SWAN)",
  "Cyber Cell Threat Intel Sync",
  "Election Webcasting/CCTV Bandwidth Modeler",
  "Disaster Mobile Tower/VSAT Cost Coordinator",
  "IT/Telecom Budget Tracker",
  "Custom Workflow for Emergency Bandwidth Burst",
  "AI Driven Data Growth/Cost Predictor",
  "Predictive Need for Fiber Upgrade",
  "Custom Alert Trigger for IG Provisioning/IT",
  "Network Infrastructure Lifecycle Tracker"
];
...
const InternetExpenseMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INTERNET EXPENSE MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INTERNET EXPENSE <span>MONITORING</span></h1>
...
export default InternetExpenseMonitoringDetailed;
