...
const aiExperts = [
  "Bulk Summons Generation/Formatting AI",
  "Delivery Route/Process Server Optimizer",
  "Electronic Service (Email/WhatsApp) Tracker",
  "Statutory Deadline/Validity Alert Bot",
  "Witness/Accused Attendance Predictor",
  "Non-Service Reason/Excuse Analyzer",
  "CCTNS/E-Courts API Sync Engine",
  "Pending Summons Backlog Tracker",
  "Summons Command Dashboard",
  "Voice-Command Summons Status Bot",
  "Automated Daily Service Roster",
  "Inter-District/State Sync Bot",
  "Geo-Spatial Non-Service Hotspot Mapper",
  "Address Verification/Correction AI",
  "Fake Address/Absconder Detector",
  "Digital Signature/Acknowledgment Verifier",
  "AI Evaluator for Process Server Efficiency",
  "Audit/Service Log Generator",
  "Data Privacy/Witness Detail Scrubber",
  "Directorate of Prosecution Sync",
  "Field Process Server Mobile App",
  "Historical Evasion Pattern Matcher",
  "SHO/Supervisory Officer Briefing",
  "Process Server Resource Allocator",
  "Blockchain Immutable Delivery Hash",
  "Anti-Tamper Acknowledgment Shield",
  "Mobile App for E-Summons Delivery",
  "Jurisdiction Polygon Matcher",
  "Multi-Lingual Summons Translator",
  "Historical Service Rate Analyzer",
  "Summons Service SOP Trainer",
  "Summons DB Server Health Monitor",
  "Imminent Limitation Period Alert",
  "Syndicate Witness Intimidation Profiler",
  "High-Profile VIP Witness Classifier",
  "AI Assisted Substituted Service Drafter",
  "Document Digitization Storage Forecaster",
  "Secure Protected Witness Protector",
  "Integration with Postal/Telecom APIs",
  "Citizen Summons Status Portal Sync",
  "Mass Trial/Riot Case Summons Modeler",
  "Disaster Disrupted Service Tracker",
  "Service/Travel Allowance Budget Tracker",
  "Custom Workflow for Bailable Warrants",
  "AI Driven Service Delay Predictor",
  "Predictive Need for Police Escort",
  "Custom Alert Trigger for Nodal Officers",
  "Summons Lifecycle Timeline Tracker"
];
...
const SummonsManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SUMMONS MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SUMMONS <span>MANAGEMENT</span></h1>
...
export default SummonsManagementDetailed;
