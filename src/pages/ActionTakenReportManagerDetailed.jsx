...
const aiExperts = [
  "ATR Deadline/Timeline Tracker AI",
  "Evidence/Document Verification Bot",
  "Automated Escalation (to higher ranks) Engine",
  "Pending Task/Bottleneck Identifier",
  "Vague/Incomplete Report Detector",
  "Semantic Similarity Matcher (for generic replies)",
  "Geo-Spatial Pending ATR Mapper",
  "Cross-Department Dependency Analyzer",
  "ATR Dashboard",
  "Voice-Command Task Query Bot",
  "Automated Weekly Defaulter Report",
  "Meeting Minutes (MoM) Sync Bot",
  "Multi-Lingual ATR Translation",
  "Attachment/Photo Authenticity Checker",
  "Fake/Fabricated ATR Predictor",
  "Task Completion Percentage Estimator",
  "AI Evaluator for Action Effectiveness",
  "Audit/ATR Submission Log Gen",
  "Data Privacy/Classified Info Scrubber",
  "E-Office/File Tracking Sync",
  "Field Officer Task Update App",
  "Historical Delay/Excuse Correlator",
  "Supervisory Officer Briefing AI",
  "Re-Investigation/Follow-up Allocator",
  "Blockchain Immutable ATR Hash",
  "Anti-Tamper Report Shield",
  "Mobile App for Evidence Upload",
  "Jurisdiction-wise Compliance Benchmarker",
  "Automated Reminder for Overdue ATRs",
  "Historical Compliance Quality Analyzer",
  "ATR Drafting SOP Trainer",
  "ATR DB Server Health Monitor",
  "Imminent Deadline Default Alert",
  "Chronic Defaulter/Evasive Officer Profiler",
  "High-Priority/Court-Mandated ATR Classifier",
  "AI Assisted Show-Cause Notice Drafter",
  "Document Storage Forecaster",
  "Secure Internal Inquiry Protector",
  "Integration with Judicial/Court Portals",
  "Public Grievance Resolution Sync",
  "Election Commission Order ATR Modeler",
  "Disaster Relief Action Coordinator",
  "Task Execution Expense Budget Tracker",
  "Custom Workflow for ATR Rejection/Revision",
  "AI Driven Compliance Probability Predictor",
  "Predictive Need for Resource Allocation",
  "Custom Alert Trigger for DGP/Home Secretary",
  "ATR Lifecycle Timeline Tracker"
];
...
const ActionTakenReportManagerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ACTION TAKEN REPORT MANAGER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ACTION TAKEN REPORT <span>MANAGER</span></h1>
...
export default ActionTakenReportManagerDetailed;
