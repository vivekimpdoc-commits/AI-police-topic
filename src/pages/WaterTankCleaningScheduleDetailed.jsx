...
const aiExperts = [
  "IoT Water Quality/Turbidity Monitor",
  "Automated Cleaning/Chlorination Roster AI",
  "Contamination/Pathogen Alert Bot",
  "Real-Time Water Level/Usage Predictor",
  "Mosquito/Dengue Breeding Risk Scorer",
  "PH/TDS Level Anomaly Detector",
  "Geo-Spatial Water Scarcity/Tank Mapper",
  "Borewell/Municipal Supply Source Switcher AI",
  "Water Tank Health Dashboard",
  "Voice-Command Water Status Bot",
  "Automated Monthly Hygiene Report",
  "Municipal Corporation/Jal Board Sync",
  "Underground vs Overhead Tank Analytics",
  "Leakage/Overflow Detection AI",
  "Substandard Cleaning/Chemical Detector",
  "Pump Motor Health/Burnout Predictor",
  "AI Evaluator for Water Safety",
  "Audit/Cleaning Certificate Log Generator",
  "Data Privacy/Usage Pattern Scrubber",
  "State Health Department Sync",
  "Maintenance Staff Roster App",
  "Historical Waterborne Disease Correlator",
  "Estate/Welfare Officer Briefing AI",
  "Cleaning Vendor Task Allocator",
  "Blockchain Immutable Hygiene Hash",
  "Anti-Tamper Water Quality Shield",
  "Mobile App for Taste/Odor Complaints",
  "Station-wise Water Usage Benchmarker",
  "Automated Reminder for Next Cleaning",
  "Historical Maintenance Contract Analyzer",
  "Water Sanitation SOP Trainer",
  "IoT Sensor Gateway Health Monitor",
  "Imminent Contamination/Poisoning Alert",
  "Vendor Negligence/Fake Cleaning Profiler",
  "High-Capacity/Barrack Tank Classifier",
  "AI Assisted Health Advisory Drafter",
  "Sensor Data/Log Storage Forecaster",
  "Secure Water Supply Schematic Protector",
  "Integration with Public Health Engineering (PHED)",
  "Barrack/Colony Resident Advisory Sync",
  "Summer Drought/Shortage Modeler",
  "Flood/Disaster Contamination Coordinator",
  "Water Supply/Cleaning Budget Tracker",
  "Custom Workflow for Emergency Supply Tender",
  "AI Driven Filter Replacement Predictor",
  "Predictive Need for Tank Expansion",
  "Custom Alert Trigger for Quartermaster",
  "Tank Cleaning Lifecycle Timeline Tracker"
];
...
const WaterTankCleaningScheduleDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI WATER TANK CLEANING SCHEDULE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI WATER TANK CLEANING <span>SCHEDULE</span></h1>
...
export default WaterTankCleaningScheduleDetailed;
