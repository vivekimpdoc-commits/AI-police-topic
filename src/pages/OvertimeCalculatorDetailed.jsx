...
const aiExperts = [
  "Duty Roster/Attendance Sync AI",
  "Extra-Hour/Shift Extension Calculator",
  "Fatigue/Burnout Risk Scorer",
  "Fair Compensation/Distribution Mapper",
  "Biometric/Geo-Fenced Punch-Out Integrator",
  "Holiday/Weekend Duty Multiplier AI",
  "Geo-Spatial Heavy-Duty Zone Mapper",
  "Unjustified/Fake Overtime Detector",
  "Overtime Analytics Dashboard",
  "Voice-Command Duty Hours Bot",
  "Automated Monthly OT Payout Report",
  "HRMS/Attendance System Sync",
  "Rank-wise OT Cap/Limit Monitor",
  "Shift Handover Delay Analyzer",
  "Favoritism/Unequal Distribution Predictor",
  "Budget vs Actual OT Cost Correlator",
  "AI Evaluator for Work-Life Balance",
  "Audit/Payout Log Generator",
  "Data Privacy/Shift Roster Scrubber",
  "Finance/Accounts Sync",
  "Officer OT Claim Mobile App",
  "Historical Festival/VIP Duty Correlator",
  "SP/Commandant Briefing AI",
  "Duty Roster Auto-Adjuster (for rest)",
  "Blockchain Immutable OT Hash",
  "Anti-Tamper Attendance Shield",
  "Mobile App for Supervisor Approval",
  "Unit-wise OT Expenditure Benchmarker",
  "Automated Alert for Max Hours Exceeded",
  "Historical OT Expenditure Trend Analyzer",
  "Duty Hours/Compensation SOP Trainer",
  "Biometric Server Health Monitor",
  "Imminent Staff Burnout/Collapse Alert",
  "Habitual OT Claimant (Fraud) Profiler",
  "High-Risk VIP/Law & Order Duty Classifier",
  "AI Assisted Budget Enhancement Drafter",
  "Attendance Log Storage Forecaster",
  "Secure Personnel Location Protector",
  "Integration with Health/Medical Records",
  "Welfare Portal Sync (for stress relief)",
  "Election Phase OT Modeler",
  "Disaster Rescue Continuous Duty Coordinator",
  "Overtime Allowance Budget Tracker",
  "Custom Workflow for Emergency OT Approval",
  "AI Driven Peak-Duty Cost Predictor",
  "Predictive Need for More Manpower",
  "Custom Alert Trigger for IG Welfare",
  "Officer Duty/Rest Lifecycle Timeline"
];
...
const OvertimeCalculatorDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI OVERTIME CALCULATOR
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI OVERTIME <span>CALCULATOR</span></h1>
...
export default OvertimeCalculatorDetailed;
