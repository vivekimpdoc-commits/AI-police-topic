...
const aiExperts = [
  "Social Media Hate Speech Extractor AI",
  "Communal Tension Sentiment Scorer",
  "Instigator/Agitator Network Mapper",
  "Fake News/Rumor Trajectory Analyzer",
  "Weapon/Stone Stockpiling Detector",
  "Dark Web Extremist Chatter Monitor",
  "Financial Funding/Hawala Tracer Bot",
  "Historical Riot Flashpoint Matcher",
  "Riot Intelligence Dashboard",
  "Voice-Command Threat Query Bot",
  "Automated Daily Tension Report",
  "Inter-Agency (IB/CID) Sync Bot",
  "Geo-Spatial Hotspot Predictor AI",
  "CCTV/Drone Facial Recognition Integrator",
  "WhatsApp/Telegram Viral Message Tracer",
  "Inflammatory Poster/Audio OCR Decoder",
  "AI Evaluator for Riot Probability",
  "Audit/Intelligence Log Generator",
  "Data Privacy/Innocent Bypass Scrubber",
  "State Intelligence Bureau Sync",
  "Field Intel Officer Alert App",
  "Past Riot Precedent Correlator AI",
  "DGP/Home Minister Briefing Bot",
  "Tactical Resource Allocator AI",
  "Blockchain Immutable Intel Hash",
  "Anti-Tamper Suspect Profile Shield",
  "Mobile App for Covert Intel Sync",
  "Flash-Mob Geolocation Coordinator",
  "Multi-Lingual Hate Speech Translator",
  "Historical Riot Escalation Analyzer",
  "Anti-Riot SOP Training Assistant",
  "Intel DB Server Health Monitor",
  "Imminent Mob Violence Alert Bot",
  "Organized Syndicate Instigator Profiler",
  "VIP Target Assessment Classifier",
  "AI Assisted Pre-Emptive Raid Drafter",
  "Social Media Archive Forecaster",
  "Secure Source/Informer Protector",
  "Integration with National Security DB",
  "Citizen Rumor Reporting Analytics",
  "Election Cycle Riot Modeler",
  "Disaster Scavenger/Riot Coordinator",
  "Intel Operations Budget Tracker",
  "Custom Workflow for Curfew/Internet Ban",
  "AI Driven Retaliation Predictor",
  "Predictive Need for Paramilitary",
  "Custom Alert Trigger for Cyber Cell",
  "Riot Lifecycle & Post-Mortem Tracker"
];
...
const RiotIntelligenceDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI RIOT INTELLIGENCE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI RIOT <span>INTELLIGENCE</span></h1>
...
export default RiotIntelligenceDetailed;
