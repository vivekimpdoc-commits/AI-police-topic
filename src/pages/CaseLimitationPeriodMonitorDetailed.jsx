...
const aiExperts = [
  "Statutory Deadline (60/90/180 Days) Tracker AI",
  "Default/Statutory Bail Risk Alert Engine",
  "Sanction-for-Prosecution Delay Analyzer",
  "Investigating Officer (IO) Performance Scorer",
  "Section/Offence to Limitation Mapping NLP",
  "FSL/Medical Report Dependency Tracker",
  "Geo-Spatial Pendency/Delay Hotspot Mapper",
  "Automated Deadline Extension Request Drafter",
  "Limitation Period Dashboard",
  "Voice-Command Deadline Query Bot",
  "Automated Weekly Imminent Default Bail Report",
  "Directorate of Prosecution Sync",
  "Imminent Default Bail/Case Collapse Predictor",
  "Government Sanction Bottleneck Alert",
  "Forensic Lab (FSL) Delay Impact Estimator",
  "Investigation Stagnation/Inertia Flagging AI",
  "AI Evaluator for IO Timeliness Index",
  "Audit/Deadline Log Generator",
  "Data Privacy/Accused Identity Scrubber",
  "Home Department (Sanction Branch) Sync",
  "Investigating Officer/SHO Mobile App",
  "Historical Default Bail to Acquittal Correlator",
  "SP (Crime)/SSP Briefing AI",
  "Expedited Investigation/Charge-sheeting Allocator",
  "Blockchain Immutable Timestamp/FIR Hash",
  "Anti-Tamper Charge-sheet Date Shield",
  "Mobile App for Red-Flagged Pending Cases",
  "Police Station-wise Default Bail Rate Benchmarker",
  "Automated Alert for 10 Days to Statutory Deadline",
  "Historical Legal Setback/Litigation Cost Analyzer",
  "Time-Bound Investigation/CrPC SOP Trainer",
  "CCTNS/Court Diary API Health Monitor",
  "Imminent Release of High-Risk Criminal (Due to Delay) Alert",
  "Habitual Slow/Negligent IO Profiler",
  "High-Stakes (UAPA/NDPS/Murder) Case Classifier",
  "AI Assisted Sanction Reminder/Escalation Drafter",
  "Charge-sheet Filing/Pendency Trend Forecaster",
  "Secure Case Diary/Evidence Protector",
  "Integration with Inter-operable Criminal Justice System (ICJS)",
  "Central Forensic Science Lab (CFSL) Sync",
  "Election Fast-Track (MCC Violation) Limitation Modeler",
  "Disaster (Mass FIR) Investigation Coordination",
  "Overtime/Investigation Support Budget Tracker",
  "Custom Workflow for Economic Offences/Complex Fraud",
  "AI Driven Investigation Completion Date Predictor",
  "Predictive Need for Transfer to Specialized Agency (CID/SIT)",
  "Custom Alert Trigger for DGP/ADG Law & Order",
  "FIR Registration to Final Charge-sheet Timeline"
];
...
const CaseLimitationPeriodMonitorDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CASE LIMITATION PERIOD MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CASE LIMITATION PERIOD <span>MONITORING</span></h1>
...
export default CaseLimitationPeriodMonitorDetailed;
