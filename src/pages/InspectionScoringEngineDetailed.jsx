...
const aiExperts = [
  "Dynamic Weightage/Criteria Algorithm AI",
  "Peer Group/Category Benchmarking Engine",
  "Historical Performance Curve Analyzer",
  "State-Wide Station Ranking Integrator",
  "Urban vs Rural Complexity Normalizer",
  "Subjectivity/Bias Removal Filter",
  "Geo-Spatial Performance Heatmapper",
  "Best-Practice/Champion Identification Bot",
  "Inspection Scoring & Ranking Dashboard",
  "Voice-Command Ranking Query Bot",
  "Automated Annual 'Best Station' Report",
  "Ministry of Home Affairs (MHA) Sync",
  "Sudden Performance Drop/Slump Predictor",
  "Unfair Grading/Favoritism Alert",
  "Resource-Deficit vs Low-Score Correlation Analyzer",
  "Morale/Motivation Impact Estimator",
  "AI Evaluator for Overall Excellence Index",
  "Audit/Scoring Log Generator",
  "Data Privacy/Officer Appraisal Scrubber",
  "HRMS/Promotion Board Sync",
  "DGP/Commissioner Dashboard App",
  "Historical Reward/Punishment Correlator",
  "Home Minister/CM Briefing AI",
  "Reward/Trophy Allocation Task Allocator",
  "Blockchain Immutable Score Hash",
  "Anti-Tamper Ranking Algorithm Shield",
  "Mobile App for Station Scorecard View",
  "State-to-State (National) Benchmarker",
  "Automated Alert for Bottom 10% Stations",
  "Historical Incentive/Reward Budget Analyzer",
  "Performance Appraisal/Evaluation SOP Trainer",
  "Data Aggregation/API Health Monitor",
  "Imminent Unit Mutiny/Severe Demoralization Alert",
  "Consistently Poor Performing Unit Profiler",
  "High-Weightage (Heinous Crime/Law & Order) Classifier",
  "AI Assisted Commendation/Appreciation Drafter",
  "Scoring Data/Analytics Forecaster",
  "Secure Evaluation Algorithm Protector",
  "Integration with SMART Policing (BPR&D) Metrics",
  "Public Relations/Media Sync",
  "Election Readiness Overall Score Modeler",
  "Disaster Resilience Capability Ranker",
  "Rewards & Recognition Budget Tracker",
  "Custom Workflow for Specialized Units (CID/Cyber)",
  "AI Driven Next Year Ranking Predictor",
  "Predictive Need for Leadership Change (SHO)",
  "Custom Alert Trigger for DGP",
  "Inspection Data Ingestion to Final Rank Publication"
];
...
const InspectionScoringEngineDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INSPECTION SCORING ENGINE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INSPECTION SCORING <span>ENGINE</span></h1>
...
export default InspectionScoringEngineDetailed;
