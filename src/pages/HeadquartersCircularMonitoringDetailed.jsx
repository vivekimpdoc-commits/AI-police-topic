...
const aiExperts = [
  "Circular Issuance/Distribution Engine",
  "District/Unit Compliance (ATR) Tracker AI",
  "Old Circular Contradiction/Conflict Detector",
  "Semantic Archiving/Tagging Bot",
  "Read-Receipt/Acknowledgment Tracker",
  "Effectiveness/Implementation Scorer",
  "Geo-Spatial District Compliance Heatmapper",
  "Key Clause/Action Item Extractor AI",
  "Circular Monitoring Dashboard",
  "Voice-Command Policy Query Bot",
  "Automated Quarterly Compliance Report",
  "E-Office/State Police Portal Sync",
  "Multi-Lingual Translation (State/English)",
  "Vague/Ambiguous Wording Highlighting AI",
  "Implementation Resistance/Delay Predictor",
  "Summary/Abstract Generator",
  "AI Evaluator for Policy Clarity",
  "Audit/Distribution Log Generator",
  "Data Privacy/Restricted Circular Scrubber",
  "Law/Training Department Sync",
  "Field Officer Compliance Mobile App",
  "Historical Circular Success/Failure Correlator",
  "DGP/ADG (Admin) Briefing AI",
  "Remedial Training/Notice Allocator",
  "Blockchain Immutable Circular Hash",
  "Anti-Tamper Policy Document Shield",
  "Mobile App for Quick Compliance Update",
  "District-wise Implementation Benchmarker",
  "Automated Reminder for Action Taken Report",
  "Historical Policy Revision Analyzer",
  "Policy Drafting/Implementation SOP Trainer",
  "Archive Database Health Monitor",
  "Imminent Implementation Failure Alert",
  "Habitual Defaulter District Profiler",
  "High-Impact/Service Rule Change Classifier",
  "AI Assisted Corrigendum Drafter",
  "Policy/Archive Storage Forecaster",
  "Secure Restricted Circular Protector",
  "Integration with HRMS/Appraisals",
  "Public Information Portal Sync (for unclassified)",
  "Election Guideline Circular Modeler",
  "Disaster SOP Circular Effectiveness Coordinator",
  "Policy Printing/Distribution Budget Tracker",
  "Custom Workflow for Urgent Directives",
  "AI Driven Compliance/Resistance Predictor",
  "Predictive Need for Video Conference Briefing",
  "Custom Alert Trigger for DGP",
  "Circular Issuance to Implementation Timeline"
];
...
const HeadquartersCircularMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI HEADQUARTERS CIRCULAR MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI HEADQUARTERS CIRCULAR <span>MONITORING</span></h1>
...
export default HeadquartersCircularMonitoringDetailed;
