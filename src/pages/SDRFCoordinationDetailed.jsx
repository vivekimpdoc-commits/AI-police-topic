...
const aiExperts = [
"SDRF Company Deployment & Rotation AI",
  "Local Intelligence/Topography Sync Bot",
  "Flood Inundation/Water-Level Modeler",
  "Rescue Boat/Motorboat Inventory Tracker",
  "Local Police-SDRF Joint Ops Comm Sync",
  "Drowning/Deep Water Search Grid Optimizer",
  "Building Collapse Triage & Marking AI",
  "Real-time SDRF Convoy/Boat GPS Tracker",
  "Predictive Need for SDRF Reinforcements",
  "Incident Command System (ICS) Auto-Gen",
  "SDRF Base Camp Setup Location Optimizer",
  "Command Center SDRF Dashboard",
  "Voice-Command SDRF Resource Query Bot",
  "Automated Local Casualty/Rescued Tally",
  "Mountain/Trekking Rescue Route Modeler",
  "Flash Flood/Cloudburst Early Warning AI",
  "Local Hospital/Ambulance Sync for SDRF",
  "Drone Recon/Thermal Imaging Sync Bot",
  "Rope Rescue/High-Altitude Equipment Tracker",
  "Debris Clearance/Tree Cutting Prioritizer",
  "AI Evaluator for SDRF Response Efficacy",
  "Inquiry/Audit SDRF Action Log Generator",
  "Data Privacy/Victim Info Sanitizer Bot",
  "Inter-District Border Clearance for SDRF",
  "Industrial/Factory Fire SDRF Deployment AI",
  "SDRF Base Camp Ration/Supply Predictor",
  "Senior Officer (State DGP) Briefing Gen",
  "Media/Public Alert SMS Drafter AI",
  "Blockchain Immutable Log of SDRF Orders",
  "Police-SDRF Perimeter/Cordon Security AI",
  "Mobile App for SDRF Team Leader Sync",
  "Fuel/Generator Logistics for Base Camp",
  "Regional Dialect Translator for Rescuers",
  "Historical State Disaster Precedent Matcher",
  "Local Morgue/Post-Mortem Capacity Sync",
  "SDRF Personnel Leave/Fatigue Monitor AI",
  "Temporary Shelter Setup Requisition AI",
  "Sonar/Diver Deployment in Dams/Rivers",
  "Landslide Debris Volume Estimator AI",
  "Cyclone Shelter Readiness Sync Bot",
  "AI Assisted Post-Rescue Debriefing Gen",
  "SDRF Equipment (Pumps/Cutters) Alert",
  "Traffic Green-Corridor for SDRF Convoy",
  "Integration with State Disaster Mgt (SDMA)",
  "Citizen/Village Head SOS Router to SDRF",
  "Heatwave/Cold-Wave Relief Distribution AI",
  "Fair/Mela (Kumbh) SDRF Repurposing AI",
  "State Disaster Fund/Expense Tracker",
  "Custom Workflow/Approval for State Ops",
  "AI Driven Demobilization Predictor",
  "Predictive Need for Local Medical Eqp",
  "Custom Alert Trigger for SDRF Commander"
];
...
const SDRFCoordinationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SDRF COORDINATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI SDRF COORDINATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in state disaster response force local intel, rescue boats & flood response.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SDRF <span>COORDINATION</span></h1>
            <p className="cyber-subtitle">State Disaster Response Force Local Intel, Rescue Boats & Flood Response</p>
          </div>
        </div>
      </header>
...
export default SDRFCoordinationDetailed;
