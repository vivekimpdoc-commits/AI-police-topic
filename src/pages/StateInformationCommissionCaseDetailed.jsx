...
const aiExperts = [
  "RTI Query Intent/NLP Extractor",
  "Section 8/9 Exemption Clause Analyzer",
  "Information Retrieval Assistant AI",
  "Appellate Authority Routing Bot",
  "RTI Reply Draft Generator",
  "Repeated/Vexatious Query Correlator",
  "Penalty/Fine Risk Predictor AI",
  "SIC Hearing Schedule Optimizer",
  "RTI Compliance Dashboard",
  "Voice-Command RTI Query Bot",
  "Automated RTI Status Report Gen",
  "Inter-Department Info Request Bot",
  "PIO/APIO Workload Balancer AI",
  "Redaction/Anonymization Engine",
  "RTI Cost/Fee Calculation Bot",
  "Historical RTI Reply Precedent Matcher",
  "AI Evaluator for RTI Reply Completeness",
  "Audit/RTI Access Log Generator",
  "Data Privacy/Confidentiality Scrubber",
  "State Information Commission Sync",
  "Field IO Information Gathering App",
  "Cold Case Info Disclosure Rules AI",
  "Public Information Officer Briefing",
  "Document Retrieval Resource Allocator",
  "Blockchain Immutable RTI Reply Hash",
  "Anti-Tamper RTI Record Shield",
  "Mobile App for PIO Alerts",
  "Query Geographic Origin Matcher",
  "Multi-Lingual RTI Translator",
  "Historical RTI Trend/Topic Analyzer",
  "RTI Act Compliance Trainer AI",
  "RTI Tracking DB Server Monitor",
  "Imminent 30-Day Deadline Alert Bot",
  "Organized Crime Info Fishing Profiler",
  "VIP/Sensitive Info Request Classifier",
  "AI Assisted SIC Hearing Brief Drafter",
  "Document Digitization Forecaster",
  "Secure Whistleblower Identity Protector",
  "Integration with SIC Web Portal",
  "Citizen RTI Portal Analytics",
  "Media/Activist Query Surge Modeler",
  "Disaster Relief Info Request Coordinator",
  "RTI Fine/Penalty Budget Tracker",
  "Custom Workflow for RTI Approval",
  "AI Driven SIC Ruling Predictor",
  "Predictive Need for Legal Counsel",
  "Custom Alert Trigger for Nodal PIO",
  "RTI Lifecycle Timeline Tracker"
];
...
const StateInformationCommissionCaseDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI STATE INFORMATION COMMISSION TRACKER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI STATE INFORMATION COMMISSION <span>TRACKER</span></h1>
...
export default StateInformationCommissionCaseDetailed;
