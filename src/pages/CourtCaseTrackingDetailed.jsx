...
const aiExperts = [
  "E-Courts API Sync/Scraper Engine",
  "Hearing Date Calendar Optimizer",
  "Summons/Warrant Generation Bot",
  "Statutory Deadline (90-day) Alert AI",
  "Witness Attendance Predictor",
  "IO Court Appearance Scheduler",
  "Next Hearing Propensity Modeler",
  "Bail Expiry/Cancellation Tracker",
  "Court Case Dashboard",
  "Voice-Command Case Status Bot",
  "Automated Daily Court Roster",
  "Prosecution Department Sync Bot",
  "Judicial Officer Roster/Leave Matcher",
  "Pending Warrant Geo-Mapper",
  "Case Delay/Adjournment Analyzer",
  "Bail Surety Verification AI",
  "AI Evaluator for IO Readiness",
  "Audit/Tracking Access Log Gen",
  "Data Privacy/Juvenile Name Scrubber",
  "Directorate of Prosecution Sync",
  "Field IO Hearing Reminder App",
  "Cold Case Hearing Resumption Matcher",
  "DGP/SP Level Pending Trial Briefing",
  "Court Pairi Officer Allocator",
  "Blockchain Immutable Case Status Hash",
  "Anti-Tamper Court Order Shield",
  "Mobile App for IOs/Witnesses",
  "Court/Jurisdiction Polygon Matcher",
  "Multi-Lingual Court Order Translator",
  "Historical Adjournment Pattern Analyzer",
  "Court Procedure SOP Trainer",
  "Tracking Server Health Monitor",
  "Imminent Limitation Period Alert Bot",
  "Syndicate Bail Application Profiler",
  "VIP Case Fast-Track Classifier",
  "AI Assisted Status Report Drafter",
  "Court Document Storage Forecaster",
  "Secure Witness Address Protector",
  "Integration with Prison/Jail DB",
  "Citizen Case Status Portal Sync",
  "Mass Arrest Trial Batching Modeler",
  "Disaster Disrupted Court Coordinator",
  "Witness Travel/TA Budget Tracker",
  "Custom Workflow for High Court Appeals",
  "AI Driven Conviction Probability Predictor",
  "Predictive Need for Expert Witness",
  "Custom Alert Trigger for Nodal Officers",
  "Case Trial Lifecycle Timeline Tracker"
];
...
const CourtCaseTrackingDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI COURT CASE TRACKING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI COURT CASE <span>TRACKING</span></h1>
...
export default CourtCaseTrackingDetailed;
