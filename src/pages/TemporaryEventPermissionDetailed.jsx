...
const aiExperts = [
  "Venue Capacity/Crowd Density Calculator",
  "Structural/Tent Safety Certification Tracker",
  "Emergency Exit/Evacuation Route Validator",
  "Security Screening/DFMD Placement Planner",
  "Fire NOC/Electrical Safety Coordinator",
  "Traffic/Parking Capacity Analyzer",
  "Geo-Spatial Event Venue Layout Mapper",
  "Automated Risk Category (Low/Med/High) Scorer",
  "Event Permission Dashboard",
  "Voice-Command Application Query Bot",
  "Automated Event Readiness/Safety Report",
  "Municipal Corporation/Fire Department Sync",
  "Overcrowding/Stampede Risk Predictor",
  "Fake Safety Certificate (PWD/Fire) Alert",
  "VIP Movement/Protocol Clash Analyzer",
  "Evacuation Bottleneck/Chokepoint Estimator",
  "AI Evaluator for Event Safety Index",
  "Audit/Clearance Log Generator",
  "Data Privacy/Event Organizer Details Scrubber",
  "Traffic/Transport Department Sync",
  "Event Nodal Officer/SHO Mobile App",
  "Historical Event Mishap/Failure Correlator",
  "City Magistrate/SP (City) Briefing AI",
  "Pre-Event Joint Inspection Allocator",
  "Blockchain Immutable NOC/Approval Hash",
  "Anti-Tamper Digital Permission Shield",
  "Mobile App for On-Site Safety Checklist Verification",
  "Venue-wise Incident History Benchmarker",
  "Automated Alert for Unauthorized Ticket Over-selling",
  "Historical Event Deployment/Security Cost Analyzer",
  "Public Event/Concert Security SOP Trainer",
  "E-District/Single Window API Health Monitor",
  "Imminent Structural Collapse/Fire Hazard Alert",
  "Habitual Defaulter (Event Management Co.) Profiler",
  "High-Stakes (International Artist/Sports) Event Classifier",
  "AI Assisted Cancellation/Stop-Event Order Drafter",
  "Event Frequency/Tourist Influx Forecaster",
  "Secure VVIP Itinerary/Threat Protector",
  "Integration with State Disaster Response Force (SDRF)",
  "Emergency Medical Services/Hospital Sync",
  "Election Public Meeting/Rally Ground Modeler",
  "Disaster (Sudden Weather/Storm) Event Cancellation Coordinator",
  "Security Equipment (DFMD/HHMD) Rental Budget Tracker",
  "Custom Workflow for Protests/Dharna Permissions",
  "AI Driven Disaster/Stampede Probability Predictor",
  "Predictive Need for Specialized Crowd Control Units",
  "Custom Alert Trigger for District Magistrate",
  "Application to Multi-Agency Clearance Timeline"
];
...
const TemporaryEventPermissionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI TEMPORARY EVENT PERMISSION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI TEMPORARY EVENT <span>PERMISSION</span></h1>
...
export default TemporaryEventPermissionDetailed;
