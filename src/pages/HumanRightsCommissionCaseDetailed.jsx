...
const aiExperts = [
  "NHRC Notice NLP Extractor",
  "Allegation Severity Classifier AI",
  "Factual Rebuttal Generation Assistant",
  "Compensation Payout Log Monitor",
  "Previous Complaint Correlator",
  "Human Rights Violation Pattern Mapper",
  "Legal Defense Precedent Matcher",
  "Disciplinary Action Tracker Bot",
  "HRC Case Coordination Dashboard",
  "Voice-Command Case Query Bot",
  "Automated Compliance Report Gen",
  "State/National Commission Sync Bot",
  "Custodial Violence Risk Predictor",
  "Illegal Detention Flagging Engine",
  "Fake Encounter Allegation Analyzer",
  "Action Taken Report (ATR) Validator",
  "AI Evaluator for Response Adequacy",
  "Audit/HRC File Access Log Gen",
  "Data Privacy/Victim Identity Scrubber",
  "Nodal Human Rights Officer Sync",
  "Field IO Compliance Alert App",
  "Historical HRC Precedent Matcher",
  "DGP Level HRC Briefing AI",
  "Legal/Counsel Resource Allocator",
  "Blockchain Immutable HRC Response Hash",
  "Anti-Tamper Allegation Shield AI",
  "Mobile App for Compliance Check",
  "Violation Hotspot Geolocation Matcher",
  "Multi-Lingual Complaint Translator",
  "Historical HRC Trend Analyzer",
  "Human Rights Sensitization Trainer",
  "HRC Tracking DB Server Monitor",
  "Urgent Show-Cause Notice Alert",
  "Organized Crime False Allegation Profiler",
  "VIP/High-Profile HRC Case Classifier",
  "AI Assisted Interim Response Drafter",
  "HRC Document Storage Forecaster",
  "Secure Witness/Victim Protector",
  "Integration with NHRC Web Portal",
  "Citizen HRC Petition Analytics",
  "Public Outcry Escalation Modeler",
  "Disaster Relief Rights Coordinator",
  "HRC Compensation Budget Tracker",
  "Custom Workflow for Rebuttal Approval",
  "AI Driven Commission Ruling Predictor",
  "Predictive Need for Independent Inquiry",
  "Custom Alert Trigger for Nodal Leads",
  "HRC Case Lifecycle Timeline Tracker"
];
...
const HumanRightsCommissionCaseDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI HUMAN RIGHTS COMMISSION CASE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI HUMAN RIGHTS COMMISSION <span>CASE</span></h1>
...
export default HumanRightsCommissionCaseDetailed;
