...
const aiExperts = [
  "Predictive Failure/Wear & Tear AI",
  "AMC Lifecycle/Renewal Tracker Bot",
  "Spare Parts Inventory Forecasting Engine",
  "Vendor SLA (Service Level Agreement) Auditor",
  "Root Cause Analysis (RCA) for Frequent Breakdowns",
  "Downtime/Lost Productivity Cost Calculator",
  "Geo-Spatial Vendor Response-Time Mapper",
  "Preventive vs Reactive Maintenance Optimizer",
  "Maintenance Planner Dashboard",
  "Voice-Command Maintenance Query Bot",
  "Automated Monthly AMC Audit Report",
  "State Procurement/Finance Department Sync",
  "Imminent Critical Instrument Failure Predictor",
  "Vendor SLA Violation/Delay Alert",
  "Spare Part Shortage/Stock-out Flagging AI",
  "Obsolete/End-of-Life (EoL) Equipment Predictor",
  "AI Evaluator for Instrument Uptime Index",
  "Audit/Maintenance Log Generator",
  "Data Privacy/Vendor Contract Scrubber",
  "Laboratory Information Management System (LIMS) Sync",
  "Lab Manager/Technician Mobile App",
  "Historical Breakdown-to-Backlog Correlator",
  "FSL Director (Administration) Briefing AI",
  "Repair/Service Ticket Allocator",
  "Blockchain Immutable Maintenance Log Hash",
  "Anti-Tamper AMC/SLA Shield",
  "Mobile App for Immediate Fault Reporting",
  "Instrument Make/Model Reliability Benchmarker",
  "Automated Alert for Expiring AMC/Warranties",
  "Historical Repair/Spare Parts Cost Analyzer",
  "Preventive Maintenance SOP Trainer",
  "IoT/Diagnostic API Health Monitor",
  "Imminent Total Lab Shutdown (Due to Key Server/HVAC Failure) Alert",
  "Habitual Defective Vendor Profiler",
  "Mission-Critical (DNA Sequencer) Instrument Classifier",
  "AI Assisted Penalty/Show-Cause Notice Drafter (for Vendors)",
  "Instrument Replacement/Modernization Forecaster",
  "Secure AMC Pricing/Contract Protector",
  "Integration with Government e-Marketplace (GeM)",
  "Cyber Security/Firmware Update Sync",
  "Election Evidentiary Backlog Risk (Due to Breakdown) Modeler",
  "Disaster Relief (Mobile FSL) Maintenance Coordinator",
  "Equipment Maintenance & Repair Budget Tracker",
  "Custom Workflow for Imported/Proprietary Instruments",
  "AI Driven Next Breakdown Date Predictor",
  "Predictive Need for AMC Upgrade",
  "Custom Alert Trigger for ADG Forensics",
  "Fault Detection to Vendor Resolution Timeline"
];
...
const InstrumentMaintenancePlannerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INSTRUMENT MAINTENANCE PLANNER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INSTRUMENT MAINTENANCE <span>PLANNER</span></h1>
...
export default InstrumentMaintenancePlannerDetailed;
