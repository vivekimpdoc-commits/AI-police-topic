...
const aiExperts = [
  "Targeted Audience/Rank Selector AI",
  "Read-Receipt Analytics Engine",
  "Standing Order/SOP Update Tracker",
  "Semantic Search Engine for Circulars",
  "Categorization & Tagging Bot",
  "Obsolete/Superseded Circular Detector",
  "Geo-Spatial Distribution Heatmapper",
  "Bandwidth-Optimized Delivery (for remote stations)",
  "Circular Dashboard",
  "Voice-Command Circular Query Bot",
  "Automated Weekly Readership Report",
  "Police Training Academy Sync Bot",
  "Multi-Lingual Circular Translation",
  "Attachment/Annexure Malware Scanner",
  "Fake/Phishing Circular Predictor",
  "Summary/TL;DR Generator AI",
  "AI Evaluator for Information Penetration",
  "Audit/Delivery Log Generator",
  "Data Privacy/Internal Only Scrubber",
  "CCTNS/Intranet Sync",
  "Field Officer Mobile Circular App",
  "Historical Circular Correlator AI",
  "Supervisory Officer Briefing Bot",
  "Actionable Directive Extractor",
  "Blockchain Immutable Circular Hash",
  "Anti-Tamper Record Shield",
  "Mobile App for Quick Reference",
  "Zone/Range specific Routing",
  "Automated Reminder for Unread Circulars",
  "Historical Relevance/Search Rate Analyzer",
  "Information Dissemination SOP Trainer",
  "Intranet Server Health Monitor",
  "Imminent Policy Change Alert",
  "Non-Compliance/Ignorance Profiler",
  "Urgent/Flash Message Classifier",
  "AI Assisted Reminder Drafter",
  "Archival Storage Forecaster",
  "Secure Official Secrets Protector",
  "Integration with WhatsApp/SMS Gateways (Internal)",
  "Public Advisory Portal Sync (if public)",
  "Election Guideline Distribution Modeler",
  "Disaster Protocol Dissemination Coordinator",
  "Communication Expense Budget Tracker",
  "Custom Workflow for Clarification Requests",
  "AI Driven Policy Awareness Predictor",
  "Predictive Need for Briefing/Workshop",
  "Custom Alert Trigger for SP/SSP",
  "Circular Validity Timeline Tracker"
];
...
const CircularDistributionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CIRCULAR DISTRIBUTION SYSTEM
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CIRCULAR DISTRIBUTION <span>SYSTEM</span></h1>
...
export default CircularDistributionDetailed;
