...
const aiExperts = [
  "Legislative Assurance NLP Extractor",
  "Execution Timeline Predictor Engine",
  "Departmental Allocation Router Bot",
  "Assurance Fulfillment Status Scorer",
  "Delay/Bottleneck Root Cause Analyzer",
  "Budget vs Expenditure Tracker AI",
  "Pending Assurance Aging Matrix Gen",
  "Extension Request Formatting Bot",
  "Assurance Monitoring Dashboard",
  "Voice-Command Assurance Query Bot",
  "Automated Progress/Delay Report Gen",
  "Cross-Department Execution Sync Bot",
  "Public Announcement (CM/HM) Tracker",
  "Contractor/Vendor Performance Scorer",
  "Infrastructure Project Milestones Bot",
  "Committee Review Schedule Optimizer",
  "AI Evaluator for Fulfillment Quality",
  "Audit/Assurance Action Log Gen",
  "Data Privacy/Internal Memo Scrubber",
  "Legislative Assurance Committee Sync",
  "Field Execution Verification App",
  "Historical Assurance Delay Matcher",
  "Senior Officer Review Briefing AI",
  "Assurance Task Resource Allocator",
  "Blockchain Immutable Assurance Hash",
  "Anti-Tamper Progress Shield AI",
  "Mobile App for Deadline Alerts",
  "Assurance Geolocation Mapping AI",
  "Multi-Lingual Assurance Translator",
  "Historical Fulfillment Trend Analyzer",
  "Assurance Compliance SOP Trainer",
  "Assurance DB Server Health Monitor",
  "Urgent Dropped Assurance Alert Bot",
  "Organized Crime Interference Profiler",
  "VIP/Flagship Project Classifier",
  "AI Assisted Action Taken Report Drafter",
  "Project Document Storage Forecaster",
  "Secure Vendor/Contractor Evaluator",
  "Integration with Govt Planning Portal",
  "Citizen Project Transparency Analytics",
  "Public Protest over Delays Modeler",
  "Disaster Rebuild Assurance Coordinator",
  "Assurance Execution Budget Tracker",
  "Custom Workflow for Status Approval",
  "AI Driven Committee Ruling Predictor",
  "Predictive Need for Budget Revision",
  "Custom Alert Trigger for Nodal Leads",
  "Assurance Lifecycle Timeline Tracker"
];
...
const AssuranceMonitoringCellDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ASSURANCE MONITORING CELL
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ASSURANCE MONITORING <span>CELL</span></h1>
...
export default AssuranceMonitoringCellDetailed;
