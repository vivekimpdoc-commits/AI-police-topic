...
const aiExperts = [
"Geo-Spatial Jurisdiction Mapper AI",
  "Automated Police Station (PS) Router",
  "Cyber Cell Dedicated Escalation Bot",
  "Women/Child Desk Priority Assigner AI",
  "Economic Offenses Wing (EOW) Filter",
  "Anti-Terror/ATS Intelligence Relay Bot",
  "Narcotics/NCB Joint Routing AI",
  "Traffic/Highway Police Dispatch Router",
  "Railway/GRP Jurisdiction Sync Bot",
  "Officer Workload & Case-Load Balancer",
  "Specialized Skill/Language IO Matcher AI",
  "Cross-District Boundary Dispute Resolver",
  "Zero-FIR to Original Jurisdiction Relay",
  "VIP/High-Profile Complaint Escalation AI",
  "Emergency/SOS 112 Rapid Dispatch Link",
  "Tourist/Foreigner Police Station Router",
  "Medical/Hospital Medico-Legal Assigner",
  "Automated Supervisor (SHO/CO) CC Bot",
  "Inter-Agency (Fire/Civic) Request Sync",
  "Complaint Re-Routing/Handoff Tracker",
  "Holiday/Night Shift Duty Roster Sync",
  "Pending/Overdue Complaint Alert AI",
  "SLA (Service Level Agreement) Breach Predictor",
  "Fake/Prank Complaint Auto-Archiver AI",
  "Multiple/Duplicate Complaint Merger AI",
  "Keyword-Based Crime Categorization AI",
  "Sentiment/Emotion Based Escalation Bot",
  "Historical IO Success Rate Matcher AI",
  "RTI/Legal Grievance Dedicated Assigner",
  "Missing Person/Anti-Human Trafficking Link",
  "Animal Cruelty/Wildlife Crime Router",
  "Financial Fraud to Bank Nodal Officer Link",
  "Social Media Outrage/Viral Complaint Router",
  "Election Code Violation Observer Sync",
  "Disaster/NDRF Coordination Routing AI",
  "Protest/Mob Violence Riot Control Sync",
  "Smuggling/Border Checkpost Alert Router",
  "Forest/Mining Mafia Task Force Link",
  "Bail/Parole Violation Alert Assigner",
  "Extortion/Ransom Call Specialist Router",
  "Automated Read-Receipt/Transfer SMS AI",
  "Voice-Command Routing Status Tracker",
  "Command Center Real-time Routing Map",
  "Blockchain Immutable Log of Transfers",
  "Officer Leave/Absentee Auto-Reassigner",
  "Court Warrant/Summons Delivery Router",
  "Inter-State/Interpol Desk Handoff AI",
  "Prison/Jail Inmate Complaint Router",
  "Domestic Violence/Counseling NGO Sync",
  "Labor/Industrial Dispute Assigner AI",
  "Pollution/Environmental Hazard Router",
  "Caste/Communal Tension Specialized Router",
  "AI Generated Routing Efficiency Report",
  "Complaint Routing Bottleneck/Chokepoint AI",
  "Geofence Based Mobile IO Assigner",
  "Suspect/Habitual Offender DB Cross-Check",
  "Automated Victim Support Handoff Bot",
  "Media/Press Briefing Officer Sync",
  "Internal Vigilance/Corruption Router AI",
  "Local Slang/Dialect Based Desk Assigner"
];
...
const ComplaintRoutingDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI COMPLAINT ROUTING
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI COMPLAINT ROUTING</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in jurisdiction mapping, automatic assignment & workload balancing.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI COMPLAINT <span>ROUTING</span></h1>
            <p className="cyber-subtitle">Jurisdiction Mapping, Automatic Assignment & Workload Balancing</p>
          </div>
        </div>
      </header>
...
export default ComplaintRoutingDetailed;
