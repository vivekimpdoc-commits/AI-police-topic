...
const aiExperts = [
  "Pending Action/ATR Extractor AI",
  "Crime Trend/Stat Summarizer Bot",
  "Priority/Urgency Schedular",
  "Automated Minutes of Meeting (MoM) Drafter",
  "Participant Availability/Calendar Sync",
  "Previous MoM Continuity Checker",
  "Geo-Spatial Hotspot Discussion Prompter",
  "Resource Deficit Highlight AI",
  "Agenda Dashboard",
  "Voice-Command Agenda Query Bot",
  "Automated Pre-Meeting Briefing Pack",
  "Video Conference (NIC/Zoom) Sync",
  "Speech-to-Text Transcription Integration",
  "Action Item/Task Delegator Bot",
  "Irrelevant/Off-Topic Detector",
  "Duration/Time-boxing Enforcer AI",
  "AI Evaluator for Meeting Efficiency",
  "Audit/Agenda Modification Log",
  "Data Privacy/Classified Discussion Scrubber",
  "State Command Center Sync",
  "Officer Pre-Read Mobile App",
  "Historical Meeting Decision Correlator",
  "Chairperson/DGP Briefing AI",
  "Follow-up Task Allocator",
  "Blockchain Immutable MoM Hash",
  "Anti-Tamper Agenda Shield",
  "Mobile App for Live Updates",
  "Jurisdiction-Specific Agenda Tailoring",
  "Multi-Lingual Minutes Translation",
  "Historical Decision Implementation Analyzer",
  "Meeting Protocol SOP Trainer",
  "Agenda Server Health Monitor",
  "Imminent Unresolved Issue Alert",
  "Chronic Defaulter/Delay Profiler",
  "High-Stakes/Crisis Meeting Classifier",
  "AI Assisted Show-Cause Drafter (for absentees)",
  "Meeting Recording/Transcript Storage Forecaster",
  "Secure Classified Meeting Protector",
  "Integration with E-Office/File Tracking",
  "Media Briefing Generator Sync",
  "Election Preparedness Meeting Modeler",
  "Disaster Review Meeting Coordinator",
  "Meeting/Travel Expense Budget Tracker",
  "Custom Workflow for Emergency Agenda Approval",
  "AI Driven Discussion Outcome Predictor",
  "Predictive Need for Expert Invitee",
  "Custom Alert Trigger for Nodal Officers",
  "Agenda Lifecycle Timeline Tracker"
];
...
const MeetingAgendaGeneratorDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI MEETING AGENDA GENERATOR
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI MEETING AGENDA <span>GENERATOR</span></h1>
...
export default MeetingAgendaGeneratorDetailed;
