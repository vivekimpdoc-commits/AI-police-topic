...
const aiExperts = [
  "OM (Office Memorandum) NLP Drafting AI",
  "Version Control/Revision History Engine",
  "Dynamic Distribution List Optimizer",
  "Amendment/Corrigendum Linker AI",
  "Policy Contradiction Checker Bot",
  "Cross-Reference to Standing Orders AI",
  "Geo-Spatial Implementation Mapper",
  "Approval Matrix/Hierarchy Automator",
  "Memorandum Management Dashboard",
  "Voice-Command Policy Query Bot",
  "Automated New Policy Distribution Report",
  "Personnel/HRMS Department Sync",
  "Multi-Lingual OM Translation",
  "Superseded/Obsolete OM Detector",
  "Fake/Forged Memorandum Predictor",
  "Summary/Impact Abstract Generator",
  "AI Evaluator for Policy Clarity",
  "Audit/Approval Log Generator",
  "Data Privacy/Internal Draft Scrubber",
  "State Police Headquarters Sync",
  "Officer Policy Update Mobile App",
  "Historical Policy Reversal Correlator",
  "IG/ADG Administration Briefing AI",
  "Task/Compliance Allocator",
  "Blockchain Immutable OM Hash",
  "Anti-Tamper Policy Document Shield",
  "Mobile App for Draft Review",
  "Implementation Rate Benchmarker",
  "Automated Reminder for Read-Receipts",
  "Historical Policy Effectiveness Analyzer",
  "Policy Drafting SOP Trainer",
  "Document Server Health Monitor",
  "Imminent Policy Conflict Alert",
  "Chronic Non-Compliance Profiler",
  "High-Impact/Service Rule Change Classifier",
  "AI Assisted Clarification OM Drafter",
  "Archival Storage Forecaster",
  "Secure Internal Policy Protector",
  "Integration with E-Office",
  "Citizen Facing Policy Portal Sync (if public)",
  "Election Code Compliance OM Modeler",
  "Disaster SOP Modification Coordinator",
  "Policy Printing/Distribution Budget Tracker",
  "Custom Workflow for Emergency OM",
  "AI Driven Policy Impact Predictor",
  "Predictive Need for Training/Workshop",
  "Custom Alert Trigger for Nodal Officers",
  "Memorandum Lifecycle Timeline Tracker"
];
...
const OfficeMemorandumManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI OFFICE MEMORANDUM MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI OFFICE MEMORANDUM <span>MANAGEMENT</span></h1>
...
export default OfficeMemorandumManagementDetailed;
