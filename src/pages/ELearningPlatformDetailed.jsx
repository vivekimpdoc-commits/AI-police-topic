...
const aiExperts = [
  "Micro-Learning Module Generator AI",
  "Officer Skill Gap Analyzer",
  "Gamified Learning Progression Engine",
  "Interactive Quiz/Test Evaluator Bot",
  "Course Recommendation Router",
  "Video Lecture Sentiment/Engagement Analyzer",
  "On-the-job Scenario Simulator AI",
  "Peer-to-Peer Knowledge Share Moderator",
  "E-Learning Command Dashboard",
  "Voice-Command Course Search Bot",
  "Automated Officer Progress Report",
  "Inter-District Skill Comparison Bot",
  "Predictive Training Dropout Analyzer",
  "Cyber-Security Literacy Tracker",
  "Legal Update Micro-Course Bot",
  "Forensic Collection Refresh Trainer",
  "AI Evaluator for Course Effectiveness",
  "Audit/Course Completion Log Gen",
  "Data Privacy/Officer Performance Scrubber",
  "National Police Academy E-Sync Bot",
  "Field Officer Mobile Learning App",
  "Cold Case Review Study Module Gen",
  "Academy Director Briefing AI",
  "Instructor/Content Creator Allocator",
  "Blockchain Immutable Certificate Hash",
  "Anti-Tamper Test Score Shield",
  "Mobile App for Offline E-Learning",
  "Regional Language Course Matcher",
  "Multi-Lingual Course Content Translator",
  "Historical Learning Retention Analyzer",
  "Course Creation/SOP Trainer AI",
  "E-Learning Server Health Monitor",
  "Urgent Mandatory Compliance Course Alert",
  "Organized Crime Takedown Course Profiler",
  "VIP Security Drill Module Classifier",
  "AI Assisted Course Curriculum Drafter",
  "Video/Content Storage Forecaster",
  "Secure Evaluation Metric Protector",
  "Integration with HRMS Promotion Engine",
  "Citizen Police Volunteer E-Learning",
  "Riot/Crowd Control Refresh Modeler",
  "Disaster Relief Training Coordinator",
  "E-Learning Platform Budget Tracker",
  "Custom Workflow for Course Approval",
  "AI Driven Future Skill Predictor",
  "Predictive Need for Remedial Training",
  "Custom Alert Trigger for Training Leads",
  "Course Content Relevance Timeline Tracker"
];
...
const ELearningPlatformDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI E-LEARNING PLATFORM
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI E-LEARNING <span>PLATFORM</span></h1>
...
export default ELearningPlatformDetailed;
