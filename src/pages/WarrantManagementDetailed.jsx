...
const aiExperts = [
  "Warrant Priority/Severity Scorer AI",
  "Fugitive/Absconder Geo-Locator Bot",
  "Pending Warrant Age Analyzer",
  "Statutory Expiry/Recall Tracker",
  "Warrant Execution Resource Allocator",
  "Bail Jumper Cross-District Matcher",
  "CCTNS/Court Sync Engine",
  "Unexecuted Warrant Alert Bot",
  "Warrant Command Dashboard",
  "Voice-Command Warrant Query Bot",
  "Automated Daily Execution Roster",
  "Inter-Station Sync Bot",
  "Geo-Spatial Fugitive Hotspot Mapper",
  "Facial Recognition Warrant Matcher",
  "Fake ID/Alias Predictor AI",
  "Surrender/Arrest Probability Scorer",
  "AI Evaluator for IO Performance",
  "Audit/Warrant Access Log Gen",
  "Data Privacy/Juvenile Scrubber",
  "Directorate of Prosecution Sync",
  "Field IO Warrant Execution App",
  "Historical Absconder Pattern Matcher",
  "SHO/Supervisory Officer Briefing AI",
  "Tactical Raid Resource Allocator",
  "Blockchain Immutable Warrant Hash",
  "Anti-Tamper Record Shield",
  "Mobile App for Quick Arrest Updates",
  "Jurisdiction Polygon Matcher",
  "Multi-Lingual Warrant Translator",
  "Historical Execution Rate Analyzer",
  "Warrant Procedure SOP Trainer",
  "Warrant Server Health Monitor",
  "Imminent Statutory Deadline Alert",
  "Organized Crime Absconder Profiler",
  "High-Profile Fugitive Classifier",
  "AI Assisted Raid Plan Drafter",
  "Document Storage Forecaster",
  "Secure Informant Link Protector",
  "Integration with Prisons/Jail DB",
  "Citizen Most-Wanted Portal Sync",
  "Inter-State Warrant Coordination Modeler",
  "Disaster Disrupted Execution Tracker",
  "Warrant Ops Budget Tracker",
  "Custom Workflow for NBW Cancellation",
  "AI Driven Execution Delay Predictor",
  "Predictive Need for Special Task Force",
  "Custom Alert Trigger for SP/SSP",
  "Warrant Lifecycle Timeline Tracker"
];
...
const WarrantManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI WARRANT MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI WARRANT <span>MANAGEMENT</span></h1>
...
export default WarrantManagementDetailed;
