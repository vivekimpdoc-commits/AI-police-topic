...
const aiExperts = [
  "Contempt of Court Risk Scorer AI",
  "Judicial Directive/Order Parsing NLP",
  "Statutory Deadline/Timeline Tracker",
  "Multi-Department Coordination Engine",
  "High Court/Supreme Court Precedent Linker",
  "Bail Condition/Surety Verification Monitor",
  "Geo-Spatial Non-Compliance Hotspot Mapper",
  "Action Taken Report (ATR) Generator Bot",
  "Compliance Monitor Dashboard",
  "Voice-Command Order Query Bot",
  "Automated Weekly Contempt Risk Report",
  "Directorate of Prosecution Sync",
  "Imminent Deadline Breach/Contempt Predictor",
  "Misinterpretation of Judicial Order Alert",
  "Departmental Bottleneck/Delay Analyzer",
  "Frivolous/Repeated Adjournment Flagging AI",
  "AI Evaluator for Judicial Compliance Index",
  "Audit/ATR Submission Log Generator",
  "Data Privacy/Juvenile Identity Scrubber",
  "E-Courts/National Judicial Data Grid Sync",
  "Nodal/Legal Officer Mobile App",
  "Historical Contempt Fine/Stricture Correlator",
  "IG (Legal/Law & Order) Briefing AI",
  "Compliance Execution/Verification Allocator",
  "Blockchain Immutable Order Receipt Hash",
  "Anti-Tamper Action Taken Report Shield",
  "Mobile App for Immediate Field Compliance Upload",
  "Unit-wise Compliance Promptness Benchmarker",
  "Automated Alert for Supreme Court/High Court Directives",
  "Historical Litigation/Contempt Penalty Cost Analyzer",
  "Legal Compliance/Affidavit Drafting SOP Trainer",
  "Judicial IT System API Health Monitor",
  "Imminent DGP/SP Personal Appearance (Summons) Alert",
  "Habitual Delaying/Non-Compliant Officer Profiler",
  "High-Sensitivity (Habeas Corpus/Human Rights) Order Classifier",
  "AI Assisted Compliance Affidavit Drafter",
  "Compliance Workload/Litigation Forecaster",
  "Secure Protected Witness/Whistleblower Detail Protector",
  "Integration with Inter-operable Criminal Justice System (ICJS)",
  "State Legal Services Authority Sync",
  "Election (ECI/Court Mandated) Security Compliance Modeler",
  "Disaster (Compensation Disbursement) Court Order Coordinator",
  "Legal Defense/Advocate Fee Budget Tracker",
  "Custom Workflow for CBI/NIA Handover Orders",
  "AI Driven Court Satisfaction/Acceptance Predictor",
  "Predictive Need for Legal Cell Expansion",
  "Custom Alert Trigger for DGP/Home Secretary",
  "Order Pronouncement to Final Compliance Timeline"
];
...
const CourtOrderComplianceMonitorDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI COURT ORDER COMPLIANCE MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI COURT ORDER COMPLIANCE <span>MONITORING</span></h1>
...
export default CourtOrderComplianceMonitorDetailed;
