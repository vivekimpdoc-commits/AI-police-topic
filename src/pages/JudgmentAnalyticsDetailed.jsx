...
const aiExperts = [
  "Acquittal Reason NLP Extractor",
  "Conviction Rate Trend Analyzer",
  "Judicial Officer Propensity/Trend Scorer",
  "Sentencing Disparity Modeler AI",
  "Investigation Flaw/Loophole Identifier",
  "Hostile Witness Pattern Tracker",
  "Section-wise Conviction Probability AI",
  "Forensic Rejection Reason Analyzer",
  "Judgment Analytics Dashboard",
  "Voice-Command Analytics Query Bot",
  "Automated Quarterly Conviction Report",
  "Training Academy Feedback Sync Bot",
  "Geospatial Acquittal Hotspot Mapper",
  "Bail Granting Pattern Extractor",
  "Fine/Penalty Trend Analyzer",
  "Appeal Success Rate Predictor",
  "AI Evaluator for IO Performance",
  "Audit/Analytics Access Log Gen",
  "Data Privacy/Judge Detail Scrubber",
  "High Court/Supreme Court E-Committee Sync",
  "Field IO Feedback/Alert App",
  "Cold Case Conviction Correlator AI",
  "DGP/Home Secretary Briefing Bot",
  "Remedial Training Resource Allocator",
  "Blockchain Immutable Analytics Hash",
  "Anti-Tamper Analytics Shield AI",
  "Mobile App for Senior Supervisory Officers",
  "Jurisdictional Bench Trend Matcher",
  "Multi-Lingual Judgment OCR/Translator",
  "Historical Judicial Trend Analyzer",
  "Judgment Analysis SOP Trainer",
  "Analytics Server Health Monitor",
  "Imminent Systemic Flaw Alert Bot",
  "Syndicate Acquittal Pattern Profiler",
  "High-Profile Case Judgment Classifier",
  "AI Assisted SOP Revision Drafter",
  "Judgment Data Storage Forecaster",
  "Secure Performance Metric Protector",
  "Integration with E-Courts/NJDG APIs",
  "Citizen Justice Transparency Analytics",
  "Riot/Mass Violence Conviction Modeler",
  "Disaster Fraud Judgment Coordinator",
  "Analytics Platform Budget Tracker",
  "Custom Workflow for Policy Recommendation",
  "AI Driven Policy Impact Predictor",
  "Predictive Need for Legal Reform",
  "Custom Alert Trigger for IG/ADG",
  "Judgment Trend Timeline Tracker"
];
...
const JudgmentAnalyticsDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI JUDGMENT ANALYTICS
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI JUDGMENT <span>ANALYTICS</span></h1>
...
export default JudgmentAnalyticsDetailed;
