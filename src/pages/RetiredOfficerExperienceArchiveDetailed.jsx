...
const aiExperts = [
  "Interview Audio/Video Transcription NLP",
  "Tacit Knowledge/Tradecraft Extractor AI",
  "Retired Officer-Trainee Mentorship Matcher",
  "Historical Riot/Crisis Negotiation Case Study Analyzer",
  "Investigative Modus Operandi (MO) Archiver",
  "Semantic Search/Query Engine for Past Cases",
  "Geo-Spatial Mapping of Historical Postings",
  "Cross-Referencing with Current Unsolved Cases AI",
  "Experience Archive Dashboard",
  "Voice-Command History Query Bot",
  "Automated Monthly Tradecraft Digest",
  "Police Training Academy/PTC Sync",
  "Knowledge Loss/Retirement Drain Risk Predictor",
  "Outdated SOP/Obsolete Tactic Flagging Engine",
  "Language/Dialect Translation AI for Interrogations",
  "Subject Matter Expert (SME) Directory Generator",
  "AI Evaluator for Tacit Knowledge Retention",
  "Audit/Archive Access Log Generator",
  "Data Privacy/Classified Identity Scrubber",
  "Pension/Welfare Directorate Sync",
  "Retired Officer Mobile/Audio Upload App",
  "Historical Success/Failure Correlator",
  "DGP (Training/HR) Briefing AI",
  "Debriefing/Interview Scheduling Allocator",
  "Blockchain Immutable Archive Hash",
  "Anti-Tamper Classified Experience Shield",
  "Mobile App for Quick Tactic Reference (for Trainees)",
  "District-wise Knowledge Retention Benchmarker",
  "Automated Alert for Impending SME Retirement",
  "Historical Training Cost Analyzer",
  "Mentorship/Experience Sharing SOP Trainer",
  "Audio/Video Cloud Storage Health Monitor",
  "Imminent Loss of Crucial Domain Expertise Alert",
  "Unresponsive/Unwilling Participant Profiler",
  "High-Priority (Anti-Terror/CID) Knowledge Classifier",
  "AI Assisted Honorarium/Recognition Drafter",
  "Archive Storage/Indexing Forecaster",
  "Secure Classified Operation Protector",
  "Integration with National Police Mission",
  "State CID/Intelligence Branch Sync",
  "Election Booth-Management Historical Tactics Modeler",
  "Disaster Rescue/Evacuation Historical Precedent Coordinator",
  "Recording/Archiving Infrastructure Budget Tracker",
  "Custom Workflow for Gallantry Awardees",
  "AI Driven Mentorship Match Probability Predictor",
  "Predictive Need for Specialized Tradecraft Manuals",
  "Custom Alert Trigger for IG Training",
  "Retirement to Debriefing/Archiving Timeline"
];
...
const RetiredOfficerExperienceArchiveDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI RETIRED OFFICER EXPERIENCE ARCHIVE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI RETIRED OFFICER EXPERIENCE <span>ARCHIVE</span></h1>
...
export default RetiredOfficerExperienceArchiveDetailed;
