...
const aiExperts = [
  "Cash Van Route/Threat Risk Scorer AI",
  "Live Telematics/GPS Deviation Tracker",
  "Armed Guard (Gun License) Validator",
  "Ambush/Chokepoint Predictor Engine",
  "Cash Loading/Unloading SOP Monitor",
  "Multi-Van Pooling/Batching AI",
  "Geo-Spatial High-Risk Route Mapper",
  "Vehicle Breakdown/Delay Correlator",
  "Cash Van Command Dashboard",
  "Voice-Command Van Status Bot",
  "Automated Daily Movement Report",
  "Highway Patrol/Dial 112 Sync Bot",
  "CCTV/ANPR Route Surveillance Integrator",
  "Fake Guard/Imposter Predictor AI",
  "Private Security Agency (PSARA) Sync AI",
  "Alarm/Panic Button Tester Bot",
  "AI Evaluator for Route Safety",
  "Audit/Movement Log Generator",
  "Data Privacy/Cash Volume Scrubber",
  "State Lead Bank/RBI Guideline Sync",
  "Field Patrol Van Alert App",
  "Historical Cash Van Heist Correlator",
  "Command Center/Supervisory Briefing AI",
  "Tactical Escort/QRT Allocator",
  "Blockchain Immutable Route Hash",
  "Anti-Tamper Movement Record Shield",
  "Mobile App for Van Custodians (Panic)",
  "Jurisdiction Boundary Matcher",
  "Multi-Lingual Emergency Broadcast Translator",
  "Historical Robbery/Ambush Trend Analyzer",
  "Cash Van SOP/Protocol Trainer",
  "Tracking DB Server Health Monitor",
  "Imminent Route Deviation/Ambush Alert",
  "Organized Dacoity Syndicate Profiler",
  "High-Value Cash Transit Classifier",
  "AI Assisted Contingency Route Drafter",
  "Telematics/Video Storage Forecaster",
  "Secure Route Plan Protector",
  "Integration with Cash Replenishment Agencies",
  "Citizen Traffic/Suspicious Activity Portal",
  "Festival/Election Cash Movement Modeler",
  "Disaster/Riot Evacuation Coordinator",
  "Escort/Patrol Expense Budget Tracker",
  "Custom Workflow for High-Value Transit Approval",
  "AI Driven Heist Probability Predictor",
  "Predictive Need for Police Escort",
  "Custom Alert Trigger for SP/SSP",
  "Van Movement Lifecycle Timeline Tracker"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CASH VAN MOVEMENT COORDINATION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CASH VAN MOVEMENT <span>COORDINATION</span></h1>
...
export default CashVanMovementDetailed;
