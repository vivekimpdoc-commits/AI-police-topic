...
const aiExperts = [
  "Randomized Target Selection Algorithm",
  "Geo-Fenced Proximity Trigger Alert",
  "Stealth Deployment/Route Optimizer",
  "Real-Time Spot-Check Reporting Bot",
  "Tip-off/Information Leak Detector",
  "Night Duty/Sentry Alertness Scorer",
  "Historical Vulnerability Hotspot Mapper",
  "Response Time/Turnout Evaluator",
  "Surprise Inspection Dashboard",
  "Voice-Command Target Query Bot",
  "Automated Weekly Spot-Check Report",
  "District Control Room (DCR) Sync",
  "Duty Evasion/Absence Predictor",
  "Compromised Route/Traffic Jam Analyzer",
  "Register Manipulation (Post-Arrival) Detector",
  "Lock-up/Prisoner Count Validator",
  "AI Evaluator for Operational Alertness",
  "Audit/Spot-Check Log Generator",
  "Data Privacy/Surprise Plan Scrubber",
  "Anti-Corruption/Vigilance Sync",
  "Gazetted Officer (GO) Night App",
  "Historical Negligence Correlator",
  "SP/SSP Briefing AI",
  "Remedial Action Task Allocator",
  "Blockchain Immutable Spot-Check Hash",
  "Anti-Tamper Night Diary Shield",
  "Mobile App for Live Video/Photo Evidence",
  "Station-wise Alertness Benchmarker",
  "Automated Alert for Missing Sentries",
  "Historical Night-Duty Fuel Cost Analyzer",
  "Surprise Check/Night Round SOP Trainer",
  "GPS/Vehicle Tracking API Monitor",
  "Imminent Custodial Incident Alert",
  "Habitual Sleeper/Absentee Profiler",
  "High-Risk (Border/Highway) Target Classifier",
  "AI Assisted Suspension/Notice Drafter",
  "Spot-Check Evidence/Video Forecaster",
  "Secure Surprise Target Roster Protector",
  "Integration with Dial 112/Emergency Dispatch",
  "Traffic/Highway Patrol Sync",
  "Election Vulnerable Booth Surprise Check Modeler",
  "Disaster Relief Camp Night Audit Coordinator",
  "Night Round Vehicle Fuel Budget Tracker",
  "Custom Workflow for DGP Flying Squad",
  "AI Driven Negligence Hotspot Predictor",
  "Predictive Need for Roster Shuffle",
  "Custom Alert Trigger for Zonal IG",
  "Target Selection to Spot Report Timeline"
];
...
const SurpriseInspectionSystemDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SURPRISE INSPECTION SYSTEM
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SURPRISE INSPECTION <span>SYSTEM</span></h1>
...
export default SurpriseInspectionSystemDetailed;
