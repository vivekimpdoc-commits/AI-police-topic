...
const aiExperts = [
  "Change Management KPI Tracker AI",
  "Training vs Actual Usage Correlator",
  "Tech-Fatigue/Burnout Detection AI",
  "Modernization ROI/Cost-Savings Estimator",
  "Feature Utilization/Abandonment Analyzer",
  "User Interface (UI) Friction/Click-path Scorer",
  "Geo-Spatial Tech Adoption Mapper",
  "Generational (Age-based) Adoption Analyzer",
  "Adoption Analytics Dashboard",
  "Voice-Command Usage Query Bot",
  "Automated Quarterly Adoption/ROI Report",
  "HRMS/Training Directorate Sync",
  "System Relapse (Back to Paper) Predictor",
  "Password Reset/Login Failure Spike Alert",
  "Shadow IT/Unauthorized Workaround Detector",
  "Peer-Influence/Champion Identification Engine",
  "AI Evaluator for Digital Transformation Index",
  "Audit/Usage Log Generator",
  "Data Privacy/Officer Activity Scrubber",
  "IT/Modernization Department Sync",
  "Change Ambassador/Trainer Mobile App",
  "Historical IT Project Failure Correlator",
  "DGP (Modernization) Briefing AI",
  "Refresher Training Task Allocator",
  "Blockchain Immutable Usage Hash",
  "Anti-Tamper Analytics Record Shield",
  "Mobile App for Officer Tech-Support/Help",
  "Unit-wise Digital Fluency Benchmarker",
  "Automated Alert for Near-Zero Usage Rates",
  "Historical Software License Wastage Analyzer",
  "Change Management/Digital Literacy SOP Trainer",
  "Application/Server Log API Monitor",
  "Imminent Project Failure (Due to Non-Adoption) Alert",
  "Laggard/Tech-Resistant Officer Profiler",
  "Mission-Critical (CCTNS/Dispatch) App Classifier",
  "AI Assisted Mandatory Usage Directive Drafter",
  "Usage Trend/Analytics Data Forecaster",
  "Secure User Activity Log Protector",
  "Integration with E-Office/Digital India Portals",
  "Public Grievance Redressal Sync",
  "Election Tech Tools Adoption Modeler",
  "Disaster Comms App Usage Coordinator",
  "IT Training/Change Management Budget Tracker",
  "Custom Workflow for Retiring/Senior Officers",
  "AI Driven Peak Adoption Date Predictor",
  "Predictive Need for UI/UX Redesign",
  "Custom Alert Trigger for IG IT",
  "Software Rollout to 90% Adoption Timeline"
];
...
const InnovationAdoptionAnalyticsDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INNOVATION ADOPTION ANALYTICS
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INNOVATION ADOPTION <span>ANALYTICS</span></h1>
...
export default InnovationAdoptionAnalyticsDetailed;
