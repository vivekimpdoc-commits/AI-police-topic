...
const aiExperts = [
  "Source Reliability Profile Scorer AI",
  "Deepfake Audio/Video Analyzer Bot",
  "Cross-Reference News Matching Engine AI",
  "Sentiment Shift Trend Predictor Bot",
  "Fact-Checking Database Connector Bot",
  "Image Edit/Photoshop Detector Engine AI",
  "Bots & Spam Account Classifier Bot",
  "Stance Detection/Bias Profiling Engine",
  "Credibility Control Command Dashboard",
  "Voice-Command Credibility Query Bot",
  "Automated Fact Check Report Generator AI",
  "Cross-Agency Verification Hub Sync Engine",
  "Web Domain Trust Factor Scorer AI",
  "Suspicious Text Plagiarism Checker Bot",
  "Botnet Propaganda Push Coordinator Bot",
  "Social Media Narrative Network Mapper AI",
  "AI Evaluator for Information Risk Index %",
  "Audit/Fact Check Verification Log Generator",
  "Data Privacy/Whistleblower IP Masker AI",
  "Police-Information Technology Cell Sync Bot",
  "IO Fact Verification Field Mobile App Sync",
  "Cold Case Fake Narrative Timeline Linker",
  "Senior Officer (ADG Cyber Wing) Briefing Bot",
  "Public Fake News Checker/Report Web Portal",
  "Blockchain Immutable Verified News Ledger",
  "Anti-Cyber Propaganda Firewall Security AI",
  "Mobile App for Quick Fact Check Lookup",
  "Reverse Search Engine Query Manager AI",
  "Multi-Lingual Audio Transcript Translator Bot",
  "Historical Propaganda Trend Pattern Matcher",
  "Staff Fact-Check Tool Operations Trainer AI",
  "Fact-Check DB Server Infrastructure Health",
  "Urgent Rumor Spike Riot Warning Alert AI",
  "Traffic/Transit Fake Blockage Rumor Filter",
  "Viral Narrative Network Source Triangulator",
  "VIP Target Defamation Campaign Tracker AI",
  "AI Assisted Post-Fact Investigation Draft",
  "Fact-Check Queue Priority Load Balancer AI",
  "Deepfake Video Signature Detector Bot",
  "Integration with National Fact-Check Portal",
  "Citizen Rumor Report & Verify Mobile Portal",
  "Extreme Rumor Event Sentiment Stress Modeler",
  "Disaster Situation Fake SOS Alert Filter AI",
  "Credibility Wing Operation Budget Tracker AI",
  "Custom Workflow/Approval for Public Fact Alert",
  "AI Driven Emerging Deepfake Tech Predictor",
  "Predictive Need for Public Advisory Warning",
  "Custom Alert Trigger for Cyber Wing Commander"
];
...
const InformationCredibilityScoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CREDIBILITY SCORING
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI CREDIBILITY SCORING</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in source reliability verification, fact-checking analytics, fake news detection & cross-referencing.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CREDIBILITY <span>SCORING</span></h1>
            <p className="cyber-subtitle">Source Reliability Verification, Fact-checking Analytics, Fake News Detection & Cross-referencing</p>
          </div>
        </div>
      </header>
...
export default InformationCredibilityScoringDetailed;
