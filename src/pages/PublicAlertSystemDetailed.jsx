...
const aiExperts = [
"Geo-Fenced Cell Broadcast Router",
  "Earthquake/Seismic Alert Sync AI",
  "Cyclone & Flood Evacuation Predictor",
  "Tsunami Early Warning Broadcaster",
  "Riot/Mob Violence Area Alert Bot",
  "Terrorist Attack SOS Broadcaster",
  "Active Shooter Geolocation Alert",
  "Hazardous Chemical Leak Zone AI",
  "Nuclear/Radiological Fallout Modeler",
  "Forest Fire Spread Prediction Alert",
  "Landslide/Avalanche Warning Sync",
  "Highway Pile-up/Accident Alert AI",
  "Bridge Collapse/Infrastructure Alert",
  "Dam Water Release Flash Flood AI",
  "Toll Plaza Emergency Barrier Sync",
  "Railway Derailment Public Alert",
  "Aviation Crash Zone Comms Link",
  "Missing Child (AMBER) Alert Sync",
  "Escaped Convict BOLO Broadcaster",
  "Serial Killer Proximity Alert AI",
  "Interstate Fugitive Alert Relay Bot",
  "Smart City Siren/PA System Trigger",
  "Digital Billboard Emergency Takeover",
  "Television/Radio Emergency Override",
  "Social Media API SOS Broadcaster",
  "Automated Multilingual Alert Translator",
  "Telecom Operator Network Load Sync",
  "Do-Not-Disturb (DND) Bypass AI",
  "Public Panic & Stampede Predictor",
  "Safe-Zone / Shelter Routing Guide AI",
  "Hospital Bed / Blood Availability Sync",
  "Ambulance/Fire-Engine Corridor Alert",
  "Power Grid Failure Comms Backup AI",
  "Internet Shutdown Offline Mesh Alert",
  "V2V (Vehicle-to-Vehicle) SOS Sync",
  "Drone Speaker/Audio Relay Dispatch",
  "Wearable/IoT Emergency Alert Sync",
  "Weather Department API Integration",
  "NDRF/SDRF Deployment Coordination",
  "Local NGO/Volunteer Alert Router",
  "VIP/Convoy Security Alert Bypass",
  "Election Violence Area Alert AI",
  "Curfew / Section 144 Enforcement Sync",
  "Fake Alert/Hacking Intrusion Detector",
  "Alert Effectiveness & Read-Receipt AI",
  "False-Alarm De-escalation Bot",
  "Public Health/Epidemic Outbreak Alert",
  "Cyber Attack/Grid Hack Comms Sync",
  "Automated 'All-Clear' Broadcaster",
  "Historical Disaster Pattern Modeler",
  "Alert Template Generator & Optimizer",
  "Cross-Border Conflict Air-Raid Alert",
  "Maritime Coastguard Alert Sync AI",
  "Subterranean/Metro Evacuation Alert",
  "School/Campus Lockdown Sync Bot",
  "CCTV/ANPR Integration for Alerts",
  "Command Center Alert Dashboard AI",
  "Inter-Agency Actionable Intel Sync",
  "Automated Audit Log for Broadcasts",
  "AI Crisis Communication Strategist"
];
...
const PublicAlertSystemDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI PUBLIC ALERT SYSTEM
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI PUBLIC ALERT SYSTEM</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in geo-fenced emergency broadcasts, natural disaster warnings & riot alerts.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI PUBLIC ALERT <span>SYSTEM</span></h1>
            <p className="cyber-subtitle">Geo-Fenced Emergency Broadcasts, Natural Disaster Warnings & Riot Alerts</p>
          </div>
        </div>
      </header>
...
export default PublicAlertSystemDetailed;
