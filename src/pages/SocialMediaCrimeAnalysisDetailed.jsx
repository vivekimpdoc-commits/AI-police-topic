...
const aiExperts = [
"Communal Hate Speech/Sentiment Analyzer",
  "Fake News & Misinformation Virality Tracker",
  "Cyber-Bullying/Troll Farm Detection AI",
  "Online Harassment/Stalking Threat Scorer",
  "Deepfake/Morph Image Identification Engine",
  "Sextortion/Revenge Porn Distribution Alert",
  "Terror Recruitment/Radicalization Profiler",
  "Gang/Mafia Bragging & Threat Extractor",
  "Weapon/Gun Display (Reels/Shorts) Alert AI",
  "Riot/Mob Incitement Sentiment Tracker",
  "Bot Network/Astroturfing Analyzer AI",
  "Command Center Social Media Dashboard",
  "Voice-Command Social Trend Query Assistant",
  "Automated Takedown/Section 69A Notice Gen",
  "Influencer/Instigator Network Graphing AI",
  "Geo-Location Extraction from Social Posts",
  "Hashtag/Trend Manipulation Predictor Bot",
  "Inter-Agency (IB/Cyber Cell) Sync AI",
  "Historical Propaganda Precedent Matcher",
  "Election Code/Voter Intimidation Alert AI",
  "Suicide/Self-Harm Ideation Early Warning",
  "Victim Sentiment/Public Outrage Scorer",
  "Drug/Narcotics Slang NLP Extractor Bot",
  "Prostitution/Escort Service Ad Analyzer",
  "AI Evaluator for Free Speech vs Hate Speech",
  "Blockchain Immutable Log of Takedowns",
  "Nodal Officer (Meta/X/Google) Auto-Router",
  "AI Driven Public Rebuttal/Clarification Drafter",
  "Dark Web Leak Cross-Referenced on Social",
  "Suspicious/Anonymous Account Origin Tracer",
  "IP Log/Login History Subpoena Auto-Gen",
  "Multi-Lingual/Regional Dialect NLP Engine",
  "VIP/Politician Death Threat Sentiment AI",
  "Caste/Religion Sensitivities Conflict Bot",
  "AI Protocol for Internet Shutdown Advisory",
  "Senior Officer (IG/ADG) Crisis Briefing AI",
  "Video/Audio Deepfake Audio-Print Matcher",
  "Crowdsourced Fact-Check Integration Bot",
  "Child Abuse/CSAM Hashtag Flagging AI",
  "Animal Cruelty/Torture Video Alert Bot",
  "Financial Scam/Crypto Pump-and-Dump Linker",
  "Data Privacy/Victim Doxxing Erasure AI",
  "AI Assisted Open Source Intel (OSINT) Builder",
  "Custom Keyword/Emoji Threat Tracker AI"
];
...
const SocialMediaCrimeAnalysisDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SOCIAL MEDIA CRIME ANALYSIS
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI SOCIAL MEDIA CRIME ANALYSIS</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in cyber-bullying, hate speech tracking, fake news virality & online harassment.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SOCIAL MEDIA <span>CRIME ANALYSIS</span></h1>
            <p className="cyber-subtitle">Cyber-Bullying, Hate Speech Tracking, Fake News Virality & Online Harassment</p>
          </div>
        </div>
      </header>
...
export default SocialMediaCrimeAnalysisDetailed;
