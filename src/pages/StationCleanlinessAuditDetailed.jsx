...
const aiExperts = [
  "Visual Hygiene/Cleanliness Scorer AI",
  "Lock-up/Toilet Sanitation Auditor",
  "Public Reception/Waiting Area Aesthetic Analyzer",
  "5S Methodology (Sort, Set, Shine) Compliance Bot",
  "Record Room/Malkhana Dust/Pest Detector",
  "Scrap/Seized Vehicle Yard Clutter Analyzer",
  "Geo-Spatial Station Hygiene Heatmapper",
  "Contractor/Sweeper Attendance Sync AI",
  "Cleanliness Audit Dashboard",
  "Voice-Command Hygiene Query Bot",
  "Automated Weekly Swachhata (Cleanliness) Report",
  "Municipal/Sanitation Department Sync",
  "Infectious Disease/Outbreak Predictor (Lock-up)",
  "Bio-Hazard/Medical Waste Mishandling Alert",
  "Water Stagnation/Dengue Risk Detector",
  "Cleaning Supply/Chemical Shortage Analyzer",
  "AI Evaluator for Swachh Police Station Index",
  "Audit/Sanitation Log Generator",
  "Data Privacy/Custody Video Scrubber",
  "Health/Medical Officer Sync",
  "Nodal Officer (Swachhata) Mobile App",
  "Historical Custodial Health Issue Correlator",
  "SP (Administration) Briefing AI",
  "Housekeeping/Scrap Disposal Task Allocator",
  "Blockchain Immutable Cleanliness Hash",
  "Anti-Tamper Sweeper Attendance Shield",
  "Mobile App for Public/Citizen Feedback",
  "Station-wise Hygiene Benchmarker",
  "Automated Alert for Severe Unhygienic Conditions",
  "Historical Cleaning Contract Cost Analyzer",
  "Swachh Bharat/Sanitation SOP Trainer",
  "IoT Odor/Air Quality Sensor Monitor",
  "Imminent Epidemic (in Barrack/Lock-up) Alert",
  "Habitual Clutter/Mess Creator Profiler",
  "High-Footfall (City Center) Station Classifier",
  "AI Assisted Contractor Penalty Drafter",
  "Cleanliness Image/Before-After Forecaster",
  "Secure Lock-up Footage Protector",
  "Integration with National Swachh Bharat Portal",
  "Pollution Control Board Sync",
  "Election Observer Visit Readiness Modeler",
  "Disaster Flood/Mud Clearance Coordinator",
  "Sanitation/Housekeeping Budget Tracker",
  "Custom Workflow for Hazardous Seizure Disposal",
  "AI Driven Cleaning Supply Indent Predictor",
  "Predictive Need for Pest Control",
  "Custom Alert Trigger for Range DIG",
  "Deficiency Identification to Deep Clean Timeline"
];
...
const StationCleanlinessAuditDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI STATION CLEANLINESS AUDIT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI STATION CLEANLINESS <span>AUDIT</span></h1>
...
export default StationCleanlinessAuditDetailed;
