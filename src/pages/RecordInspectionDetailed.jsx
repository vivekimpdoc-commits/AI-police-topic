...
const aiExperts = [
  "Physical Register vs CCTNS Parity Checker",
  "Missing/Overwritten Entry Detection AI",
  "Delayed Investigation/Charge-sheet Red-Flagger",
  "Bail/Absconder Register Audit Bot",
  "Village Crime Notebook (VCNB) Completeness Scorer",
  "Malkhana (Property) Register Validation AI",
  "Geo-Spatial Crime Record Mapping Integrator",
  "Case Diary (CD) Submission Timeline Analyzer",
  "Record Inspection Dashboard",
  "Voice-Command Record Query Bot",
  "Automated Monthly Crime Audit Report",
  "State Crime Records Bureau (SCRB) Sync",
  "Data Manipulation/Whitener Use Predictor",
  "FIR Registration Delay/Burking Alert",
  "Pending Warrant/Summons Accumulation Analyzer",
  "Habitual Offender/History-Sheeter Update Monitor",
  "AI Evaluator for Documentation Compliance Index",
  "Audit/Inspection Log Generator",
  "Data Privacy/Victim Identity Scrubber",
  "Prosecution/Legal Department Sync",
  "Inspecting Officer/Circle Officer App",
  "Historical Acquittal (Due to Bad Records) Correlator",
  "IG (Crime) Briefing AI",
  "Record Updating/Correction Task Allocator",
  "Blockchain Immutable CCTNS Hash",
  "Anti-Tamper Crime Register Shield",
  "Mobile App for Spot File Scanning",
  "Station-wise Record Accuracy Benchmarker",
  "Automated Alert for Expiring Limitation Periods",
  "Historical Litigation/Compensation Cost Analyzer",
  "Crime Documentation/CCTNS SOP Trainer",
  "Database Synchronization/API Health Monitor",
  "Imminent Custodial/Legal Crisis Alert",
  "Sloppy Investigating Officer (IO) Profiler",
  "Heinous Crime (Murder/Rape) Record Classifier",
  "AI Assisted Show-Cause Notice Drafter",
  "Crime Data/Storage Forecaster",
  "Secure Case File/Evidence Protector",
  "Integration with E-Courts/ICJS",
  "Women/Child Protection Cell Sync",
  "Election Preventive Arrest Register Modeler",
  "Disaster Missing Person Record Coordinator",
  "CCTNS/Digitization Budget Tracker",
  "Custom Workflow for Unsolved/Cold Cases",
  "AI Driven Backlog Clearance Predictor",
  "Predictive Need for IO Refresher Training",
  "Custom Alert Trigger for SP Crime",
  "Discrepancy Detection to Rectification Timeline"
];
...
const RecordInspectionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI RECORD INSPECTION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI RECORD <span>INSPECTION</span></h1>
...
export default RecordInspectionDetailed;
