...
const aiExperts = [
  "CCTV Hairnet/Glove Compliance AI",
  "Automated Pest/Rodent Detection Vision",
  "FSSAI Standard/Checklist Validator",
  "Sanitation/Cleanliness Scoring Engine",
  "Temperature/Cold Storage Monitor AI",
  "Dishwashing/Sterilization Effectiveness Bot",
  "Geo-Spatial Kitchen Zone Mapper",
  "Cross-Contamination Vector Analyzer",
  "Kitchen Hygiene Dashboard",
  "Voice-Command Audit Query Bot",
  "Automated Weekly Hygiene Report",
  "Police Mess/Canteen Department Sync",
  "Raw/Cooked Meat Separation Violation Detector",
  "Spoiled/Rotting Ingredient Alert",
  "Staff Hand-Washing Frequency Predictor",
  "Garbage Disposal Delay Analyzer",
  "AI Evaluator for Mess Hygiene Index",
  "Audit/Compliance Log Generator",
  "Data Privacy/Staff Identity Scrubber",
  "Health/Medical Officer Sync",
  "Mess Commander Inspection Mobile App",
  "Historical Food Poisoning Event Correlator",
  "SP (Lines/Admin) Briefing AI",
  "Deep Cleaning Task Allocator",
  "Blockchain Immutable Audit Video Hash",
  "Anti-Tamper Kitchen CCTV Shield",
  "Mobile App for Spot Fine/Notice",
  "Mess-wise Hygiene Benchmarker",
  "Automated Alert for FSSAI Violation",
  "Historical Mess Cleaning Material Expense Analyzer",
  "Food Safety/Hygiene SOP Trainer",
  "Kitchen CCTV/Sensor Gateway Monitor",
  "Imminent Foodborne Illness Outbreak Alert",
  "Habitual Hygiene Violator (Staff) Profiler",
  "High-Capacity (Training Academy) Mess Classifier",
  "AI Assisted Show-Cause Notice Drafter",
  "Audit Video/Image Storage Forecaster",
  "Secure Health Inspection Protector",
  "Integration with Food Safety Department",
  "Force Welfare/Health Portal Sync",
  "Election Mega-Kitchen Hygiene Modeler",
  "Disaster Relief Camp Kitchen Coordinator",
  "Sanitation/Cleaning Material Budget Tracker",
  "Custom Workflow for Pest Extermination",
  "AI Driven Bacteria/Spoilage Risk Predictor",
  "Predictive Need for Kitchen Equipment Overhaul",
  "Custom Alert Trigger for IG Provisioning",
  "Ingredient Prep to Service Hygiene Timeline"
];
...
const KitchenHygieneAuditDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI KITCHEN HYGIENE AUDIT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI KITCHEN HYGIENE <span>AUDIT</span></h1>
...
export default KitchenHygieneAuditDetailed;
