...
const aiExperts = [
  "Commission of Inquiry NLP Summarizer",
  "Major Incident Post-Mortem Extractor",
  "Strategic Doctrine/Policy Version Control AI",
  "Semantic Search Engine for Archives",
  "Failure/Success Pattern Correlator",
  "Recommendation vs Implementation Tracker",
  "Geo-Spatial Historical Incident Mapper",
  "Court/Judicial Stricture Indexer",
  "Strategic Review Repository Dashboard",
  "Voice-Command Archive Query Bot",
  "Automated Doctrine Evolution Report",
  "State Archives/Record Room Sync Bot",
  "OCR for Historic/Handwritten Reports",
  "Cross-Reference/Citation Linker AI",
  "Fake/Altered Historical Document Detector",
  "Classified/Secret Clearance Filter AI",
  "AI Evaluator for Policy Relevance",
  "Audit/Access Log Generator",
  "Data Privacy/Classified Info Scrubber",
  "State Home Department Sync",
  "Field Officer Policy Quick-Search App",
  "Cold Case/Historical Riot Matcher",
  "DGP/Policy Maker Briefing AI",
  "Research/Staff Officer Allocator",
  "Blockchain Immutable Archive Hash",
  "Anti-Tamper Historical Record Shield",
  "Mobile App for Secure Document Viewing",
  "National/International Doctrine Matcher",
  "Multi-Lingual Historic Translation Engine",
  "Historical Policy Effectiveness Analyzer",
  "Strategic Analysis SOP Trainer",
  "Archive Server/Storage Health Monitor",
  "Imminent Policy Expiry/Review Alert",
  "Historical Syndicate Evolution Profiler",
  "High-Sensitivity/Classified Document Classifier",
  "AI Assisted New Doctrine Drafter",
  "Massive Archival Storage Forecaster",
  "Secure Official Secrets Act Protector",
  "Integration with National Police Memorial/Archives",
  "Declassified Document Public Portal Sync",
  "Historical Riot/Communal Clash Modeler",
  "Disaster Relief Evolution Coordinator",
  "Archival Digitization Budget Tracker",
  "Custom Workflow for Declassification",
  "AI Driven Policy Trend Predictor",
  "Predictive Need for Doctrine Overhaul",
  "Custom Alert Trigger for IG/ADG",
  "Strategic Policy Evolution Timeline Tracker"
];
...
const StrategicReviewRepositoryDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI STRATEGIC REVIEW REPOSITORY
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI STRATEGIC REVIEW <span>REPOSITORY</span></h1>
...
export default StrategicReviewRepositoryDetailed;
