...
const aiExperts = [
  "Silent Zone (Hospital/School) Proximity Calculator",
  "Noise Pollution (Decibel) Limit Tracker",
  "Festival/Event Time-Limit Enforcement Engine",
  "Public Complaint/Dial 112 Correlation AI",
  "Religious/Political Event Profiler",
  "Automated Permission/NOC Generator",
  "Geo-Spatial Loudspeaker/DJ Mapping Bot",
  "Communal Sensitivity/Tension Assessor",
  "Loudspeaker Permission Dashboard",
  "Voice-Command Noise Query Bot",
  "Automated Monthly Noise Compliance Report",
  "Pollution Control Board (SPCB) Sync",
  "Time-Limit Violation/Night-Time Breach Predictor",
  "Communal Flashpoint (Overlapping Events) Alert",
  "Repeated Defaulter (DJ/Organizer) Analyzer",
  "Fake Permission/Forged NOC Detector",
  "AI Evaluator for Noise Control Index",
  "Audit/Permission Log Generator",
  "Data Privacy/Applicant Detail Scrubber",
  "State Intelligence/LIU Sync",
  "Beat Constable/Traffic Police Mobile App",
  "Historical Clash/Riot (due to noise) Correlator",
  "Sub-Divisional Magistrate (SDM)/CO Briefing AI",
  "Decibel Meter Measurement/Verification Allocator",
  "Blockchain Immutable NOC Hash",
  "Anti-Tamper Digital Permission Shield",
  "Mobile App for On-Site Decibel Logging",
  "Station-wise Noise Complaint Redressal Benchmarker",
  "Automated Alert for 10 PM Deadline Violations",
  "Historical Law & Order Deployment Cost Analyzer",
  "Noise Pollution Rules (2000) SOP Trainer",
  "Emergency Response (Dial 112) API Health Monitor",
  "Imminent Communal Standoff (Processions meeting) Alert",
  "Habitual Noise Violator/DJ Operator Profiler",
  "High-Sensitivity (Exam Time/Hospital) Zone Classifier",
  "AI Assisted Challan/Seizure Order Drafter",
  "Festival Volume/Permission Demand Forecaster",
  "Secure Informant/Complainant Protector",
  "Integration with Local Intelligence Data",
  "Traffic Police/Control Room Sync",
  "Election Rally/Public Address Approval Modeler",
  "Disaster/Emergency Broadcast Exemption Coordinator",
  "Decibel Meter/Equipment Procurement Budget Tracker",
  "Custom Workflow for Permanent Installations (Religious Sites)",
  "AI Driven Violation/Conflict Probability Predictor",
  "Predictive Need for Peace Committee Meetings",
  "Custom Alert Trigger for SP/SSP",
  "Application Receipt to Final Approval Timeline"
];
...
const LoudspeakerPermissionManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI LOUDSPEAKER PERMISSION MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI LOUDSPEAKER PERMISSION <span>MANAGEMENT</span></h1>
...
export default LoudspeakerPermissionManagementDetailed;
