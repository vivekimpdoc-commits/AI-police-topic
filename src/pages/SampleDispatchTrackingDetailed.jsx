...
const aiExperts = [
  "Secure Chain of Custody (CoC) Validator AI",
  "GPS/Transit Route Tracker",
  "Tamper-Evident Seal/Photo Analyzer",
  "Automated FSL Receipt/Acknowledgement Generator",
  "Temperature/Cold-Chain Integrity Monitor",
  "Courier/Malkhana Delay Predictor",
  "Geo-Spatial Sample Movement Mapper",
  "Cross-Contamination Risk Scorer",
  "Sample Dispatch Tracking Dashboard",
  "Voice-Command Sample Query Bot",
  "Automated Weekly Transit Audit Report",
  "State Malkhana (Evidence Room) Sync",
  "Transit Delay/Route Deviation Alert",
  "Seal Tampering/Replacement Detector",
  "Cold-Chain Failure (DNA/Blood) Predictor",
  "Missing/Misplaced Sample Flagging AI",
  "AI Evaluator for CoC Integrity Index",
  "Audit/Transit Log Generator",
  "Data Privacy/Victim Identity Scrubber",
  "Investigating Officer (IO) App Sync",
  "Malkhana In-Charge/Courier Mobile App",
  "Historical Tampering/Acquittal Correlator",
  "SP (Crime) Briefing AI",
  "Dispatch/Courier Re-Routing Allocator",
  "Blockchain Immutable CoC Hash",
  "Anti-Tamper Transit Log Shield",
  "Mobile App for Geo-Tagged Handover",
  "District-wise Dispatch Speed Benchmarker",
  "Automated Alert for Compromised/Tampered Sample",
  "Historical Courier/Transport Cost Analyzer",
  "Evidence Packaging/Dispatch SOP Trainer",
  "IoT (Temperature/GPS) Sensor API Monitor",
  "Imminent Evidence Spoliation/Loss Alert",
  "Careless Courier/Malkhana Officer Profiler",
  "High-Stakes (Murder/Rape) Sample Classifier",
  "AI Assisted Show-Cause Notice Drafter (for Delay)",
  "Transit Bottleneck/Delay Forecaster",
  "Secure Evidence Details Protector",
  "Integration with Inter-operable Criminal Justice System (ICJS)",
  "Prosecution Directorate Sync",
  "Election Violence Evidence Dispatch Modeler",
  "Disaster Victim ID (DNA) Sample Coordinator",
  "Evidence Transport/Logistics Budget Tracker",
  "Custom Workflow for Cyber/Digital Evidence Transit",
  "AI Driven Estimated Time of Arrival (ETA) Predictor",
  "Predictive Need for Specialized Transport (Cold Storage)",
  "Custom Alert Trigger for FSL Director",
  "Seizure at Scene to FSL Receipt Timeline"
];
...
const SampleDispatchTrackingDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SAMPLE DISPATCH TRACKING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SAMPLE DISPATCH <span>TRACKING</span></h1>
...
export default SampleDispatchTrackingDetailed;
