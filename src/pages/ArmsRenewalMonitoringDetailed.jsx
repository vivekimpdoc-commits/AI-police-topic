...
const aiExperts = [
  "Automated License Expiry Alert Engine",
  "Fresh Police/LIU Verification Router",
  "Physical Weapon Inspection (Bore/Condition) Tracker",
  "Late Fee/Penalty Calculation AI",
  "Ammunition Consumption/Usage Analyzer",
  "Criminal Involvement (Post-Issuance) Cross-Matcher",
  "Geo-Spatial Pending Renewal Mapper",
  "Senior Citizen/Medical Re-evaluation Trigger",
  "Renewal Monitoring Dashboard",
  "Voice-Command Renewal Status Bot",
  "Automated Monthly Expired License Report",
  "National Database of Arms Licenses (NDAL) Sync",
  "Weapon Loss/Misplacement Predictor",
  "Fake Medical Certificate (Renewal) Alert",
  "Prolonged Non-Renewal (Absconder Risk) Analyzer",
  "Verification Bottleneck/Delay Estimator",
  "AI Evaluator for Renewal Efficiency Index",
  "Audit/Renewal Log Generator",
  "Data Privacy/Licensee Identity Scrubber",
  "District Magistrate Licensing Office Sync",
  "Verification Officer/SHO Mobile App",
  "Historical Non-Renewal vs Crime Involvement Correlator",
  "SP/DM Briefing Interface",
  "Verification/Inspection Task Allocator",
  "Blockchain Immutable Renewal/Inspection Hash",
  "Anti-Tamper Weapon Photo Shield",
  "Mobile App for Geo-tagged Weapon Inspection",
  "District-wise Renewal Clearance Benchmarker",
  "Automated Alert for 30-Days to Expiry",
  "Historical Penalty Revenue Cost Analyzer",
  "License Renewal Processing SOP Trainer",
  "Citizen Portal/NDAL API Health Monitor",
  "Imminent Mass Expiry (Year-End) Alert",
  "Habitual Late-Renewing Citizen Profiler",
  "High-Priority (VIP/Security Guard) Renewal Classifier",
  "AI Assisted License Cancellation/Suspension Drafter",
  "Renewal Volume/Workload Forecaster",
  "Secure Health/Medical Detail Protector",
  "Integration with E-District Service Portal",
  "Traffic/Challan Database (for Character checks) Sync",
  "Election Weapon Deposit Tracking (Expired Licenses) Modeler",
  "Disaster Relocation (Address Change) Renewal Coordinator",
  "Licensing Cell Staff Overtime Budget Tracker",
  "Custom Workflow for Inherited/Transferred Weapons",
  "AI Driven Renewal Rejection Probability Predictor",
  "Predictive Need for Renewal Camps (Melas)",
  "Custom Alert Trigger for Home Secretary",
  "Expiry Alert to Final Renewal Timeline"
];
...
const ArmsRenewalMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ARMS RENEWAL MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ARMS RENEWAL <span>MONITORING</span></h1>
...
export default ArmsRenewalMonitoringDetailed;
