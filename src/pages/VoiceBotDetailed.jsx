...
const aiExperts = [
"Dial 112 Distress Voice Analyzer",
  "Real-Time Vernacular Translator",
  "Acoustic Panic/Fear Detector",
  "Background Noise Context AI",
  "Gunshot/Scream Audio Matcher AI",
  "Automated Call Triage Router",
  "Robo-Cop FAQ Voice Responder",
  "Citizen Voice Biometric Matcher",
  "Fake Emergency Call Filter Bot",
  "Drunk Caller Detection AI",
  "Hostage Situation Whisper Analyzer",
  "Elderly Caller Priority Router",
  "Multi-Lingual NLP Interpreter",
  "Call Drop Re-Connect & Trace AI",
  "Automated FIR Voice Dictation Bot",
  "Caller Location Triangulation Sync",
  "Voice Sentiment & Emotion AI",
  "Suicide Helpline Keyword Flag AI",
  "Domestic Abuse Keyword Alert Bot",
  "Cyber Fraud Helpdesk Voice AI",
  "Traffic E-Challan Voice Query Bot",
  "Police Recruitment FAQ Voice Bot",
  "Stutter/Speech-Impairment AI Decoder",
  "Automated Outbound Follow-up Bot",
  "Officer Dispatch Voice Coordinator",
  "Ambulance/Fire Relay Voice AI",
  "Kidnapping Demand Voice Analyzer",
  "Extortion Call Threat Scorer",
  "Voice Bot to Human Handoff AI",
  "Automated Call Transcript Generator",
  "Citizen Feedback Voice Surveyor",
  "Jansunwai Voice Complaint Logger",
  "Women Helpline (1090) Priority AI",
  "Child Helpline (1098) Sync Bot",
  "Anti-Corruption Tip Voice Analyzer",
  "Missing Person Voice Query Bot",
  "Public Event Info Voice Desk",
  "Passport Verification Status Bot",
  "Tenant/Servant Verification Voice AI",
  "Automated Case Status Updater Bot",
  "Suspect Interrogation Voice Analyzer",
  "Lie/Deception Acoustic Modeler",
  "CCTNS Database Voice Query Bot",
  "Officer Radio Comms Voice Parser",
  "Emergency Broadcast Voice Gen AI",
  "Mass Caller Queue Optimizer",
  "Voice Bot Server Load Predictor",
  "Local Slang/Dialect NLP Modeler",
  "Cross-Border Language Translator AI",
  "Tourist Emergency Voice Assistant",
  "VIP Distress Call Identifier",
  "Automated Daily Call Report Gen",
  "Voice Bot Audit & QA Analyzer",
  "Continuous Learning Speech AI",
  "Offline Mode Voice Assistant",
  "Police Vehicle Voice Command Sync",
  "In-App Voice Search Coordinator",
  "Smart Wearable Voice Trigger AI",
  "Social Media Audio Scraping Bot",
  "Command Center Voice Alert AI"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI VOICE BOT ASSISTANT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI VOICE BOT ASSISTANT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in vernacular translation, sentiment analysis & emergency distress detection.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI VOICE BOT <span>ASSISTANT</span></h1>
            <p className="cyber-subtitle">Vernacular Translation, Sentiment Analysis & Emergency Distress Detection</p>
          </div>
        </div>
      </header>
...
export default VoiceBotDetailed;
