...
const aiExperts = [
"FST (Flying Squad) GPS Tracking Dashboard",
  "SST (Static Surveillance) Checkpost Monitor",
  "Illegal Cash Seizure Geo-Heatmap AI",
  "Liquor/Drug Smuggling Route Predictor",
  "Illegal Arms/Weapon Interception Alert Bot",
  "Hawala/Suspicious Transaction Flagging AI",
  "Voter Bribery/Distribution Complaint Router",
  "Video Recording/Seizure Memo Generator",
  "Command Center Flying Squad Dashboard",
  "Voice-Command Seizure Query Assistant",
  "Automated Daily Seizure Stat (ECI) Sender",
  "Inter-District Smuggler Chase Sync Engine",
  "Vehicle/License Plate (ANPR) Blacklist Alert",
  "Income Tax/Excise Dept Joint Raid Sync AI",
  "Social Media/cVIGIL Complaint Extractor Bot",
  "Freebie/Gift (Saree/Utensils) Seizure Tracker",
  "AI Evaluator for Squad Intercept Efficiency",
  "Audit/Panchnama Log Auto-Generator",
  "Data Privacy/Whistleblower Info Masker",
  "Police-Election Commission Seizure Sync",
  "Bank/ATM Suspicious Cash Withdrawal Alert",
  "Warehouse/Godown Raid Route Optimizer",
  "Senior Officer (Expenditure Observer) Briefing",
  "Public Anti-Bribery Awareness Drafter",
  "Blockchain Immutable Log of Seized Cash",
  "Drone Overwatch for Smuggling Routes AI",
  "Mobile App for FST/SST Officer Sync",
  "Seized Goods Malkhana Deposition Tracker",
  "Multi-Lingual Seizure Translation Bot",
  "Historical Seizure Hotspot Matcher AI",
  "Medical/Narcotics Testing Kit Inventory Bot",
  "Squad Personnel Fatigue/Shift Monitor",
  "Temporary Naka Relocation Geo-Optimizer",
  "Traffic Bottleneck Evasion for FST Vehicles",
  "Shadow Zone Offline Seizure Sync Engine",
  "Armed Escort/QRT Backup for Cash Seizure",
  "AI Assisted Post-Seizure FIR Drafter",
  "Vehicle Breakdown/Repair Alert for FST",
  "VIP/Politician Vehicle Checking Protocol Bot",
  "Integration with ECI ESMS (Election Seizure)",
  "Citizen WhatsApp Tip-Off Analyzer AI",
  "Night-Time Surveillance/Thermal Camera Sync",
  "Return-to-Owner (Post-Election) Clearance",
  "Squad Logistics/Fuel Expense Tracker AI",
  "Custom Workflow/Approval for Raid",
  "AI Driven Smuggling Diversion Predictor",
  "Predictive Need for Central Armed Forces",
...
const FlyingSquadDashboardDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI FLYING SQUAD DASHBOARD
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI FLYING SQUAD DASHBOARD</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in tracking fst/sst intercepting illegal cash, liquor, drugs & arms.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI FLYING SQUAD <span>DASHBOARD</span></h1>
            <p className="cyber-subtitle">Tracking FST/SST Intercepting Illegal Cash, Liquor, Drugs & Arms</p>
          </div>
        </div>
      </header>
...
export default FlyingSquadDashboardDetailed;
