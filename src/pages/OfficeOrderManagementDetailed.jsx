...
const aiExperts = [
  "Office Order NLP Drafting Assistant",
  "Policy/Regulation Cross-Reference AI",
  "Digital Signature/Approval Workflow Bot",
  "Officer Acknowledgment Tracker",
  "Historical Precedent Search Engine",
  "Contradiction/Conflict Detector AI",
  "Geo-Spatial Order Impact Mapper",
  "Urgency/Priority Routing AI",
  "Order Management Dashboard",
  "Voice-Command Order Query Bot",
  "Automated Daily Compliance Report",
  "State Home Department Sync Bot",
  "Multi-Lingual Order Translation (English/Hindi)",
  "Read-Receipt/View Tracking Engine",
  "Fake/Forged Order Detector",
  "Archive & Retrieval Bot",
  "AI Evaluator for Implementation Speed",
  "Audit/Distribution Log Generator",
  "Data Privacy/Classified Order Scrubber",
  "Personnel/HRMS Sync",
  "Field Officer Mobile Notification App",
  "Historical Order Revision Correlator",
  "DGP/IG Level Order Briefing AI",
  "Task/Action Item Extractor",
  "Blockchain Immutable Order Hash",
  "Anti-Tamper Document Shield",
  "Mobile App for Immediate Acknowledgment",
  "Jurisdiction-Specific Order Routing",
  "Automated Reminder for Pending Actions",
  "Historical Compliance Rate Analyzer",
  "Order Drafting SOP Trainer",
  "Document Server Health Monitor",
  "Imminent Deadline/Default Alert",
  "Serial Defaulter Profiler",
  "High-Priority/Top-Secret Order Classifier",
  "AI Assisted Corrigendum Drafter",
  "Order Data Storage Forecaster",
  "Secure Classified Order Protector",
  "Integration with E-Office/NIC",
  "Citizen Facing Order Portal Sync (if public)",
  "Election (MCC) Order Compliance Modeler",
  "Disaster/Emergency Order Coordinator",
  "Printing/Paper Savings Tracker",
  "Custom Workflow for Verbal Order Formalization",
  "AI Driven Policy Impact Predictor",
  "Predictive Need for Legal Vetting",
  "Custom Alert Trigger for Nodal Officers",
  "Order Lifecycle Timeline Tracker"
];
...
const OfficeOrderManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI OFFICE ORDER MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI OFFICE ORDER <span>MANAGEMENT</span></h1>
...
export default OfficeOrderManagementDetailed;
