...
const aiExperts = [
  "Remand Expiry (24h/14d) Alert Engine",
  "Judicial vs Police Custody Tracker",
  "Mandatory Medical Checkup Scheduler",
  "Interrogation Plan/Milestone AI",
  "Custodial Violence Risk Predictor",
  "Statutory (60/90 Day) Charge-Sheet Alert",
  "CCTNS/Prison Sync Engine",
  "Remand Extension Justification Drafter",
  "Remand Command Dashboard",
  "Voice-Command Custody Status Bot",
  "Automated Daily Remand Roster",
  "Hospital/Medical Officer Sync Bot",
  "Geo-Spatial Lockup Capacity Monitor",
  "CCTV Lockup Feed Anomaly Detector",
  "Fake Illness/Delay Tactic Predictor",
  "Interrogation Transcript Summarizer",
  "AI Evaluator for IO Remand Efficiency",
  "Audit/Custody Transfer Log Gen",
  "Data Privacy/Medical Record Scrubber",
  "Human Rights Commission Guideline Sync",
  "Field IO Custody Alert App",
  "Historical Custodial Death Correlator",
  "SHO/Supervisory Officer Briefing",
  "Interrogator/Specialist Allocator",
  "Blockchain Immutable Custody Hash",
  "Anti-Tamper Medical Report Shield",
  "Mobile App for Court Production Updates",
  "Jurisdictional Court Matcher",
  "Multi-Lingual Interrogation Translator",
  "Historical Remand Success Rate Analyzer",
  "Custody Procedure SOP Trainer",
  "Remand DB Server Health Monitor",
  "Imminent Expiry/Illegal Detention Alert",
  "Syndicate Custody Intimidation Profiler",
  "High-Profile Accused Classifier",
  "AI Assisted Remand Application Drafter",
  "CCTV/Audio Storage Forecaster",
  "Secure Custody Location Protector",
  "Integration with State Prisons Dept",
  "Citizen/Family Custody Status Portal",
  "Mass Arrest Remand Triage Modeler",
  "Disaster Disrupted Production Tracker",
  "Custody/Diet Expense Budget Tracker",
  "Custom Workflow for Specialized Agency Transfer",
  "AI Driven Information Extraction Predictor",
  "Predictive Need for Narco/Polygraph",
  "Custom Alert Trigger for SP/SSP",
  "Remand Lifecycle Timeline Tracker"
];
...
const RemandMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI REMAND MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI REMAND <span>MONITORING</span></h1>
...
export default RemandMonitoringDetailed;
