...
const aiExperts = [
  "Asset Checkout Request Router Engine AI",
  "Asset Return Auditing Image Classifier Bot",
  "Asset Maintenance Predictive Scheduler Bot",
  "Asset Depreciation Calculator Algorithm",
  "Asset Stock Shortage Warning Alert Bot",
  "Optimal Asset Life Cycle Predictor Engine",
  "Smart Asset Tag (RFID/QR) Linker Bot",
  "Asset Reservation Priority Allocator Bot",
  "Asset Operations Control Command Dashboard",
  "Voice-Command Asset Status Query Bot",
  "Automated Asset Audit Log Report Generator",
  "Cross-Department Asset Transfer Sync Engine",
  "Laptop/Device OS Version Auto-Verify Bot",
  "Suspicious Asset Usage Duration Alert Engine",
  "Asset Return Quality Scoring Assistant AI",
  "Asset Warranty Expiry Automated Tracker Bot",
  "AI Evaluator for Asset Utilization Score %",
  "Audit/Asset Reservation History Log Creator",
  "Data Privacy/User Device Serial Number Masker",
  "Police-Store Department Inventory Database Sync",
  "Store Keeper Asset Issue Mobile App Sync",
  "Cold Case Asset Signature Matcher Linker AI",
  "Senior Officer (ADG Logistics) Briefing Bot",
  "Public Lost Found Office Property Registry",
  "Blockchain Immutable Asset Handover Log Hasher",
  "Anti-Theft Geofenced Asset Tracker Shield",
  "Mobile App for QR Code Asset Checkout Scan",
  "Bluetooth Beacon Asset Location Tracker Bot",
  "Multi-Lingual Asset Description Translator",
  "Historical Asset Demand Seasonality Analyzer",
  "Staff Asset Handling SOP Compliance Auditor",
  "Asset Management Database Health Monitor",
  "Urgent Asset Recall Priority Notification AI",
  "Traffic/Transit Asset Delivery Fleet Monitor",
  "Security Clearance Verify Bot for Asset Use",
  "VIP Visit Special Equipment Reservation Bot",
  "AI Assisted Post-Return Asset Damage Report",
  "Asset Storage Logistics/Space Allocator Bot",
  "Eco-friendly Asset Disposal Router Optimizer",
  "Integration with Government e-Marketplace (GeM)",
  "Citizen Asset Loss Reporting Helpline Assistant",
  "Extreme Event Asset Stress Modeler Algorithm",
  "Disaster Situation Asset Allocation Planner",
  "Asset Purchase/Repair Budget Cost Tracker AI",
  "Custom Workflow/Approval for Restricted Asset",
  "AI Driven New Asset Technology Predictor AI",
  "Predictive Need for Asset Replacement/Upgrade",
  "Custom Alert Trigger for Logistics Chief"
];
...
const OfficeAssetReservationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ASSET RESERVATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI ASSET RESERVATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in hardware checkout registry, return auditing, maintenance schedulers & depreciation tracker.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ASSET <span>RESERVATION</span></h1>
            <p className="cyber-subtitle">Hardware Checkout Registry, Return Auditing, Maintenance Schedulers & Depreciation Tracker</p>
          </div>
        </div>
      </header>
...
export default OfficeAssetReservationDetailed;
