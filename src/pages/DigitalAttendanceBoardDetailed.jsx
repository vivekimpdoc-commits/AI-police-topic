...
const aiExperts = [
  "Live Duty/Availability Status AI",
  "Geo-Fenced Beat/Patrol Tracker",
  "Smart Roll-Call/Briefing Automator",
  "Officer Availability/ETA Predictor",
  "Court Duty/Summons Cross-Reference Bot",
  "VIP Duty/Deployment Integrator",
  "Geo-Spatial Force Distribution Mapper",
  "Real-Time Absentee/Missing Staff Alert",
  "Attendance Board Dashboard",
  "Voice-Command Staff Status Bot",
  "Automated Daily Roll-Call Report",
  "HRMS/Payroll Sync Bot",
  "Facial Recognition/Biometric Sign-in",
  "Vehicle (GPS) vs Officer Location Correlator",
  "Fake GPS/Spoofing Detector",
  "Leave/Medical Absence Sync AI",
  "AI Evaluator for Beat Coverage",
  "Audit/Attendance Log Generator",
  "Data Privacy/Officer Location Scrubber",
  "State Police Control Room Sync",
  "Officer Geo-Check-in Mobile App",
  "Historical Absenteeism Correlator",
  "SHO/Duty Officer Briefing AI",
  "Dynamic Beat Re-allocator",
  "Blockchain Immutable Attendance Hash",
  "Anti-Tamper Location Record Shield",
  "Mobile App for Supervisory Dashboard",
  "Police Station-wise Discipline Benchmarker",
  "Automated Reminder for Missed Check-ins",
  "Historical Punctuality Trend Analyzer",
  "Attendance/Beat SOP Trainer",
  "Biometric Server Health Monitor",
  "Imminent Area Uncovered Alert",
  "Habitual Latecomer Profiler",
  "Critical/Armed Duty Classifier",
  "AI Assisted Absentee Notice Drafter",
  "Location Data Storage Forecaster",
  "Secure Officer Identity Protector",
  "Integration with Dial 112 Dispatch",
  "Citizen Facing Police Station Display Sync",
  "Election Booth Deployment Modeler",
  "Disaster Emergency Roll-Call Coordinator",
  "Biometric Infrastructure Budget Tracker",
  "Custom Workflow for Special Duty Assignment",
  "AI Driven Response Time Predictor",
  "Predictive Need for Force Augmentation",
  "Custom Alert Trigger for SP/SSP",
  "Daily Officer Duty Lifecycle Tracker"
];
...
const DigitalAttendanceBoardDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DIGITAL ATTENDANCE BOARD
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DIGITAL ATTENDANCE <span>BOARD</span></h1>
...
export default DigitalAttendanceBoardDetailed;
