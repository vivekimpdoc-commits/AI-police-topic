...
const aiExperts = [
  "SOP Compliance Checklist Engine",
  "Legal Loophole Identifier AI",
  "Chain of Custody Audit Bot",
  "Charge-sheet Completeness Scorer",
  "Witness Statement Contradiction Finder",
  "Forensic Request Delay Tracker",
  "Arrest Procedure Validation Bot",
  "Bail Rejection Probability Scorer",
  "Quality Review Dashboard",
  "Voice-Command Quality Query Bot",
  "Automated Case Defect Report Gen",
  "Supervisory Officer Alert Coordinator",
  "Time-Limit/Statute of Limitations Tracker",
  "Cyber Evidence Handling Validator",
  "Economic Offense Documentation Auditor",
  "Cold Case Defect Resurfacing AI",
  "AI Evaluator for Overall Case Quality",
  "Audit/Review Action Log Generator",
  "Data Privacy/Reviewer Anonymizer",
  "CCTNS Case File Sync Bot",
  "Field IO Rectification Task App",
  "Cold Case Quality Revamp Engine",
  "Senior Officer (SSP/DIG) Review Briefing",
  "Investigative Training Resource Allocator",
  "Blockchain Immutable Quality Hash",
  "Anti-Tamper Review Feedback Shield",
  "Mobile App for IO Quality Checklist",
  "Jurisdictional Quality Comparison Map",
  "Multi-Lingual Charge-sheet Translator",
  "Historical Case Defect Analyzer",
  "Investigation Quality SOP Trainer AI",
  "Quality Review Rule Engine Monitor",
  "Imminent Statutory Deadline Alert Bot",
  "Organized Crime Case Robustness Profiler",
  "VIP Case Quality Classifier Bot",
  "AI Assisted Defect Rectification Draft",
  "Quality Audit Storage Forecaster",
  "Secure Whistleblower Review Protector",
  "Integration with Prosecution Portal",
  "Citizen Grievance Investigation Auditor",
  "Riot/Mob Case Mass Review Modeler",
  "Disaster Fraud Case Quality Coordinator",
  "Quality Audit Operations Tracker",
  "Custom Workflow for Final Charge-sheet",
  "AI Driven Acquittal Risk Predictor",
  "Predictive Need for Specialized IOs",
  "Custom Alert Trigger for Supervisory Leads",
  "Quality Improvement Timeline Tracker"
];
...
const InvestigationQualityDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INVESTIGATION QUALITY REVIEW
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INVESTIGATION QUALITY <span>REVIEW</span></h1>
...
export default InvestigationQualityDetailed;
