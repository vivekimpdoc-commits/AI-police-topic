...
const aiExperts = [
  "Workload Balancing/Routing Algorithm",
  "Backlog/Pendency Predictor AI",
  "Automated Case/Test Prioritization Engine",
  "Reagent/Staff Constraint Modeler",
  "Turnaround Time (TAT) vs Capacity Analyzer",
  "Inter-Division (DNA/Cyber/Tox) Load Balancer",
  "Geo-Spatial Regional FSL Load Mapper",
  "Urgent/Court-Mandated Rush Order Manager",
  "Laboratory Capacity Dashboard",
  "Voice-Command Pendency Query Bot",
  "Automated Monthly Backlog Audit Report",
  "State Police Headquarters (PHQ) Sync",
  "Imminent Division Chokepoint/Collapse Predictor",
  "Reagent/Consumable Exhaustion Alert",
  "Expert/Analyst Burnout/Fatigue Scorer",
  "Unbalanced Distribution (Regional FSL) Flagging AI",
  "AI Evaluator for Lab Efficiency Index",
  "Audit/Workload Log Generator",
  "Data Privacy/Case Detail Scrubber",
  "Directorate of Prosecution Sync",
  "FSL Division Head/Analyst App",
  "Historical Backlog-to-Acquittal Correlator",
  "FSL Director/ADG Briefing AI",
  "Case Re-Assignment/Routing Allocator",
  "Blockchain Immutable Pendency Hash",
  "Anti-Tamper Workload Report Shield",
  "Mobile App for Quick Status Update",
  "Division-wise Efficiency/Output Benchmarker",
  "Automated Alert for Over 1-Year Pending Cases",
  "Historical Overtime/Reagent Cost Analyzer",
  "Workload Management/Triage SOP Trainer",
  "LIMS (Laboratory Information Management System) API Monitor",
  "Imminent Court Contempt (Due to Delay) Alert",
  "Low-Output/Slow Analyst Profiler",
  "High-Priority (Fast-Track Court) Case Classifier",
  "AI Assisted Resource Augmentation Proposal Drafter",
  "Pendency/Backlog Clearance Forecaster",
  "Secure Case Priority List Protector",
  "Integration with E-Courts (Next Hearing Date)",
  "HRMS/Leave Portal Sync (for Analysts)",
  "Election (Ballot/EVM) Fast-Track Testing Modeler",
  "Disaster (Mass Casualty) Rapid ID Coordinator",
  "Laboratory Consumables/Overtime Budget Tracker",
  "Custom Workflow for High-Profile/CBI Cases",
  "AI Driven TAT (Turnaround Time) Predictor",
  "Predictive Need for Outsourcing to Private Labs",
  "Custom Alert Trigger for Home Secretary",
  "Sample Receipt to Report Dispatch Timeline"
];
...
const LaboratoryCapacityDashboardDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI LABORATORY CAPACITY DASHBOARD
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI LABORATORY CAPACITY <span>DASHBOARD</span></h1>
...
export default LaboratoryCapacityDashboardDetailed;
