...
const aiExperts = [
  "Extinguisher Pressure/Expiry Tracking AI",
  "Smoke/Heat Detector Health Monitor",
  "Automated Fire/Mock Drill Logger",
  "Fire NOC (No Objection Certificate) Renewal Engine",
  "Evacuation Route Blockage/Obstruction Detector",
  "Sprinkler System Pressure/Pump Validator",
  "Geo-Spatial Fire Asset/Hydrant Mapper",
  "Flammable Material Storage Risk Analyzer",
  "Fire Safety Compliance Dashboard",
  "Voice-Command Safety Query Bot",
  "Automated Quarterly Fire Readiness Report",
  "State Fire Service/Directorate Sync",
  "Missing/Moved Extinguisher Alert AI",
  "False Alarm/Dust Confusion Predictor",
  "Hydrant Dry-Run/Failure Alert",
  "Staff Drill Participation/Knowledge Scorer",
  "AI Evaluator for Building Fire Resilience",
  "Audit/Inspection Log Generator",
  "Data Privacy/Evacuation Roster Scrubber",
  "Estate/Infrastructure Department Sync",
  "Fire Safety Officer Inspection App",
  "Historical Short-Circuit/Fire Event Correlator",
  "SP (Infrastructure) Briefing AI",
  "Refilling/Maintenance Task Allocator",
  "Blockchain Immutable NOC Hash",
  "Anti-Tamper Fire Panel/Log Shield",
  "Mobile App for Spot Hazard Reporting",
  "Facility-wise Fire Readiness Benchmarker",
  "Automated Alert for Overdue Refilling",
  "Historical Fire Safety Budget Analyzer",
  "Evacuation/First-Responder SOP Trainer",
  "Fire Alarm Control Panel (FACP) Monitor",
  "Imminent Fire Hazard (Blockage) Alert",
  "Habitual Safety Violator (Branch) Profiler",
  "High-Risk (Malkhana/Record Room) Zone Classifier",
  "AI Assisted Vendor SLA Penalty Drafter",
  "Compliance/Drill Video Storage Forecaster",
  "Secure Evacuation Blueprint Protector",
  "Integration with Municipal Fire Department",
  "Building Management System (BMS) Sync",
  "Election EVM Strongroom Fire Safety Modeler",
  "Disaster Post-Earthquake Fire Risk Coordinator",
  "Fire Equipment Maintenance Budget Tracker",
  "Custom Workflow for Structural Fire Upgrades",
  "AI Driven Refill/Replacement Predictor",
  "Predictive Need for Advanced Suppression (Gas-Based)",
  "Custom Alert Trigger for DGP/ADG Admin",
  "Hazard Detection to Elimination Timeline"
];
...
const FireSafetyComplianceDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI FIRE SAFETY COMPLIANCE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI FIRE SAFETY <span>COMPLIANCE</span></h1>
...
export default FireSafetyComplianceDetailed;
