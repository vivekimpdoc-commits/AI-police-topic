...
const aiExperts = [
  "Poison Detection GC-MS/LC-MS Analyzer AI",
  "Drug Screening Panel Automation Bot",
  "Blood Alcohol Content (BAC) Calculator AI",
  "Viscera Sample Preservation Protocol Bot",
  "Pesticide/Insecticide Detection Engine AI",
  "Narcotic Substance Identification Bot",
  "Post-Mortem Toxicology Report Generator",
  "Chronic Poisoning Pattern Detector AI",
  "Toxicology Case Command Dashboard",
  "Voice-Command Tox Result Query Bot",
  "Automated Tox Report Draft Generator AI",
  "Cross-Lab Tox Database Sync Engine",
  "Heavy Metal (Arsenic/Lead) Detector AI",
  "Synthetic Drug (Fentanyl) Alert Engine",
  "Sample Degradation/Shelf-Life Monitor Bot",
  "Drug Interaction/Polypharmacy Analyzer AI",
  "AI Evaluator for Tox Detection Accuracy",
  "Audit/Sample Chain-of-Custody Log Gen",
  "Data Privacy/Victim Tox Data Masker AI",
  "Police-FSL Toxicology Division Sync Bot",
  "IO Viscera Submission Protocol Mobile App",
  "Cold Case Poisoning Re-Analysis Queue AI",
  "Senior Officer (Tox Division Head) Briefing",
  "Public Anti-Drug Awareness Data Portal",
  "Blockchain Immutable Tox Result Record",
  "Anti-Contamination Lab Protocol Bot",
  "Mobile App for IO Sample Collection Guide",
  "New Psychoactive Substance (NPS) Library",
  "Multi-Lingual Tox Report Translator Bot",
  "Historical Serial Poisoning Case Matcher",
  "Staff Toxicologist Competency Tracker AI",
  "GC-MS/LC-MS Machine Health Monitor Bot",
  "Urgent Poisoning Emergency Priority Queue",
  "Traffic Drunk-Driving BAC Fast-Track AI",
  "Suicide/Overdose Substance Identifier Bot",
  "VIP Food Tasting Security Tox Check AI",
  "AI Assisted Post-Report Court Testimony Aid",
  "Tox Lab Reagent/Standard Expiry Tracker",
  "Environmental Toxin (Water/Soil) Analyzer",
  "Integration with Poison Info Center (PIC)",
  "Citizen Poison Helpline Data Linker AI",
  "Extreme Decomposed Sample Recovery AI",
  "Disaster Chemical Spill Mass Screening AI",
  "Toxicology Lab Budget/Expense Tracker",
  "Custom Workflow/Approval for Re-Testing",
  "AI Driven Emerging Drug Trend Predictor",
  "Predictive Need for New Detection Method",
  "Custom Alert Trigger for Tox Lab Chief"
];
...
const ToxicologyCaseManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI TOXICOLOGY CASE MANAGEMENT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI TOXICOLOGY CASE MANAGEMENT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in poison detection, drug screening, blood alcohol analysis & viscera reports.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI TOXICOLOGY CASE <span>MANAGEMENT</span></h1>
            <p className="cyber-subtitle">Poison Detection, Drug Screening, Blood Alcohol Analysis & Viscera Reports</p>
          </div>
        </div>
      </header>
...
export default ToxicologyCaseManagementDetailed;
