...
const aiExperts = [
  "Ground-Level Feedback Sentiment AI",
  "Contradiction/Conflict Detector Bot",
  "Compliance/Action Taken Tracker",
  "Effectiveness/Impact Scoring Engine",
  "Implementation Bottleneck Mapper",
  "Read-Receipt/Acknowledgment Tracker",
  "Geo-Spatial Compliance Heatmapper",
  "Key Influencer/Adopter Identifier",
  "Circular Impact Dashboard",
  "Voice-Command Compliance Query Bot",
  "Automated Quarterly Effectiveness Report",
  "Field Unit/Thana Sync Bot",
  "Multi-Lingual Feedback Translation",
  "Vague/Ambiguous Clause Highlighting AI",
  "Resistance/Reluctance Predictor",
  "Summary/Abstract Generator",
  "AI Evaluator for Policy Clarity",
  "Audit/Feedback Log Generator",
  "Data Privacy/Anonymization Engine",
  "Training Department Sync",
  "Officer Feedback/Reporting App",
  "Historical Circular Success Correlator",
  "IG/ADG Administration Briefing AI",
  "Remedial Training/Action Allocator",
  "Blockchain Immutable Compliance Hash",
  "Anti-Tamper Feedback Shield",
  ...
  "Circular/Directive SOP Trainer",
  "Analytics Server Health Monitor",
  "Imminent Implementation Failure Alert",
  "Habitual Defaulter Unit Profiler",
  "High-Impact/Critical Circular Classifier",
  "AI Assisted Corrigendum Drafter",
  "Analytics Data Storage Forecaster",
  "Secure Internal Feedback Protector",
  "Integration with HRMS Appraisals",
  "Citizen Feedback Loop Sync",
  "Election Guideline Compliance Modeler",
  "Disaster SOP Effectiveness Coordinator",
  "Training/Sensitization Budget Tracker",
  "Custom Workflow for Sensitive Circulars",
  "AI Driven Resistance Predictor",
  "Predictive Need for Video Conference Briefing",
  "Custom Alert Trigger for DGP",
  "Circular Implementation Timeline Tracker"
];
...
const CircularImpactAnalyzerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CIRCULAR IMPACT ANALYZER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CIRCULAR IMPACT <span>ANALYZER</span></h1>
...
export default CircularImpactAnalyzerDetailed;
