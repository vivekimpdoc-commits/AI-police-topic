...
const aiExperts = [
"MCC (Model Code) Violation Complaint Router",
  "Social Media Hate Speech/Communal Post AI",
  "Unauthorized Political Rally/Procession Alert",
  "Illegal Banner/Poster/Hoarding Removal Tracker",
  "Defacement of Public Property Geo-Mapper",
  "Loudspeaker/Noise Limit Violation Monitor",
  "Fake News/Deepfake Audio Detector Bot",
  "Unapproved Political Advertisement Flagging",
  "Command Center MCC Monitoring Dashboard",
  "Voice-Command Violation Query Assistant",
  "Automated Notice/Show-Cause Generator AI",
  "Inter-Department (Municipal/Police) Sync",
  "VIP/Star Campaigner Speech Sentiment Analyzer",
  "Religious Places Used for Campaign Flagging",
  "Caste/Religion based Vote Appeal Detector",
  "cVIGIL App Integration & Auto-Classification",
  "AI Evaluator for Violation Resolution Speed",
  "Audit/FIR Log for MCC Breach Generator",
  "Data Privacy/Complainant Identity Masker",
  "Police-Returning Officer Joint Action Sync",
  "Government Vehicle/Machinery Misuse Alert",
  "New Scheme/Project Inauguration Blockage AI",
  "Senior Officer (General Observer) Briefing",
  "Public Awareness Broadcast Drafter AI",
  "Blockchain Immutable Log of MCC Actions",
  "Drone Aerial Scan for Illegal Banners AI",
  "Mobile App for Video Surveillance Team (VST)",
  "Printing Press/Pamphlet Publisher Verification",
  "Multi-Lingual Hate Speech Translation Bot",
  "Historical MCC Violation Precedent Matcher",
  "Medical Camp/Charity used for Bribery Check",
  "VST/MCC Squad Fatigue Monitor AI",
  "Temporary Checkpost for Pamphlet Seizure",
  "Traffic/Rally Route Clash Deconfliction",
  "Shadow Zone Rally Monitoring Sync Engine",
  "Armed Guarding for Banner Removal Teams",
  "AI Assisted Post-Violation Report Drafter",
  "Video Storage/Cloud Capacity Alert Bot",
  "VIP Helicopter Landing Pad MCC Check AI",
  "Integration with ECI cVIGIL/Suvidha Portal",
  "Citizen Anonymous WhatsApp Complaint Sync",
  "Night-Time Campaigning/Curfew Monitor Bot",
  "Post-Election Banner Removal/Cleanup Sync",
  "MCC Enforcement Logistics Expense Tracker",
  "Custom Workflow/Approval for Case Filing",
  "AI Driven Riot/Clash Escalation Predictor",
...
const MCCMonitoringSupportDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI MCC MONITORING SUPPORT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI MCC MONITORING SUPPORT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in social media scanning, illegal rallies, hate speech & banner removal.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI MCC MONITORING <span>SUPPORT</span></h1>
            <p className="cyber-subtitle">Social Media Scanning, Illegal Rallies, Hate Speech & Banner Removal</p>
          </div>
        </div>
      </header>
...
export default MCCMonitoringSupportDetailed;
