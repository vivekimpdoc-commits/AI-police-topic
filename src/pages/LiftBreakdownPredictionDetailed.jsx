...
const aiExperts = [
  "Motor/Sheave Vibration Analysis AI",
  "Door Jam/Sensor Failure Predictor",
  "Usage Frequency/Traffic Heatmapper",
  "AMC Vendor SLA/Accountability Tracker",
  "Cable/Rope Tension Anomaly Detector",
  "Overload/Capacity Breach Alert",
  "Geo-Spatial Elevator Network Mapper",
  "Floor Wait Time/Congestion Optimizer",
  "Elevator Health Dashboard",
  "Voice-Command Lift Status Bot",
  "Automated Monthly Lift Safety Report",
  "Building Management System (BMS) Sync",
  "Mid-Floor Entrapment Risk Predictor",
  "Uneven Leveling/Trip Hazard Alert",
  "Brake Pad Wear/Tear Scorer",
  "Power Fluctuation Impact Analyzer",
  "AI Evaluator for Vertical Mobility Safety",
  "Audit/Maintenance Log Generator",
  "Data Privacy/VIP Movement Scrubber",
  "Estate/Infrastructure Department Sync",
  "Elevator Technician Mobile App",
  "Historical Breakdown/Entrapment Correlator",
  "Chief Security Officer Briefing AI",
  "Servicing/Rescue Task Allocator",
  "Blockchain Immutable Maintenance Hash",
  "Anti-Tamper Lift Controller Shield",
  "Mobile App for Emergency Intercom/SOS",
  "Lift-wise Uptime/Reliability Benchmarker",
  "Automated Alert for Passenger Entrapment",
  "Historical AMC/Repair Cost Analyzer",
  "Elevator Rescue/Safety SOP Trainer",
  "IoT Vibration/Load Sensor Health Monitor",
  "Imminent Free-Fall/Catastrophic Failure Alert",
  "Substandard AMC Vendor Profiler",
  "High-Traffic (Public/Reception) Lift Classifier",
  "AI Assisted Vendor Penalty Drafter",
  "Component Lifespan Forecaster",
  "Secure Elevator Control Network Protector",
  "Integration with State Lift Inspectorate",
  "Fire Alarm/Emergency Evacuation Sync",
  "Election Command Center VIP Movement Modeler",
  "Disaster Evacuation Override Coordinator",
  "Elevator AMC/Modernization Budget Tracker",
  "Custom Workflow for VIP/DGP Exclusive Lift",
  "AI Driven Part Replacement Predictor",
  "Predictive Need for Complete Lift Replacement",
  "Custom Alert Trigger for SP Admin",
  "Entrapment to Rescue Timeline"
];
...
const LiftBreakdownPredictionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI LIFT BREAKDOWN PREDICTION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI LIFT BREAKDOWN <span>PREDICTION</span></h1>
...
export default LiftBreakdownPredictionDetailed;
