...
const aiExperts = [
  "AR Raid Simulation Scenario Builder AI",
  "Live Facial Recognition Overlay Engine",
  "Crowd Control/Riot Drill AR Simulator",
  "AR Crime Scene Walkthrough Trainer",
  "AR Weapon Handling Safety Simulator",
  "AR Building Entry/Hostage Scenario Bot",
  "AR Evidence Collection Guidance Overlay",
  "AR First-Aid/Triage Training Module",
  "AR Training Command Dashboard",
  "Voice-Command AR Session Controller",
  "Automated AR Performance Scorer AI",
  "Cross-Unit AR Multi-Player Training Sync",
  "HoloLens/Magic Leap Fleet Manager AI",
  "AR Night-Vision Tactical Overlay Bot",
  "AR Navigation Overlay for Patrol Routes",
  "AR Forensic Fingerprint Lift Trainer",
  "AI Evaluator for AR Trainee Scores",
  "Audit/AR Session Log Auto-Generator",
  "Data Privacy/Suspect Face AR Blur AI",
  "Police Academy AR Curriculum Sync",
  "AR Cyber Crime Lab Virtual Tour",
  "AR Financial Crime Document Inspector",
  "Senior Officer (Training IG) Briefing",
  "Public Awareness AR Demo for Schools",
  "AR Evidence Chain Visualization Engine",
  "AR Device Battery/Overheating Monitor AI",
  "Mobile AR Lite Mode for Smartphones",
  "Satellite Image AR Terrain Overlay",
  "Multi-Lingual AR Instruction Translator",
  "Historical Case AR Reconstruction Bot",
  "Staff AR Competency Assessment Engine",
  "AR Hardware Maintenance/Repair Tracker",
  "Temporary Naka AR Setup Guide Bot",
  "Traffic AR HUD for Patrol Officers",
  "Accident Scene AR Reconstruction AI",
  "Biometric AR Identification Overlay Bot",
  "AI Assisted Post-Training AR Report Gen",
  "AR Content Version/Update Manager AI",
  "VIP Security AR Threat Overlay Bot",
  "Integration with Police Training Academy (PTA)",
  "Citizen AR Safety Awareness App Bot",
  "Extreme Conditions (Heat/Rain) AR Adapter",
  "Disaster Drill AR Mass Casualty Scenario",
  "AR Training Budget/Procurement Tracker",
  "Custom Workflow/Approval for AR Curriculum",
  "AI Driven AR Training Gap Predictor",
  "Predictive Need for AR Content Update",
  "Custom Alert Trigger for Training Commandant"
];
...
const AugmentedRealityTrainingDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI AUGMENTED REALITY TRAINING
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI AUGMENTED REALITY TRAINING</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in ar headsets for raids, crowd control simulations & live face recognition overlay.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI AUGMENTED REALITY <span>TRAINING</span></h1>
            <p className="cyber-subtitle">AR Headsets for Raids, Crowd Control Simulations & Live Face Recognition Overlay</p>
          </div>
        </div>
      </header>
...
export default AugmentedRealityTrainingDetailed;
