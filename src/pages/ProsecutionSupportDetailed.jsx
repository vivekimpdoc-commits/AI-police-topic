...
const aiExperts = [
  "Cross-Examination Question Generator AI",
  "Evidence/Chain of Custody Linker",
  "Hostile Witness Probability Scorer",
  "Deposition Contradiction Detector",
  "Trial Strategy/Precedent Matcher",
  "Defense Argument Predictor Bot",
  "Digital Evidence Presentation Organizer",
  "Expert Testimony Correlator AI",
  "Prosecution Support Dashboard",
  "Voice-Command Evidence Query Bot",
  "Automated Trial Readiness Report",
  "Police-Prosecutor Sync Bot",
  "Forensic Report NLP Summarizer",
  "Witness Credibility/Background Analyzer",
  "Similar Acquittal Pattern Matcher",
  "Bail Objection Point Extractor",
  "AI Evaluator for Case Strength",
  "Audit/Evidence Review Log Gen",
  "Data Privacy/Informant Scrubber",
  "State Advocate General Sync Bot",
  "Prosecutor Mobile Prep App",
  "Cold Case Evidence Re-evaluation AI",
  "Director of Prosecution Briefing",
  "Special Public Prosecutor Allocator",
  "Blockchain Immutable Evidence Hash",
  "Anti-Tamper Prosecution Strategy Shield",
  "Mobile App for Trial Updates",
  "Jurisdiction Precedent Matcher AI",
  "Multi-Lingual Deposition Translator",
  "Historical Trial Success Analyzer",
  "Prosecution SOP/Guideline Trainer",
  "Support DB Server Health Monitor",
  "Imminent Witness Tampering Alert Bot",
  "Syndicate Intimidation Profiler",
  "High-Profile VIP Trial Classifier",
  "AI Assisted Final Argument Drafter",
  "Trial Video/Audio Storage Forecaster",
  "Secure Victim Identity Protector",
  "Integration with FSL/Forensic DB",
  "Citizen Trial Transparency Analytics",
  "Mass Trial/Riot Case Strategy Modeler",
  "Disaster Trial Delay Coordinator",
  "Prosecution Ops Budget Tracker",
  "Custom Workflow for Appeal Approval",
  "AI Driven Trial Duration Predictor",
  "Predictive Need for Additional Evidence",
  "Custom Alert Trigger for Lead Prosecutors",
  "Prosecution Trial Phase Tracker"
];
...
const ProsecutionSupportDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI PROSECUTION SUPPORT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI PROSECUTION <span>SUPPORT</span></h1>
...
export default ProsecutionSupportDetailed;
