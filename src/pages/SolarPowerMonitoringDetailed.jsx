...
const aiExperts = [
  "Panel Efficiency/Output Optimizer AI",
  "Dust/Soiling Accumulation Alert Bot",
  "Grid-Tie (Net Metering) Sync Engine",
  "Carbon Footprint/Green Energy Scorer",
  "Inverter Health/Fault Predictor",
  "Shadow/Obstruction Tracking AI",
  "Geo-Spatial Rooftop Solar Mapper",
  "Battery Bank/Storage Degradation Analyzer",
  "Solar Power Dashboard",
  "Voice-Command Energy Query Bot",
  "Automated Monthly ROI/Savings Report",
  "State Renewable Energy Agency Sync",
  "Weather/Cloud Cover Output Predictor",
  "Thermal Scan for Hotspot/Damaged Cells",
  "Fake AMC/Cleaning Visit Detector",
  "Energy Trading/Excess Power Sales AI",
  "AI Evaluator for Green Police Station Rating",
  "Audit/Maintenance Log Generator",
  "Data Privacy/Energy Usage Scrubber",
  "State Electricity Board Sync",
  "Maintenance/Cleaning Staff App",
  "Historical Output vs Weather Correlator",
  "Estate/Finance Officer Briefing AI",
  "Vendor/Cleaning Task Allocator",
  "Blockchain Immutable Energy Hash",
  "Anti-Tamper Net-Metering Shield",
  "Mobile App for Live Output Tracking",
  "District-wise Green Energy Benchmarker",
  "Automated Reminder for Panel Washing",
  "Historical CAPEX ROI Analyzer",
  "Green Energy Maintenance SOP Trainer",
  "IoT Inverter Gateway Monitor",
  "Imminent Inverter Failure/Fire Alert",
  "Substandard Panel/Vendor Profiler",
  "Off-Grid/Remote Station Classifier",
  "AI Assisted Solar Expansion Drafter",
  "Telemetry/Output Data Storage Forecaster",
  "Secure Smart Grid Blueprint Protector",
  "Integration with National Solar Mission Portals",
  "Citizen Transparency on Police Green Energy",
  "Cyclone/Hailstorm Damage Modeler",
  "Disaster Island-Mode (Off-Grid) Coordinator",
  "Solar CAPEX/AMC Budget Tracker",
  "Custom Workflow for Battery Replacement",
  "AI Driven Panel Degradation Predictor",
  "Predictive Need for Capacity Expansion",
  "Custom Alert Trigger for Nodal Officer",
  "Solar Asset Lifecycle Timeline Tracker"
];
...
const SolarPowerMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SOLAR POWER MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SOLAR POWER <span>MONITORING</span></h1>
...
export default SolarPowerMonitoringDetailed;
