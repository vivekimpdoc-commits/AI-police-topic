...
const aiExperts = [
  "Predictive Repair Costing Engine AI",
  "AMC (Annual Maintenance) SLA Tracker",
  "Renovation/Repair Prioritization Scorer",
  "PWD (Public Works Dept) Estimation Sync",
  "Material Cost/Inflation Impact Analyzer",
  "Lifecycle Degradation/Depreciation Bot",
  "Geo-Spatial Police Estate/Condition Mapper",
  "Emergency Repair Fund Allocator",
  "Maintenance Budget Dashboard",
  "Voice-Command Estate Query Bot",
  "Automated Quarterly CAPEX/OPEX Report",
  "State Police Housing Corporation Sync",
  "Historical Contractor Cost-Overrun Detector",
  "Substandard Material/Early Failure AI",
  "Fake/Inflated Tender Estimate Identifier",
  "Preventive vs Reactive Cost Correlator",
  "AI Evaluator for Estate ROI",
  "Audit/Tender Log Generator",
  "Data Privacy/Blueprint Scrubber",
  "Finance/Accounts Sync",
  "Estate Officer Inspection Mobile App",
  "Historical Monsoon/Disaster Damage Correlator",
  "IG (Provisioning & Estate) Briefing AI",
  "Vendor/Contractor Task Allocator",
  "Blockchain Immutable Maintenance Hash",
  "Anti-Tamper Tender Shield",
  "Mobile App for Quick Repair Indent",
  "District-wise Infrastructure Health Benchmarker",
  "Automated Reminder for AMC Renewal",
  "Historical Maintenance Expenditure Analyzer",
  "Estate Management/Financial Power SOP Trainer",
  "Estate DB Server Health Monitor",
  "Imminent Fund Lapse (Financial Year End) Alert",
  "Corrupt Contractor/Cartel Profiler",
  "High-Priority (Armory/Server Room) Classifier",
  "AI Assisted Budget Enhancement Drafter",
  "Tender/Blueprint Storage Forecaster",
  "Secure Armory/Jail Layout Protector",
  "Integration with E-Tendering Portal",
  "Welfare/Housing Portal Sync",
  "Election Infrastructure Upgrade Modeler",
  "Disaster Rebuilding Cost Coordinator",
  "Civil Works/Maintenance Budget Tracker",
  "Custom Workflow for Emergency Structural Shoring",
  "AI Driven Next-Year Budget Predictor",
  "Predictive Need for New Construction",
  "Custom Alert Trigger for DGP (Estate)",
  "Building Financial Lifecycle Timeline Tracker"
];
...
const BuildingMaintenanceBudgetDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI BUILDING MAINTENANCE BUDGET
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI BUILDING MAINTENANCE <span>BUDGET</span></h1>
...
export default BuildingMaintenanceBudgetDetailed;
