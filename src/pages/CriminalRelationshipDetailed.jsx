...
const aiExperts = [
  "Gang Hierarchy Visualizer AI",
  "Telecom Call Detail Record (CDR) Linker",
  "Social Media Connection Mapper",
  "Financial Transaction Network AI",
  "Prison/Jail Contact Correlator",
  "Family/Associate Tree Generator",
  "Modus Operandi (MO) Syndicate Matcher",
  "Rival Gang Conflict Predictor AI",
  "Relationship Mapping Dashboard",
  "Voice-Command Network Query Bot",
  "Automated Syndicate Structure Report",
  "Cross-District Gang Link Coordinator",
  "Geo-Spatial Meetup Predictor AI",
  "Covert Communication Channel Detector",
  "Key Influencer/Kingpin Identifier",
  "Money Laundering Route Mapper AI",
  "AI Evaluator for Network Fragility",
  "Audit/Network Query Log Generator",
  "Data Privacy/Innocent Associate Scrubber",
  "National Gang Database Sync Bot",
  "Field Patrol Gang Watch App",
  "Cold Case Network Re-evaluation AI",
  "Senior Officer Syndicate Briefing",
  "Asset Seizure Target Optimizer",
  "Blockchain Immutable Network Hash",
  "Anti-Tamper Network Profile Shield",
  "Mobile App for Network Map View",
  "Cell Tower Co-location Matcher AI",
  "Multi-Lingual Gang Slang Translator",
  "Historical Gang Evolution Analyzer",
  "Gang Investigation SOP Trainer AI",
  "Network Graph DB Server Monitor",
  "Imminent Gang War Alert Bot",
  "Organized Crime Operations Profiler",
  "VIP Threat Syndicate Classifier",
  "AI Assisted Syndicate Takedown Draft",
  "Network Graph Storage Forecaster",
  "Secure Informant Link Validator",
  "Integration with Interpol Red Notices",
  "Citizen Gang Activity Reporting Analyzer",
  "Riot/Mob Instigator Network Modeler",
  "Disaster Looting Syndicate Coordinator",
  "Syndicate Operations Revenue Tracker",
  "Custom Workflow for Target Approvals",
  "AI Driven New Gang Alliance Predictor",
  "Predictive Need for Task Force Deployment",
  "Custom Alert Trigger for Anti-Gang Unit",
  "Network Evolution Timeline Tracker"
];
...
const CriminalRelationshipDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CRIMINAL RELATIONSHIP
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CRIMINAL <span>RELATIONSHIP</span></h1>
...
export default CriminalRelationshipDetailed;
