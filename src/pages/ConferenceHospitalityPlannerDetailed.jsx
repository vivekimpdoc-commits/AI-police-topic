...
const aiExperts = [
  "Dynamic Headcount/Catering Predictor",
  "Tea/Coffee Break Synchronization AI",
  "Special Diet (Vegan/Diabetic) Aggregator",
  "External Vendor/Caterer Coordinator Bot",
  "Table Seating & Protocol Arrangement AI",
  "Menu Cost vs Budget Optimizer",
  "Geo-Spatial Conference Hall/Dining Mapper",
  "Food Wastage/Excess Predictor",
  "Conference Hospitality Dashboard",
  "Voice-Command Menu Query Bot",
  "Automated Post-Conference Hospitality Report",
  "Logistics/Estate Department Sync",
  "Last-Minute RSVP/Change Adapter",
  "Water/Beverage Depletion Alert",
  "Vendor Delay/No-Show Predictor",
  "Menu Repetition/Variety Analyzer",
  "AI Evaluator for Delegate Satisfaction",
  "Audit/Catering Expense Log Generator",
  "Data Privacy/Delegate Profile Scrubber",
  "Finance/Accounts Department Sync",
  "Hospitality Manager Mobile App",
  "Historical Conference Consumption Correlator",
  "Event Nodal Officer Briefing AI",
  "Wait-Staff/Usher Task Allocator",
  "Blockchain Immutable Vendor Invoice Hash",
  "Anti-Tamper Delegate Feedback Shield",
  "Mobile App for Live Catering Updates",
  "Vendor-wise Quality Benchmarker",
  "Automated Reminder for Vendor Setup",
  "Historical Event Cost-Per-Head Analyzer",
  "Event Hospitality/Etiquette SOP Trainer",
  "Conference Hall Utility Health Monitor",
  "Imminent Food Shortage (During Break) Alert",
  "Substandard Caterer/Vendor Profiler",
  "High-Profile (DGP/CM level) Event Classifier",
  "AI Assisted Vendor Penalty Drafter",
  "Event Analytics Storage Forecaster",
  "Secure VIP Delegate List Protector",
  "Integration with State Guest Houses",
  "Tender/Empanelment Portal Sync",
  "Election Briefing (Mass Headcount) Modeler",
  "Disaster Response Briefing Coordinator",
  "Event/Conference Budget Tracker",
  "Custom Workflow for Multi-Day Seminars",
  "AI Driven Food Consumption Predictor",
  "Predictive Need for Menu Modification",
  "Custom Alert Trigger for Event Commander",
  "Event Setup to Wrap-up Timeline Tracker"
];
...
const ConferenceHospitalityPlannerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CONFERENCE HOSPITALITY PLANNER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CONFERENCE HOSPITALITY <span>PLANNER</span></h1>
...
export default ConferenceHospitalityPlannerDetailed;
