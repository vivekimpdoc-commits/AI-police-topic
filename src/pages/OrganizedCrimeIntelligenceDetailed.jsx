...
const aiExperts = [
"Mafia/Syndicate Hierarchical Structure Mapper",
  "Illicit Financial Flow/Hawala Tracker AI",
  "Shell Company/Benami Asset Link Analyzer",
  "Money Laundering/PMLA Trigger Predictor",
  "Extortion/Protection Racket Modeler Bot",
  "Narco-Terrorism/Drug Cartel Sync AI",
  "Illegal Sand/Mining Mafia Operations Tracker",
  "Land Grab/Real Estate Syndicate Analyzer",
  "Human Trafficking/Prostitution Ring Modeler",
  "Cyber-Crime Syndicate (Jamtara style) Tracker",
  "Arms Smuggling/Gun-Running Network AI",
  "Counterfeit Currency/Fake Note Ring Bot",
  "Tender/Contract Fixing Syndicate Analyzer",
  "Liquor/Excise Mafia Interstate Linker AI",
  "Wildlife/Poaching Organized Network Tracker",
  "Organized Beggary/Child Labor Ring Bot",
  "Command Center Real-time Syndicate Dashboard",
  "Voice-Command Mafia Dossier Query Assistant",
  "Automated Link Analysis/Graph Visualization AI",
  "Telecom/CDR (Call Record) Node Mapper Bot",
  "Financial/Bank Statement Bulk Analyzer AI",
  "Crypto-Currency/Dark Web Transaction Tracker",
  "Social Media Extortion/Threat Profiler Bot",
  "CCTV/Vehicle Movement Syndicate Linker",
  "Historical Case/Acquittal Strategy Modeler",
  "Lawyer/Legal Counsel Network Analyzer",
  "Corrupt Official/Insider Threat Flagging AI",
  "Rival Syndicate Turf War Early Warning Bot",
  "Hitman/Contract Killer Alias & Network AI",
  "Undercover Informant Tip-Off Verifier AI",
  "AI Protocol for Coordinated Multi-State Raids",
  "Inter-Agency (ED/CBI/NIA) Intel Fusion Sync",
  "Blockchain Immutable Log of Syndicate Intel",
  "Mobile App Push-Alert for Task Force IOs",
  "Predictive Leadership Succession Modeler",
  "Syndicate Recruitment/Youth Target Analyzer",
  "Prison/Jail Operations (Don Calling) Predictor",
  "Bail/Parole Syndicate Guarantor Tracker AI",
  "Election/Political Funding Organized Link AI",
  "Media/Press Propaganda by Mafia Modeler",
  "AI Assisted MCOCA/UAPA Charge-Sheet Drafter",
  "Senior Officer (DGP/IG) Executive Briefing",
  "Asset Attachment/Seizure Value Estimator AI",
  "Witness Intimidation/Elimination Risk Bot",
  "AI Evaluator for Syndicate Dismantling ROI",
  "Custom Entity Extraction from Raw Intel AI",
  "Cross-Border/International Interpol Linker",
  "Document Forgery/Fake Passport Ring Bot",
  "Gambling/Betting/IPL Satta Syndicate AI",
  "Extortion Audio/Voice-Print Matcher Bot",
  "AI Driven Decoy/Honeypot Strategy Drafter",
  "Financial Audit/Tax Evasion Parallel Sync",
  "Data Privacy/Encrypted Comms Bypass Modeler",
  "Syndicate Logistics/Transport Fleet Tracker",
  "AI Driven Interrogation Strategy for Kingpins",
  "Predictive Syndicate Retaliation Warning AI"
];
...
const OrganizedCrimeIntelligenceDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ORGANIZED CRIME INTELLIGENCE
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI ORGANIZED CRIME INTELLIGENCE</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in dismantling mafia structures, illicit financial flows & shell companies.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ORGANIZED CRIME <span>INTELLIGENCE</span></h1>
            <p className="cyber-subtitle">Dismantling Mafia Structures, Illicit Financial Flows & Shell Companies</p>
          </div>
        </div>
      </header>
...
export default OrganizedCrimeIntelligenceDetailed;
