...
const aiExperts = [
"Blockchain Immutable Log of Relief Funds",
  "Black-Market/Resale of Relief Material AI",
  "NGO/Corporate CSR Fund Utilization Tracker",
  "Disaster Relief Fund (CM/PM Cares) Auditor",
  "Fake Beneficiary/Ghost Identity Detector",
  "Supplier/Vendor Overpricing Alert Engine",
  "Duplicate Invoice/Billing Fraud Catch Bot",
  "Equitable Distribution Geo-Heatmap AI",
  "Command Center Material Audit Dashboard",
  "Voice-Command Audit Query Assistant",
  "Automated Transparency/Compliance Report Gen",
  "Inter-Agency Financial Sync (Treasury)",
  "Public/Citizen RTI Query Auto-Responder",
  "Donation (Physical Goods) Tally vs Issue AI",
  "Cash/DBT (Direct Benefit Transfer) Tracker",
  "Pilferage/Warehouse Theft Detection AI",
  "AI Evaluator for Procurement ROI/Efficiency",
  "Legal/Court Inquiry Evidence Log Generator",
  "Data Privacy/Beneficiary Financial Masker",
  "Police-Vigilance/Anti-Corruption Sync Bot",
  "Foreign Aid/International Funds Tracker",
  "Logistics/Transport Overbilling Alert AI",
  "Senior Officer (Relief Comm/CAG) Briefing",
  "Public Transparency Portal Data Broadcaster",
  "Smart Contract Execution for Vendor Payment",
  "Barcode/RFID Tracker for High-Value Goods",
  "Mobile App for Field Auditor Sync",
  "Quality Control/Sub-Standard Goods Alert AI",
  "Multi-Lingual Audit Finding Translator",
  "Historical Disaster Scam/Fraud Precedent",
  "Medical/Pharmacy Relief Supply Auditor AI",
  "Auditor/Vigilance Officer Route Modeler",
  "Temporary Camp Relief Distribution Audit",
  "Traffic/Toll Fraud by Relief Trucks Bot",
  "Flood/Earthquake Damage Assessment vs Claims AI",
  "Insurance Claim/Compensation Fraud Detector",
  "AI Assisted Post-Relief Financial Audit",
  "Security Guard Extortion/Bribe Alert AI",
  "Media/Press Audit Data Extractor Bot",
  "Integration with State Finance Dept Portal",
  "Citizen Whistleblower Complaint Router AI",
  "Heatwave/Cooling Center Expense Auditor",
  "Post-Disaster Rehab Seed/Tool Subsidy Tracker",
  "NGO vs Gov Aid Overlap/Duplication AI",
  "Custom Workflow/Approval for Large Payments",
  "AI Driven Fraud Predictive Modeler",
  "Predictive Need for CBI/Vigilance Probe",
  "Custom Alert Trigger for Chief Auditor"
];
...
const ReliefMaterialAuditDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI RELIEF MATERIAL AUDIT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI RELIEF MATERIAL AUDIT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in financial transparency, blockchain logs of funds & preventing black-market sales.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI RELIEF MATERIAL <span>AUDIT</span></h1>
            <p className="cyber-subtitle">Financial Transparency, Blockchain Logs of Funds & Preventing Black-Market Sales</p>
          </div>
        </div>
      </header>
...
export default ReliefMaterialAuditDetailed;
