...
const aiExperts = [
  "Inquiry Case Workflow Auto-Generator AI",
  "Audio Statement Transcription Engine AI",
  "Evidence Collection Timeline Matcher Bot",
  "Inquiry Legal Compliance Check Engine AI",
  "Witness Statement Discrepancy Sorter Bot",
  "Charged Sheet Draft Auto-Generator Bot AI",
  "Hearing Schedule Auto-Conflict Resolver Bot",
  "Inquiry Case Status Escalation Alert Bot",
  "Inquiry Management Control Dashboard Portal",
  "Voice-Command Inquiry Detail Query Bot",
  "Automated inquiry Case Progress Report Gen",
  "Cross-Department Inquiry Database Sync Engine",
  "Witness Attendance Verification QR Code Bot",
  "Suspicious Inquiry Delay Warning Alert Engine",
  "Inquiry Document Plagiarism & Tamper Checker",
  "Legal Notice Auto-Drafting Assistant Bot",
  "AI Evaluator for Inquiry Procedural Score %",
  "Audit/Inquiry File Modify Log Generator Bot",
  "Data Privacy/Witness Aadhaar Masker Engine",
  "Police-HQ Legal Cell Inquiry Database Sync",
  "Inquiry IO Field Helper Mobile App Portal",
  "Cold Case Inquiry Signature Matcher Linker",
  "Senior Officer (DGP HQ Admin) Briefing Bot",
  "Public Absconding Officer Inquiry Status Board",
  "Blockchain Immutable Inquiry Evidence Registry",
  "Anti-Coercion Witness Safety Alert Shield AI",
  "Mobile App for Quick Witness Summons Search",
  "EPABX SIP Call Recorder Linker for Inquiry",
  "Multi-Lingual Inquiry Statement Translator Bot",
  "Historical Inquiry Case Precedent Sorter Bot",
  "Staff Inquiry IO SOP Compliance Trainer AI",
  "Inquiry Server Node Cluster Health Monitor",
  "Urgent Legal Stay/Court Order Priority Alert",
  "Traffic/Transit Convoy Route for Accused Staff",
  "Digital Forensic Inquiry Keyword Searcher Bot",
  "VIP Protection Inquiry Clearances Scheduler",
  "AI Assisted Inquiry Findings Report Draft Bot",
  "Inquiry Case Queue Load Balancer Engine AI",
  "Court Stay Legal Argument Success Predictor",
  "Integration with Integrated Criminal Justice System",
  "Citizen Public Grievance Inquiry Tracker Bot",
  "Extreme Case load Inquiry Sorter Engine AI",
  "Disaster Situation Inquiry Postponement Guide",
  "Inquiry Wing Operations Budget/Cost Tracker",
  "Custom Workflow/Approval for Inquiry Dismissal",
  "AI Driven Emerging Misconduct Trend Predictor",
  "Predictive Need for External Judicial Inquiry",
  "Custom Alert Trigger for Inquiry Nodal Officer"
];
...
const DepartmentalInquiryManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DEPARTMENTAL INQUIRY MANAGEMENT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI DEPARTMENTAL INQUIRY MANAGEMENT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in inquiry case workflows, statement transcription, evidence gathering & legal compliance.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DEPARTMENTAL INQUIRY <span>MANAGEMENT</span></h1>
            <p className="cyber-subtitle">Inquiry Case Workflows, Statement Transcription, Evidence Gathering & Legal Compliance</p>
          </div>
        </div>
      </header>
...
export default DepartmentalInquiryManagementDetailed;
