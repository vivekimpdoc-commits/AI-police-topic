...
const aiExperts = [
  "Live CCTV Facial Extractor AI",
  "Criminal Watchlist/Database Matcher",
  "Crowd Density Face Scanner Engine",
  "Disguise/Mask/Helmet Penetration AI",
  "Multi-Angle/Low-Light Enhancer",
  "Age/Weight Fluctuation Compensator",
  "Border Checkpost/Airport Sync Bot",
  "Real-Time Suspect Alert Broadcaster",
  "FR Command Dashboard",
  "Voice-Command Face Query Bot",
  "Automated Daily Match Report",
  "Inter-District/State Intel Sync",
  "Geo-Spatial Suspect Tracking Mapper",
  "Twin/Lookalike Disambiguation AI",
  "Fake/Morph Image Detector",
  "Video Frame Rate Optimization Bot",
  "AI Evaluator for Match Accuracy (Confidence Score)",
  "Audit/Scan Log Generator",
  "Data Privacy/Non-Target Blur Engine",
  "National Automated Facial Recognition System Sync",
  "Field IO Face Scan App",
  "Historical Sightings Correlator AI",
  "Command Center Briefing Bot",
  "Beat Patrol Interception Allocator",
  "Blockchain Immutable Match Hash",
  "Anti-Tamper Biometric Shield",
  "Mobile App for Beat Cops (Quick Scan)",
  "Jurisdiction/Transit Route Matcher",
  "Multi-Lingual Match Alert Translator",
  "Historical False-Positive Rate Analyzer",
  "Facial Recognition Use SOP Trainer",
  "FR DB/Server Health Monitor",
  "Imminent Absconder Sighting Alert",
  "Terror/Syndicate Member Profiler",
  "VIP/VVIP Threat Recognition Classifier",
  "AI Assisted Arrest Memo Drafter",
  "Video/Biometric Storage Forecaster",
  "Secure Undercover Agent Protector",
  "Integration with Passport/Visa DB",
  "Citizen Missing Person Photo Upload Sync",
  "Riot/Mob Violence Face Extraction Modeler",
  "Disaster Victim Identification Coordinator",
  "FR Software Licensing Budget Tracker",
  "Custom Workflow for Interstate Arrests",
  "AI Driven Movement Predictor",
  "Predictive Need for Rapid Action Force",
  "Custom Alert Trigger for Cyber/Intel SP",
  "Suspect Tracking Timeline Log"
];
...
const FacialRecognitionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI FACIAL RECOGNITION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI FACIAL <span>RECOGNITION</span></h1>
...
export default FacialRecognitionDetailed;
