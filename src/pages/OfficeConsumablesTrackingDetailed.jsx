...
const aiExperts = [
  "Pantry Stock Level Image Classifier AI",
  "Automated Restock Purchase Order Generator",
  "Consumables Usage Audit Sorter Engine AI",
  "Consumables Expiry Predictive Warning Bot",
  "Kitchen Supplies Waste Analyzer Algorithm AI",
  "Optimal Order Quantity Recommender Bot",
  "Smart Inventory Tag (RFID/QR) Matcher",
  "Pantry Priority Resource Allocator Bot",
  "Consumables Operations Control Dashboard",
  "Voice-Command Pantry Status Query Bot",
  "Automated Weekly Consumables Expense Report",
  "Cross-Office Pantry Stock Transfer Sync",
  "Fresh Fruit/Vegetable Quality Grading Bot",
  "Suspicious Consumption Spike Warning Engine",
  "Supplier Delivery Schedule Matcher Bot AI",
  "Refrigerator/Storage Temperature Sync Bot",
  "AI Evaluator for Pantry Cost Efficiency %",
  "Audit/Pantry Issue History Log Generator",
  "Data Privacy/Staff Dining Choice Data Masker",
  "Police-HQ Canteen Supply Database Sync Bot",
  "Pantry In-charge Stock Control Mobile App",
  "Cold Case Supplier Invoice Matcher Linker",
  "Senior Officer (SP HQ Administration) Briefing",
  "Public Canteen Menu/Price Feedback Portal",
  "Blockchain Immutable Supply Handover Registry",
  "Anti-Theft Smart Pantry Security Shield AI",
  "Mobile App for QR Code Pantry Item Scan",
  "Water Dispenser Sensor Filter Health Monitor",
  "Urgent Pantry Supply Shortage Notification",
  "Traffic/Transit Supply Truck Route Planner",
  "Dietary Restriction Menu Recommender Bot",
  "VIP Event Catering Supply Reservation Bot",
  "AI Assisted Post-Event Consumables Report",
  "Pantry Warehouse Space Allocation Optimizer",
  "Eco-friendly Packaging Supplier Matcher Bot",
  "Integration with Government e-Marketplace (GeM)",
  "Citizen Public Canteen Review Voice Assistant",
  "Extreme Event Supply Shortage Modeler Bot",
  "Disaster Relief Camp Rations Sorter Engine",
  "Pantry Operations Maintenance Budget Tracker",
  "Custom Workflow/Approval for Premium Purchases",
  "AI Driven New Consumable Demand Predictor AI",
  "Predictive Need for Bulk Rations Order",
  "Custom Alert Trigger for Pantry Manager"
];
...
const OfficeConsumablesTrackingDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CONSUMABLES TRACKING
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI CONSUMABLES TRACKING</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in kitchen/pantry supplies monitor, automated restock order, usage auditing & cost control.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CONSUMABLES <span>TRACKING</span></h1>
            <p className="cyber-subtitle">Kitchen/Pantry Supplies Monitor, Automated Restock Order, Usage Auditing & Cost Control</p>
          </div>
        </div>
      </header>
...
export default OfficeConsumablesTrackingDetailed;
