...
const aiExperts = [
"Relief Camp Crowd Density & Panic Alert AI",
  "Women/Children Zone Security Enforcer Bot",
  "Food/Ration Distribution Queue Optimizer",
  "Theft/Looting Detection via CCTV/Drone",
  "Missing Person/Child Face Matcher Engine",
  "Camp Access Control/Entry Logging AI",
  "Medical Triage/Quarantine Zone Security",
  "Epidemic/Disease Outbreak Heatmap Bot",
  "Fire/Hazard Alert within Tent-City AI",
  "VIP/Minister Visit Security Escort Mapper",
  "Command Center Shelter Security Dashboard",
  "Voice-Command Camp Incident Query Bot",
  "Automated Guard Shift/Rotation Scheduler",
  "Inter-Agency (NGO/Police) Comm Sync AI",
  "Rumor/Riot Incitement Audio Sentiment Bot",
  "Water/Sanitation Supply Guarding AI",
  "Weapons/Contraband Entry Detection Scanner",
  "Suspect/Known Offender Alert at Entry",
  "Unattended Baggage/IED Threat Alert AI",
  "Lighting/Generator Failure Blackout Alert",
  "AI Evaluator for Shelter Guard Ratio",
  "Incident/FIR Log Generator for Camp Crimes",
  "Data Privacy/Victim Info Masking Protocol",
  "Police-Civil Defence Joint Guarding AI",
  "Evacuee Registration/Aadhar Verification Bot",
  "Food Poisoning/Sabotage Alert Engine",
  "Senior Officer (Camp In-Charge) Briefing Bot",
  "Public Announcement/PA System Drafter AI",
  "Blockchain Immutable Log of Camp Entry",
  "Perimeter Fence/Boundary Breach Detector",
  "Mobile App for Camp Guard SOS Sync",
  "Vulnerable Elderly/Disabled Person Tracker",
  "Multi-Lingual Evacuee Communication Bot",
  "Historical Camp Security Precedent Matcher",
  "Medical Supply/Pharmacy Guarding AI",
  "Guard Fatigue/Stress Monitor AI",
  "Temporary Checkpost/Naka at Camp Gate",
  "Traffic/Parking Management for Relief Trucks",
  "Flood/Storm Re-Evacuation Route Guard AI",
  "Camp Disbandment/Returnee Escort AI",
  "AI Assisted Post-Camp Crime Audit Gen",
  "Security Eqp (Lathi/Shield) Inventory Alert",
  "Media/Press Enclosure Security Allocator",
  "Integration with State Relief Commissioner",
  "Citizen/Evacuee Complaint Router AI",
  "Heatwave/Cooling Center Crowd Modeler",
  "Gender-Segregated Washroom Security Bot",
  "Shelter Expense/Budget Tracker Sync",
  "Custom Workflow/Approval for Entry Pass",
  "AI Driven Camp De-escalation Predictor",
  "Predictive Need for Riot Police Backup",
  "Custom Alert Trigger for Camp Commander"
];
...
const EmergencyShelterSecurityDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI EMERGENCY SHELTER SECURITY
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI EMERGENCY SHELTER SECURITY</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in crowd control, preventing theft/assault & missing persons reunification.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI EMERGENCY SHELTER <span>SECURITY</span></h1>
            <p className="cyber-subtitle">Crowd Control, Preventing Theft/Assault & Missing Persons Reunification</p>
          </div>
        </div>
      </header>
...
export default EmergencyShelterSecurityDetailed;
