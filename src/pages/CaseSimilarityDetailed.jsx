...
const aiExperts = [
  "Historical Case Precedent Searcher",
  "Legal Argument/Strategy Correlator",
  "Charge-sheet Structure Matcher",
  "Judicial Outcome Predictor AI",
  "Bail/Parole Precedent Analyzer",
  "Witness Statement Similarity Scorer",
  "Forensic Evidence Similarity Linker",
  "Conviction Rate Optimization Engine",
  "Case Similarity Dashboard",
  "Voice-Command Similarity Query Bot",
  "Automated Precedent Brief Generator",
  "Cross-State Judgement Sync Bot",
  "Linguistic FIR Similarity Matcher",
  "Cyber Fraud Similarity Clustering AI",
  "Economic Offense Precedent Finder",
  "Cold Case Similarity Resurfacing AI",
  "AI Evaluator for Precedent Relevance",
  "Audit/Similarity Search Log Generator",
  "Data Privacy/Juvenile Name Scrubber",
  "National Judicial Data Grid Sync",
  "Field IO Legal Precedent App",
  "Cold Case Legal Strategy Revamp AI",
  "Public Prosecutor Briefing Bot",
  "Legal Resource Optimization Allocator",
  "Blockchain Immutable Precedent Hash",
  "Anti-Tamper Legal Strategy Shield",
  "Mobile App for IO Similarity Search",
  "Jurisdiction Similarity Geolocation Bot",
  "Multi-Lingual Judgement Translator",
  "Historical Judgement Trend Analyzer",
  "Legal Drafting SOP Trainer AI",
  "Similarity Vector DB Health Monitor",
  "Urgent High-Profile Case Precedent Alert",
  "Organized Crime Legal Strategy Profiler",
  "VIP Case Similarity Classifier Bot",
  "AI Assisted Legal Argument Draft",
  "Vector DB Storage Forecaster",
  "Secure Informant Legal Protection Precedent",
  "Integration with eCourts Portal",
  "Citizen Legal Queries Similarity Analyzer",
  "Riot/Mob Violence Conviction Precedent Modeler",
  "Disaster Fraud Case Precedent Coordinator",
  "Legal Investigation Expense Tracker",
  "Custom Workflow for Prosecutor Approval",
  "AI Driven Defense Strategy Predictor",
  "Predictive Need for Expert Witnesses",
  "Custom Alert Trigger for Legal Leads",
  "Legal Precedent Evolution Tracker"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CASE SIMILARITY
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CASE <span>SIMILARITY</span></h1>
...
export default CaseSimilarityDetailed;
