...
const aiExperts = [
  "OCR/Historical Digitization Engine",
  "Clause/Section Extraction AI",
  "Date of Applicability/Enforcement Tracker",
  "Legal/Act Cross-Referencing Linker",
  "Semantic Search & Tagging AI",
  "Superseded/Amended Notification Alert Bot",
  "Geo-Spatial Jurisdiction/Boundary Mapper",
  "Topic Clustering/Categorization Bot",
  "Gazette Archive Dashboard",
  "Voice-Command Notification Query Bot",
  "Automated Monthly Update Report",
  "State Printing Press/Secretariat Sync",
  "Multi-Lingual Translation (State/English)",
  "Contradiction/Conflict Detector",
  "Fake/Forged Gazette Identifier",
  "Impact Abstract/Summary Generator",
  "AI Evaluator for Legal Applicability",
  "Audit/Search Log Generator",
  "Data Privacy/Anonymization Scrubber",
  "Law/Prosecution Department Sync",
  "Field Officer Reference App",
  "Historical Boundary/Jurisdiction Shift Correlator",
  "DGP/Legal Advisor Briefing AI",
  "Branch Update/Compliance Allocator",
  "Blockchain Immutable Gazette Hash",
  "Anti-Tamper Official Record Shield",
  "Mobile App for Quick Reference",
  "Unit-wise Legal Awareness Benchmarker",
  "Automated Reminder for New Notifications",
  "Historical Amendment Frequency Analyzer",
  "Legal Procedure/SOP Trainer",
  "Archive Database Health Monitor",
  "Imminent Legal Challenge/Loophole Alert",
  "Non-Compliance/Ignorance Profiler",
  "High-Priority/Service Rule Classifier",
  "AI Assisted Circular Generation from Gazette",
  "Document Storage/Archive Forecaster",
  "Secure Sensitive Notification Protector",
  "Integration with E-Courts/Tribunals",
  "Public Information Portal Sync",
  "Election Boundary Delimitation Modeler",
  "Disaster/Emergency Notification Coordinator",
  "Digitization/Archive Budget Tracker",
  "Custom Workflow for Restricted Notifications",
  "AI Driven Legal Impact Predictor",
  "Predictive Need for Police Manual Update",
  "Custom Alert Trigger for Nodal Officers",
  "Gazette Notification Lifecycle Timeline"
];
...
const GazetteNotificationArchiveDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI GAZETTE NOTIFICATION ARCHIVE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI GAZETTE NOTIFICATION <span>ARCHIVE</span></h1>
...
export default GazetteNotificationArchiveDetailed;
