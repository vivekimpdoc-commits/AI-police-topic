...
const aiExperts = [
"Home Guard Roster & Shift Auto-Scheduler",
  "Traffic Duty/Intersection Allocation AI",
  "VIP Security/Route Lining Escort Matcher",
  "Law & Order/Riot Backup Deployment Bot",
  "Night Patrolling/Beat Augmentation AI",
  "Election/Polling Booth Duty Allocator",
  "Fair/Festival (Mela) Crowd Guard Deployer",
  "Real-time Home Guard GPS Tracker/App Sync",
  "Leave/Attendance/Absenteeism Predictor",
  "Weapons/Baton (Lathi) Issuance Tracker",
  "Command Center Home Guard Dashboard",
  "Voice-Command Guard Availability Query Bot",
  "Automated Duty Allowance/Salary Sync AI",
  "Skill-Based (Driver/Cook) Guard Matcher",
  "Inter-District Transfer/Deputation Modeler",
  "Railway/Bus Station Security Allocation AI",
  "Hospital/Jail Guarding Duty Assignor",
  "Bank/Treasury Escort Duty Roster Engine",
  "Quick Response Team (QRT) Reserve Modeler",
  "Disaster Relief/Camp Guard Deployer AI",
  "AI Evaluator for Guard Deployment Efficiency",
  "Disciplinary/Default Action Log Generator",
  "Data Privacy/Guard Personal Info Masker",
  "Police-Home Guard Joint Duty Sync Bot",
  "Fatigue/Continuous Duty Hours Monitor",
  "Guard Accommodation/Barrack Space Modeler",
  "Senior Officer (Commandant) Briefing Gen",
  "Duty Notification/SMS Alert Drafter AI",
  "Blockchain Immutable Log of Duty Roster",
  "Unarmed vs Armed Guard Requirement AI",
  "Mobile App for Guard Check-in/Selfie Sync",
  "Vulnerable Area/Hotspot Guard Deployer",
  "Multi-Lingual Guard Communication Bot",
  "Historical Deputation Precedent Matcher",
  "Uniform/Kit Replacement Inventory Alert",
  "Medical/Fitness Checkup Due Alert AI",
  "Temporary Checkpost/Naka Setup AI",
  "Traffic Fine/Challan App Integration Sync",
  "Border/Coastal Patrolling Augmentation Bot",
  "Evacuation Route Escort Duty Allocator",
  "AI Assisted Post-Duty Debriefing Gen",
  "Weapon/Ammunition Expiry/Audit Alert",
  "VIP Visit/Convoy Reserve Guard Allocator",
  "Integration with State Police HRMS",
  "Citizen Complaint vs Guard Duty Router",
  "Heatwave/Extreme Weather Duty Adjuster",
  "Strike/Bandh Reserve Guard Repurposing",
  "Budget/Overtime Expense Tracker AI",
  "Custom Workflow/Approval for Leave",
  "AI Driven Guard Demobilization Predictor",
  "Predictive Need for Armed vs Unarmed",
  "Custom Alert Trigger for Platoon Cmdr"
];
...
const HomeGuardDeploymentDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI HOME GUARD DEPLOYMENT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI HOME GUARD DEPLOYMENT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in auxiliary force rotation, traffic management & vip security relief.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI HOME GUARD <span>DEPLOYMENT</span></h1>
            <p className="cyber-subtitle">Auxiliary Force Rotation, Traffic Management & VIP Security Relief</p>
          </div>
        </div>
      </header>
...
export default HomeGuardDeploymentDetailed;
