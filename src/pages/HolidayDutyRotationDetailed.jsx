...
const aiExperts = [
  "Equitable Festival/Holiday Allocator AI",
  "Predictive Leave Approval Engine",
  "Weekly Rest-Day (Off) Tracker",
  "Force Morale/Sentiment Analyzer",
  "Religious/Cultural Preference Matcher",
  "Peak Festival Demand Sync (Diwali/Eid)",
  "Geo-Spatial Hometown Commute Mapper",
  "Compensatory Off (Comp-Off) Manager",
  "Holiday Duty Dashboard",
  "Voice-Command Duty Query Bot",
  "Automated Festival Roster Publisher",
  "HRMS/Leave Management Sync",
  "Predictive Mass Leave Modeler",
  "Family Emergency/Compassionate Leave Prioritizer",
  "Fake Medical Certificate Predictor",
  "Reserve/Standby Rotation AI",
  "AI Evaluator for Roster Fairness",
  "Audit/Leave Approval Log Generator",
  "Data Privacy/Staff Detail Scrubber",
  "State Police Welfare Dept Sync",
  "Officer Leave Request Mobile App",
  "Historical Leave Denial Correlator",
  "Supervisory Officer Briefing AI",
  "Emergency Duty Re-Allocator",
  "Blockchain Immutable Leave Hash",
  "Anti-Tamper Duty Shield",
  "Mobile App for Instant Approvals",
  "Jurisdiction-wise Morale Benchmarker",
  "Multi-Lingual Holiday Notification",
  "Historical Burnout/Resignation Analyzer",
  "Leave Policy/SOP Trainer",
  "Duty Rotation DB Server Health Monitor",
  "Imminent Force Depletion Alert",
  "Habitual Festival Leave Profiler",
  "Critical Festival/VIP Duty Classifier",
  "AI Assisted Welfare Counseling Drafter",
  "Roster Data Storage Forecaster",
  "Secure Officer Schedule Protector",
  "Integration with CCTNS/Command Center",
  "Citizen Facing Desk Availability Sync",
  "Election Coinciding with Festival Modeler",
  "Disaster Leave Cancellation Coordinator",
  "Holiday Pay/Allowance Budget Tracker",
  "Custom Workflow for Exceptional Leave",
  "AI Driven Mutiny/Strike Predictor",
  "Predictive Need for Central Forces (CAPF)",
  "Custom Alert Trigger for IG/ADG",
  "Officer Leave Lifecycle Timeline Tracker"
];
...
const HolidayDutyRotationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI HOLIDAY DUTY ROTATION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI HOLIDAY DUTY <span>ROTATION</span></h1>
...
export default HolidayDutyRotationDetailed;
