...
const aiExperts = [
"E-Waybill Forgery Detector AI",
  "GST Mismatch Alert Engine",
  "Supply Chain Route Validator",
  "High-Value Cargo Tracker Bot",
  "Cross-Border Trade Flow Analyzer",
  "Commercial Goods Tax Evasion AI",
  "Stolen Merchandise Matcher",
  "Real-time Inventory Transit Sync",
  "Fake Invoice Recognition Bot",
  "Customs Duty Evasion Profiler",
  "Suspicious Bulk Transport Alert",
  "Interstate Trade Restriction Bot",
  "Commodity Price Anomaly Tracker",
  "Perishable Goods Transit Optimizer",
  "Cold-Chain Integrity Monitor",
  "Hazardous Chemical Transit Auth",
  "Live Animal Smuggling Detector",
  "Narcotics in Cargo X-Ray AI",
  "Weapons in Freight Sensor Bot",
  "Textile/Gold Smuggling Modeler",
  "Automated Transit Declaration Sync",
  "Driver & Cargo ID Matcher",
  "RTO Registration Mismatch AI",
  "Warehouse to Border Sync AI",
  "Unloading Zone Geofence Alert",
  "Transporter Syndicate Link Analyzer",
  "E-Waybill Expiration Predictor",
  "Goods Classification Verification Bot",
  "Overnight Transport Profiler AI",
  "Fake Company Registration Flag",
  "Shell Company Transit Auditor",
  "Border Goods Queuing Optimizer",
  "Blacklisted Transporter Alert Bot",
  "AI-Powered Transit Escort Routing",
  "Blockchain Transit Ledger Sync",
  "Automated Goods Audit Reconciler",
  "Cargo Weight vs Volume Modeler",
  "Inter-Agency Goods Intelligence Link",
  "Suspect Freight Forwarder AI",
  "Route Adherence Compliance Bot",
  "Transport Strike Impact Analyzer",
  "Weather-Delay Goods Routing AI",
  "Night-Vision Transit Auditor",
  "Border Trade Economics Modeler",
  "Illicit Tobacco Transit Tracker",
  "Counterfeit Currency Cargo Alert",
  "Tax Haven Smuggling Route Modeler",
  "Goods Confiscation Ledger AI",
  "Auction Recommender for Seized Goods",
  "Dynamic Checkpost Resource Allocator",
  "Goods Transit Time Deviation Bot",
  "Interstate Checkpost Handoff AI",
  "E-Waybill API Outage Predictor",
  "Digital Signature Tamper Detector",
  "Biometric Driver Authentication AI",
  "Toll-Receipt to Invoice Matcher",
  "Multi-State Transport Data Sync",
  "Automated Trade-War Impact Alert",
  "Goods Vehicle Fleet Sync AI",
  "Smart Tag & RFID Cargo Tracker"
];
...
const GoodsMovementVerificationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI GOODS MOVEMENT VERIFICATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI GOODS MOVEMENT VERIFICATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in e-waybill authentication, gst mismatch detection & supply chain analytics.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI GOODS MOVEMENT <span>VERIFICATION</span></h1>
            <p className="cyber-subtitle">E-Waybill Authentication, GST Mismatch Detection & Supply Chain Analytics</p>
          </div>
        </div>
      </header>
...
export default GoodsMovementVerificationDetailed;
