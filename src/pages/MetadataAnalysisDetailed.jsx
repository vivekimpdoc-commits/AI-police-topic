...
const aiExperts = [
"EXIF Data (GPS/Time/Device) Extractor AI",
  "PDF/Word Document Author Origin Tracer",
  "Image/Video Edit History (Photoshop) Analyzer",
  "File Creation vs Modification Timestamp AI",
  "Time-Zone/NTP Manipulation Detector",
  "Software/App Version Fingerprinter Bot",
  "Hidden/Deleted Metadata Recovery Engine",
  "Camera Lens/Sensor Defect Matcher AI",
  "Email Header (IP/Route/Mailer) Analyzer",
  "Social Media Platform Scrubbing Bypass AI",
  "Malware/Ransomware Compile-Time Extractor",
  "Steganography Payload Metadata Flag Bot",
  "Command Center Real-time Metadata Dashboard",
  "Voice-Command Metadata Parameter Query",
  "Automated Evidence Timeline Generator AI",
  "Device Mac Address/IMEI Link Analyzer",
  "Cross-Referencing GPS Meta with Telecom CDR",
  "Geo-Spoofing/Fake GPS Location Detector",
  "Financial/Excel Ledger Edit History Tracer",
  "Audio File Recording Device Profiler",
  "AI Evaluator for Metadata Admissibility",
  "Blockchain Immutable Log of Extracted Meta",
  "Inter-Agency (CERT-In/Cyber) Sync Bot",
  "Alibi Verification vs Metadata Location AI",
  "Copyright/Watermark Meta Verifier Bot",
  "Officer/IO Report Tamper Verification AI",
  "Deepfake Generation Tool Meta Tracer",
  "Phishing URL/Domain Registration Meta Bot",
  "AI Assisted Forensic Meta Report Drafter",
  "Data Privacy/Victim Meta Sanitizer AI",
  "Mobile App On-the-Fly Meta Extractor",
  "Senior Officer Cyber Threat Briefing Meta",
  "Video Codec/Compression Software Matcher",
  "Threat/Extortion Email Route Tracer AI",
  "Cloud Storage/Google Drive Revision Meta AI",
  "Printer/Scanner Hidden Meta (Yellow Dots) AI",
  "Terror/Insurgent Comms Device Profiler",
  "Child Abuse (CSAM) Source Device Linker",
  "Integration with National Cyber Crime Portal",
  "AI Driven Batch Metadata Categorization",
  "Custom Meta Tag Extraction Definition AI",
  "Predictive Suspect Linkage via Meta Matches",
  "Election Fake News Origin Meta Tracer",
  "Custom Alert Trigger for Spoofed Timestamps"
];
...
const MetadataAnalysisDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI METADATA ANALYSIS
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI METADATA ANALYSIS</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in exif extraction (gps/time), pdf author tracing & identifying edited files.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI METADATA <span>ANALYSIS</span></h1>
            <p className="cyber-subtitle">EXIF Extraction (GPS/Time), PDF Author Tracing & Identifying Edited Files</p>
          </div>
        </div>
      </header>
...
export default MetadataAnalysisDetailed;
