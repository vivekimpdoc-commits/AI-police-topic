...
const aiExperts = [
  "Meeting Lunch/Catering Requirement Aggregator",
  "Police Mess/Canteen Sync Engine",
  "Packed Meal/Field Duty Logistics Bot",
  "Dietitian/Nutrition Profile Linker AI",
  "Vendor Dispatch/Delivery Time Tracker",
  "Temperature/Food Quality Assurance AI",
  "Geo-Spatial Field Delivery Route Mapper",
  "Last-Minute Headcount Adjustment Bot",
  "Catering Coordination Dashboard",
  "Voice-Command Catering Query Bot",
  "Automated Weekly Catering Expense Report",
  "District Police Mess/Lines Sync",
  "Delivery Delay/Traffic Block Predictor",
  "Spoilage/Stale Food Alert AI",
  "Vendor Over-Billing/Discrepancy Detector",
  "Menu Fatigue/Repetition Analyzer",
  "AI Evaluator for Field Meal Satisfaction",
  "Audit/Catering Invoice Log Generator",
  "Data Privacy/Dietary Need Scrubber",
  "Finance/Accounts Department Sync",
  "Field Commander Meal App",
  "Historical Riot/Election Deployment Correlator",
  "SP (Lines/Admin) Briefing AI",
  "Mess/Vendor Task Allocator",
  "Blockchain Immutable Delivery Receipt Hash",
  "Anti-Tamper Catering Invoice Shield",
  "Mobile App for Food Quality Sign-off",
  "Vendor/Mess Delivery Speed Benchmarker",
  "Automated Reminder for Meal Dispatches",
  "Historical Catering Cost Analyzer",
  "Field Catering/Hygiene SOP Trainer",
  "Mess Kitchen Utility Health Monitor",
  "Imminent Delivery Failure (Field Ops) Alert",
  "Substandard Caterer/Vendor Profiler",
  "High-Priority (VIP/CM Duty) Meal Classifier",
  "AI Assisted Disputed Bill Drafter",
  "Catering Analytics Storage Forecaster",
  "Secure Force Deployment Route Protector",
  "Integration with Health/Medical Department",
  "Dietary Feedback Portal Sync",
  "Election Phase Mega-Catering Modeler",
  "Disaster Relief Camp Meal Coordinator",
  "Field Rations/Catering Budget Tracker",
  "Custom Workflow for Emergency Dry Rations",
  "AI Driven Deployment Meal Predictor",
  "Predictive Need for Mobile Kitchens",
  "Custom Alert Trigger for IG (Armed Battalion)",
  "Catering Order to Field Delivery Timeline"
];
...
const OfficialCateringCoordinationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI OFFICIAL CATERING COORDINATION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI OFFICIAL CATERING <span>COORDINATION</span></h1>
...
export default OfficialCateringCoordinationDetailed;
