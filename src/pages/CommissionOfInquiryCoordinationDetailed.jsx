...
const aiExperts = [
  "Inquiry Directive NLP Extractor",
  "Subpoena & Summons Tracker AI",
  "Evidence Submission Log Monitor",
  "Cross-Department Inquiry Sync Bot",
  "Witness Testimony Collator AI",
  "Hearings Schedule Optimizer Engine",
  "Legal Document Preparation Assistant",
  "Inquiry Findings Trend Analyzer",
  "Coordination Command Dashboard",
  "Voice-Command Inquiry Query Bot",
  "Automated Daily Progress Report Gen",
  "Inter-Agency Liaison Coordination Bot",
  "Affidavit Veracity Scorer AI",
  "Inquiry Mandate Compliance Checker",
  "Action Taken Report (ATR) Drafter",
  "Delay/Bottleneck Predictor Engine",
  "AI Evaluator for Inquiry Readiness",
  "Audit/Access Log Generator AI",
  "Data Privacy/Sensitive Deposition Scrubber",
  "Nodal Officer Sync Bot",
  "Field IO Deposition Alert App",
  "Cold Case Inquiry Reference Matcher",
  "Senior Officer (DIG/IG) Briefing AI",
  "Legal Resource Allocator Bot",
  "Blockchain Immutable Evidence Hash",
  "Anti-Tamper Affidavit Shield AI",
  "Mobile App for Hearing Schedules",
  "Geo-Spatial Incident Overlay Matcher",
  "Multi-Lingual Deposition Translator",
  "Historical Inquiry Precedent Analyzer",
  "SOP Compliance Trainer AI",
  "Coordination DB Server Monitor",
  "Imminent Deadline Alert Bot",
  "Organized Crime Inquiry Profiler",
  "VIP Deposition Security Classifier",
  "AI Assisted Interim Report Drafter",
  "Document Storage Size Forecaster",
  "Secure Witness Identity Protector",
  "Integration with Judicial Portals",
  "Citizen Deposition Portal Tracker",
  "Public Outcry/Media Sentiment Modeler",
  "Disaster Inquiry Coordination Bot",
  "Inquiry Expense/Budget Tracker",
  "Custom Workflow for Evidence Submission",
  "AI Driven Finding Predictor",
  "Predictive Need for Expert Witnesses",
  "Custom Alert Trigger for Nodal Leads",
  "Inquiry Lifecycle Timeline Tracker"
];
...
const CommissionOfInquiryCoordinationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI COMMISSION OF INQUIRY COORDINATION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI COMMISSION OF INQUIRY <span>COORDINATION</span></h1>
...
export default CommissionOfInquiryCoordinationDetailed;
