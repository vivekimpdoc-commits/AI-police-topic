...
const aiExperts = [
  "Bilingual (English/Hindi) Legal Translation AI",
  "Automated FIR/Charge-sheet Drafting Engine",
  "Remand Request/Bail Opposition Formulator AI",
  "Standardized Seizure/Panchnama Memo Generator",
  "Dynamic Legal Code (BNS/BNSS) Format Updater",
  "Typographical/Legal Error Detection NLP",
  "Geo-Spatial Template Usage/Adoption Mapper",
  "Case Diary (CD) Formatting Assistant",
  "Standard Templates Dashboard",
  "Voice-Command Template Search Bot",
  "Automated Monthly Template Usage Report",
  "E-Courts/Judiciary IT System Sync",
  "Outdated/Repealed Section Usage Predictor",
  "Court Rejection/Objection Risk Analyzer",
  "Language Ambiguity/Vagueness Flagging AI",
  "Formatting Inconsistency Detector",
  "AI Evaluator for Documentation Standardization",
  "Audit/Download Log Generator",
  "Data Privacy/Auto-Redaction Engine",
  "Law/Legal Affairs Department Sync",
  "Station Writer/Munshi Mobile App",
  "Historical Document Rejection Correlator",
  "SP (Legal/Crime) Briefing AI",
  "Template Revision/Update Task Allocator",
  "Blockchain Immutable Template Hash",
  "Anti-Tamper Legal Format Shield",
  "Mobile App for Offline/Remote Seizure Memo Generation",
  "District-wise Template Compliance Benchmarker",
  "Automated Alert for Supreme Court Format Changes",
  "Historical Stationery/Printing Cost Analyzer",
  "Legal Drafting/Documentation SOP Trainer",
  "Document Storage/Cloud API Monitor",
  "Imminent Bail/Release (Due to Bad Drafting) Alert",
  "Habitual Sloppy Drafter Profiler",
  "High-Priority (UAPA/NDPS) Template Classifier",
  "AI Assisted Notice/Summons Generator",
  "Drafting Workload/Time-Saving Forecaster",
  "Secure Digital Signature (DSC) Protector",
  "Integration with CCTNS/Core Policing App",
  "State Prosecution Directorate Sync",
  "Election Preventive Arrest (CrPC/BNSS) Template Modeler",
  "Disaster Unnatural Death/Inquest Report Coordinator",
  "Legal Software/License Budget Tracker",
  "Custom Workflow for Cyber Crime/Digital Seizures",
  "AI Driven Court Acceptance Rate Predictor",
  "Predictive Need for New Language Templates",
  "Custom Alert Trigger for IG Legal",
  "Law Amendment to Template Update Timeline"
];
...
const StandardTemplatesRepositoryDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI STANDARD TEMPLATES REPOSITORY
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI STANDARD TEMPLATES <span>REPOSITORY</span></h1>
...
export default StandardTemplatesRepositoryDetailed;
