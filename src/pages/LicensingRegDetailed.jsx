...
const expertRoutes = {
  "Arms License Bot": "/arms-license-bot-agent",
  "Background Vetting AI": "/background-vetting-ai-agent",
  "Explosives Audit Bot": "/explosives-audit-bot-agent",
  "Event Permission Router": "/event-permission-router-agent",
  "Loudspeaker Monitor AI": "/loudspeaker-monitor-ai-agent",
  "Hotel DB Sync Bot": "/hotel-db-sync-bot-agent",
  "Procession Safety Analyst": "/procession-safety-analyst-agent",
  "Cinema Security Evaluator": "/cinema-security-evaluator-agent",
  "Renewal Predictor": "/renewal-predictor-agent",
  "Forgery Detector AI": "/forgery-detector-ai-agent",
  "Risk Profiling Engine": "/risk-profiling-engine-agent"
};
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> LICENSING & REGULATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>LICENSING & REGULATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in arms permits, event nocs & hotel watchlist sync.
            </p>
