...
const aiExperts = [
  "Device Health/Uptime Monitor AI",
  "Remote Template Sync/Distribution Engine",
  "Spoofing/Fake Fingerprint Detection Vision",
  "Fingerprint/Iris Quality Scorer",
  "Offline Mode/Buffer Auto-Sync Bot",
  "Device Tamper/Vandalism Alert AI",
  "Geo-Spatial Device Location Mapper",
  "Network/Connectivity Drop Analyzer",
  "Biometric Device Dashboard",
  "Voice-Command Device Status Bot",
  "Automated Weekly Device Uptime Report",
  "IT/Network Department Sync",
  "Dry/Wet Fingerprint Enhancement AI",
  "Template Corruption/Duplicate Detector",
  "Unauthorized Device Relocation Predictor",
  "Firmware/Software Update Automator",
  "AI Evaluator for Biometric Accuracy",
  "Audit/Sync Event Log Generator",
  "Data Privacy/Biometric Template Scrubber",
  "HRMS/Attendance System Sync",
  "Field Technician/Admin Mobile App",
  "Historical Device Failure Correlator",
  "SP (Computer/IT) Briefing AI",
  "Repair/Replacement Task Allocator",
  "Blockchain Immutable Template Hash",
  "Anti-Tamper Device Hardware Shield",
  "Mobile App for Manual Attendance (Fallback)",
  "Station-wise Device Reliability Benchmarker",
  "Automated Alert for Offline Terminals",
  "Historical Maintenance Expense Analyzer",
  "Biometric Enrollment/Usage SOP Trainer",
  "Central Biometric Server Health Monitor",
  "Imminent Server Storage Exhaustion Alert",
  "Habitual Device Vandal/Tamperer Profiler",
  "Critical (Jail/Armory) Device Classifier",
  "AI Assisted Vendor SLA Penalty Drafter",
  "Biometric Template Storage Forecaster",
  "Secure Cryptographic Key Protector",
  "Integration with CCTNS/AFIS (Automated Fingerprint Identification System)",
  "Citizen Verification Portal Sync",
  "Election Duty Remote Verification Modeler",
  "Disaster Field Camp Biometric Coordinator",
  "Biometric Hardware Budget Tracker",
  "Custom Workflow for Device Condemnation",
  "AI Driven Device Lifespan Predictor",
  "Predictive Need for Facial Recognition Upgrade",
  "Custom Alert Trigger for IG IT",
  "Device Installation to Decommission Timeline"
];
...
const BiometricDeviceAdministrationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI BIOMETRIC DEVICE ADMINISTRATION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI BIOMETRIC DEVICE <span>ADMINISTRATION</span></h1>
...
export default BiometricDeviceAdministrationDetailed;
