...
const aiExperts = [
  "RFID/NFC Pass Provisioning Engine",
  "Zone-Based Access Control AI",
  "Tailgating/Piggybacking Detection Vision",
  "Time-Bound Access Expiry Bot",
  "Multi-Campus/Site Roaming Linker",
  "Lost/Stolen Pass Blacklist Automator",
  "Geo-Spatial Access Event Mapper",
  "Pass Duplication/Cloning Predictor",
  "Smart Access Pass Dashboard",
  "Voice-Command Access Query Bot",
  "Automated Daily Entry/Exit Audit",
  "Campus Security/Sentry Sync",
  "Unauthorized Zone Entry Alert",
  "Pass Handover/Sharing Identifier",
  "Unusual After-Hours Access Analyzer",
  "Access Point Congestion Optimizer",
  "AI Evaluator for Physical Security Index",
  "Audit/Access Event Log Generator",
  "Data Privacy/Movement History Scrubber",
  "IT/Server Room Security Sync",
  "Access Control Admin App",
  "Historical Security Breach Correlator",
  "Chief Security Officer Briefing AI",
  "Sentry/Guard Deployment Allocator",
  "Blockchain Immutable Access Event Hash",
  "Anti-Tamper Access Card Shield",
  "Mobile App for Pass Requisition",
  "Gate-wise Clearance Speed Benchmarker",
  "Automated Alert for Blacklisted Card Use",
  "Historical Card Replacement Cost Analyzer",
  "Campus Access/Security SOP Trainer",
  "RFID Reader/Controller Health Monitor",
  "Imminent Perimeter Breach Alert",
  "Suspicious Movement/Wandering Profiler",
  "High-Security (Armory/Control Room) Pass Classifier",
  "AI Assisted Security Violation Notice Drafter",
  "Access Log/Video Storage Forecaster",
  "Secure Encryption Key Protector",
  "Integration with HRMS/Attendance",
  "External Vendor/Contractor Portal Sync",
  "Election Counting Center Access Modeler",
  "Disaster Relief Camp Access Coordinator",
  "Access Control Infrastructure Budget Tracker",
  "Custom Workflow for VIP Escort Access",
  "AI Driven Peak Gate Traffic Predictor",
  "Predictive Need for Additional Turnstiles",
  "Custom Alert Trigger for SP Security",
  "Card Issuance to Revocation Timeline"
];
...
const SmartAccessPassManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SMART ACCESS PASS MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SMART ACCESS PASS <span>MANAGEMENT</span></h1>
...
export default SmartAccessPassManagementDetailed;
