...
const aiExperts = [
  "NLP Idea Deduplication Engine",
  "Feasibility/Impact Scoring AI",
  "Automated Reward/Recognition Tracker",
  "Field Officer Crowdsourcing Bot",
  "Idea Clustering/Categorization AI",
  "Plagiarism/Originality Checker",
  "Geo-Spatial Idea Origin Mapper",
  "Budget vs Implementation ROI Estimator",
  "Idea Submission Dashboard",
  "Voice-Command Idea Pitch Bot",
  "Automated Monthly Innovation Report",
  "HRMS/Appraisal Sync",
  "Stalled Idea/Bottleneck Predictor",
  "High-Impact/Low-Cost Idea Identifier",
  "Cross-District Collaboration Recommender",
  "Patentability/IP Potential Analyzer",
  "AI Evaluator for Innovation Index",
  "Audit/Submission Log Generator",
  "Data Privacy/Anonymity Scrubber",
  "State DGP (Modernization) Sync",
  "Constable/Officer Pitch Mobile App",
  "Historical Success/Failure Correlator",
  "Review Committee Briefing AI",
  "Feasibility Study Task Allocator",
  "Blockchain Immutable Idea Timestamp",
  "Anti-Tamper Pitch Record Shield",
  "Mobile App for Peer Voting/Rating",
  "District-wise Idea Generation Benchmarker",
  "Automated Alert for High-Potential Pitches",
  "Historical R&D Cost Analyzer",
  "Innovation/Pitching SOP Trainer",
  "Portal/Database Health Monitor",
  "Imminent IP/Idea Theft Risk Alert",
  "Habitual Spam/Low-Effort Submitter Profiler",
  "High-Priority (Cyber/Tech) Idea Classifier",
  "AI Assisted Concept Note Drafter",
  "Pitch Video/Audio Storage Forecaster",
  "Secure IP Vault Protector",
  "Integration with Police Welfare Fund",
  "E-Office/File Movement Sync",
  "Election Security Hack/Idea Modeler",
  "Disaster Rapid Response Innovation Coordinator",
  "Innovation/Reward Budget Tracker",
  "Custom Workflow for Top-Secret/Intel Ideas",
  "AI Driven Adoption Rate Predictor",
  "Predictive Need for Prototyping Funds",
  "Custom Alert Trigger for IG Tech",
  "Idea Pitch to Prototype Timeline"
];
...
const IdeaSubmissionPortalDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI IDEA SUBMISSION PORTAL
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI IDEA SUBMISSION <span>PORTAL</span></h1>
...
export default IdeaSubmissionPortalDetailed;
