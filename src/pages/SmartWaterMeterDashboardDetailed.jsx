...
const aiExperts = [
  "Real-Time Consumption Tracker",
  "Anomalous Usage/Leak Detector",
  "Municipal Bill Reconciliation Engine",
  "Water Conservation Gamification AI",
  "Peak Demand Time Analyzer",
  "Flow Rate/Pressure Drop Monitor",
  "Geo-Spatial Water Usage Heatmapper",
  "Borewell/Tank Level Sync AI",
  "Smart Water Dashboard",
  "Voice-Command Water Query Bot",
  "Automated Monthly Consumption Report",
  "Municipal/Jal Board Sync",
  "Underground Leak/Pipe Burst Predictor",
  "Unauthorized Tapping/Theft Alert",
  "Sensor Drift/Calibration Predictor",
  "Barrack vs Office Usage Segmenter",
  "AI Evaluator for Water Efficiency Index",
  "Audit/Billing Log Generator",
  "Data Privacy/Resident Data Scrubber",
  "Finance/Estate Department Sync",
  "Plumber/Estate Officer App",
  "Historical Summer Demand Correlator",
  "SP (Lines) Briefing AI",
  "Repair/Inspection Task Allocator",
  "Blockchain Immutable Consumption Hash",
  "Anti-Tamper Smart Meter Shield",
  "Mobile App for Wastage Reporting",
  "Unit-wise Water Efficiency Benchmarker",
  "Automated Alert for Continuous Flow (Leak)",
  "Historical Water Tariff/Cost Analyzer",
  "Water Conservation SOP Trainer",
  "IoT Smart Meter Gateway Monitor",
  "Imminent Supply Exhaustion Alert",
  "Habitual Water Waster (Unit/Block) Profiler",
  "High-Consumption (Mess/Hospital) Classifier",
  "AI Assisted Bill Dispute Drafter",
  "Consumption Trend Data Forecaster",
  "Secure Telemetry Network Protector",
  "Integration with Central Ground Water Board",
  "Sustainability/Green Audit Sync",
  "Election Force Mass Consumption Modeler",
  "Disaster Relief Camp Water Allocation Coordinator",
  "Utility/Water Bill Budget Tracker",
  "Custom Workflow for Rainwater Harvesting Yield",
  "AI Driven Monthly Bill Predictor",
  "Predictive Need for Plumbing Overhaul",
  "Custom Alert Trigger for Commandant",
  "Anomaly Detection to Resolution Timeline"
];
...
const SmartWaterMeterDashboardDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SMART WATER METER DASHBOARD
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SMART WATER METER <span>DASHBOARD</span></h1>
...
export default SmartWaterMeterDashboardDetailed;
