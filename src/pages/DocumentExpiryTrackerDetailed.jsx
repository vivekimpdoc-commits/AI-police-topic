...
const aiExperts = [
"Police ID Card/Smart Card Expiry Alert AI",
  "Vendor/Contractor Agreement Expiry Bot",
  "Software/Antivirus License Tracker AI",
  "Building Lease/Rent Agreement Expiry Sync",
  "Vehicle Insurance/Fitness Certificate Tracker",
  "CCTV/Wireless AMC (Annual Maint) Alert",
  "Gun License/Explosive Permit Expiry Tracker",
  "Private Security Agency (PSARA) License Bot",
  "Command Center Expiry Tracking Dashboard",
  "Voice-Command Expiry Status Query Assistant",
  "Automated Renewal Reminder (SMS/Email) Gen",
  "Inter-Department Renewal Status Sync Engine",
  "Digital Certificate (DSC/e-Sign) Expiry Alert",
  "Hotel/Lodge Operating License Verifier",
  "Bar/Liquor Shop License Expiry Tracker",
  "Telecom/Internet Provider SLA Expiry Bot",
  "AI Evaluator for Contract Renewal Speed",
  "Audit/Lapsed License Penalty Log Generator",
  "Data Privacy/Vendor Financial Info Masker",
  "Police-RTO Vehicle Expiry Sync Bot",
  "Stationery/Uniform Supplier Contract Alert",
  "Toll-Plaza/FASTag Exemption Expiry Tracker",
  "Senior Officer (HQ/Admin) Expiry Briefing",
  "Public/Citizen License Renewal Reminder AI",
  "Blockchain Immutable Log of Renewals",
  "Dog-Squad/K9 Veterinary Certificate Expiry",
  "Mobile App for Admin Officer Sync",
  "Hospital/Ambulance MOU Expiry Tracker",
  "Multi-Lingual Renewal Form Generator",
  "Historical Lapsed Contract Precedent Matcher",
  "Departmental Promotion Exam Eligibility Tracker",
  "Admin Staff Workload/Renewal Monitor",
  "Temporary Checkpost Land Use Expiry Bot",
  "Traffic Radar/Breathalyzer Calibration Expiry",
  "Hazardous Material/Chemical Storage License",
  "Aviation/Drone Pilot License Expiry Tracker",
  "AI Assisted Post-Renewal SLA Drafter",
  "Budget/Fund Lapse Alert for Renewals",
  "VIP Escort Vehicle Special Pass Expiry AI",
  "Integration with State E-Tender/Procurement",
  "Citizen Passport Validity/Expiry Tracker",
  "Foreigner (FRRO) Visa Expiry Alert AI",
  "Election Duty Requisition Order Expiry Bot",
  "Renewal Fee/Penalty Expense Tracker AI",
  "Custom Workflow/Approval for Auto-Renewal",
  "AI Driven Vendor Default Predictor",
  "Predictive Need for Tender Re-bidding",
  "Custom Alert Trigger for Procurement Officer"
];
...
const DocumentExpiryTrackerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DOCUMENT EXPIRY TRACKER
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI DOCUMENT EXPIRY TRACKER</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in automated alerts for vendor contracts, amc, software licenses & id cards.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DOCUMENT EXPIRY <span>TRACKER</span></h1>
            <p className="cyber-subtitle">Automated Alerts for Vendor Contracts, AMC, Software Licenses & ID Cards</p>
          </div>
        </div>
      </header>
...
export default DocumentExpiryTrackerDetailed;
