...
const aiExperts = [
"Mass Deployment Loadout Optimizer",
  "Polycarbonate Shield Integrity Scanner",
  "Tactical Baton Distribution Log AI",
  "Rapid Riot Recall Coordinator Bot",
  "Squad Readiness & Deficit Modeler",
  "Riot Gear Shortage Predictor AI",
  "Polycarbonate Material Fatigue AI",
  "Automated Kit Assembly & Sync Bot",
  "Riot Damage Liability Assessor",
  "Vehicle & Truck Loadout Sync AI",
  "Emergency Gear Requisition Bot",
  "Tear Gas Mask Fitment Analytics",
  "Gas Mask Filter Expiration AI",
  "Body Armor Deficit Allocator Bot",
  "Anti-Riot Shield Scratch Analyzer",
  "Water Cannon Resupply Coordinator",
  "Flashbang Grenade Pouch Tracker",
  "Crowd-Control Drone Deployment AI",
  "Riot Helmet Visor Impact Analyzer",
  "Automated Rubber Bullet Allocation AI",
  "Special Forces Riot Loadout Sync",
  "Inter-District Gear Transfer Bot",
  "RFID Mass Checkout Gate Scanner",
  "Riot Shield interlocking Sync AI",
  "Arm/Leg Guard Sizing Optimizer",
  "Fire-Resistant Suit Degradation AI",
  "Stun-Gun Battery Drain Predictor",
  "Automated Barricade Deployment AI",
  "Taser Cartridge Replenishment Bot",
  "Riot Suit Cleaning & Wash Tracker",
  "Acoustic Cannon (LRAD) Sync AI",
  "Pepper Spray Canister Expiry Bot",
  "Tactical Glove Wear & Tear AI",
  "K9 Riot Armor Allocator Bot",
  "Mounted Police Riot Gear Tracker",
  "Crowd-Density vs Gear Need Predictor",
  "Automated Armoury Unlock Sentinel",
  "Biometric Squad Leader Sign-off AI",
  "Stolen Riot Gear Dark-Web Scanner",
  "Riot Asset Depreciation Calculator",
  "Helicopter Drop-Pod Resupply AI",
  "Supplier Riot Gear Defect Analyzer",
  "Blockchain Damage/Liability Ledger",
  "Post-Riot Gear Recovery Tracker",
  "Missing Baton Geofencing Alert",
  "Riot Gear Sweat/Corrosion Modeler",
  "Tactical Boot Wear Forecaster",
  "Smart Shield Impact Telemetry AI",
  "Budget Forecasting for Riot Kits",
  "Riot Gear Sanitation Audit Bot",
  "Chemical Agent Exposure Tracker",
  "CCTV Mass Scan Verification AI",
  "Automated Post-Deployment Show-Cause",
  "Riot Squad Comm-link Sync Bot",
  "Air-Gapped Mobile Gear Scanner",
  "Riot Unit Efficiency & Loadout Scorer",
  "Central Reserve Riot Allocator",
  "Anti-Hoarding Gear Sync Bot",
  "Smart Baton Impact Sensor Sync",
  "Next-Gen Exoskeleton Procurement AI"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> RIOT GEAR TRACKING
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>RIOT GEAR TRACKING</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in mass deployment sync & rapid gear recall.
            </p>
