...
const aiExperts = [
  "Ingredient Sourcing/Traceability AI",
  "Sample Testing/Lab Report Log Engine",
  "Perishable Expiry/FIFO Management Bot",
  "Nutritional/Caloric Value Analytics",
  "Adulteration/Contamination Risk Scorer",
  "Vendor Certification/License Validator",
  "Geo-Spatial Supply Chain Origin Mapper",
  "Dietary Need (Force Health) Optimizer",
  "Food Safety Dashboard",
  "Voice-Command Nutrition Query Bot",
  "Automated Monthly Safety & Health Report",
  "State Food & Drug Administration (FDA) Sync",
  "Counterfeit/Substandard Brand Detector",
  "Cold-Chain Breach (Transit) Alert",
  "Repetitive Menu Nutrient Deficit Predictor",
  "Supplier Monopoly/Cartelization Analyzer",
  "AI Evaluator for Force Nutrition Index",
  "Audit/Testing Log Generator",
  "Data Privacy/Vendor Pricing Scrubber",
  "Police Hospital/Medical Department Sync",
  "Mess Officer Sourcing Mobile App",
  "Historical Sickness/Fitness Correlator",
  "Commandant/SP Briefing AI",
  "Lab Testing/Sampling Task Allocator",
  "Blockchain Immutable Supply/Test Hash",
  "Anti-Tamper Lab Report Shield",
  "Mobile App for Barcode Verification",
  "Vendor-wise Quality & Safety Benchmarker",
  "Automated Alert for Expired Ingredients",
  "Historical Ration Expense vs Nutrition Analyzer",
  "Mess Sourcing/Safety SOP Trainer",
  "Cold Storage IoT Health Monitor",
  "Imminent Adulteration/Poisoning Alert",
  "Corrupt Ration Supplier Profiler",
  "High-Energy (Commando/ATS) Diet Classifier",
  "AI Assisted Vendor Blacklisting Drafter",
  "Testing/Certification Storage Forecaster",
  "Secure Dietary/Health Record Protector",
  "Integration with Food Safety Labs",
  "Constabulary Welfare/Feedback Sync",
  "Election Duty Field Ration Safety Modeler",
  "Disaster Relief Food Packet Coordinator",
  "Ration/Nutrition Budget Tracker",
  "Custom Workflow for Emergency Recalls",
  "AI Driven Caloric Need (Winter/Summer) Predictor",
  "Predictive Need for Diet Menu Overhaul",
  "Custom Alert Trigger for IG Welfare",
  "Farm/Supplier to Plate Safety Timeline"
];
...
const FoodSafetyComplianceDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI FOOD SAFETY COMPLIANCE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI FOOD SAFETY <span>COMPLIANCE</span></h1>
...
export default FoodSafetyComplianceDetailed;
