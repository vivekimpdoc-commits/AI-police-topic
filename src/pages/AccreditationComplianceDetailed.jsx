...
const aiExperts = [
  "ISO/IEC 17025 Compliance Tracker AI",
  "NABL Audit Readiness/Mock Audit Scorer",
  "Document Version Control/Change Management Bot",
  "Automated Corrective & Preventive Action (CAPA) Tracker",
  "Staff Training/Competency Matrix Validator",
  "Management Review Meeting (MRM) Minute Analyzer",
  "Geo-Spatial Multi-Lab Compliance Mapper",
  "Uncertainty of Measurement (MU) Validation AI",
  "Accreditation Compliance Dashboard",
  "Voice-Command Compliance Query Bot",
  "Automated Monthly NABL Readiness Report",
  "National Accreditation Board (NABL/QCI) Sync",
  "Accreditation Suspension/Non-Conformance Predictor",
  "SOP Deviation/Violation Alert",
  "Overdue Calibration/Internal Audit Flagging AI",
  "Unresolved CAPA/Root Cause Analysis Delay Analyzer",
  "AI Evaluator for Global Standard Compliance Index",
  "Audit/Compliance Log Generator",
  "Data Privacy/Audit Finding Scrubber",
  "Directorate of Forensic Science Services (DFSS) Sync",
  "Quality Manager/FSL Director Mobile App",
  "Historical Non-Conformance (NC) Correlator",
  "Home Department (Forensics) Briefing AI",
  "CAPA/Compliance Task Allocator",
  "Blockchain Immutable Compliance/SOP Hash",
  "Anti-Tamper Audit Trail Shield",
  "Mobile App for Spot Audit/Checklist",
  "Regional Lab-to-Lab Compliance Benchmarker",
  "Automated Alert for Critical ISO Non-Conformance",
  "Historical Accreditation/Audit Cost Analyzer",
  "Quality Management System (QMS) SOP Trainer",
  "Document Control/QMS API Health Monitor",
  "Imminent NABL De-recognition/Suspension Alert",
  "Habitual Compliance Violator Profiler",
  "Mandatory/Statutory Compliance Classifier",
  "AI Assisted NABL Application/Renewal Drafter",
  "Compliance/Quality Maturity Forecaster",
  "Secure Audit Finding/Vulnerability Protector",
  "Integration with International Forensic Standards",
  "State Quality Control Board Sync",
  "Election Forensic Evidence Admissibility (Due to Accreditation) Modeler",
  "Disaster Mobile-FSL Rapid Accreditation Coordinator",
  "Quality Assurance/Accreditation Budget Tracker",
  "Custom Workflow for New Discipline Scope Extension",
  "AI Driven Next Surveillance Audit Readiness Predictor",
  "Predictive Need for External Quality Consultant",
  "Custom Alert Trigger for DGP/Home Secretary",
  "Non-Conformance Identification to CAPA Closure Timeline"
];
...
const AccreditationComplianceDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ACCREDITATION COMPLIANCE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ACCREDITATION <span>COMPLIANCE</span></h1>
...
export default AccreditationComplianceDetailed;
