...
const aiExperts = [
"Predictive Explosive Instability Modeler",
  "Magazine Temperature & Humidity Monitor",
  "Nitroglycerin Sweating Sensor AI",
  "Automated Explosive Batch Expiry Forecaster",
  "Seismic & Vibration Impact Analyzer",
  "Detonator & C4 Separation Validator",
  "Blast-Radius Liability Assessor Bot",
  "Magazine Access Biometric Authenticator",
  "Static Electricity Anomaly Detector",
  "Explosives Transport Geofencing AI",
  "Tamper-Evident Seal Verification Bot",
  "K9 Explosive Detection Sweep Coordinator",
  "Ventilation & Gas Build-up Analyzer",
  "Explosive Disposal & Detonation Scheduler",
  "RFID Explosive Material Tracker",
  "Stolen Explosives Dark-Web Scanner",
  "Armoury Bomb-Squad Deployment Sync",
  "Chemical Degradation Trajectory AI",
  "Post-Blast Residue Sync Analyzer",
  "Live vs Dummy Explosive Auditor",
  "Automated Stock Deficit Alerter",
  "Explosive Requisition & Authorization AI",
  "Magazine Structural Integrity AI",
  "Ammunition & Explosive Cross-Storage Flag",
  "CCTV Thermal Imaging Vault Sync",
  "Water-Damage & Flooding Predictor",
  "Lightning Strike Risk Modeler AI",
  "Supplier SLA & Defective Batch Flag AI",
  "Automated Evacuation Route Modeler",
  "Explosive Value Depreciation Calculator",
  "Blockchain Explosive Tracking Ledger",
  "Missing Detonator Alert Sentinel",
  "Blast Shield Integrity Scanner AI",
  "Magazine Fire-Suppression Sync AI",
  "Emergency Riot Grenade Dispatch AI",
  "Anti-Terror Bomb-Kit Allocation Bot",
  "Civilian Proximity Danger Forecaster",
  "Automated Safety Show-Cause Generator",
  "Explosive Transport Convoy Sync AI",
  "Helicopter Explosive Resupply Modeler",
  "Special Forces High-Yield C4 Sync",
  "Flashbang Magazine Allocation Modeler",
  "Depot Electromagnetic Interference AI",
  "Bomb Suit Inventory & Degradation Sync",
  "Robotic Bomb-Disposal Arm Sync AI",
  "Defective Fuse Pre-Detonation Predictor",
  "Chemical Explosive Sweating Alerter",
  "Automated Destruction Certificate Generator",
  "Supplier Audit & Material Defect Profiler",
  "Tactical Comm-link Vault Alert AI",
  "Chemical Agent Quarantine Alerter",
  "Explosive Vault Air-Pressure Monitor",
  "Automated Inter-Departmental Requisition AI",
  "Air-Gapped Inventory Verification Bot",
  "CCTV Armoury Integration Sentinel",
  "Underground Magazine Seismic Sync",
  "Mobile Explosive Dispatch Bot",
  "Advanced Wind & Weather Forecasting AI",
  "Post-Disposal Decontamination Sync",
  "Strategic Explosive Reserve Monitor"
];
...
const ExplosiveStorageDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> EXPLOSIVE STORAGE
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>EXPLOSIVE STORAGE</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in air-gapped vault sensors & vibration alerts.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">EXPLOSIVE <span>STORAGE</span></h1>
            <p className="cyber-subtitle">Air-Gapped Vault Sensors & Vibration Alerts</p>
          </div>
        </div>
      </header>
...
export default ExplosiveStorageDetailed;
