...
const aiExperts = [
  "Dynamic Bed Capacity/Occupancy Optimizer",
  "Barrack Hygiene/Sanitation Scoring AI",
  "Mess/Canteen Headcount Sync Engine",
  "Force Deployment/Return Arrival Linker",
  "Linen/Mattress Replacement Scheduler",
  "Shared Washroom Maintenance Tracker",
  "Geo-Spatial Barrack Capacity Mapper",
  "Mosquito/Pest Control Auto-Scheduler",
  "Barrack Management Dashboard",
  "Voice-Command Occupancy Bot",
  "Automated Weekly Living Condition Report",
  "Lines/Reserve Inspector (RI) Sync",
  "Overcrowding/Congestion Alert AI",
  "Infectious Disease Spread Predictor",
  "Unreported Damage/Vandalism Detector",
  "Water/Electricity Usage per Jawan Analyzer",
  "AI Evaluator for Force Welfare Index",
  "Audit/Inspection Log Generator",
  "Data Privacy/Personnel Roster Scrubber",
  "Medical/Hospital Department Sync",
  "Barrack Commander Inspection App",
  "Historical Festival Deployment Correlator",
  "Commandant/SP (Lines) Briefing AI",
  "Housekeeping/Sweeper Task Allocator",
  "Blockchain Immutable Hygiene Hash",
  "Anti-Tamper Occupancy Record Shield",
  "Mobile App for Jawan Grievance/Request",
  "Battalion-wise Living Standard Benchmarker",
  "Automated Alert for Severe Unhygienic Conditions",
  "Historical Barrack Maintenance Cost Analyzer",
  "Barrack Discipline/Upkeep SOP Trainer",
  "CCTV/Access Control Health Monitor",
  "Imminent Dengue/Malaria Outbreak Alert",
  "Habitual Rule-Breaker/Vandal Profiler",
  "High-Capacity (Training Center) Barrack Classifier",
  "AI Assisted Capacity Expansion Proposal Drafter",
  "Occupancy Data Storage Forecaster",
  "Secure Force Deployment Strength Protector",
  "Integration with HRMS/Leave Management",
  "Force Welfare Committee Sync",
  "Election Mass Deployment Billeting Modeler",
  "Disaster Relief Force Accommodation Coordinator",
  "Barrack Upkeep/Welfare Budget Tracker",
  "Custom Workflow for Female Officer Barracks",
  "AI Driven Peak Occupancy Predictor",
  "Predictive Need for Mobile Toilets/Tents",
  "Custom Alert Trigger for ADG Armed Police",
  "Check-in to Check-out Lifecycle Tracker"
];
...
const PoliceBarrackManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI POLICE BARRACK MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI POLICE BARRACK <span>MANAGEMENT</span></h1>
...
export default PoliceBarrackManagementDetailed;
