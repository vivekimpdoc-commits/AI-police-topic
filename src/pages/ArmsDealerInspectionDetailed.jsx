...
const aiExperts = [
  "Stock Register/Inventory Auditing AI",
  "Ammunition Sales/Quota Validation Engine",
  "Physical Security (Vault/CCTV) Assessment Bot",
  "Discrepancy/Missing Weapon Flagging AI",
  "Buyer License (UIN) Verification Engine",
  "Geo-Spatial Dealer Location/Proximity Mapper",
  "Suspicious Bulk Purchase Analyzer",
  "License Expiry/Renewal Tracker (Dealer)",
  "Dealer Inspection Dashboard",
  "Voice-Command Stock Query Bot",
  "Automated Quarterly Dealer Audit Report",
  "National Database of Arms Licenses (NDAL) Sync",
  "Black-Market Diversion Risk Predictor",
  "Unregistered Sale/Fake Entry Alert",
  "Security Vulnerability (Vault/Alarm) Analyzer",
  "Inspection Overdue/Pendency Estimator",
  "AI Evaluator for Dealer Compliance Index",
  "Audit/Inspection Log Generator",
  "Data Privacy/Buyer Detail Scrubber",
  "State Arms Cell/Home Department Sync",
  "Inspecting Officer/SHO Mobile App",
  "Historical Dealer Infraction Correlator",
  "City Magistrate/SP (City) Briefing AI",
  "Surprise Inspection Task Allocator",
  "Blockchain Immutable Stock Verification Hash",
  "Anti-Tamper Audit Report Shield",
  "Mobile App for On-Site Video/Photo Upload",
  "Station-wise Inspection Compliance Benchmarker",
  "Automated Alert for Discrepant Ammunition Sales",
  "Historical Dealer Profit/Tax Correlation Analyzer",
  "Arms Rules Compliance/Inspection SOP Trainer",
  "Dealer Inventory Portal API Monitor",
  "Imminent Stock Audit Deadline Alert",
  "Habitual Rule-Breaking Dealer Profiler",
  "High-Risk (Bulk/Restricted Ammunition) Classifier",
  "AI Assisted Show-Cause Notice Drafter",
  "Weapon Sales/Trend Forecaster",
  "Secure Confidential Informant Protector",
  "Integration with Commercial Tax/GST Data",
  "Local Intelligence Unit (LIU) Sync",
  "Election Fast-Track Dealer Stock Sealing Modeler",
  "Disaster/Riot Immediate Dealer Closure Coordinator",
  "Inspection Team Transport Budget Tracker",
  "Custom Workflow for Gunsmith/Repair Workshop Audits",
  "AI Driven Infraction Probability Predictor",
  "Predictive Need for Inter-State Dealer Coordination",
  "Custom Alert Trigger for District Magistrate",
  "Inspection Date to Compliance Resolution Timeline"
];
...
const ArmsDealerInspectionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ARMS DEALER INSPECTION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ARMS DEALER <span>INSPECTION</span></h1>
...
export default ArmsDealerInspectionDetailed;
