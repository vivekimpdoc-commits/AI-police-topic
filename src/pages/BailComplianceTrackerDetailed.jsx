...
const aiExperts = [
  "Bail Condition Extraction/NLP Analyzer",
  "Police Station Attendance Log Integrator",
  "Surety/Guarantor Verification Scorer",
  "Bail Expiry/Extension Alert Bot",
  "Flight Risk/Absconder Predictor Engine",
  "Bail Violation/Crime Recidivism Correlator",
  "CCTNS/E-Courts Bail Sync",
  "Bail Cancellation Request Generator AI",
  "Bail Compliance Dashboard",
  "Voice-Command Compliance Query Bot",
  "Automated Defaulter Alert Report",
  "Inter-District/State Sync Bot",
  "Geo-Spatial Geofence (City Limits) Monitor",
  "Biometric/Face-Scan Attendance Verifier",
  "Fake Surety/Forged Document Detector",
  "Passport/Travel Ban Monitor",
  "AI Evaluator for IO Monitoring Efficiency",
  "Audit/Attendance Log Generator",
  "Data Privacy/Juvenile Bail Scrubber",
  "Directorate of Prosecution Sync",
  "Field IO Bail Check App",
  "Historical Bail Jumping Pattern Matcher",
  "SHO/Supervisory Officer Briefing",
  "Surveillance Resource Allocator",
  "Blockchain Immutable Attendance Hash",
  "Anti-Tamper Compliance Shield",
  "Mobile App for Remote GPS Check-in",
  "Jurisdiction Polygon Matcher",
  "Multi-Lingual Court Order Translator",
  "Historical Recidivism Rate Analyzer",
  "Bail Monitoring SOP Trainer",
  "Bail DB Server Health Monitor",
  "Imminent Flight Risk Alert Bot",
  "Organized Syndicate Surety Profiler",
  "High-Profile Accused Classifier",
  "AI Assisted Cancellation Application Drafter",
  "Biometric Data Storage Forecaster",
  "Secure Informant Link Protector",
  "Integration with Immigration/Airport APIs",
  "Citizen Surety Verification Portal",
  "Mass Arrest Bail Trend Modeler",
  "Disaster Disrupted Attendance Tracker",
  "Surveillance Ops Budget Tracker",
  "Custom Workflow for High Court Appeals",
  "AI Driven Violation Probability Predictor",
  "Predictive Need for Asset Attachment",
  "Custom Alert Trigger for Nodal Officers",
  "Bail Lifecycle Timeline Tracker"
];
...
const BailComplianceTrackerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI BAIL COMPLIANCE TRACKER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI BAIL COMPLIANCE <span>TRACKER</span></h1>
...
export default BailComplianceTrackerDetailed;
