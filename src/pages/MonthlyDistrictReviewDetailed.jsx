...
const aiExperts = [
"SP/SSP Monthly Performance Scorer",
  "YoY/MoM Crime Statistic Correlator",
  "Monthly Budget & Resource Utilization AI",
  "District-wise Crime Rate Heatmap",
  "Monthly Conviction & Acquittal Analytics",
  "Pending Investigation Monthly Backlog AI",
  "Monthly Cyber Crime MO Evolution Bot",
  "Traffic/Fatality Monthly Trend Modeler",
  "Women/Child Safety Monthly Audit",
  "Narcotics/Contraband Monthly Seizure ROI",
  "Organized Crime/Gang Monthly Takedown",
  "Monthly Riot/Law & Order Incident Review",
  "Monthly Jansunwai (Grievance) SLA Scorer",
  "Monthly Officer Commendation & Reward AI",
  "Suspension/Disciplinary Monthly Tally",
  "Police Station Monthly Cleanliness Audit",
  "Vehicle/Fleet Monthly Fuel & Repair ROI",
  "Armoury/Ammunition Monthly Stock Audit",
  "Malkhana (Evidence Room) Monthly Disposal",
  "Monthly Court Summons/Warrant Compliance",
  "CCTNS Data Quality Monthly Rater AI",
  "Monthly Media & Public PR Sentiment AI",
  "Social Media Threat Monthly Trajectory",
  "VIP Security Monthly Cost Analyzer",
  "Election/Political Event Monthly Review",
  "Festival/Religious Gathering Monthly Log",
  "Monthly Intelligence/Special Branch Yield",
  "Interstate Border Monthly Interception AI",
  "Monthly E-Challan & Fine Revenue Sync",
  "Monthly Police Training/Fitness Rater",
  "Monthly Public Trust/Feedback Index AI",
  "Automated Monthly Review PPT Generator",
  "Monthly Review Voice/Video Brief Gen",
  "Senior Level (DGP/Home Ministry) Sync Bot",
  "Predictive Crime Mapping for Next Month",
  "Monthly Informant Reward Payout ROI AI",
  "Prison/Jail Monthly Capacity/Incident Log",
  "Parole/Bail Jumper Monthly Arrest Tally",
  "Illegal Mining/Forest Crime Monthly Sync",
  "Railway/Transport Police Monthly Review",
  "Tourist Police Monthly Impact Analyzer",
  "Monthly Disaster/Rescue Mission Summary",
  "Cyber Cell Monthly Resolution Rate Bot",
  "Monthly Drone/CCTV Uptime & ROI Audit",
  "Monthly Command Center Operations Review",
  "Cross-District Monthly Performance Ranker",
  "Monthly Review Multi-Lingual Output Bot",
  "Automated Monthly Review Distribution AI",
  "Monthly Action Item Follow-up Tracker",
  "Historical Monthly Trend vs Current AI",
  "Monthly Budget Shortfall Predictor Bot",
  "Monthly Police Welfare/Health Camp ROI",
  "Departmental Promotion/Transfer Monthly Log",
  "Monthly Legal/RTI Compliance Audit AI",
  "Monthly Cybersecurity Breach Attempt Log",
  "Monthly Digest Blockchain Audit Trail",
  "AI Generated Monthly Strategy Drafter",
  "Monthly Public Alert System Effectiveness",
  "Monthly Inter-Agency Joint Ops Review",
  "AI Executive Summary for Chief Minister"
];
...
const MonthlyDistrictReviewDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI MONTHLY DISTRICT REVIEW
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI MONTHLY DISTRICT REVIEW</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in sp/ssp performance analytics, yoy crime statistics & budget utilization.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI MONTHLY DISTRICT <span>REVIEW</span></h1>
            <p className="cyber-subtitle">SP/SSP Performance Analytics, YoY Crime Statistics & Budget Utilization</p>
          </div>
        </div>
      </header>
...
export default MonthlyDistrictReviewDetailed;
