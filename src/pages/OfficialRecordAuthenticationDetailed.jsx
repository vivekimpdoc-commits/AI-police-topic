...
const aiExperts = [
  "Digital Signature (DSC) Verification Engine",
  "Digital/Invisible Watermarking AI",
  "Tamper/Modification Detection Bot",
  "Blockchain Hashing/Immutability Logger",
  "Forged Seal/Stamp OCR Detector",
  "Metadata/EXIF Data Analyzer",
  "Geo-Spatial Authentication Request Mapper",
  "Document Version/Hash Comparator",
  "Record Authentication Dashboard",
  "Voice-Command Validity Query Bot",
  "Automated Monthly Tamper Attempt Report",
  "State IT Department/Certifying Authority Sync",
  "Cross-Reference Verification with Source",
  "Deepfake/AI-Manipulated Image Detector",
  "Expired/Revoked Signature Predictor",
  "Audit Trail/Chain of Custody Generator",
  "AI Evaluator for Document Integrity",
  "Audit/Verification Log Generator",
  "Data Privacy/PII Scrubber",
  "Law/Prosecution Department Sync",
  "Investigating Officer Verification App",
  "Historical Forgery/Fraud Correlator",
  "Supervisory Officer/Cyber Cell Briefing AI",
  "Forensic Review Task Allocator",
  "Blockchain Immutable Audit Hash",
  "Anti-Tamper Cryptographic Shield",
  "Mobile App for QR/Barcode Verification",
  "Department-wise Fraud Attempt Benchmarker",
  "Automated Alert for Failed Authentication",
  "Historical Verification Cost/Time Analyzer",
  "Digital Authentication SOP Trainer",
  "Blockchain/Crypto Server Health Monitor",
  "Imminent Large-Scale Forgery Alert",
  "Habitual Forger/Syndicate Profiler",
  "High-Stakes Court Evidence Classifier",
  "AI Assisted FIR/Legal Action Drafter",
  "Hash Ledger Storage Forecaster",
  "Secure Master Key/Certificate Protector",
  "Integration with E-Courts/DigiLocker",
  "Citizen Document Verification Portal Sync",
  "Election Affidavit Authentication Modeler",
  "Disaster Relief Claim Verification Coordinator",
  "Cyber Security/Crypto Budget Tracker",
  "Custom Workflow for Disputed Documents",
  "AI Driven Forgery Trend Predictor",
  "Predictive Need for Upgraded Encryption",
  "Custom Alert Trigger for Nodal Officer",
  "Document Authentication/Validity Timeline"
];
...
const OfficialRecordAuthenticationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI OFFICIAL RECORD AUTHENTICATION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI OFFICIAL RECORD <span>AUTHENTICATION</span></h1>
...
export default OfficialRecordAuthenticationDetailed;
