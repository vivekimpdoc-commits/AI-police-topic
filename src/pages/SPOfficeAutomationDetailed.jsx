...
const aiExperts = [
  "District Command Dashboard AI",
  "Thana/SHO Performance Scorecard Engine",
  "Automated Daily Situation Report (DSR) Generator",
  "Public Grievance/Jan-Sunwai Tracker",
  "Force Deployment/Law & Order Optimizer",
  "Crime Review Meeting (CRM) Automator",
  "Geo-Spatial District Crime/Patrol Mapper",
  "VIP Movement/Protocol Tracker",
  "SP Office Automation Dashboard",
  "Voice-Command District Query Bot",
  "Automated Weekly Crime Review Report",
  "DIG/IG Command Sync",
  "Grievance Sentiment/Urgency Analyzer",
  "Burking/Non-Registration of FIR Detector",
  "Caste/Communal Tension Predictor",
  "CRM Minutes of Meeting (MoM) Generator",
  "AI Evaluator for District Policing Index",
  "Audit/DSR Log Generator",
  "Data Privacy/Complainant Info Scrubber",
  "District Magistrate/Collectorate Sync",
  "SP Mobile Command App",
  "Historical District Crime/Festival Correlator",
  "Reader/PRO Briefing AI",
  "Task/Resource Re-allocation Engine",
  "Blockchain Immutable Grievance Hash",
  "Anti-Tamper DSR Shield",
  "Mobile App for Field Inspection Notes",
  "Thana-wise (SHO) Performance Benchmarker",
  "Automated Alert for PHQ/CM Deadlines",
  "Historical Grievance Resolution Analyzer",
  "District Policing/Patrol SOP Trainer",
  "District Database Server Health Monitor",
  "Imminent Riot/L&O Breakdown Alert",
  "Non-Performing SHO/Beat Officer Profiler",
  "High-Priority Heinous/Women Crime Classifier",
  "AI Assisted Suspension/Reward Order Drafter",
  "District Data Storage Forecaster",
  "Secure VIP Movement Layout Protector",
  "Integration with CCTNS/Dial 112",
  "Public Grievance Portal (CM Helpline) Sync",
  "Election District Deployment Modeler",
  "Disaster District Relief Coordinator",
  "District Level Budget/Fund Tracker",
  "Custom Workflow for Magisterial Inquiries",
  "AI Driven Crime Surge Predictor",
  "Predictive Need for Extra Force (PAC/RAF)",
  "Custom Alert Trigger for SP",
  "District Grievance/Crime Timeline Tracker"
];
...
const SPOfficeAutomationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SP OFFICE AUTOMATION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SP OFFICE <span>AUTOMATION</span></h1>
...
export default SPOfficeAutomationDetailed;
