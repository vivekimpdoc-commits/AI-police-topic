...
const aiExperts = [
  "Overhead Tank Level/Telemetry AI",
  "Pipe Leakage/Pressure Drop Detector",
  "RO/Water Purification Plant Health Scorer",
  "Barrack/Mess Water Usage Optimizer",
  "Automated Borewell/Pump Scheduler",
  "TDS/Water Quality Anomaly Alert",
  "Geo-Spatial Campus Water Network Mapper",
  "Rainwater Harvesting Yield Tracker",
  "Water Supply Dashboard",
  "Voice-Command Water Query Bot",
  "Automated Weekly Water Consumption Report",
  "Municipal/Jal Board Sync",
  "Underground Pipe Burst Predictor",
  "Tap Left Open/Wastage Alert",
  "Pump Motor Burnout/Overheating Predictor",
  "Supply vs Demand Deficit Analyzer",
  "AI Evaluator for Water Conservation Index",
  "Audit/Usage Log Generator",
  "Data Privacy/Barrack Roster Scrubber",
  "Estate/PWD Department Sync",
  "Plumber/Maintenance Mobile App",
  "Historical Summer Drought Correlator",
  "Commandant/SP (Lines) Briefing AI",
  "Repair/Filter Replacement Task Allocator",
  "Blockchain Immutable Water Quality Hash",
  "Anti-Tamper Sensor Log Shield",
  "Mobile App for Leak Reporting",
  "Battalion-wise Water Efficiency Benchmarker",
  "Automated Alert for Critical Tank Low",
  "Historical Water Tanker Expense Analyzer",
  "Water Conservation SOP Trainer",
  "IoT Level/Pressure Sensor Monitor",
  "Imminent Complete Water Outage Alert",
  "Habitual Water Waster Profiler",
  "Critical (Hospital/Mess) Supply Classifier",
  "AI Assisted RO Maintenance Penalty Drafter",
  "Consumption/Telemetry Data Forecaster",
  "Secure SCADA/Water Control Protector",
  "Integration with State Ground Water Board",
  "Health/Sanitation Portal Sync",
  "Election Mass Barrack Water Demand Modeler",
  "Disaster Relief Camp Water Coordinator",
  "Plumbing/Water Utility Budget Tracker",
  "Custom Workflow for Emergency Tanker Indent",
  "AI Driven Daily Demand Predictor",
  "Predictive Need for Borewell Deepening",
  "Custom Alert Trigger for RI (Reserve Inspector)",
  "Leak Detection to Repair Timeline"
];
...
const WaterSupplyMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI WATER SUPPLY MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI WATER SUPPLY <span>MONITORING</span></h1>
...
export default WaterSupplyMonitoringDetailed;
