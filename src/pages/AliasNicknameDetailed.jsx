...
const aiExperts = [
  "Phonetic Name Similarity Matcher",
  "Social Media Handle Resolver AI",
  "Underworld Nickname/Slang Decoder",
  "Tattoo/Physical Mark Identity Linker",
  "Modus Operandi (MO) Alias Correlator",
  "Cross-Platform Identity Resolution",
  "False Identity Document Flagging Bot",
  "Biometric to Alias Matcher AI",
  "Alias Resolution Dashboard",
  "Voice-Command Alias Query Bot",
  "Automated Identity Dossier Generator",
  "Inter-State Alias De-duplication Bot",
  "Linguistic Origin Analyzer AI",
  "Cyber-Criminal Avatar Tracker",
  "Alias Frequency/Usage Heatmapper",
  "Stolen Identity Conflict Resolver",
  "AI Evaluator for Match Confidence",
  "Audit/Alias Search Log Generator",
  "Data Privacy/Mistaken Identity Scrubber",
  "CCTNS Alias Database Sync Bot",
  "Field Patrol Alias Lookup App",
  "Cold Case Alias Re-investigation AI",
  "Investigating Officer Briefing AI",
  "Alias Pattern Evolution Tracker",
  "Blockchain Immutable Identity Hash",
  "Anti-Tamper Identity Profile Shield",
  "Mobile App for Quick Alias Search",
  "Alias Geolocation Consistency Matcher",
  "Multi-Lingual Nickname Translator",
  "Historical Alias Usage Analyzer",
  "Identity Verification SOP Trainer AI",
  "Alias DB Server Health Monitor",
  "High-Value Target Alias Alert Bot",
  "Organized Crime Alias Profiler",
  "VIP Stalker Alias Classifier Bot",
  "AI Assisted Identity Reveal Draft",
  "Alias Database Storage Forecaster",
  "Secure Informant Identity Protector",
  "Integration with Aadhaar/Passport DB",
  "Citizen Suspicious Person Alias Scorer",
  "Mob Instigator Alias Modeler",
  "Disaster Fraudster Alias Coordinator",
  "Alias Investigation Resource Tracker",
  "Custom Workflow for Identity Merge",
  "AI Driven New Alias Generation Predictor",
  "Predictive Need for Physical Surveillance",
  "Custom Alert Trigger for ID Leads",
  "Alias Lifecycle Timeline Tracker"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ALIAS MATCHING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ALIAS <span>MATCHING</span></h1>
...
export default AliasNicknameDetailed;
