        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <Network className="inline-icon" size={28} /> AI Alias & Nickname Matching
            </h2>
            <div className="glass-card" style={{ padding: '2rem' }}>
              <p style={{ fontSize: '1.1rem', color: '#e2e8f0', lineHeight: '1.8' }}>
                The <strong>AI Alias & Nickname Matching</strong> is a highly advanced neural subsystem designed to automate and enhance intelligence gathering, link analysis, and predictive mapping for law enforcement agencies.
              </p>
            </div>
