...
const aiExperts = [
"Dial 112 Intelligent Call Routing AI",
  "Nearest Available Responder Mapper",
  "Dynamic Call Queue Load Balancer",
  "Emergency vs Non-Emergency Triage Bot",
  "Traffic-Aware Patrol Routing AI",
  "High-Priority/SOS Call Escalation AI",
  "Caller Geolocation Triangulator",
  "Voice Emotion/Panic Scorer AI",
  "Multi-Lingual Caller Intent Decoder",
  "Automated Dispatch Ticket Drafter",
  "Repeat Caller/Spam Filter AI",
  "Fake/Prank Call Detection Modeler",
  "Dispatcher Fatigue/Burnout Predictor",
  "Shift Handover Dispatch Sync Bot",
  "Cross-Jurisdiction Handoff Router",
  "Ambulance/Fire Relay Coordinator AI",
  "VIP Distress Priority Routing AI",
  "Women/Child Helpline (1090/1098) Link",
  "Senior Citizen Priority Dispatch Bot",
  "Domestic Violence Silent Call Analyzer",
  "Kidnapping/Hostage Situation Dispatcher",
  "Armed Robbery Rapid Response AI",
  "Riot/Mob Violence Force Optimizer",
  "Disaster/Earthquake Rescue Dispatcher",
  "Highway/Accident Pile-up Response AI",
  "Cyber Crime Helpdesk Call Router",
  "Traffic/E-Challan Query Diverter",
  "Lost & Found Article Call Handler",
  "Public Event/Festival Crowd Dispatch AI",
  "Election Booth Incident Router",
  "Railway/Transport Police Relay Bot",
  "Tourist/Foreigner Assist Dispatcher",
  "Animal/Wildlife Rescue Call Link",
  "Medical/Blood Emergency Dispatch AI",
  "Drone/CCTV Feed Link to Dispatcher",
  "Officer Body-Cam Live Feed Trigger",
  "Historical Dispatch Time (ETA) Correlator",
  "Predictive Crime Hotspot Dispatch AI",
  "Resource/Vehicle Availability Sync",
  "Armoury/Special Weapons Dispatch Link",
  "Command Center Real-Time CAD Dashboard",
  "Automated Follow-up Call Dispatcher",
  "Call Abandonment/Drop Recovery Bot",
  "Dispatcher Script/FAQ Suggester AI",
  "Court/Warrant Query Dispatch Link",
  "Inter-Agency Joint Task Force Router",
  "Post-Incident Dispatch Effectiveness Rater",
  "Public Feedback on Response Time AI",
  "Network/Telecom Outage Dispatch Bypass",
  "Satellite Phone/VHF Dispatch Fallback",
  "Automated Voice-over/TTS Dispatch Relayer",
  "Radio Chatter to CAD Sync Bot",
  "Blockchain Immutable Dispatch Logger",
  "AI-Generated Dispatch Analytics Report",
  "Local Slang/Dialect NLP Call Parser",
  "Suicide/Crisis Intervention Dispatch Link",
  "Mass Casualty Incident (MCI) Triage AI",
  "Undercover Officer Extraction Dispatch",
  "Suspect Pursuit/Chase Vector Planner",
  "AI Dispatch Training Simulator"
];
...
const CallDispatchOptimizationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CALL DISPATCH OPTIMIZATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI CALL DISPATCH OPTIMIZATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in 112 cad routing, nearest responder mapping & dynamic queue balancing.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CALL DISPATCH <span>OPTIMIZATION</span></h1>
            <p className="cyber-subtitle">112 CAD Routing, Nearest Responder Mapping & Dynamic Queue Balancing</p>
          </div>
        </div>
      </header>
...
export default CallDispatchOptimizationDetailed;
