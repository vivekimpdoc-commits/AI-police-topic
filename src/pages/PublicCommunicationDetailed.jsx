...
const aiExperts = [
"Bulk SMS Routing & Optimization AI",
  "Automated Robo-Call Dispatcher",
  "Vernacular Voice Blast Bot",
  "Community Trust Scoring Modeler",
  "WhatsApp/Telegram Broadcast AI",
  "Geo-Fenced Public Alert Router",
  "Public Awareness Campaign ROI AI",
  "Event/Festival Crowd Advisory Bot",
  "Cyber Crime Awareness Scheduler",
  "Women/Child Safety Outreach Bot",
  "Neighborhood Watch Comms Sync",
  "Missing Person Amber Alert Blast",
  "Traffic Advisory & Diversion AI",
  "Weather & Disaster Evacuation Bot",
  "Election Security Assurance Blast",
  "Wanted Criminal BOLO Broadcaster",
  "Stolen Vehicle SMS Alert Sync",
  "Public Feedback & Survey Dispatch",
  "Police Recruitment Drive Outreach",
  "Pension/Welfare Comms for Seniors",
  "Anonymous Tip-Line SMS Gateway",
  "VIP Visit Route Blockade Advisory",
  "Riot/Curfew Section 144 Broadcaster",
  "Fake News Debunking SMS Blast",
  "Two-Way SMS Query Responder AI",
  "Outbound Call Answer Rate Predictor",
  "Public Outreach Channel Balancer",
  "Telecom Network Congestion AI",
  "Multi-Lingual SMS Auto-Translator",
  "Police Station Contact Card Sync",
  "Community Policing Newsletter Sync",
  "School/College Safety Broadcast",
  "NGO/Civil Society Comms Sync",
  "Public Address (PA) System Link AI",
  "Drone Speaker/Audio Relay Bot",
  "Smart City Billboard Alert Sync",
  "Digital Display Board Router AI",
  "Social Media to SMS Failover AI",
  "Automated Apology/Clarification Dispatch",
  "Aadhar/Mobile DB Sync for Outreach",
  "Public Emotion & Panic Modeler",
  "Emergency Voice-Bot Responder",
  "Citizen App Push Notification Sync",
  "Telecom Provider Outage Alert",
  "Targeted Demographics Outreach AI",
  "SMS Delivery Receipt Analytics AI",
  "Language-Specific Voice Over Gen",
  "Public Comm API Rate Limiter",
  "Do-Not-Disturb (DND) Override AI",
  "Mass Email Dispatch & Tracking Bot",
  "Inter-Departmental Comms Sync",
  "Police Event Invitation Sender AI",
  "Public Health/Epidemic Comms Sync",
  "Automated Follow-Up Broadcast Bot",
  "Suspicious Link Phishing Checker",
  "Citizen Comm Behavior Analytics",
  "Command Center Broadcast Dashboard",
  "Voice Phishing (Vishing) Alert Bot",
  "Public Chatbot Integration Sync",
  "AI-Powered Town-Hall Moderator"
];
...
const PublicCommunicationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI PUBLIC COMMUNICATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI PUBLIC COMMUNICATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in community outreach, bulk sms/voice routing & public trust scoring.
            </p>
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            ...
            <p className="cyber-subtitle">Community Outreach, Bulk SMS/Voice Routing & Public Trust Scoring</p>
          </div>
        </div>
      </header>
...
export default PublicCommunicationDetailed;
