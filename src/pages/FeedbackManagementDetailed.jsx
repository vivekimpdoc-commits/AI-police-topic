...
const aiExperts = [
"Police Station Rating Analyzer",
  "Officer Behavior NLP Flagging",
  "Automated Feedback Follow-up Bot",
  "Citizen Satisfaction Index Modeler",
  "Fake Review & Spam Filter AI",
  "Corruption & Bribery Tip Analyzer",
  "Interrogation Room Feedback Sync",
  "Traffic Cop Behavior Scorer",
  "Emergency Response (112) Rater",
  "Jansunwai Resolution Feedback AI",
  "Social Media Sentiment Scraper",
  "Vernacular Feedback Translator",
  "Voice Call Emotion/Tone Analyzer",
  "Anonymous Feedback Validator",
  "Negative Feedback Escalation Router",
  "Officer Empathy Scorer AI",
  "Police Station Cleanliness Rater",
  "FIR Registration Hassle Modeler",
  "Women Desk Effectiveness Analyzer",
  "Child-Friendly Station Scorer",
  "Senior Citizen Care Auditor",
  "LGBTQ+ Sensitivity Feedback Bot",
  "Community Policing Impact Analyzer",
  "Feedback Trend vs Crime Rate AI",
  "Officer Reward & Recognition Bot",
  "Repeat Offender Complaint Filter",
  "RTI Response Satisfaction Modeler",
  "Passport Verification Feedback AI",
  "Tenant Verification Ease Scorer",
  "Cyber Cell Resolution Rater",
  "Traffic E-Challan Dispute Analyzer",
  "Feedback Keyword Cloud Generator",
  "Officer Stress vs Behavior Correlator",
  "Automated Show-Cause Drafter",
  "Training Needs Predictor via Feedback",
  "Public Trust Index Calculator",
  "District-wise Performance Heatmap",
  "Mobile App Usability Feedback AI",
  "Citizen Portal Ease-of-Use Scorer",
  "SMS/WhatsApp Survey Dispatcher",
  "Feedback Link Expiry Predictor",
  "QR Code Scan Feedback Analytics",
  "Kiosk Feedback Face-Emotion AI",
  "Video Testimonial Analyzer Bot",
  "NGO & Civil Rights Audit Sync",
  "Media Outlet Sentiment Link AI",
  "Public Event Police Management Rater",
  "VIP Security Escort Feedback AI",
  "Tourist Police Helpfulness Scorer",
  "Border Checkpost Behavior Auditor",
  "Toll Plaza Police Intervention Rater",
  "Prison Visitor Experience Scorer",
  "Malkhana Release Experience AI",
  "Court Evidence Deposition Feedback",
  "Officer Transfer/Posting Feedback AI",
  "Predictive Attrition Risk Modeler",
  "Departmental Inquiry Sync Bot",
  "Blockchain Immutable Feedback Log",
  "Feedback Dashboard Data Sync AI",
  "Command Center Public Trust AI"
];
...
const FeedbackManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI FEEDBACK MANAGEMENT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI FEEDBACK MANAGEMENT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in police station rating analytics, officer behavior flagging & automated follow-ups.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI FEEDBACK <span>MANAGEMENT</span></h1>
            <p className="cyber-subtitle">Police Station Rating Analytics, Officer Behavior Flagging & Automated Follow-Ups</p>
          </div>
        </div>
      </header>
...
export default FeedbackManagementDetailed;
