...
const aiExperts = [
  "IoT Compressor Fault/Gas Leak Predictor",
  "Energy Consumption/Efficiency Analyzer",
  "Server Room/Armory Climate Control AI",
  "AMC (Annual Maintenance) SLA Tracker",
  "Filter Choke/Air Quality (AQI) Monitor",
  "Occupancy-based Smart Cooling Optimizer",
  "Geo-Spatial AC Inventory Mapper",
  "Power Surge/Voltage Fluctuation Correlator",
  "AC Maintenance Dashboard",
  "Voice-Command Climate Query Bot",
  "Automated Monthly Energy Savings Report",
  "State Electricity Board/Grid Sync",
  "Central HVAC vs Split AC Analytics",
  "Condensation/Water Leakage Detector",
  "Fake/Skipped Servicing Detector",
  "Refrigerant Phase-out/Compliance Scorer",
  "AI Evaluator for Cooling Efficiency",
  "Audit/Gas Refill Log Generator",
  "Data Privacy/Occupancy Sensor Scrubber",
  "IT/Data Center Management Sync",
  "Technician Dispatch Mobile App",
  "Historical Breakdown vs Weather Correlator",
  "Estate/IT Officer Briefing AI",
  "Vendor/Technician Task Allocator",
  "Blockchain Immutable Service Hash",
  "Anti-Tamper AMC Log Shield",
  "Mobile App for Temperature Complaints",
  "Brand/Model Energy Efficiency Benchmarker",
  "Automated Reminder for Filter Cleaning",
  "Historical Repair/Replacement Cost Analyzer",
  "HVAC Maintenance SOP Trainer",
  "IoT Thermostat/Gateway Health Monitor",
  "Imminent Server Room Overheating Alert",
  "Fraudulent Gas Refill Billing Profiler",
  "Critical/Server Room AC Classifier",
  "AI Assisted Eco-Friendly Replacement Drafter",
  "Sensor Telemetry Storage Forecaster",
  "Secure Data Center Layout Protector",
  "Integration with Building Management System (BMS)",
  "Officer Workspace Comfort Index Sync",
  "Heatwave Cooling Load Modeler",
  "Disaster Power-Cut Priority Coordinator",
  "Electricity Bill/AMC Budget Tracker",
  "Custom Workflow for Emergency Portable AC",
  "AI Driven Lifespan/Scrap Predictor",
  "Predictive Need for Solar/Green Energy",
  "Custom Alert Trigger for IT SP/Nodal Officer",
  "AC Unit Lifecycle Timeline Tracker"
];
...
const AirConditionerMaintenanceDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI AIR CONDITIONER MAINTENANCE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI AIR CONDITIONER <span>MAINTENANCE</span></h1>
...
export default AirConditionerMaintenanceDetailed;
