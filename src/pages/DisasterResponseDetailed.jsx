...
const aiExperts = [
  "Meteorological/Seismic Early Warning Sync",
  "Evacuation Route Optimizer Engine",
  "Drone/Satellite Aerial Damage Mapper",
  "Social Media SOS Aggregator AI",
  "Casualty/Injury Prediction Modeler",
  "Hospital Bed/Blood Bank Availability Bot",
  "Shelter/Relief Camp Capacity Tracker",
  "Missing Person Visual Matcher AI",
  "Disaster Command Dashboard",
  "Voice-Command SOS Query Bot",
  "Automated Daily Relief Report",
  "NDRF/SDRF Coordination Sync Bot",
  "Geo-Spatial Flood/Fire Polygon Mapper",
  "Telecom Network Outage Analyzer",
  "Donation/Relief Material Router AI",
  "Roadblock/Bridge Collapse Detector",
  "AI Evaluator for Resource Deficit",
  "Audit/Rescue Action Log Generator",
  "Data Privacy/Victim Detail Scrubber",
  "State Disaster Management Authority Sync",
  "Field Rescue Officer Tasking App",
  "Historical Disaster Precedent Matcher",
  "CM/Chief Secretary Briefing AI",
  "Heavy Equipment/Boat Allocator Bot",
  "Blockchain Immutable Relief Hash",
  "Anti-Tamper Fund Allocation Shield",
  "Mobile App for Ground Volunteers",
  "SOS Geolocation Cluster Matcher",
  "Multi-Lingual Rescue Instructions Translator",
  "Historical Rescue Efficiency Analyzer",
  "Disaster Response SOP Trainer",
  "Disaster DB Server Health Monitor",
  "Imminent Secondary Threat (Epidemic) Alert",
  "Looting/Scavenging Risk Profiler",
  "VIP Rescue Protocol Classifier",
  "AI Assisted Rescue Plan Drafter",
  "Aerial Imagery Storage Forecaster",
  "Secure Volunteer DB Protector",
  "Integration with Armed Forces (Army/Air Force)",
  "Citizen Damage Reporting Analytics",
  "Post-Disaster Riot/Law & Order Modeler",
  "Logistics Supply Chain Coordinator",
  "Disaster Relief Budget Tracker",
  "Custom Workflow for Air-Drop Approvals",
  "AI Driven Epidemic Outbreak Predictor",
  "Predictive Need for Central Assistance",
  "Custom Alert Trigger for Medical Teams",
  "Disaster Recovery Timeline Tracker"
];
...
const DisasterResponseDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DISASTER RESPONSE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DISASTER <span>RESPONSE</span></h1>
...
export default DisasterResponseDetailed;
