...
const aiExperts = [
"Poll Day Clash/Violence Geo-Heatmap AI",
  "Bogus Voting/Impersonation Complaint Router",
  "EVM Breakdown/Replacement Tracking Bot",
  "Quick Response Team (QRT) Auto-Dispatcher",
  "Voter Intimidation/Threat Alert Engine",
  "Political Party Worker Skirmish Predictor",
  "Social Media Rumor/Fake News Debunker AI",
  "Booth Capturing/Looting Predictive Alert",
  "Command Center Poll Day Dashboard",
  "Voice-Command Incident Query Assistant",
  "Automated Situation Report (SitRep) Sender",
  "Inter-District Force Re-allocation Engine",
  "Helicopter/Airlift Emergency Evac Tracker",
  "Weapon/Firing Incident Triangulation Bot",
  "Audio/Sentiment Analysis of Distress Calls",
  "Traffic Blockade/Road Roko Alert AI",
  "AI Evaluator for Poll Day Peacefulness %",
  "Audit/FIR Auto-Drafter for Incidents",
  "Data Privacy/Complainant Info Masker",
  "Police-Magistrate Joint Action Sync Bot",
  "Flash Strike/Boycott of Polls Alert",
  "Tear Gas/Lathi Charge Incident Logger",
  "Senior Officer (Observer/DGP) Briefing",
  "Public Advisory/Curfew Alert Drafter",
  "Blockchain Immutable Log of All Incidents",
  "Drone Surveillance Feed Sync for QRTs",
  "Mobile App for Sector Officer SOS",
  "Hospital/Ambulance Sync for Poll Injuries",
  "Multi-Lingual Distress Call Translator",
  "Historical Poll Violence Pattern Matcher",
  "Medical Emergency First-Aid Dispatch AI",
  "Force Fatigue/Stress Level Monitor Bot",
  "Temporary Checkpost Sealing Route AI",
  "Traffic Green-Corridor for QRT Dispatch",
  "Shadow Zone Offline Incident Sync Engine",
  "Armed Insurgency/Naxal Attack Alert Bot",
  "AI Assisted Post-Poll Violence Analysis",
  "Vehicle Breakdown/Tow-Truck Standby Alert",
  "VIP/Candidate Attack/Clash Alert Engine",
  "Integration with ECI cVIGIL App",
  "Citizen WhatsApp/SMS SOS Extractor AI",
  "Weather-Related Voting Disruption Alert",
  "Repoll/Countermand Recommendation Gen",
  "Incident Response Logistics/Fuel Tracker",
  "Custom Workflow/Approval for Firing",
  "AI Driven Riot De-escalation Predictor",
  "Predictive Need for Paramilitary Backup",
  "Custom Alert Trigger for Control Room"
];
...
const PollDayIncidentTrackerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI POLL DAY INCIDENT TRACKER
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI POLL DAY INCIDENT TRACKER</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in real-time reporting of clashes, fake voting, breakdowns & qrt dispatch.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI POLL DAY INCIDENT <span>TRACKER</span></h1>
            <p className="cyber-subtitle">Real-time Reporting of Clashes, Fake Voting, Breakdowns & QRT Dispatch</p>
          </div>
        </div>
      </header>
...
export default PollDayIncidentTrackerDetailed;
