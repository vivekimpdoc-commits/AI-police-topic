...
const aiExperts = [
  "Evidence SHA-256 Hash Generator Bot",
  "Immutable Timestamp Ledger for FIRs",
  "Custody Transfer Smart Contract Engine",
  "Police-FSL Blockchain Handover Sync",
  "Court-Admissible Blockchain Certificate AI",
  "Multi-Agency Distributed Ledger Node",
  "Seizure Memo Blockchain Registration",
  "Digital Signature + Blockchain Combo Verifier",
  "Blockchain Registry Command Dashboard",
  "Voice-Command Ledger Query Assistant",
  "Automated Block Mining/Validation Bot",
  "Cross-State Blockchain Evidence Sync",
  "Hyperledger Fabric Police Network Manager",
  "Evidence Alteration/Fork Detection AI",
  "Witness Statement Blockchain Timestamp",
  "Forensic Report Blockchain Seal Generator",
  "AI Evaluator for Blockchain Integrity %",
  "Audit/Consensus Log Auto-Generator",
  "Data Privacy/Zero-Knowledge Proof Engine",
  "Police-Prosecution Blockchain Share Link",
  "Cyber Crime Digital Artifact Hasher",
  "Financial Crime Transaction Ledger AI",
  "Senior Officer (IT/Cyber) Briefing Bot",
  "Public Verification QR Code Generator",
  "Smart Contract for Automatic Evidence Lock",
  "Ransomware Recovery Blockchain Backup",
  "Mobile App for IO Field Hash Upload",
  "Multi-Chain Interoperability Bridge AI",
  "Multi-Lingual Blockchain Status Translator",
  "Historical Evidence Re-Hashing Engine",
  "Departmental Enquiry Blockchain Trail",
  "Node Health/Uptime Monitor AI",
  "Temporary Evidence Hold Smart Contract",
  "Traffic Challan Blockchain Receipt Bot",
  "Narcotics Seizure Chain-of-Custody Ledger",
  "Post-Mortem Report Blockchain Seal",
  "AI Assisted Post-Trial Archival on Chain",
  "Expired Block Pruning/Cleanup Engine",
  "VIP Threat Intel Immutable Ledger AI",
  "Integration with National Judicial Data Grid",
  "Citizen Evidence Submission Blockchain Bot",
  "Gas Fee/Transaction Cost Optimizer AI",
  "Disaster Recovery Multi-Node Replication",
  "Blockchain Infrastructure Budget Tracker",
  "Custom Workflow/Approval for Chain Write",
  "AI Driven Consensus Attack Predictor",
  "Predictive Need for Node Scaling",
  "Custom Alert Trigger for Blockchain Admin"
];
...
const BlockchainEvidenceRegistryDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI BLOCKCHAIN EVIDENCE REGISTRY
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI BLOCKCHAIN EVIDENCE REGISTRY</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in distributed ledger for evidence hashing, timestamping & tamper-proof custody.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI BLOCKCHAIN EVIDENCE <span>REGISTRY</span></h1>
            <p className="cyber-subtitle">Distributed Ledger for Evidence Hashing, Timestamping & Tamper-Proof Custody</p>
          </div>
        </div>
      </header>
...
export default BlockchainEvidenceRegistryDetailed;
