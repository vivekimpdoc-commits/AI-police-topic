...
const aiExperts = [
  "Reagent/Chemical Expiry Predictor AI",
  "Hazardous Material/MSDS Compliance Checker",
  "Automated Procurement/Indent Trigger Engine",
  "Usage Anomaly/Pilferage Detector",
  "Storage Condition (Temp/Humidity) Monitor",
  "Batch/Lot Traceability Linker",
  "Geo-Spatial Lab Inventory Layout Mapper",
  "First-In-First-Out (FIFO) Optimization Bot",
  "Chemical Inventory Dashboard",
  "Voice-Command Stock Query Bot",
  "Automated Monthly Consumption/Expiry Report",
  "State Procurement/Store Department Sync",
  "Imminent Stock-out (Critical Reagent) Predictor",
  "Chemical Degradation/Spoilage Alert",
  "Suspicious/Excessive Usage (Pilferage) Flagging AI",
  "Incompatible Chemical Storage/Fire Hazard Detector",
  "AI Evaluator for Inventory Optimization Index",
  "Audit/Consumption Log Generator",
  "Data Privacy/Vendor Pricing Scrubber",
  "Fire & Safety Department Sync",
  "Storekeeper/Lab Analyst Mobile App",
  "Historical Expiry/Wastage Cost Correlator",
  "FSL Director (Stores) Briefing AI",
  "Re-order/Disposal Task Allocator",
  "Blockchain Immutable Inventory/Lot Hash",
  "Anti-Tamper Stock Register Shield",
  "Mobile App for Barcode/QR Scanning",
  "Division-wise Chemical Wastage Benchmarker",
  "Automated Alert for Expired/Degraded Reagents",
  "Historical Chemical Procurement/Disposal Cost Analyzer",
  "Hazardous Chemical Handling/Disposal SOP Trainer",
  "IoT (Storage Temp)/Barcode API Monitor",
  "Imminent Lab Fire/Toxicity (Due to Bad Storage) Alert",
  "Habitual Hoarder/Waster Analyst Profiler",
  "High-Risk (Explosive/Toxic) Chemical Classifier",
  "AI Assisted Hazardous Waste Disposal Manifest Drafter",
  "Reagent Consumption/Demand Forecaster",
  "Secure Precursor Chemical/Narcotics Standard Protector",
  "Integration with Government e-Marketplace (GeM)",
  "Pollution Control Board Sync",
  "Election Mass-Testing Reagent Demand Modeler",
  "Disaster (Chemical Spill) Antidote/Reagent Coordinator",
  "Lab Consumables/Chemicals Budget Tracker",
  "Custom Workflow for NDPS/Narcotics Standards",
  "AI Driven Next Quarter Indent Predictor",
  "Predictive Need for Safe Disposal Action",
  "Custom Alert Trigger for Lab Admin",
  "Low-Stock Detection to Replenishment Timeline"
];
...
const ChemicalInventoryDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CHEMICAL INVENTORY
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CHEMICAL <span>INVENTORY</span></h1>
...
export default ChemicalInventoryDetailed;
