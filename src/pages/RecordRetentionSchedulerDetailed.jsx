...
const aiExperts = [
  "Statutory Retention Schedule (Police Rules) Engine",
  "Automated Weeding-Out/Destruction Recommender",
  "Archival Digitization Priority Scorer",
  "Physical Storage/Compactor Optimizer",
  "Case Property/Malkhana Record Sync Bot",
  "Historical Value/Significance Classifier",
  "Geo-Spatial Record Room Mapper",
  "Duplicate/Redundant File Detector",
  "Record Retention Dashboard",
  "Voice-Command Record Query Bot",
  "Automated Monthly Weeding Report",
  "State Archives Department Sync",
  "OCR/Text Extraction for Old Records",
  "Condition/Decay (Termite/Moisture) Predictor",
  "Fake/Tampered Historical Record Detector",
  "Digital Storage Cost Calculator",
  "AI Evaluator for Record Room Efficiency",
  "Audit/Destruction Log Generator",
  "Data Privacy/Expungement Scrubber",
  "CCTNS/ICJS Sync",
  "Record Room Staff Task App",
  "Historical File Loss/Damage Correlator",
  "Supervisory Officer Briefing AI",
  "Digitization Vendor Task Allocator",
  "Blockchain Immutable Destruction Hash",
  "Anti-Tamper Archival Shield",
  "Mobile App for Barcode Scanning",
  "Category-wise Retention Matcher",
  "Multi-Lingual Indexing Translation",
  "Historical Digitization ROI Analyzer",
  "Record Management SOP Trainer",
  "Archive Server Health Monitor",
  "Imminent Unlawful Retention Alert",
  "Termite/Pest Infestation Threat Profiler",
  "Permanent/Historical Record Classifier",
  "AI Assisted Destruction Certificate Drafter",
  "Digital Archival Storage Forecaster",
  "Secure Classified Record Protector",
  "Integration with National Archives",
  "RTI Portal (for available records) Sync",
  "Election Record Retention Modeler",
  "Disaster (Fire/Flood) Record Rescue Coordinator",
  "Digitization/Storage Budget Tracker",
  "Custom Workflow for Historic Preservation",
  "AI Driven Storage Exhaustion Predictor",
  "Predictive Need for Pest Control",
  "Custom Alert Trigger for Nodal Officers",
  "Record Lifecycle Timeline Tracker"
];
...
const RecordRetentionSchedulerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI RECORD RETENTION SCHEDULER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI RECORD RETENTION <span>SCHEDULER</span></h1>
...
export default RecordRetentionSchedulerDetailed;
