...
const aiExperts = [
  "Space/Floor Plan Optimization AI",
  "Hierarchy/Rank-based Allocator",
  "Inter-Department Synergy Mapper",
  "Pandemic/Social Distancing Protocol Engine",
  "IT/Network Resource (LAN/Power) Mapper",
  "Visitor Flow/Security Zoning AI",
  "3D Geo-Spatial Office Mapper",
  "Meeting/Conference Room Usage Predictor",
  "Seating Plan Dashboard",
  "Voice-Command Desk Query Bot",
  "Automated Space Utilization Report",
  "State Police Housing/Estate Sync",
  "Hot-Desking/Flexible Seating Manager",
  "Ergonomic/Lighting Assessment Bot",
  "Unauthorized Access/Zone Breach Detector",
  "Department Relocation/Shift Planner",
  "AI Evaluator for Space Efficiency",
  "Audit/Allocation Log Generator",
  "Data Privacy/VVIP Location Scrubber",
  "Fire/Emergency Safety Protocol Sync",
  "Officer Desk Navigator Mobile App",
  "Historical Space Shortage Correlator",
  "Estate Officer/Administration Briefing AI",
  "Maintenance/Cleaning Task Allocator",
  "Blockchain Immutable Floor Plan Hash",
  "Anti-Tamper Layout Shield",
  "Mobile App for Resource Requests (AC/IT)",
  "Headquarters-wise Space Benchmarker",
  "Automated Reminder for Maintenance",
  "Historical Occupancy Trend Analyzer",
  "Office Layout/Security SOP Trainer",
  "Facilities Server Health Monitor",
  "Imminent Overcrowding/Fire Hazard Alert",
  "Resource (Power/Network) Failure Profiler",
  "High-Security/Confidential Zone Classifier",
  "AI Assisted Relocation Notice Drafter",
  "3D Model Storage Forecaster",
  "Secure Blueprint/Floor Plan Protector",
  "Integration with CCTV/Access Control",
  "Citizen Visitor Pass Route Sync",
  "Election Control Room Setup Modeler",
  "Disaster Evacuation Route Coordinator",
  "Office Furniture/IT Budget Tracker",
  "Custom Workflow for VIP Expansion",
  "AI Driven Future Space Requirement Predictor",
  "Predictive Need for New Building/Wing",
  "Custom Alert Trigger for Nodal Officers",
  "Office Layout Evolution Timeline Tracker"
];
...
const OfficeSeatingPlanDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI OFFICE SEATING PLAN
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI OFFICE SEATING <span>PLAN</span></h1>
...
export default OfficeSeatingPlanDetailed;
