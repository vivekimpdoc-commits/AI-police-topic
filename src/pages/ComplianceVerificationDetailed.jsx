...
const aiExperts = [
  "ATR vs IoT/CCTNS Data Cross-Referencer",
  "Photo/Video Evidence Authenticator AI",
  "GPS Metadata/Spoofing Detector",
  "Targeted Spot-Check/Re-Audit Router",
  "NLP-Based Document Consistency Checker",
  "Vendor Bill/Repair Invoice Validator",
  "Geo-Spatial Verification Mapper",
  "False Compliance/Bluff Probability Scorer",
  "Compliance Verification Dashboard",
  "Voice-Command Verification Query Bot",
  "Automated Monthly Validation Report",
  "State Audit/Vigilance Sync",
  "Stock-Photo/Recycled Image Predictor",
  "Collusion/Cover-up Alert",
  "Time-Stretching/Delay Tactic Analyzer",
  "Resource Misallocation Detector",
  "AI Evaluator for ATR Authenticity Index",
  "Audit/Verification Log Generator",
  "Data Privacy/Evidence Scrubber",
  "Finance/Accounts Department Sync",
  "Verification Officer/Auditor App",
  "Historical Forged Compliance Correlator",
  "ADG (Vigilance) Briefing AI",
  "Physical Re-Verification Task Allocator",
  "Blockchain Immutable Evidence Hash",
  "Anti-Tamper Verification Record Shield",
  "Mobile App for Geo-Tagged Validation",
  "Unit-wise Honesty/Integrity Benchmarker",
  "Automated Alert for High-Probability Fake ATR",
  "Historical Fraud/Wastage Cost Analyzer",
  "Evidence Collection/Audit SOP Trainer",
  "IoT/Data Ingestion API Health Monitor",
  "Imminent Audit Failure/Scandal Alert",
  "Habitual Fabricator/Liar Profiler",
  "High-Stakes (Financial/Armory) Compliance Classifier",
  "AI Assisted FIR/Vigilance Inquiry Drafter",
  "Verification Data/Image Storage Forecaster",
  "Secure Whistleblower/Audit Protector",
  "Integration with Accountant General (AG) Office",
  "Anti-Corruption Bureau Sync",
  "Election Expenditure/Deployment Validation Modeler",
  "Disaster Relief Fund Utilization Verifier",
  "Audit/Vigilance Operations Budget Tracker",
  "Custom Workflow for Court-Mandated Compliance",
  "AI Driven Verification Workload Predictor",
  "Predictive Need for Independent External Audit",
  "Custom Alert Trigger for DGP/Home Secretary",
  "ATR Submission to Final Validation Timeline"
];
...
const ComplianceVerificationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI COMPLIANCE VERIFICATION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI COMPLIANCE <span>VERIFICATION</span></h1>
...
export default ComplianceVerificationDetailed;
