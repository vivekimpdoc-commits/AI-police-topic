...
const aiExperts = [
  "Warehouse/Industrial Vulnerability Scorer",
  "Perimeter/Boundary Wall Breach Analyzer",
  "Fire Safety & Hazardous Material Auditor",
  "Night Patrol/Beat Sync Optimizer",
  "Inventory Theft/Pilferage Trend Correlator",
  "CCTV/Drone Night Surveillance AI",
  "Geo-Spatial Industrial Estate Mapper",
  "Suspicious Truck/Loading Anomaly Detector",
  "Warehouse Security Dashboard",
  "Voice-Command Estate Query Bot",
  "Automated Monthly Audit Report",
  "Fire Department/Emergency Sync Bot",
  "Guard Duty/Sleep Anomaly Analyzer",
  "Burglary/Tunneling Predictor AI",
  "Private Security Agency (PSARA) Sync",
  "Entry/Exit Log Verification Bot",
  "AI Evaluator for Estate Preparedness",
  "Audit/Inspection Log Generator",
  "Data Privacy/Corporate Inventory Scrubber",
  "State Industrial Development Corp Sync",
  "Field IO Estate Spot-Check App",
  "Historical Warehouse Burglary Correlator",
  "SHO/Supervisory Officer Briefing AI",
  "Night Patrol/Beat Allocator",
  "Blockchain Immutable Audit Hash",
  "Anti-Tamper Security Rating Shield",
  "Mobile App for Estate Managers (Report)",
  "Jurisdiction/Zone Polygon Matcher",
  "Multi-Lingual Safety Advisory Translator",
  "Historical Theft/Arson Trend Analyzer",
  "Warehouse Security Audit SOP Trainer",
  "Audit DB Server Health Monitor",
  "Imminent Perimeter Breach/Fire Alert",
  "Organized Cargo Theft Syndicate Profiler",
  "High-Value Inventory (Electronics/Pharma) Classifier",
  "AI Assisted Security Advisory Drafter",
  "Audit Image/Video Storage Forecaster",
  "Secure Corporate Vulnerability Protector",
  "Integration with Logistics/Transport DB",
  "Citizen/Worker Suspicious Reporting Sync",
  "Riot/Arson Target Security Modeler",
  "Disaster/Flood Inventory Evacuation Coordinator",
  "Audit/Patrol Expense Budget Tracker",
  "Custom Workflow for License Suspension",
  "AI Driven Burglary Probability Predictor",
  "Predictive Need for Increased Night Patrol",
...
const WarehouseSecurityDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI WAREHOUSE SECURITY ASSESSMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI WAREHOUSE SECURITY <span>ASSESSMENT</span></h1>
...
export default WarehouseSecurityDetailed;
