...
const aiExperts = [
"Digital Station Diary (e-GD) Entry Bot",
  "Biometric Malkhana (Property) Check-in/out",
  "Tablet-Based Sentry/Guard Duty Roster AI",
  "Digital Lockup/Prisoner Movement Log",
  "e-Warrant/Summons Execution Entry System",
  "Digital Absconder Check/Update Kiosk",
  "Beat Officer Digital Patrol Book App",
  "Digital Missing Persons Entry Tracker",
  "Command Center Digital Log Dashboard",
  "Voice-Command e-Register Entry Assistant",
  "Automated Timestamp & GPS Location Tagger",
  "Offline-to-Online Sync for Remote Stations",
  "Inter-Shift Duty Handover Digital Log",
  "Speech-to-Text (Local Language) e-Entry",
  "Digital Log Discrepancy/Anomaly Detector",
  "Digital FIR Auto-Numbering/Sequencing AI",
  "AI Evaluator for Digital Log Adherence",
  "Audit/Correction History Log Generator",
  "Data Privacy/Role-Based Access Control AI",
  "Police-Jail Digital Log Synchronization",
  "Digital Arms/Ammunition Issue Kiosk",
  "Digital Vehicle/Patrol Logbook (e-Log)",
  "Senior Officer (SHO/SP) e-Register Briefing",
  "Public Complaint e-Register Kiosk AI",
  "Blockchain Immutable Log of All Entries",
  "Digital Visitor/Media Entry Pass System",
  "Mobile App for IO Digital Field Notes",
  "Digital Gun License Verification Entry",
  "Multi-Lingual CCTNS Real-time Sync Bot",
  "Digital Riot/Agitation Incident Logger",
  "Passport Verification Digital Sign-off",
  "Tablet Battery/Network Connectivity Monitor",
  "Temporary Checkpost Digital Entry App",
  "Traffic E-Challan Kiosk Log Integration",
  "Digital Accident Report (DAR) Entry Bot",
  "Digital Inquest/Seizure Memo Generator",
  "AI Assisted Post-Entry Spell/Error Check",
  "Hardware/Tablet Malfunction Alert Bot",
  "VIP Movement Digital Route Logger",
  "Integration with State Police Portal",
  "Citizen E-FIR/E-Complaint Log Linker",
  "Foreigner (C-Form) Digital Verification",
  "Election Duty Digital Attendance App",
  "Digital Register Cost/Savings Tracker",
  "Custom Workflow/Approval for Log Edit",
  "AI Driven Paperless Goal Predictor",
  "Predictive Need for e-Register Training",
  "Custom Alert Trigger for Station Writer"
];
...
const ManualRegisterReplacementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI MANUAL REGISTER REPLACEMENT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI MANUAL REGISTER REPLACEMENT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in transitioning active logs into tablet-based biometric entry systems.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI MANUAL REGISTER <span>REPLACEMENT</span></h1>
            <p className="cyber-subtitle">Transitioning Active Logs into Tablet-Based Biometric Entry Systems</p>
          </div>
        </div>
      </header>
...
export default ManualRegisterReplacementDetailed;
