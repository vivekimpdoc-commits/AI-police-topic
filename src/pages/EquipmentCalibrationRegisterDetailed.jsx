...
const aiExperts = [
  "Instrument Drift Predictor AI",
  "Automated Calibration Scheduler",
  "Digital Signature/Log Authenticator",
  "NABL Compliance Checker",
  "Spectrometer/Chromatograph Health Scorer",
  "Vendor/Service AMC Tracker",
  "Geo-Spatial Lab Instrument Mapper",
  "Measurement Uncertainty Calculator AI",
  "Equipment Calibration Dashboard",
  "Voice-Command Instrument Query Bot",
  "Automated Monthly Calibration Audit Report",
  "Forensic Science Lab (FSL) Sync",
  "Calibration Expiry/Overdue Alert",
  "Fake/Forged Calibration Certificate Detector",
  "Instrument Down-Time/Failure Predictor",
  "Historical Accuracy/Variance Analyzer",
  "AI Evaluator for Instrument Reliability Index",
  "Audit/Calibration Log Generator",
  "Data Privacy/Test Record Scrubber",
  "Quality Council of India (QCI) Sync",
  "Lab Technician/Analyst Mobile App",
  "Historical Erroneous Result Correlator",
  "FSL Director Briefing AI",
  "Calibration/Service Task Allocator",
  "Blockchain Immutable Calibration Hash",
  "Anti-Tamper Instrument Log Shield",
  "Mobile App for Quick QR Code Log View",
  "Instrument-wise ROI/Lifespan Benchmarker",
  "Automated Alert for Critical Instrument Drift",
  "Historical Maintenance/Calibration Cost Analyzer",
  "Lab Instrument Handling SOP Trainer",
  "IoT/Instrument API Health Monitor",
  "Imminent Court Evidence Rejection (Due to Uncalibrated Gear) Alert",
  "Habitual Negligent Technician Profiler",
  "High-Priority (DNA/Toxicology) Instrument Classifier",
  "AI Assisted Service/Replacement Indent Drafter",
  "Instrument Lifespan/Depreciation Forecaster",
  "Secure Calibration Record Protector",
  "Integration with E-Courts (Evidence Validation)",
  "State Procurement Portal Sync",
  "Election Forensic (EVM Tampering) Gear Readiness Modeler",
  "Disaster (Chemical Leak) Analyzer Readiness Coordinator",
  "Lab Equipment Maintenance Budget Tracker",
  "Custom Workflow for Breathalyzers/Speed Guns",
  "AI Driven Next Service Date Predictor",
  "Predictive Need for Complete Instrument Replacement",
  "Custom Alert Trigger for IG Forensics",
  "Drift Detection to Recalibration Timeline"
];
...
const EquipmentCalibrationRegisterDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI EQUIPMENT CALIBRATION REGISTER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI EQUIPMENT CALIBRATION <span>REGISTER</span></h1>
...
export default EquipmentCalibrationRegisterDetailed;
