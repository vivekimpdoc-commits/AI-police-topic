...
const aiExperts = [
"Modus Operandi (MO) Clustering Engine AI",
  "Serial Offender/Serial Killer Linker Bot",
  "Criminal Signature Behavior Extractor AI",
  "NLP Parser for FIR Narrative Patterns",
  "Burglary/House-Break Entry Method Matcher",
  "Vehicle Theft Bypass/Hotwire Pattern AI",
  "Chain-Snatching Target Selection Modeler",
  "Cyber Fraud/Phishing Script Pattern Matcher",
  "Financial Scam Shell Company Network AI",
  "Narcotics/Drug Concealment Pattern Bot",
  "Weapon/Firearm Ballistics Pattern Matcher",
  "Counterfeit Currency/Fake Note Pattern AI",
  "Kidnapping/Ransom Demand Tone Analyzer",
  "Rape/Sexual Assault MO Linker Bot",
  "Arson/Fire-Setting Signature Behavior AI",
  "Poisoning/Chemical Usage Pattern Detector",
  "Command Center Real-time Pattern Dashboard",
  "Voice-Command Pattern Query Assistant",
  "Automated Case Linkage Recommendation Bot",
  "Inter-District/State Border MO Matcher AI",
  "Suspect Alias/Nickname Pattern Matcher",
  "Tattoo/Gang-Sign/Graffiti Image Analyzer",
  "CCTV Suspect Gait/Clothing Pattern AI",
  "Social Media Bragging/Confession Pattern Bot",
  "Historical Unsolved (Cold Case) Pattern Sync",
  "Arrested Suspect Confession Contradiction AI",
  "Bail-Jumper Recidivism Pattern Modeler",
  "Juvenile Offender Escalation Pattern AI",
  "Victim Typology/Demographic Pattern Matcher",
  "Time-of-Day/Day-of-Week Precision Modeler",
  "Escape Route/Getaway Vehicle Pattern AI",
  "Tool/Weapon Left at Scene Pattern Matcher",
  "AI Generated Serial Crime Intelligence Brief",
  "Mobile App Push-Alert for New MO Patterns",
  "Blockchain Immutable Log of Discovered Patterns",
  "Inter-Agency (CBI/NIA) Pattern Sharing Sync",
  "Senior Officer (SP/DGP) Pattern Radar AI",
  "AI Protocol for Serial Task Force Creation",
  "Undercover Informant Tip-Off MO Matcher",
  "Fake/Copycat Crime Identifier Bot",
  "Traffic E-Challan/Fake Number Plate Pattern",
  "Smuggling/Contraband Hidden Compartment AI",
  "Illegal Mining/Sand Mafia Operation Pattern",
  "Election Fraud/Booth Capturing MO Modeler",
  "Prostitution/Human Trafficking Recruitment AI",
  "Terror/IED Placement Signature Behavior",
  "Riot/Mob Incitement Sentiment Pattern",
  "Industrial/Corporate Espionage MO Matcher",
  "AI Evaluator for Pattern Recognition Accuracy",
  "Explainable AI (XAI) for MO Link Justification",
  "Data Privacy/Anonymization in Pattern Matching",
  "Custom Keyword/Tag Pattern Definition Tool",
  "CCTNS Bulk Data Pattern Mining Engine",
  "Telecom/CDR Ping Location Pattern Analyzer",
  "Financial Transaction/Hawala Flow Pattern Bot",
  "Dark Web/Crypto Ransom MO Pattern Tracker",
  "AI Driven Link Analysis Visualization Graph",
  "Cross-Referencing Missing Persons with MO",
  "Animal Cruelty/Poaching Signature Modeler",
  "AI Assisted Suspect Interrogation Strategy Gen"
];
...
const CrimePatternDiscoveryDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CRIME PATTERN DISCOVERY
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI CRIME PATTERN DISCOVERY</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in identifying modus operandi (mo), serial offenses & criminal signature behaviors.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CRIME PATTERN <span>DISCOVERY</span></h1>
            <p className="cyber-subtitle">Identifying Modus Operandi (MO), Serial Offenses & Criminal Signature Behaviors</p>
          </div>
        </div>
      </header>
...
export default CrimePatternDiscoveryDetailed;
