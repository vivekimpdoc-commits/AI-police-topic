...
const aiExperts = [
"Police Mitra Application Auto-Vetter AI",
  "Criminal Record/Background Check Sync",
  "Civilian Volunteer Skill-Mapping Bot",
  "Non-Critical Duty Auto-Assigner AI",
  "Traffic Control Volunteer Scheduler",
  "Festival/Crowd Management Mitra Router",
  "Digital Identity & ID Card Generator Bot",
  "Mitra Performance/Activity Scorer AI",
  "Reward & Recognition Recommendation Bot",
  "Volunteer Geolocation & Check-In Tracker",
  "Automated Training/Orientation Video Sync",
  "Cyber-Mitra (Digital Volunteer) Tasker AI",
  "Senior Citizen Assist Mitra Allocator",
  "Neighborhood Watch Patrol Sync Bot",
  "Disaster Relief Volunteer Mobilizer AI",
  "Mitra Feedback/Complaint Logger AI",
  "Women/Child Safety Volunteer Router",
  "Multi-Lingual Mitra Communication Sync",
  "Automated Duty Reminder WhatsApp/SMS AI",
  "Mitra Attrition/Drop-out Predictor Bot",
  "Gamification & Leaderboard Generator AI",
  "Mitra Insurance/Welfare Benefit Tracker",
  "Fake/Rogue Volunteer Detector AI",
  "Suspicious Activity Report by Mitra Link",
  "Mitra Duty Fatigue/Burnout Modeler",
  "Public Sentiment Towards Mitra Scorer",
  "Cross-District Mitra Transfer Sync",
  "Special Skill (Medical/Diving) Mitra Router",
  "Informant Tip-Off Verification via Mitra AI",
  "Mitra Social Media Amplification Bot",
  "Student/Youth Cadet Corps (NCC) Link AI",
  "Mitra Resource/Jacket Inventory Tracker",
  "AI Generated Monthly Mitra Newsletter",
  "Mitra Grievance Redressal Escalator",
  "VIP Route Sanitization Volunteer Sync AI",
  "Election Queue Management Mitra Planner",
  "Mitra Read-Receipt & Broadcast Alert Bot",
  "Community Trust Index Correlation AI",
  "Voice-Command Duty Allocation Assistant",
  "Automated Certificate/Appreciation Gen AI",
  "Mitra Legal/Rights Boundary Enforcer Bot",
  "Undercover/Plain-Clothes Volunteer Sync",
  "Blood Donor/Emergency Volunteer Router",
  "Animal Rescue/Wildlife Mitra Link AI",
  "Mitra Engagement ROI Analytics Bot",
  "Central PHQ Mitra Database Synchronizer",
  "Mitra Emergency SOS Panic Button Link",
  "Local Dialect/Language Skill Matcher AI",
  "Historical Mitra Incident Resolution Correlator",
  "Mitra Misconduct/Abuse of Power Flag AI",
  "Blockchain Immutable Log of Mitra Actions",
  "AI Strategy for Mitra Recruitment Drive",
  "Corporate/CSR Sponsored Mitra Program AI",
  "Interactive AI Chatbot for Mitra Queries",
  "Mitra Patrol Route Optimization Modeler",
  "Off-Duty/On-Call Status Toggle Tracker",
  "Mitra Intervention vs Crime Drop Scorer",
  "AI Evaluator for Mitra Promotion/Awards",
  "Night Patrol Volunteer Risk Assessor AI",
  "CCTNS Non-Core Data Entry Mitra Sync"
];
...
const PoliceMitraPortalDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI POLICE MITRA PORTAL
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI POLICE MITRA PORTAL</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in vetting civilian volunteers, non-critical duty assignment & rewarding public assistance.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI POLICE MITRA <span>PORTAL</span></h1>
            <p className="cyber-subtitle">Vetting Civilian Volunteers, Non-Critical Duty Assignment & Rewarding Public Assistance</p>
          </div>
        </div>
      </header>
...
export default PoliceMitraPortalDetailed;
