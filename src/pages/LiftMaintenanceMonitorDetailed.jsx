...
const aiExperts = [
  "IoT Vibration/Motor Fault Predictor",
  "Real-Time Entrapment/Stall Alert Bot",
  "AMC (Annual Maintenance Contract) Compliance AI",
  "Overload/Capacity Breach Analyzer",
  "Power Fluctuation/Backup Generator Integrator",
  "Usage Pattern/Peak Hour Scheduler AI",
  "Geo-Spatial Multi-Story Police Building Mapper",
  "Cable Wear/Friction Anomaly Detector",
  "Lift Maintenance Dashboard",
  "Voice-Command Elevator Status Bot",
  "Automated Monthly Safety Audit Report",
  "State Electrical Inspectorate Sync",
  "CCTV Sync for Vandalism/Suspicious Activity",
  "Door Sensor Alignment/Failure Predictor",
  "Fake/Skipped AMC Visit Detector",
  "Fire Alarm/Emergency Grounding Integrator",
  "AI Evaluator for Lift Safety Index",
  "Audit/Service Log Generator",
  "Data Privacy/Passenger Video Scrubber",
  "Estate/PWD Department Sync",
  "Technician Dispatch/Tracking App",
  "Historical Breakdown/Trap Correlator",
  "Building Admin/Security Briefing AI",
  "Vendor Penalty/SLA Allocator",
  "Blockchain Immutable Service Hash",
  "Anti-Tamper Safety Certificate Shield",
  "Mobile App for Emergency Intercom",
  "Brand/Model Reliability Benchmarker",
  "Automated Reminder for Statutory Inspection",
  "Historical Downtime/Cost Analyzer",
  "Elevator Safety/Rescue SOP Trainer",
  "IoT Gateway/Controller Health Monitor",
  "Imminent Snapping/Free-Fall Alert",
  "Habitual AMC Defaulter Vendor Profiler",
  "High-Priority/VVIP Lift Classifier",
  "AI Assisted Penalty Notice Drafter",
  "Sensor Data/Service History Storage Forecaster",
  "Secure Building Access Control Protector",
  "Integration with Fire/Disaster Protocols",
  "Visitor/Citizen Accessibility Sync",
  "Earthquake/Seismic Shut-down Modeler",
  "Post-Disaster Rescue Operations Coordinator",
  "Lift AMC/Replacement Budget Tracker",
  "Custom Workflow for VIP Override Control",
  "AI Driven Part Replacement Predictor",
  "Predictive Need for Elevator Modernization",
  "Custom Alert Trigger for Estate Officer",
  "Elevator Component Lifecycle Tracker"
];
...
const LiftMaintenanceMonitorDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI LIFT MAINTENANCE MONITOR
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI LIFT MAINTENANCE <span>MONITOR</span></h1>
...
export default LiftMaintenanceMonitorDetailed;
