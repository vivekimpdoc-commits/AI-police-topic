...
const aiExperts = [
"Frame-by-Frame Motion Tracker AI",
  "Suspect Gait/Walking Style Analysis Bot",
  "Low-Light/IR Video Enhancer Engine",
  "License Plate (ANPR) Extractor from Moving Video",
  "Deepfake Video/Lip-Sync Mismatch Detector",
  "Crowd Panic/Stampede Early Warning AI",
  "Weapon Drawn/Brandished Detection Bot",
  "Violence/Fight/Assault Action Classifier",
  "Vehicle Speed/Trajectory Estimation AI",
  "Accident/Crash Reconstruction from Video",
  "Bag/Luggage Left Behind Alert Engine",
  "Loitering/Suspicious Behavior Tracker",
  "Command Center Real-time Video Dashboard",
  "Voice-Command Video Clip Query Assistant",
  "Automated Video Summary/Highlight Reel Gen",
  "Multi-Camera Cross-Tracking (Re-ID) AI",
  "Face Recognition in Moving Crowds",
  "Traffic Rule Violation (Red Light/Wrong Way) Bot",
  "Fire/Smoke Detection in Surveillance Video",
  "Vandalism/Property Damage Classifier AI",
  "Chain-Snatching/Robbery Action Modeler",
  "Kidnapping/Forced Entry Detection Bot",
  "Officer/Police Body-Cam Interaction Auditor",
  "Drone/UAV Aerial Pursuit Tracking AI",
  "AI Evaluator for Video Evidence Admissibility",
  "Blockchain Immutable Hash of Processed Video",
  "Video Metadata (Time/Date/Camera ID) Extractor",
  "Inter-Agency (Traffic/Civil) Video Sync Bot",
  "Social Media Viral Video Authenticator AI",
  "Riot/Mob Incitement Action Tracker",
  "Camouflage/Disguise Penetration in Video",
  "Object Tracking (Briefcase/Weapon) Across Feeds",
  "AI Assisted 3D Scene Reconstruction",
  "Data Privacy/Bystander Face & Plate Blurring",
  "Mobile App Remote CCTV Feed Analyzer",
  "Suspect Vehicle Pursuit Route Mapper",
  "Train/Metro Station Platform Safety AI",
  "Airport/Border Checkpoint Threat Rater",
  "Night Patrol/Beat Area Anomaly Alert AI",
  "Senior Officer (SP/DGP) Incident Briefing Gen",
  "Audio-Video Sync/Desync Forgery Detector",
  "Flash-Mob/Sudden Gathering Alert AI",
  "Illegal Sand Mining/Truck Movement Tracker",
  "VIP Route Convoy Threat Detection AI",
  "Election Booth Capturing/Rigging Alert",
  "Custom Action/Behavior Training Interface",
  "Integration with City-Wide CCTV Grid",
  "AI Driven Bandwidth Optimizer for Live Feeds",
  "Predictive Escalation Warning from Video",
  "Undercover Sting Operation Video Enhancer",
  "Prison/Jail Inmate Clash Detection AI",
  "Custom Alert Trigger Definition Tool"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI VIDEO ANALYTICS
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI VIDEO ANALYTICS</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in cctv frame-by-frame, low-light license plates, gait analysis & object tracking.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI VIDEO <span>ANALYTICS</span></h1>
            <p className="cyber-subtitle">CCTV Frame-by-Frame, Low-Light License Plates, Gait Analysis & Object Tracking</p>
          </div>
        </div>
      </header>
