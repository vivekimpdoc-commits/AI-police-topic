...
const aiExperts = [
  "Experimental SOP/Policy Trial Tracker",
  "Legal/Constitutional Impact Analyzer AI",
  "Public Feedback/Social Sentiment NLP",
  "Policy Iteration/Version Control Bot",
  "Human Rights Violation Risk Scorer",
  "On-Ground Officer Compliance/Friction Monitor",
  "Geo-Spatial Policy Rollout Mapper",
  "Judicial/Court Ruling Conflict Predictor",
  "Policy Experiment Dashboard",
  "Voice-Command Policy Query Bot",
  "Automated Monthly Trial Evaluation Report",
  "State Legal/Prosecution Department Sync",
  "Public Backlash/Protest Predictor",
  "Media/Press Sentiment Analyzer",
  "Officer Confusion/Misinterpretation Alert",
  "Operational Cost vs Benefit Analyzer",
  "AI Evaluator for Policy Success Rate",
  "Audit/Feedback Log Generator",
  "Data Privacy/Public Comment Scrubber",
  "Police Training Academy/SOP Sync",
  "Field Officer Feedback App",
  "Historical Policy Failure Correlator",
  "DGP/Home Secretary Briefing AI",
  "Policy Revision/Drafting Task Allocator",
  "Blockchain Immutable Policy Draft Hash",
  "Anti-Tamper Feedback Record Shield",
  "Mobile App for Citizen Opinion Polling",
  "District-wise Policy Adoption Benchmarker",
  "Automated Alert for Severe Legal Challenges",
  "Historical Policy Implementation Cost Analyzer",
  "New SOP/Directive Training Simulator",
  "Social Media/News Scraping API Monitor",
  "Imminent Supreme/High Court Stay Alert",
  "Habitual Policy Violator (Officer) Profiler",
  "High-Sensitivity (Use of Force/Search) Policy Classifier",
  "AI Assisted Gazette Notification Drafter",
  "Feedback/Sentiment Data Forecaster",
  "Secure Draft Policy Document Protector",
  "Integration with State Legislative Assembly Sync",
  "Human Rights Commission (NHRC) Sync",
  "Election Experimental Security SOP Modeler",
  "Disaster Evacuation Protocol Trial Coordinator",
  "Public Awareness/Campaign Budget Tracker",
  "Custom Workflow for Traffic/Challan Rules",
  "AI Driven Public Acceptance Predictor",
  "Predictive Need for Legal Amendment",
  "Custom Alert Trigger for ADG Law & Order",
  "Drafting to State-wide Notification Timeline"
];
...
const ExperimentalPolicyRegisterDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI EXPERIMENTAL POLICY REGISTER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI EXPERIMENTAL POLICY <span>REGISTER</span></h1>
...
export default ExperimentalPolicyRegisterDetailed;
