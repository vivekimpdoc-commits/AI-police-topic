...
const aiExperts = [
"Volunteer Skill-Mapping & Auto-Assigner AI",
  "Disaster Relief Volunteer Mobilization Bot",
  "Festival/Crowd Management Router AI",
  "Traffic Assistance Volunteer Scheduler",
  "Emergency Blood/Plasma Donor Locator AI",
  "Local Area Knowledge (Guide) Volunteer Link",
  "Volunteer Geolocation & Heatmap Sync",
  "Automated SMS/WhatsApp Activation Bot",
  "Volunteer Performance & Dependability Scorer",
  "Fake/Rogue Volunteer Detector AI",
  "Volunteer Fatigue & Burnout Modeler",
  "Women/Child Safe-Space Volunteer Router",
  "Search & Rescue (Missing Person) Mobilizer",
  "Multi-Lingual Volunteer Translator Bot",
  "Volunteer Background/Criminal Check Sync",
  "Reward & Recognition Gamification AI",
  "Youth/Student (NCC/NSS) Network Bridger",
  "Senior Citizen Care Volunteer Allocator",
  "First-Responder / CPR Trained Locator AI",
  "Volunteer Resource (Jacket/Cap) Inventory",
  "Automated Training/Instruction Video Sync",
  "Volunteer Grievance & Feedback Logger AI",
  "Public Protest De-escalation Volunteer Link",
  "Election Queue Management Router Bot",
  "Cyber-Hygiene Digital Volunteer Tasker AI",
  "VIP Route Sanitization Line-Manager Bot",
  "Neighborhood Watch Night Patrol Sync",
  "Volunteer Insurance/Welfare Claim Tracker",
  "Cross-District Volunteer Transfer Sync AI",
  "Automated Monthly Volunteer Digest Gen",
  "Historical Incident Response ROI Scorer",
  "Command Center Volunteer Dashboard Link",
  "Volunteer Attrition & Drop-out Predictor",
  "Off-Duty/On-Call Status Toggle Tracker AI",
  "Voice-Command Volunteer Dispatch Assistant",
  "Volunteer Social Media Amplification Bot",
  "AI Generated Deployment Strategy Drafter",
  "Blockchain Immutable Log of Volunteer Ops",
  "Local Dialect/Language Matcher AI",
  "Volunteer Intervention vs Crime Drop Scorer",
  "AI Evaluator for Volunteer Awards/Medals",
  "Public Trust Index Impact by Volunteers AI",
  "Stray Animal Rescue Volunteer Link Bot",
  "Food/Water Distribution Crowd Control AI",
  "Volunteer Misconduct/Abuse Flag Bot",
  "Central PHQ Volunteer Database Sync AI",
  "Volunteer Emergency SOS Panic Link",
  "Corporate CSR Volunteer matching AI",
  "Weather/Rain Impact on Volunteer Turnout",
  "AI Protocol for Safe Volunteer Extraction",
  "Volunteer/Police Friction Early Warning AI",
  "Specialized Skill (Diver/Climber) Router",
  "Inter-Agency Joint Ops Volunteer Sync",
  "Mobile App Push-Notification Router AI",
  "Volunteer Briefing Note Auto-Generator",
  "AI Driven Mass-Mobilization Drill Planner",
  "Event Ticket/Entry Validation Volunteer AI",
  "CCTNS Non-Core Support Volunteer Sync",
  "Volunteer Transport/Carpool Optimizer AI",
  "Mega Event (Kumbh/Mela) Grid Allocator"
];
...
const CommunityVolunteerNetworkDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI COMMUNITY VOLUNTEER NETWORK
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI COMMUNITY VOLUNTEER NETWORK</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in mobilizing volunteers for disaster relief, crowd management & traffic assistance.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI COMMUNITY VOLUNTEER <span>NETWORK</span></h1>
            <p className="cyber-subtitle">Mobilizing Volunteers for Disaster Relief, Crowd Management & Traffic Assistance</p>
          </div>
        </div>
      </header>
...
export default CommunityVolunteerNetworkDetailed;
