...
const aiExperts = [
"GIS/Spatial Crime Distribution Mapper",
  "Interactive Topographical Crime Overlay AI",
  "Real-Time 112/Emergency Call Heatmapper",
  "Beat/Jurisdiction Boundary Conflict Mapper",
  "Streetlight/Dark Spot Overlay Predictor AI",
  "CCTV/Camera Blind-Spot Geolocation Bot",
  "Burglary/Theft Spatial Cluster Analyzer",
  "Vehicle Theft Escape Route Mapper AI",
  "Narcotics/Drug Trade Supply Chain Map",
  "Slum/Marginalized Area Crime Overlays",
  "Traffic Accident/Black-Spot Mapper AI",
  "Prostitution/Red-Light Area Density Map",
  "Liquor Shop/Bar Proximity Crime Linker",
  "School/College Surroundings Safety Map",
  "Hospital/Medical Emergency Route Map AI",
  "Bank/ATM Vulnerability Spatial Analyzer",
  "Industrial/Factory Dispute Mapping AI",
  "Railway/Metro Station Crime Density Bot",
  "Interstate Border Smuggling Route Map AI",
  "River/Forest Topography Smuggling Mapper",
  "Geo-Fenced Suspect Movement Overlay",
  "Parolee/Habitual Offender Residence Map",
  "Command Center Real-time GIS Dashboard",
  "Voice-Command Map Navigation Assistant",
  "AI Generated 3D Crime Scene Mapping",
  "Mobile App Beat Patrol Route Overlay AI",
  "Historical Crime Topography Progression",
  "Festival/Rally Route Security Mapper AI",
  "Election Booth Vulnerability GIS Overlay",
  "Disaster/Flood Prone Area Crime Map AI",
  "Communal Tension/Riot Hotspot Polygon Bot",
  "Public Protest/Gathering Geolocation AI",
  "Missing Person Last Seen Spatial Tracker",
  "Wildlife/Poaching Reserve Mapping Bot",
  "Illegal Mining/Sand Mafia Satellite Overlay",
  "Drone/UAV Aerial Reconnaissance Integrator",
  "AI Protocol for Dynamic Geofencing Setup",
  "Predictive Escape Route (Chokepoint) AI",
  "Bail-Jumper Last Known Location Mapper",
  "Cyber Crime IP Address Geolocation Mapper",
  "Financial Fraud/Scam Call Center Map AI",
  "Victim Demographic Spatial Correlation",
  "Officer GPS/AVL Patrol Coverage Mapper",
  "Response Time (SLA) Spatial Heatmap AI",
  "NGO/Civil Society Resource Mapping Sync",
  "Blockchain Immutable Log of GIS Data",
  "Inter-Agency (Civic/Health) Map Sync Bot",
  "AI Evaluator for Optimal PS/Chowki Location",
  "Public Open Data Crime Map Sanitizer AI",
  "VVIP Movement Route Sanitization Map",
  "Weapon/Arms Smuggling Corridor AI",
  "Terror/Insurgency Safe-House Spatial Bot",
  "AI Assisted Tactical Deployment Mapper",
  "Automated Map/KML File Export for IOs",
  "Satellite Imagery/Google Earth Sync AI",
  "Temporal-Spatial (Time-Space) Anomaly Bot",
  "Weather/Rainfall Topography Crime Sync",
  "AI Driven Spatial Outlier Detection Engine",
  "Neighborhood Watch/RWA Patrol Map Sync",
  "Crowdsourced Public Risk Survey Overlay"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CRIME MAPPING
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI CRIME MAPPING</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in gis integration, spatial distribution of offenses & topographical overlays.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CRIME <span>MAPPING</span></h1>
            <p className="cyber-subtitle">GIS Integration, Spatial Distribution of Offenses & Topographical Overlays</p>
          </div>
        </div>
      </header>
...
export default CrimeMappingDetailed;
