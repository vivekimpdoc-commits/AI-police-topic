...
const aiExperts = [
  "Real-Time Crime Reduction Tracker AI",
  "Conviction Rate Target Monitor",
  "Public Grievance Disposal Scorer",
  "Traffic Fatality Reduction Engine",
  "Drug/Contraband Seizure Goal Tracker",
  "Cyber Crime Resolution Metric AI",
  "Geo-Spatial Goal Achievement Mapper",
  "Women/Child Crime Safety Index Scorer",
  "Mission Objective Executive Dashboard",
  "Voice-Command Goal Query Bot",
  "Automated Monthly Target Report",
  "State Crime Records Bureau Sync",
  "Organized Crime/Gang Neutralization Tracker",
  "Pending Investigation Backlog Monitor",
  "Fake Statistic/Data Manipulation Detector",
  "Community Policing Engagement Scorer",
  "AI Evaluator for Zone/Range Performance",
  "Audit/Target Modification Log Gen",
  "Data Privacy/Victim Detail Scrubber",
  "Ministry of Home Affairs (MHA) Sync",
  "Field Commander Goal Tracking App",
  "Historical Performance Baseline Correlator",
  "DGP/Chief Minister Briefing AI",
  "Incentive/Reward Recommendation Engine",
  "Blockchain Immutable Metric Hash",
  "Anti-Tamper Target Score Shield",
  "Mobile App for SP/SSP Updates",
  "Inter-State Benchmarking Matcher",
  "Multi-Lingual Executive Summary Generator",
  "Historical Goal Achievement Analyzer",
  "Objective Setting/KPI SOP Trainer",
  "Dashboard Server Health Monitor",
  "Imminent Target Failure/Deficit Alert",
  "Syndicate Activity Spike Profiler",
  "High-Priority Core Mission Classifier",
  "AI Assisted Remedial Strategy Drafter",
  "Data Analytics Storage Forecaster",
  "Secure Performance Appraisal Protector",
  "Integration with CCTNS/ICJS",
  "Citizen Transparent Policing Dashboard",
  "Election Year Crime Trend Modeler",
  "Disaster Disrupted Mission Coordinator",
  "Performance Incentive Budget Tracker",
  "Custom Workflow for Target Revision",
  "AI Driven Year-End Achievement Predictor",
  "Predictive Need for Special Task Forces",
  "Custom Alert Trigger for DGP/Home Minister",
  "Mission Objective Timeline Tracker"
];
...
const MissionObjectiveDashboardDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI MISSION OBJECTIVE DASHBOARD
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI MISSION OBJECTIVE <span>DASHBOARD</span></h1>
...
export default MissionObjectiveDashboardDetailed;
