...
const aiExperts = [
  "Gunshot Detection (ShotSpotter) Sensor AI",
  "Seismic/Vibration Sensor Tunnel Detector",
  "Chemical/Biological Agent Sniffer Bot",
  "Smart Streetlight Crime Alert Integration",
  "Air Quality/Pollution Monitoring Sensor AI",
  "Flood/Water Level IoT Sensor Sync Bot",
  "Fire/Smoke Detector IoT Alert Engine",
  "Noise Pollution Level Monitor AI",
  "Smart Sensor Command Dashboard",
  "Voice-Command Sensor Status Query Bot",
  "Automated Sensor Health/Calibration AI",
  "Cross-City Sensor Network Mesh Manager",
  "LoRaWAN/NB-IoT Sensor Protocol Manager",
  "Sensor Data Anomaly Detection Engine AI",
  "Encrypted Sensor-to-Cloud Data Pipeline",
  "Forensic Environment Sensor Logger Bot",
  "AI Evaluator for Sensor Alert Accuracy",
  "Audit/Sensor Maintenance Log Generator",
  "Data Privacy/Sensor Range Geo-Fence AI",
  "Police-Smart City Joint Sensor Sync",
  "Cyber Crime Electromagnetic Sensor Bot",
  "ATM/Bank Vibration Sensor Alert AI",
  "Senior Officer (Smart City SP) Briefing",
  "Public Air Quality Sensor Data Portal",
  "Blockchain Immutable Sensor Data Hasher",
  "Anti-Tampering Sensor Physical Shield AI",
  "Mobile App for Sensor Field Technician",
  "Satellite Backhaul for Remote Sensors",
  "Multi-Lingual Sensor Alert Translator Bot",
  "Historical Sensor Data Trend Analyzer",
  "Staff IoT Training & Certification AI",
  "Sensor Hardware Lifecycle/Warranty Tracker",
  "Temporary Naka Portable Sensor Kit Bot",
  "Traffic Speed/Red-Light Sensor Sync AI",
  "Accident Prone Zone Sensor Cluster Bot",
  "Post-Blast Residue Detection Sensor AI",
  "AI Assisted Post-Deployment Sensor Audit",
  "Battery/Solar Power Sensor Management AI",
  "VIP Route Environmental Sensor Sweep",
  "Integration with ISRO/Weather Dept Sensors",
  "Citizen Noise/Pollution Complaint Mapper",
  "Extreme Weather Sensor Hardening AI",
  "Disaster Early Warning Sensor Network",
  "Sensor Network Budget/Procurement Tracker",
  "Custom Workflow/Approval for Sensor Install",
  "AI Driven Sensor Failure Predictor",
  "Predictive Need for Sensor Network Expansion",
  "Custom Alert Trigger for IoT Admin"
];
...
const SmartSensorIntegrationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SMART SENSOR INTEGRATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI SMART SENSOR INTEGRATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in iot gunshot detectors, seismic sensors, chemical detectors & smart streetlights.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SMART SENSOR <span>INTEGRATION</span></h1>
            <p className="cyber-subtitle">IoT Gunshot Detectors, Seismic Sensors, Chemical Detectors & Smart Streetlights</p>
          </div>
        </div>
      </header>
...
export default SmartSensorIntegrationDetailed;
