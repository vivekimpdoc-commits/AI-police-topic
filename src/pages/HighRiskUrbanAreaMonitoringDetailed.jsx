...
const aiExperts = [
  "Urban Gang/Syndicate Territory Mapper",
  "Demographic Friction/Communal Tension Alert",
  "Drug/Narcotics Peddling Hotspot Predictor",
  "Rapid Mobilization/Chokepoint Router",
  "Slum/Ghetto Unregistered Tenant/Migrant Analyzer",
  "CCTV/ANPR Density & Blind-Spot Mapper",
  "Geo-Spatial Urban Vulnerability Heatmapper",
  "Youth Unemployment/Radicalization Scorer",
  "High-Risk Urban Intelligence Dashboard",
  "Voice-Command Area Query Bot",
  "Automated Weekly Slum/Urban Threat Report",
  "Municipal Corporation/Urban Planning Sync",
  "Imminent Gang War/Turf Dispute Predictor",
  "Flash-Mob/Protest Assembly Alert AI",
  "Illegal Encroachment/Land-Mafia Linker",
  "Emergency Vehicle/Riot-Control Access Analyzer",
  "AI Evaluator for Urban Safe-City Index",
  "Audit/Urban Intel Log Generator",
  "Data Privacy/Citizen PII Scrubber",
  "Anti-Narcotics Task Force (ANTF) Sync",
  "City SP/ACP Mobile App",
  "Historical Riot/Curfew Correlator",
  "Commissioner of Police (CP) Briefing AI",
  "Area Domination/Flag March Task Allocator",
  "Blockchain Immutable Urban Intel Hash",
  "Anti-Tamper Informant Log Shield",
  "Mobile App for Resident Welfare Association (RWA) Tip",
  "Zone/Ward-wise Urban Crime Benchmarker",
  "Automated Alert for Armed Syndicate Mobilization",
  "Historical Urban Deployment Cost Analyzer",
  "Urban Riot Control/CQB (Close Quarters) SOP Trainer",
  "City Surveillance/CCTV Grid API Monitor",
  "Imminent Urban Terror/Communal Riot Alert",
  "Drug Lord/Gang Leader Profiler",
  "High-Priority (Communal Flashpoint) Area Classifier",
  "AI Assisted Section 144/Curfew Order Drafter",
  "Urban Crime/Migration Trend Forecaster",
  "Secure Undercover Asset Protector",
  "Integration with Safe City/Smart City Command Center",
  "State Intelligence/ATS Sync",
  "Election Urban Voter Intimidation Modeler",
  "Disaster Slum Fire/Building Collapse Coordinator",
  "Urban Surveillance/Informant Budget Tracker",
  "Custom Workflow for Nightlife/Pub Brawls",
  "AI Driven Gang Retaliation Predictor",
  "Predictive Need for Permanent Police Outpost (Chowki)",
  "Custom Alert Trigger for DGP/CP",
  "Tension Detection to Rapid Deployment Timeline"
];
...
const HighRiskUrbanAreaMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI HIGH-RISK URBAN AREA MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI HIGH-RISK URBAN AREA <span>MONITORING</span></h1>
...
export default HighRiskUrbanAreaMonitoringDetailed;
