...
const aiExperts = [
  "IoT Drain Blockage/Flow Rate Predictor",
  "Pre-Monsoon De-silting/Cleaning Auditor",
  "Mosquito/Vector-Borne Disease Risk Scorer",
  "Sewage Overflow/Backflow Alert Bot",
  "Underground Pipe Sonar/Robotic Scanner AI",
  "Rainwater Harvesting Pit Health Monitor",
  "Geo-Spatial Campus Drainage Mapper",
  "Chemical/Toxic Effluent Detector",
  "Drainage Health Dashboard",
  "Voice-Command Sanitation Query Bot",
  "Automated Pre-Monsoon Audit Report",
  "Municipal Corporation/Sanitation Dept Sync",
  "CCTV based Surface Water-logging AI",
  "Septic Tank Level/Evacuation Predictor",
  "Substandard Contractor Cleaning Detector",
  "Slope/Gradient Flaw Identifier",
  "AI Evaluator for Campus Sanitation",
  "Audit/Cleaning Log Generator",
  "Data Privacy/Internal Layout Scrubber",
  "Public Health Department Sync",
  "Sanitation Staff Routing App",
  "Historical Flood/Water-logging Correlator",
  "Estate/Welfare Officer Briefing AI",
  "Sewer Cleaning Machine Allocator",
  "Blockchain Immutable Audit Hash",
  "Anti-Tamper Sanitation Record Shield",
  "Mobile App for Overflow Reporting",
  "Campus-wise Hygiene/Sanitation Benchmarker",
  "Automated Reminder for De-silting",
  "Historical Maintenance Contract Analyzer",
  "Sanitation/Hygiene SOP Trainer",
  "IoT Flow Sensor Server Monitor",
  "Imminent Flooding/Sewage Backup Alert",
  "Contractor Fraud/Negligence Profiler",
  "Critical/Basement Evidence Room Classifier",
  "AI Assisted Municipal Coordination Drafter",
  "Sensor/Robotic Video Storage Forecaster",
  "Secure Underground Blueprint Protector",
  "Integration with Weather/Rainfall Forecasts",
  "Police Colony Resident Health Sync",
  "Heavy Monsoon/Cyclone Flooding Modeler",
  "Post-Disaster Epidemic Prevention Coordinator",
  "Sanitation/Drainage Repair Budget Tracker",
  "Custom Workflow for Emergency Pumping",
  "AI Driven Pipe Replacement Predictor",
  "Predictive Need for Deep Drainage Overhaul",
  "Custom Alert Trigger for Estate Officer",
  "Drainage Infrastructure Timeline Tracker"
];
...
const DrainageInspectionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DRAINAGE INSPECTION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DRAINAGE <span>INSPECTION</span></h1>
...
export default DrainageInspectionDetailed;
