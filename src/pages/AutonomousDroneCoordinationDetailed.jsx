...
const aiExperts = [
  "Multi-Drone Swarm Formation Controller AI",
  "Riot/Protest Aerial Monitoring Drone Bot",
  "Border Surveillance Long-Range Drone AI",
  "Traffic Density Mapping Aerial Drone Bot",
  "VIP/VVIP Security Overwatch Drone AI",
  "Crime Scene Aerial Photography Drone Bot",
  "Night-Vision/Thermal Surveillance Drone AI",
  "Anti-Drone Detection & Neutralizer Bot",
  "Drone Coordination Command Dashboard",
  "Voice-Command Drone Fleet Query Bot",
  "Automated Flight Path Optimizer Engine",
  "Cross-Agency Drone Airspace Sync AI",
  "DJI/Garuda Aerospace Fleet Manager AI",
  "Drone LIDAR 3D Terrain Mapping Bot",
  "Drone GPS Denied Navigation (Visual SLAM)",
  "Forensic Evidence Delivery Drone Bot",
  "AI Evaluator for Drone Mission Efficiency",
  "Audit/Drone Flight Log Auto-Generator",
  "Data Privacy/Drone Camera Geo-Fence AI",
  "Police-DGCA Drone Regulation Sync Bot",
  "Cyber Crime Suspect Tracking Drone AI",
  "Cash Transport Overwatch Security Drone",
  "Senior Officer (DGP/IG) Drone Briefing",
  "Public Drone Awareness/Safety Broadcaster",
  "Drone Blockchain Flight Record Hasher",
  "Anti-Jamming/Spoofing Drone Shield AI",
  "Mobile App for Drone Pilot Remote Sync",
  "Satellite Comm Drone Beyond Visual LOS",
  "Multi-Lingual Drone Loudspeaker Bot",
  "Historical Drone Mission Analytics AI",
  "Staff Drone Pilot Licensing Tracker",
  "Drone Battery/Spare Parts Inventory AI",
  "Temporary Naka Aerial Overwatch Drone",
  "Traffic Accident Aerial Survey Drone",
  "Flood/Disaster Rescue Spotter Drone AI",
  "Post-Blast Aerial Survey Drone Bot",
  "AI Assisted Post-Flight Drone Debrief",
  "Drone Charging/Docking Station Planner",
  "VIP Route Advance Sweep Drone AI",
  "Integration with DGCA/AAI Airspace System",
  "Citizen Drone Complaint/Violation Tracker",
  "Extreme Weather Drone Grounding Alert",
  "Disaster Relief Supply Drop Drone AI",
  "Drone Program Budget/Procurement Tracker",
  "Custom Workflow/Approval for Flight Plan",
  "AI Driven Drone Collision Predictor",
  "Predictive Need for Drone Fleet Expansion",
...
const AutonomousDroneCoordinationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI AUTONOMOUS DRONE COORDINATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI AUTONOMOUS DRONE COORDINATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in multi-drone swarm management for riots, borders, traffic & vip overwatch.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI AUTONOMOUS DRONE <span>COORDINATION</span></h1>
            <p className="cyber-subtitle">Multi-Drone Swarm Management for Riots, Borders, Traffic & VIP Overwatch</p>
          </div>
        </div>
      </header>
...
export default AutonomousDroneCoordinationDetailed;
