...
const aiExperts = [
"Kernel Density Estimation (KDE) Engine AI",
  "Micro-Location/Pinpoint Crime Density Bot",
  "Shift-Wise (Day/Night) Hotspot Tracker AI",
  "Emerging/Nascent Hotspot Early Warning",
  "Disappearing/Cooling Hotspot Analyzer",
  "Burglary/House-Break Hotspot Predictor",
  "Vehicle Theft/Carjacking Density AI",
  "Chain-Snatching/Robbery Corridor Bot",
  "Eve-Teasing/Women Harassment Hotspot AI",
  "Narcotics/Drug Peddling Zone Detector",
  "Liquor Vend/Bar Nuisance Radius Scorer",
  "Cyber Fraud/ATM Skimming Hotspot AI",
  "Traffic Congestion/Accident Density Bot",
  "Riot/Communal Clash Vulnerability Zone AI",
  "Missing Child/Kidnapping Density Modeler",
  "Weapon/Gunfire Incident Hotspot Mapper",
  "Command Center Real-time Hotspot Dash",
  "Voice-Command Hotspot Query Assistant",
  "Automated Patrol Re-routing to Hotspots",
  "Beat Officer Deployment Optimizer AI",
  "Historical Hotspot Recurrence Analyzer",
  "Weekend/Holiday Hotspot Shift Predictor",
  "Festival/Event Induced Temporary Hotspot AI",
  "Weather/Seasonality Impact on Hotspots",
  "Socio-Economic Overlay for Hotspot Root Cause",
  "Streetlight/Infrastructure Deficit Hotspot Link",
  "CCTV Coverage Gap Hotspot Analyzer AI",
  "Public Trust/Fear Survey Hotspot Sync",
  "AI Generated Heatmap Video/Animation Gen",
  "Spatial-Temporal Hotspot Drift Tracker AI",
  "Inter-District/Border Hotspot Sync Bot",
  "Suspect/Parolee Proximity to Hotspot AI",
  "Organized Crime/Mafia Territory Density AI",
  "Grievance/Jansunwai Complaint Hotspot Bot",
  "Emergency 112 Call Volume Hotspot AI",
  "Fake/Prank Call Density Filter Engine",
  "AI Evaluator for Hotspot Mitigation ROI",
  "Inter-Agency (Civic Body) Issue Router",
  "Mobile App Push-Alerts for Hotspot Patrol",
  "VIP Route Intersection with Hotspot AI",
  "Industrial/Labor Tension Density Mapper",
  "School/College Youth Crime Hotspot Bot",
  "Railway/Mass Transit Crime Density AI",
  "Tourist/Foreigner Targeting Hotspot Predictor",
  "Prostitution/Human Trafficking Density AI",
  "Illegal Encroachment/Land Grab Hotspot",
  "Environmental/Pollution Crime Hotspot Bot",
  "Blockchain Immutable Audit of Hotspot Data",
  "Senior Officer (SP/DGP) Executive Summary AI",
  "Media/Public Relations Hotspot Clarification Bot",
  "AI Protocol for Targeted Raid Planning",
  "Undercover Informant Deployment in Hotspots",
  "Dynamic Geofence Auto-Creation for Hotspots",
  "AI Assisted Risk Assessment for Field Ops",
  "Predictive Escalation Warning from Hotspots",
  "Cross-Referencing Hotspots with Bail Jumpers",
  "Caste/Tribe Specific Offense Density AI",
  "Animal Cruelty/Stray Dog Menace Hotspot",
  "AI Driven Root Cause Analysis for Density",
  "Custom Polygon/Lasso Hotspot Definition Tool"
];
...
const CrimeHotspotDetectionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CRIME HOTSPOT DETECTION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI CRIME HOTSPOT DETECTION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in kernel density estimation, micro-location density & shift-wise tracking.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CRIME HOTSPOT <span>DETECTION</span></h1>
            <p className="cyber-subtitle">Kernel Density Estimation, Micro-Location Density & Shift-Wise Tracking</p>
          </div>
        </div>
      </header>
...
export default CrimeHotspotDetectionDetailed;
