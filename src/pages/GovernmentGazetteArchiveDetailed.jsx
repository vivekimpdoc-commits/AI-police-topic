...
const aiExperts = [
"Gazette Notification OCR & Digitizer AI",
  "NLP Based Legal Boundary/Jurisdiction Search",
  "Historical Gazette Notification Cross-Referencer",
  "New Law (BNS/BSA) to Old Gazette Matcher",
  "PS Boundary/Delimitation Notification Tracker",
  "Automated Gazette Expiry/Supersede Alert AI",
  "Multi-Lingual (Hindi/English) Gazette Translator",
  "Keyword/Topic Extractor from Old Gazettes",
  "Gazette PDF Watermark & Authenticator Bot",
  "Voice-Command Gazette Query Assistant",
  "Command Center Real-time Notification Dashboard",
  "Land Acquisition/Dispute Gazette Linker",
  "Promotion/Transfer Gazette Notification Sync",
  "Arms Act/Explosive Rules Notification Matcher",
  "Election/Model Code of Conduct Gazette AI",
  "Public Holiday/Dry Day Notification Router",
  "Riot/Curfew (Section 163 BNSS) Gazette Sync",
  "Gazette Contradiction/Conflict Flagging Engine",
  "Automated Chronological Index Generator",
  "Gazette Plagiarism/Forgery Detection AI",
  "RTI Query Auto-Responder for Gazettes",
  "Inter-Department (Revenue/Home) Gazette Sync",
  "Blockchain Immutable Log of Notifications",
  "AI Generated Monthly Gazette Digest",
  "Judicial/Court Subpoena Gazette Retrieval AI",
  "Officer Promotion Seniority List Verifier",
  "Gazette Keyword Cloud & Trend Analyzer",
  "Missing/Lost Gazette Issue Predictor Bot",
  "Old Text (Faded/Torn) Image Enhancer AI",
  "Gazette Distribution/Dispatch Tracker Bot",
  "Automated Summary/Gist Generator for SP/SHO",
  "State vs Central Gazette Rule Comparator AI",
  "Police Medal/Award Notification Archiver",
  "Confidential/Extraordinary Gazette Secure Room",
  "Cyber Law/IT Act Amendment Gazette Linker",
  "Traffic/MV Act Fine Revision Notification AI",
  "Municipal/Civic Body Limit Dispute Resolver",
  "Forest/Wildlife Protected Area Gazette Sync",
  "Excise/Liquor Ban Notification Tracker",
  "AI Evaluator for Gazette Legal Admissibility",
  "Automated Upload to State Data Center/CCTNS",
  "Gazette Access/Download Analytics Bot",
  "Mobile App for Beat Officer Gazette Ref",
  "AI Protocol for Emergency Gazette Drafting",
  "Pre-Independence/British Era Gazette Archivist",
  "Caste/Tribe Status Notification Verifier",
  "Pension/Retirement Benefit Gazette Sync",
  "AI Driven Legal Precedent Modeler from Gazettes",
  "Interstate Border Dispute Notification Link",
  "Gazette Metadata (Date/Volume/Part) Auto-Tagger",
  "Suspended/Dismissed Officer Notification Tracker",
  "AI Assisted Drafting of New Notifications",
  "Gazette Access Privilege/Clearance Checker",
  "Disaster Management Act Notification Sync",
  "Automated Typo/Error Flagging in Gazettes",
  "Gazette Subscription/Mailing List Manager",
  "Historical Timeline Visualization of Rules AI",
  "AI Driven Cross-Index for Legal Counsel",
  "VIP Security Protocol Gazette Archiver",
  "Public/Citizen Open Data Portal Synchronizer"
];
...
const GovernmentGazetteArchiveDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI GOVERNMENT GAZETTE ARCHIVE
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI GOVERNMENT GAZETTE ARCHIVE</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in digitizing old notifications, nlp search for legal boundaries & cross-referencing.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI GOVERNMENT <span>GAZETTE ARCHIVE</span></h1>
            <p className="cyber-subtitle">Digitizing Old Notifications, NLP Search for Legal Boundaries & Cross-Referencing</p>
          </div>
        </div>
      </header>
...
export default GovernmentGazetteArchiveDetailed;
