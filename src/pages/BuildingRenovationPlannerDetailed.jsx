...
const aiExperts = [
  "Space Utilization/Occupancy Analyzer",
  "Renovation ROI/Cost-Benefit Estimator",
  "Temporary Relocation/Decanting Logistics AI",
  "Modern Aesthetic/Ergonomic Modeler",
  "Budget vs Actual Cost Tracker",
  "Vendor Selection/Tender Evaluation Bot",
  "Geo-Spatial Renovation Project Mapper",
  "Material Quantity/Wastage Optimizer",
  "Renovation Planning Dashboard",
  "Voice-Command Project Status Bot",
  "Automated Monthly Progress Report",
  "State Housing/PWD Sync",
  "Project Delay/Cost Overrun Predictor",
  "Workplace Disruption Analyzer",
  "Structural Alteration Risk Scorer",
  "Energy Efficiency Upgrade Integrator",
  "AI Evaluator for Modernization Index",
  "Audit/Project Milestone Log Generator",
  "Data Privacy/Floorplan Scrubber",
  "Finance/Planning Department Sync",
  "Project Manager Mobile App",
  "Historical Renovation Bottleneck Correlator",
  "DGP (Modernization) Briefing AI",
  "Contractor Task/Phase Allocator",
  "Blockchain Immutable Milestone Hash",
  "Anti-Tamper Tender Evaluation Shield",
  "Mobile App for Progress Photo Upload",
  "Contractor-wise Execution Speed Benchmarker",
  "Automated Alert for Timeline Slippage",
  "Historical Material Cost Analyzer",
  "Construction Safety/Compliance SOP Trainer",
  "Project Management Software Sync Monitor",
  "Imminent Budget Exhaustion Alert",
  "Underperforming Contractor Profiler",
  "High-Impact (Control Room/Public Area) Renovation Classifier",
  "AI Assisted Penalty/Extension Notice Drafter",
  "Renovation Blueprint/3D Model Forecaster",
  "Secure Architectural Plan Protector",
  "Integration with E-Procurement/Treasury",
  "Green Building Certification Sync",
  "Election Phase Renovation Pause Modeler",
  "Disaster Resilient Rebuilding Coordinator",
  "Capital Expenditure (CAPEX) Budget Tracker",
  "Custom Workflow for Smart Police Station Upgrades",
  "AI Driven Final Completion Date Predictor",
  "Predictive Need for Design Revisions",
  "Custom Alert Trigger for ADG Provisioning",
  "Project Inception to Handover Timeline"
];
...
const BuildingRenovationPlannerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI BUILDING RENOVATION PLANNER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI BUILDING RENOVATION <span>PLANNER</span></h1>
...
export default BuildingRenovationPlannerDetailed;
