...
const aiExperts = [
  "Fuel Siphoning/Pilferage Pattern Detector",
  "Fake Fuel Bill/Receipt Identifier AI Bot",
  "Mileage vs Fuel Consumed Discrepancy Alert",
  "GPS Route vs Fuel Station Location Matcher",
  "Duplicate Fuel Entry/Double Billing Detector",
  "Fuel Tank Sudden Drop Anomaly Alert AI",
  "Driver-Pump Operator Collusion Detector Bot",
  "After-Hours Refueling Alert Engine",
  "Fuel Fraud Detection Command Dashboard",
  "Voice-Command Fraud Alert Query Bot",
  "Automated Fraud Investigation Report Gen",
  "Cross-Vehicle Fraud Pattern Comparison AI",
  "Fuel Card/Coupon Misuse Tracking Engine",
  "Fuel Adulteration (Water/Kerosene) Alert AI",
  "Phantom Vehicle Fuel Claim Detector Bot",
  "Benami (Proxy) Fuel Purchase Flagging AI",
  "AI Evaluator for Fuel Leakage/Fraud %",
  "Audit/Investigation Outcome Log Generator",
  "Data Privacy/Accused Staff Data Masker AI",
  "Police-Vigilance Cell Fraud Report Sync",
  "Patrol Car Fuel Pattern Anomaly Monitor",
  "Armored Vehicle High-Fuel Fraud Screening",
  "Senior Officer (Vigilance) Fraud Briefing",
  "Public Fuel Expenditure Transparency",
  "Blockchain Immutable Fuel Receipt Hasher",
  "Anti-Fraud IoT Fuel Cap Lock Sensor AI",
  "Mobile App for Real-time Fuel Verification",
  "Electric Vehicle Charging Fraud Detector",
  "Multi-Lingual Fraud Alert Translator Bot",
  "Historical Fuel Fraud Precedent Matcher",
  "Staff Departmental Enquiry Fuel Fraud AI",
  "Vendor/Pump Operator Blacklist Engine",
  "Temporary Naka Fuel Fraud Quick Check Bot",
  "Traffic Unit Fuel Consumption Auditor AI",
  "Accident Vehicle Fuel Pre/Post Checker",
  "VIP Fleet Fuel Integrity Monitor AI",
  "AI Assisted Post-Fraud Penalty Calculator",
  "Fuel Fraud Financial Impact Estimator AI",
  "Eco-Audit: Fuel Wastage Cost Analyzer",
  "Integration with Oil Marketing Company API",
  "Citizen Fuel Fraud Tip-Off Receiver Bot",
  "Seasonal Fuel Consumption Anomaly Checker",
  "Disaster Vehicle Fuel Emergency Auditor",
  "Fuel Fraud Prevention Budget Tracker",
  "Custom Workflow/Approval for DE Initiation",
  "AI Driven Fraud Recurrence Predictor",
  "Predictive Need for Surprise Audit",
...
const FuelFraudDetectionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI FUEL FRAUD DETECTION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI FUEL FRAUD DETECTION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in siphoning detection, fake bill identification & mileage discrepancy alerts.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI FUEL FRAUD <span>DETECTION</span></h1>
            <p className="cyber-subtitle">Siphoning Detection, Fake Bill Identification & Mileage Discrepancy Alerts</p>
          </div>
        </div>
      </header>
...
export default FuelFraudDetectionDetailed;
