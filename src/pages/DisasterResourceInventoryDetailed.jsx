...
const aiExperts = [
"Heavy Earth-Mover (JCB/Crane) Tracker AI",
  "Life-Jacket/Rescue Boat Inventory Bot",
  "Floodlight/Generator/Fuel Stock Modeler",
  "Emergency Medical Kit/First-Aid Tracker",
  "Ambulance/Hearse Van Availability Sync",
  "Tent/Tarpaulin/Camp Supply Inventory AI",
  "Ration/Food-Packet/Water Bottle Predictor",
  "Sandbag/Embankment Material Tracker",
  "Rope/Carabiner/Climbing Gear Auditor",
  "Diving/Scuba Equipment Readiness AI",
  "Command Center Resource Dashboard",
  "Voice-Command Inventory Query Assistant",
  "Automated Supply Burn-Rate/Depletion Alert",
  "Private Contractor/Vendor Requisition Bot",
  "Inter-District Resource Pooling Engine",
  "Communication (Satphone/VHF) Eqp Tracker",
  "Fire-Extinguisher/Foam Stock Modeler",
  "Drone/UAV/Thermal Camera Availability AI",
  "Chemical/Biological (CBRN) Suit Auditor",
  "Body Bag/Morgue Freezer Capacity Sync",
  "AI Evaluator for Resource Gap/Deficit",
  "Audit/Procurement Log Auto-Generator",
  "Data Privacy/Vendor Pricing Info Masker",
  "Police-SDRF-NDRF Resource Deconfliction",
  "Perishable Goods (Medicine/Food) Expiry Alert",
  "Transport/Truck Logistics for Resources AI",
  "Senior Officer (DM/Relief Comm) Briefing",
  "Public Donation/Crowdsource Request Drafter",
  "Blockchain Immutable Log of Resource Issue",
  "Asset GPS Tagging & Location Tracker AI",
  "Mobile App for Field Store-Keeper Sync",
  "Cold-Chain/Vaccine Storage Temperature Bot",
  "Multi-Lingual/Regional Resource Naming AI",
  "Historical Disaster Burn-Rate Precedent",
  "Helipad/Aviation Fuel Tanker Readiness AI",
  "Resource Repair/Maintenance Due Alert",
  "Temporary Relief Camp Supply Router",
  "Water-Pump/De-Watering Eqp Tracker",
  "Avalanche/Snow-Cutter Eqp Availability",
  "Cyclone/Chainsaw Tree-Cutting Eqp Sync",
  "AI Assisted Post-Disaster Asset Audit",
  "Weapon/Security Gear for Escorts Alert",
  "VIP/Rescue Team Specialized Eqp Router",
  "Integration with National Disaster Dash (NDEM)",
  "Citizen/NGO Contribution Logger AI",
  "Heatwave/ORs/Cooler Inventory Sync Bot",
  "Election/Fair Repurposing of Resources",
  "Disaster Fund/Budget Utilization Tracker",
  "Custom Workflow/Approval for Procurement",
  "AI Driven Predictive Restocking Engine",
  "Predictive Need for Specialized Eqp (Sonar)",
  "Custom Alert Trigger for Quartermaster"
];
...
const DisasterResourceInventoryDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DISASTER RESOURCE INVENTORY
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI DISASTER RESOURCE INVENTORY</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in life-jackets, earth-movers (jcbs), floodlights & emergency med-kits.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DISASTER RESOURCE <span>INVENTORY</span></h1>
            <p className="cyber-subtitle">Life-Jackets, Earth-Movers (JCBs), Floodlights & Emergency Med-Kits</p>
          </div>
        </div>
      </header>
...
export default DisasterResourceInventoryDetailed;
