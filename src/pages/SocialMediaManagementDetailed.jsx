...
const aiExperts = [
"X/Twitter Trending Hashtag Tracker",
  "Facebook Group Sentiment Analyzer",
  "Instagram Story/Reel Threat OCR",
  "YouTube Hate Speech Video Flag",
  "Deepfake/Morphed Image Detector",
  "Bot/Troll Account Identification AI",
  "Cyber-Bullying Keyword Scorer",
  "Riot/Mob Mobilization Predictor",
  "Communal Harmony Threat Alert Bot",
  "Social Media Viral Misinformation AI",
  "Police Dept Reputation Score Modeler",
  "Automated PR Response Generator",
  "Anonymous Handle De-anonymizer",
  "Influencer/Politician Sentiment Sync",
  "WhatsApp Forward Traceability AI",
  "Telegram Dark-Channel Scraper",
  "Reddit/Discord Extremist NLP Bot",
  "Social Media Location Spoof Detector",
  "Digital Footprint & Network Mapper",
  "Extortion/Blackmail Post Alert",
  "Suicide/Self-Harm Intent Flag AI",
  "Terror Recruitment NLP Tracker",
  "Gun/Weapon Display Image Recognition",
  "Drug Cartel Slang Decoder AI",
  "Stolen Goods Online Sale Matcher",
  "Lost Person/Pet Social Scanner",
  "Traffic E-Challan Viral Rant Flag",
  "Police Atrocity Allegation Alert",
  "Officer Social Media Conduct Auditor",
  "Automated Social Media FIR Router",
  "Live-Stream Violence Detection AI",
  "Election Propaganda Tracker Bot",
  "Foreign Interference Bot Net Alert",
  "Social Media API Rate Limit Optimizer",
  "Sentiment vs Crime Rate Correlator",
  "Hashtag Hijacking Detection Bot",
  "Automated Positive Story Amplification",
  "Cyber Fraud Phishing Link Scraper",
  "Social Audio (Clubhouse/Spaces) Parser",
  "Social Media Image Metadata Tracker",
  "Meme & Satire Context Decoder",
  "Multi-Lingual Slang NLP Modeler",
  "Social Profile to CCTNS Sync Bot",
  "Open Source Intelligence (OSINT) AI",
  "Fake Police Social Handle Flag AI",
  "Automated Content Takedown Drafter",
  "Social Network Graph Centrality Bot",
  "Dark Web/Social Media Link Sync",
  "Prostitution/Escort Ad Scraper",
  "Animal Cruelty Video Flag AI",
  "Honeypot/Decoy Account Manager",
  "Social Media Ad-Campaign ROI Scorer",
  "Social Engineering Attack Predictor",
  "Online Radicalization Trajectory Bot",
  "Social Media Evidence Archiver AI",
  "Court-Admissible Hash Generator",
  "Social Media Crisis Escalation Matrix",
  "Automated Daily Social Digest Gen",
  "Command Center Social Wall Sync",
  "Inter-Agency Social Intel Sharing"
];
...
const SocialMediaManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SOCIAL MEDIA MANAGEMENT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI SOCIAL MEDIA MANAGEMENT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in viral hashtag tracking, troll identification & sentiment analysis.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SOCIAL MEDIA <span>MANAGEMENT</span></h1>
            <p className="cyber-subtitle">Viral Hashtag Tracking, Troll Identification & Sentiment Analysis</p>
          </div>
        </div>
      </header>
...
export default SocialMediaManagementDetailed;
