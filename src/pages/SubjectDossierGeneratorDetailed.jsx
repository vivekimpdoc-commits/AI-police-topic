...
const aiExperts = [
  "Criminal Profile Auto-Aggregator Engine AI",
  "Family/Contact Linkage Analyzer Bot",
  "Asset/Property Valuation Database Matcher",
  "Suspect Modus Operandi (MO) Classifier",
  "Associated Gang Members Network Mapper Bot",
  "Known Alias/Nickname Matcher Engine AI",
  "Suspect Education/Employment Profiler Bot",
  "Suspect Court Case History Linker AI",
  "Subject Dossier Command Dashboard Portal",
  "Voice-Command Dossier Detail Query Bot",
  "Automated Full Dossier PDF Report Generator",
  "Cross-Department Suspect Database Sync Engine",
  "Social Media Suspect Account Profiler AI",
  "Travel/Immigration History Sync Engine Bot",
  "Biometric (Face/Fingerprint) Dossier Linker",
  "Financial Transaction Risk Index Scorer AI",
  "AI Evaluator for Suspect Re-Offense Risk %",
  "Audit/Dossier View Access Log Generator",
  "Data Privacy/Non-Suspect Contact Identity Masker",
  "Police-National Database (CCTNS/NDSO) Sync",
  "Field Investigator Dossier Access Mobile App",
  "Cold Case Suspect Profile Re-activation Linker",
  "Senior Officer (DIG CID) Briefing Bot",
  "Public Wanted/Absconder Profile Gallery Portal",
  "Blockchain Immutable Dossier Action Trail Hasher",
  "Anti-Leak dossier Security/RBAC Firewall AI",
  "Mobile App for Quick Suspect Photo Scan",
  "Tower Dump Contact Association Profiler AI",
  "Multi-Lingual Dossier Translation Converter Bot",
  "Historical Crime Record Trend Matcher AI",
  "Staff Dossier Creation Skill Tracker AI",
  "Dossier Server Cluster Infrastructure Health",
  "Urgent Absconder Spotting Surveillance Alert AI",
  "Traffic/Transit Suspect Interception Protocol Bot",
  "Cryptocurrency Account Dossier Linker Engine",
  "VIP Threat Profile Dossier Aggregator Bot",
  "AI Assisted Case File/Dossier Summary Draft",
  "Dossier DB Query Load Balancer Engine AI",
  "Drug Peddler Narcotics Database Dossier Linker",
  "Integration with NCB/NIA Suspect Database",
  "Citizen Wanted Criminal Sighting Report App",
  "Extreme Case Load Profile Sync Modeler AI",
  "Disaster Target Subject Location Finder Bot",
  "Dossier Center Operation Budget Tracker AI",
  "Custom Workflow/Approval for Dossier Sharing",
  "AI Driven Suspect Future Crime Type Predictor",
  "Predictive Need for History-Sheeter Tagging",
  "Custom Alert Trigger for CID Commander"
];
...
const SubjectDossierGeneratorDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DOSSIER GENERATOR
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI DOSSIER GENERATOR</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in automated criminal profiling, contact links, financial backgrounds & modus operandi reports.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DOSSIER <span>GENERATOR</span></h1>
            <p className="cyber-subtitle">Automated Criminal Profiling, Contact Links, Financial Backgrounds & Modus Operandi Reports</p>
          </div>
        </div>
      </header>
...
export default SubjectDossierGeneratorDetailed;
