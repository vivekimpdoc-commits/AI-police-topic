...
const aiExperts = [
  "Critical Infra Vulnerability/Risk Scorer AI",
  "Sabotage/Terror Threat Predictor Engine",
  "Perimeter Intrusion/Drone Detection AI",
  "Multi-Agency Mock Drill Coordinator",
  "Power Grid/Dam/Telecom Site Auditor",
  "Cyber-Physical Attack Threat Correlator",
  "Geo-Spatial Critical Asset Heatmapper",
  "Employee/Contractor Background Verification AI",
  "Critical Infra Command Dashboard",
  "Voice-Command Asset Status Bot",
  "Automated Quarterly Audit Report",
  "Inter-Agency (IB/CISF/NDRF) Sync Bot",
  "CCTV/Sensor Health & Coverage Analyzer",
  "Fake ID/Unauthorized Access Predictor",
  "Armed Guard (CISF/State Police) Verifier",
  "Emergency Evacuation Route Optimizer",
  "AI Evaluator for Site Preparedness",
  "Audit/Inspection Log Generator",
  "Data Privacy/Classified Layout Scrubber",
  "National Critical Information Infrastructure Protection Centre (NCIIPC) Sync",
  "Field IO/CISF Security Checklist App",
  "Historical Sabotage/Attack Correlator AI",
  "DGP/Home Secretary Briefing Bot",
  "Tactical Quick Reaction Team (QRT) Allocator",
  "Blockchain Immutable Audit Hash",
  "Anti-Tamper Security Plan Shield",
  "Mobile App for Site Managers (Panic/Report)",
  "Jurisdiction/Zone Polygon Matcher",
  "Multi-Lingual Emergency Protocol Translator",
  "Historical Threat Trend Analyzer",
  "Critical Infra Security SOP Trainer",
  "Audit DB Server Health Monitor",
  "Imminent Sabotage/Breach Alert Bot",
  "Terror/Extremist Syndicate Profiler",
  "Vital/High-Risk Asset Classifier",
  "AI Assisted Contingency/Disaster Plan Drafter",
  "Audit Image/Video/Sensor Storage Forecaster",
  "Secure Classified Blueprint Protector",
  "Integration with Central/State Intelligence",
  "Citizen Suspicious Activity Reporting Portal",
  "War/Conflict Scenario Threat Modeler",
  "Disaster/Natural Calamity Impact Coordinator",
  "Audit/Security Upgradation Budget Tracker",
  "Custom Workflow for National Security Alert",
  "AI Driven Attack Probability Predictor",
  "Predictive Need for Paramilitary Deployment",
  "Custom Alert Trigger for Chief Secretary",
  "Audit Rectification/Upgradation Timeline Tracker"
];
...
const CriticalInfrastructureDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CRITICAL INFRA SECURITY REGISTER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CRITICAL INFRA SECURITY <span>REGISTER</span></h1>
...
export default CriticalInfrastructureDetailed;
