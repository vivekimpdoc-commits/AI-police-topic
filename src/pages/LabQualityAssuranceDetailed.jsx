...
const aiExperts = [
  "Proficiency Testing/Z-Score Analyzer AI",
  "Automated Blind/Dummy Sample Generator",
  "SOP Compliance/Deviation Tracker",
  "Internal Audit/NABL Readiness Automation Engine",
  "Analyst Competency/Error-Rate Profiler",
  "Cross-Contamination Root Cause Analysis (RCA)",
  "Geo-Spatial Quality Metrics Heatmapper",
  "Document Control/Version History Manager",
  "Quality Assurance (QA) Dashboard",
  "Voice-Command QA Query Bot",
  "Automated Quarterly Internal Audit Report",
  "National Accreditation Board for Testing and Calibration Laboratories (NABL) Sync",
  "Systemic Error/Bias Predictor",
  "SOP Violation/Shortcut Alert",
  "Proficiency Test Failure Flagging AI",
  "Outdated/Unapproved Method Usage Detector",
  "AI Evaluator for Lab Quality/Reliability Index",
  "Audit/QA Log Generator",
  "Data Privacy/Analyst Performance Scrubber",
  "Directorate of Forensic Science Services (DFSS) Sync",
  "Quality Manager/Internal Auditor Mobile App",
  "Historical Quality-Lapse/Court-Rejection Correlator",
  "FSL Director (Quality) Briefing AI",
  "Corrective & Preventive Action (CAPA) Task Allocator",
  "Blockchain Immutable QA/Audit Hash",
  "Anti-Tamper Test Record Shield",
  "Mobile App for Spot SOP Reference",
  "Division-wise Quality/Error-Rate Benchmarker",
  "Automated Alert for Critical Quality Failure (CAPA Required)",
  "Historical Re-testing/Wastage Cost Analyzer",
  "ISO/IEC 17025 Standard SOP Trainer",
  "LIMS/QA Module API Health Monitor",
  "Imminent Accreditation Suspension/Revocation Alert",
  "High-Error-Rate/Careless Analyst Profiler",
  "High-Stakes (DNA/Digital) Division QA Classifier",
  "AI Assisted Corrective Action (CAPA) Report Drafter",
  "Quality Improvement/Trend Forecaster",
  "Secure QA/Internal Audit File Protector",
  "Integration with E-Courts (Evidence Reliability)",
  "HRMS/Training Needs Assessment Sync",
  "Election Forensic Evidence Integrity Modeler",
  "Disaster Victim ID (DNA) QA Coordinator",
  "Quality Control/Proficiency Testing Budget Tracker",
  "Custom Workflow for New Testing Method Validation",
  "AI Driven Next Internal Audit Requirement Predictor",
  "Predictive Need for Analyst Retraining",
  "Custom Alert Trigger for FSL Director",
  "Error Detection to CAPA Implementation Timeline"
];
...
const LabQualityAssuranceDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI LAB QUALITY ASSURANCE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI LAB QUALITY <span>ASSURANCE</span></h1>
...
export default LabQualityAssuranceDetailed;
