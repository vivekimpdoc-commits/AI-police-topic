...
const aiExperts = [
  "Highway Robbery/Dacoity Risk Scorer AI",
  "Cash Handling/Transport Protocol Auditor",
  "CCTV/ANPR Highway Integration Bot",
  "Night Shift Staffing/Guard Verifier",
  "Fuel Adulteration/Smuggling Anomaly Detector",
  "Fire/Hazard Safety Compliance Scorer",
  "Geo-Spatial Isolated Pump Mapper",
  "Suspect Vehicle Fueling Pattern AI",
  "Security Audit Command Dashboard",
  "Voice-Command Pump Status Bot",
  "Automated Monthly Audit Report",
  "Highway Patrol/Traffic Sync Bot",
  "Suspicious Loitering/Reconnaissance Detector",
  "Drive-off/Fuel Theft Predictor",
  "Private Guard (PSARA) Verification AI",
  "Emergency Shut-off/Panic Button Tester",
  "AI Evaluator for Pump Preparedness",
  "Audit/Inspection Log Generator",
  "Data Privacy/Customer Vehicle Scrubber",
  "Petroleum Ministry/Explosives Dept Sync",
  "Field IO Security Checklist App",
  "Historical Highway Crime Correlator",
  "SHO/Supervisory Officer Briefing",
  "Highway Patrol Beat Allocator",
  "Blockchain Immutable Audit Hash",
  "Anti-Tamper Security Rating Shield",
  "Mobile App for Pump Managers (Panic/Report)",
  "Highway Route/Jurisdiction Matcher",
  "Multi-Lingual Safety Advisory Translator",
  "Historical Crime Trend Analyzer",
  "Pump Security Audit SOP Trainer",
  "Audit Server Health Monitor",
  "Imminent Highway Robbery Alert Bot",
  "Organized Fuel Theft Syndicate Profiler",
  "High-Risk Isolated Target Classifier",
  "AI Assisted Security Notice Drafter",
  "Audit Image/Video Storage Forecaster",
  "Secure Flaw/Vulnerability Protector",
  "Integration with Oil Marketing Companies (OMC)",
  "Citizen/Manager Suspicious Reporting Portal",
  "Riot/Arson Target Security Modeler",
  "Disaster/Fuel Supply Protection Coordinator",
  "Patrol/Audit Expense Budget Tracker",
  "Custom Workflow for NOC Cancellation",
  "AI Driven Dacoity Probability Predictor",
  "Predictive Need for Armed Highway Patrol",
...
const PetrolPumpSecurityDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI PETROL PUMP SECURITY AUDIT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI PETROL PUMP SECURITY <span>AUDIT</span></h1>
...
export default PetrolPumpSecurityDetailed;
