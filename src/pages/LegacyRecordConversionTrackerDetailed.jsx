...
const aiExperts = [
  "Scanning Progress/Volume Tracker AI",
  "OCR Quality/Accuracy Check Engine",
  "Automated Metadata Tagging Bot",
  "Vendor SLA/Penalty Calculator",
  "Faded Text/Handwriting Enhancement AI",
  "Missing Page/Gap Detector",
  "Geo-Spatial Document Origin Mapper",
  "Batch Processing/Queue Optimizer",
  "Conversion Tracker Dashboard",
  "Voice-Command Progress Query Bot",
  "Automated Weekly Digitization Report",
  "IT/Modernization Department Sync",
  "Multi-Lingual Handwriting (Urdu/Hindi) OCR",
  "Data Corruption/Formatting Error Detector",
  "Fake/Manipulated Scan Predictor",
  "Content Summarizer/Abstractor AI",
  "AI Evaluator for Digitization Quality",
  "Audit/QA Log Generator",
  "Data Privacy/PII Masking Engine",
  "Record Room/Archives Sync",
  "QA Inspector Mobile App",
  "Historical Record Decay/Loss Correlator",
  "Nodal Officer/SP Briefing AI",
  "Vendor/Scanner Task Allocator",
  "Blockchain Immutable Digital Copy Hash",
  "Anti-Tamper Digitized Record Shield",
  "Mobile App for Random QA Checks",
  "Vendor-wise Digitization Speed Benchmarker",
  "Automated Reminder for Pending Batches",
  "Historical Digitization Cost Analyzer",
  "Digitization QA SOP Trainer",
  "Storage/Cloud Gateway Health Monitor",
  "Imminent Storage/Budget Exhaustion Alert",
  "Substandard Vendor/Contractor Profiler",
  "Fragile/Historical Document Classifier",
  "AI Assisted Vendor Notice Drafter",
  "Digital Storage/Cloud Capacity Forecaster",
  "Secure Classified Legacy Record Protector",
  "Integration with CCTNS/E-Office",
  "Public Portal Sync (for unclassified historical data)",
  "Election Old Record Digitization Modeler",
  "Disaster Recovery Backup Coordinator",
  "Digitization Project Budget Tracker",
  "Custom Workflow for Fragile/Torn Documents",
  "AI Driven Project Completion Predictor",
  "Predictive Need for Cloud Storage Upgrade",
  "Custom Alert Trigger for IG Modernization",
  "Legacy Record Conversion Timeline Tracker"
];
...
const LegacyRecordConversionTrackerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI LEGACY RECORD CONVERSION TRACKER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI LEGACY RECORD CONVERSION <span>TRACKER</span></h1>
...
export default LegacyRecordConversionTrackerDetailed;
