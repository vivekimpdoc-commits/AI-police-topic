...
const aiExperts = [
  "Officer Skill/Training Matrix Analyzer",
  "Technology/Hardware Deficit Identifier AI",
  "Cyber/Forensic Capability Scorer",
  "Future Threat (Drones/Deepfakes) Modeler",
  "Weapons/Tactical Gear Gap Analyzer",
  "Language/Soft-Skill Requirement Predictor",
  "Geo-Spatial Capability Disparity Mapper",
  "Investigation Quality Bottleneck Extractor",
  "Capability Gap Command Dashboard",
  "Voice-Command Deficit Query Bot",
  "Automated Annual Modernization Report",
  "Police Training Academy Sync Bot",
  "New Legislation (BNS/IT Act) Readiness Scorer",
  "Traffic Management Tech (ANPR/Radar) Auditor",
  "Fake Certification/Skill Exaggeration Detector",
  "Digital Literacy/IT Skill Assessment AI",
  "AI Evaluator for Modernization Funds",
  "Audit/Assessment Log Generator",
  "Data Privacy/Personnel Detail Scrubber",
  "Bureau of Police Research & Development (BPR&D) Sync",
  "Field Officer Self-Assessment App",
  "Historical Failure/Skill Gap Correlator",
  "DGP/Modernization IG Briefing AI",
  "Training Program/Fund Allocator",
  "Blockchain Immutable Assessment Hash",
  "Anti-Tamper Capability Score Shield",
  "Mobile App for Skill Updates",
  "Inter-State Capability Benchmarker",
  "Multi-Lingual Training Needs Generator",
  "Historical Modernization Impact Analyzer",
  "Capability Assessment SOP Trainer",
  "Gap Analysis DB Server Health Monitor",
  "Imminent Critical Skill Shortage Alert",
  "Organized Cyber Syndicate Evolution Profiler",
  "High-Risk Tech Deficit Classifier",
  "AI Assisted Modernization Proposal Drafter",
  "Assessment Data Storage Forecaster",
  "Secure Vulnerability Report Protector",
  "Integration with National Cyber Crime Portal",
  "Citizen Feedback on Tech Adoption Sync",
  "Riot/Mass Protest Tactical Gap Modeler",
  "Disaster Response Capability Coordinator",
  "Modernization Grant/Budget Tracker",
  "Custom Workflow for Specialized Hiring",
  "AI Driven Future Threat Predictor",
  "Predictive Need for Foreign Training",
  "Custom Alert Trigger for Home Secretary",
  "Modernization Roadmap Timeline Tracker"
];
...
const CapabilityGapAnalysisDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CAPABILITY GAP ANALYSIS
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CAPABILITY GAP <span>ANALYSIS</span></h1>
...
export default CapabilityGapAnalysisDetailed;
