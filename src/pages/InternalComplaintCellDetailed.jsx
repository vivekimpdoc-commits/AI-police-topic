...
const aiExperts = [
  "Grievance Category Auto-Classifier AI",
  "Complaint Redressal Wait-time Predictor Bot",
  "Harassment Case Trigger Notification Bot",
  "Action Log Integrity Auditor Engine AI",
  "Complaint Priority Sorter Algorithm Bot",
  "Staff Stress/Harassment Sentiment Analyzer",
  "Officer Response SLA Breach Tracker Bot",
  "Anonymous Complaint Validation Check Bot",
  "Complaint Cell Operations Dashboard Portal",
  "Voice-Command Complaint Status Query Bot",
  "Automated Daily Complaint Cell Report Gen",
  "Cross-Office Grievance Database Sync Engine",
  "Complaint OTP/Token Verification Engine AI",
  "Suspicious Complaint Spike Alert System Bot",
  "Internal Mediation Meeting Scheduler Bot",
  "Complainant Safety Geofencing Alert System",
  "AI Evaluator for Department Grievance Index",
  "Audit/Complaint Read Access Log Generator",
  "Data Privacy/Complainant Name Scrubber Engine",
  "Police-Internal Affairs Division Sync Bot",
  "Complaint Cell Officer Mobile Status App Sync",
  "Cold Case Complaint Timeline Linker Matcher",
  "Senior Officer (SP Internal Affairs) Briefing",
  "Public Police Grievance Web Reporting Portal",
  "Blockchain Immutable Grievance Ledger Registry",
  "Anti-Retaliation Protection Alert Shield AI",
  "Mobile App for Quick Grievance Submitter Bot",
  "Bluetooth Beacon Mediation Room Coordinator",
  "Multi-Lingual Complaint Transcript Translator",
  "Historical Complaint Resolution Rate Sorter",
  "Staff Grievance SOP Compliance Trainer AI",
  "Complaint Cell Server Infrastructure Health",
  "Urgent Harassment Complaint Priority Sorter",
  "Traffic/Transit Commute Grievance Sorter Bot",
  "Digital/Email Harassment Keyword Flagging AI",
  "VIP Escort Staff Grievance Resolver Bot",
  "AI Assisted Post-Mediation Inquiry Draft Bot",
  "Complaint Intake Queue Load Balancer Engine",
  "Evacuation Route Planner for Mediation Rooms",
  "Integration with State Grievance Portal DB",
  "Citizen Complaint Helpline Voice Assistant Bot",
  "Extreme Case Rush Complaint Sorter Engine AI",
  "Disaster Situation Emergency Complaint Router",
  "Complaint Cell Maintenance Budget Tracker AI",
  "Custom Workflow/Approval for Tribunal Reference",
  "AI Driven New Grievance Type Predictor AI",
  "Predictive Need for Specialized Counsellor",
  "Custom Alert Trigger for Cell Nodal Officer"
];
...
const InternalComplaintCellDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INTERNAL COMPLAINT CELL
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI INTERNAL COMPLAINT CELL</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in grievance registry, redressal status boards, harassment case triggers & action logs.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INTERNAL COMPLAINT <span>CELL</span></h1>
            <p className="cyber-subtitle">Grievance Registry, Redressal Status Boards, Harassment Case Triggers & Action Logs</p>
          </div>
        </div>
      </header>
...
export default InternalComplaintCellDetailed;
