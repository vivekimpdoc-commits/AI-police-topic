...
const aiExperts = [
  "Auto-Updating Designation/Posting AI",
  "CUG (Closed User Group) Number Mapper",
  "Role/Skill-based Semantic Search Engine",
  "Transfer/Promotion Sync Bot",
  "Emergency/Nodal Officer Highlight Engine",
  "Retired/Suspended Officer Filter",
  "Geo-Spatial Officer Location Mapper",
  "Inter-Department (Civic/Admin) Contact Sync",
  "Contact Directory Dashboard",
  "Voice-Command Contact Query Bot",
  "Automated Monthly Update Report",
  "HRMS/Personnel Department Sync",
  "Multi-Lingual Directory Generation",
  "Duplicate/Obsolete Number Detector",
  "Fake/Scammer Caller ID Predictor (for public)",
  "VCard/Contact Card Generator AI",
  "AI Evaluator for Directory Accuracy",
  "Audit/Update Log Generator",
  "Data Privacy/Personal Number Scrubber",
  "State Police Headquarters Sync",
  "Officer Contact Search Mobile App",
  "Historical Posting Precedent Correlator",
  "Supervisory Officer Briefing AI",
  "Telecom/CUG Vendor Task Allocator",
  "Blockchain Immutable Contact Hash",
  "Anti-Tamper Directory Shield",
  "Mobile App for Instant Call/Message",
  "Jurisdiction-wise Contact Benchmarker",
  "Automated Reminder for Number Update",
  "Historical Search/Query Trend Analyzer",
  "Communication SOP Trainer",
  "Directory Server Health Monitor",
  "Imminent Unreachable Key Officer Alert",
  "Unresponsive/Switched Off Number Profiler",
  "VVIP/Top-Secret Contact Classifier",
  "AI Assisted CUG Number Reallocation Drafter",
  "Database Storage Forecaster",
  "Secure Classified Contact Protector",
  "Integration with Dial 112/Command Center",
  "Citizen Facing Public Directory Sync",
  "Election Observer Contact Modeler",
  "Disaster Nodal Agency Contact Coordinator",
  "CUG Telecom Bill Budget Tracker",
  "Custom Workflow for Undercover Number Issuance",
  "AI Driven Skill Search Predictor",
  "Predictive Need for Dedicated Helplines",
  "Custom Alert Trigger for Telecom SP",
  "Officer Contact Evolution Timeline Tracker"
];
...
const DepartmentContactDirectoryDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DEPARTMENT CONTACT DIRECTORY
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DEPARTMENT CONTACT <span>DIRECTORY</span></h1>
...
export default DepartmentContactDirectoryDetailed;
