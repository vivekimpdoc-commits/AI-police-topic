...
const aiExperts = [
"Station Inspection (IG/DIG) Report Cloud Storage",
  "Geo-Tagged Malkhana Verification Photo AI",
  "Lockup/Cell Condition Video Audit Repository",
  "Armory/Weapon Physical Count Evidence AI",
  "Police Vehicle Fleet Condition Photo Sync",
  "Station Cleanliness/Swachh Bharat Audit Bot",
  "Record Room/File Organization Evidence AI",
  "Barrack/Mess Food Quality Video Logger",
  "Command Center Evidence Repository Dashboard",
  "Voice-Command Inspection Evidence Query",
  "Automated Inspection Finding Indexing Bot",
  "Watermark/Timestamp Adder for Evidence",
  "Inter-Station Audit Comparison Engine",
  "Speech-to-Text of Dictated Inspection Notes",
  "Image Tampering/Deepfake Detector for Audits",
  "Night Surprise Inspection Geo-Fencing AI",
  "AI Evaluator for Inspection Score/Grade",
  "Audit/Rectification Log Auto-Generator",
  "Data Privacy/Suspect Face Blur in Inspection",
  "Police-HQ Inspection Report Sync Bot",
  "CCTV DVR/Backup Verification Evidence AI",
  "Station Boundary/Perimeter Security Photo Bot",
  "Senior Officer (DGP) Inspection Briefing",
  "Public Feedback/Citizen Survey Evidence AI",
  "Blockchain Immutable Log of Inspection Proof",
  "Wireless/Comms Equipment Test Video AI",
  "Mobile App for Inspecting Officer Uploads",
  "Uniform/Turnout Parade Photo Verifier",
  "Multi-Lingual Inspection Note Translator",
  "Historical Inspection Remarks Matcher",
  "Departmental Enquiry (DE) Evidence Storage",
  "Inspector Fatigue/Audit Load Monitor AI",
  "Temporary Post/Naka Setup Evidence Sync",
  "Traffic Checkpost Bodycam Footage Audit",
  "Accident Prone Zone Inspection Proof",
  "Hospital/Triage Guarding Duty Audit AI",
  "AI Assisted Post-Inspection Summary Gen",
  "Storage Capacity/Cloud Quota Alert Bot",
  "VIP Route Sanitary/Security Inspection AI",
  "Integration with State Police Audit Portal",
  "Citizen Complaint Verification Evidence",
  "Foreigner Checkpost Register Photo Audit",
  "Election Booth Security Inspection Video",
  "Inspection Travel/Audit Expense Tracker",
  "Custom Workflow/Approval for Audit Closure",
  "AI Driven Repeated Failure Predictor",
  "Predictive Need for Station Renovation",
  "Custom Alert Trigger for Vigilance Officer"
];
...
const InspectionEvidenceRepositoryDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INSPECTION EVIDENCE REPOSITORY
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI INSPECTION EVIDENCE REPOSITORY</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in secure cloud storage, ig/dig visit reports & geo-tagged audit proofs.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INSPECTION EVIDENCE <span>REPOSITORY</span></h1>
            <p className="cyber-subtitle">Secure Cloud Storage, IG/DIG Visit Reports & Geo-Tagged Audit Proofs</p>
          </div>
        </div>
      </header>
...
export default InspectionEvidenceRepositoryDetailed;
