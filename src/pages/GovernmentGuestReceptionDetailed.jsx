...
const aiExperts = [
  "VIP Escort/Pilot Allocation AI",
  "Welcome Protocol/Garland Automation Bot",
  "Guest Itinerary/Flight Sync Engine",
  "Local Liaison Officer (LO) Matchmaker",
  "Convoy Route Security/Traffic Analyzer",
  "Hotel/Guest House Check-in Optimizer",
  "Geo-Spatial VIP Movement/Convoy Mapper",
  "Cultural/Dietary Preference Profiler",
  "Guest Reception Dashboard",
  "Voice-Command Itinerary Query Bot",
  "Automated Post-Visit Protocol Report",
  "State Protocol/General Administration (GAD) Sync",
  "Flight Delay/Schedule Change Alert",
  "Route Protest/Traffic Blockade Predictor",
  "Escort Vehicle Breakdown Identifier",
  "Liaison Officer Language/Skill Matcher",
  "AI Evaluator for Reception Flawlessness",
  "Audit/Convoy Log Generator",
  "Data Privacy/VIP Itinerary Scrubber",
  "Security/Intelligence Branch Sync",
  "Liaison Officer Protocol App",
  "Historical VIP Visit Disruption Correlator",
  "SP (Protocol/Security) Briefing AI",
  "Pilot/Escort Task Allocator",
  "Blockchain Immutable Itinerary Hash",
  "Anti-Tamper VIP Schedule Shield",
  "Mobile App for Convoy Live Tracking",
  "Liaison Officer Performance Benchmarker",
  "Automated Alert for Imminent Arrival",
  "Historical Protocol Expenditure Analyzer",
  "VIP Security/Reception SOP Trainer",
  "Convoy Radio/GPS Gateway Health Monitor",
  "Imminent Security Threat/Route Breach Alert",
  "Inefficient Liaison/Driver Profiler",
  "High-Risk (Z+) Protectee Reception Classifier",
  "AI Assisted Protocol Revision Drafter",
  "Visit Analytics Storage Forecaster",
  "Secure VVIP Safe-House Protector",
  "Integration with Airport Authority/ATC",
  "Zero Public Exposure Policy Sync",
  "Election Observer Reception Modeler",
  "Disaster Central Team Visit Coordinator",
  "Protocol/Hospitality Budget Tracker",
  "Custom Workflow for Unscheduled VIP Stops",
  "AI Driven Convoy ETA Predictor",
  "Predictive Need for Extra Pilot Vehicles",
  "Custom Alert Trigger for DGP/ADG Security",
  "VIP Arrival to Safe Departure Timeline"
];
...
const GovernmentGuestReceptionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI GOVERNMENT GUEST RECEPTION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI GOVERNMENT GUEST <span>RECEPTION</span></h1>
...
export default GovernmentGuestReceptionDetailed;
