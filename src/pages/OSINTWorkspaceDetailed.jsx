...
const aiExperts = [
  "Dark Web Chat Scraper AI",
  "Social Media Keyword Alert Bot",
  "Rogue IP Geolocation Finder",
  "Automated Image Metadata Reader",
  "Public Forum Crawler Bot",
  "Domain Registry Owner Lookup Bot",
  "Username Alias Resolver Engine AI",
  "Email Breach Leak Database Linker",
  "OSINT Operations Command Dashboard",
  "Voice-Command OSINT Query Bot",
  "Automated Daily Threat Intel Report Gen",
  "Cross-Platform Handle Search Engine",
  "EXIF Data Lat/Long Map Plotter AI",
  "Suspicious Post Reverse Image Search Bot",
  "Forum Post Sentimental Analyzer Bot",
  "Darknet Marketplace Product Sync Bot",
  "AI Evaluator for Handle Suspicion Score",
  "Audit/OSINT Search History Log Generator",
  "Data Privacy/Operator VPN IP Masker AI",
  "Police-Cyber Cell OSINT Database Sync",
  "OSINT Field Investigator Mobile Sync App",
  "Cold Case Profile Link Analysis Matcher",
  "Senior Officer (SP Cyber Intel) Briefing Bot",
  "Public OSINT Suspicious Link Checking Portal",
  "Blockchain Immutable Search Query Hash Log",
  "Anti-Honeypot Covert Browse Protection AI",
  "Mobile App for Quick OSINT Search Bot",
  "Website Defacement Monitor Alert Bot",
  "Multi-Lingual Social Post Translator Engine",
  "Historical Social Media Trend Matcher Bot",
  "Staff OSINT Search Efficacy Trainer AI",
  "OSINT Scraping Node Server Health Monitor",
  "Urgent Terror Propaganda Post Alert Bot",
  "Traffic/Transit Vehicle Plate Image Matcher",
  "Hate Speech Keyword Flagging Engine AI",
  "VIP Social Media Threat Tracker AI",
  "AI Assisted Post-OSINT Case File Draft",
  "OSINT Server Proxy Rotator Optimizer Bot",
  "Virtual Sandbox Profile Activity Sync Bot",
  "Integration with National Cyber Crime Portal",
  "Citizen Fake Account Reporting App Portal",
  "Extreme Traffic Spammer/Botnet Detector AI",
  "Disaster Social Media Rescue Request Finder",
  "OSINT Operations Budget/Tool Expense Tracker",
  "Custom Workflow/Approval for Target Monitoring",
  "AI Driven New Threat Group Predictor",
  "Predictive Need for Server Proxy Scale-up",
  "Custom Alert Trigger for OSINT Nodal Officer"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI OSINT WORKSPACE
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI OSINT WORKSPACE</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in social media scrapers, dark web crawlers, automated search & threat monitoring platforms.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI OSINT <span>WORKSPACE</span></h1>
            <p className="cyber-subtitle">Social Media Scrapers, Dark Web Crawlers, Automated Search & Threat Monitoring Platforms</p>
          </div>
        </div>
      </header>
...
export default OSINTWorkspaceDetailed;
