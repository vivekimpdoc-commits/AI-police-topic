...
const aiExperts = [
"CAPF/Paramilitary Force Deployment Optimizer",
  "State Police vs Armed Police Ratio AI",
  "Home Guard/NCC Volunteer Allocator Bot",
  "Polling Booth Sensitivity/Criticality Matcher",
  "Inter-District Force Deputation Sync Engine",
  "Election Phase-wise Force Movement AI",
  "Women Police Deployment for Pink Booths",
  "Quick Response Team (QRT) Pre-positioning Bot",
  "Command Center Force Allocation Dashboard",
  "Voice-Command Force Query Assistant",
  "Automated Duty Roster/Shift Generator AI",
  "Force Accommodation/Barrack Space Modeler",
  "Off-Duty/Fatigue Tracking for Security Forces",
  "Naxal/Insurgency Area Specialized Force Sync",
  "Election Commission (ECI) Guideline Sync AI",
  "Weapon/Ammunition Issue Tracker for Forces",
  "AI Evaluator for Force Distribution Equity",
  "Audit/Defaulter Log for Absenteeism Gen",
  "Data Privacy/Force Personnel Info Masker",
  "Police-Magistrate Joint Patrol Route AI",
  "VIP/Star Campaigner Route Force Diverter",
  "Reserve Force/Standby Deployment Predictor",
  "Senior Officer (Observer) Briefing Bot",
  "Election Duty Exemption/Medical Leave AI",
  "Blockchain Immutable Log of Duty Orders",
  "Helicopter/Airlift Force Insertion Geo-Mapper",
  "Mobile App for Force Check-in/Selfie Sync",
  "Multi-Lingual Comm Bot for Outside Forces",
  "Force Transportation/Bus Allocation Router",
  "Historical Poll Violence Precedent Matcher",
  "Border Checkpost (Naka) Sealing Force AI",
  "Medical/Ambulance Sync for Injured Forces",
  "Temporary Tent/Camp Setup Modeler",
  "Traffic Duty Repurposing for Elections Bot",
  "Vulnerable Hamlet Confidence Building Patrol AI",
  "EVM Strong Room Guard Ratio Calculator",
  "AI Assisted Post-Election Force Withdrawal",
  "Security Eqp (Lathi/Shield) Inventory AI",
  "Media/Press Enclosure Security Allocator",
  "Integration with ECI/CEO State Portal",
  "Citizen App for Checking Booth Security Level",
  "Extreme Weather (Heat/Rain) Force Modeler",
  "Shadow/Decoy Force Deployment Engine",
  "Force Travel/DA Expense Tracker AI",
  "Custom Workflow/Approval for Duty Change",
  "AI Driven Force Reinforcement Predictor",
...
const InternationalConferenceManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INTERNATIONAL CONFERENCE MANAGEMENT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI INTERNATIONAL CONFERENCE MANAGEMENT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in managing its core operations efficiently.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INTERNATIONAL CONFERENCE <span>MANAGEMENT</span></h1>
...
export default InternationalConferenceManagementDetailed;
