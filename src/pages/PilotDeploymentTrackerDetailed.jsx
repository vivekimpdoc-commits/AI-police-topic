...
const aiExperts = [
  "Controlled Environment Test Scheduler",
  "Real-Time KPI/Metric Monitor",
  "User Friction/Adoption Scorer",
  "Go/No-Go Decision Modeling AI",
  "A/B Testing Outcome Analyzer",
  "Bug/Defect Reporting Integrator",
  "Geo-Spatial Pilot Location Mapper",
  "Vendor SLA/Commitment Tracker",
  "Pilot Deployment Dashboard",
  "Voice-Command Pilot Status Bot",
  "Automated Monthly Evaluation Report",
  "State Procurement/Tech Sync",
  "System Crash/Failure Predictor",
  "False Positive/Error Rate Analyzer",
  "Training Deficit/Skill Gap Predictor",
  "Scalability/Infrastructure Load Estimator",
  "AI Evaluator for Pilot Success Probability",
  "Audit/Test Log Generator",
  "Data Privacy/Test Data Scrubber",
  "Finance/Modernization Sync",
  "Field Tester Mobile App",
  "Historical Pilot Failure Correlator",
  "Technology Evaluation Committee Briefing AI",
  "Bug Fix/Iteration Task Allocator",
  "Blockchain Immutable Test Result Hash",
  "Anti-Tamper KPI Score Shield",
  "Mobile App for Quick Feedback/Survey",
  "District-wise Tech Readiness Benchmarker",
  "Automated Alert for Critical System Failure",
  "Historical Pilot Cost Analyzer",
  "Technology Testing SOP Trainer",
  "Test Server/Sandbox Health Monitor",
  "Imminent Pilot Cancellation/Scrap Risk Alert",
  "Underperforming Vendor/Solution Profiler",
  "Mission-Critical (Facial Recognition/ANPR) Pilot Classifier",
  "AI Assisted Evaluation Report Drafter",
  "Test Data/Video Storage Forecaster",
  "Secure Prototype Intellectual Property Protector",
  "Integration with National Crime Records Bureau (NCRB)",
  "Legal/Ethical Compliance Sync",
  "Election Pilot (EVM Tracking) Modeler",
  "Disaster Comms Pilot Coordinator",
  "R&D/Pilot Funding Budget Tracker",
  "Custom Workflow for Lethal/Non-Lethal Weapons",
  "AI Driven State-wide Rollout Predictor",
  "Predictive Need for Hardware Upgrades",
  "Custom Alert Trigger for DGP Tech",
  "Pilot Kickoff to Final Decision Timeline"
];
...
const PilotDeploymentTrackerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI PILOT DEPLOYMENT TRACKER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI PILOT DEPLOYMENT <span>TRACKER</span></h1>
...
export default PilotDeploymentTrackerDetailed;
