...
const aiExperts = [
  "Auto Inward Number/Barcode Generator",
  "Sender/Organization Tagging AI",
  "Attachment/Enclosure OCR Scanner",
  "Smart Categorization (Complaint/Order/Misc)",
  "Duplicate Receipt Detector",
  "Prior Reference/Reply Matcher",
  "Geo-Spatial Origin of Receipt Mapper",
  "Priority/VIP Sender Identifier",
  "Receipt Register Dashboard",
  "Voice-Command Receipt Query Bot",
  "Automated Daily Inward Volume Report",
  "E-Office System Sync Bot",
  "Multi-Lingual Receipt Translation",
  "Content Summarizer/Abstractor AI",
  "Fake/Phishing Document Detector",
  "Missing Enclosure Alert Bot",
  "AI Evaluator for Inward Speed",
  "Audit/Receipt Log Generator",
  "Data Privacy/Complainant Info Scrubber",
  "State Intelligence Bureau Sync",
  "Dak Clerk Mobile App",
  "Historical Volume/Peak Correlator",
  "Superintendent/Head Clerk Briefing AI",
  "Filing/Routing Allocator",
  "Blockchain Immutable Receipt Hash",
  "Anti-Tamper Inward Shield",
  "Mobile App for Immediate Scanning",
  "Source/Department-wise Volume Benchmarker",
  "Automated Reminder for Routing Delay",
  "Historical Inward Trend Analyzer",
  "Receipt/Filing SOP Trainer",
  "Scanner/Hardware Health Monitor",
  "Imminent Bottleneck/Pile-up Alert",
  "Frequent/Vexatious Sender Profiler",
  "Court Order/Contempt Receipt Classifier",
  "AI Assisted Acknowledgment Receipt Drafter",
  "Scanned Image Storage Forecaster",
  "Secure Sensitive Receipt Protector",
  "Integration with CCTNS/Crime Branch",
  "Citizen Grievance Portal Sync",
  "Election Related Receipt Modeler",
  "Disaster Aid Receipt Coordinator",
  "Digitization Hardware Budget Tracker",
  "Custom Workflow for Classified Receipts",
  "AI Driven Processing Workload Predictor",
  "Predictive Need for High-Speed Scanners",
  "Custom Alert Trigger for Nodal Officer",
  "Receipt to Routing Timeline Tracker"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI RECEIPT REGISTER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI RECEIPT <span>REGISTER</span></h1>
...
export default ReceiptRegisterDetailed;
