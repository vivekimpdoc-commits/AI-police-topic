...
const aiExperts = [
  "Structural Degradation Predictor AI",
  "Automated Digital Snag/Defect Logger",
  "Vendor/Contractor SLA Monitor",
  "Estate Lifecycle/Depreciation Analyzer",
  "Roof Leakage/Seepage Sensor Sync",
  "Routine Whitewash/Painting Scheduler",
  "Geo-Spatial Police Estate Mapper",
  "Preventive Maintenance Task Router",
  "Building Maintenance Dashboard",
  "Voice-Command Repair Query Bot",
  "Automated Monthly Estate Health Report",
  "State PWD/Housing Board Sync",
  "Emergency Repair Triage AI",
  "Vendor Over-Billing/Delay Predictor",
  "Unattended Ticket Escalator",
  "Material/Cement Quality Validator",
  "AI Evaluator for Estate Integrity Index",
  "Audit/Repair Log Generator",
  "Data Privacy/Vendor Pricing Scrubber",
  "Finance/Estate Department Sync",
  "Estate Officer Field Inspection App",
  "Historical Monsoon Damage Correlator",
  "SP (Administration) Briefing AI",
  "Repair/Plumbing Task Allocator",
  "Blockchain Immutable Repair Hash",
  "Anti-Tamper Maintenance Record Shield",
  "Mobile App for Quick Photo-Snag Upload",
  "Station-wise Upkeep Benchmarker",
  "Automated Alert for Structural Cracks",
  "Historical Civil Work Cost Analyzer",
  "Estate Management SOP Trainer",
  "IoT Structural Sensor Health Monitor",
  "Imminent Roof/Wall Collapse Alert",
  "Substandard Contractor Profiler",
  "High-Priority (Headquarters/Armory) Repair Classifier",
  "AI Assisted Vendor Penalty Drafter",
  "Maintenance Image/Blueprint Forecaster",
  "Secure Facility Layout Protector",
  "Integration with E-Tendering/Procurement",
  "Quarter Allotment Portal Sync",
  "Election Force Rapid Barrack Repair Modeler",
  "Disaster Earthquake Damage Coordinator",
  "Civil Maintenance/Repair Budget Tracker",
  "Custom Workflow for Heritage Police Buildings",
  "AI Driven Annual Repair Budget Predictor",
  "Predictive Need for Deep Renovation",
  "Custom Alert Trigger for IG Provisioning",
  "Snag Detection to Resolution Timeline"
];
...
const PoliceBuildingMaintenanceDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI POLICE BUILDING MAINTENANCE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI POLICE BUILDING <span>MAINTENANCE</span></h1>
...
export default PoliceBuildingMaintenanceDetailed;
