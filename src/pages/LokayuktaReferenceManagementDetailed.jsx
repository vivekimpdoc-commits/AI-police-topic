...
const aiExperts = [
  "Corruption Allegation NLP Extractor",
  "Disproportionate Asset Calculation AI",
  "Financial Transaction Trace Bot",
  "Asset Declaration Verifier Engine",
  "Benami Property Link Analyzer",
  "Contract/Tender Rigging Correlator",
  "Whistleblower Complaint Tracker",
  "Disciplinary Action Compliance Bot",
  "Lokayukta Reference Dashboard",
  "Voice-Command Lokayukta Query Bot",
  "Automated DA/Asset Report Gen",
  "Inter-Agency Vigilance Sync Bot",
  "Income vs Expenditure Modeler AI",
  "Shell Company Linkage Detector",
  "Lifestyle vs Salary Correlation AI",
  "Witness/Complainant Safety Scorer",
  "AI Evaluator for Inquiry Robustness",
  "Audit/Reference Access Log Gen",
  "Data Privacy/Complainant Scrubber",
  "State Vigilance Department Sync",
  "Field Vigilance IO Task App",
  "Historical Corruption Precedent Matcher",
  "Senior Officer (Vigilance) Briefing",
  "Forensic Accounting Resource Allocator",
  "Blockchain Immutable Asset Hash",
  "Anti-Tamper Financial Record Shield",
  "Mobile App for Vigilance Hearing Alerts",
  "Asset Geolocation Overlay Matcher",
  "Multi-Lingual Complaint Translator",
  "Historical Anti-Corruption Trend Analyzer",
  "Vigilance SOP Compliance Trainer",
  "Lokayukta Tracking DB Monitor",
  "Imminent Filing Deadline Alert Bot",
  "Organized Crime Synergy Profiler",
  "VIP/High-Ranking Officer Classifier",
  "AI Assisted Final Inquiry Drafter",
  "Financial Document Storage Forecaster",
  "Secure Whistleblower Protector",
  "Integration with Revenue/Tax Portals",
  "Citizen Anti-Corruption Portal Analytics",
  "Media/Political Fallout Modeler",
  "Disaster Fund Embezzlement Coordinator",
  "Lokayukta Inquiry Expense Tracker",
  "Custom Workflow for Prosecution Sanction",
  "AI Driven Lokayukta Ruling Predictor",
  "Predictive Need for CBI/ED Referral",
  "Custom Alert Trigger for Nodal Vigilance",
  "Lokayukta Case Timeline Tracker"
];
...
const LokayuktaReferenceManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI LOKAYUKTA REFERENCE MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI LOKAYUKTA REFERENCE <span>MANAGEMENT</span></h1>
...
export default LokayuktaReferenceManagementDetailed;
