...
const aiExperts = [
  "Bomb Disposal Robot (BDR) Remote Controller",
  "K9-Assist Ground Robot Coordinator AI",
  "Surveillance Crawler/Snake Robot Manager",
  "Anti-Terror Assault Robot Deployer Bot",
  "Underwater ROV (Remotely Operated Vehicle) AI",
  "Fire-Fighting Robot Deployment Engine",
  "Hostage Negotiation Robot Comm Link AI",
  "Chemical/Biological Hazmat Robot Controller",
  "Robotics Coordination Command Dashboard",
  "Voice-Command Robot Fleet Query Bot",
  "Automated Robot Health/Battery Monitor",
  "Cross-Unit Multi-Robot Swarm Sync AI",
  "Boston Dynamics/Tata Robotics Fleet Mgr",
  "Robot Night-Vision/Thermal Camera Sync",
  "Robot GPS/Indoor Navigation Engine AI",
  "Forensic Evidence Robot Collection Arm",
  "AI Evaluator for Robot Mission Success",
  "Audit/Robot Mission Log Auto-Generator",
  "Data Privacy/Robot Camera Feed Masker",
  "Police-Military Joint Robot Ops Sync",
  "Cyber Crime Lab Robot Evidence Handler",
  "Financial Vault Security Patrol Robot",
  "Senior Officer (NSG/ATS) Briefing Bot",
  "Public Demo/Exhibition Robot Coordinator",
  "Robot Blockchain Mission Log Hasher AI",
  "Anti-Hacking/Jamming Robot Shield Bot",
  "Mobile App for Remote Robot Pilot Sync",
  "Satellite Uplink Robot Control Link AI",
  "Multi-Lingual Robot Voice Command Bot",
  "Historical Robot Mission Analytics AI",
  "Staff Robot Operator Training Simulator",
  "Robot Spare Parts/Warranty Tracker AI",
  "Temporary Naka Robot Sentry Deployer",
  "Traffic Robot (Cop-Bot) Controller AI",
  "Accident Scene Robot Evidence Collector",
  "Post-Blast Robot Forensic Scanner AI",
  "AI Assisted Post-Mission Robot Debrief",
  "Robot Charging Station Network Planner",
  "VIP Route Robot Advance Sweeper AI",
  "Integration with DRDO/Defence Robot Program",
  "Citizen Robot Helpdesk Kiosk Controller",
  "Extreme Weather Robot Hardening AI",
  "Disaster Rescue Robot Deployment Engine",
  "Robotics Program Budget/ROI Tracker AI",
  "Custom Workflow/Approval for Robot Deploy",
  "AI Driven Robot Malfunction Predictor",
  "Predictive Need for Robot Fleet Scaling",
  "Custom Alert Trigger for Robot Ops Chief"
];
...
const RoboticsCoordinationPlatformDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ROBOTICS COORDINATION PLATFORM
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI ROBOTICS COORDINATION PLATFORM</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in managing bomb disposal, k9-assist bots, surveillance crawlers & anti-terror robots.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ROBOTICS <span>COORDINATION PLATFORM</span></h1>
            <p className="cyber-subtitle">Managing Bomb Disposal, K9-Assist Bots, Surveillance Crawlers & Anti-Terror Robots</p>
          </div>
        </div>
      </header>
...
export default RoboticsCoordinationPlatformDetailed;
