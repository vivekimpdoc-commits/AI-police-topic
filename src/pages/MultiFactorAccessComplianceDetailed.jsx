...
const aiExperts = [
  "MFA Policy Enforcement Engine AI",
  "Risk-Based Step-Up Authentication Bot",
  "OTP/SMS Gateway Integrator",
  "Hardware Token (FIDO2) Validator AI",
  "Context-Aware (Location/Device) Auth Scorer",
  "Failed Attempt/Brute-Force Detector",
  "Geo-Spatial Authentication Heatmapper",
  "Bypass/Exception Log Analyzer",
  "MFA Compliance Dashboard",
  "Voice-Command Security Query Bot",
  "Automated Weekly Compliance/Breach Report",
  "IT/Cyber Security Sync",
  "Phishing/Man-in-the-Middle (MitM) Predictor",
  "Token/Device Loss Alert AI",
  "Sim-Swap/Fraudulent OTP Detector",
  "User Adoption/Friction Analyzer",
  "AI Evaluator for Zero-Trust Maturity",
  "Audit/Auth Event Log Generator",
  "Data Privacy/Token ID Scrubber",
  "Network/Firewall Operations Sync",
  "User Authenticator Mobile App",
  "Historical Cyber Attack Correlator",
  "Chief Information Security Officer (CISO) Briefing",
  "Helpdesk/Token Reset Task Allocator",
  "Blockchain Immutable Auth Log Hash",
  "Anti-Tamper MFA Configuration Shield",
  "Mobile App for Push Notification Approval",
  "Department-wise MFA Compliance Benchmarker",
  "Automated Alert for Persistent Login Failures",
  "Historical MFA SMS/Gateway Cost Analyzer",
  "Cyber Hygiene/Zero-Trust SOP Trainer",
  "OTP Gateway/IdP Health Monitor",
  "Imminent Account Takeover Alert",
  "MFA Evader/Non-Compliant User Profiler",
  "High-Privilege (Database Admin) Account Classifier",
  "AI Assisted Security Violation Notice Drafter",
  "Authentication Log Storage Forecaster",
  "Secure Encryption/Signing Key Protector",
  "Integration with E-Office/CCTNS Applications",
  "Cyber Cell Threat Intel Sync",
  "Election Control Room Secure Access Modeler",
  "Disaster Remote Access/VPN Coordinator",
  "MFA/Token Licensing Budget Tracker",
  "Custom Workflow for Emergency Break-Glass Access",
  "AI Driven Authentication Delay Predictor",
  "Predictive Need for Passwordless Rollout",
  "Custom Alert Trigger for IG IT",
  "Authentication Request to Success/Denial Timeline"
];
...
const MultiFactorAccessComplianceDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI MULTI-FACTOR ACCESS COMPLIANCE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI MULTI-FACTOR ACCESS <span>COMPLIANCE</span></h1>
...
export default MultiFactorAccessComplianceDetailed;
