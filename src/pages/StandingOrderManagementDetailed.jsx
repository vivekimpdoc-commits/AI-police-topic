...
const aiExperts = [
  "Drafting/Formatting Assistant AI",
  "Legacy Order Consolidator Engine",
  "Periodic Review/Expiry Reminder Bot",
  "Version Control/Revision Tracker",
  "Cross-Reference to IPC/BNS AI",
  "Contradictory Clause Detector",
  "Geo-Spatial Applicability Mapper",
  "Approval Matrix/Hierarchy Automator",
  "Standing Order Dashboard",
  "Voice-Command SO Query Bot",
  "Automated Annual Review Report",
  "Law/Prosecution Department Sync",
  "Multi-Lingual Translation Engine",
  "Obsolete/Redundant Rule Identifier",
  "Plagiarism/Duplication Checker",
  "Executive Summary/Abstract Generator",
  "AI Evaluator for Legal Soundness",
  "Audit/Approval Log Generator",
  "Data Privacy/Internal Draft Scrubber",
  "State Police Headquarters Sync",
  "Officer Quick Reference Mobile App",
  "Historical Rule Amendment Correlator",
  "DGP/Legal Advisor Briefing AI",
  "Review Committee Task Allocator",
  "Blockchain Immutable SO Hash",
  "Anti-Tamper Rulebook Shield",
  "Mobile App for Draft Review",
  "Implementation Rate Benchmarker",
  "Automated Alert for Outdated Orders",
  "Historical Revision Frequency Analyzer",
  "Police Manual/SOP Trainer",
  "Document Server Health Monitor",
  "Imminent Legal Challenge/Conflict Alert",
  "Non-Compliance/Defaulter Profiler",
  "High-Stakes/Service Rule SO Classifier",
  "AI Assisted Amendment Drafter",
  "Rulebook/Archive Storage Forecaster",
  "Secure Restricted Order Protector",
  "Integration with Police Academy/Training",
  "RTI/Public Information Portal Sync",
  "Election Duty Standing Order Modeler",
  "Disaster Response SO Modification Coordinator",
  "Legal Consultation/Drafting Budget Tracker",
  "Custom Workflow for Emergency SO",
  "AI Driven Legal Implication Predictor",
  "Predictive Need for Comprehensive Overhaul",
  "Custom Alert Trigger for Chief Secretary",
  "Standing Order Lifecycle Timeline Tracker"
];
...
const StandingOrderManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI STANDING ORDER MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI STANDING ORDER <span>MANAGEMENT</span></h1>
...
export default StandingOrderManagementDetailed;
