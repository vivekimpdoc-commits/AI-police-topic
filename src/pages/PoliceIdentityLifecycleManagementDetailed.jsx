...
const aiExperts = [
  "ID Issuance/Onboarding Automator AI",
  "Rank Promotion/Transfer Sync Engine",
  "Retirement/Suspension ID Revocation Bot",
  "Credential Security/Audit Log Analyzer",
  "Biometric Enrollment Quality Checker",
  "Duplicate/Fake ID Detector",
  "Geo-Spatial ID Usage Mapper",
  "Digital Signature (DSC) Linker AI",
  "Identity Lifecycle Dashboard",
  "Voice-Command Identity Query Bot",
  "Automated Monthly Credential Audit Report",
  "HRMS/Personnel Department Sync",
  "Data Manipulation/Tamper Alert",
  "ID Card Expiry/Renewal Predictor",
  "Unauthorized Rank Upgrade Identifier",
  "Lifecycle Phase Transition Optimizer",
  "AI Evaluator for Credential Integrity",
  "Audit/Issuance Trail Generator",
  "Data Privacy/PII Scrubber",
  "State Intelligence/Security Branch Sync",
  "Identity Verification Mobile App",
  "Historical Credential Fraud Correlator",
  "DGP (Administration) Briefing AI",
  "ID Printing/Dispatch Task Allocator",
  "Blockchain Immutable Identity Hash",
  "Anti-Tamper Digital Credential Shield",
  "Mobile App for Rank Update Request",
  "Branch-wise Issuance Speed Benchmarker",
  "Automated Alert for Expired Credentials",
  "Historical ID Replacement Cost Analyzer",
  "Identity Verification SOP Trainer",
  "Central ID Database Health Monitor",
  "Imminent Impersonation/Breach Alert",
  "Habitual ID Loser (Careless Officer) Profiler",
  "High-Stakes (Intelligence/ATS) ID Classifier",
  "AI Assisted Suspension Notice Drafter",
  "Credential Image/Data Forecaster",
  "Secure Master Key/Certificate Protector",
  "Integration with National Databases (CCTNS)",
  "Force Welfare Portal Sync",
  "Election Deputation ID Modeler",
  "Disaster Emergency Access Authorization Coordinator",
  "Smart Card/Printing Budget Tracker",
  "Custom Workflow for Covert/Alias IDs",
  "AI Driven Next-Year Enrollment Predictor",
  "Predictive Need for ID Format Upgrade",
  "Custom Alert Trigger for IG Admin",
  "Onboarding to Retirement Timeline Tracker"
];
...
const PoliceIdentityLifecycleManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI POLICE IDENTITY LIFECYCLE MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI POLICE IDENTITY LIFECYCLE <span>MANAGEMENT</span></h1>
...
export default PoliceIdentityLifecycleManagementDetailed;
