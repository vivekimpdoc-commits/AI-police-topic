...
const aiExperts = [
  "Role-Based Restricted Access Control AI",
  "End-to-End Encryption Engine",
  "Hand-to-Hand (Special Messenger) Tracker",
  "Espionage/Leak Prevention Monitor",
  "Auto-Classification (Secret/Top Secret)",
  "Digital Watermarking/Print Tracker AI",
  "Geo-Spatial Movement of Messenger Mapper",
  "Unauthorized Copy/Forward Detector",
  "Confidential Register Dashboard",
  "Voice-Command Access Query Bot",
  "Automated Access/Audit Trail Report",
  "State Intelligence/CID Sync",
  "Biometric/OTP Decryption Gateway",
  "Self-Destruct/Time-Limited View Timer",
  "Phishing/Social Engineering Predictor",
  "Double-Envelope Verification Bot",
  "AI Evaluator for Security Protocol Compliance",
  "Audit/Chain of Custody Log Generator",
  "Data Privacy/PII Scrubber",
  "Ministry of Home Affairs Sync",
  "Special Messenger GPS Tracking App",
  "Historical Information Leak Correlator",
  "DGP/Intelligence Chief Briefing AI",
  "Clearance/Access Allocator",
  "Blockchain Immutable Custody Hash",
  "Anti-Tamper Encryption Shield",
  "Mobile App for Secure Viewing",
  "Unit-wise Secrecy Discipline Benchmarker",
  "Automated Alert for Unauthorized Access",
  "Historical Access Frequency Analyzer",
  "Official Secrets Act/SOP Trainer",
  "Encryption Server Health Monitor",
  "Imminent Data Leak/Compromise Alert",
  "Insider Threat/Snooping Profiler",
  "Nuclear/State Security Classifier",
  "AI Assisted Damage Control Protocol Drafter",
  "Encrypted Vault Storage Forecaster",
  "Secure SCIF (Sensitive Compartmented Info) Protector",
  "Integration with National Intelligence Grid",
  "Zero Public Exposure Sync",
  "Election Security Intelligence Modeler",
  "Disaster Vulnerability Intelligence Coordinator",
  "Encryption Infrastructure Budget Tracker",
  "Custom Workflow for Declassification",
  "AI Driven Threat/Leak Predictor",
  "Predictive Need for Clearance Upgrade",
  "Custom Alert Trigger for DGP",
  "Confidential Letter Lifecycle Tracker"
];
...
const ConfidentialLetterRegisterDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CONFIDENTIAL LETTER REGISTER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CONFIDENTIAL LETTER <span>REGISTER</span></h1>
...
export default ConfidentialLetterRegisterDetailed;
