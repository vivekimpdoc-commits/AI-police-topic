...
const aiExperts = [
  "Inward Summons/Warrant Sorting NLP",
  "Priority/Urgency Tagging Engine",
  "Investigating Officer (IO) Response Deadline Monitor",
  "Legal/Judicial Language Simplifier AI",
  "Non-Bailable Warrant (NBW) Execution Tracker",
  "Bailable Warrant (BW)/Summons Delivery Scorer",
  "Geo-Spatial Warrant Execution Hotspot Mapper",
  "Automated Acknowledgment/Service Report Router",
  "Judicial Correspondence Dashboard",
  "Voice-Command Warrant Query Bot",
  "Automated Weekly Unexecuted Warrant Report",
  "District Court/Registry Sync",
  "Statutory Deadline/Hearing Date Breach Predictor",
  "Absconder/Fugitive Flight Risk Analyzer",
  "Incorrect Address/Fake Surety Flagging AI",
  "Process Server/Constable Delay Estimator",
  "AI Evaluator for Process Execution Index",
  "Audit/Correspondence Log Generator",
  "Data Privacy/Witness Address Scrubber",
  "Prosecution Department Sync",
  "Process Server/Summons Constable Mobile App",
  "Historical Non-Execution/Contempt Correlator",
  "SP (Legal/Warrants) Briefing AI",
  "Warrant Execution/Serving Task Allocator",
  "Blockchain Immutable Service/Delivery Hash",
  "Anti-Tamper Court Notice Shield",
  "Mobile App for Geo-Tagged Summons Delivery",
  "Police Station-wise Warrant Execution Benchmarker",
  "Automated Alert for Long-Pending NBWs (High-Profile)",
  "Historical Postal/Dispatch Cost Analyzer",
  "Summons Service/Legal Process SOP Trainer",
  "E-Courts CIS (Case Information System) API Monitor",
  "Imminent SP/SHO Personal Appearance (Due to NBW Pendency) Alert",
  "Habitual Evader/Absconder Profiler",
  "High-Priority (CBI/CID/Supreme Court) Notice Classifier",
  "AI Assisted Non-Execution/Absconder Report (Sec 82/83) Drafter",
  "Warrant Execution/Pendency Trend Forecaster",
  "Secure Whistleblower/Protected Witness Detail Protector",
  "Integration with CCTNS/ICJS",
  "State Crime Records Bureau (SCRB) Sync",
  "Election (History-Sheeter NBW Execution) Mass Drive Modeler",
  "Disaster (Missing Accused/Witness) Address Verification Coordinator",
  "Process Server Travel/TA Budget Tracker",
  "Custom Workflow for Inter-State/International Extradition Notices",
  "AI Driven Successful Execution Probability Predictor",
  "Predictive Need for Special Warrant Execution Teams",
  "Custom Alert Trigger for SP Headquarters",
  "Receipt from Court to Final Execution Timeline"
];
...
const JudicialCorrespondenceTrackerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI JUDICIAL CORRESPONDENCE TRACKER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI JUDICIAL CORRESPONDENCE <span>TRACKER</span></h1>
...
export default JudicialCorrespondenceTrackerDetailed;
