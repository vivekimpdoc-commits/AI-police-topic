...
const aiExperts = [
  "Tariff Anomaly/Overcharging Detector AI",
  "Smart Sub-metering Usage Insights Bot",
  "Power Factor/Maximum Demand Penalty Analyzer",
  "Solar/Green Energy ROI (Net Metering) Scorer",
  "Peak Hour Load/Tariff Optimizer",
  "Vampire Draw/Idle Power Identifier",
  "Geo-Spatial Station-wise Energy Mapper",
  "AC/Heater Seasonal Usage Correlator",
  "Electricity Bill Dashboard",
  "Voice-Command Power Cost Query Bot",
  "Automated Monthly Energy Audit Report",
  "State Electricity Board (DISCOM) Sync",
  "Estimated vs Actual Reading Conflict Detector",
  "Faulty Meter/Slow Meter Predictor",
  "Illegal Hooking (Katiya) / Theft Identifier",
  "Energy Efficiency Rating (BEE) Correlator",
  "AI Evaluator for Green Police Station",
  "Audit/Payment Log Generator",
  "Data Privacy/Occupancy Scrubber",
  "Finance/Accounts Sync",
  "Energy Officer/Quartermaster Mobile App",
  "Historical Heatwave/Cooling Cost Correlator",
  ...
  "Mobile App for Meter Reading Upload",
  "Station-wise Energy Efficiency Benchmarker",
  "Automated Alert for Disconnection Notice",
  "Historical Energy Expenditure Trend Analyzer",
  "Energy Conservation SOP Trainer",
  "Smart Meter/IoT Gateway Health Monitor",
  "Imminent Budget Exhaustion Alert",
  "Energy Wasting Unit/Barrack Profiler",
  "High-Consumption (Data Center/Control Room) Classifier",
  "AI Assisted Disputed Bill Complaint Drafter",
  "Smart Meter Telemetry Storage Forecaster",
  "Secure Critical Infrastructure Power Protector",
  "Integration with Building Management System (BMS)",
  "Citizen Transparency (Green Energy) Sync",
  "Election Control Room 24x7 Load Modeler",
  "Disaster Power-Cut/DG Fuel Cost Coordinator",
  "Electricity/Energy Budget Tracker",
  "Custom Workflow for Solar Installation Tender",
  "AI Driven Summer Tariff Predictor",
  "Predictive Need for Capacitor Bank (Power Factor)",
  "Custom Alert Trigger for Nodal Officer",
  "Energy Cost Lifecycle Timeline Tracker"
];
...
const ElectricityBillAnalyticsDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ELECTRICITY BILL ANALYTICS
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ELECTRICITY BILL <span>ANALYTICS</span></h1>
...
export default ElectricityBillAnalyticsDetailed;
