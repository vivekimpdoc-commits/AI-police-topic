...
const aiExperts = [
  "VIP Reference/DO Letter Priority Engine",
  "Assembly/Parliament Question Tracker AI",
  "Court Notice/Summons Deadline Monitor",
  "NLP Topic/Subject Extractor Bot",
  "Auto-Assign/Routing to Relevant Branch",
  "Sentiment/Tone Analysis of Govt Letters",
  "Geo-Spatial Origin/Issue Mapper",
  "Cross-Reference Previous Correspondence AI",
  "Govt Letter Tracking Dashboard",
  "Voice-Command Letter Query Bot",
  "Automated Daily Pending Reply Report",
  "State Secretariat/MHA Sync Bot",
  "Multi-Lingual Translation (State Language to English)",
  "Attachment/Enclosure Verification Bot",
  "Fake/Forged Letterhead Detector",
  "Draft Reply/Noting Generator AI",
  "AI Evaluator for Reply Quality/Speed",
  "Audit/Correspondence Log Generator",
  "Data Privacy/Confidential Scrubber",
  "E-Courts/Legislative Assembly Sync",
  "Nodal Officer Alert Mobile App",
  "Historical Delayed Reply Correlator",
  "DGP/Home Secretary Briefing AI",
  "Drafting Task Allocator",
  "Blockchain Immutable Receipt Hash",
  "Anti-Tamper Correspondence Shield",
  "Mobile App for Draft Approval",
  "Department-wise Pendency Benchmarker",
  "Automated Reminder for Imminent Deadlines",
  "Historical Legislative Question Trend Analyzer",
  "Govt Correspondence SOP Trainer",
  "Tracking DB Server Health Monitor",
  "Imminent Contempt of Court/Privilege Motion Alert",
  "Chronic Defaulter Branch Profiler",
  "High-Sensitivity/Secret Letter Classifier",
  "AI Assisted Apology/Extension Drafter",
  "Archival Storage Forecaster",
  "Secure Official Secrets Act Protector",
  "Integration with E-Office",
  "Citizen Portal (for public notices) Sync",
  "Election Commission Letter Modeler",
  "Disaster/NDMA Directive Coordinator",
  "Correspondence Translation Budget Tracker",
  "Custom Workflow for Top-Secret Handling",
  "AI Driven Assembly Question Predictor",
  "Predictive Need for Legal/Expert Consultation",
  "Custom Alert Trigger for Chief Secretary",
  "Letter Lifecycle Timeline Tracker"
];
...
const GovernmentLetterTrackingDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI GOVERNMENT LETTER TRACKING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI GOVERNMENT LETTER <span>TRACKING</span></h1>
...
export default GovernmentLetterTrackingDetailed;
