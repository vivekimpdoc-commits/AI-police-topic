...
const aiExperts = [
  "Real-time Fuel Level IoT Sensor Sync AI",
  "Per-Vehicle Daily Fuel Consumption Tracker",
  "GPS Route vs Fuel Burn Correlation Engine",
  "Fuel Pump Dispenser Reconciliation Bot",
  "Petrol/Diesel Price Fluctuation Alert AI",
  "Fleet Average Mileage Benchmarking Bot",
  "Fuel Requisition/Indent Approval Workflow",
  "Emergency Refueling Route Optimizer AI",
  "Fuel Management Command Dashboard",
  "Voice-Command Fuel Status Query Bot",
  "Automated Monthly Fuel Statement Generator",
  "Cross-Station Fuel Consumption Comparator",
  "Fuel Tank Leak/Seepage Detection Sensor AI",
  "Adulteration/Quality Test Reminder Bot",
  "Fuel Card/Coupon Issuance Tracker AI",
  "Idle Engine Fuel Wastage Alert Bot",
  "AI Evaluator for Fleet Fuel Efficiency %",
  "Audit/Fuel Pilferage Investigation Logger",
  "Data Privacy/Driver Fuel Data Masker AI",
  "Police-State Petroleum Depot Sync Bot",
  "Patrol Car Fuel Optimization Route AI",
  "Armored Vehicle High-Fuel Usage Tracker",
  "Senior Officer (Transport SP) Briefing",
  "Public Vehicle Requisition Fuel Limiter AI",
  "Blockchain Immutable Fuel Transaction Log",
  "Anti-Siphoning Device Monitor AI",
  "Mobile App for Driver Refueling Log Sync",
  "Generator/DG Set Fuel Consumption Tracker",
  "Multi-Lingual Fuel Alert Translator Bot",
  "Historical Fuel Trend Precedent Matcher",
  "Staff Fuel Allowance Calculator AI",
  "Fuel Vendor SLA/Performance Tracker AI",
  "Temporary Naka Vehicle Fuel Allocation",
  "Traffic Patrol Bike Fuel Optimizer Bot",
  "Accident Response Vehicle Fuel Priority AI",
  "VIP Escort Convoy Fuel Reservation Bot",
  "AI Assisted Post-Month Fuel Audit Gen",
  "Fuel Budget vs Actual Expense Tracker",
  "Eco-Driving Score for Fuel Savings AI",
  "Integration with State Transport Portal",
  "Citizen Vehicle Fuel Theft Complaint Bot",
  "Extreme Heat Fuel Evaporation Monitor AI",
  "Disaster Response Vehicle Fuel Reserve",
  "Fuel Procurement Tender Budget Tracker",
  "Custom Workflow/Approval for Extra Fuel",
  "AI Driven Fuel Theft Pattern Predictor",
  "Predictive Need for Bulk Fuel Purchase",
  "Custom Alert Trigger for Fleet Admin"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI FUEL MANAGEMENT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI FUEL MANAGEMENT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in real-time fuel consumption tracking, mileage analytics & pump reconciliation.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI FUEL <span>MANAGEMENT</span></h1>
            <p className="cyber-subtitle">Real-time Fuel Consumption Tracking, Mileage Analytics & Pump Reconciliation</p>
          </div>
        </div>
      </header>
...
export default FuelManagementDetailed;
