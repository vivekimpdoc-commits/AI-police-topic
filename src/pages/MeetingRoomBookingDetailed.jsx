...
const aiExperts = [
  "Room Reservation Conflict Resolver AI",
  "Meeting Room Occupancy Forecaster Bot",
  "Smart AV System Device Allocator Bot",
  "Meeting Duration Estimator Algorithm",
  "No-Show Meeting Auto-Cancel Engine AI",
  "Optimal Meeting Size Recommender Bot",
  "Room Temperature Comfort Optimizer Bot",
  "Catering & Coffee Order Coordinator Bot",
  "Room Booking Operations Dashboard Portal",
  "Voice-Command Room Availability Query Bot",
  "Automated Daily Booking Audit Report Gen",
  "Cross-Department Meeting Invite Sync Engine",
  "Smart Screen AV Hardware Auto-Connector",
  "Suspicious Long Meeting Alert Monitor AI",
  "Meeting Room Noise Level Indicator Bot",
  "VIP Boardroom Booking Priority Router",
  "AI Evaluator for Room Booking Efficacy %",
  "Audit/Room Reservation Logs Auto-Generator",
  "Data Privacy/Meeting Subject Title Masker",
  "Police-HQ Administrative Calendar Sync Bot",
  "Meeting Host Room Control Mobile App Sync",
  "Cold Case Scheduling Conflict Resolver Bot",
  "Senior Officer (ADG Admin) Briefing Bot",
  "Public Meeting Invite QR Entry Portal",
  "Blockchain Immutable Room Booking Hasher Bot",
  "Anti-Double Booking Calendar Shield Engine",
  "Mobile App for Meeting Room Tablet Sign-in",
  "Bluetooth Beacon Proximity Presence Monitor",
  "Multi-Lingual Meeting Title Translator Bot",
  "Historical Peak Booking Hours Sorter Bot",
  "Staff Meeting Conduct Compliance Auditor AI",
  "Room Calendar API Server Health Monitor",
  "Urgent Emergency Operations Room Lock-in AI",
  "Traffic/Transit Conference Corridor Flow Monitor",
  "Air Quality Carbon Dioxide Sensor Warning AI",
  "VIP High-Security Meeting Perimeter Alert",
  "AI Assisted Post-Meeting Resource Report",
  "Room Cleaning/Maintenance Schedule Tracker",
  "Natural Ventilation Room Selector Optimizer",
  "Integration with Google Workspace/Outlook Calendar",
  "Citizen Public Grievance Room Booking App",
  "Extreme Case Emergency Meeting Room Sorter",
  "Disaster Command Center Quick Room Allocator",
  "Room Ops Maintenance Budget/Cost Tracker",
  "Custom Workflow/Approval for Director Boardroom",
  "AI Driven New Meeting Room Demand Predictor",
  "Predictive Need for Extra Meeting Spaces",
  "Custom Alert Trigger for HQ Secretary"
];
...
const MeetingRoomBookingDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI MEETING ROOM BOOKING
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI MEETING ROOM BOOKING</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in automated room reservation, schedule conflict resolution, smart av allocation & resource auditing.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI MEETING ROOM <span>BOOKING</span></h1>
            <p className="cyber-subtitle">Automated Room Reservation, Schedule Conflict Resolution, Smart AV Allocation & Resource Auditing</p>
          </div>
        </div>
      </header>
...
export default MeetingRoomBookingDetailed;
