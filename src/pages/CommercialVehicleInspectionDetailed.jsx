...
const aiExperts = [
"Overload Penalty Predictor",
  "Weighbridge Anomaly Sync Bot",
  "Commercial Freight Profiler AI",
  "GST/E-Waybill Discrepancy Finder",
  "Hazardous Material Transit Modeler",
  "Interstate Tax Evasion Analyst",
  "Multi-Axle Load Distribution AI",
  "Fake License Plate Detector",
  "Driver Logbook Fatigue Tracker",
  "Cargo Content X-Ray Sync AI",
  "Smuggling Route Prediction Engine",
  "Night-Time Transit Optimizer",
  "Customs Duty Deficit Flag AI",
  "Livestock Smuggling Alert Bot",
  "Agricultural Produce Verifier",
  "Stolen Goods Matching Algorithm",
  "Checkpost Duty Bypass Predictor",
  "Toll Booth Queue Analytics AI",
  "Automatic Number Plate Recognition (ANPR) Bot",
  "Vehicle Blacklist Database Sync",
  "Cross-Border Transit Delay Modeler",
  "Off-Road Checkpoint Detour Predictor",
  "Commercial Driver Background Checker",
  "Fleet Management Sync API",
  "Transport Union Strike Monitor",
  "Fuel Adulteration Alert Bot",
  "Cold Chain Logistics Profiler",
  "Over-Dimensional Cargo (ODC) Escort AI",
  "Tire Wear & Blowout Predictor",
  "Air-Brake Failure Analytics AI",
  "Challan Defaulter Identification AI",
  "State RTO Database Sync Bot",
  "Insurance/PUC Expiry Flag AI",
  "Suspicious Halt Geofence Alert",
  "Route Deviation Analyst Bot",
  "Fake Registration Document Scanner",
  "Driver Intoxication Sensor Sync",
  "Passenger-in-Cargo Alert Bot",
  "Illegal Liquor Transit Modeler",
  "Arms/Ammunition Smuggling Tracker",
  "Border Traffic Chokepoint Analyzer",
  "CCTV Freight Security Auditor",
  "Transport Agent Bribery Profiler",
  "Night Vision Thermal Escort AI",
  "Unregistered Goods Alert System",
  "Dynamic Cargo Value Estimator",
  "Automated E-Challan Generator",
  "Interstate Escort Routing AI",
  "Heavy Vehicle Bridge Load Monitor",
  "Real-Time GPS Spoofing Detector",
  "Anti-Tailgating Checkpost Sensor",
  "V2V (Vehicle-to-Vehicle) Communication Sync",
  "Smart Barricade Integration AI",
  "Commercial Vehicle Convoy Sync",
  "Border Toll Revenue Analytics",
  "Driver Face-Mismatch Alert AI",
  "Unauthorized Passenger Transit Bot",
  "Counterfeit Goods AI Scanner",
  "Regional Trade Flow Predictor",
  "High-Value Transit Tracking AI"
];
...
const CommercialVehicleInspectionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI COMMERCIAL VEHICLE INSPECTION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI COMMERCIAL VEHICLE INSPECTION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in automated overload detection, commercial tax verification & weighbridge sync.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI COMMERCIAL VEHICLE <span>INSPECTION</span></h1>
            <p className="cyber-subtitle">Automated Overload Detection, Commercial Tax Verification & Weighbridge Sync</p>
          </div>
        </div>
      </header>
...
export default CommercialVehicleInspectionDetailed;
