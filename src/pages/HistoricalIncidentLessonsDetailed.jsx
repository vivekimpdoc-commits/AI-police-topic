...
const aiExperts = [
  "Root Cause Analysis (RCA) Extraction AI",
  "Intelligence Gap/Failure Identification Engine",
  "Socio-Political Context/Undercurrent Mapper",
  "Automated Training Curriculum Updater Bot",
  "Media Narrative vs Ground Reality NLP Analyzer",
  "Officer/Command Chain Bottleneck Detector",
  "Geospatial Historical Flashpoint Heatmapper",
  "Inter-Agency Miscommunication Analyzer",
  "Historical Lessons Dashboard",
  "Voice-Command Incident Query Bot",
  "Automated Quarterly Lessons-Learned Report",
  "State/Central Intelligence Branch Sync",
  "Repeat Failure/Ignored Warning Predictor",
  "Systemic Vulnerability/Flaw Analyzer",
  "Resource/Logistical Deficit Predictor",
  "Community Alienation/Trust Deficit Scorer",
  "AI Evaluator for Institutional Learning Index",
  "Audit/Curriculum Update Log Generator",
  "Data Privacy/Classified Intel Scrubber",
  "Police Training College (PTC) Sync",
  "Commanding Officer/Instructor Mobile App",
  "Historical Casualty/Damage Correlator",
  "DGP (Planning/Modernization) Briefing AI",
  "Curriculum Revision/Integration Allocator",
  "Blockchain Immutable RCA Hash",
  "Anti-Tamper Classified Lesson Shield",
  "Mobile App for Quick Lesson Briefing (Pre-Deployment)",
  "State-to-State Incident Avoidance Benchmarker",
  "Automated Alert for Repeating Historical Mistakes",
  "Historical Compensation/Rebuilding Cost Analyzer",
  "Crisis Management/Command SOP Trainer",
  "Database/Archive Indexing API Monitor",
  "Imminent Major Incident (Repeating Pattern) Alert",
  "Systemic/Institutional Flaw Profiler",
  "High-Impact (Terror/Mass-Casualty) Lesson Classifier",
  "AI Assisted Inquiry Commission Report Drafter",
  "Incident Recurrence/Trend Forecaster",
  "Secure Inquiry/Commission File Protector",
  "Integration with National Security Council (NSCS)",
  "Home Department/Secretariat Sync",
  "Election Historical Violence (Booth-wise) Modeler",
  "Disaster Historical Flaw/Response Delay Coordinator",
  "Research & Analysis Budget Tracker",
  "Custom Workflow for High-Profile Assassinations",
  "AI Driven Institutional Readiness Score Predictor",
  "Predictive Need for Complete Policy Overhaul",
  "Custom Alert Trigger for Home Minister",
  "Inquiry Conclusion to Curriculum Update Timeline"
];
...
const HistoricalIncidentLessonsDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI HISTORICAL INCIDENT LESSONS
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI HISTORICAL INCIDENT <span>LESSONS</span></h1>
...
export default HistoricalIncidentLessonsDetailed;
