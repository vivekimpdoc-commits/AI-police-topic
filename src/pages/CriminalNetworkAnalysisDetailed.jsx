...
const aiExperts = [
"Telecom/CDR (Call Detail Record) Link Mapper",
  "Associate/Accomplice Graph Visualization AI",
  "Relative/Family Member Front-man Detector",
  "Financial/Bank Transaction Node Analyzer",
  "Social Media Mutual-Friend/Follower Linker",
  "Co-Accused/Historical FIR Link Modeler",
  "Bail Guarantor/Surety Network Cross-Check",
  "Prison/Jail Visitor Log Network Matcher",
  "Vehicle Ownership/Transfer Link Analyzer",
  "Property/Land Registry (Benami) Node AI",
  "Hotel/Flight Booking Co-Traveler Sync",
  "Weapon/License Common Supplier Modeler",
  "Cyber/IP Address Co-Location Linker Bot",
  "CCTV/Facial Recognition Co-Occurrence AI",
  "Undercover Informant Tip-Off Node Verifier",
  "Legal Counsel/Lawyer Commonality Analyzer",
  "Command Center Real-time Network Dashboard",
  "Voice-Command Network Node Query Assistant",
  "Automated Central Hub/Kingpin Identifier AI",
  "Degree of Separation/Shortest Path Modeler",
  "Predictive Next-Target/Next-Recruit AI",
  "Syndicate/Gang Splinter Faction Predictor",
  "Temporal Link (Time-Based Interaction) AI",
  "Spatial Link (Location-Based Meeting) AI",
  "AI Generated Network Dismantling Strategy",
  "Mobile App Interactive Graph Viewer for IOs",
  "Blockchain Immutable Log of Network Links",
  "Inter-Agency (CBI/ED/NIA) Graph Sync Bot",
  "Data Privacy/Innocent Bypass Filter Engine",
  "AI Evaluator for Network Disruption ROI",
  "Custom Entity/Node Type Definition Tool",
  "Senior Officer (SP/DGP) Executive Briefing",
  "Election Funding/Political Nexus Node Linker",
  "NGO/Shell Company Front-man Identifier Bot",
  "Cross-Border/International Node Tracker",
  "Terror/Sleeper Cell Network Visualization AI",
  "Narcotics/Drug Supply Chain Node Mapper",
  "Human Trafficking/Prostitution Ring Linker",
  "Illegal Mining/Sand Mafia Transport Sync",
  "Cyber-Fraud/Jamtara Caller Network AI",
  "Extortion/Ransom Call Relay Node Tracker",
  "Weapon Smuggling/Gun-Running Graph Bot",
  "Financial Scam/Ponzi Scheme Downline Link",
  "AI Assisted Interrogation Node Vulnerability",
  "Predictive Retaliation/Hit-man Node Modeler",
  "Witness Intimidation Source Tracker Bot",
  "Automated Arrest/Warrant Impact on Graph AI",
  "AI Driven Decoy/Honeypot Node Insertion",
  "Suspicious Activity/Outlier Node Alert Bot",
  "CCTNS Database Bulk Network Cross-Check",
  "AI Assisted Charge-Sheet Conspiracy Drafter",
  "Media/Public Relations Network Sanitizer",
  "Financial Audit of Common Nodes/Businesses",
  "Telecom IMEI/IMSI Swap/Burner Phone Linker",
  "AI Protocol for Multi-State Coordinated Raids",
  "Predictive Communication Blackout Impact AI"
];
...
const CriminalNetworkAnalysisDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CRIMINAL NETWORK ANALYSIS
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI CRIMINAL NETWORK ANALYSIS</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in link analysis, mapping associates/relatives/frontmen & cdr visualization.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CRIMINAL NETWORK <span>ANALYSIS</span></h1>
            <p className="cyber-subtitle">Link Analysis, Mapping Associates/Relatives/Frontmen & CDR Visualization</p>
          </div>
        </div>
      </header>
...
export default CriminalNetworkAnalysisDetailed;
