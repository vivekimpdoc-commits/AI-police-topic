...
const aiExperts = [
  "Tread Depth IoT Sensor Monitor AI",
  "Tyre Rotation Schedule Optimizer Bot",
  "Puncture/Blowout Prediction Engine AI",
  "Tyre Pressure (TPMS) Real-time Alert Bot",
  "Tyre Brand/Model Performance Comparator",
  "Retread vs New Tyre Decision Engine AI",
  "Tyre Age/Manufacturing Date Tracker Bot",
  "Tyre Alignment/Balancing Reminder AI",
  "Tyre Lifecycle Command Dashboard",
  "Voice-Command Tyre Status Query Bot",
  "Automated Tyre Replacement Alert Gen AI",
  "Cross-Fleet Tyre Consumption Comparator",
  "Tyre Warranty Claim Tracker Engine AI",
  "Road Surface vs Tyre Wear Correlation AI",
  "Tyre Inventory/Stock Level Monitor Bot",
  "Scrap Tyre Disposal/Recycling Tracker",
  "AI Evaluator for Tyre Cost per KM",
  "Audit/Tyre Fraud Investigation Logger",
  "Data Privacy/Vendor Tyre Data Masker AI",
  "Police-Tyre Supplier SLA Sync Bot",
  "Patrol Car Heavy-Use Tyre Allocator AI",
  "Armored Vehicle Bulletproof Tyre Tracker",
  "Senior Officer (Admin) Tyre Briefing Bot",
  "Public Fleet Tyre Condition Transparency",
  "Blockchain Immutable Tyre History Log",
  "Anti-Counterfeit Tyre Barcode Scanner AI",
  "Mobile App for Driver Tyre Inspection",
  "Electric Vehicle Low-Rolling Tyre Tracker",
  "Multi-Lingual Tyre Alert Translator Bot",
  "Historical Tyre Failure Pattern Matcher",
  "Staff Driver Tyre Abuse Report AI",
  "Vendor Tyre Delivery Performance Tracker",
  "Temporary Naka Vehicle Tyre Status Bot",
  "Traffic Patrol Bike Tyre Wear Tracker",
  "Accident-Caused Tyre Damage Assessor AI",
  "VIP Fleet Premium Tyre Allocation Bot",
  "AI Assisted Post-Replacement Quality Check",
  "Tyre Budget vs Actual Expense Tracker",
  "Eco-Tyre (Low Emission) Planner AI",
  "Integration with Tyre Manufacturer Portal",
  "Citizen Complaint about Bald Tyres Router",
  "Extreme Weather Tyre Selection Advisor",
  "Disaster Terrain Tyre Suitability Matcher",
  "Tyre Procurement Budget Tracker AI",
  "Custom Workflow/Approval for Bulk Purchase",
  "AI Driven Tyre Demand Forecaster",
  "Predictive Need for Emergency Stock",
  "Custom Alert Trigger for Store Keeper"
];
...
const TyreLifecycleTrackingDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI TYRE LIFECYCLE TRACKING
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI TYRE LIFECYCLE TRACKING</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in tread depth monitoring, rotation schedules & tyre procurement analytics.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI TYRE LIFECYCLE <span>TRACKING</span></h1>
            <p className="cyber-subtitle">Tread Depth Monitoring, Rotation Schedules & Tyre Procurement Analytics</p>
          </div>
        </div>
      </header>
...
export default TyreLifecycleTrackingDetailed;
