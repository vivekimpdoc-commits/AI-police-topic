...
const aiExperts = [
  "Need-to-Know/Clearance Level Router AI",
  "Decryption Key/Access Lifecycle Manager",
  "Secure Read-Receipt/Acknowledgement Tracker",
  "Information Leak/Insider Threat Scorer",
  "Time-Sensitive/Flash Intel Prioritizer",
  "Content Redaction/Sanitization Engine",
  "Geo-Spatial Threat vs Recipient Mapper",
  "Burn-After-Reading/Self-Destruct Enforcer",
  "Intelligence Dissemination Dashboard",
  "Voice-Command Workflow Query Bot",
  "Automated Daily Dissemination Audit Report",
  "State/Central Intelligence Branch Sync",
  "Unauthorized Forwarding/Screenshot Predictor",
  "Action-Delayed/Unread Intel Alert",
  "Clearance Level Violation/Bypass Analyzer",
  "Phishing/Social Engineering Compromise Predictor",
  "AI Evaluator for Secure Comms Efficiency",
  "Audit/Access/Decryption Log Generator",
  "Data Privacy/Source Protection Scrubber",
  "Special Branch/CID Sync",
  "Field Commander Secure Inbox App",
  "Historical Intel-Leak Correlator",
  "IG (Intelligence) Briefing AI",
  "Action-Taken Report (ATR) Allocator",
  "Blockchain Immutable Access Log Hash",
  "Anti-Tamper Watermarking/Fingerprint Shield",
  "Mobile App for Encrypted Intel View",
  "Unit-wise Response/Read-Time Benchmarker",
  "Automated Alert for Suspected Insider Leak",
  "Historical Secure Comms Infrastructure Cost Analyzer",
  "Information Security/OPSEC SOP Trainer",
  "Cryptography/VPN API Health Monitor",
  "Imminent Top-Secret Intel Compromise Alert",
  "Careless/Compromised Officer Profiler",
  "Flash/Critical (Actionable within Hours) Classifier",
  "AI Assisted Intelligence Circular Drafter",
  "Information Flow/Bottleneck Forecaster",
  "Secure Network/Air-Gapped Server Protector",
  "Integration with National Intelligence Grid",
  "Telecom/Cyber Security (CERT-In) Sync",
  "Election Sensitive Threat Intel Router",
  "Disaster Early-Warning Dissemination Coordinator",
  "Cyber Security/Encryption Budget Tracker",
  "Custom Workflow for VIP Movement Intel",
  "AI Driven Action Response Time Predictor",
  "Predictive Need for Clearance Revocation",
  "Custom Alert Trigger for DGP",
  "Intel Generation to Field Execution Timeline"
];
...
const IntelligenceDisseminationWorkflowDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INTELLIGENCE DISSEMINATION WORKFLOW
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INTELLIGENCE DISSEMINATION <span>WORKFLOW</span></h1>
...
export default IntelligenceDisseminationWorkflowDetailed;
