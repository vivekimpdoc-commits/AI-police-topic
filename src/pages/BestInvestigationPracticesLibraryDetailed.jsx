...
const aiExperts = [
  "Court Acquittal/Conviction Ratio Analyzer AI",
  "Forensic Evidence Collection SOP Validator",
  "Cyber/Financial Crime Tracking Guide Generator",
  "Cross-State Modus Operandi (MO) Sharing Engine",
  "Charge-sheet Flaw/Loophole Detector NLP",
  "Supreme/High Court Ruling Linker AI",
  "Geo-Spatial Organized Crime Best-Practice Mapper",
  "Witness/Victim Interrogation Tactics Extractor",
  "Investigation Practices Dashboard",
  "Voice-Command Case Law Query Bot",
  "Automated Weekly Investigative Insights Report",
  "State Crime Records Bureau (SCRB) Sync",
  "Investigative Pitfall/Common Error Predictor",
  "Procedural Lapses (CrPC/BNS) Red-Flagger",
  "New/Emerging Crime Trend Analyzer",
  "Evidence Chain-of-Custody Optimization Scorer",
  "AI Evaluator for Investigation Quality Index",
  "Audit/Library Access Log Generator",
  "Data Privacy/Victim PII Scrubber",
  "Directorate of Prosecution/Legal Sync",
  "Investigating Officer (IO) Mobile Toolkit App",
  "Historical Investigation Failure Correlator",
  "IG (CID/Crime) Briefing AI",
  "Refresher Training/Case Review Allocator",
  "Blockchain Immutable Case-Law Hash",
  "Anti-Tamper Evidence SOP Shield",
  "Mobile App for On-Scene Forensic Guidance",
  "Zone-wise Conviction Rate Benchmarker",
  "Automated Alert for High-Profile Acquittals",
  "Historical Litigation/Appeal Cost Analyzer",
  "Investigation/Charge-sheeting SOP Trainer",
  "Legal Database/API Sync Monitor",
  "Imminent Case Collapse (Due to Flawed SOP) Alert",
  "Habitual Poor-Investigator (IO) Profiler",
  "High-Stakes (Murder/Rape/Terror) Case Classifier",
  "AI Assisted Legal Opinion/Drafting Tool",
  "Conviction Rate/Trend Forecaster",
  "Secure Undercover/Sensitive Tactics Protector",
  "Integration with Inter-operable Criminal Justice System (ICJS)",
  "National/State Forensic Science Lab (FSL) Sync",
  "Election Violence Investigation Best Practices Modeler",
  "Disaster/Mass-Casualty Victim ID Practices Coordinator",
  "Legal/Forensic Training Budget Tracker",
  "Custom Workflow for Economic Offences Wing (EOW)",
  "AI Driven Case Success Probability Predictor",
  "Predictive Need for Specialized Forensic Tools",
  "Custom Alert Trigger for DGP",
  "Acquittal/Judgment to Library Update Timeline"
];
...
const BestInvestigationPracticesLibraryDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI BEST INVESTIGATION PRACTICES LIBRARY
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI BEST INVESTIGATION PRACTICES <span>LIBRARY</span></h1>
...
export default BestInvestigationPracticesLibraryDetailed;
