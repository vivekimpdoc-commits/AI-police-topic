...
const aiExperts = [
"Physical Record Condition Rater AI",
  "Climate/Humidity Sensor IoT Integration",
  "Pest Control/Anti-Termite Schedule Predictor",
  "Faded Ink/Torn Page Vulnerability Alert",
  "Historical FIR Preservation Priority Scorer",
  "Document Lamination/Binding Need Assessor",
  "Fire Suppression System Status Monitor AI",
  "Water-Leak/Seepage Early Warning Bot",
  "AI Driven Digitization Urgency Rater",
  "Record Room Access/Dust Ingress Tracker",
  "Fungus/Mold Growth Predictive Modeler",
  "Voice-Command Preservation Status Query",
  "Command Center Real-Time Environment Dash",
  "Automated Preservation Budget Estimator AI",
  "Acid-Free Paper Procurement Recommender",
  "Microfilm/Microfiche Archival Sync Bot",
  "Multi-Lingual Heritage Document Translator",
  "Pre-Independence/British Record Curator AI",
  "Document Restoration Specialist Vendor Link",
  "Blockchain Immutable Log of Interventions",
  "High-Profile Case Document Safe-Keeper",
  "Evidence/Malkhana Document Linkage AI",
  "RTI Document Fragility Refusal Suggester",
  "AI Generated Monthly Record Health Report",
  "Record Room Air Quality (AQI) Monitor",
  "Sunlight/UV Exposure Damage Predictor",
  "Old Blueprint/Map Preservation Tracker AI",
  "CCTNS Digital Twin Cross-Verification Bot",
  "Officer Custody/Handling Carelessness Rater",
  "Disaster Recovery/Evacuation Protocol AI",
  "AI Evaluator for Preservation Process ROI",
  "Inter-Agency (National Archives) Sync Bot",
  "Confidential File Degradation Alert AI",
  "Weapon/Armory Blue-Book Preservation AI",
  "Election/Constituency Map Archival Bot",
  "Suspicious Activity/Vandalism Alert AI",
  "Central PHQ Master Preservation Sync",
  "Automated Temperature Fluctuation SMS Alert",
  "AI Assisted Restoration Technique Suggester",
  "Record Room Capacity vs Density Optimizer",
  "Old FIR Indexing/Cataloging AI",
  "Handwritten Case Diary Ink Fading Predictor",
  "Post-Flood/Disaster Document Salvage AI",
  "AI Protocol for Handling Fragile Records",
  "Record Room Structural Integrity Rater",
  "Mobile App for Daily Physical Check Sync",
  "AI Driven Chemical Treatment Schedule",
  "Heritage Building Record Room Modeler AI",
  "Vendor Vetting for Fumigation Services",
  "AI Generated Video Guide for File Handling",
  "Cross-District Best Practice Sharer Bot",
  "Public Trust/Transparency Heritage Display AI",
  "Court Subpoena Fragile File Escort AI",
  "AI Assisted Insurance Valuation for Records",
  "Digital Enhancement of Damaged Text AI",
  "Historical Protest/Freedom Struggle Archiver"
];
...
const DocumentPreservationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DOCUMENT PRESERVATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI DOCUMENT PRESERVATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in tracking physical condition of old firs, pest control & climate/humidity monitoring.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DOCUMENT <span>PRESERVATION</span></h1>
            <p className="cyber-subtitle">Tracking Physical Condition of Old FIRs, Pest Control & Climate/Humidity Monitoring</p>
          </div>
        </div>
      </header>
...
export default DocumentPreservationDetailed;
