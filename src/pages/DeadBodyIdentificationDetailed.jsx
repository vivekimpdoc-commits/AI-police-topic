...
const aiExperts = [
  "UIDB (Unidentified Dead Body) DB Matcher",
  "Post-Mortem Craniofacial Reconstruction AI",
  "Dental Record/Odontology Matcher Bot",
  "Tattoo/Surgical Implant Serial Extractor",
  "Missing Persons (CCTNS) Cross-Matcher",
  "Decomposition Compensator/Enhancer AI",
  "Mortuary/Hospital Sync Engine",
  "DNA Profile/Forensic DB Integrator",
  "UIDB Command Dashboard",
  "Voice-Command Feature Query Bot",
  "Automated Daily Mortuary Report",
  "Forensic Science Lab (FSL) Sync Bot",
  "Geo-Spatial Discovery Spot Mapper",
  "Clothing/Belongings Pattern Matcher",
  "Foul Play/Homicide Indicator Extractor",
  "Fingerprint (Post-Mortem) Enhancer",
  "AI Evaluator for Match Probability",
  "Audit/Identification Log Gen",
  "Data Privacy/Deceased Detail Scrubber",
  "State Crime Records Bureau Sync",
  "Field IO UIDB Upload App",
  "Historical Missing Person Correlator",
  "SHO/Supervisory Officer Briefing",
  "Forensic/Medical Examiner Task Allocator",
  "Blockchain Immutable Autopsy Hash",
  "Anti-Tamper Forensic Record Shield",
  "Mobile App for Mortuary Staff",
  "Jurisdiction/River Current Modeler (for drownings)",
  "Multi-Lingual Press Release Generator",
  "Historical Identification Rate Analyzer",
  "UIDB Handling SOP/Protocol Trainer",
  "Mortuary DB Server Health Monitor",
  "Imminent Match/Family Locate Alert",
  "Serial Killer Victim Signature Profiler",
  "High-Profile/VIP Deceased Classifier",
  "AI Assisted Inquest Report Drafter",
  "High-Res Forensic Image Storage Forecaster",
  "Secure Informant Link Protector",
  "Integration with Aadhar/Biometric APIs",
  "Citizen UIDB Public Portal Sync",
  "Mass Casualty/Riot Victim Modeler",
  "Disaster/Calamity Mortuary Coordinator",
  "Forensic DNA/Burial Budget Tracker",
  "Custom Workflow for Cremation/Burial Approval",
  "AI Driven Origin/Hometown Predictor",
  "Predictive Need for Advanced DNA Profiling",
  "Custom Alert Trigger for SP/SSP",
  "UIDB Identification & Disposal Timeline Tracker"
];
...
const DeadBodyIdentificationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DEAD BODY IDENTIFICATION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DEAD BODY <span>IDENTIFICATION</span></h1>
...
export default DeadBodyIdentificationDetailed;
