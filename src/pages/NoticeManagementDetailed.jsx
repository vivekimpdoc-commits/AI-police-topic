...
const aiExperts = [
  "Section 41A/160 Notice Generator AI",
  "Legal Text/Format Vetting Engine",
  "Notice Compliance/Appearance Tracker",
  "Statutory Validity/Expiry Alert Bot",
  "Suspect/Witness Flight Risk Predictor",
  "Non-Compliance Escalation Analyzer",
  "CCTNS Notice Registry Sync",
  "Pending Notice Backlog Tracker",
  "Notice Command Dashboard",
  "Voice-Command Notice Status Bot",
  "Automated Daily Notice Roster",
  "Inter-Station Jurisdiction Sync Bot",
  "Geo-Spatial Suspect Movement Mapper",
  "Email/WhatsApp Delivery Receipt Tracker",
  "Fake Identity/Proxy Appearance Detector",
  "Digital Acknowledgment Verifier",
  "AI Evaluator for IO Notice Compliance",
  "Audit/Notice Access Log Gen",
  "Data Privacy/Informant Name Scrubber",
  "State Legal Dept Sync",
  "Field IO Notice Delivery App",
  "Historical Evasion Pattern Matcher",
  "SHO/Supervisory Officer Briefing",
  "Notice Server Resource Allocator",
  "Blockchain Immutable Notice Hash",
  "Anti-Tamper Record Shield",
  "Mobile App for Quick Compliance Updates",
  "Jurisdiction Polygon Matcher",
  "Multi-Lingual Notice Translator",
  "Historical Compliance Rate Analyzer",
  "Notice Procedure SOP Trainer",
  "Notice DB Server Health Monitor",
  "Imminent Expiry/Arrest Deadline Alert",
  "Syndicate Evasion Profiler",
  "High-Profile Notice Classifier",
  "AI Assisted Arrest Memo Drafter",
  "Document Storage Forecaster",
  "Secure Whistleblower Notice Protector",
  "Integration with Cyber Cell Tracking",
  "Citizen Notice Status Portal Sync",
  "Mass Agitation/Protest Notice Modeler",
  "Disaster Disrupted Compliance Tracker",
  "Notice Service Budget Tracker",
  "Custom Workflow for Notice Escalation",
  "AI Driven Non-Appearance Predictor",
  "Predictive Need for Surveillance/Lookout",
...
const NoticeManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI NOTICE MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI NOTICE <span>MANAGEMENT</span></h1>
...
export default NoticeManagementDetailed;
