...
const aiExperts = [
  "Real-Time SOP Query Resolution Bot",
  "Dynamic Procedural Checklist Generator",
  "Legal Loophole Identifier AI",
  "SOP Compliance Audit Tracker",
  "Context-Aware Procedure Router",
  "Emergency Response SOP Expediter",
  "Evidence Handling Protocol Enforcer",
  "Arrest/Detention SOP Verifier AI",
  "SOP Assistant Command Dashboard",
  "Voice-Command Procedure Query Bot",
  "Automated SOP Deviation Report",
  "Cross-Department SOP Sync Bot",
  "New Legislation Impact Analyzer AI",
  "Cyber Evidence SOP Validator",
  "Traffic/Accident Scene SOP Guide",
  "Forensic Lab Request Protocol Bot",
  "AI Evaluator for Field Compliance",
  "Audit/SOP Usage Log Generator",
  "Data Privacy/Sensitive Protocol Scrubber",
  "State Police HQ Directives Sync",
  "Field IO SOP Mobile App",
  "Cold Case SOP Revision Correlator",
  "Supervisory Officer Briefing AI",
  "Training/Refresh Course Allocator Bot",
  "Blockchain Immutable Audit Hash",
  "Anti-Tamper SOP Archive Shield",
  "Mobile App for Offline SOP View",
  "Jurisdiction-Specific SOP Matcher",
  "Multi-Lingual SOP Translator",
  "Historical SOP Deviation Analyzer",
  "SOP Authoring & Drafting Assistant",
  "SOP DB Server Health Monitor",
  "Imminent Compliance Failure Alert Bot",
  "Organized Crime Raid SOP Profiler",
  "VIP Escort/Security SOP Classifier",
  "AI Assisted New SOP Drafter",
  "SOP Document Storage Forecaster",
  "Secure Internal Audit Protector",
  "Integration with National Guidelines",
  "Citizen Interface Protocol Guide",
  "Riot/Mob Control SOP Modeler",
  "Disaster Response SOP Coordinator",
  "SOP Training Budget Tracker",
  "Custom Workflow for SOP Amendment",
  "AI Driven Common Error Predictor",
  "Predictive Need for SOP Modernization",
  "Custom Alert Trigger for Compliance Leads",
  "SOP Version Lifecycle Timeline Tracker"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SOP ASSISTANT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SOP <span>ASSISTANT</span></h1>
...
export default SOPAssistantDetailed;
