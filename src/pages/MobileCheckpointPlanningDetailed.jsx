...
const aiExperts = [
"Predictive Nakabandi Route Planner",
  "Smuggler Evasion Detour Modeler",
  "Surprise Checkpoint Generator",
  "Mobile Barricade Deployment Sync",
  "Traffic Chokepoint Analyzer",
  "Night-Time Secluded Route Profiler",
  "Criminal Heatmap Checkpoint Link",
  "DUI/DWI Hotspot Predictor",
  "Hit-and-Run Intercept Router",
  "Off-Road Vehicle Evasion Alert",
  "Interstate Border Detour Modeler",
  "Mobile CCTV Setup Optimizer",
  "Checkpost Duty Roster Generator",
  "Officer Fatigue & Relief Sync",
  "Weapon/Armoury Loadout Predictor",
  "Emergency Spike-Strip Deployer AI",
  "Checkpost Illumination/Power Planner",
  "Drone Aerial Surveillance Sync",
  "Radio Dead-Zone Mapping AI",
  "Local Villager Tipping Analyzer",
  "Informant Data to Checkpoint Link",
  "Gang Movement Intercept Planner",
  "Election Day Cash Seizure Router",
  "Illegal Liquor Transit Detour AI",
  "Arms Smuggling Chokepoint AI",
  "Livestock Smuggling Route Predictor",
  "Mobile Checkpoint ROI Scorer",
  "Traffic Jam Mitigation AI",
  "VIP Movement Route Clearer",
  "Ambulance Bypass Router AI",
  "Checkpost Security Threat Modeler",
  "Riot/Protest Blockade Coordinator",
  "Terrorist Infiltration Route AI",
  "Border Fence Breach Checkpoint",
  "Highway Patrol GPS Sync Bot",
  "Toll-Evasion Intercept Planner",
  "Vehicle Speed & Trajectory Modeler",
  "Fugitive Pursuit Trap Setter AI",
  "Cross-Border Jurisdiction Sync",
  "Mobile Checkpoint Van Tracker",
  "Checkpost Water & Rations Planner",
  "Weather-Impacted Checkpoint AI",
  "Fog/Visibility Safety Modeler",
  "Checkpost Accident Risk Analyzer",
  "Anti-Bribery Audit & Sync Bot",
  "Bodycam Stream to Command Sync",
  "Digital e-Challan Issuance Sync",
  "Breathalyzer Data Sync Bot",
  "Vehicle X-Ray Scanner Deployment",
  "Explosive Sniffer Dog (K9) Router",
  "Counterfeit Currency Check AI",
  "Inter-Agency Joint Operation Sync",
  "Mobile Checkpoint De-escalation AI",
  "Legal Compliance & Rights Auditor",
  "Citizen Feedback & Harassment Log",
  "Checkpost Abandonment Alert Bot",
  "Decoy Checkpoint Generator AI",
  "Tactical Ambush Risk Modeler",
  "Checkpost Infrastructure ROI AI",
  "Central Command Webhook Agent"
];
...
const MobileCheckpointPlanningDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI MOBILE CHECKPOINT PLANNING
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI MOBILE CHECKPOINT PLANNING</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in surprise nakabandi routing, predictive evasion & barricade logistics.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI MOBILE CHECKPOINT <span>PLANNING</span></h1>
            <p className="cyber-subtitle">Surprise Nakabandi Routing, Predictive Evasion & Barricade Logistics</p>
          </div>
        </div>
      </header>
...
export default MobileCheckpointPlanningDetailed;
