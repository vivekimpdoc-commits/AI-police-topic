...
const aiExperts = [
  "Drone-based Crack/Fissure Detector AI",
  "Seismic Vulnerability/Earthquake Readiness Scorer",
  "Material Degradation (Concrete/Steel) Analyzer",
  "Structural Integrity Predictive Modeler",
  "Thermal Imaging for Moisture/Leak Detection",
  "Vibration/Stress Sensor Sync Bot",
  "Geo-Spatial Police Real Estate Mapper",
  "Renovation/Repair Priority Scorer",
  "Structural Inspection Dashboard",
  "Voice-Command Building Health Bot",
  "Automated Quarterly Audit Report",
  "State Police Housing Corporation Sync",
  "Old/Heritage Police Station Assessment AI",
  "Load-Bearing Capacity Calculator",
  "Fake/Substandard Construction Material Predictor",
  "3D Building Model (BIM) Integrator",
  "AI Evaluator for Condemnation/Demolition",
  "Audit/Inspection Log Generator",
  "Data Privacy/Floor Plan Scrubber",
  "PWD (Public Works Department) Sync",
  "Field Engineer AR (Augmented Reality) App",
  "Historical Collapse/Failure Correlator",
  "Estate Officer Briefing AI",
  "Repair Task/Tender Allocator",
  "Blockchain Immutable Audit Hash",
  "Anti-Tamper Structural Report Shield",
  "Mobile App for Quick Image Uploads",
  "Inter-District Infrastructure Benchmarker",
  "Automated Reminder for Routine Checks",
  "Historical Maintenance Cost Analyzer",
  "Structural Safety SOP Trainer",
  "IoT Sensor Data Server Monitor",
  "Imminent Structural Collapse Alert",
  "Contractor Fraud/Corruption Profiler",
  "High-Risk/Dilapidated Building Classifier",
  "AI Assisted Condemnation Proposal Drafter",
  "Drone Video/3D Scan Storage Forecaster",
  "Secure Classified Blueprint Protector",
  "Integration with National Disaster Management Authority",
  "Citizen Safety Buffer Zone Sync",
  "Disaster Resilience Structural Modeler",
  "Post-Disaster Damage Assessment Coordinator",
  "Capital Expenditure/Repair Budget Tracker",
  "Custom Workflow for Emergency Evacuation",
  "AI Driven Lifespan Predictor",
  "Predictive Need for Major Renovation",
  "Custom Alert Trigger for Housing IG",
  "Building Lifecycle Timeline Tracker"
];
...
const BuildingStructuralInspectionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI BUILDING STRUCTURAL INSPECTION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI BUILDING STRUCTURAL <span>INSPECTION</span></h1>
...
export default BuildingStructuralInspectionDetailed;
