...
const aiExperts = [
"Malicious URL/Domain Reputation Scanner",
  "Spoofed Email Header/DKIM/SPF Analyzer",
  "SMS (Smishing) Link Origin Tracker AI",
  "Fake Banking/Govt Portal Clone Detector",
  "WhatsApp/Telegram Phishing Campaign Bot",
  "Social Media Spear-Phishing Profiler AI",
  "Typosquatting/Lookalike Domain Matcher",
  "Phishing Kit/Source Code Fingerprinter",
  "Automated Takedown Request (Registrar) Gen",
  "Zero-Day Phishing Threat Intel Feed Sync",
  "QR Code (Quishing) Destination Analyzer",
  "Voice Phishing (Vishing) Audio Deepfake Alert",
  "Command Center Phishing Heatmap Dash",
  "Voice-Command Phishing IOC Query Assistant",
  "URL Redirect/Shortener Unmasking Engine",
  "Malware Payload Drop URL Sandboxing AI",
  "Inter-Agency (CERT-In/NCIIPC) Sync Bot",
  "Telecom Bulk SMS Gateway Abuse Tracker",
  "AI Evaluator for Phishing Email Sophistication",
  "Blockchain Immutable Log of IOCs",
  "Public Incident Reporting/Triage Router AI",
  "Financial Institution Impersonation Alert",
  "Govt Scheme/Freebie Phishing Predictor",
  "Election/Voter ID Update Scam Tracker",
  "Corporate CEO/Vendor Fraud (BEC) AI",
  "Phishing Campaign Geolocation Modeler",
  "Tax/Income Tax Refund Spoof Alert Bot",
  "Delivery/Courier (FedEx/Post) Scam Linker",
  "AI Protocol for Mass-Blocking via ISPs",
  "Dark Web Credential Dump Sync for Phishing",
  "AI Driven Public Awareness SMS Drafter",
  "Senior Officer Cyber Briefing Generator",
  "Social Engineering Persuasion Metric AI",
  "Victim Compromise/Click-Rate Modeler",
  "Fake Job/Recruitment Phishing Analyzer",
  "Cloud Hosting (AWS/GCP) Phishing Abuse AI",
  "Dynamic Threat Signature Auto-Updater",
  "AI Assisted Subpoena for Domain Registrars",
  "SSL Certificate Forgery/LetsEncrypt Abuse AI",
  "Multi-Lingual Phishing Lure Translator Bot",
  "Ransomware Initial Access via Phishing AI",
  "Targeted VIP/Politician Spear-Phishing Guard",
  "AI Evaluator for Internal Police Email Security",
  "Custom YARA Rule Generator for Phishing"
];
...
const PhishingDetectionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI PHISHING DETECTION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI PHISHING DETECTION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in malicious url scanning, spoofed email analysis & sms (smishing) scam alerts.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI PHISHING <span>DETECTION</span></h1>
            <p className="cyber-subtitle">Malicious URL Scanning, Spoofed Email Analysis & SMS (Smishing) Scam Alerts</p>
          </div>
        </div>
      </header>
...
export default PhishingDetectionDetailed;
