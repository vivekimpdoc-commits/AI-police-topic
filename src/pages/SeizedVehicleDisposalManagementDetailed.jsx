...
const aiExperts = [
  "Chassis/Engine Number OCR Extractor",
  "RTO Vahan Database Cross-Matcher AI",
  "Vehicle Depreciation/Scrap Value Calculator",
  "Automated Release/Auction Routing Engine",
  "Stolen Vehicle Database (NCRB) Linker",
  "Insurance/Financier Claim Analyzer",
  "Geo-Spatial Police Station Yard Overcrowding Mapper",
  "Fake Registration/Forged Document Detector",
  "Vehicle Disposal Dashboard",
  "Voice-Command Vehicle Query Bot",
  "Automated Monthly Yard Decongestion Report",
  "Regional Transport Office (RTO) Sync",
  "Vehicle Rot/Total Loss Predictor",
  "Unclaimed/Abandoned Vehicle Alert",
  "Illegitimate Claimant/Fraud Predictor",
  "Environmental Hazard (Oil Leak/Rust) Analyzer",
  "AI Evaluator for Yard Decongestion Index",
  "Audit/Release Log Generator",
  "Data Privacy/Owner Detail Scrubber",
  "State Traffic Directorate Sync",
  "Traffic/Malkhana Officer Mobile App",
  "Historical Scrap-Value vs Time Correlator",
  "SP (Traffic/City) Briefing AI",
  "Valuation/RTO Verification Task Allocator",
  "Blockchain Immutable Vehicle Disposal Hash",
  "Anti-Tamper Release Order Shield",
  "Mobile App for On-Site Vehicle Assessment",
  "Station-wise Vehicle Clearance Benchmarker",
  "Automated Alert for Vehicles Parked > 1 Year",
  "Historical Towing/Storage Cost Analyzer",
  "Vehicle Release/Auction SOP Trainer",
  "Vahan/Sarathi API Health Monitor",
  "Imminent Station Yard Overcrowding Alert",
  "Habitual Fake Claimant/Scrap Mafia Profiler",
  "High-Value (Luxury/Commercial) Vehicle Classifier",
  "AI Assisted Superdari/Release Bond Drafter",
  "Vehicle Rust/Depreciation Forecaster",
  "Secure Confiscation/Challan Detail Protector",
  "Integration with CCTNS/E-Challan System",
  "Insurance Regulatory (IRDAI) Sync",
  "Election (Cash/Liquor Transport) Vehicle Confiscation Modeler",
  "Disaster (Flood Damaged) Abandoned Vehicle Coordinator",
  "Scrap/Towing Vendor Payment Budget Tracker",
  "Custom Workflow for Narcotics (NDPS) Smuggling Vehicles",
  "AI Driven Scrap vs Auction Probability Predictor",
  "Predictive Need for Centralized Vehicle Dumping Yards",
  "Custom Alert Trigger for DGP",
  "Seizure Date to Final Release/Auction Timeline"
];
...
const SeizedVehicleDisposalManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SEIZED VEHICLE DISPOSAL MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SEIZED VEHICLE DISPOSAL <span>MANAGEMENT</span></h1>
...
export default SeizedVehicleDisposalManagementDetailed;
