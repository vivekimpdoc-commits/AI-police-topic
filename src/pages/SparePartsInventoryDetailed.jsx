...
const aiExperts = [
  "Auto Reorder Point (ROP) Calculator AI",
  "Minimum/Maximum Stock Level Monitor Bot",
  "Vendor Quote Comparison & Selection AI",
  "Dead/Slow-Moving Stock Flagging Engine",
  "Fast-Moving Spare Part Priority Stockist",
  "Barcode/QR Code Inventory Scanner Bot",
  "Spare Part Compatibility Verifier AI",
  "Genuine vs Counterfeit Part Detector Bot",
  "Spare Parts Inventory Command Dashboard",
  "Voice-Command Stock Level Query Bot",
  "Automated Monthly Consumption Report Gen",
  "Cross-Workshop Stock Comparison Engine",
  "ABC Analysis (High-Value Part) Classifier",
  "Lead Time/Delivery Delay Predictor AI",
  "Warehouse Rack/Bin Location Optimizer Bot",
  "Scrap/Condemned Part Disposal Tracker",
  "AI Evaluator for Inventory Turnover Ratio",
  "Audit/Stock Discrepancy Logger AI",
  "Data Privacy/Vendor Price Data Masker AI",
  "Police-Procurement Portal (GEM) Sync Bot",
  "Patrol Car Common Spare Kit Assembler AI",
  "Armored Vehicle Specialized Part Tracker",
  "Senior Officer (Store) Inventory Briefing",
  "Public Tender/Procurement Transparency",
  "Blockchain Immutable Stock Movement Log",
  "Anti-Pilferage CCTV Store Monitor AI",
  "Mobile App for Store Keeper Issue/Receive",
  "Electric Vehicle Part Specialty Tracker",
  "Multi-Lingual Part Name Translator Bot",
  "Historical Consumption Trend Analyzer AI",
  "Staff Requisition Approval Workflow Bot",
  "Vendor Performance Rating Engine AI",
  "Temporary Naka Emergency Spare Kit Bot",
  "Traffic Vehicle Common Spare Stocker AI",
  "Accident Repair Part Fast-Track Issuer",
  "VIP Fleet Priority Spare Reservation",
  "AI Assisted Post-Issue Return/Surplus Audit",
  "Inventory Carrying Cost Optimizer AI",
  "Green/Recycled Part Procurement Planner",
  "Integration with GeM/E-Tender Portal",
  "Citizen Transparency on Police Fleet Parts",
  "Extreme Demand Surge Stock Buffer AI",
  "Disaster Vehicle Mass-Repair Stock Planner",
  "Spare Parts Budget/Expense Tracker AI",
  "Custom Workflow/Approval for Bulk Purchase",
  "AI Driven Stock-Out Risk Predictor",
  "Predictive Need for Emergency Procurement",
  "Custom Alert Trigger for Chief Store Keeper"
];
...
const SparePartsInventoryDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SPARE PARTS INVENTORY
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI SPARE PARTS INVENTORY</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in auto reorder, vendor management, consumption analytics & dead stock alerts.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SPARE PARTS <span>INVENTORY</span></h1>
            <p className="cyber-subtitle">Auto Reorder, Vendor Management, Consumption Analytics & Dead Stock Alerts</p>
          </div>
        </div>
      </header>
...
export default SparePartsInventoryDetailed;
