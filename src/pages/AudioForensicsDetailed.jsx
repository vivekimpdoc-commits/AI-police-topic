...
const aiExperts = [
"Voice-Print/Speaker Biometric Matcher",
  "Deepfake Audio (Voice Cloning) Detector",
  "Background Noise/Static Isolation Engine",
  "Emotional Stress/Deception Analysis Bot",
  "Speech-to-Text Multi-Lingual Transcriber",
  "Dialect/Regional Accent Profiler AI",
  "Extortion/Ransom Call Keyword Alert AI",
  "Gunshot/Explosion Acoustic Signature Matcher",
  "Audio Splicing/Tamper Detection Bot",
  "Hidden Microphone/Wiretap Echo Locator",
  "Overlapping Voice Separation (Diarization) AI",
  "Scream/Panic Audio Recognition Engine",
  "Command Center Real-time Audio Dashboard",
  "Voice-Command Audio Search Query Bot",
  "Automated Interrogation Transcript Generator",
  "Telecom/Wiretap Bulk Audio Scanner",
  "Social Media/WhatsApp Voice Note Analyzer",
  "Age/Gender Estimation from Voice AI",
  "Vehicle Engine/Background Environment Profiler",
  "Keyword/Slang (Drugs/Terror) Spotting Bot",
  "AI Evaluator for Audio Evidence Admissibility",
  "Blockchain Immutable Hash of Audio Files",
  "Inter-Agency (CBI/NIA) Voice DB Sync",
  "Riot/Mob Incitement Speech Analyzer",
  "Hate Speech/Communal Audio Profiler",
  "Officer Body-Cam Audio Enhancer AI",
  "Undercover Sting/Hidden Mic Enhancer",
  "Suicide Note/Distress Call Sentiment AI",
  "AI Assisted Forensic Report Drafter",
  "Data Privacy/Victim Voice Masking Bot",
  "Mobile App Audio Recording Enhancer",
  "Senior Officer Incident Briefing Audio Gen",
  "Codec/Compression Artifact Analyzer AI",
  "Audio Frequency/Spectrogram Visualizer",
  "Electrical Grid (ENF) Audio Timestamp Verifier",
  "Fake Customer Care/Scammer Voice Matcher",
  "Jamtara/Phishing Module Caller Profiler",
  "Kidnapping/Hostage Proof-of-Life Verifier",
  "VIP Threat/Abusive Call Trace AI",
  "Election Rally Hate Speech Transcription AI",
  "Domestic Violence/Abuse 112 Call Analyzer",
  "Integration with National Voice DB (CCTNS)",
  "AI Driven Batch Audio Categorization",
  "Predictive Threat Escalation from Tone AI",
  "Custom Keyword/Phrase Training Interface",
  "Disaster/Emergency Call Triage Priority AI",
  "Industrial/Machinery Tamper Acoustic Rater",
  "Cyber-Bullying Audio Note Tracker"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI AUDIO FORENSICS
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI AUDIO FORENSICS</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in voice-print matching, background noise isolation, voice cloning & stress analysis.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI AUDIO <span>FORENSICS</span></h1>
            <p className="cyber-subtitle">Voice-Print Matching, Background Noise Isolation, Voice Cloning & Stress Analysis</p>
          </div>
        </div>
      </header>
...
export default AudioForensicsDetailed;
