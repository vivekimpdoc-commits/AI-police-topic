...
const aiExperts = [
  "Generative AI Age Progression Engine",
  "Pediatric Bone/Facial Structure Modeler",
  "Genetic/Family Resemblance Integrator",
  "Long-Term Fugitive Aging Simulator",
  "Lifestyle Factor (Smoking/Weight) Modifier",
  "Historical Cold Case Photo Enhancer",
  "CCTNS/Missing Persons DB Sync",
  "Cross-Age Facial Recognition Matcher",
  "Age Progression Dashboard",
  "Voice-Command Progression Request Bot",
  "Automated Quarterly Cold Case Update",
  "Anti-Human Trafficking Unit Sync Bot",
  "Geo-Spatial Last Known Location Mapper",
  "Morph/Deepfake Detection AI",
  "Skull-to-Face Reconstruction Overlay",
  "Disguise (Beard/Glasses) Simulator",
  "AI Evaluator for Progression Accuracy",
  "Audit/Render Log Generator",
  "Data Privacy/Victim Info Scrubber",
  "State CID/Crime Branch Sync",
  "Field IO Progression Reference App",
  "Historical Recovery Correlator AI",
  "Supervisory/Nodal Officer Briefing",
  "Cold Case Re-investigation Allocator",
  "Blockchain Immutable Render Hash",
  "Anti-Tamper Image Shield",
  "Mobile App for Family Updates",
  "Jurisdiction Matcher",
  "Multi-Lingual Missing Poster Updater",
  "Historical Match Success Rate Analyzer",
  "Age Progression Utility SOP Trainer",
  "Render Farm Server Health Monitor",
  "Imminent Cold Case Lead Alert",
  "Child Trafficking Syndicate Profiler",
  "High-Profile Fugitive Classifier",
  "AI Assisted Re-Investigation Plan Drafter",
  "High-Res Image Storage Forecaster",
  "Secure Identity Protection Scrubber",
  "Integration with NGO/Shelter Home DBs",
  "Citizen 'Have You Seen Me?' Portal Sync",
  "Long-Term Kidnapping Outcome Modeler",
  "Disaster Orphan Identification Coordinator",
  "Progression Software/Compute Budget Tracker",
  "Custom Workflow for Interpol Red Notice",
  "AI Driven Location Predictor",
  "Predictive Need for Specialized Task Force",
  "Custom Alert Trigger for IG/ADG",
  "Cold Case Lifecycle Timeline Tracker"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI AGE PROGRESSION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI AGE <span>PROGRESSION</span></h1>
...
export default AgeProgressionDetailed;
