...
const aiExperts = [
  "3D Terrain Mapper AI",
  "Crime Hotspot Heatmap Bot",
  "GPS Patrol Vehicle Sync AI",
  "Dynamic Beat Route Planner",
  "Inter-State Border GIS Linker",
  "Topographical Line-of-Sight Analyzer",
  "Hydrological Flood Impact Modeler",
  "Infrastructure Asset Geotagger Bot",
  "GIS Platform Command Dashboard",
  "Voice-Command Map Layer Query Bot",
  "Automated Daily Geospatial Report Gen",
  "Cross-Department GIS Database Sync Engine",
  "Emergency SOS Location Triangulation AI",
  "Suspicious Vehicle Path Overlay Bot",
  "Historical Crime Density Trend Plotter",
  "Illegal Mining Satellite GIS Matcher",
  "AI Evaluator for Route Vulnerability Score",
  "Audit/Map Layer Edit Log Generator",
  "Data Privacy/Officer Location Masker AI",
  "Police-Municipal GIS Database Sync Bot",
  "Patrol Beat Officer Mobile Map Sync",
  "Cold Case Location Signature Linker AI",
  "Senior Officer (SP GIS Command) Briefing Bot",
  "Public Missing Person Last-Seen Geo Portal",
  "Blockchain Immutable Geotagged Evidence Log",
  "Anti-Tamper GPS Tracking Security AI",
  "Mobile App for Offline Map Navigation",
  "Waterbody Encroachment Geo-Profiler Bot",
  "Multi-Lingual Location Name Translator Bot",
  "Historical Landslide/Road Blockage Predictor",
  "Patrol Vehicle Fuel-Efficiency Route Optimizer",
  "GIS Server/Geo-Database Health Monitor Bot",
  "Urgent Riot Mobilization Route Planner Alert",
  "Traffic Intersect Congestion Heatmap Linker",
  "Terror Safehouse Spatial Clustering Analyzer",
  "VIP Convoy Alternate Route Generator AI",
  "AI Assisted Post-Disaster Geo Damage Valuation",
  "Beat Force Deployment Spatial Forecaster",
  "Global/National Grid Coordinate Translator",
  "Integration with ISRO/Bhuvan GIS Database",
  "Citizen Public Utility Fault Reporting App",
  "Extreme Weather Route Navigation Assistant",
  "Evacuation Zone Crowd Flow Simulator AI",
  "GIS Operations Budget/Cost Tracker AI",
  "Custom Workflow/Approval for Map Layer Edit",
  "AI Driven New Crime Cluster Predictor",
  "Predictive Need for Extra Checkpoint Location",
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI GIS PLATFORM
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI GIS PLATFORM</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in geospatial mapping, layering data, real-time resource location tracking & crime hotspots.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI GIS <span>PLATFORM</span></h1>
            <p className="cyber-subtitle">Geospatial Mapping, Layering Data, Real-Time Resource Location Tracking & Crime Hotspots</p>
          </div>
        </div>
      </header>
...
export default GISPlatformDetailed;
