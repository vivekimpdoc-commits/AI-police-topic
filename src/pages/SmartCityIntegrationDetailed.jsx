...
const aiExperts = [
  "Smart Traffic Light Cycle Optimizer AI",
  "Acoustic Gunshot Triangulation Detector Bot",
  "Air Quality Index (AQI) Anomaly Alert AI",
  "Smart Streetlight Energy Saver Sync Bot",
  "Public Wi-Fi Rogue AP Scanner Engine AI",
  "Drainage/Manhole Overflow Predictor Bot",
  "IoT Fire Alarm Heat Sensor Linker AI",
  "Emergency Broadcast Speaker Sync Bot",
  "Smart City Command Dashboard Portal",
  "Voice-Command IoT Sensor Status Bot",
  "Automated Daily Smart Infrastructure Report",
  "Cross-Agency (Municipal/Police) IoT Sync",
  "Emergency Vehicle Green Corridor Routing AI",
  "Crowd Density Sensor Overload Predictor Bot",
  "Smart Parking Space Availability Forecaster",
  "Electric Grid Overload Short-Circuit Alert",
  "AI Evaluator for Urban Infrastructure Safety",
  "Audit/Sensor Configuration Change Log Bot",
  "Data Privacy/Citizen Face Blur CCTV Engine",
  "Police-Smart City Command Center (ICCC) Sync",
  "Maintenance Engineer Mobile Alert Sync Portal",
  "Cold Case CCTV Footage Location Linker AI",
  "Senior Officer (Commissioner ICCC) Briefing Bot",
  "Public Citizen Utility Feedback Smart App",
  "Blockchain Immutable IoT Command Log Engine",
  "Anti-Cyber Attack Sensor Geofence Defensor",
  "Mobile App for Smart Signal Override",
  "Gas Leak/Toxic Fume Diffusion Modeler AI",
  "Multi-Lingual Public Alert Announcement Bot",
  "Historical Infrastructure Failure Trend Matcher",
  "Smart City Field Staff Safety Monitor Bot",
  "CCTV Camera/Sensor Hardware Health Analyzer",
  "Urgent Fire Emergency Evacuation Coordinator",
  "Traffic Speed Gun Integration Alert Bot",
  "Sound Pollution/Decibel Limit Warning Alert",
  "VIP Movement Smart Signal Corridor Planner",
  "AI Assisted Smart City Damage Audit Report",
  "Municipal Water Supply Valve Safety Monitor",
  "Subway/Underpass Flood Level Water Monitor",
  "Integration with National Smart Cities Mission DB",
  "Citizen Smart Helpdesk Voice Assistant Bot",
  "Extreme Heat/Cold Infrastructure Risk Modeler",
  "Mass Evacuation Assembly Point Allocator AI",
  "ICCC Sensor Maintenance Budget Tracker AI",
  "Custom Workflow/Approval for Emergency Lockdown",
  "AI Driven Smart Grid Energy Load Predictor",
  "Predictive Need for Emergency Service Dispatch",
  "Custom Alert Trigger for ICCC Commander"
];
...
const SmartCityIntegrationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SMART CITY INTEGRATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI SMART CITY INTEGRATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in iot sensor feeds, smart traffic signals, infrastructure monitoring & evacuation routing.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SMART CITY <span>INTEGRATION</span></h1>
            <p className="cyber-subtitle">IoT Sensor Feeds, Smart Traffic Signals, Infrastructure Monitoring & Evacuation Routing</p>
          </div>
        </div>
      </header>
...
export default SmartCityIntegrationDetailed;
