...
const aiExperts = [
  "Section 35 (CrPC 41A) Notice Automation AI",
  "Mass Email/SMS Delivery & Read-Receipt Tracker",
  "India Post/Courier API Integrator",
  "Statutory Response Timeline Logging Engine",
  "Language Translation/Formatting Bot",
  "Bounced/Undelivered Notice Analyzer",
  "Geo-Spatial Notice Distribution/Compliance Mapper",
  "Digital Signature/Authentication Validator",
  "Notice Dispatch Dashboard",
  "Voice-Command Dispatch Query Bot",
  "Automated Weekly Notice Compliance Report",
  "Directorate of Prosecution Sync",
  "Non-Compliance/Absconder Risk Predictor",
  "Invalid Address/Fake Contact Alert",
  "Statutory Deadline (14 days) Breach Predictor",
  "Systemic Postal/Courier Delay Analyzer",
  "AI Evaluator for Dispatch/Service Efficiency",
  "Audit/Delivery Log Generator",
  "Data Privacy/Suspect Contact Scrubber",
  "Telecom/ISP Data Sync (for Digital Delivery)",
  "Investigating Officer/Desk Officer Mobile App",
  "Historical Non-Compliance to Arrest Correlator",
  "SP (Crime/Cyber) Briefing AI",
  "Follow-up/Verification Task Allocator",
  "Blockchain Immutable Dispatch/Delivery Hash",
  "Anti-Tamper Delivery Receipt Shield",
  "Mobile App for Field Verification of Address",
  "Unit-wise Digital Service Adoption Benchmarker",
  "Automated Alert for High-Profile Non-Compliance (Action Required)",
  "Historical Postal/SMS API Cost Analyzer",
  "Legal Drafting/Notice Issuance SOP Trainer",
  "SMS Gateway/Postal API Health Monitor",
  "Imminent Legal Challenge (Due to Defective Service) Alert",
  "Habitual Evader/Non-Responder Profiler",
  "High-Priority (Cyber/Economic Offence) Notice Classifier",
  "AI Assisted Non-Bailable Warrant (NBW) Request Drafter",
  "Notice Volume/Dispatch Cost Forecaster",
  "Secure Target Identity/Case Detail Protector",
  "Integration with CCTNS/ICJS",
  "State Cyber Crime Coordination Center Sync",
  "Election (Preventive Binding Down) Mass Notice Modeler",
  "Disaster (Evacuation/Requisition) Urgent Notice Coordinator",
  "Postal/Digital Communication Budget Tracker",
  "Custom Workflow for Foreign National/Interpol Notices",
  "AI Driven Compliance/Appearance Probability Predictor",
  "Predictive Need for Physical Raid/Arrest",
  "Custom Alert Trigger for IG Legal",
  "Notice Generation to Acknowledgment/Compliance Timeline"
];
...
const LegalNoticeDispatchCenterDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI LEGAL NOTICE DISPATCH CENTER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI LEGAL NOTICE DISPATCH <span>CENTER</span></h1>
...
export default LegalNoticeDispatchCenterDetailed;
