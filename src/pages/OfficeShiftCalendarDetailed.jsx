...
const aiExperts = [
  "Dynamic 24/7 Shift Optimizer AI",
  "Fatigue/Rest Gap Manager",
  "Skill-based (Cyber/Comms) Shift Allocator",
  "Automated Duty Swapping Approver",
  "Leave/Absence Conflict Resolver",
  "Peak Workload/Crime Trend Sync",
  "Geo-Spatial Staff Commute Mapper",
  "Overtime/Comp-Off Balance Tracker",
  "Shift Calendar Dashboard",
  "Voice-Command Roster Query Bot",
  "Automated Weekly Roster Publisher",
  "HRMS/Payroll Sync Bot",
  "Predictive Absenteeism Modeler",
  "Gender/Special Need Shift Accommodator",
  "Fake Medical Leave Predictor",
  "Emergency Surge Staffing AI",
  "AI Evaluator for Roster Fairness",
  "Audit/Roster Change Log Generator",
  "Data Privacy/Staff Detail Scrubber",
  "State Police Headquarters Sync",
  "Officer Shift/Swap Mobile App",
  "Historical Staff Shortage Correlator",
  "Supervisory Officer Briefing AI",
  "Reserve/Standby Staff Allocator",
  "Blockchain Immutable Roster Hash",
  "Anti-Tamper Shift Shield",
  "Mobile App for Instant Shift Alerts",
  "Jurisdiction-wise Shift Benchmarker",
  "Multi-Lingual Shift Notification",
  "Historical Fatigue-Incident Analyzer",
  "Shift Policy/SOP Trainer",
  "Roster DB Server Health Monitor",
  "Imminent Under-staffing Alert",
  "Habitual Shift Evader Profiler",
  "Critical/Night Shift Classifier",
  ...
  "Election/Festival Surge Shift Modeler",
  "Disaster Extended Shift Coordinator",
  "Overtime/Allowance Budget Tracker",
  "Custom Workflow for VIP Duty Reallocation",
  "AI Driven Burnout/Stress Predictor",
  "Predictive Need for Recruitment",
  "Custom Alert Trigger for SP/SSP",
  "Officer Shift Lifecycle Timeline Tracker"
];
...
const OfficeShiftCalendarDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI OFFICE SHIFT CALENDAR
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI OFFICE SHIFT <span>CALENDAR</span></h1>
...
export default OfficeShiftCalendarDetailed;
