...
const aiExperts = [
  "Stolen Goods Database (CCTNS) Matcher",
  "Suspicious Transaction Anomaly Detector",
  "Digital Ledger OCR/Data Extractor",
  "Frequent Pledger/Seller Profiler",
  "Item Serial Number/IMEI Verifier",
  "Shop License Expiry/Renewal Tracker",
  "Geo-Spatial Pawn Shop Heatmapper",
  "Repeat Offender Fencing Network AI",
  "Pawn Shop Command Dashboard",
  "Voice-Command Item Query Bot",
  "Automated Daily Audit Report",
  "Inter-District Fencing Sync Bot",
  "CCTV Feed Anomaly Detector (Shop Front)",
  "Jewelry Melting/Tampering Predictor",
  "Fake ID/Alias Verification AI",
  "Statutory Compliance (KYC) Auditor",
  "AI Evaluator for IO Audit Efficiency",
  "Audit/Seizure Log Generator",
  "Data Privacy/Legitimate Seller Scrubber",
  "State Licensing Department Sync",
  "Field IO Spot-Check App",
  "Historical Fencing Hotspot Matcher",
  "SHO/Supervisory Officer Briefing AI",
  "Raid/Recovery Task Allocator",
  "Blockchain Immutable Ledger Hash",
  "Anti-Tamper Digital Record Shield",
  "Mobile App for Shop Owners (Upload)",
  "Jurisdiction Polygon Matcher",
  "Multi-Lingual Compliance Translator",
  "Historical Recovery Rate Analyzer",
  "Audit SOP/Guideline Trainer",
  "Pawn DB Server Health Monitor",
  "Imminent License Expiry Alert Bot",
  "Organized Crime Syndicate Fencing Profiler",
  "High-Value Item Alert Classifier",
  "AI Assisted Search Warrant Drafter",
  "Digital Ledger Storage Forecaster",
  "Secure Whistleblower Link Protector",
  "Integration with National Stolen Vehicle DB",
  "Citizen Lost Item Search Portal Sync",
  "Inter-State Smuggling Route Modeler",
  "Disaster/Looting Recovery Coordinator",
  "Recovery/Reward Budget Tracker",
  "Custom Workflow for License Cancellation",
  "AI Driven Stolen Item Match Predictor",
  "Predictive Need for Specialist Appraiser",
  "Custom Alert Trigger for SP/SSP",
  "Recovery/Seizure Timeline Tracker"
];
...
const PawnShopMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI PAWN SHOP MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI PAWN SHOP <span>MONITORING</span></h1>
...
export default PawnShopMonitoringDetailed;
