...
const aiExperts = [
  "Bullet Striation Comparison AI Engine",
  "Cartridge Case Ejector Mark Matcher Bot",
  "IBIS (Integrated Ballistic ID) Search AI",
  "Firearm Serial Number Recovery Enhancer",
  "Gunshot Residue (GSR) Pattern Analyzer",
  "Trajectory Reconstruction 3D Modeler AI",
  "Bullet Fragmentation Reassembly Bot",
  "Weapon Type Identifier from Bullet AI",
  "Ballistics Analysis Command Dashboard",
  "Voice-Command Ballistic Search Query Bot",
  "Automated Ballistic Report Generator AI",
  "Cross-State IBIS Database Sync Engine",
  "Country-of-Origin Weapon Tracer AI Bot",
  "Illegal Arms Factory Detection Linker",
  "Firing Range Test-Fire Database Manager",
  "Bullet Caliber/Gauge Classifier Engine",
  "AI Evaluator for Ballistic Match Score",
  "Audit/Chain-of-Custody Ammo Log Gen",
  "Data Privacy/Sensitive Arms Data Masker",
  "Police-NCRB/NSG Ballistic Bureau Sync",
  "Patrol Officer Fired Shell Collection App",
  "Cold Case Ballistic Re-Analysis Engine",
  "Senior Officer (Forensic Dir) Briefing",
  "Public Arms License Surrender Tracker",
  "Blockchain Immutable Ballistic Record",
  "Anti-Tampering Evidence Bullet Seal AI",
  "Mobile App for IO Bullet Recovery Sync",
  "3D Printed Gun Detection Scanner AI",
  "Multi-Lingual Ballistic Report Translator",
  "Historical Unsolved Firing Case Matcher",
  "Staff Ballistic Expert Training Tracker",
  "IBIS Hardware/Server Health Monitor AI",
  "Temporary Naka Arms Seizure Quick Scan",
  "Traffic Incident Firearms Check Protocol",
  "Accident vs Shooting Damage Differentiator",
  "VIP Threat Weapon Intelligence DB AI",
  "AI Assisted Post-Match Court Report Gen",
  "Ballistic Lab Chemical Supply Tracker",
  "Test-Fire vs Crime Scene Bullet Matcher",
  "Integration with Arms License Portal",
  "Citizen Illegal Arms Tip-Off Analyzer",
  "Extreme Corroded Bullet Recovery AI",
  "Disaster Area Looted Arms Tracker Bot",
  "Ballistic Lab Budget/Expense Tracker AI",
  "Custom Workflow/Approval for Lab Access",
  "AI Driven Weapon Trafficking Predictor",
  "Predictive Need for IBIS Data Expansion",
  "Custom Alert Trigger for Ballistic Expert"
];
...
const BallisticsAnalysisSupportDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI BALLISTICS ANALYSIS SUPPORT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI BALLISTICS ANALYSIS SUPPORT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in bullet/cartridge matching, ibis integration & weapon tracing analytics.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI BALLISTICS ANALYSIS <span>SUPPORT</span></h1>
            <p className="cyber-subtitle">Bullet/Cartridge Matching, IBIS Integration & Weapon Tracing Analytics</p>
          </div>
        </div>
      </header>
...
export default BallisticsAnalysisSupportDetailed;
