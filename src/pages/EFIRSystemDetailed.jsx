...
const aiExperts = [
"e-FIR OTP & Aadhaar Authentication AI",
  "Automated CCTNS Portal Synchronizer",
  "Digital Signature & Non-Repudiation Bot",
  "Citizen Identity Spoof Detection AI",
  "Cross-Platform (Web/Mobile) e-FIR Sync",
  "Lost Article/Document e-FIR Auto-Approver",
  "Vehicle Theft e-FIR Direct Insurance Link",
  "Cyber Fraud e-FIR to Bank Freeze Router",
  "Automated e-FIR PDF Copy Generator",
  "e-FIR Status Tracking & Notification AI",
  "Multi-Lingual e-FIR Form Translator Bot",
  "Geo-Fenced Jurisdiction Auto-Mapper",
  "Zero-FIR Interstate/Cross-District Relay",
  "Fake/Prank e-FIR Submission Predictor",
  "Upload Evidence (Photo/Video) Virus Scan",
  "Media File Metadata & Deepfake Checker",
  "e-FIR to IO (Investigating Officer) Auto-Assign",
  "Supervisor (SHO) Approval/Reject Workflow",
  "e-FIR Modification & Amendment Tracker",
  "Blockchain Immutable Ledger for e-FIRs",
  "Voice-to-Text e-FIR Dictation Assistant",
  "Chatbot for e-FIR Filing Guidance",
  "Accessibility (Visually Impaired) e-FIR Bot",
  "Senior Citizen Priority e-FIR Routing AI",
  "Women/POCSO Anonymous e-FIR Vault",
  "e-FIR Data Leak Prevention (DLP) AI",
  "Server Load & Downtime Failover Router",
  "e-FIR Analytics & Volume Trend Modeler",
  "Automated RTI/Legal Copy Extraction AI",
  "Integration with DigiLocker for Citizens",
  "Vahan/Sarathi Database Verification Link",
  "Telecom/CDR Request Auto-Gen from e-FIR",
  "Missing Person e-FIR Broadcast Sync",
  "Traffic/Accident e-Challan Cross-Check",
  "Financial Scam e-FIR to RBI/FIU Sync",
  "Property/Land Record (Bhulekh) Matcher",
  "Automated Court E-Filing Integration",
  "e-FIR Plagiarism/Duplicate Checker AI",
  "Offense Categorization (Cognizable) Bot",
  "Legal Admissibility Pre-Check Scorer",
  "Public Sentiment & Feedback Surveyor",
  "e-FIR Rejection/Closure Reason Analyzer",
  "Mobile App Push Notification Engine",
  "SMS/WhatsApp e-FIR Copy Dispatcher",
  "Emergency/SOS e-FIR Escalation AI",
  "Foreigner/Tourist e-FIR Translation Link",
  "Automated Charge-Sheet Generation Foundation",
  "Inter-Agency Joint Task Force Relay Bot",
  "e-FIR Archival & Smart Search Engine",
  "AI Generated Monthly e-FIR Digest",
  "Cyber Attack/DDoS Protection for e-FIR DB",
  "Audit Log for Authorized e-FIR Access",
  "Officer Workload Balancer for e-FIRs",
  "Complainant Anonymity & Privacy Shield AI",
  "Minor/Juvenile Suspect Flagging Bot",
  "Hate Speech/Communal e-FIR Priority Alert",
  "Election Commission e-FIR Sync Bot",
  "Medical/Hospital E-FIR Direct Intake",
  "CCTV/Drone Evidence Direct Upload Link",
  "Inter-State Smuggling e-FIR Pattern Matcher"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI e-FIR SYSTEM
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI e-FIR SYSTEM</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in secure digital signatures, otp verification & cctns portal integration.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI e-FIR <span>SYSTEM</span></h1>
            <p className="cyber-subtitle">Secure Digital Signatures, OTP Verification & CCTNS Portal Integration</p>
          </div>
        </div>
      </header>
...
export default EFIRSystemDetailed;
