...
const aiExperts = [
  "Online Marketplace (OLX/Quikr) Scraper AI",
  "Mobile IMEI/Laptop Serial Matcher",
  "Digital Register Compliance Auditor",
  "Suspicious Repeat Seller/Buyer Profiler",
  "Stolen Electronics CCTNS Sync Bot",
  "Price Anomaly (Under-Priced) Detector",
  "Geo-Spatial Fraud Hub Mapper",
  "Inter-State Mobile Smuggling Network AI",
  "Goods Register Command Dashboard",
  "Voice-Command IMEI Query Bot",
  "Automated Daily Flagged Item Report",
  "Cyber Cell/Telecom Sync Bot",
  "Image/Photo Matcher for Stolen Goods",
  "Bulk Refurbishment/Wiping Detector",
  "Fake KYC/Aadhar Verification AI",
  "Statutory Return Filing Tracker",
  "AI Evaluator for Shop Compliance",
  "Audit/Seizure Log Generator",
  "Data Privacy/Legitimate User Scrubber",
  "Central Equipment Identity Register (CEIR) Sync",
  "Field IO Spot-Check Mobile App",
  "Historical Fraud Pattern Matcher",
  "SHO/Supervisory Officer Briefing",
  "Cyber/Tech Specialist Task Allocator",
  "Blockchain Immutable Item Hash",
  "Anti-Tamper Register Shield AI",
  "Mobile App for Shop Owners (Quick Upload)",
  "Jurisdiction Polygon Matcher",
  "Multi-Lingual Platform Rule Translator",
  "Historical Recovery Rate Analyzer",
  "Goods Audit SOP Trainer AI",
  "Goods DB Server Health Monitor",
  "Imminent Bulk Smuggling Shipment Alert",
  "Organized Cyber-Fraud Syndicate Profiler",
  "High-Value Electronics Alert Classifier",
  "AI Assisted Takedown Notice Drafter",
  "Digital Record Storage Forecaster",
  "Secure Cyber-Informant Protector",
  "Integration with E-Commerce Fraud APIs",
  "Citizen Lost Mobile Portal Sync",
  "International Smuggling Route Modeler",
  "Disaster/Looting E-Commerce Tracker",
  "Cyber Audit Operations Budget Tracker",
  "Custom Workflow for ISP/Platform Blocking",
  "AI Driven Fence/Fraud Predictor",
  "Predictive Need for Cyber Forensics",
  "Custom Alert Trigger for Cyber SP",
  "Goods Recovery Timeline Tracker"
];
...
const SecondHandGoodsRegisterDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SECOND-HAND GOODS REGISTER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SECOND-HAND GOODS <span>REGISTER</span></h1>
...
export default SecondHandGoodsRegisterDetailed;
