...
const aiExperts = [
  "Searchable Intercom Extension Indexer AI",
  "Department Hierarchy Auto-Mapper Engine",
  "Click-to-Dial SIP Protocol Sync Engine",
  "Staff Presence/Availability Status Indicator",
  "Rogue Extension Scan & Block Engine AI",
  "Extension Request Router Matcher Bot AI",
  "Emergency Broadcast Call Routing Engine",
  "Interactive Voice Directory Assistant Bot",
  "Intercom Operations Control Dashboard Portal",
  "Voice-Command Directory Extension Query Bot",
  "Automated Daily Directory Edit Report Gen",
  "Cross-Office Telecom Server Sync Engine",
  "SIP Audio Quality Anomaly Analyzer Engine",
  "Suspicious Call Duration/Volume Monitor Bot",
  "Call Log Analytics Sorter Assistant AI",
  "Officer Mobile Forwarding Setup Auto-sync",
  "AI Evaluator for Intercom Usage Efficiency %",
  "Audit/Directory Modification Log Generator",
  "Data Privacy/Classified Extension Masker AI",
  "Police-EPABX Telecom Department Sync Bot",
  "HQ Officer Directory Lookup Mobile App Sync",
  "Cold Case Call Log Discrepancy Linker AI",
  "Senior Officer (SP Telecom Wing) Briefing Bot",
  "Public Helpline Directory Information Portal",
  "Blockchain Immutable Telecom Command Registry",
  "Anti-Eavesdropping SIP Connection Shield AI",
  "Mobile App for Offline Directory Search Bot",
  "Caller ID Verification Name Matcher Engine",
  "Multi-Lingual Directory Name Translator Bot",
  "Historical Call Volume Sorter Pattern Matcher",
  "Staff Telecom SOP Compliance Auditor AI",
  "EPABX Server Hardware Device Health Monitor",
  "Urgent Emergency Hot-Line Priority Alert AI",
  "Traffic/Transit Telecommunication Routing Sorter",
  "Rogue SIP Extension Intrusion Alert Bot AI",
  "VIP Intercom Line Security Verification Bot",
  "AI Assisted Post-Call Quality Audit Report",
  "Telecom Cables/Wiring Repair Work Tracker Bot",
  "SIP Bandwidth Utilization Route Optimizer",
  "Integration with National Police Phone Directory",
  "Citizen Public Grievance Helpline Sorter Bot",
  "Extreme Crisis Call Volume Load Balancer AI",
  "Disaster emergency Helpline Directory Sync",
  "Telecom Wing Operation Budget Tracker AI",
  "Custom Workflow/Approval for Hotline Activation",
  "AI Driven New Extension Demand Predictor AI",
  "Predictive Need for Telecom Server Upgrade",
  "Custom Alert Trigger for Telecom Commander"
];
...
const IntercomDirectoryDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INTERCOM DIRECTORY
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI INTERCOM DIRECTORY</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in searchable extension directory, department hierarchy maps, click-to-dial & presence indicators.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INTERCOM <span>DIRECTORY</span></h1>
            <p className="cyber-subtitle">Searchable Extension Directory, Department Hierarchy Maps, Click-to-Dial & Presence Indicators</p>
          </div>
        </div>
      </header>
...
export default IntercomDirectoryDetailed;
