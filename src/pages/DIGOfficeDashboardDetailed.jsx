...
const aiExperts = [
  "Sub-Range/Special Unit Command Dashboard",
  "Targeted Operation/Raid Tracker AI",
  "Investigating Officer (IO) Performance Scorer",
  "Specialized Case (CID/ACB) Pendency Monitor",
  "IG/ADG Directive Compliance Tracker",
  "Inter-District Co-ordination Linker",
  "Geo-Spatial Organized Crime Mapper",
  "Secret Service Fund/Informer Optimizer",
  "DIG Office Management Dashboard",
  "Voice-Command Operation Query Bot",
  "Automated Weekly Specialized Briefing Report",
  "IG/Range Command Sync",
  "Case Diary/Evidence Sentiment Analyzer",
  "Delay in Forensic/Cyber Report Tracker",
  "Leak/Compromise in Operation Predictor",
  "Summary of Complex Investigation Generator",
  "AI Evaluator for Conviction Rate",
  "Audit/Operation Log Generator",
  "Data Privacy/Informer ID Scrubber",
  "Forensic Lab/Cyber Cell Sync",
  "DIG Mobile Command/Raid App",
  "Historical Organized Syndicate Correlator",
  "Reader/DSP Briefing AI",
  "Special Investigation Team (SIT) Task Allocator",
  "Blockchain Immutable Evidence Hash",
  "Anti-Tamper Raid Log Shield",
  "Mobile App for Covert Approvals",
  "IO/Sub-unit Efficiency Benchmarker",
  "Automated Alert for Court Deadlines",
  "Historical Secret Fund Expenditure Analyzer",
  "Specialized Investigation SOP Trainer",
  "Covert Operations Server Health Monitor",
  "Imminent Operation Compromise Alert",
  "Corrupt/Inefficient IO Profiler",
  "High-Profile/Sensational Case Classifier",
  "AI Assisted Case Transfer Order Drafter",
  "Investigation Data Storage Forecaster",
  "Secure Covert Intel Protector",
  "Integration with National Databases (NATGRID/CCTNS)",
  "Zero Public Exposure Policy Sync",
  "Election Special Task Force Modeler",
  "Disaster Specialized Rescue Coordinator",
  "Secret Fund/Operation Budget Tracker",
  "Custom Workflow for Inter-State Raids",
  "AI Driven Syndicate Activity Predictor",
  "Predictive Need for Specialized Tech (UAV/Cyber)",
  "Custom Alert Trigger for DIG",
  "Specialized Case Lifecycle Timeline Tracker"
];
...
const DIGOfficeDashboardDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DIG OFFICE DASHBOARD
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DIG OFFICE <span>DASHBOARD</span></h1>
...
export default DIGOfficeDashboardDetailed;
