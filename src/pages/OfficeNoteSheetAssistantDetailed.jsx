...
const aiExperts = [
  "Auto-Drafting/Templating Engine AI",
  "Historical Precedent Search Bot",
  "Rule/Act Citation Suggester AI",
  "Automated Hierarchy Routing Engine",
  "Sentiment/Tone Formality Checker",
  "Financial Approval/Budget Rule Linker",
  "Geo-Spatial File Origin Mapper",
  "Grammar/Spell Check & Formatting Bot",
  "Note Sheet Assistant Dashboard",
  "Voice-Command File Query Bot",
  "Automated Weekly Pendency Report",
  "E-Office/Dak System Sync",
  "Multi-Lingual Note Translation",
  "Contradictory Noting Detector",
  "Unauthorized Noting/Overwrite Predictor",
  "Summary/Abstract of Noting Generator",
  "AI Evaluator for Noting Quality",
  "Audit/Routing Log Generator",
  "Data Privacy/Classified Content Scrubber",
  "Finance/Establishment Department Sync",
  "Officer Approval Mobile App",
  "Historical Delay/Bottleneck Correlator",
  "Supervisory Officer Briefing AI",
  "Task/Delegation Engine",
  "Blockchain Immutable Noting Hash",
  "Anti-Tamper Digital Signature Shield",
  "Mobile App for Quick Remarks",
  "Desk-wise Processing Speed Benchmarker",
  "Automated Reminder for Pending Files",
  "Historical Approval Rate Analyzer",
  "File Processing/Noting SOP Trainer",
  "E-Office Gateway Health Monitor",
  "Imminent File Deadlock/Stall Alert",
  "Habitual Objector/Delayer Profiler",
  "High-Priority/VIP File Classifier",
  "AI Assisted Clarification Note Drafter",
  "Digital File Storage Forecaster",
  "Secure Top-Secret File Protector",
  "Integration with State Treasury",
  "RTI Information Extraction Sync",
  "Election Urgent Transfer File Modeler",
  "Disaster Emergency Fund Approval Coordinator",
  "E-Office Licensing Budget Tracker",
  "Custom Workflow for Top-Secret Clearances",
  "AI Driven Approval Outcome Predictor",
  "Predictive Need for Inter-Department Meeting",
  "Custom Alert Trigger for Nodal Officer",
  "Note Sheet Routing Timeline Tracker"
];
...
const OfficeNoteSheetAssistantDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI OFFICE NOTE SHEET ASSISTANT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI OFFICE NOTE SHEET <span>ASSISTANT</span></h1>
...
export default OfficeNoteSheetAssistantDetailed;
