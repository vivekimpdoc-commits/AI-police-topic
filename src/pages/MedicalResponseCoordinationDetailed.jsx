...
const aiExperts = [
"Mass Casualty Triage (Red/Yellow/Green) AI",
  "Mobile Clinic/Ambulance GPS Dispatcher",
  "Blood/Plasma Bank Real-time Stock Sync",
  "Mortuary/Body-Bag Capacity Modeler",
  "Disease Outbreak/Epidemic Early Warning AI",
  "Specialized Doctor/Surgeon Roster Matcher",
  "Oxygen Cylinder/Concentrator Burn-Rate AI",
  "Emergency Medicine/Vaccine Cold-Chain Tracker",
  "Command Center Medical Response Dashboard",
  "Voice-Command Medical Query Assistant",
  "Automated Casualty/Injury Tally Generator",
  "Inter-Hospital Bed Availability Sync Engine",
  "Airlift/Medevac Helicopter Route Planner",
  "Burn Unit/Trauma Center Routing AI",
  "Psychiatric/Trauma Counselor Allocator Bot",
  "Snake-bite/Anti-Venom Stock Locator",
  "AI Evaluator for Medical Response Time",
  "Audit/Treatment Log Auto-Generator",
  "Data Privacy/Patient Medical Record Masker",
  "Police-Health Dept Joint Ops Sync AI",
  "Fake Doctor/Quack Impersonation Alert",
  "Waterborne Disease (Cholera) Predictor",
  "Senior Officer (CMO/DM) Briefing Bot",
  "Public Health Advisory/SMS Drafter AI",
  "Blockchain Immutable Log of Medical Supplies",
  "Field Hospital/Tent Setup Location Optimizer",
  "Mobile App for Paramedic/EMT Sync",
  "Unidentified Body/DNA Sample Tracker AI",
  "Multi-Lingual Patient Communication Bot",
  "Historical Epidemic Response Precedent Matcher",
  "Dialysis/Critical Care Patient Evac Router",
  "Doctor/Nurse Fatigue & Shift Monitor AI",
  "Temporary Morgue/Ice-Box Requisition AI",
  "Traffic Green-Corridor for Ambulances",
  "Flood/Earthquake Injury Pattern Modeler",
  "Zoonotic/Animal Disease Spillover Alert Bot",
  "AI Assisted Post-Disaster Health Audit Gen",
  "Bio-Hazard/Medical Waste Disposal Router",
  "VIP/Foreign Dignitary Medical Escort AI",
  "Integration with National Health Mission (NHM)",
  "Citizen SOS for Ambulance Router AI",
  "Heatwave/Sunstroke Victim Triage AI",
  "Post-Disaster Epidemic Prevention Modeler",
  "Medical Relief Expense/Budget Tracker",
  "Custom Workflow/Approval for Air Ambulance",
  "AI Driven Medical Demobilization Predictor",
  "Predictive Need for Specialized Drugs",
  "Custom Alert Trigger for Chief Medical Officer"
];
...
const MedicalResponseCoordinationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI MEDICAL RESPONSE COORDINATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI MEDICAL RESPONSE COORDINATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in triage management, mobile clinics, blood banks & mortuary logistics.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI MEDICAL RESPONSE <span>COORDINATION</span></h1>
            <p className="cyber-subtitle">Triage Management, Mobile Clinics, Blood Banks & Mortuary Logistics</p>
          </div>
        </div>
      </header>
...
export default MedicalResponseCoordinationDetailed;
