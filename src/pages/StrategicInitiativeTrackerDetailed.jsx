...
const aiExperts = [
  "Strategic Project Milestone Tracker AI",
  "Budget/Fund Utilization Predictor",
  "KPI (Key Performance Indicator) Measuring Engine",
  "Delay/Bottleneck Identification Bot",
  "Vendor/Contractor Performance Scorer",
  "Resource Allocation vs Utilization Correlator",
  "Geo-Spatial Initiative Rollout Mapper",
  "Public Impact/Sentiment Analyzer AI",
  "Strategic Initiative Dashboard",
  "Voice-Command Project Status Bot",
  "Automated Monthly Progress Report",
  "Finance/Planning Department Sync",
  "Hardware/Software Delivery Tracker",
  "Training/Capacity Building Integrator",
  "Fake Progress/Inflated Metrics Detector",
  "Cross-Project Dependency Analyzer",
  "AI Evaluator for Project ROI",
  "Audit/Milestone Update Log Gen",
  "Data Privacy/Financial Detail Scrubber",
  "State Police Housing/Welfare Sync",
  "Field Officer Implementation App",
  "Historical Project Failure Correlator",
  "DGP/Nodal Officer Briefing Bot",
  "Fund Reallocation/Optimization AI",
  "Blockchain Immutable Progress Hash",
  "Anti-Tamper Milestone Shield",
  "Mobile App for Vendor Updates",
  "Jurisdiction-wise Rollout Comparison Matcher",
  "Multi-Lingual Progress Report Generator",
  "Historical Initiative Success Analyzer",
  "Project Management SOP Trainer",
  "Initiative DB Server Health Monitor",
  "Imminent Fund Lapse/Deadline Alert",
  "Vendor Fraud/Corruption Profiler",
  "High-Priority/Flagship Project Classifier",
  "AI Assisted Show-Cause Notice Drafter",
  "Project Document Storage Forecaster",
  "Secure Internal Audit Protector",
  "Integration with State Treasury/PFMS",
  "Citizen Transparency/Impact Portal Sync",
  "Election Code (MCC) Impact Modeler",
  "Disaster Disrupted Project Coordinator",
  "Project Contingency/Cost Overrun Tracker",
  "Custom Workflow for Project Extension",
  "AI Driven Completion Date Predictor",
  "Predictive Need for External Consultants",
  "Custom Alert Trigger for Home Secretary",
  "Initiative Lifecycle Timeline Tracker"
];
...
const StrategicInitiativeTrackerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI STRATEGIC INITIATIVE TRACKER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI STRATEGIC INITIATIVE <span>TRACKER</span></h1>
...
export default StrategicInitiativeTrackerDetailed;
