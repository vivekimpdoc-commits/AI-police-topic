...
const aiExperts = [
  "District-wise Modernization Ranker",
  "R&D Budget Utilization Analyzer",
  "Tech Adoption/Usage Rate Scorer",
  "Continuous Improvement Metric AI",
  "Training vs Implementation Correlator",
  "Legacy System Phase-out Tracker",
  "Geo-Spatial Tech Maturity Mapper",
  "Officer Tech-Literacy Indexer",
  "Innovation Scorecard Dashboard",
  "Voice-Command Ranking Query Bot",
  "Automated Quarterly Modernization Report",
  "DGP/Home Department Sync",
  "Budget Lapse/Underutilization Predictor",
  "Tech Abandonment/Disuse Alert",
  "Paper-based Process Relapse Detector",
  "Inter-District Knowledge Transfer Optimizer",
  "AI Evaluator for Smart Police Index",
  "Audit/Ranking Log Generator",
  "Data Privacy/Performance Data Scrubber",
  "Finance/Planning Department Sync",
  "SP (Superintendent of Police) Dashboard App",
  "Historical Resistance to Change Correlator",
  "Home Minister Briefing AI",
  "Tech Refresher Training Allocator",
  "Blockchain Immutable Scorecard Hash",
  "Anti-Tamper Ranking Shield",
  "Mobile App for Best Practice Sharing",
  "State-to-State Modernization Benchmarker",
  "Automated Alert for Lowest Ranked Districts",
  "Historical IT Procurement ROI Analyzer",
  "Change Management/Adoption SOP Trainer",
  "Data Sync/API Health Monitor",
  "Imminent Funding Cut (Due to Non-Usage) Alert",
  "Laggard/Tech-Resistant Unit Profiler",
  "High-Weightage (Cyber/Forensic) Metric Classifier",
  "AI Assisted Commendation Letter Drafter",
  "Analytics Data Storage Forecaster",
  "Secure Ranking Algorithm Protector",
  "Integration with Central Smart Police (CCTNS) KPIs",
  "Public Relations/Media Sync",
  "Election Tech Readiness Modeler",
  "Disaster Tech Resilience Coordinator",
  "Modernization Grant (C/S) Budget Tracker",
  "Custom Workflow for Specialized Units (ATS/STF)",
  "AI Driven Next Quarter Rank Predictor",
  "Predictive Need for IT Manpower",
  "Custom Alert Trigger for DGP Modernization",
  "Fund Allocation to Successful Adoption Timeline"
];
...
const InnovationScorecardDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INNOVATION SCORECARD
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INNOVATION <span>SCORECARD</span></h1>
...
export default InnovationScorecardDetailed;
