...
const aiExperts = [
  "VIP Threat Assessment/Scoring AI",
  "Route Sanitization & Vulnerability Mapper",
  "Anti-Drone/UAV Detection Integrator",
  "Social Media VIP Threat Extractor",
  "Convoy GPS/Telematics Tracker",
  "CCTV/ANPR Route Stitching Engine",
  "Crowd Density/Hostility Modeler",
  "Sniper/Vantage Point Analyzer AI",
  "VIP Security Command Dashboard",
  "Voice-Command Route Query Bot",
  "Automated Threat Intel Report Gen",
  "Inter-District/State Border Sync Bot",
  "Geo-Spatial Safe-House Predictor AI",
  "Traffic Signal Pre-emption Bot",
  "Fake Identification/Imposter Detector",
  "Past VIP Attack Precedent Matcher",
  "AI Evaluator for Force Multiplier",
  "Audit/Security Protocol Log Gen",
  "Data Privacy/VIP Itinerary Scrubber",
  "Special Protection Group (SPG) Sync",
  "Field Escort Tactical App",
  "Historical Threat Profile Matcher AI",
  "DGP/Security Chief Briefing Bot",
  "Tactical Gear/Vehicle Allocator",
  "Blockchain Immutable Itinerary Hash",
  "Anti-Tamper Security Plan Shield",
  "Mobile App for Convoy Commanders",
  "Threat Geolocation Polygon Matcher",
  "Multi-Lingual Threat Translator",
  "Historical VIP Security Audit Analyzer",
  "VIP Protection SOP Trainer AI",
  "Security DB Server Health Monitor",
  "Imminent Route Breach Alert Bot",
  "Terror/Assassination Syndicate Profiler",
  "Z+/Z/Y Security Level Classifier",
  "AI Assisted Contingency Plan Drafter",
  "Surveillance Video Storage Forecaster",
  "Secure Comm Channel Protector",
  "Integration with Intelligence Bureau (IB)",
  "Media Leak Detection Analytics",
  "Riot/Protest Route Interception Modeler",
  "Disaster Evacuation VIP Coordinator",
  "VIP Security Expense Tracker",
  "Custom Workflow for Route Diversion",
  "AI Driven Attack Probability Predictor",
  "Predictive Need for Air Evacuation",
  "Custom Alert Trigger for NSG/SWAT",
  "VIP Movement Timeline Tracker"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI VIP SECURITY
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI VIP <span>SECURITY</span></h1>
...
export default VIPSecurityDetailed;
