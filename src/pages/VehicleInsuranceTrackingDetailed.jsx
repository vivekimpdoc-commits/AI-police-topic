...
const aiExperts = [
  "Insurance Policy Expiry Alert Engine AI",
  "Claim Filing/Processing Workflow Bot",
  "Premium Amount Comparison Optimizer AI",
  "Accident Damage Photo Upload for Claims",
  "Third-Party Liability Claim Tracker Bot",
  "Comprehensive vs Third-Party Policy Advisor",
  "No-Claim Bonus (NCB) Tracking Engine AI",
  "Lapsed/Uninsured Vehicle Flagging Bot",
  "Vehicle Insurance Command Dashboard",
  "Voice-Command Insurance Status Query Bot",
  "Automated Insurance Renewal Reminder Gen",
  "Cross-Fleet Insurance Compliance Checker",
  "Insurance Surveyor Visit Scheduler AI",
  "Claim Rejection/Dispute Escalation Bot",
  "Policy Document Digital Vault Storage",
  "Insurance Premium Budget Forecaster AI",
  "AI Evaluator for Claim Settlement Speed",
  "Audit/Insurance Fraud Detection Logger",
  "Data Privacy/Driver Claim Data Masker AI",
  "Police-Insurance Company API Sync Bot",
  "Patrol Car Accident Claim Fast-Track AI",
  "Armored Vehicle Specialized Policy Tracker",
  "Senior Officer (Finance) Insurance Briefing",
  "Public Vehicle Requisition Insurance Check",
  "Blockchain Immutable Claim Record Hasher",
  "Anti-Fraud Duplicate Claim Detector AI",
  "Mobile App for Accident Scene Photo Sync",
  "Electric Vehicle Special Policy Tracker",
  "Multi-Lingual Insurance Alert Translator",
  "Historical Claim Pattern Trend Analyzer",
  "Staff Personal Vehicle Insurance Advisor",
  "Vendor/Garage Insurance Tie-up Manager",
  "Temporary Vehicle Insurance Coverage Bot",
  "Traffic Crane/Tow Insurance Verifier AI",
  "Hit-and-Run Third-Party Claim Processor",
  "VIP Fleet Comprehensive Policy Manager",
  "AI Assisted Post-Claim Settlement Audit",
  "Insurance vs Repair Cost Analysis Bot",
  "Green Vehicle Insurance Discount Tracker",
  "Integration with IRDAI/Vahan Portal",
  "Citizen Accident Insurance Info Portal",
  "Extreme Event (Flood/Fire) Claim Fast-Track",
  "Disaster Fleet Mass-Claim Processor AI",
  "Insurance Budget/Premium Tracker AI",
  "Custom Workflow/Approval for New Policy",
  "AI Driven Claim Fraud Predictor",
  "Predictive Need for Policy Upgrade",
  "Custom Alert Trigger for Insurance Admin"
];
...
const VehicleInsuranceTrackingDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI VEHICLE INSURANCE TRACKING
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI VEHICLE INSURANCE TRACKING</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in policy expiry alerts, claim processing & premium optimization analytics.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI VEHICLE INSURANCE <span>TRACKING</span></h1>
            <p className="cyber-subtitle">Policy Expiry Alerts, Claim Processing & Premium Optimization Analytics</p>
          </div>
        </div>
      </header>
...
export default VehicleInsuranceTrackingDetailed;
