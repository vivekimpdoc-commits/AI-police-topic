...
const aiExperts = [
  "Show-Cause Notice Auto-Drafting Engine AI",
  "Penalty Record History Profile Tracker Bot",
  "Appeal Deadline Notification Alarm Bot AI",
  "Charge-Sheet Template Selector Router Bot",
  "Penalty Severity Level Auto-Recommender Bot",
  "Disciplinary Inquiry Status Monitor Bot AI",
  "Appeal Hearing Schedule Conflict Resolver Bot",
  "Disciplinary Action SLA Breach Alert Bot",
  "Disciplinary Action Control Dashboard Portal",
  "Voice-Command Case Summary Query Bot",
  "Automated Daily Disciplinary Case Report Gen",
  "Cross-Department Action Database Sync Engine",
  "Notice Delivery QR Pass Code Generator Bot",
  "Suspicious Case Delay Warning Alert Engine",
  "Penalty Execution Status Verifier Bot AI",
  "Appeal Case Outcome Draft Auto-Generator",
  "AI Evaluator for Disciplinary Compliance Score",
  "Audit/Disciplinary Case Modify Log Generator",
  "Data Privacy/Staff Personal Asset Data Masker",
  "Police-CID Disciplinary Branch Database Sync",
  "CID IO Disciplinary Helper Mobile App Portal",
  "Cold Case Disciplinary Precedent Matcher Linker",
  "Senior Officer (DGP Headquarters) Briefing Bot",
  "Public Wanted/Disciplined Staff Registry List",
  "Blockchain Immutable Disciplinary Order Registry",
  "Anti-Leak Case File Protection Shield Bot",
  "Mobile App for Quick Disciplinary Record Scan",
  "EPABX SIP Caller ID Verification Matcher",
  "Multi-Lingual Notice Translation Converter Bot",
  "Historical Disciplinary Action Pattern Matcher",
  "Staff Disciplinary Code SOP Training Tracker",
  "Disciplinary DB Server Cluster Health Monitor",
  "Urgent Appeal Stay/Court Order Warning Alert",
  "Traffic/Transit Convoy Route for Hearing Staff",
  "Cyber Misconduct Disciplinary Action Sorter Bot",
  "VIP Special Disciplinary Committee Scheduler",
  "AI Assisted Post-Hearing Findings Report Draft",
  "Disciplinary Case Queue Load Balancer Engine",
  "Legal Appeal Argument Win Probability Predictor",
  "Integration with National Judicial Database (ICJS)",
  "Citizen Staff Misconduct Reporting Helpline App",
  "Extreme Case Load Queue Sorter Engine AI",
  "Disaster emergency Disciplinary Override Guide",
  "Disciplinary Wing Operations Budget Tracker AI",
  "Custom Workflow/Approval for Dismissal Notice",
  "AI Driven Future Misconduct Type Predictor AI",
  "Predictive Need for Legal Counsel Engagement",
  "Custom Alert Trigger for Disciplinary Nodal Chief"
];
...
const DisciplinaryActionManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DISCIPLINARY ACTION MANAGEMENT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI DISCIPLINARY ACTION MANAGEMENT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in show-cause notice builder, penalty records, appeal status board & charge-sheet templates.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DISCIPLINARY ACTION <span>MANAGEMENT</span></h1>
            <p className="cyber-subtitle">Show-Cause Notice Builder, Penalty Records, Appeal Status Board & Charge-Sheet Templates</p>
          </div>
        </div>
      </header>
...
export default DisciplinaryActionManagementDetailed;
