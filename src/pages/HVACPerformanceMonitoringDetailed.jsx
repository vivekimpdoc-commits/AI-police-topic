...
const aiExperts = [
  "Chiller/Compressor Efficiency AI",
  "Refrigerant Gas Leak Detector",
  "Filter Dust/Clog Degradation Scorer",
  "Server Room/Data Center Climate Optimizer",
  "Air Quality/CO2 Level Monitor",
  "Thermal Comfort vs Energy Analyzer",
  "Geo-Spatial HVAC Zone Heatmapper",
  "Variable Refrigerant Flow (VRF) Optimizer",
  "HVAC Performance Dashboard",
  "Voice-Command Climate Query Bot",
  "Automated Weekly HVAC Health Report",
  "Building Management System (BMS) Sync",
  "Compressor Seizure/Failure Predictor",
  "Condensation/Drip Leak Alert",
  "Occupancy-Based Temperature Adjuster",
  "Duct Blockage/Airflow Analyzer",
  "AI Evaluator for HVAC Efficiency Index",
  "Audit/Maintenance Log Generator",
  "Data Privacy/Zone Occupancy Scrubber",
  "IT (Server Room)/Estate Sync",
  "HVAC Technician Mobile App",
  "Historical Summer Breakdown Correlator",
  "Chief Technology Officer (CTO) Briefing AI",
  "Servicing/Filter Replacement Task Allocator",
  "Blockchain Immutable Maintenance Hash",
  "Anti-Tamper HVAC Controller Shield",
  "Mobile App for Temperature Complaint",
  "Zone-wise Cooling Efficiency Benchmarker",
  "Automated Alert for Server Room Overheating",
  "Historical AMC (Annual Maintenance) Cost Analyzer",
  "HVAC Operations/Safety SOP Trainer",
  "IoT Thermostat/Sensor Health Monitor",
  "Imminent Server Shutdown (Heat) Alert",
  "Substandard AMC Vendor Profiler",
  "Mission-Critical (CCTNS Data Center) Cooling Classifier",
  "AI Assisted Vendor Penalty Drafter",
  "Telemetry/Temperature Trend Forecaster",
  "Secure BMS Network Protector",
  "Integration with Weather Forecast API",
  "Environmental Compliance Sync",
  "Election Command Center Cooling Modeler",
  "Disaster Mobile Control Room AC Coordinator",
  "HVAC Maintenance Budget Tracker",
  "Custom Workflow for Morgue/Forensic Lab Cooling",
  "AI Driven Monthly Power Draw Predictor",
  "Predictive Need for System Replacement",
  "Custom Alert Trigger for SP IT/Computer",
  "Anomaly Detection to Repair Timeline"
];
...
const HVACPerformanceMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI HVAC PERFORMANCE MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI HVAC PERFORMANCE <span>MONITORING</span></h1>
...
export default HVACPerformanceMonitoringDetailed;
