...
const aiExperts = [
"Cross-Border Skirmish Analyzer",
  "Illegal Immigration Predictor",
  "Night-Time Infiltration Alert AI",
  "Border Fence Breach Detector",
  "Tunnel Digging Acoustic Scanner",
  "Drone Intrusion Tracker AI",
  "Smuggling Drop-Point Modeler",
  "Weapon Fire Acoustic Matcher",
  "Border Guard Distress Signal AI",
  "Refugee Crisis Flow Predictor",
  "Interstate Boundary Dispute Logger",
  "Hostile Outpost Monitoring Bot",
  "Biometric Illegal Crossing Tracker",
  "Wildlife Poaching Incident Sync",
  "Border Incident NLP Summarizer",
  "Diplomatic Protest Log AI",
  "Ceasefire Violation Tracker",
  "Troop Mobilization Analyzer",
  "Border CCTV Blind-Spot Modeler",
  "Radar/Sonar Intrusion Sync",
  "Marine Border Patrol Link AI",
  "Riverine Border Skirmish Analyzer",
  "High-Altitude Border Alert Bot",
  "Desert Border Heat Signature AI",
  "Forest Border Canopy Scanner",
  "Ammunition Expended Log AI",
  "Casualty & Medevac Routing Bot",
  "Enemy Communication Intercept AI",
  "False Flag Incident Predictor",
  "Local Villager Movement Tracker",
  "Smuggler Syndicate Link Analyzer",
  "Border Infrastructure Sabotage AI",
  "Landmine & IED Detection Alert",
  "Border Checkpost Assault Predictor",
  "Riot/Protest Border Blockade AI",
  "Social Media Border Propaganda AI",
  "Deep-Fake Incident Verification",
  "Satellite Imagery Sync Bot",
  "UAV (Drone) Patrol Orchestrator",
  "Inter-Agency Intelligence Sync AI",
  "Border Resource Allocation Predictor",
  "Incident Heatmap Generator AI",
  "Time-of-Day Intrusion Modeler",
  "Historical Conflict Pattern AI",
  "Digital Twin Border Simulation AI",
  "Automated Incident Report Generator",
  "Cross-Border Arrest Ledger Sync",
  "Smuggler Extradition Workflow AI",
  "Hostage Situation Prediction Model",
  "Border Epidemic/Health Alert Bot",
  "Livestock Straying Incident Logger",
  "Border Water-Dispute Sync AI",
  "Interstate Liquor Smuggling Log",
  "Narcotics Seizure Incident Registry",
  "Human Trafficking Rescue Sync",
  "Unidentified Corpse Border Tracker",
  "Night-Vision Incident Replay AI",
  "Thermal Signature Alert Archive",
  "Border Incident Legal Audit AI",
  "Central Command Webhook Bot"
];
...
const BorderIncidentRegisterDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI BORDER INCIDENT REGISTER
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI BORDER INCIDENT REGISTER</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in cross-border skirmish tracking, illegal crossing logs & conflict resolution analytics.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI BORDER INCIDENT <span>REGISTER</span></h1>
            <p className="cyber-subtitle">Cross-Border Skirmish Tracking, Illegal Crossing Logs & Conflict Resolution Analytics</p>
          </div>
        </div>
      </header>
...
export default BorderIncidentRegisterDetailed;
