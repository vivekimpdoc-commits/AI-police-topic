...
const aiExperts = [
  "Polling Booth Vulnerability Scorer AI",
  "Force/Paramilitary Deployment Optimizer",
  "Electoral Violence History Analyzer",
  "Social Media Hate Speech/Propaganda Bot",
  "EVM Strong-Room CCTV Monitor",
  "Political Rivalry Clash Predictor",
  "Illegal Cash/Liquor Movement Tracker",
  "Voter Intimidation Sentiment AI",
  "Election Command Dashboard",
  "Voice-Command Booth Query Bot",
  "Automated Daily Election Brief",
  "Election Commission (ECI) Sync Bot",
  "Geo-Spatial Sensitive Booth Mapper",
  "Border/Checkpost Nakabandi Analyzer",
  "Fake News/Deepfake Audio Detector",
  "Historical Rigging/Booth Capturing Matcher",
  "AI Evaluator for Optimal Deployment",
  "Audit/Force Allocation Log Gen",
  "Data Privacy/Voter Info Scrubber",
  "Central Armed Police Forces (CAPF) Sync",
  "Field Sector Magistrate App",
  "Cold Case Electoral Violence Correlator",
  "DGP/Chief Electoral Officer Briefing",
  "Vehicle/Logistics Resource Allocator",
  "Blockchain Immutable EVM Custody Hash",
  "Anti-Tamper Strong-Room Shield",
  "Mobile App for Polling Officers",
  "Incident Geolocation Cluster Matcher",
  "Multi-Lingual Propaganda Translator",
  "Historical Election Security Analyzer",
  "Election Code (MCC) SOP Trainer",
  "Election DB Server Health Monitor",
  "Imminent Booth Capturing Alert Bot",
  "Organized Syndicate Funding Profiler",
  "VIP Candidate Security Classifier",
  "AI Assisted Re-Poll Plan Drafter",
  "Strong-Room Video Storage Forecaster",
  "Secure Whistleblower Tip Protector",
  "Integration with Voter Registration DB",
  "Citizen MCC Violation Analytics",
  "Communal Riot Escalation Modeler",
  "Disaster/Weather Impact on Voting Coordinator",
  "Election Security Budget Tracker",
  "Custom Workflow for MCC Violations",
  "AI Driven Voter Turnout Predictor",
  "Predictive Need for Aerial Surveillance",
  "Custom Alert Trigger for Zonal Officers",
  "Election Phase Timeline Tracker"
];
...
const ElectionDutyManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ELECTION DUTY MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ELECTION DUTY <span>MANAGEMENT</span></h1>
...
export default ElectionDutyManagementDetailed;
