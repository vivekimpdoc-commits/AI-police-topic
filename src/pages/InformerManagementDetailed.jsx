...
const aiExperts = [
  "Informer Reliability Scoring AI",
  "Identity Masking & Anonymity Bot",
  "Tip Consistency Checker Engine",
  "Informer Cross-Linking Matcher",
  "Payout/Reward Allocation Predictor",
  "Informer Risk Assessment Bot",
  "Informer Network Mapping AI",
  "Informer Communication Encryption Bot",
  "Informer Dashboard Analytics",
  "Voice-Command Informer Query Bot",
  "Automated Reward Audit Generator",
  "Cross-District Informer De-duplication AI",
  "Tip Success Rate Forecaster",
  "Covert Operations Liaison AI",
  "Informer Compromise Alert Engine",
  "Informer Lifecycle Management Bot",
  "AI Evaluator for Tip Validity",
  "Audit/Access Log Generator AI",
  "Data Privacy/Informer File Scrubber",
  "Police-Intel Bureau Sync Bot",
  "Field Handler Coordination App Sync",
  "Cold Case Informer Re-engagement AI",
  "Senior Officer Briefing AI",
  "Reward Budget Optimization Bot",
  "Blockchain Immutable Tip Registry",
  "Anti-Leak Informer Profile Shield",
  "Mobile App for Secure Handler Comms",
  "Cell Tower Geolocation Boundary Matcher AI",
  "Multi-Lingual Tip Translation Converter",
  "Historical Tip Accuracy Analyzer",
  "Handler SOP Compliance Trainer AI",
  "Informer Server Health Monitor",
  "Urgent Threat Tip Escalation Bot",
  "Organized Crime Informer Profiler",
  "VIP Threat Tip Classifier Bot",
  "AI Assisted Tip Action Plan Draft",
  "Informer Storage Size Forecaster",
  "Secure Payout Voucher Generator",
  "Integration with National Database",
  "Citizen Informer Registration Portal",
  "Extreme Tip Spike Modeler",
  "Disaster SOS Informer Coordinator",
  "Reward Fund Expenditure Tracker",
  "Custom Workflow for Covert Escapes",
  "AI Driven New Syndicate Informer Pattern",
  "Predictive Need for Field Verification",
  "Custom Alert Trigger for Handlers",
  "Handler Performance Analytics Bot"
];
...
const InformerManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INFORMER MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INFORMER <span>MANAGEMENT</span></h1>
...
export default InformerManagementDetailed;
