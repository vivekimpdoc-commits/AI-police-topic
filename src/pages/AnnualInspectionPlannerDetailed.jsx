...
const aiExperts = [
  "Annual Schedule/Itinerary Optimizer AI",
  "Pre-Inspection Checklist Generator",
  "DIG/IG Calendar Sync Engine",
  "Readiness/Preparation Scorer",
  "Historical Observation/Deficiency Linker",
  "Geospatial Route/Tour Planner",
  "Document/Register Pre-Audit Bot",
  "Pending Inquiry/Case Flagging AI",
  "Annual Inspection Dashboard",
  "Voice-Command Schedule Query Bot",
  "Automated Monthly Inspection Progress Report",
  "PHQ (Police Headquarters) Sync",
  "Last-Minute Postponement/Clash Predictor",
  "Unprepared Unit/Station Alert",
  "Weather/Event Disruption Analyzer",
  "Officer Availability/Leave Sync",
  "AI Evaluator for Station Readiness Index",
  "Audit/Itinerary Log Generator",
  "Data Privacy/Tour Schedule Scrubber",
  "State Intelligence/Security Sync",
  "Inspecting Officer Mobile App",
  "Historical Grading/Score Correlator",
  "DGP (Administration) Briefing AI",
  "Preparation Task Allocator (to SHOs)",
  "Blockchain Immutable Schedule Hash",
  "Anti-Tamper Inspection Record Shield",
  "Mobile App for Station Preparation Uploads",
  "Range-wise Inspection Completion Benchmarker",
  "Automated Alert for Overdue Inspections",
  "Historical Tour/TA-DA Cost Analyzer",
  "Inspection Preparation SOP Trainer",
  "Calendar API/Database Health Monitor",
  "Imminent VIP Visit/Inspection Clash Alert",
  "Habitual Defaulter (Unprepared Station) Profiler",
  "High-Priority (Sensitive Station) Classifier",
  "AI Assisted Inspection Order Drafter",
  "Tour/Schedule Data Storage Forecaster",
  "Secure Itinerary/Movement Protector",
  "Integration with E-Office/HRMS",
  "Media/PRO Update Sync",
  "Election Year Accelerated Inspection Modeler",
  "Disaster/Emergency Tour Coordinator",
  "Tour & Travel Allowance Budget Tracker",
  "Custom Workflow for DGP/CM Inspections",
  "AI Driven Inspection Completion Date Predictor",
  "Predictive Need for Remedial Training",
  "Custom Alert Trigger for IG Range",
  "Notification to Final Report Timeline"
];
...
const AnnualInspectionPlannerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ANNUAL INSPECTION PLANNER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ANNUAL INSPECTION <span>PLANNER</span></h1>
...
export default AnnualInspectionPlannerDetailed;
