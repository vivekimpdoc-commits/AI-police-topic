...
const aiExperts = [
"Crime Fear/Perception Heatmap Generator",
  "Crowdsourced Dark/Unsafe Spot Identifier",
  "Vulnerable Demographic (Women/Elderly) AI",
  "Automated Risk Survey Poll Dispatcher",
  "Neighborhood Crime Tolerance Scorer",
  "Streetlight/Infrastructure Gap Mapper AI",
  "Drug/Substance Abuse Hotspot Predictor",
  "Eve-Teasing/Harassment Zone Triangulator",
  "Local Gang/Mafia Intimidation Modeler",
  "Cyber Fraud Susceptibility Rater AI",
  "Communal/Caste Tension Early Warning Bot",
  "Slum/Marginalized Area Risk Assessor",
  "Traffic/Accident High-Risk Zone Mapper",
  "School/College Surroundings Safety AI",
  "Liquor Shop/Bar Nuisance Radius Modeler",
  "Public Transport/Bus Stop Risk Scorer",
  "Multi-Lingual Survey Translation Bot",
  "Survey Anomaly/Fake Response Detector AI",
  "Historical Survey vs Actual Crime Correlator",
  "Automated Risk Mitigation Strategy Drafter",
  "Command Center Real-time Risk Dashboard",
  "Police Patrol Route Optimizer via Risk AI",
  "RWA/Gated Community Vulnerability Link",
  "Rural/Village Dispute Escalation Predictor",
  "Industrial/Factory Dispute Risk Rater",
  "Disaster/Flood Prone Area Survey AI",
  "Election Booth Violence Vulnerability Bot",
  "Festival/Mela Stampede Risk Assessor",
  "NGO/Civil Society Input Aggregator AI",
  "Voice-Command Risk Query Assistant Bot",
  "Public Trust Index vs Risk Perception AI",
  "Predictive Deployment Recommender Bot",
  "Stray Animal/Dog Menace Risk Mapper",
  "Illegal Encroachment/Land Grab Tension AI",
  "Youth Radicalization/Extremism Survey Bot",
  "Survey Engagement & Response ROI Rater",
  "Interactive Map/GIS Visualization Bot",
  "AI Driven Follow-up Survey Scheduler",
  "Senior Officer (SP/SSP) Actionable Insight AI",
  "Blockchain Immutable Survey Data Logger",
  "Missing Child/Kidnapping Fear Modeler",
  "Prostitution/Red-Light Area Spillover Risk",
  "Noise Pollution/Late Party Nuisance Mapper",
  "Financial/Loan-Shark Harassment Risk AI",
  "Tenant/Migrant Worker Friction Predictor",
  "Tourist/Foreigner Scam Vulnerability AI",
  "Hospital/Medical Emergency Risk Mapper",
  "Bank/ATM Security Vulnerability Survey",
  "Cyber-Bullying/Social Media Threat Modeler",
  "AI Evaluator for Risk Reduction Success",
  "Local Market/Bazaar Pickpocket Risk AI",
  "Weapon/Arms Proliferation Fear Scorer",
  "Inter-Agency (Civic Body) Issue Router",
  "Mobile App based Micro-Survey Pusher AI",
  "Survey Keyword/Emotion Cloud Generator",
  "AI Protocol for High-Risk Zone Sanitization",
  "Mass Transit (Metro/Railway) Risk Profiler",
  "Public Alert System Targeting via Risk AI",
  "AI Driven Community Resilience Index",
  "Post-Incident Trauma/Fear Assessor Bot"
];
...
const CommunityRiskSurveyDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI COMMUNITY RISK SURVEY
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI COMMUNITY RISK SURVEY</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in local crime fear mapping, dark spot identification via polls & vulnerability.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI COMMUNITY RISK <span>SURVEY</span></h1>
            <p className="cyber-subtitle">Local Crime Fear Mapping, Dark Spot Identification via Polls & Vulnerability</p>
          </div>
        </div>
      </header>
...
export default CommunityRiskSurveyDetailed;
