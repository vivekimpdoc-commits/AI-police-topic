...
const aiExperts = [
  "Room Readiness/Inspection Audit AI",
  "Amenity (Toiletries/Linen) Replenishment Bot",
  "HVAC/Plumbing Preventive Check Engine",
  "Housekeeping Performance Scorer",
  "Pest Control/Sanitization Scheduler",
  "VIP Room Customization/Preference AI",
  "Geo-Spatial Guest House Layout Mapper",
  "Maintenance Ticket Auto-Routing",
  "Accommodation Prep Dashboard",
  "Voice-Command Room Status Bot",
  "Automated Daily Readiness Report",
  "State Police Housing/Estate Sync",
  "AC/Geyser Malfunction Predictor",
  "Stale Linen/Poor Odor Alert AI",
  "False 'Room Ready' Tagging Detector",
  "Occupancy Turnover/Cleaning Optimizer",
  "AI Evaluator for Guest Comfort Index",
  "Audit/Inspection Log Generator",
  "Data Privacy/Guest Occupancy Scrubber",
  "Logistics/PWD Sync",
  "Housekeeping Supervisor Mobile App",
  "Historical VIP Complaint Correlator",
  "Estate Officer/Manager Briefing AI",
  "Cleaning/Maintenance Task Allocator",
  "Blockchain Immutable Inspection Hash",
  "Anti-Tamper Maintenance Log Shield",
  "Mobile App for Room Photo Verification",
  "Staff-wise Cleaning Speed Benchmarker",
  "Automated Alert for Overdue Cleaning",
  "Historical Maintenance Cost Analyzer",
  "Guest House Housekeeping SOP Trainer",
  "Room IoT (Thermostat) Gateway Monitor",
  "Imminent Room Unavailability (VIP arrival) Alert",
  "Habitual Shirkers (Housekeeping) Profiler",
  "Presidential/CM Suite Classifier",
  "AI Assisted Vendor Penalty Drafter",
  "Inspection Image Storage Forecaster",
  "Secure Guest Ledger Protector",
  "Integration with State Tourism/Guest Houses",
  "Guest Feedback Portal Sync",
  "Election Central Force Accommodation Modeler",
  "Disaster Relief Staff Billeting Coordinator",
  "Guest House Maintenance Budget Tracker",
  "Custom Workflow for Deep Cleaning/Renovation",
  "AI Driven Room Turnaround Predictor",
  "Predictive Need for Linen Replacement",
  "Custom Alert Trigger for SP Admin",
  "Checkout to Next-Check-In Readiness Timeline"
];
...
const AccommodationPreparationChecklistDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ACCOMMODATION PREPARATION CHECKLIST
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ACCOMMODATION PREPARATION <span>CHECKLIST</span></h1>
...
export default AccommodationPreparationChecklistDetailed;
