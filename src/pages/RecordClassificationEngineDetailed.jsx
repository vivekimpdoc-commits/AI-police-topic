...
const aiExperts = [
  "Auto-tagging/Classification (A, B, C, D) AI",
  "Retention Period Assignment Bot",
  "Weeding Out/Destruction Alert Engine",
  "Semantic Archival Indexing AI",
  "Content Analysis/Category Recommender",
  "Duplicate/Redundant Record Detector",
  "Geo-Spatial Record Room Mapper",
  "Digital/Physical Location Sync",
  "Record Classification Dashboard",
  "Voice-Command Record Query Bot",
  "Automated Monthly Weeding Report",
  "Record Room/Archives Department Sync",
  "Multi-Lingual Content OCR",
  "Misclassification/Error Detector AI",
  "Unauthorized Destruction Predictor",
  "Summary/Metadata Generator",
  "AI Evaluator for Archival Compliance",
  "Audit/Classification Log Generator",
  "Data Privacy/Classified Info Scrubber",
  "Law/Legal Department Sync (for retention rules)",
  "Record Keeper Mobile App",
  "Historical Record Accumulation Correlator",
  "Superintendent/Head Clerk Briefing AI",
  "Weeding/Shredding Task Allocator",
  "Blockchain Immutable Classification Hash",
  "Anti-Tamper Record Index Shield",
  "Mobile App for Barcode Scanning",
  "Branch-wise Archival Discipline Benchmarker",
  "Automated Reminder for Expired Records",
  "Historical Storage Cost Analyzer",
  "Record Management SOP Trainer",
  "Index Database Health Monitor",
  "Imminent Space Exhaustion Alert",
  "Habitual Record Hoarder Profiler",
  "Permanent/Historical Value Classifier",
  "AI Assisted Destruction Certificate Drafter",
  "Physical/Digital Storage Space Forecaster",
  "Secure Top-Secret Record Protector",
  "Integration with State Archives",
  "RTI Information Retrieval Sync",
  "Election Record Retention Modeler",
  "Disaster Record Preservation Coordinator",
  "Storage/Digitization Budget Tracker",
  "Custom Workflow for Historical Archiving",
  "AI Driven Weeding Workload Predictor",
  "Predictive Need for More Storage Space",
  "Custom Alert Trigger for Nodal Officer",
  "Record Retention Lifecycle Timeline Tracker"
];
...
const RecordClassificationEngineDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI RECORD CLASSIFICATION ENGINE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI RECORD CLASSIFICATION <span>ENGINE</span></h1>
...
export default RecordClassificationEngineDetailed;
