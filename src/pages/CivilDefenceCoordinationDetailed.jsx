...
const aiExperts = [
"Civil Defence Volunteer Database Auto-Sorter",
  "Skill-Based (Doctor/Plumber) Volunteer Matcher",
  "First-Aid/CPR Trained Citizen Mobilizer",
  "Neighborhood Watch (Mohalla) Integration AI",
  "SMS/WhatsApp Volunteer Alert Broadcasting",
  "Warden/Sector Commander Hierarchy Sync",
  "Real-time Volunteer GPS/Location Tracker",
  "Air-Raid/Siren Warning System Sync Bot",
  "Blackout/Curfew Enforcer Volunteer Deployer",
  "Evacuation Route/Traffic Marshal Assignor",
  "Command Center Civil Defence Dashboard",
  "Voice-Command Volunteer Skill Query Bot",
  "Automated Volunteer Duty Roster/Rotation",
  "Relief Material/Ration Kit Packaging AI",
  "Community Kitchen (Langar) Staff Modeler",
  "Missing Person/Child Search Grid Assignor",
  "Local Area Topography/Safe-Zone Mapper",
  "Crowd Control/Stampede Prevention Planner",
  "Fire-Fighting (Bucket Chain) Coord Bot",
  "Animal/Cattle Rescue Volunteer Matcher",
  "AI Evaluator for Volunteer Turnout Rate",
  "Honorary Award/Certificate Auto-Generator",
  "Data Privacy/Volunteer Personal Info Masker",
  "Police-Civil Defence Joint Patrolling AI",
  "Rumor Control/Fake News Debunker Bot",
  "Volunteer Food/Water Supply Burn-Rate AI",
  "Senior Officer (DM/SP) Volunteer Briefing",
  "Public/Community Announcement Drafter AI",
  "Blockchain Immutable Log of Volunteer Duty",
  "Unarmed Perimeter Guard/Cordon Sync AI",
  "Mobile App for Volunteer Check-in/SOS",
  "Vulnerable Person (Elderly) Mapping AI",
  "Multi-Lingual/Local Dialect Comms Bot",
  "Historical Volunteer Mobilization Precedent",
  "First-Aid Kit/Bandage Inventory Tracker",
  "Volunteer Fatigue/Stress Monitor AI",
  "Temporary Relief Camp Management AI",
  "Debris Clearance/Manual Labor Assignor",
  "Flood/Sandbag Embankment Coord Bot",
  "Earthquake/Rubble Search Coord Engine",
  "AI Assisted Post-Event Debriefing Gen",
  "Civil Defence Uniform/Jacket Inventory Alert",
  "VIP Visit/Rally Crowd Marshal Allocator",
  "Integration with District Admin (Collectorate)",
  "Citizen SOS to Nearest Volunteer Router",
  "Heatwave/Water Distribution Station AI",
  "Election Duty Volunteer Repurposing AI",
  "Stipend/Expense Tracker for Volunteers",
  "Custom Workflow/Approval for Volunteers",
  "AI Driven Volunteer Demobilization Predictor",
  "Predictive Need for Specialized Skills",
  "Custom Alert Trigger for Sector Warden"
];
...
const CivilDefenceCoordinationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CIVIL DEFENCE COORDINATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI CIVIL DEFENCE COORDINATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in civilian volunteer mobilization, first-aid camps & neighborhood watch.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CIVIL DEFENCE <span>COORDINATION</span></h1>
            <p className="cyber-subtitle">Civilian Volunteer Mobilization, First-Aid Camps & Neighborhood Watch</p>
          </div>
        </div>
      </header>
...
export default CivilDefenceCoordinationDetailed;
