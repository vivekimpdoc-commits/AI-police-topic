...
const aiExperts = [
  "Procession Route/Topography Mapper AI",
  "Communal Harmony/Tension Scorer",
  "Stampede/Crowd Crush Predictor",
  "Social Media Rumor/Hate Speech Extractor",
  "Drone/UAV Aerial Procession Monitor",
  "Traffic Diversion/Parking Optimizer",
  "Fire/Safety Hazard Detector AI",
  "Historical Clash Precedent Correlator",
  "Festival Security Dashboard",
  "Voice-Command Route Query Bot",
  "Automated Daily Security Brief",
  "Inter-Department (Civic/Health) Sync Bot",
  "Geo-Spatial Sensitive Area Overlay",
  "CCTV Bottleneck Analyzer AI",
  "Weapon/Contraband Visual Scanner",
  "Peace Committee Effectiveness Scorer",
  "AI Evaluator for Force Deployment",
  "Audit/Procession Approval Log Gen",
  "Data Privacy/Organizer Detail Scrubber",
  "State Intelligence Bureau Sync",
  "Field Officer Procession Task App",
  "Past Festival Incident Matcher AI",
  "DGP/CP Level Festival Briefing Bot",
  "Barricade/Riot Gear Resource Allocator",
  "Blockchain Immutable Approval Hash",
  "Anti-Tamper Security Plan Shield",
  "Mobile App for Procession Organizers",
  "Flashpoint Geolocation Matcher",
  "Multi-Lingual Guideline Translator",
  "Historical Festival Security Analyzer",
  "Festival Security SOP Trainer AI",
  "Festival DB Server Health Monitor",
  "Imminent Communal Clash Alert Bot",
  "Organized Crime Pickpocket Profiler",
  "VIP/VVIP Attendee Security Classifier",
  "AI Assisted Contingency Plan Drafter",
  "Surveillance Video Storage Forecaster",
  "Secure Informant Intel Protector",
  "Integration with Local Municipality",
  "Citizen Safety Alert Broadcasting",
  "Terror Attack Probability Modeler",
  "Disaster Evacuation Route Coordinator",
  "Festival Security Expense Tracker",
  "Custom Workflow for Volume/DJ Restrictions",
  "AI Driven Escalation Predictor",
  "Predictive Need for Rapid Action Force",
  "Custom Alert Trigger for Nodal Officers",
  "Procession Timeline Tracker"
];
...
const FestivalSecurityDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI FESTIVAL SECURITY
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI FESTIVAL <span>SECURITY</span></h1>
...
export default FestivalSecurityDetailed;
