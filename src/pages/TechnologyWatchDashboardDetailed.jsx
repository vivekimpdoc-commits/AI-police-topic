...
const aiExperts = [
  "Global Policing Tech Scraper AI",
  "Emerging Tech Feasibility Scorer",
  "Threat Landscape/Dark Web Mapper",
  "Academic/Research Paper Summarizer Bot",
  "Competitor/Adversary Capability Analyzer",
  "Obsolete Tech Identification Engine",
  "Geo-Spatial Global Innovation Mapper",
  "Vendor/OEM Product Launch Tracker",
  "Tech Watch Intelligence Dashboard",
  "Voice-Command Tech Query Bot",
  "Automated Monthly Horizon Scanning Report",
  "State Intelligence/Cyber Sync",
  "Disruptive Tech (Quantum/Deepfake) Alert AI",
  "Vendor Lock-in/Monopoly Predictor",
  "Hype vs Reality (Gartner Cycle) Analyzer",
  "Regulatory/Legal Conflict Predictor",
  "AI Evaluator for Tech Future-Proofing",
  "Audit/Scraping Log Generator",
  "Data Privacy/Open-Source Intelligence Scrubber",
  "Central Government (BPR&D) Sync",
  "Senior Officer Tech Briefing App",
  "Historical Tech Obsolescence Correlator",
  "DGP (Tech & Telecom) Briefing AI",
  "Technology Evaluation Task Allocator",
  "Blockchain Immutable Intelligence Hash",
  "Anti-Tamper Horizon Scan Shield",
  "Mobile App for Tech News/Alerts",
  "Country-wise Policing Tech Benchmarker",
  "Automated Alert for Imminent Adversary Tech Leap",
  "Historical Tech Acquisition Delay Analyzer",
  "Tech Evaluation/Horizon Scanning SOP Trainer",
  "OSINT/Scraper API Health Monitor",
  "Imminent Cryptographic/Security Obsolescence Alert",
  "Overhyped/Vaporware Vendor Profiler",
  "Classified (SIGINT/Cyber) Tech Classifier",
  "AI Assisted Procurement Strategy Drafter",
  "OSINT Data/Video Storage Forecaster",
  "Secure Strategic Tech Roadmap Protector",
  "Integration with National Security Council (NSCS)",
  "Interpol/Europol Tech Trend Sync",
  "Election Deepfake/Misinfo Tech Modeler",
  "Disaster Predictive Analytics Tech Coordinator",
  "R&D/Tech Watch Subscription Budget Tracker",
  "Custom Workflow for Covert/Spy Tech",
  "AI Driven Mainstream Adoption Year Predictor",
  "Predictive Need for Policy/Legal Updates",
  "Custom Alert Trigger for IG Cyber",
  "Discovery to Procurement Strategy Timeline"
];
...
const TechnologyWatchDashboardDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI TECHNOLOGY WATCH DASHBOARD
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI TECHNOLOGY WATCH <span>DASHBOARD</span></h1>
...
export default TechnologyWatchDashboardDetailed;
