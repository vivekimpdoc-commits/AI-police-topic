...
const aiExperts = [
  "Tactical Failure/Success NLP Analyzer",
  "Incident Timeline/Sequence Reconstructor",
  "Anniversary/Retaliation Risk Predictor",
  "Case Study/Lessons Learned Extractor",
  "Modus Operandi (MO) Evolution Tracker",
  "Media/Public Sentiment (Historical) Correlator",
  "Geo-Spatial Major Incident Heatmapper",
  "Court Acquittal vs Investigation Flaw Linker",
  "Historical Incident Intelligence Dashboard",
  "Voice-Command Archive Query Bot",
  "Automated Pre-Anniversary Threat Report",
  "State Crime Records Bureau (SCRB) Sync",
  "Copycat Crime/Syndicate Resurgence Predictor",
  "Ignored Warning/Intelligence Failure Analyzer",
  "Socio-Political Fallout Predictor",
  "Resource/Deployment Shortfall Identifier",
  "AI Evaluator for Tactical Readiness Index",
  "Audit/Archive Access Log Generator",
  "Data Privacy/Victim Identity Scrubber",
  "Police Training Academy Sync",
  "Investigating Officer/Trainee App",
  "Historical Riot/Terror Attack Correlator",
  "DGP (Operations) Briefing AI",
  "Refresher Training/Briefing Allocator",
  "Blockchain Immutable Archive Hash",
  "Anti-Tamper Case File Shield",
  "Mobile App for On-the-Go Case Reference",
  "Range-wise Incident Resolution Benchmarker",
  "Automated Alert for Impending Incident Anniversary",
  "Historical Riot Compensation/Damage Analyzer",
  "Crisis Response/Tactical SOP Trainer",
  "Digitized Record/OCR Health Monitor",
  "Imminent Retaliatory Attack (Post-Verdict) Alert",
  "Serial Offender/Mastermind Profiler",
  "High-Impact (Communal/Terror) Incident Classifier",
  "AI Assisted Tactical Briefing Drafter",
  "Crime Trend/Cyclical Pattern Forecaster",
  "Secure Classified Case File Protector",
  "Integration with National Crime Records Bureau (NCRB)",
  "Judicial/Prosecution Department Sync",
  "Election Historical Violence (Booth-wise) Modeler",
  "Disaster Historical Flash-Flood/Quake Coordinator",
  "Digitization/Archival Budget Tracker",
  "Custom Workflow for Unsolved/Cold Cases",
  "AI Driven Future Flashpoint Predictor",
  "Predictive Need for Specialized Force Deployment",
  "Custom Alert Trigger for Home Secretary",
  "Query to Case Study Generation Timeline"
];
...
const HistoryOfMajorIncidentsRepositoryDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI HISTORY OF MAJOR INCIDENTS REPOSITORY
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI HISTORY OF MAJOR INCIDENTS <span>REPOSITORY</span></h1>
...
export default HistoryOfMajorIncidentsRepositoryDetailed;
