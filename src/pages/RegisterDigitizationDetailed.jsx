...
const aiExperts = [
"Station Diary (General Diary) OCR Digitizer",
  "FIR Register Bulk Scanning & Indexing AI",
  "Malkhana (Property) Register Auto-Digitizer",
  "Arrest Register/Lockup Log Scanner Bot",
  "Warrant/Summons Register Digitization AI",
  "Absconder/Proclaimed Offender Log OCR",
  "Crime Village/Beat Book Digitization Engine",
  "Missing Persons Register Bulk Scanner",
  "Command Center Digitization Dashboard",
  "Voice-Command Historical Record Query",
  "Automated Handwriting Recognition (ICR) Bot",
  "Faded/Damaged Document Image Enhancer",
  "Inter-Station Record De-duplication AI",
  "Regional Language (Hindi/Marathi) OCR Engine",
  "Digitized Record Meta-Tag Auto-Generator",
  "Historical FIR Number vs Year Matcher",
  "AI Evaluator for OCR Accuracy/Confidence",
  "Audit/Digitization Progress Log Generator",
  "Data Privacy/Victim Name Redaction in OCR",
  "Police-Court Record Digitization Linker",
  "Daily Crime Report (DCR) Legacy Digitizer",
  "Arms/Ammunition Issue Register OCR Bot",
  "Senior Officer (DGP/SP) Digitization Briefing",
  "Public RTI Query via Digitized Record Search",
  "Blockchain Immutable Hash for Digitized File",
  "Physical-to-Digital Rack Mapping AI",
  "Mobile App for Field Document Scanning",
  "Gun License/Renewal Register Digitizer",
  "Multi-Lingual CCTNS Upload Formatter",
  "Historical Riot/Bandh Register OCR Engine",
  "Passport Police Verification Log Digitizer",
  "Digitization Vendor SLA/Speed Monitor AI",
  "Temporary Post/Naka Log Digitization",
  "Traffic Challan/Fine Legacy Record OCR",
  "Accident (MACT) Register Bulk Scanner",
  "Post-Mortem/Inquest Register Digitization",
  "AI Assisted Post-Digitization QA Checker",
  "Record Room Pest/Moisture Damage Alert",
  "VIP Security Duty Register Digitization AI",
  "Integration with National Crime Records (NCRB)",
  "Citizen Character Certificate Log Scanner",
  "Foreigner Registration (FRO) Log Digitizer",
  "Election Duty Log Historical Digitizer",
  "Digitization Fund/Budget Tracker AI",
  "Custom Workflow/Approval for Record Destruction",
  "AI Driven Archival/Cold Storage Predictor",
  "Predictive Need for Manual Typist Correction",
  "Custom Alert Trigger for Record Keeper"
];
...
const RegisterDigitizationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI REGISTER DIGITIZATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI REGISTER DIGITIZATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in ocr scanning, text indexing & auto-categorization of historical records.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI REGISTER <span>DIGITIZATION</span></h1>
            <p className="cyber-subtitle">OCR Scanning, Text Indexing & Auto-Categorization of Historical Records</p>
          </div>
        </div>
      </header>
...
export default RegisterDigitizationDetailed;
