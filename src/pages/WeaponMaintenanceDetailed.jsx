...
const aiExperts = [
"Predictive Jamming Probability Modeler",
  "Barrel Wear & Tear Analytics AI",
  "Recoil Spring Tension Predictor",
  "Automated Maintenance Scheduler Bot",
  "Spare Parts Procurement Forecaster",
  "Armourer Skill vs Task Matcher",
  "Rust & Corrosion Risk Forecaster",
  "Recoil Degradation Tracker AI",
  "Weapon Lifecycle Analytics Engine",
  "Acoustic Fault Detection Bot",
  "Firing Pin Integrity AI",
  "Smart Cleaning Solvent Requisition AI",
  "High-Risk Weapon Quarantine AI",
  "Computer Vision Micro-Crack Detector",
  "Gas Tube Blockage Predictor",
  "Extractor & Ejector Wear Forecaster",
  "Armoury Workload Balancer AI",
  "Duty-Driven Maintenance Prioritizer",
  "Trigger Pull Weight Calibration AI",
  "Magazine Spring Tension Analyzer",
  "Laser Sight Battery Drain Predictor",
  "Optical Scope Misalignment Detector",
  "Night Vision Optic Degradation AI",
  "Environmental Dust/Humidity Wear Adjuster",
  "Automated Armourer Certification Verifier",
  "Weapon Repair Workflow Optimizer",
  "Spare Parts Inventory Anomaly Detector",
  "Weapon End-of-Life Predictor AI",
  "Acoustic Firing Signature Matcher",
  "Automated Post-Firing Cleaning Alert",
  "Teflon Coating Wear Analyzer",
  "Polymers & Composite Degradation AI",
  "Heat Stress & Barrel Warping Predictor",
  "3D Printed Spare Parts Quality AI",
  "Armourer Efficiency & Speed Scorer",
  "Biometric Tool Crib Access Monitor",
  "Maintenance Ledger Blockchain Sync",
  "Digital Worklog NLP Summarizer",
  "CCTV Bench Monitoring & Sync AI",
  "Skipped Maintenance Disciplinary Flag",
  "Third-Party Repair Vendor Sync AI",
  "Budget Forecasting for Replacements",
  "Weapon Depreciation Value Calculator",
  "Defective Batch Recall Initiator",
  "Ammunition vs Weapon Wear Correlator",
  "Riot Gear Shield Scratch Analyzer",
  "Tear Gas Launcher Pressure Tester",
  "Flashbang Fuse Integrity Predictor",
  "Helicopter Mounted Gun Maintenance AI",
  "Sniper Rifle Precision Drift Analyzer",
  "Anti-Terror Kit Maintenance Sync",
  "Water-Cannon Valve Wear Forecaster",
  "Bulletproof Vest Kevlar Degradation AI",
  "Smart-Gun Electronics Diagnostic Bot",
  "RFID Maintenance Tag Updater",
  "Armoury Logistics & Transfer Sync AI",
  "Robotic Armourer Arm Sync AI",
  "Automated Maintenance Report Generator",
  "Predictive Equipment Calibration Tracker",
  "Central Equipment Registry Sync Bot"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> WEAPON MAINTENANCE
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>WEAPON MAINTENANCE</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in jamming probability modeler & barrel cleaning ai.
            </p>
