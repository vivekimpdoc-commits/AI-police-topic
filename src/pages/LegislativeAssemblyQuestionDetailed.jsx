...
const aiExperts = [
  "Assembly Question NLP Extractor",
  "Starred vs Unstarred Priority Sorter",
  "Historical Reply Precedent Matcher",
  "Data Compilation/Aggregation Engine",
  "Departmental Jurisdiction Router",
  "Draft Reply Formatting Assistant",
  "Statistical Fact-Checking Bot",
  "Contradiction/Error Detector AI",
  "Assembly Coordination Dashboard",
  "Voice-Command Question Query Bot",
  "Automated Session Summary Report",
  "Cross-District Data Gathering Bot",
  "Supplementary Question Predictor AI",
  "Political Sensitivity Scorer",
  "Crime Stat Auto-Updater Engine",
  "Pending Assurance Tracker Bot",
  "AI Evaluator for Reply Accuracy",
  "Audit/Assembly Reply Access Log Gen",
  "Data Privacy/Sensitive Detail Scrubber",
  "Home Department Secretariat Sync",
  "Field IO Data Request Alert App",
  "Past Session Reference Matcher",
  "DGP/Home Minister Briefing AI",
  "Data Gathering Resource Allocator",
  "Blockchain Immutable Reply Hash",
  "Anti-Tamper Assembly Record Shield",
  "Mobile App for Session Alerts",
  "Question Geographic Focus Matcher",
  "Multi-Lingual Question Translator",
  "Historical Assembly Trend Analyzer",
  "Parliamentary Procedure Trainer",
  "Assembly Coordination DB Monitor",
  "Urgent Session Deadline Alert Bot",
  "Organized Crime Question Profiler",
  "VIP/Constituency Specific Classifier",
  "AI Assisted Debate Prep Drafter",
  "Assembly Record Storage Forecaster",
  "Secure Informant Info Excluder",
  "Integration with Vidhan Sabha Portal",
  "Media Coverage Analytics on Replies",
  "Opposition Walkout/Protest Modeler",
  "Disaster Relief Assembly Query Coordinator",
  "Legislative Cell Expense Tracker",
  "Custom Workflow for Home Minister Approval",
  "AI Driven Follow-Up Question Predictor",
  "Predictive Need for Press Briefing",
...
const LegislativeAssemblyQuestionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI LEGISLATIVE ASSEMBLY QUESTION COORDINATION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI LEGISLATIVE ASSEMBLY QUESTION <span>COORDINATION</span></h1>
...
export default LegislativeAssemblyQuestionDetailed;
