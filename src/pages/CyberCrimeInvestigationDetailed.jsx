...
const aiExperts = [
"Digital Forensics Disk Image Analyzer AI",
  "Malware/Ransomware Reverse Engineering Bot",
  "IP Address & Proxy/VPN Unmasking AI",
  "Network Intrusion/Packet Sniffing Analyzer",
  "Encrypted Communication/Signal Decoder",
  "Deleted File Recovery & Carving AI",
  "RAM/Volatile Memory Dump Analyzer",
  "Metadata (EXIF/Header) Extractor Bot",
  "Email Header Spoofing Detector AI",
  "Server Log (Apache/Nginx) Parse & Trace",
  "Zero-Day Vulnerability Exploit Matcher",
  "Command & Control (C2) Server Locator",
  "Botnet Architecture & Node Analyzer AI",
  "Cryptocurrency Mixer/Tumbler Tracer AI",
  "Dark Web Link & Onion Routing Tracker",
  "Social Engineering Attack Vector Analyzer",
  "Command Center Cyber Intel Dashboard",
  "Voice-Command Cyber Terminology Assistant",
  "Automated Cyber-Crime FIR Auto-Drafter",
  "Inter-Agency (CERT-In) Threat Sync Bot",
  "Stenography (Hidden Data) Detector AI",
  "Password Hash Cracking Optimizer AI",
  "Biometric Bypass/Deepfake Authenticator",
  "IoT Device (Smart Home) Forensics Bot",
  "Drone/UAV Flight Log Forensics AI",
  "Cloud Storage/AWS/Azure Access Log Tracer",
  "USB/Rogue Device Fingerprinting AI",
  "Web Application Firewall (WAF) Bypass Analyzer",
  "SQL Injection/XSS Attack Timeline Gen",
  "Ransomware Decryption Key Matcher DB",
  "AI Evaluator for Digital Evidence Admissibility",
  "Blockchain Immutable Evidence Chain-of-Custody",
  "Historical Cyber Incident Precedent Linker",
  "Cyber Syndicate/Jamtara Module Mapper",
  "Mobile App (APK/IPA) Malware Sandbox AI",
  "Spyware/Pegasus Infection Detection Bot",
  "Telecom CDR/IPDR Cross-Correlation AI",
  "VPN Log Subpoena Auto-Generator Bot",
  "AI Assisted Phishing Domain Takedown",
  "OSINT (Open Source Intel) Aggregator Engine",
  "Cross-Border Cyber Attack Attribution AI",
  "Critical Infrastructure SCADA Network Defender",
  "Insider Threat/Data Exfiltration Tracer",
  "AI Driven Hardware Keylogger Detection",
  "Corporate Espionage Digital Trail AI",
  "Election/EVM Hacking Claim Verifier",
  "Cyber Extortion/DDoS Threat Analyzer",
  "Child Pornography (CSAM) Hash Matcher",
  "AI Generated Cyber Security Audit Gen",
  "Suspect Machine Browser History NLP Scrubber",
  "Financial Log (SWIFT) Fraud Forensics",
  "Data Privacy/Victim Data Sanitizer Bot",
  "AI Protocol for Live-System Seizure (Triage)",
  "Digital Signature Forgery Detection AI",
  "Cyber-Bullying Origin Tracker",
  "Fake Customer Care Number VoIP Tracer"
];
...
const CyberCrimeInvestigationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CYBER CRIME INVESTIGATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI CYBER CRIME INVESTIGATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in digital forensics, malware reverse engineering, ip tracing & network intrusion.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CYBER CRIME <span>INVESTIGATION</span></h1>
            <p className="cyber-subtitle">Digital Forensics, Malware Reverse Engineering, IP Tracing & Network Intrusion</p>
          </div>
        </div>
      </header>
...
export default CyberCrimeInvestigationDetailed;
