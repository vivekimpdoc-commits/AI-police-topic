...
const aiExperts = [
  "Jail-to-Court Transit Route Optimizer",
  "High-Risk Prisoner/Gang Escort Allocator",
  "Virtual (Video Conferencing) vs Physical Routing AI",
  "Hearing Date/Time Clash Resolution Engine",
  "Escort Force (Guards/Vehicles) Requirement Calculator",
  "Gang Rivalry/Transit Ambush Risk Scorer",
  "Geo-Spatial Court/Prison/Hospital Mapper",
  "Medical Emergency/Hospital Production Scheduler",
  "Production Warrant Dashboard",
  "Voice-Command Escort Query Bot",
  "Automated Daily Prisoner Movement Report",
  "Prison Management System (E-Prisons) Sync",
  "Transit Ambush/Escape Attempt Predictor",
  "Escort Shortage/Force Depletion Alert",
  "Hearing Adjournment (Due to Non-Production) Estimator",
  "Hostile Crowd/Media Mob Risk Analyzer",
  "AI Evaluator for Escort Efficiency & Safety Index",
  "Audit/Transit Log Generator",
  "Data Privacy/Medical Status Scrubber",
  "State Armed Police (Reserve Lines) Sync",
  "Escort Commander/Jailer Mobile App",
  "Historical Custody Escape/Attack Correlator",
  "Reserve Inspector (RI)/SP Lines Briefing AI",
  "Vehicle & Armed Guard Task Allocator",
  "Blockchain Immutable Prisoner Handover Hash",
  "Anti-Tamper Warrant/Production Shield",
  "Mobile App for Live GPS Transit Tracking",
  "District-wise Virtual Hearing Adoption Benchmarker",
  "Automated Alert for High-Risk (Terror/Underworld) Movements",
  "Historical Fuel/Escort Deployment Cost Analyzer",
  "Prisoner Escort/Handcuffing SOP Trainer",
  "Video Conferencing/E-Courts API Health Monitor",
  "Imminent Gang War/Shootout During Transit Alert",
  "Flight-Risk/Desperate Prisoner Profiler",
  "High-Security (Category A/B) Prisoner Classifier",
  "AI Assisted Virtual Hearing Request Drafter",
  "Escort Force Demand/Shortfall Forecaster",
  "Secure Route/Timing/Vehicle Detail Protector",
  "Integration with Inter-operable Criminal Justice System (ICJS)",
  "Traffic Police/Control Room Sync",
  "Election (Force Diversion) Virtual Hearing Maximization Modeler",
  "Disaster (Flooded Routes) Transit Re-routing Coordinator",
  "Escort Fleet/Fuel & VC Infrastructure Budget Tracker",
  "Custom Workflow for Inter-State Prisoner Transfer",
  "AI Driven Ambush/Escape Vulnerability Predictor",
  "Predictive Need for Bullet-Proof Vehicles",
  "Custom Alert Trigger for SP City/Jail Superintendent",
  "Warrant Receipt to Court Production Timeline"
];
...
const ProductionWarrantSchedulerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI PRODUCTION WARRANT SCHEDULER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI PRODUCTION WARRANT <span>SCHEDULER</span></h1>
...
export default ProductionWarrantSchedulerDetailed;
