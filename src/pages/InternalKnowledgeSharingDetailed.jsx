...
const aiExperts = [
"Case Study Repository Auto-Indexer",
  "Investigative Technique Sharing Router",
  "Legal Precedent & Court Ruling Wiki AI",
  "Modus Operandi (MO) Knowledge Base",
  "Cyber Crime Investigation Playbook AI",
  "Forensic Evidence Collection Guide Bot",
  "Interrogation Strategy & Tips Repository",
  "Automated Cross-Referencing Search AI",
  "New Law (BNS, BNSS, BSA) Explainer Bot",
  "Riot/Crowd Control Tactical Guide AI",
  "VIP Security Protocol Knowledge Base",
  "Election Security Best Practices Wiki",
  "Narcotics/Drug Bust Case Study Sync",
  "Financial/Economic Fraud Playbook AI",
  "Women/Child Crime Sensitivity Guide",
  "Human Trafficking Investigation Wiki",
  "Terror/Extremist Funding Case Studies",
  "Smart Search & NLP Query Resolver",
  "Officer Experience/Wisdom Extractor AI",
  "Automated Knowledge Article Drafter",
  "Video/Audio Tutorial Transcriber Bot",
  "Knowledge Base Gap Analyzer AI",
  "Multi-Lingual Training Material Translator",
  "CCTNS Data Entry Best Practices Wiki",
  "Traffic Accident Reconstruction Guide",
  "Disaster/Rescue Operations Playbook AI",
  "Wildlife/Forest Crime Investigation Guide",
  "Illegal Mining Prosecution Case Studies",
  "Armoury/Weapon Handling Safety Wiki",
  "Drone/CCTV Operation Manual Bot",
  "Command Center Standard Operating Proc (SOP)",
  "Informant/Source Handling Guidelines",
  "Media/Press Interaction Protocol Wiki",
  "Court Deposition/Evidence Presentation Guide",
  "Internal Wiki Access & Permission Auditor",
  "Knowledge Sharing Gamification/Reward AI",
  "Automated FAQ & Troubleshoot Generator",
  "Historical Unsolved Case Theory Wiki",
  "Interstate Extradition Procedure Guide",
  "Interpol/Red Corner Notice Playbook",
  "Forensic Audit/Cyber Log Analysis Guide",
  "Mobile Forensics/CDR Analysis Wiki",
  "Social Media OSINT Investigation Guide",
  "Dark Web Investigation Playbook AI",
  "Knowledge Article Upvote/Rating Scorer",
  "Outdated Protocol/Law Deprecation Alert",
  "Automated Training Module Creator AI",
  "Officer Orientation/Onboarding Wiki",
  "Departmental Disciplinary Case Precedents",
  "Police Welfare/Leave Policy Explainer",
  "Internal Chatbot for Knowledge Queries",
  "Knowledge Base Version Control AI",
  "Secure Encrypted Knowledge Vault Bot",
  "Inter-Departmental Best Practice Sync",
  "Cross-District Case Study Matcher AI",
  "Knowledge Article Read-Receipt Tracker",
  "AI Generated Mind-Map for Complex Cases",
  "Expert Officer Directory/Mentor Router",
  "Knowledge Base Blockchain Audit Trail",
  "Centralized PHQ Knowledge Disseminator"
];
...
const InternalKnowledgeSharingDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INTERNAL KNOWLEDGE SHARING
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI INTERNAL KNOWLEDGE SHARING</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in case study repositories, investigative technique sharing & legal precedent wikis.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INTERNAL KNOWLEDGE <span>SHARING</span></h1>
            <p className="cyber-subtitle">Case Study Repositories, Investigative Technique Sharing & Legal Precedent Wikis</p>
          </div>
        </div>
      </header>
...
export default InternalKnowledgeSharingDetailed;
