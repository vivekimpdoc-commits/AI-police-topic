...
const aiExperts = [
"Geo-Tagged SOS Distress Router",
  "Shake/Drop Emergency Trigger AI",
  "Mobile Video Evidence Validator",
  "Fake GPS Location Detector",
  "Push Notification Target Optimizer",
  "App Crash & Bug Predictor",
  "Citizen Location Heatmap AI",
  "Women Safety Escort Route AI",
  "Safe-City Safe-Route Recommender",
  "Live Commute Tracking Bot",
  "One-Touch 112 Dispatch Link",
  "Audio Recording Metadata Analyzer",
  "Crowdsourced Traffic Alert Sync",
  "Missing Person Nearby Alert AI",
  "Stolen Vehicle Sighting Uploader",
  "Lost/Found Item Matcher Bot",
  "Mobile E-Challan Scanner Bot",
  "Digital Driving License Sync",
  "Citizen App Battery Drain Modeler",
  "Offline Mode SOS Cacher AI",
  "Automated FIR Draft via App",
  "Voice Command App Navigator",
  "In-App Chatbot Resolution Engine",
  "App User Retention Analytics AI",
  "Citizen App Rating & Review NLP",
  "Local Police Station Locator AI",
  "Officer Rating & Feedback Bot",
  "Vernacular App Localization AI",
  "Neighborhood Watch Group Sync",
  "Suspicious Activity Photo OCR",
  "Cyber Fraud One-Tap Reporter",
  "App Identity Verification (eKYC)",
  "Biometric App Access Securer",
  "Tourist Mode Safety Optimizer",
  "Senior Citizen Daily Check-in AI",
  "Domestic Violence Silent Alarm",
  "App Permissions Privacy Auditor",
  "Malware/Spyware Detection on Phone",
  "Public Transport Safety Rater",
  "Event/Rally Crowd Density Sync",
  "Wanted Criminal Face Matcher (AR)",
  "Missing Pet Registry Bot",
  "Noise Pollution Audio Uploader",
  "Illegal Parking Photo Flag AI",
  "Pothole/Civic Issue Auto-Router",
  "Blood Donor Emergency Sync AI",
  "Disaster Relief Volunteer Router",
  "App Gamification & Reward Modeler",
  "Citizen Cop Certificate Generator",
  "In-App Threat Level Broadcaster",
  "Automated OTP Delivery Predictor",
  "App API Latency Analyzer",
  "Cross-Platform Sync AI (iOS/Android)",
  "Mobile Wallet E-Challan Linker",
  "Digital Summons Push Tracker",
  "App Engagement Heatmap Bot",
  "Bluetooth Proximity Alert Sync",
  "IoT Wearable Watch SOS Link",
  "Social Media Share Sync Bot",
  "Command Center App Telemetry AI"
];
...
const CitizenMobileAppDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CITIZEN MOBILE APP
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI CITIZEN MOBILE APP</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in geo-tagged sos, push notifications & mobile evidence upload validation.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CITIZEN MOBILE <span>APP</span></h1>
            <p className="cyber-subtitle">Geo-Tagged SOS, Push Notifications & Mobile Evidence Upload Validation</p>
          </div>
        </div>
      </header>
...
export default CitizenMobileAppDetailed;
