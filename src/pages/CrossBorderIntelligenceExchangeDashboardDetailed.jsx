...
const aiExperts = [
  "Inter-State Fugitive/Criminal Tracker AI",
  "Smuggling/Contraband Route Geo-Predictor",
  "Real-Time Interstate Alert/BOLO Engine",
  "Secure/Encrypted Cross-Border Comms Bot",
  "Modus Operandi (MO) Cross-Match Analyzer",
  "Human Trafficking/Missing Person Linker",
  "Geo-Spatial Border Checkpoint/Porous Route Mapper",
  "Inter-State Gang/Syndicate Network Analyzer",
  "Cross-Border Intelligence Dashboard",
  "Voice-Command Interstate Query Bot",
  "Automated Monthly Joint-Ops Intelligence Report",
  "Neighboring State Police/CID Sync",
  "Fugitive Border-Crossing/Escape Predictor",
  "Fake ID/Vehicle Plate Interstate Mismatch Alert",
  "Weapon/Narcotics Supply Chain Analyzer",
  "Jurisdictional Dispute/Delay Red-Flagger",
  "AI Evaluator for Inter-State Cooperation Index",
  "Audit/Data-Exchange Log Generator",
  "Data Privacy/Classified Intel Scrubber",
  "National Investigation Agency (NIA) Sync",
  "Nodal Officer (Interstate) Secure App",
  "Historical Cross-Border Crime Correlator",
  "IG (Border/Interstate) Briefing AI",
  "Joint-Raid/Coordination Task Allocator",
  "Blockchain Immutable Intel Exchange Hash",
  "Anti-Tamper Secure Message Shield",
  "Mobile App for Border Outpost (BOP) Alerts",
  "State-to-State Response Time Benchmarker",
  "Automated Alert for High-Value Target Crossing",
  "Historical Joint-Ops/Extradition Cost Analyzer",
  "Interstate Arrest/Transit Remand SOP Trainer",
  "CCTNS/Inter-operable Criminal Justice System API Monitor",
  "Imminent Major Smuggling/Terror Infiltration Alert",
  "Interstate Kingpin/Smuggler Profiler",
  "High-Priority (Terror/Arms) Intel Classifier",
  "AI Assisted Letter Rogatory/Transit Warrant Drafter",
  "Interstate Crime/Migration Trend Forecaster",
  "Secure Undercover/Joint-Ops Plan Protector",
  "Integration with BSF/SSB (Border Guarding Forces)",
  "Narcotics Control Bureau (NCB) Sync",
  "Election Interstate Liquor/Cash Smuggling Modeler",
  "Disaster Interstate Relief/Refugee Coordinator",
  "Joint Task Force/Travel Budget Tracker",
  "Custom Workflow for International Border (Nepal/Bangladesh)",
  "AI Driven Syndicate Expansion Predictor",
  "Predictive Need for Joint Border Checkposts",
  "Custom Alert Trigger for DGP",
  "Intel Receipt to Joint Operation Execution Timeline"
];
...
const CrossBorderIntelligenceExchangeDashboardDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CROSS-BORDER INTELLIGENCE EXCHANGE DASHBOARD
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CROSS-BORDER INTELLIGENCE EXCHANGE <span>DASHBOARD</span></h1>
...
export default CrossBorderIntelligenceExchangeDashboardDetailed;
