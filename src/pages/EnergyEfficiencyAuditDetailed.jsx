...
const aiExperts = [
  "Appliance Power Draw Analyzer",
  "Carbon Footprint/Emissions Tracker",
  "LED/BLDC Fan Upgrade ROI Estimator",
  "Rooftop Solar Potential Mapper",
  "Phantom Load/Standby Power Detector",
  "Peak Demand Charge Optimizer",
  "Geo-Spatial Energy Waste Hotspot Mapper",
  "Tariff Slab/Penalty Optimizer",
  "Energy Efficiency Dashboard",
  "Voice-Command Energy Query Bot",
  "Automated Quarterly Energy Audit Report",
  "State Renewable Energy Agency Sync",
  "Inefficient/Aging AC Unit Predictor",
  "Unnecessary After-Hours Lighting Alert",
  "Solar Yield Degradation Predictor",
  "Insulation/Heat Gain Analyzer",
  "AI Evaluator for Green Building Compliance",
  "Audit/Consumption Log Generator",
  "Data Privacy/Occupancy Profile Scrubber",
  "Finance/Modernization Department Sync",
  "Energy Auditor Mobile App",
  "Historical Energy Price Trend Correlator",
  "DGP (Modernization) Briefing AI",
  "Retrofit/Replacement Task Allocator",
  "Blockchain Immutable Audit Hash",
  "Anti-Tamper Energy Log Shield",
  "Mobile App for Appliance Inventory",
  "Station-wise Energy Efficiency Benchmarker",
  "Automated Alert for Excessive Power Draw",
  "Historical Utility Bill Analyzer",
  "Energy Conservation SOP Trainer",
  "Smart Plug/Sub-meter Health Monitor",
  "Imminent Transformer Overload Alert",
  "Energy-Inefficient Facility Profiler",
  "High-Consumption (Server Room/Command Center) Classifier",
  "AI Assisted Solar Tender Drafter",
  "Energy Consumption Forecaster",
  "Secure Facility Electrical Layout Protector",
  "Integration with National Smart Grid",
  "Carbon Credit Exchange Sync",
  "Election 24x7 Operations Energy Modeler",
  "Disaster Power Resilience/Microgrid Coordinator",
  "Energy Upgrade/CAPEX Budget Tracker",
  "Custom Workflow for EV Charging Station Integration",
  "AI Driven Annual Energy Savings Predictor",
  "Predictive Need for Complete Rewiring",
...
const EnergyEfficiencyAuditDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ENERGY EFFICIENCY AUDIT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ENERGY EFFICIENCY <span>AUDIT</span></h1>
...
export default EnergyEfficiencyAuditDetailed;
