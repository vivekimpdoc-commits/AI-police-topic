...
const aiExperts = [
"Automated BOLO (Be On Look-Out) Drafter",
  "Suspect Vehicle ANPR Flash Relay",
  "Inter-District Crime Alert Router AI",
  "Stolen Vehicle Highway Checkpost Sync",
  "Missing Person / Amber Alert Broadcaster",
  "Fugitive/Escaped Convict Geolocation Alert",
  "Riot/Mob Violence Flash Broadcast AI",
  "Terrorist Attack Rapid Alert Sync",
  "Active Shooter/Sniper Zone Broadcast",
  "Bank Robbery / Heist Instant Relay",
  "Kidnapping/Hostage Suspect Tracking Alert",
  "VVIP Route Security Threat Flash",
  "Smuggling/Contraband Convoy Alert Bot",
  "Cyber Fraud/Scam Modus Operandi Alert",
  "Traffic/Pile-up Highway Diversion Broadcast",
  "Disaster/Earthquake Rapid Responder Alert",
  "Fire/Explosion Multi-Agency Flash Bot",
  "Hazardous Material/Gas Leak Evacuation Alert",
  "Railway/Train Sabotage Flash Relay",
  "Aviation/Airport Security Threat Alert",
  "Maritime/Coastal Intrusion Broadcast AI",
  "Border Infiltration Inter-Agency Alert",
  "Election Booth Violence Flash Sync",
  "Festival/Event Stampede Warning Broadcast",
  "Women/Child Abuse Rapid Intercept Alert",
  "VIP/Politician Attack Flash Broadcast",
  "Prison/Jail Riot or Breakout Alert AI",
  "Police Officer Distress (Officer Down) Alert",
  "Automated Text-to-Speech Radio Relay",
  "Digital Signage/Billboard Suspect Display",
  "Social Media / WhatsApp BOLO Integration",
  "CCTV/Facial Recognition Triggered Alert",
  "Toll Plaza Barrier Lockdown Broadcast",
  "Mobile Police App Push Notification Bot",
  "Cross-State/National DB (CCTNS) Sync AI",
  "Interpol Red-Corner Notice Flash Relay",
  "Broadcast Target Radius Optimizer",
  "Incident Severity / Urgency Scorer AI",
  "Multi-Lingual Broadcast Translator Bot",
  "False-Alarm / Stand-Down Cancellation AI",
  "Broadcast Read-Receipt & Acknowledge Tracker",
  "Automated Post-Incident Effectiveness Report",
  "Historical Broadcast vs Arrest Correlator",
  "Informant/Source Tip-Off Broadcast Link",
  "Command Center BOLO Dashboard Sync",
  "Voice-Command Initiated Flash Alert",
  "Encrypted Secure Broadcast Channelizer",
  "Public Alert System / Siren Overlap AI",
  "Officer Body-Cam Suspect Match Broadcast",
  "Drone Surveillance Threat Relay Bot",
  "Weapon/Gunshot Acoustic Triggered Alert",
  "Predictive Suspect Escape Route Broadcaster",
  "Railway/Bus Station Suspect Intercept Alert",
  "Hotel/Guest House Occupancy Flash Sync",
  "Pawn-Shop/Scrap-Dealer Stolen Goods Alert",
  "Hospital Medico-Legal Gunshot Wound Alert",
  "AI-Generated Suspect Sketch (Composite) Relay",
  "Blockchain Immutable Log of Broadcasts",
  "Inter-Agency Joint Task Force Alert Sync",
  "Mass Casualty Incident (MCI) Blood/Resource Alert"
];
...
const IncidentBroadcastSystemDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INCIDENT BROADCAST SYSTEM
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI INCIDENT BROADCAST SYSTEM</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in automated bolo alerts, suspect vehicle relay & inter-district flash messages.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INCIDENT BROADCAST <span>SYSTEM</span></h1>
            <p className="cyber-subtitle">Automated BOLO Alerts, Suspect Vehicle Relay & Inter-District Flash Messages</p>
          </div>
        </div>
      </header>
...
export default IncidentBroadcastSystemDetailed;
