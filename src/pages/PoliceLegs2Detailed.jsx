...
const aiExperts = [
"Court Order Compliance AI", "Property Auction Bot", "Magistrate Comms Bot", "Warrant Scheduler AI", "Limitation Period Monitor", "Legal Notice Dispatch AI", "Disposal Tracker Bot", "Judicial Correspondence AI", "Unclaimed Property AI", "Case Property Auditor", "Legal Timeline Bot"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> POLICE LEGAL PROCESS
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>POLICE LEGAL PROCESS</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in court compliance ai, property auctions & limitation guard.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">POLICE <span>LEGAL PROCESS</span></h1>
            <p className="cyber-subtitle">Court Compliance AI, Property Auctions & Limitation Guard</p>
          </div>
        </div>
      </header>
