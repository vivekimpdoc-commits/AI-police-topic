...
const aiExperts = [
  "Traffic Diversion/Congestion Modeler AI",
  "Communal Sensitivity/Hotspot Mapping Engine",
  "Police Force Deployment Estimator",
  "Multi-Agency (Fire/Health/Municipality) NOC Coordinator",
  "Historical Route Precedent/Dispute Analyzer",
  "Overlap/Clash Detector (Multiple Processions)",
  "Geo-Spatial Route & Checkpoint Mapper",
  "Crowd Density/Flow Rate Predictor",
  "Procession Route Dashboard",
  "Voice-Command Route Query Bot",
  "Automated Festival Readiness/Route Report",
  "State Intelligence/Local Intelligence Unit Sync",
  "Chokepoint/Stampede Vulnerability Predictor",
  "Communal Flashpoint/Provocation Alert",
  "Unauthorized Route Deviation Estimator",
  "Inadequate Force Allocation Flagging AI",
  "AI Evaluator for Procession Safety Index",
  "Audit/NOC Clearance Log Generator",
  "Data Privacy/Organizer Background Scrubber",
  "Traffic/Highway Police Sync",
  "Sector Magistrate/Zonal Officer Mobile App",
  "Historical Riot/Clash Correlator (on specific routes)",
  "District Magistrate/SP Briefing Interface",
  "Drone/CCTV Monitoring Task Allocator",
  "Blockchain Immutable Route Approval Hash",
  "Anti-Tamper Permission/Condition Shield",
  "Mobile App for Live Procession Tracking",
  "District-wise Event Management Benchmarker",
  "Automated Alert for Sudden Route Deviations",
  "Historical Force Deployment/Barricading Cost Analyzer",
  "Crowd Management/Procession SOP Trainer",
  "Google Maps/Traffic API Health Monitor",
  "Imminent Stampede/Overcrowding Emergency Alert",
  "Habitual Rule-Breaking Organizer Profiler",
  "High-Risk (Religious/Political) Procession Classifier",
  "AI Assisted Preventive Action (Sec 107/116) Drafter",
  "Procession Volume/Crowd Forecaster",
  "Secure Intelligence/Threat Input Protector",
  "Integration with Safe City/CCTV Network",
  "Emergency Medical Services (Ambulance) Sync",
  "Election Roadshow/Rally Route Modeler",
  "Disaster (Evacuation during Procession) Coordinator",
  "Barricade/Drone/Video-graphy Budget Tracker",
  "Custom Workflow for VVIP/Protest Marches",
  "AI Driven Clash/Riot Probability Predictor",
  "Predictive Need for Rapid Action Force (RAF)",
  "Custom Alert Trigger for ADG Law & Order",
  "Application to Final Route Clearance Timeline"
];
...
const ProcessionRoutePermissionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI PROCESSION ROUTE PERMISSION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI PROCESSION ROUTE <span>PERMISSION</span></h1>
...
export default ProcessionRoutePermissionDetailed;
