...
const aiExperts = [
  "Range Command Dashboard AI",
  "District (SP) Performance/Scorecard Engine",
  "Annual/Surprise Inspection Scheduler",
  "Public Petition/Review Tracker",
  "ADG/DGP Directive Compliance Monitor",
  "Crime Review Meeting (CRM) Automator",
  "Geo-Spatial Range Crime/L&O Mapper",
  "Force Deployment/Reserve Optimizer",
  "IG Office Workflow Dashboard",
  "Voice-Command Range Query Bot",
  "Automated Monthly Range Briefing Report",
  "ADG/Zone Command Sync",
  "Petition Sentiment/Urgency Analyzer",
  "Inspection Defect/Compliance Tracker",
  "Data Manipulation by Districts Predictor",
  "CRM Minutes of Meeting (MoM) Generator",
  "AI Evaluator for Range Policing Index",
  "Audit/Inspection Log Generator",
  "Data Privacy/Petitioner Info Scrubber",
  "State Intelligence Branch Sync",
  "IG Mobile Inspection App",
  "Historical Range Crime/Riot Correlator",
  "Reader/Staff Officer Briefing AI",
  "Task/Inquiry Delegation Engine",
  "Blockchain Immutable Inspection Hash",
  "Anti-Tamper Range Record Shield",
  "Mobile App for Tour Notes/Approvals",
  "District-wise (SP) Performance Benchmarker",
  "Automated Alert for PHQ Deadlines",
  "Historical Petition Resolution Analyzer",
  "Inspection/Tour Note SOP Trainer",
  "Range Database Server Health Monitor",
  "Imminent Communal/Caste Tension Alert",
  "Non-Performing SP/Subdivision Profiler",
  "High-Priority Heinous Crime Classifier",
  "AI Assisted Show-Cause Notice Drafter",
  "Range Data Storage Forecaster",
  "Secure Inspection Report Protector",
  "Integration with CCTNS/District Portals",
  "Public Grievance Portal (CM Helpline) Sync",
  "Election Range Force Modeler",
  "Disaster Range Relief Coordinator",
  "Range Level Budget/Fund Tracker",
  "Custom Workflow for Magisterial Inquiries",
  "AI Driven Petition Surge Predictor",
  "Predictive Need for Range-Level Training",
  "Custom Alert Trigger for IG",
  "Range Petition/Inquiry Timeline Tracker"
];
...
const IGOfficeWorkflowDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI IG OFFICE WORKFLOW
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI IG OFFICE <span>WORKFLOW</span></h1>
...
export default IGOfficeWorkflowDetailed;
