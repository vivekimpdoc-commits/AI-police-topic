...
const aiExperts = [
"Police Personnel Accommodation/Barrack Allocator",
  "Food/Ration/MRE Supply Chain for Forces",
  "Election Requisitioned Vehicle Fleet GPS Sync",
  "Emergency Medical Kit/First-Aid Inventory",
  "Bus/Truck Allocation for Troop Movement AI",
  "Fuel/Diesel Reserve Depletion Modeler",
  "Drinking Water Supply Router for Forces",
  "Toilet/Sanitation Facility Tracker at Booths",
  "Command Center Election Resource Dashboard",
  "Voice-Command Resource Query Assistant",
  "Automated Re-order/Vendor Payment Alert",
  "Inter-District Resource Pooling Engine",
  "Bedding/Cot/Mosquito Net Inventory Bot",
  "Weapon/Ammunition Supply Tracker for Escorts",
  "Wireless/Walkie-Talkie Battery Status AI",
  "Winter/Rain Gear (Umbrella/Jacket) Allocator",
  "AI Evaluator for Resource Deficit/Sufficiency",
  "Audit/Procurement Log Auto-Generator",
  "Data Privacy/Vendor Financial Info Masker",
  "Police-Transport-Civil Admin Sync Bot",
  "Vehicle Breakdown/Tow-Truck GPS Router",
  "Helipad/Aviation Fuel Tanker Readiness AI",
  "Senior Officer (Admin/HQ) Briefing Bot",
  "Public Requisition Notice Drafter AI",
  "Blockchain Immutable Log of Resource Issue",
  "Asset GPS Tagging & Loss Prevention AI",
  "Mobile App for Quartermaster/Store Sync",
  "Cold-Chain/Vaccine Storage for Medical Camp",
  "Multi-Lingual/Regional Resource Naming AI",
  "Historical Election Burn-Rate Precedent",
  "Dog-Squad/K9 Veterinary Supply Tracker",
  "Resource Repair/Maintenance Due Alert",
  "Temporary Tent/Camp Setup Modeler",
  "Traffic Green-Corridor for Supply Trucks",
  "Avalanche/Flood Route Supply Diversion",
  "Armed Insurgency Zone Special Logistics AI",
  "AI Assisted Post-Election Asset Audit Gen",
  "Security Eqp (Lathi/Shield) Damage Alert",
  "VIP Security Resource Ring-Fencing AI",
  "Integration with State E-Procurement Portal",
  "Citizen Vehicle Requisition Exemption AI",
  "Extreme Weather (Heatwave/ORs) Supply Bot",
  "Return/De-requisition of Civilian Vehicles",
  "Election Budget/Logistics Expense Tracker",
  "Custom Workflow/Approval for Emergency PO",
  "AI Driven Predictive Restocking Engine",
  "Predictive Need for Specialized Transport",
  "Custom Alert Trigger for Logistics SP"
];
...
const ElectionResourceDashboardDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ELECTION RESOURCE DASHBOARD
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI ELECTION RESOURCE DASHBOARD</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in logistics for police personnel: barracks, food, vehicles & medical kits.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ELECTION RESOURCE <span>DASHBOARD</span></h1>
            <p className="cyber-subtitle">Logistics for Police Personnel: Barracks, Food, Vehicles & Medical Kits</p>
          </div>
        </div>
      </header>
...
export default ElectionResourceDashboardDetailed;
