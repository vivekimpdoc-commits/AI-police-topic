...
const aiExperts = [
  "Inquest Report NLP Extractor",
  "Post-Mortem Findings Analyzer",
  "Custodial Death Pattern Modeler",
  "Magistrate Liaison Coordination Bot",
  "Witness Statement Discrepancy Scorer",
  "Forensic/Viscera Report Tracker",
  "Medical History Correlation AI",
  "Encounter/Police Action Audit Bot",
  "Inquiry Workflow Dashboard",
  "Voice-Command Inquest Query Bot",
  "Automated Findings Summary Gen",
  "Inter-Department Medical Sync Bot",
  "Time-of-Death vs Statement Matcher",
  "Torture/Injury Mark Analysis AI",
  "Mandatory Videography Log Monitor",
  "Compliance with NHRC Guidelines AI",
  "AI Evaluator for Inquest Transparency",
  "Audit/Workflow Access Log Gen",
  "Data Privacy/Victim Info Scrubber",
  "District Magistrate Office Sync Bot",
  "Field Officer Inquest Alert App",
  "Cold Case Inquest Reference AI",
  "Senior Officer Incident Briefing",
  "Medical Expert Resource Allocator",
  "Blockchain Immutable Inquest Hash",
  "Anti-Tamper Post-Mortem Shield",
  "Mobile App for Magistrate Schedules",
  "Incident Geolocation Context Matcher",
  "Multi-Lingual Inquest Translator",
  "Historical Custodial Incident Analyzer",
  "NHRC SOP Compliance Trainer AI",
  "Workflow DB Server Health Monitor",
  "Imminent Statutory Deadline Alert",
  "Organized Crime Hit Inquest Profiler",
  "VIP Custodial Threat Classifier",
  "AI Assisted Final Report Drafter",
  "Autopsy Video Storage Forecaster",
  "Secure Whistleblower Protector",
  "Integration with Hospital Systems",
  "Victim Family Communication Tracker",
  "Public Protest/Riot Risk Modeler",
  "Disaster Casualty Inquest Coordinator",
  "Magisterial Inquiry Expense Tracker",
  "Custom Workflow for Magistrate Approval",
  "AI Driven Liability Predictor",
  "Predictive Need for Independent Autopsy",
  "Custom Alert Trigger for SP/SSP",
  "Inquest Lifecycle Timeline Tracker"
];
...
const MagisterialInquiryWorkflowDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI MAGISTERIAL INQUIRY WORKFLOW
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI MAGISTERIAL INQUIRY <span>WORKFLOW</span></h1>
...
export default MagisterialInquiryWorkflowDetailed;
