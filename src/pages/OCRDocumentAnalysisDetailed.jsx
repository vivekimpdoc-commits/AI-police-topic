...
const aiExperts = [
"Multi-Lingual Handwriting to Text OCR Engine",
  "Forged Signature/Check Modification Detector",
  "Fake Stamp/Seal Impression Analyzer AI",
  "Suicide Note/Ransom Letter Sentiment NLP",
  "Regional Dialect (Hindi/Urdu/Marathi) Translator",
  "Document Alteration/Erasure Detection Bot",
  "Ink Age/Chemical Composition Proxy Rater AI",
  "Typewriter/Printer Fingerprint Matcher",
  "Counterfeit Currency/Fake ID OCR Scanner",
  "Bank Statement/Ledger Data Extractor AI",
  "Land Registry/Property Deed Authenticator",
  "Passport/Visa Forgery Detection Engine",
  "Command Center Real-time Document Dashboard",
  "Voice-Command Document Content Query Bot",
  "Automated FIR/Case Diary Digitizer AI",
  "Cross-Referencing Names/Dates in Bulk Files",
  "Historical/British Era Cursive OCR AI",
  "Keyword/Entity (Person/Location) Extractor",
  "Plagiarism/Copy-Paste Confession Detector",
  "Torn/Shredded Document Reconstructor AI",
  "AI Evaluator for Document Admissibility",
  "Blockchain Immutable Hash of Scanned Doc",
  "Inter-Agency (Revenue/Court) Doc Sync",
  "Financial Fraud/Shell Company Invoice OCR",
  "Election Affidavit/Nomination Scrutiny AI",
  "Medical/Autopsy Report NLP Extractor",
  "Cyber-Crime IP/Log File Document Parser",
  "RTI/Legal Query Auto-Responder Linker",
  "AI Assisted Document Summary Generator",
  "Data Privacy/Redaction of Sensitive Names",
  "Mobile App Field Document Scanner Sync",
  "Senior Officer (SP/DGP) Briefing Gist Gen",
  "Watermark/Security Thread Verifier AI",
  "Faded Text/Burnt Document Enhancer Engine",
  "Extortion/Threat Letter Typographic Profiler",
  "Vendor/Tender Contract Fraud Analyzer",
  "Terror/Insurgent Propaganda Pamphlet OCR",
  "Caste/Tribe Certificate Verification Bot",
  "Integration with CCTNS/State Data Center",
  "AI Driven Batch Document Categorization",
  "Custom OCR Training for Specific Fonts",
  "Predictive Case Linkage from Document NLP",
  "Disaster/Flood Damaged Document Recovery AI",
  "Public/Citizen Complaint OCR Digitizer"
];
...
const OCRDocumentAnalysisDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI OCR & DOCUMENT ANALYSIS
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI OCR & DOCUMENT ANALYSIS</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in extracting text, translating regional languages & forged signature/stamp detection.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI OCR & DOCUMENT <span>ANALYSIS</span></h1>
            <p className="cyber-subtitle">Extracting Text, Translating Regional Languages & Forged Signature/Stamp Detection</p>
          </div>
        </div>
      </header>
...
export default OCRDocumentAnalysisDetailed;
