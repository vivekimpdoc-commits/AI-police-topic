...
const aiExperts = [
  "Automated Compliance/Chasing Engine",
  "Deadline Reminder/Escalation Bot",
  "Recurring Flaw/Pattern Analysis AI",
  "Root Cause Analysis (RCA) Generator",
  "Action Taken Report (ATR) Validation AI",
  "Inter-Departmental Dependency Mapper",
  "Geo-Spatial Deficiency Heatmapper",
  "Penalty/Adverse Entry Recommender",
  "Deficiency Tracking Dashboard",
  "Voice-Command Compliance Query Bot",
  "Automated Weekly Pending ATR Report",
  "PHQ/DGP Office Sync",
  "Fake/Superficial Compliance Predictor",
  "Chronic Defaulter/Ignored Order Alert",
  "Resource/Budget Constraint Identifier",
  "Escalation Matrix/Delay Analyzer",
  "AI Evaluator for Compliance Agility Index",
  "Audit/ATR Log Generator",
  "Data Privacy/Personnel Action Scrubber",
  "HRMS/Disciplinary Directorate Sync",
  "SHO/Unit Commander Action App",
  "Historical Non-Compliance Consequence Correlator",
  "IG (Inspection & Verification) Briefing AI",
  "Remedial Task/Budget Allocator",
  "Blockchain Immutable Compliance Hash",
  "Anti-Tamper ATR Shield",
  "Mobile App for Compliance Photo/Proof Upload",
  "District-wise Compliance Speed Benchmarker",
  "Automated Alert for Critical Unresolved Flaws",
  "Historical Cost of Delay/Negligence Analyzer",
  "Compliance/ATR Submission SOP Trainer",
  "Workflow/Ticketing System Health Monitor",
  "Imminent Systemic Failure/Crisis Alert",
  "Habitual Defaulter (Officer/Unit) Profiler",
  "High-Risk (Security/Armory) Deficiency Classifier",
  "AI Assisted Warning/Charge-Sheet Drafter",
  "Compliance Trend/Data Forecaster",
  "Secure Inspection Report Protector",
  "Integration with State Finance/Budget Portal",
  "Public Grievance/CM Helpline Sync",
  "Election Preparedness Deficiency Modeler",
  "Disaster Relief Readiness Flaw Coordinator",
  "Remedial Action/Contingency Budget Tracker",
  "Custom Workflow for Statutory/NHRC Flaws",
  "AI Driven Resolution Time Predictor",
  "Predictive Need for Policy Overhaul",
  "Custom Alert Trigger for DGP",
  "Flaw Identification to Final Resolution Timeline"
];
...
const InspectionDeficiencyTrackerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INSPECTION DEFICIENCY TRACKER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INSPECTION DEFICIENCY <span>TRACKER</span></h1>
...
export default InspectionDeficiencyTrackerDetailed;
