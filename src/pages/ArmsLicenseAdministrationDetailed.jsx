...
const aiExperts = [
  "Criminal Antecedent (CCTNS) Cross-Matcher",
  "Threat Perception/Need Assessment AI",
  "Medical/Psychological Fitness Validator",
  "Digital License/UIN Generator Bot",
  "Address/Police Verification Routing Engine",
  "Geo-Spatial License Density Mapper",
  "Ammunition Quota Allocation Calculator",
  "Fake Document/Forged Signature Detector",
  "Arms License Dashboard",
  "Voice-Command Application Query Bot",
  "Automated Monthly Arms Registration Report",
  "National Database of Arms Licenses (NDAL) Sync",
  "Concealed Criminal History Alert",
  "Political/Election Influencer Profiler",
  "Unjustified Threat Claim Analyzer",
  "Verification Delay/Pendency Estimator",
  "AI Evaluator for License Processing Index",
  "Audit/Approval Log Generator",
  "Data Privacy/Applicant Identity Scrubber",
  "State Intelligence Bureau Sync",
  "Licensing Officer/DM Mobile App",
  "Historical License Misuse/Crime Correlator",
  "District Magistrate (DM)/SP Briefing AI",
  "Field Verification Task Allocator",
  "Blockchain Immutable Approval Hash",
  "Anti-Tamper Digital License Shield",
  "Mobile App for Quick Verification Uploads",
  "District-wise Approval Time Benchmarker",
  "Automated Alert for High-Profile (VIP) Applications",
  "Historical Administrative Cost Analyzer",
  "Arms Act/Licensing SOP Trainer",
  "NDAL/ALIS API Health Monitor",
  "Imminent NDAL Portal Sync Failure Alert",
  "Habitual Gun-Culture/Display Offender Profiler",
  "Prohibited Bore/Restricted Weapon Classifier",
  "AI Assisted Final Approval/Rejection Order Drafter",
  "License Application/Renewal Volume Forecaster",
  "Secure Weapon Serial Number Protector",
  "Integration with E-District/Citizen Portal",
  "Local Intelligence Unit (LIU) Sync",
  "Election (Code of Conduct) Mass Weapon Deposit Modeler",
  "Disaster/Riot Weapon Surrender Coordinator",
  "Licensing Branch Infrastructure Budget Tracker",
  "Custom Workflow for Sports/Shooter Quotas",
  "AI Driven Application Approval/Rejection Predictor",
  "Predictive Need for Specialized Licensing Camps",
  "Custom Alert Trigger for Home Department",
  "Application Submission to Final Issuance Timeline"
];
...
const ArmsLicenseAdministrationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ARMS LICENSE ADMINISTRATION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ARMS LICENSE <span>ADMINISTRATION</span></h1>
...
export default ArmsLicenseAdministrationDetailed;
