...
const aiExperts = [
  "Property Valuation Estimator AI",
  "Automated E-Auction Catalogue Generator",
  "Bidding Fraud/Cartel Detector",
  "Court Approval Document Mapper",
  "Reserve Price Optimizer",
  "Depreciation/Obsolescence Calculator",
  "Geo-Spatial Auction Yard Mapper",
  "Public Notification/Advertisement Bot",
  "Property Auction Dashboard",
  "Voice-Command Lot Query Bot",
  "Automated Monthly Revenue Generation Report",
  "State Treasury/Finance Sync",
  "Unsold/Stagnant Lot Predictor",
  "Bidder Background Check/Risk Analyzer",
  "Under-Pricing/Corruption Flagging AI",
  "Auction Delay/Pendency Estimator",
  "AI Evaluator for Auction Transparency Index",
  "Audit/Bidding Log Generator",
  "Data Privacy/Case Detail Scrubber",
  "E-Courts Property Disposal Sync",
  "Malkhana In-Charge/Auction Officer Mobile App",
  "Historical Revenue/Bid Success Correlator",
  "SP (Administration) Briefing AI",
  "Lot Preparation/Assessment Task Allocator",
  "Blockchain Immutable Bidding/Auction Hash",
  "Anti-Tamper Auction Result Shield",
  "Mobile App for Live Auction Tracking",
  "District-wise Auction Revenue Benchmarker",
  "Automated Alert for Suspiciously Low Bids",
  "Historical Advertisement/Storage Cost Analyzer",
  "Property Disposal/Auction SOP Trainer",
  "E-Auction Portal API Health Monitor",
  "Imminent Space Exhaustion (Due to Delayed Auctions) Alert",
  "Habitual Cartel/Syndicate Bidder Profiler",
  "High-Value (Jewelry/Cash) Asset Classifier",
  "AI Assisted Final Sale Deed/Certificate Drafter",
  "Auction Revenue/Turnover Forecaster",
  "Secure Bidder Identity/Financial Protector",
  "Integration with Government e-Marketplace (GeM)",
  "State Malkhana (Evidence Room) Sync",
  "Election (Seized Liquor/Cash) Fast-Track Disposal Modeler",
  "Disaster (Abandoned Property) Auction Coordinator",
  "Property Storage/Security Budget Tracker",
  "Custom Workflow for Narcotics/Contraband Destruction",
  "AI Driven Optimal Auction Date Predictor",
  "Predictive Need for Larger Storage Yards",
  "Custom Alert Trigger for IG Legal",
  "Court Order to Final Auction Completion Timeline"
];
...
const CasePropertyAuctionManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CASE PROPERTY AUCTION MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CASE PROPERTY AUCTION <span>MANAGEMENT</span></h1>
...
export default CasePropertyAuctionManagementDetailed;
