...
const aiExperts = [
"Machine Learning (ML) Crime Forecaster AI",
  "Temporal (Time-Series) Prediction Engine",
  "Spatial-Temporal (Time & Location) Modeler",
  "Weather/Climate Impact Crime Predictor",
  "Local Festival/Event Crime Escalation AI",
  "Election Cycle Violence/Fraud Forecaster",
  "Burglary/House-Break Probability Scorer",
  "Vehicle Theft/Joyriding Trend Predictor",
  "Chain-Snatching/Street Robbery Forecaster",
  "Riot/Communal Clash Early Warning System",
  "Narcotics/Drug Supply Chain Spike Predictor",
  "Cyber Fraud/Scam Campaign Predictor AI",
  "Women/Child Abuse Under-Reporting Predictor",
  "Traffic/Accident Fatality Forecasting Bot",
  "Suicide/Mental Health Crisis Predictor",
  "Economic/Financial Offense Trend Modeler",
  "Command Center Real-Time Prediction Dash",
  "Voice-Command Future Threat Query Bot",
  "Automated Predictive Patrol Route Gen AI",
  "Resource/Manpower Allocation Optimizer",
  "Historical Accuracy/Confidence Scorer AI",
  "Predictive Algorithm Bias/Fairness Auditor",
  "Suspect Recidivism/Re-Offense Forecaster",
  "Bail-Jumper Absconding Probability AI",
  "Organized Crime Turf War Predictor Bot",
  "Gang Rivalry Escalation Forecaster AI",
  "Public Protest/Mob Violence Predictor",
  "VIP Security Threat Level Forecaster AI",
  "Interstate Smuggling Route Shift Predictor",
  "Illegal Mining/Forestry Activity Forecaster",
  "Weapon/Arms Proliferation Predictor Bot",
  "Emergency 112 Call Volume Forecaster AI",
  "Social Media Sentiment to Crime Predictor",
  "Economic Downturn/Unemployment Crime Link",
  "Infrastructure Project/Construction Crime Predictor",
  "Mass Transit (Metro/Rail) Crime Forecaster",
  "Tourist Season Crime Spike Predictor AI",
  "School/College Exam-Time Stress Crime AI",
  "Industrial Dispute/Strike Escalation Predictor",
  "Agricultural/Crop Theft Forecasting Bot",
  "AI Generated Predictive Intelligence Briefing",
  "Mobile App Predictive Alert Push for Officers",
  "Blockchain Immutable Log of AI Predictions",
  "Inter-Agency Intelligence Fusion Predictor",
  "Senior Officer (SP/DGP) Risk Radar AI",
  "AI Protocol for Pre-Emptive Raid Planning",
  "Undercover Informant Tip-Off Verifier AI",
  "Fake News/Rumor Violence Impact Predictor",
  "Predictive Bail Objection Auto-Drafter AI",
  "CCTNS Raw Data to ML Feature Extractor",
  "Custom Predictive Model Training Interface",
  "AI Driven ‘What-If’ Scenario Simulator",
  "Night/Weekend Shift Crime Anomaly Predictor",
  "Cyber-Bullying to Physical Harm Forecaster",
  "Hate Speech Virality to Action Predictor",
  "Cross-Border Terror/Insurgency Predictor",
  "AI Evaluator for Predictive Policing ROI",
  "Public Trust Impact of Predictive Policing AI",
  "Privacy-Preserving (Federated) ML Predictor",
  "Explainable AI (XAI) for Prediction Justification"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CRIME PREDICTION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI CRIME PREDICTION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in machine learning forecasts, weather/event correlations & future crime occurrences.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CRIME <span>PREDICTION</span></h1>
            <p className="cyber-subtitle">Machine Learning Forecasts, Weather/Event Correlations & Future Crime Occurrences</p>
          </div>
        </div>
      </header>
...
export default CrimePredictionDetailed;
