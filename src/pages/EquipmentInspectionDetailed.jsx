...
const aiExperts = [
  "Anti-Riot/Tear Gas Expiry & Degradation AI",
  "Body-Worn Camera (BWC) Health & Storage Auditor",
  "Breathalyzer/Speed Gun Calibration Checker",
  "Wireless Radio/Comms Battery Health Scorer",
  "Lathi/Shield/Helmet Inventory & Damage Analyzer",
  "Metal Detector/Baggage Scanner Validation Bot",
  "Geo-Spatial Equipment Distribution Mapper",
  "Forensic Kit/Evidence Collection Readiness Scorer",
  "Equipment Inspection Dashboard",
  "Voice-Command Gear Query Bot",
  "Automated Monthly Provisioning Report",
  "State Police Store/Quartermaster Sync",
  "Defective/Substandard Gear Predictor",
  "Un-synced/Offline BWC Alert",
  "Calibration Drift/Accuracy Loss Analyzer",
  "Hoarding/Uneven Distribution Detector",
  "AI Evaluator for Operational Gear Readiness",
  "Audit/Inspection Log Generator",
  "Data Privacy/BWC Video Scrubber",
  "Telecom/Wireless Department Sync",
  "Provisioning Inspector Mobile App",
  "Historical Equipment Failure/Riot Correlator",
  "DGP (Provisioning & Logistics) Briefing AI",
  "Repair/Replacement Indent Allocator",
  "Blockchain Immutable Calibration Hash",
  "Anti-Tamper BWC Log Shield",
  "Mobile App for Damaged Gear Reporting",
  "District-wise Gear Readiness Benchmarker",
  "Automated Alert for Expiring Tear Gas/Munitions",
  "Historical Procurement/Maintenance Cost Analyzer",
  "Equipment Maintenance/Handling SOP Trainer",
  "IoT/Smart-Gear Battery Health Monitor",
  "Imminent Riot (Without Adequate Gear) Alert",
  "Habitual Gear Loser/Damager Profiler",
  "High-Priority (VIP Security/ATS) Gear Classifier",
  "AI Assisted Procurement Indent Drafter",
  "Equipment Lifespan/Depreciation Forecaster",
  "Secure Armory/Store Inventory Protector",
  "Integration with GeM (Govt e-Marketplace)",
  "Forensic Science Lab (FSL) Sync",
  "Election Mass Deployment Gear Modeler",
  "Disaster Relief (Life Jacket/Rope) Readiness Coordinator",
  "Modernization/Equipment Budget Tracker",
  "Custom Workflow for Bomb Disposal Squad (BDS) Gear",
  "AI Driven Next-Year Procurement Predictor",
  "Predictive Need for Tech Upgrades",
  "Custom Alert Trigger for IG Provisioning",
  "Defect Identification to Replacement Timeline"
];
...
const EquipmentInspectionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI EQUIPMENT INSPECTION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI EQUIPMENT <span>INSPECTION</span></h1>
...
export default EquipmentInspectionDetailed;
