...
const aiExperts = [
  "Chronological Event Parser Engine AI",
  "CDR (Call Data Record) Timeline Matcher Bot",
  "Suspect Movement Path Visualizer Bot",
  "CCTV Footage Timestamp Sync Engine AI",
  "Social Media Post Chronology Linker Bot",
  "Bank Account Transaction Timeline Plotter",
  "Vehicle Toll Plaza Entry Chronologist Bot",
  "Location History Log Matcher Engine AI",
  "Timeline Builder Command Dashboard Portal",
  "Voice-Command Timeline Query Bot",
  "Automated Case Timeline Report Generator AI",
  "Cross-Agency Timeline Sharing Sync Engine",
  "Multi-Suspect Interaction Timeline Mapper AI",
  "Suspicious Transaction Timestamp Linker Bot",
  "Hotel Check-in/Check-out Chronology Analyzer",
  "Flight/Train Booking Timestamp Matcher Bot",
  "AI Evaluator for Timeline Consistency Score",
  "Audit/Timeline Modification Log Generator",
  "Data Privacy/Informant Event Masker AI",
  "Police-CCTNS Case Timeline Database Sync",
  "Investigator Timeline Sync Mobile App Portal",
  "Cold Case Crime Sequence Reconstruction Linker",
  "Senior Officer (SP Intelligence) Briefing Bot",
  "Public Missing Person Timeline Tracking Portal",
  "Blockchain Immutable Timeline Record Hasher",
  "Anti-Tamper Timestamp Audit trail Security",
  "Mobile App for Field Event Geo-Tagging",
  "Tower Dump Timeline Sequence Merger AI",
  "Multi-Lingual Incident Log Date-Time Standardizer",
  "Historical Crime Modus Operandi Chrono Matcher",
  "Staff Case Reconstruction Training Tracker AI",
  "Timeline Database Server Infrastructure Health",
  "Urgent Timeline Gap Identification Alert AI",
  "Traffic Transit Accident Chrono Reconstruction",
  "Conspiracy Event Association Network Mapper",
  "VIP Route Chronological Transit Planner Bot",
  "AI Assisted Post-Reconstruction Inquiry Draft",
  "Timeline Rendering Engine Priority Optimizer",
  "GPS Track Interpolator/Gap Filler Bot AI",
  "Integration with ICJS/CCTNS Case History",
  "Citizen Missing Last-Seen Chrono Input App",
  "Extreme Case Event Timeline Load Modeler AI",
  "Disaster Situation Event Chain Chrono Tracker",
  "Timeline Builder Tool Budget Tracker AI",
  "Custom Workflow/Approval for Timeline Release",
  "AI Driven Crime Execution Pattern Predictor",
  "Predictive Need for Additional CDR Request",
  "Custom Alert Trigger for Case IO"
];
...
const IntelligenceTimelineBuilderDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI TIMELINE BUILDER
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI TIMELINE BUILDER</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in chronological event reconstruction, suspect movement logs, activity mapping & link analysis.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI TIMELINE <span>BUILDER</span></h1>
            <p className="cyber-subtitle">Chronological Event Reconstruction, Suspect Movement Logs, Activity Mapping & Link Analysis</p>
          </div>
        </div>
      </header>
...
export default IntelligenceTimelineBuilderDetailed;
