...
const aiExperts = [
"Habitual Offender/History-Sheeter Tracker",
  "Recidivism/Re-offense Probability Scorer",
  "Bail/Parole Condition Violation Alert AI",
  "Bail-Jumper/Absconder Location Predictor",
  "Automated Bail Objection Report Drafter",
  "Prison Release/Discharge Early Warning Bot",
  "Cross-District/State Warrant Matcher AI",
  "Modus Operandi (MO) Consistency Analyzer",
  "Criminal Network/Accomplice Re-Linker Bot",
  "Social Media Activity/Threat Tracker AI",
  "Telecom/CDR (Call Record) Suspect Sync",
  "Financial/Bank Transaction Anomaly Alert",
  "Geo-Fenced Parole Boundary Enforcer AI",
  "Facial Recognition CCTV Matcher for Parolees",
  "Traffic E-Challan/Vehicle Movement Sync",
  "Family/Relative Contact Frequency Modeler",
  "Command Center Real-time Offender Dashboard",
  "Voice-Command Offender Dossier Search Bot",
  "AI Generated Offender Threat Matrix Profile",
  "Mobile App Push-Alert for Beat Patrol Officers",
  "Juvenile to Adult Offender Escalation AI",
  "Organized Crime/Mafia Don Activity Tracker",
  "Narcotics/Drug Peddler Repeat Arrest Modeler",
  "Cyber Fraudster/Scammer Recidivism AI",
  "Property Offender/Burglar Habitual Tracker",
  "Violent/Assault Offender Risk Escalation AI",
  "Sexual Offender Registry Sync & Monitor Bot",
  "Terror/UAPA Suspect Post-Release Tracker",
  "Historical Arrest vs Conviction Rate AI",
  "Court Hearing/Summons Attendance Tracker",
  "Legal Loophole/Acquittal Strategy Analyzer",
  "Officer/IO Intimidation Threat Predictor",
  "AI Protocol for Preventive Detention (NSA/Gunda Act)",
  "Inter-Agency (Prisons/Prosecution) Sync Bot",
  "Blockchain Immutable Log of Offender History",
  "Data Privacy/Human Rights Policy Enforcer",
  "Informant/Tip-Off Verification vs Offender AI",
  "Fake Identity/Alias/Aadhar Forgery Detector",
  "Asset/Property Benami Transaction Tracker",
  "Extortion/Ransom Call Voice-Print Matcher",
  "Weapon/Firearms Procurement Predictor Bot",
  "Elections/Political Rally Participation Alert",
  "Festival/Event Disruption Risk by Offenders AI",
  "Interstate Gang Affiliation Modeler AI",
  "AI Assisted Interrogation Question Drafter",
  "Senior Officer (SP/DGP) High-Risk Radar AI",
  "Media/Press Verification for Wanted List Bot",
  "Public Reward/Bounty Allocation Recommender",
  "AI Evaluator for Rehabilitation/Reformation",
  "NGO/Civil Society Rehab Program Sync",
  "Psychological/Behavioral Profile Extractor",
  "Custom Alert Trigger Definition Tool AI",
  "CCTNS Database Real-time Bulk Cross-Check",
  "Missing Person Linkage to Sex Offenders AI",
  "Night Patrol/Beat Book Offender Check Sync",
  "AI Driven Heatmap of Offender Residences"
];
...
const RepeatOffenderAnalysisDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI REPEAT OFFENDER ANALYSIS
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI REPEAT OFFENDER ANALYSIS</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in recidivism rates, bail tracking of habitual offenders & parole conditions.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI REPEAT OFFENDER <span>ANALYSIS</span></h1>
            <p className="cyber-subtitle">Recidivism Rates, Bail Tracking of Habitual Offenders & Parole Conditions</p>
          </div>
        </div>
      </header>
...
export default RepeatOffenderAnalysisDetailed;
