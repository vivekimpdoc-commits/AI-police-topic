...
const aiExperts = [
  "Open Source Intel (OSINT) Correlator",
  "Historical Precedent Matcher AI",
  "Fact-Checking Database Connector",
  "Deepfake/Manipulated Media Detector",
  "Cross-Department Report Verifier",
  "Witness Testimony Consistency Scorer",
  "Alibi Verification Logic Engine",
  "Social Media Rumor Debunker Bot",
  "Verification Status Dashboard",
  "Voice-Command Verification Query Bot",
  "Automated Corroboration Report Gen",
  "Inter-State Verification Hub Sync",
  "Geo-Spatial Claim Validator AI",
  "Digital Footprint Authenticator",
  "Information Paradox Detector Bot",
  "Document Forgery Identifier AI",
  "AI Evaluator for Final Intel Grade",
  "Audit/Verification Trail Log Gen",
  "Data Privacy/Sensitive Flag Engine",
  "National Crime Record Bureau Sync",
  "Field Verification Tasker App",
  "Cold Case Evidence Re-verifier AI",
  "Senior Investigating Officer Briefing",
  "Public Record Scraping/Validator Bot",
  "Blockchain Immutable Verification Hash",
  "Anti-Tamper Evidence Shield AI",
  "Mobile App for Field Verification",
  "Cell Tower vs Alibi Geolocation Matcher",
  "Multi-Lingual Document Translator",
  "Historical Verification Accuracy Analyzer",
  "Investigation SOP Compliance Trainer",
  "Verification API Server Monitor",
  "Urgent Threat Verification Expediter",
  "Organized Crime Claim Profiler",
  "VIP Threat Verification Classifier",
  "AI Assisted Verification Plan Draft",
  "Verification Data Storage Forecaster",
  "Secure Witness Statement Authenticator",
  "Integration with Telecom Call Records",
  "Citizen Tip Verification Portal",
  "Mass Hysteria/Rumor Spike Modeler",
  "Disaster Claim Verification Coordinator",
  "Verification Ops Resource Tracker",
  "Custom Workflow for Verification Approvals",
  "AI Driven Deception Pattern Predictor",
  "Predictive Need for Physical Raid",
  "Custom Alert Trigger for Verification Lead",
  "Verification Timeline Tracker AI"
];
...
const IntelligenceVerificationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INTELLIGENCE VERIFICATION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INTELLIGENCE <span>VERIFICATION</span></h1>
...
export default IntelligenceVerificationDetailed;
