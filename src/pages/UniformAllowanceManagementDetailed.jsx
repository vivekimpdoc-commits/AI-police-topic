...
const aiExperts = [
  "Annual Allowance Disbursal Automator",
  "Kit/Equipment Issuance Tracker AI",
  "Uniform Wear-and-Tear/Lifespan Predictor",
  "Vendor Quality/Fabric Audit Bot",
  "Rank-wise Entitlement/Matrix AI",
  "Inventory/Stock Depletion Forecaster",
  "Geo-Spatial Store/Armory Mapper",
  "Duplicate Claim/Re-issue Detector",
  "Uniform Allowance Dashboard",
  "Voice-Command Inventory Query Bot",
  "Automated Quarterly Disbursal Report",
  "State Quartermaster/Store Sync",
  "Substandard Material/Stitching Predictor",
  "Winter/Summer Gear Switch Analyzer",
  "Fake Vendor/Billing Fraud Identifier",
  "Size/Measurement Distribution Optimizer",
  "AI Evaluator for Turnout/Appearance Index",
  "Audit/Issuance Log Generator",
  "Data Privacy/Personnel Record Scrubber",
  "Finance/Accounts Department Sync",
  "Officer Indent/Request Mobile App",
  "Historical Vendor Performance Correlator",
  "IG Provisioning Briefing AI",
  "Store Keeper Task Allocator",
  "Blockchain Immutable Issuance Hash",
  "Anti-Tamper Inventory Shield",
  "Mobile App for Digital Acknowledgment",
  "District-wise Kit Readiness Benchmarker",
  "Automated Reminder for Annual Renewal",
  "Historical Procurement Cost Analyzer",
  "Provisioning/Store SOP Trainer",
  "Inventory DB Server Health Monitor",
  "Imminent Stock-Out (Riot Gear) Alert",
  "Corrupt Quartermaster/Vendor Profiler",
  "High-Priority (Commando/ATS) Gear Classifier",
  "AI Assisted E-Tender Drafter",
  "Inventory Data Storage Forecaster",
  "Secure Tender/Pricing Protector",
  "Integration with CSD/Police Canteen",
  "Welfare Portal Sync",
  "Election Special Duty Kit Modeler",
  "Disaster High-Vis Gear Coordinator",
  "Uniform/Equipment Budget Tracker",
  "Custom Workflow for Condemnation/Scrap",
  "AI Driven Procurement Delay Predictor",
  "Predictive Need for Bulk Tender",
  "Custom Alert Trigger for DGP Provisioning",
  "Equipment Lifespan Timeline Tracker"
];
...
const UniformAllowanceManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI UNIFORM ALLOWANCE MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI UNIFORM ALLOWANCE <span>MANAGEMENT</span></h1>
...
export default UniformAllowanceManagementDetailed;
