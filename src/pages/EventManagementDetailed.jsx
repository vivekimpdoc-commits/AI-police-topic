...
const aiExperts = [
  "Event NOC/Permit Workflow Assistant AI",
  "Crowd Density Risk Predictor Engine",
  "Traffic Diversion Router Bot",
  "Social Media Hype Sentiment Analyzer",
  "Fire/Safety Compliance Checker",
  "Emergency Medical Route Optimizer",
  "Resource (Force/Barricade) Allocator",
  "VIP/VVIP Threat Matrix Modeler",
  "Event Command Dashboard",
  "Voice-Command Permit Query Bot",
  "Automated Daily Security Brief",
  "Inter-Department (Civic/Medical) Sync Bot",
  "Geo-Spatial Venue Map Overlay AI",
  "CCTV/Drone Blind-Spot Analyzer",
  "Ticket Scalping/Fraud Detector",
  "Historical Event Precedent Matcher",
  "AI Evaluator for Event Approval",
  "Audit/Approval Access Log Generator",
  "Data Privacy/Organizer Detail Scrubber",
  "Traffic Police Sync Bot",
  "Field Officer Venue Checklist App",
  "Cold Case Stampede Incident Correlator",
  "DGP/CP Level Event Briefing AI",
  "Ticketing/Pass Authorization Allocator",
  "Blockchain Immutable NOC Hash",
  "Anti-Tamper Permit Shield AI",
  "Mobile App for Organizers",
  "Protest/Flash-Mob Geolocation Matcher",
  "Multi-Lingual Guideline Translator",
  "Historical Event Safety Analyzer",
  "Event Security SOP Trainer AI",
  "Event DB Server Health Monitor",
  "Imminent Overcrowding Alert Bot",
  "Organized Crime Extortion Profiler",
  "High-Risk Political Rally Classifier",
  "AI Assisted Deployment Drafter",
  "Venue Layout Storage Forecaster",
  "Secure Whistleblower Threat Protector",
  "Integration with Fire/Health Depts",
  "Citizen Event Feedback Analytics",
  "Communal Tension Flashpoint Modeler",
  "Disaster Evacuation Coordinator",
  "Event Security Billing/Expense Tracker",
  "Custom Workflow for Multi-District Events",
  "AI Driven Incident Probability Predictor",
  "Predictive Need for Rapid Action Force",
  "Custom Alert Trigger for Nodal Officers",
  "Event Lifecycle & Post-Mortem Tracker"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI EVENT MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI EVENT <span>MANAGEMENT</span></h1>
...
export default EventManagementDetailed;
