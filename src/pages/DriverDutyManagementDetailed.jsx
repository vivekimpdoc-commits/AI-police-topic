...
const aiExperts = [
  "Driver Shift/Roster Auto-Scheduler AI",
  "Fatigue Detection via Dashcam/Wearable Bot",
  "Driving License Validity Checker Engine",
  "Rash Driving/Speeding Alert System AI",
  "Drunk Driving Detection Breathalyzer Sync",
  "Driver Performance Scorecard Generator",
  "Night Duty/Long Shift Alert Enforcer Bot",
  "Inter-Station Driver Deputation Tracker",
  "Driver Duty Command Dashboard",
  "Voice-Command Driver Query Assistant",
  "Automated Driver Attendance Logger AI",
  "Cross-Fleet Driver Availability Comparator",
  "Mobile Phone Usage While Driving Detector",
  "Seat Belt/Safety Compliance Monitor AI",
  "Route Deviation/Unauthorized Stop Alert",
  "Driver Training/Refresher Scheduler Bot",
  "AI Evaluator for Driver Safety Score",
  "Audit/Traffic Violation Log Auto-Generator",
  "Data Privacy/Driver Biometric Masker AI",
  "Police-RTO License Verification Sync Bot",
  "Patrol Car Driver Rotation Optimizer AI",
  "VIP Escort Driver Selection Algorithm",
  "Senior Officer (Admin SP) Briefing Bot",
  "Public Complaint (Rash Driving) Router AI",
  "Blockchain Immutable Driving Log Hasher",
  "Anti-Sleep Device (Mobileye) Integration",
  "Mobile App for Driver Check-in/Selfie Sync",
  "GPS Speed Governor Compliance Checker",
  "Multi-Lingual Driver Instruction Bot",
  "Historical Accident Prone Driver Matcher",
  "Staff Driver Leave/Availability Tracker",
  "Driver Health/Medical Fitness Scheduler",
  "Temporary Naka Driver Assignment Bot",
  "Traffic Duty Driver Allocation Engine",
  "Accident Response Driver Priority AI",
  "VIP Motorcade Driver Skill Assessor Bot",
  "AI Assisted Post-Incident Driver Review",
  "Overtime/Extra Duty Compensation Tracker",
  "Eco-Driving Habit Improvement Coach AI",
  "Integration with Sarathi DL Portal",
  "Citizen Driver Behavior Complaint Router",
  "Extreme Weather Driving Safety Advisor",
  "Disaster Convoy Driver Deployment AI",
  "Driver Welfare/Expense Tracker AI",
  "Custom Workflow/Approval for Duty Change",
  "AI Driven Accident Risk Predictor",
  "Predictive Need for Driver Recruitment",
  "Custom Alert Trigger for Transport Officer"
];
...
const DriverDutyManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DRIVER DUTY MANAGEMENT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI DRIVER DUTY MANAGEMENT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in shift scheduling, fatigue monitoring, license tracking & performance analytics.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DRIVER DUTY <span>MANAGEMENT</span></h1>
            <p className="cyber-subtitle">Shift Scheduling, Fatigue Monitoring, License Tracking & Performance Analytics</p>
          </div>
        </div>
      </header>
...
export default DriverDutyManagementDetailed;
