...
const aiExperts = [
  "Conference Room/Resource Optimizer AI",
  "Outlook/Google Calendar Sync Engine",
  "Automated Agenda/MoM (Minutes of Meeting) Generator",
  "Video Conference (NIC/Zoom) Link Automator",
  "Participant Conflict/Availability Resolver",
  "Audio-to-Text Transcription Bot",
  "Geo-Spatial PHQ Meeting Room Mapper",
  "Action Item/Task Extractor AI",
  "Meeting Scheduler Dashboard",
  "Voice-Command Booking Bot",
  "Automated Weekly Meeting Productivity Report",
  "IT/Network Department Sync",
  "Multi-Lingual Transcription Engine",
  "Off-Topic/Time-Wastage Analyzer",
  "Double-Booking/Clash Predictor",
  "Meeting Summary/Abstract Generator",
  "AI Evaluator for Meeting Efficiency",
  "Audit/Booking Log Generator",
  "Data Privacy/Classified Discussion Scrubber",
  "DGP/ADG Secretariat Sync",
  "Officer Calendar Mobile App",
  "Historical Delay in ATR (Action Taken) Correlator",
  "Staff Officer Briefing AI",
  "Catering/IT Support Task Allocator",
  "Blockchain Immutable MoM Hash",
  "Anti-Tamper Meeting Record Shield",
  "Mobile App for Quick RSVP",
  "Branch-wise Meeting Frequency Benchmarker",
  "Automated Reminder for Action Items",
  "Historical Meeting Cost (Time) Analyzer",
  "Conference Protocol SOP Trainer",
  "VC Equipment/Network Health Monitor",
  "Imminent Schedule Clash (CM/DGP) Alert",
  "Habitual Latecomer/Absentee Profiler",
  "Top-Secret/Intelligence Briefing Classifier",
  "AI Assisted Rescheduling Notice Drafter",
  "Video/Audio Recording Storage Forecaster",
  "Secure Classified MoM Protector",
  "Integration with E-Office (for file approval)",
  "External Agency (MHA/CBI) VC Sync",
  "Election Video Conference Marathon Modeler",
  "Disaster Emergency Command Meeting Coordinator",
  "Catering/IT Maintenance Budget Tracker",
  "Custom Workflow for Media Briefings",
  "AI Driven Meeting Duration Predictor",
  "Predictive Need for VC Bandwidth Upgrade",
  "Custom Alert Trigger for Nodal Officer",
  "Meeting Agenda to ATR Timeline Tracker"
];
...
const HeadquartersMeetingSchedulerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI HEADQUARTERS MEETING SCHEDULER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI HEADQUARTERS MEETING <span>SCHEDULER</span></h1>
...
export default HeadquartersMeetingSchedulerDetailed;
