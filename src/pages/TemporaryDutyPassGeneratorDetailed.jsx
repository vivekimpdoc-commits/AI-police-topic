...
const aiExperts = [
  "Contractor/Labor Background Vetting AI",
  "Automated Pass Expiry/Revocation Engine",
  "Geo-Fenced/Zone-Restricted Access Linker",
  "Rapid Mass Issuance/Batch Processor Bot",
  "Work Order/Tender Validity Sync AI",
  "Biometric/Face-Match Verification AI",
  "Geo-Spatial Labor Movement Mapper",
  "Duplicate/Fake Pass Detector",
  "Temporary Duty Pass Dashboard",
  "Voice-Command Contractor Query Bot",
  "Automated Weekly Vendor Access Report",
  "Estate/PWD Department Sync",
  "Overstay/After-Hours Presence Alert",
  "Criminal Record/Watchlist Match Alert",
  "Pass Sharing/Handover Predictor",
  "Contractor Labor Turnover Analyzer",
  "AI Evaluator for Contractor Security Index",
  "Audit/Pass Issuance Log Generator",
  "Data Privacy/Labor Identity Scrubber",
  "Security/Sentry Branch Sync",
  "Gate Sentry Verification Mobile App",
  "Historical Labor-Related Incident Correlator",
  "SP (Estate/Admin) Briefing AI",
  "Security Escort Task Allocator",
  "Blockchain Immutable Pass Hash",
  "Anti-Tamper Temporary Pass Shield",
  "Mobile App for Contractor Indent Request",
  "Batch Processing Speed Benchmarker",
  "Automated Reminder for Pass Renewal",
  "Historical Pass Printing/Card Cost Analyzer",
  "Contractor Security/Access SOP Trainer",
  "Access Gateway Health Monitor",
  "Imminent Sabotage/Theft Risk Alert",
  "Blacklisted Contractor/Labor Profiler",
  "High-Security Zone (Armory) Labor Classifier",
  "AI Assisted Vendor Penalty Notice Drafter",
  "Pass Image/Data Storage Forecaster",
  "Secure Facility Blueprint Protector",
  "Integration with E-Tendering/Procurement",
  "Labor Welfare/Wage Compliance Sync",
  "Election Polling Staff Temporary Pass Modeler",
  "Disaster Relief Worker Pass Coordinator",
  "Card Printing/Consumables Budget Tracker",
  "Custom Workflow for Emergency Repair Access",
  "AI Driven Labor Requirement Predictor",
  "Predictive Need for Extra Sentry Checks",
  "Custom Alert Trigger for Chief Security Officer",
  "Pass Request to Automated Expiry Timeline"
];
...
const TemporaryDutyPassGeneratorDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI TEMPORARY DUTY PASS GENERATOR
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI TEMPORARY DUTY PASS <span>GENERATOR</span></h1>
...
export default TemporaryDutyPassGeneratorDetailed;
