...
const aiExperts = [
"Multi-Agency Data Integration Engine AI",
  "CBI/Central Bureau Intel Synchronization Bot",
  "NIA/Anti-Terror Threat Relay Analyzer",
  "State Intelligence Bureau (SIB) Data Fusion",
  "Real-Time Threat Level/Alert Scorer AI",
  "Cross-Border/Interpol Red-Notice Matcher",
  "Financial Intelligence Unit (FIU) Sync Bot",
  "Narcotics Control Bureau (NCB) Linker AI",
  "Military/Border Security (BSF) Intel Sync",
  "Customs/Immigration/Airport Intel Fusion",
  "Cyber/CERT-In Vulnerability Threat Router",
  "Election Commission Intel Synchronization AI",
  "Command Center Real-Time Fusion Dashboard",
  "Voice-Command Cross-Agency Query Assistant",
  "Automated De-duplication of Intel Reports",
  "NLP Entity Extractor from Raw Intel AI",
  "Predictive Threat/Attack Forecaster Bot",
  "Geospatial/GIS Multi-Agency Threat Mapper",
  "Terror/Sleeper Cell Activation Alert AI",
  "Organized Crime Syndicate Cross-Match Bot",
  "VIP/VVIP Security Threat Matrix AI",
  "Mass-Casualty/Disaster Intel Warning Bot",
  "Communal/Riot Provocation Multi-Source AI",
  "Cyber Attack/Critical Infra Threat Predictor",
  "AI Generated Joint Task Force Action Plan",
  "Mobile App Secure Push-Alert for Task Force",
  "Blockchain Immutable Log of Intel Sharing",
  "Zero-Trust Encrypted Access Control AI",
  "Officer Clearance Level (Top Secret) Matcher",
  "AI Protocol for Source Anonymization (DLP)",
  "Inter-Agency Friction/Communication Gap Alert",
  "Historical Intel Accuracy/ROI Scorer AI",
  "Senior Officer (DGP/Home Sec) Briefing Bot",
  "Media/Press Propaganda Counter-Intel AI",
  "Undercover/Informant Network Protection Bot",
  "Fake News/Rumor Verification via Fusion AI",
  "Telecom/CDR Master Node Analysis Bot",
  "Financial/Hawala Master Ledger Sync AI",
  "Weapon/Explosive Procurement Alert Sync",
  "Human Trafficking/Smuggling Route Fusion",
  "AI Assisted Subpoena/Legal Document Gen",
  "Joint-Interrogation Strategy Recommender AI",
  "Predictive Deployment for Joint Raids Bot",
  "Custom Alert/Trigger Definition Interface AI",
  "Suspicious Person/Alias Multi-DB Matcher",
  "Stolen Vehicle/Asset National Registry Sync",
  "Missing Person National/Global Linker Bot",
  "Prison/Jail Radicalization Intel Fusion AI",
  "Election Funding/Hawala Multi-Agency Sync",
  "Industrial/Corporate Espionage Intel AI",
  "Wildlife/Poaching National Network Sync",
  "NGO/FCRA Violation Multi-Agency Matcher",
  "AI Driven 'Need-to-Know' Dissemination Bot",
  "Post-Incident Intel Autopsy/Failure Analyzer",
  "AI Evaluator for Multi-Agency Cooperation",
  "Dynamic Standard Operating Procedure (SOP) Gen"
];
...
const IntelligenceFusionCenterDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI INTELLIGENCE FUSION CENTER
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI INTELLIGENCE FUSION CENTER</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in integrating data from cbi, nia, state intel & real-time threat sharing.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI INTELLIGENCE <span>FUSION CENTER</span></h1>
            <p className="cyber-subtitle">Integrating Data from CBI, NIA, State Intel & Real-Time Threat Sharing</p>
          </div>
        </div>
      </header>
...
export default IntelligenceFusionCenterDetailed;
