...
const aiExperts = [
"Relief Camp Capacity vs Influx Modeler",
  "Missing Person/Family Reunification AI",
  "Food Quality/Poisoning Early Warning Bot",
  "Sanitation/Mobile Toilet Usage Tracker AI",
  "Tent/Bedding Allotment & Tracking System",
  "Epidemic/Cholera Outbreak Heatmap Bot",
  "Drinking Water Supply Burn-Rate AI",
  "Women & Children Safety Zone Enforcer",
  "Command Center Relief Camp Dashboard",
  "Voice-Command Camp Query Assistant",
  "Automated Daily Ration Requirement Gen",
  "Camp Lighting/Generator Fuel Tracker",
  "Evacuee Registration (Aadhar) Sync Bot",
  "Medical/Triage Booth Footfall Analyzer AI",
  "Waste Management/Disposal Router AI",
  "Camp Disbandment/Returnee Escort AI",
  "AI Evaluator for Camp Hygiene Standards",
  "Audit/Complaint Log Auto-Generator",
  "Data Privacy/Evacuee Info Masking AI",
  "Inter-Agency (NGO/Govt) Duty Sync Bot",
  "Infant/Baby Food & Diaper Inventory AI",
  "Psychological Trauma/Counselor Routing",
  "Senior Officer (Camp Commander) Briefing",
  "Public Announcement/PA System Drafter",
  "Blockchain Immutable Log of Relief Dist",
  "Camp Boundary/Perimeter Security AI",
  "Mobile App for Camp Volunteer Sync",
  "Weather/Rain Protection Modeler for Tents",
  "Multi-Lingual Evacuee Communication Bot",
  "Historical Camp Management Precedent",
  "Stray Animal/Pet Shelter Section Router",
  "Camp Staff Fatigue/Rotation Monitor AI",
  "Temporary Checkpost/Entry Log Tracking",
  "Traffic/Parking Management for Relief Trucks",
  "Flood/Storm Re-Evacuation Early Warning",
  "Gender-Segregated Facilities Tracker AI",
  "AI Assisted Post-Camp Closure Audit",
  "Security Eqp (Lathi/Torch) Inventory AI",
  "Media/Press Briefing Data Extractor Bot",
  "Integration with State Relief Portal",
  "Citizen/Evacuee Grievance Router AI",
  "Heatwave/Cooling Center Temp Modeler",
  "VIP Visit Protocol/Crowd Control AI",
  "Relief Camp Expense/Budget Tracker",
  "Custom Workflow/Approval for External Entry",
  "AI Driven Camp De-escalation Predictor",
  "Predictive Need for Specialized Doctors",
...
const ReliefCampManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI RELIEF CAMP MANAGEMENT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI RELIEF CAMP MANAGEMENT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in camp capacity, sanitation/hygiene tracking, food checks & family reunification.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI RELIEF CAMP <span>MANAGEMENT</span></h1>
            <p className="cyber-subtitle">Camp Capacity, Sanitation/Hygiene Tracking, Food Checks & Family Reunification</p>
          </div>
        </div>
      </header>
...
export default ReliefCampManagementDetailed;
