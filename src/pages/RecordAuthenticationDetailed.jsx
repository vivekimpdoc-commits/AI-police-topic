...
const aiExperts = [
"e-FIR Blockchain Immutable Hashing AI",
  "Digital Signature (DSC/e-Sign) Integration Bot",
  "Retroactive Date-Tampering Alert Engine",
  "Charge-sheet Page-by-Page Hashing AI",
  "Seizure Memo/Panchnama Authentication Bot",
  "Malkhana Entry Cryptographic Timestamp AI",
  "Arrest Memo/Lockup Register Tamper Alert",
  "Witness Statement (161 CrPC) Voice Hash",
  "Command Center Authentication Dashboard",
  "Voice-Command Record Validity Query Bot",
  "Automated Hash Verification Certificate Gen",
  "Inter-Agency (Court/FSL) Hash Sync Engine",
  "Document Alteration/Photoshop Detector",
  "PDF Metadata Tampering Alert AI",
  "Biometric (Thumbprint) Authentication Sync",
  "Old Record/Scan Integrity Verifier Bot",
  "AI Evaluator for Station Record Integrity",
  "Audit/Tamper Attempt Log Generator",
  "Data Privacy/Encrypted Storage Keys AI",
  "Police-Prosecution Hash Verification Linker",
  "Digital Station Diary (e-GD) Lock Bot",
  "Arms/Ammunition Issue Hash Verifier",
  "Senior Officer (SP/DGP) Integrity Briefing",
  "Public RTI Document Authentication QR Gen",
  "Smart Contract for Evidence Custody Transfer",
  "Bodycam/CCTV Video Frame Hashing AI",
  "Mobile App for IO Field E-Sign Sync",
  "Gun License/Permit QR Code Verifier",
  "Multi-Lingual e-Sign Instruction Bot",
  "Historical Record Forgery Pattern Matcher",
  "Departmental Enquiry Evidence Authentication",
  "Authentication Server/Node Health Monitor",
  "Temporary Naka Register Hash Sync",
  "Traffic E-Challan Image Tamper Alert",
  "Accident/Injury Report Authentication Bot",
  "Post-Mortem/Medical Report Hash Verifier",
  "AI Assisted Post-Forgery Analysis Gen",
  "Expired/Revoked DSC Token Alert Bot",
  "VIP Security Threat Intel Hash Sync AI",
  "Integration with National E-Pramaan/DigiLocker",
  "Citizen E-FIR Authentication Validator",
  "Foreigner Visa/C-Form Hash Sync Bot",
  "Election Observer Report Authentication",
  "Authentication Server Cost/License Tracker",
  "Custom Workflow/Approval for Hash Override",
  "AI Driven Internal Sabotage Predictor",
  "Predictive Need for Certificate Renewal",
  "Custom Alert Trigger for Cyber/IT Cell"
];
...
const RecordAuthenticationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI RECORD AUTHENTICATION
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI RECORD AUTHENTICATION</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in digital signatures (e-sign), blockchain hashing & tamper-proof firs.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI RECORD <span>AUTHENTICATION</span></h1>
            <p className="cyber-subtitle">Digital Signatures (e-Sign), Blockchain Hashing & Tamper-Proof FIRs</p>
          </div>
        </div>
      </header>
...
export default RecordAuthenticationDetailed;
