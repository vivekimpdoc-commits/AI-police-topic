...
const aiExperts = [
  "Diesel Level/Fuel Pilferage Detection AI",
  "Automated Run-Hour/Logbook Engine",
  "Grid-Outage vs DG Run-Time Sync Bot",
  "Engine Health/Vibration Diagnostic AI",
  "Lube Oil/Filter Degradation Predictor",
  "Emissions/Smoke Anomaly Analyzer",
  "Geo-Spatial DG Set Location Mapper",
  "Fuel Efficiency (KWH/Liter) Optimizer",
  "Generator Fleet Dashboard",
  "Voice-Command DG Status Bot",
  "Automated Weekly Fuel/Run Report",
  "State DISCOM/Grid Sync",
  "Unauthorized Siphoning/Sudden Drop Alert",
  "Battery/Self-Starter Failure Predictor",
  "Fake Run-Hour Entry Detector",
  "Optimum Load Matching Analyzer",
  "AI Evaluator for Power Backup Reliability",
  "Audit/Refueling Log Generator",
  "Data Privacy/Station Roster Scrubber",
  "Finance/Audit Department Sync",
  "DG Operator/Mechanic Mobile App",
  "Historical Summer Power Cut Correlator",
  "Reserve Inspector/Quartermaster Briefing AI",
  "Servicing/Refueling Task Allocator",
  "Blockchain Immutable Refuel Hash",
  "Anti-Tamper DG Controller Shield",
  "Mobile App for QR-Based Refuel Entry",
  "DG-wise Fuel Efficiency Benchmarker",
  "Automated Alert for Low Fuel (Critical)",
  "Historical Diesel Expenditure Analyzer",
  "Generator Operation/Safety SOP Trainer",
  "IoT Fuel/Vibration Sensor Health Monitor",
  "Imminent Engine Seizure Alert",
  "Habitual Fuel Pilferer (Staff) Profiler",
  "High-Capacity (Headquarters) DG Classifier",
  "AI Assisted Maintenance Contract Drafter",
  "Telemetry/Run-Hour Storage Forecaster",
  "Secure Fuel Indent Protector",
  "Integration with Petrol Pump/Vendor API",
  "Pollution Control Board Compliance Sync",
  "Election 24x7 Uninterrupted Power Modeler",
  "Disaster Relief Mobile DG Coordinator",
  "Diesel/Maintenance Budget Tracker",
  "Custom Workflow for Emergency Diesel Requisition",
  "AI Driven Monthly Fuel Indent Predictor",
  "Predictive Need for DG Overhaul/Replacement",
  "Custom Alert Trigger for SP Admin",
  "Grid Failure to DG Start Response Timeline"
];
...
const GeneratorMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI GENERATOR MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI GENERATOR <span>MONITORING</span></h1>
...
export default GeneratorMonitoringDetailed;
