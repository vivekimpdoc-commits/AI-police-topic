...
const aiExperts = [
  "VR/AR Tactical Simulation Engine",
  "Cadet Performance & Fatigue Scorer",
  "Curriculum Personalization AI",
  "Weapons Handling Skill Analyzer",
  "Physical Fitness Tracking Correlator",
  "Legal/IPC Exam Evaluator Bot",
  "Stress Tolerance & Psychology Modeler",
  "Interrogation Technique Simulation AI",
  "Training Academy Dashboard",
  "Voice-Command Cadet Query Bot",
  "Automated Batch Progress Report",
  "Instructor Workload Balancer Bot",
  "Predictive Dropout Risk Analyzer AI",
  "Scenario-Based Decision Scoring",
  "Crowd Control Simulation Engine",
  "First Responder First-Aid Trainer",
  "AI Evaluator for Graduation Readiness",
  "Audit/Training Completion Log Gen",
  "Data Privacy/Cadet Health Scrubber",
  "State Police HQ Talent Sync",
  "Cadet Daily Routine Management App",
  "Refresher Course Recommender AI",
  "Academy Director Briefing AI",
  "Training Facility Resource Allocator",
  "Blockchain Immutable Certification Hash",
  "Anti-Tamper Exam Result Shield",
  "Mobile App for Cadet E-Learning",
  "Geo-Spatial Simulation Environment Matcher",
  "Multi-Lingual Exam Question Translator",
  "Historical Training Success Analyzer",
  "Instructor SOP Compliance Trainer",
  "Training DB Server Health Monitor",
  "Urgent Field Deployment Alert Bot",
  "Organized Crime Simulation Profiler",
  "VIP Protection Detail Training Classifier",
  "AI Assisted Curriculum Update Drafter",
  "Training Data Storage Forecaster",
  "Secure Instructor Evaluation Protector",
  "Integration with National Police Mission",
  "Citizen/Community Engagement Simulator",
  "Riot/Mob Violence Tactical Modeler",
  "Disaster Rescue Drill Coordinator",
  "Academy Operations Budget Tracker",
  "Custom Workflow for Certification Approval",
  "AI Driven Officer Career Path Predictor",
  "Predictive Need for New Facilities",
  "Custom Alert Trigger for Chief Instructors",
  "Cadet Lifecycle & Deployment Tracker"
];
...
const PoliceTrainingAcademyDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI POLICE TRAINING ACADEMY
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI POLICE TRAINING <span>ACADEMY</span></h1>
...
export default PoliceTrainingAcademyDetailed;
