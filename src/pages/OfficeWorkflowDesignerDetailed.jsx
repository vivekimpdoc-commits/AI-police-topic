...
const aiExperts = [
  "Drag-and-Drop Process Mapping AI",
  "Approval Matrix/Hierarchy Automator",
  "Workflow Bottleneck/Delay Simulator",
  "Rule-based Conditional Routing Engine",
  "Redundant Step/Duplicate Form Detector",
  "Time-and-Motion Study Analyzer",
  "Geo-Spatial Workflow Node Mapper",
  "Parallel Processing/Task Splitter AI",
  "Workflow Designer Dashboard",
  "Voice-Command Process Query Bot",
  "Automated Workflow Efficiency Report",
  "E-Office/IT Department Sync",
  "Form/Data Field Suggestion Bot",
  "Infinite Loop/Deadlock Predictor",
  "Unauthorized Bypass/Override Detector",
  "SOP to Workflow Auto-Converter",
  "AI Evaluator for Process Optimization",
  "Audit/Workflow Change Log Gen",
  "Data Privacy/Access Control Scrubber",
  "State Administrative Reform Dept Sync",
  "Officer Workflow Testing Mobile App",
  "Historical Process Failure Correlator",
  "DGP/IG Administration Briefing AI",
  "Process Implementation Task Allocator",
  "Blockchain Immutable Process Hash",
  "Anti-Tamper Rule Engine Shield",
  "Mobile App for Workflow Approvals",
  "Inter-Department Process Benchmarker",
  "Automated Suggestion for Optimization",
  "Historical Turnaround Time Analyzer",
  "Business Process Re-engineering Trainer",
  "Workflow Server Health Monitor",
  "Imminent Process Deadlock Alert",
  "Chronic Delaying Desk/Node Profiler",
  "High-Priority/VIP Process Classifier",
  "AI Assisted SOP Revision Drafter",
  "Workflow Metadata Storage Forecaster",
  "Secure Approval Matrix Protector",
  "Integration with HRMS/Finance Portals",
  "Citizen Service Guarantee (RTS) Sync",
  "Election Fast-Track Process Modeler",
  "Disaster Emergency Procurement Workflow Coordinator",
  "Process Automation Software Budget Tracker",
  "Custom Workflow for Ad-hoc Approvals",
  "AI Driven Process Completion Time Predictor",
  "Predictive Need for Policy Change",
  "Custom Alert Trigger for Chief Secretary",
  "Workflow Evolution Timeline Tracker"
];
...
const OfficeWorkflowDesignerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI OFFICE WORKFLOW DESIGNER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI OFFICE WORKFLOW <span>DESIGNER</span></h1>
...
export default OfficeWorkflowDesignerDetailed;
