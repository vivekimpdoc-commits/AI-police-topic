...
const aiExperts = [
  "Automated Access Recertification/Review Engine",
  "Separation of Duties (SoD) Conflict Detector",
  "Orphaned/Dormant Account Identifier",
  "Role-Based Access Control (RBAC) Mapper",
  "Over-Privilege/Creep Detection AI",
  "Transfer/Promotion Privilege Adjuster",
  "Geo-Spatial Physical Access Reviewer",
  "Entitlement/License Cost Optimizer",
  "Privilege Review Dashboard",
  "Voice-Command Entitlement Query Bot",
  "Automated Quarterly Recertification Report",
  "HRMS/Personnel Department Sync",
  "Unauthorized Escalation of Privilege Predictor",
  "Peer-Group Outlier (Excess Access) Analyzer",
  "Toxic Combination (Maker-Checker) Alert",
  "Temporary Access Expiry Enforcer",
  "AI Evaluator for Least Privilege Compliance",
  "Audit/Recertification Log Generator",
  "Data Privacy/Access Matrix Scrubber",
  "IT/Cyber Security Department Sync",
  "Manager/Approver Mobile App",
  "Historical Insider Threat Correlator",
  "Chief Information Security Officer (CISO) Briefing",
  "Revocation/Deprovisioning Task Allocator",
  "Blockchain Immutable Review Hash",
  "Anti-Tamper Entitlement Matrix Shield",
  "Mobile App for Quick Access Approval",
  "Branch-wise Recertification Speed Benchmarker",
  "Automated Alert for Overdue Reviews",
  "Historical License/Entitlement Cost Analyzer",
  "Identity & Access Management (IAM) SOP Trainer",
  "Identity Provider (IdP) Health Monitor",
  "Imminent Insider Data Exfiltration Alert",
  "Habitual Over-Privileged User Profiler",
  "Critical (Financial/Intelligence) System Classifier",
  "AI Assisted Disciplinary Action Drafter",
  "Audit Log/Entitlement Storage Forecaster",
  "Secure IAM Database Protector",
  "Integration with State Treasury/E-Office",
  "Cyber Crime Investigation (Digital Forensics) Sync",
  "Election Special Task Force Access Modeler",
  "Disaster Command Center Access Coordinator",
  "IAM Software Licensing Budget Tracker",
  "Custom Workflow for Emergency Access Grant",
  "AI Driven Review Fatigue Predictor",
  "Predictive Need for Role Redefinition",
  "Custom Alert Trigger for DGP Admin",
  "Access Grant to Recertification/Revocation Timeline"
];
...
const AccessPrivilegeReviewSystemDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ACCESS PRIVILEGE REVIEW SYSTEM
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ACCESS PRIVILEGE REVIEW <span>SYSTEM</span></h1>
...
export default AccessPrivilegeReviewSystemDetailed;
