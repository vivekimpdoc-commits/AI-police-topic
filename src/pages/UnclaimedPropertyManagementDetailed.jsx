...
const aiExperts = [
  "Missing Persons (Zonal/National) Cross-Matcher",
  "Automated Public Notice/Gazette Generator",
  "Statutory Waiting Period (Section 102/459 BNSS) Tracker",
  "State Treasury Handover/Routing Bot",
  "Valuables (Gold/Cash) Assessment AI",
  "Lost & Found Portal Matching Engine",
  "Geo-Spatial Unclaimed Asset Concentration Mapper",
  "Facial/Image Recognition for Lost Items",
  "Unclaimed Property Dashboard",
  "Voice-Command Asset Query Bot",
  "Automated Quarterly Treasury Deposit Report",
  "State Crime Records Bureau (SCRB) Sync",
  "False Claim/Fraudulent Owner Predictor",
  "Property Degradation/Perishable Alert",
  "Storage Overflow/Space Crisis Estimator",
  "Match Probability Scorer (Item vs FIR)",
  "AI Evaluator for Unclaimed Asset Clearance",
  "Audit/Handover Log Generator",
  "Data Privacy/Finder Identity Scrubber",
  "State Treasury/Finance Department Sync",
  "Station House Officer (SHO) Mobile App",
  "Historical Claim Success/Failure Correlator",
  "District Magistrate/SP Briefing AI",
  "Public Notice/Advertisement Task Allocator",
  "Blockchain Immutable Treasury Handover Hash",
  "Anti-Tamper Asset Valuation Shield",
  "Mobile App for Finder/Citizen Reporting",
  "District-wise Asset Deposit Benchmarker",
  "Automated Alert for Expiring Waiting Periods",
  "Historical Public Advertisement Cost Analyzer",
  "Unclaimed Property Handling (Police Act) SOP Trainer",
  "Citizen Portal/Lost&Found API Monitor",
  "Imminent Valuables Theft/Misplacement (Internal) Alert",
  "Habitual Fraudulent Claimant Profiler",
  "High-Value (Jewelry/Electronics) Asset Classifier",
  "AI Assisted Magisterial Final Order Drafter",
  "Treasury Revenue/Deposit Forecaster",
  "Secure Finder/Informant Detail Protector",
  "Integration with National Missing Persons Portal",
  "Public Relations/Media Cell Sync",
  "Election (Unclaimed Cash/Liquor) Fast-Track Disposal Modeler",
  "Disaster (Earthquake/Train Crash) Luggage Matching Coordinator",
  "Storage/Valuation Expert Budget Tracker",
  "Custom Workflow for Unclaimed Livestock/Animals",
  "AI Driven True Owner Identification Probability Predictor",
  "Predictive Need for Inter-State Notice Publication",
  "Custom Alert Trigger for District Magistrate",
  "Date of Finding to Final Treasury Deposit Timeline"
];
...
const UnclaimedPropertyManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI UNCLAIMED PROPERTY MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI UNCLAIMED PROPERTY <span>MANAGEMENT</span></h1>
...
export default UnclaimedPropertyManagementDetailed;
