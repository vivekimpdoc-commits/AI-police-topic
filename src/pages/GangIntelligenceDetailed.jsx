...
const aiExperts = [
"Street Gang Territorial/Turf Boundary Mapper",
  "Rivalry & Retaliation Early Warning Predictor",
  "Social Media Recruitment/Bragging Tracker",
  "Tattoo/Gang-Sign/Graffiti Image Analyzer",
  "Gang Leadership & Hierarchy Modeler AI",
  "Weapon/Firearms Procurement Tracker Bot",
  "Juvenile/Youth Radicalization Predictor",
  "Extortion/Hafta Collection Route Mapper",
  "Drive-by Shooting/Gang Violence Hotspot AI",
  "Gang Name/Alias & Slang NLP Extractor",
  "Telecom/CDR (Call Record) Gang Node Linker",
  "Bail-Jumper/Parolee Gang Re-integration AI",
  "Prison/Jail Inmate Gang Faction Modeler",
  "Financial/Fund Flow (Micro-Extortion) Bot",
  "Narcotics/Drug Peddling Gang Link AI",
  "Vehicle Theft/Joyriding Gang Operations AI",
  "Command Center Real-time Gang Dashboard",
  "Voice-Command Gang Dossier Query Assistant",
  "Automated Link Analysis/Graph Visualization",
  "CCTV Suspect Gait/Color-Code Pattern AI",
  "Historical Rivalry/Feud Timeline Generator",
  "Witness Intimidation/Threat Risk Scorer",
  "Informant/Tip-Off Verification via Gang Intel",
  "Inter-District/State Border Gang Sync AI",
  "AI Protocol for Targeted Gang Sweeps/Raids",
  "Senior Officer (SP/SSP) Gang Radar Dash",
  "Mobile App Push-Alert for Beat Patrol Officers",
  "Blockchain Immutable Log of Gang Intel",
  "Inter-Agency (Task Force/STF) Sync Bot",
  "Data Privacy & Juvenile Identity Protection",
  "AI Evaluator for Gang Eradication ROI",
  "Custom Gang Affiliation Trigger Definition",
  "Social Media Live-Stream/Reel Threat Alert",
  "Music/Video (Drill/Rap) Provocation Analyzer",
  "Election/Political Muscle-Power Gang Link",
  "Festival/Event Gang Clash Predictor Bot",
  "Night Patrol/Beat Book Gang Check Sync",
  "AI Assisted Preventive Detention (Gunda Act)",
  "Court Hearing/Summons Gang Clash Warning",
  "Hospital/Medical Emergency Gang Retaliation AI",
  "Cyber-Bullying/Online Gang Harassment Bot",
  "Women/Eve-Teasing Street Gang Profiler",
  "School/College Surroundings Gang Target AI",
  "AI Driven Rehabilitation/Reformation Scorer",
  "NGO/Civil Society Youth Diversion Sync",
  "Informant Code-Word/Slang Decoder Bot",
  "AI Assisted Interrogation Strategy for Members",
  "Predictive Gang Splinter/Faction Modeler",
  "Cross-Border/Smuggling Gang Link AI",
  "Weapon Forgery/Country-made Gun (Katta) Sync",
  "Asset/Vehicle Seizure Gang Link Modeler",
  "AI Driven Decoy/Undercover Op Recommender",
  "Public Trust/Fear Index vs Gang Activity AI",
  "Automated Media/Press Release Drafter",
  "Financial Audit of Gang Front Businesses",
  "Predictive Vulnerability Modeler for Rivals"
];
...
const GangIntelligenceDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI GANG INTELLIGENCE
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI GANG INTELLIGENCE</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in street gang rivalries, territorial claims, social media & tattoo analysis.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI GANG <span>INTELLIGENCE</span></h1>
            <p className="cyber-subtitle">Street Gang Rivalries, Territorial Claims, Social Media & Tattoo Analysis</p>
          </div>
        </div>
      </header>
...
export default GangIntelligenceDetailed;
