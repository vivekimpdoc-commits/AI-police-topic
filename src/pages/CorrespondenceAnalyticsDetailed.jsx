...
const aiExperts = [
  "Public Letter Sentiment/Tone Analyzer AI",
  "NLP Topic Modeling/Clustering Engine",
  "Communication Flow/Network Graph Generator",
  "Emerging Trend/Grievance Forecaster",
  "Inter-departmental Bottleneck Mapper",
  "Key Influencer/Frequent Sender Identifier",
  "Geo-Spatial Grievance/Topic Heatmapper",
  "Spike/Anomaly Detection AI",
  "Correspondence Analytics Dashboard",
  "Voice-Command Trend Query Bot",
  "Automated Quarterly Insight Report",
  "CM Helpline/Public Grievance Portal Sync",
  "Multi-Lingual Text Mining Engine",
  "Keyword/Buzzword Extractor Bot",
  "Fake/Bot-Generated Letter Predictor",
  "Correlation with Crime/Law & Order Stats",
  "AI Evaluator for Public Satisfaction",
  "Audit/Analysis Log Generator",
  "Data Privacy/PII Masking Engine",
  "State Intelligence/CID Sync",
  "Executive Insight Mobile App",
  "Historical Policy Impact Correlator",
  "DGP/Home Minister Briefing AI",
  "Resource Reallocation Predictor",
  "Blockchain Immutable Insight Hash",
  "Anti-Tamper Analytics Shield",
  "Mobile App for Live Trend Tracking",
  "District-wise Issue Benchmarker",
  "Automated Alert for Negative Sentiment Spikes",
  "Historical Communication Efficacy Analyzer",
  "Public Relations (PR)/Drafting SOP Trainer",
  "Big Data Server Health Monitor",
  "Imminent Public Outrage/Protest Alert",
  "Coordinated Letter Writing Campaign Profiler",
  "Sensitive/Communal Topic Classifier",
  "AI Assisted Strategic Response Drafter",
  "Big Data Storage/Data Lake Forecaster",
  "Secure Intelligence Insight Protector",
  "Integration with Social Media Analytics",
  "Citizen Feedback Loop Sync",
  "Election Sentiment/Complaint Modeler",
  "Disaster Relief Satisfaction Coordinator",
  "Analytics Software/Cloud Budget Tracker",
  "Custom Workflow for Deep-Dive Investigations",
  "AI Driven Public Unrest Predictor",
  "Predictive Need for Policy Change",
  "Custom Alert Trigger for DGP",
  "Issue/Trend Evolution Timeline Tracker"
];
...
const CorrespondenceAnalyticsDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CORRESPONDENCE ANALYTICS
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CORRESPONDENCE <span>ANALYTICS</span></h1>
...
export default CorrespondenceAnalyticsDetailed;
