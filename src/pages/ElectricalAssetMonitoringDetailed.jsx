...
const aiExperts = [
  "Transformer Oil/Temperature AI Monitor",
  "UPS/Inverter Battery Degradation Predictor",
  "Short-Circuit/Thermal Overload Risk Engine",
  "Switchgear/Panel Diagnostic Bot",
  "Power Factor/Harmonic Distortion Analyzer",
  "Phase Imbalance/Voltage Fluctuation Alert",
  "Geo-Spatial Electrical Grid Mapper",
  "Asset Depreciation/Replacement Scorer",
  "Electrical Asset Dashboard",
  "Voice-Command Asset Query Bot",
  "Automated Monthly Electrical Safety Report",
  "State Electricity Inspectorate Sync",
  "Insulation Breakdown/Spark Predictor",
  "Battery Swelling/Failure Alert AI",
  "Load Creep/Unauthorized Extension Detector",
  "Preventive Maintenance ROI Analyzer",
  "AI Evaluator for Electrical Fire Safety Index",
  "Audit/Maintenance Log Generator",
  "Data Privacy/Facility Data Scrubber",
  "Estate/IT Infrastructure Sync",
  "Electrical Engineer/Technician App",
  "Historical Monsoon Trip-Out Correlator",
  "SP (Infrastructure) Briefing AI",
  "Testing/Servicing Task Allocator",
  "Blockchain Immutable Testing Hash",
  "Anti-Tamper SCADA/Panel Shield",
  "Mobile App for Spot Thermal Scan Upload",
  "Asset-wise Reliability Benchmarker",
  "Automated Alert for Imminent Transformer Failure",
  "Historical Electrical Repair Cost Analyzer",
  "Electrical Safety/LOTO (Lockout-Tagout) Trainer",
  "IoT Sensor/Thermal Camera Health Monitor",
  "Imminent Total Blackout/Fire Alert",
  "Substandard Equipment Supplier Profiler",
  "Mission-Critical (Server/CCTNS) UPS Classifier",
  "AI Assisted Condemnation Board Drafter",
  "Telemetry/Diagnostic Data Forecaster",
  "Secure Power Grid Blueprint Protector",
  "Integration with OEM (Original Equipment Manufacturer) Portals",
  "Fire Safety Compliance Sync",
  "Election Counting Center Power Resilience Modeler",
  "Disaster Command Grid Coordinator",
  "Electrical Asset Replacement Budget Tracker",
  "Custom Workflow for High-Tension (HT) Repairs",
  "AI Driven Component Failure Predictor",
  "Predictive Need for Substation Capacity Upgrade",
  "Custom Alert Trigger for Chief Engineer (Police)",
  "Anomaly Detection to Rectification Timeline"
];
...
const ElectricalAssetMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ELECTRICAL ASSET MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ELECTRICAL ASSET <span>MONITORING</span></h1>
...
export default ElectricalAssetMonitoringDetailed;
