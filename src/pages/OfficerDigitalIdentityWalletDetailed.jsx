...
const aiExperts = [
  "Smartphone-Based Digital ID Provisioner",
  "Zero-Trust/Context-Aware Authentication Engine",
  "Secure Single Sign-On (SSO) Linker",
  "Digital Badge/Award Sync Bot",
  "Geo-Fenced Login Validator AI",
  "Device Jailbreak/Root Detection AI",
  "Geo-Spatial Authentication Attempt Mapper",
  "Bluetooth/NFC Contactless Access Enabler",
  "Digital Wallet Admin Dashboard",
  "Voice-Command Auth Query Bot",
  "Automated Monthly SSO Usage Report",
  "IT/Cyber Security Sync",
  "Suspicious Login/Brute-Force Alert",
  "Stolen Device/Remote Wipe Trigger",
  "Phishing/Session Hijack Predictor",
  "Passwordless/Passkey Adoption Analyzer",
  "AI Evaluator for Cyber Security Posture",
  "Audit/Login Trail Generator",
  "Data Privacy/Wallet Encryption Scrubber",
  "HRMS/Training Academy Sync",
  "Officer Digital Wallet App",
  "Historical Cyber Breach/Compromise Correlator",
  "Chief Information Security Officer (CISO) Briefing",
  "Account Recovery/Reset Task Allocator",
  "Blockchain Immutable Auth Event Hash",
  "Anti-Tamper Digital Wallet Shield",
  "Mobile App for QR Code Verification",
  "App-wise Authentication Speed Benchmarker",
  "Automated Alert for Compromised Credentials",
  "Historical MFA (Multi-Factor) Cost Analyzer",
  "Cyber Hygiene/Digital ID SOP Trainer",
  "SSO/Identity Provider (IdP) Health Monitor",
  "Imminent Massive Credential Leak Alert",
  "Habitual Password Loser Profiler",
  "High-Privilege (Admin/Commander) Wallet Classifier",
  "AI Assisted Cyber Incident Report Drafter",
  "Authentication Log Storage Forecaster",
  "Secure Private Key/Enclave Protector",
  "Integration with E-Office/CCTNS Apps",
  "Public Servant Verification Sync",
  "Election Observer Digital Pass Modeler",
  "Disaster Rescue Team Verification Coordinator",
  "Cyber Security/License Budget Tracker",
  "Custom Workflow for Emergency Access Revocation",
  "AI Driven Adoption Rate Predictor",
  "Predictive Need for Hardware Security Keys",
  "Custom Alert Trigger for DGP (Modernization)",
  "App Provisioning to Access Timeline Tracker"
];
...
const OfficerDigitalIdentityWalletDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI OFFICER DIGITAL IDENTITY WALLET
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI OFFICER DIGITAL IDENTITY <span>WALLET</span></h1>
...
export default OfficerDigitalIdentityWalletDetailed;
