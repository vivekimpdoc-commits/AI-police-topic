...
const aiExperts = [
  "RPA (Robotic Process Automation) Engine",
  "Data Entry/Form Auto-Fill AI",
  "Legacy System (DOS/Old DB) Integrator",
  "Data Validation/Error Reduction Bot",
  "OCR/Document Parsing Automator",
  "Cross-Platform Data Sync (HRMS to CCTNS)",
  "Geo-Spatial Data Processing Mapper",
  "Repetitive Task Identification AI",
  "Process Automation Dashboard",
  "Voice-Command Task Status Bot",
  "Automated Daily RPA Output Report",
  "IT/Cyber Department Sync Bot",
  "Multi-Lingual Data Auto-Translation",
  "System Timeout/Crash Recovery Predictor",
  "Anomalous/Fraudulent Data Entry Detector",
  "Task Scheduling/Batch Processing Bot",
  "AI Evaluator for Man-Hours Saved",
  "Audit/RPA Execution Log Generator",
  "Data Privacy/PII Masking Engine",
  "National Informatics Centre (NIC) Sync",
  "Officer Bot Control Mobile App",
  "Historical Data Entry Error Correlator",
  "Supervisory Officer Briefing AI",
  "Manual Exception Handling Allocator",
  "Blockchain Immutable Bot Action Hash",
  "Anti-Tamper Script/Code Shield",
  "Mobile App for Exception Alerts",
  "RPA Efficiency vs Manual Benchmarker",
  "Automated Reminder for Script Updates",
  "Historical ROI/Cost Saving Analyzer",
  "Digital Transformation/RPA SOP Trainer",
  "RPA Server/VM Health Monitor",
  "Imminent Bot Failure/Crash Alert",
  "Legacy System Bottleneck Profiler",
  "High-Volume/Critical Process Classifier",
  "AI Assisted Automation Expansion Drafter",
  "Log/Data Storage Forecaster",
  "Secure API/Credential Protector",
  "Integration with State Treasury/PFMS",
  "Citizen Portal Auto-Update Sync",
  "Election Data Processing Surge Modeler",
  "Disaster Relief Beneficiary Auto-Fill Coordinator",
  "RPA Software Licensing Budget Tracker",
  "Custom Workflow for Bot Auditing",
  "AI Driven Processing Capacity Predictor",
  "Predictive Need for Cloud Migration",
  "Custom Alert Trigger for Nodal IT Officer",
  "Bot Script Lifecycle Timeline Tracker"
];
...
const OfficeProcessAutomationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI OFFICE PROCESS AUTOMATION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI OFFICE PROCESS <span>AUTOMATION</span></h1>
...
export default OfficeProcessAutomationDetailed;
