...
const aiExperts = [
  "Station-wise (Cost Center) Expenditure Profiler",
  "Budget vs Actuals (BvA) Variance Engine",
  "Unused Funds/Surrender (March-Rush) Predictor",
  "Financial Fraud/Anomaly Detection AI",
  "Head-of-Account (HoA) Misclassification Detector",
  "Fund Reappropriation/Diversion Suggester",
  "Geo-Spatial District Financial Health Mapper",
  "Inflation/Market Rate Adjuster Bot",
  "Cost Center Executive Dashboard",
  "Voice-Command Budget Query Bot",
  "Automated Monthly Financial Health Report",
  "State Treasury/IFMS (Integrated Financial Mgmt System) Sync",
  "Vendor Monopoly/Cartelization Detector",
  "Duplicate Invoice/Payment Predictor",
  "End-of-Year Panic Buying Identifier",
  "Cost per Constable/Station ROI Analyzer",
  "AI Evaluator for Fiscal Discipline",
  "Audit/Voucher Log Generator",
  "Data Privacy/Sensitive Procurement Scrubber",
  "Finance/Accounts & Audit Dept Sync",
  "DDO (Drawing & Disbursing Officer) Mobile App",
  "Historical Budget Cut/Allocation Correlator",
  "DGP/ADG Finance Briefing AI",
  "Fund Distribution/Allotment Engine",
  "Blockchain Immutable Financial Ledger Hash",
  "Anti-Tamper Audit Trail Shield",
  "Mobile App for Expenditure Approval",
  "Inter-District Fiscal Efficiency Benchmarker",
  "Automated Alert for 80%+ Budget Exhaustion",
  "Historical Trend & Predictive Budgeting Analyzer",
  "Financial Code/Treasury Rules SOP Trainer",
  "Financial DB Server Health Monitor",
  "Imminent Fund Lapse/Surrender Alert",
  "Habitual Defaulter/Rule Breaker Profiler",
  "High-Priority (Intelligence/Ops) Secret Fund Classifier",
  "AI Assisted Supplementary Demand Drafter",
  "Financial Data Archive Storage Forecaster",
  "Secure Secret/Covert Fund Protector",
  "Integration with Accountant General (AG) Audit",
  "Public Transparency Portal Sync (for non-classified data)",
  "Election Security Expenditure Modeler",
  "Disaster Emergency Relief Fund Coordinator",
  "Master Departmental Budget Tracker",
  "Custom Workflow for CAG (Comptroller & Auditor General) Audit Reply",
  "AI Driven Next Fiscal Requirement Predictor",
  "Predictive Need for Financial Restructuring",
  "Custom Alert Trigger for Principal Secretary Finance",
  "Financial Year Lifecycle & Audit Timeline"
];
...
const CostCenterDashboardDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI COST CENTER DASHBOARD
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI COST CENTER <span>DASHBOARD</span></h1>
...
export default CostCenterDashboardDetailed;
