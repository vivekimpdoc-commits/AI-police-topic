...
const aiExperts = [
  "IoT Cold-Chain/Temperature Tracker AI",
  "Biological Sample Shelf-Life Predictor",
  "Automated Case-Completed Disposal Alert Engine",
  "Internal Chain of Custody (CoC) Mapper",
  "Storage Capacity/Space Optimization Bot",
  "Cross-Contamination/Leakage Risk Scorer",
  "Geo-Spatial Malkhana/Cold-Room Layout Mapper",
  "Power Failure/Backup Generator Transition Analyzer",
  "Sample Storage Dashboard",
  "Voice-Command Storage Query Bot",
  "Automated Monthly Storage/Disposal Audit Report",
  "State Malkhana/Evidence Management Sync",
  "Imminent Cold-Chain Failure Predictor",
  "Sample Degradation/Spoilage Alert",
  "Unauthorized Access/Handling Flagging AI",
  "Overcrowding/Mishandling Predictor",
  "AI Evaluator for Sample Preservation Index",
  "Audit/Storage Access Log Generator",
  "Data Privacy/Case Detail Scrubber",
  "Fire & Emergency Services Sync",
  "Storage In-charge/Technician Mobile App",
  "Historical Spoliation/Acquittal Correlator",
  "FSL Director (Operations) Briefing AI",
  "Relocation/Disposal Task Allocator",
  "Blockchain Immutable CoC/Storage Hash",
  "Anti-Tamper Temp/Access Log Shield",
  "Mobile App for Barcode/RFID Tracking",
  "Division-wise Storage Discipline Benchmarker",
  "Automated Alert for Critical Temperature Deviation",
  "Historical Cold-Storage/Electricity Cost Analyzer",
  "Evidence Preservation/Storage SOP Trainer",
  "IoT Sensor (Temp/Humidity/RFID) API Monitor",
  "Imminent Evidence Loss (Due to Freezer Breakdown) Alert",
  "Careless Handler/Technician Profiler",
  "High-Sensitivity (DNA/Viscera) Sample Classifier",
  "AI Assisted Court Order (for Disposal) Drafter",
  "Storage Space Exhaustion/Expansion Forecaster",
  "Secure Physical Access (Biometric) Protector",
  "Integration with E-Courts (Case Disposal Status)",
  "Public Works Department (Electrical) Sync",
  "Election EVM/Ballot Box Secure Storage Modeler",
  "Disaster (Flood/Fire in Lab) Relocation Coordinator",
  "Cold-Storage Maintenance/Expansion Budget Tracker",
  "Custom Workflow for Explosives/Narcotics Storage",
  "AI Driven Next Disposal/Purge Date Predictor",
  "Predictive Need for New Cold-Room Setup",
  "Custom Alert Trigger for IG Forensics",
  "Temperature Deviation to Backup Action Timeline"
];
...
const SampleStorageMonitoringDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SAMPLE STORAGE MONITORING
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SAMPLE STORAGE <span>MONITORING</span></h1>
...
export default SampleStorageMonitoringDetailed;
