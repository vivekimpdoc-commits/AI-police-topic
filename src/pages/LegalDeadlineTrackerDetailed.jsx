...
const aiExperts = [
  "Charge-Sheet Deadline (60/90 day) Calculator",
  "Appeal/Revision Limitation Period AI",
  "Forensic Lab Report Delay Escalator",
  "Prosecution Sanction Deadline Tracker",
  "Statutory Default Bail Predictor",
  "High Court/Supreme Court Direction Timer",
  "CCTNS Automated Deadline Sync",
  "Delay Condonation Ground Suggester",
  "Deadline Command Dashboard",
  "Voice-Command Expiry Query Bot",
  "Automated Defaulter Alert Report",
  "Inter-Department Sync Bot",
  "Jurisdiction-Specific Holiday/Vacation Adjuster",
  "Pending Case Backlog Geo-Mapper",
  "Systemic Delay Bottleneck Analyzer",
  "Ageing FIR/Investigation Scorer",
  "AI Evaluator for IO Timeliness",
  "Audit/Deadline Override Log Gen",
  "Data Privacy/Case Detail Scrubber",
  "State Legal Dept/Advocate General Sync",
  "Field IO Deadline Alert App",
  "Historical Default Bail Correlator",
  "DGP/SP Level Pending Cases Briefing",
  "Supervisory Officer Task Allocator",
  "Blockchain Immutable Timeline Hash",
  "Anti-Tamper Deadline Shield AI",
  "Mobile App for Quick Compliance Update",
  "Jurisdictional Rule Matcher",
  "Multi-Lingual Alert Translator",
  "Historical Compliance Rate Analyzer",
  "Limitation Act SOP Trainer",
  "Tracker DB Server Health Monitor",
  "Imminent Statutory Expiry Alert Bot",
  "Organized Crime Delay Tactic Profiler",
  "VIP/High-Profile Fast-Track Classifier",
  "AI Assisted Delay Explanation Drafter",
  "Document Storage/Archival Forecaster",
  "Secure Internal Audit Protector",
  "Integration with E-Courts/NJDG API",
  "Citizen Right to Speedy Trial Analytics",
  "Mass Riot Case Deadline Batching Modeler",
  "Disaster/Pandemic Limitation Extension Coordinator",
  "Legal Penalty/Compensation Budget Tracker",
  "Custom Workflow for Inter-State Delays",
  "AI Driven Case Dismissal Predictor",
  "Predictive Need for IO Reassignment",
  "Custom Alert Trigger for Chief Secretary",
  "Case Investigation Timeline Tracker"
];
...
const LegalDeadlineTrackerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI LEGAL DEADLINE TRACKER
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI LEGAL DEADLINE <span>TRACKER</span></h1>
...
export default LegalDeadlineTrackerDetailed;
