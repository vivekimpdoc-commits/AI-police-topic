...
const aiExperts = [
"Automated Field Check-in Auditor",
  "Mobile Evidence Upload Sync AI",
  "Inspection Geofencing Validator",
  "Real-Time Video Verification Bot",
  "Officer Signature Biometric Sync",
  "Field Inspection Route Optimizer",
  "Random Spot-Check Generator AI",
  "Missing Protocol Alert Sentinel",
  "Night-Time Field Audit Sync AI",
  "Vehicle Search Log Analytics",
  "Premises Inspection Compliance Scorer",
  "Digital Document OCR Verification",
  "License & Permit Status Sync AI",
  "Fake ID Detection AI for Field Ops",
  "Automated Field Report Summarizer",
  "CCTV Inspection Sync Auditor",
  "Weapon Seizure Log Verification",
  "Narcotics Field Testing Sync AI",
  "Breathalyzer Result Uploader Bot",
  "Radar Gun Calibration Field Auditor",
  "Hostile Environment Risk Modeler",
  "Officer Body-Cam Sync Validator",
  "Field Inspection Time-Tracking AI",
  "Inter-Agency Field Coordination Bot",
  "Cross-Jurisdiction Audit Sync AI",
  "VIP Security Drill Field Auditor",
  "Event Security Perimeter Inspector",
  "Hazardous Material Field Auditor",
  "Construction Site Safety Sync AI",
  "Noise Complaint Decibel Meter Sync",
  "Environmental Pollution Field Alert",
  "Illegal Mining & Sand Smuggling AI",
  "Forest & Wildlife Poaching Sync",
  "Traffic Signal Override Field Auditor",
  "Highway Toll-Gate Inspection Sync",
  "Prison Cell Random Check Generator",
  "Cyber-Cafe Physical Audit AI",
  "Pawn Shop Ledger Field Verification",
  "Arms Dealer License Physical Audit",
  "Explosive Magazine Field Inspector",
  "Blockchain Audit Log Ledger AI",
  "Offline Mobile Audit Data Sync",
  "Voice-Activated Field Notes AI",
  "Multilingual Statement Translator AI",
  "Suspect Interrogation Heart-Rate Sync",
  "Field Evidence Chain of Custody AI",
  "Automated Show-Cause for Fake Audits",
  "Field Officer Fatigue Analyzer",
  "K9 Unit Field Deployment Auditor",
  "Drone Aerial Site Inspection AI",
  "Helicopter Patrol Visual Audit Sync",
  "Marine Vessel Inspection Tracker",
  "Subway & Rail-Network Audit AI",
  "Undercover Officer Safety Monitor",
  "Field Inspection Budget Allocator",
  "Community Trust via Audit Transparency",
  "Live Actionable Intelligence Handoff",
  "Digital Twin Audit Mapping AI",
  "Real-Time Field Readiness Dashboard",
  "Next-Gen AR (Augmented Reality) Field AI"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> FIELD INSPECTION AI
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>FIELD INSPECTION AI</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in automated check-in & evidence validator.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">FIELD INSPECTION <span>AI</span></h1>
            <p className="cyber-subtitle">Automated Check-in & Evidence Validator</p>
          </div>
        </div>
      </header>
...
export default FieldInspectionDetailed;
