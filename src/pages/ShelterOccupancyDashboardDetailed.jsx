...
const aiExperts = [
"Real-Time Bed/Cot Availability Heatmap AI",
  "Gender-Segregated Capacity Modeler",
  "Disease Outbreak (Cholera/Flu) Heatmap Bot",
  "Overcrowding/Stampede Predictive Alert AI",
  "Evacuee Influx vs Outflow Tracker",
  "Special Needs (Elderly/Disabled) Bed Allocator",
  "Quarantine/Isolation Ward Occupancy Sync",
  "Infant/Nursing Mother Zone Tracker AI",
  "Command Center Shelter Occupancy Dashboard",
  "Voice-Command Occupancy Query Assistant",
  "Automated Daily Census/Headcount Gen",
  "Inter-Camp Transfer/Load Balancing AI",
  "Toilet/Washroom to Occupant Ratio Alert",
  "Kitchen/Food Plate vs Occupant Modeler",
  "Missing Person Check-in/Check-out Sync",
  "Mobile App Registration (Aadhar) Sync",
  "AI Evaluator for Shelter Stress/Capacity",
  "Incident/Eviction Log Auto-Generator",
  "Data Privacy/Occupant Medical Info Masker",
  "Police-Civil Defence Guard Ratio Modeler",
  "Orphan/Unaccompanied Minor Tracker Bot",
  "Weather/Temp Impact on Tent Occupancy",
  "Senior Officer (Camp In-Charge) Briefing",
  "Public/Media Occupancy Stat Broadcaster",
  "Blockchain Immutable Log of Registrations",
  "Camp Boundary/Entry-Exit GPS Sync AI",
  "Biometric/Face-Scan Entry Tracker",
  "Mental Health Counseling Room Availability",
  "Multi-Lingual Occupant Demographic AI",
  "Historical Camp Occupancy Precedent Match",
  "Stray Animal/Pet Shelter Occupancy Sync",
  "Camp Staff/Volunteer Bed Allocator",
  "Temporary Checkpost/Visitor Log Sync",
  "Traffic/Bus Route to Available Shelter AI",
  "Flood/Storm Re-Evacuation Capacity Check",
  "Medical Triage Bed Availability Tracker",
  "AI Assisted Post-Camp Disbandment Audit",
  "Security Eqp/Guards vs Occupants Rater",
  "VIP Visit Impact on Occupancy/Flow AI",
  "Integration with State Relief Commissioner",
  "Citizen SOS Router to Nearest Empty Shelter",
  "Heatwave/Cooling Center Occupancy Modeler",
  "Night-Time Curfew/Headcount Enforcer Bot",
  "Shelter Expense Per Capita Tracker AI",
  "Custom Workflow/Approval for Transfer",
  "AI Driven Camp Emptying/Closure Predictor",
  "Predictive Need for Additional Tents",
  "Custom Alert Trigger for Camp Admin"
];
...
const ShelterOccupancyDashboardDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SHELTER OCCUPANCY DASHBOARD
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI SHELTER OCCUPANCY DASHBOARD</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in real-time bed availability, gender-segregated capacity & outbreak heatmaps.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SHELTER OCCUPANCY <span>DASHBOARD</span></h1>
            <p className="cyber-subtitle">Real-time Bed Availability, Gender-Segregated Capacity & Outbreak Heatmaps</p>
          </div>
        </div>
      </header>
...
export default ShelterOccupancyDashboardDetailed;
