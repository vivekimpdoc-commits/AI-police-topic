...
const aiExperts = [
  "RTI Query NLP Intent Extractor",
  "RTI Act (Section 8/9) Exemption Checker AI",
  "Automated Draft Reply Generator",
  "Previous Similar RTI Precedent Searcher",
  "First Appellate Authority (FAA) Tracker",
  "Information Gathering/Routing Engine",
  "Geo-Spatial RTI Hotspot Mapper",
  "Vexatious/Repeat Applicant Profiler",
  "RTI Assistance Dashboard",
  "Voice-Command RTI Query Bot",
  "Automated Monthly Pendency Report",
  "State Information Commission (SIC) Sync",
  "Multi-Lingual RTI Translation (Hindi/Local to English)",
  "Attachment/Information Verification Bot",
  "Fake/Fraudulent Applicant Detector",
  "Cost/Fee Calculator for Information",
  "AI Evaluator for Reply Accuracy",
  "Audit/Response Log Generator",
  "Data Privacy/Third-Party Info Scrubber",
  "E-Office/Record Room Sync",
  "PIO (Public Information Officer) Task App",
  "Historical Penalty/Adverse Order Correlator",
  "Appellate Authority Briefing AI",
  "Information Retrieval Allocator",
  "Blockchain Immutable Reply Hash",
  "Anti-Tamper RTI Record Shield",
  "Mobile App for Draft Approval",
  "Department-wise Pendency Benchmarker",
  "Automated Reminder for 30-Day Deadline",
  "Historical RTI Trend/Topic Analyzer",
  "RTI Handling SOP Trainer",
  "RTI DB Server Health Monitor",
  "Imminent 30-Day Deadline Alert",
  "Serial Litigant/Activist Profiler",
  "High-Sensitivity/Scandal RTI Classifier",
  "AI Assisted Penalty Defense Drafter",
  "RTI Document Storage Forecaster",
  "Secure Whistleblower/Informant Protector",
  "Integration with National RTI Portal",
  "Citizen RTI Status Portal Sync",
  "Election Expenditure RTI Modeler",
  "Disaster Relief Fund RTI Coordinator",
  "RTI Penalty/Compensation Budget Tracker",
  "Custom Workflow for Third-Party Notice",
  "AI Driven Information Availability Predictor",
  "Predictive Need for Legal Opinion",
  "Custom Alert Trigger for SP/SSP",
  "RTI Application Lifecycle Tracker"
];
...
const RTIAssistanceSystemDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI RTI ASSISTANCE SYSTEM
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI RTI ASSISTANCE <span>SYSTEM</span></h1>
...
export default RTIAssistanceSystemDetailed;
