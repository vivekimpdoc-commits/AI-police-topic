...
const aiExperts = [
  "Biometric/Token Access Validator AI",
  "Dossier Compartmentation/Silo Engine",
  "Alias/Fake-Identity Management Bot",
  "Handler-to-Handler Transition/Handover Protocol AI",
  "Source Burn-Risk/Compromise Scorer",
  "Unauthorized Dossier Access/Snooping Detector",
  "Geo-Spatial Handler-Source Meeting Mapper",
  "Financial/Reward Trail Obfuscator",
  "Source Access Control Dashboard",
  "Voice-Command Compartment Query Bot",
  "Automated Monthly Source Security Audit",
  "State Intelligence/Special Branch Sync",
  "Handler Co-option/Compromise Predictor",
  "Double-Agent/Turncoat Risk Analyzer",
  "Suspicious Access Pattern/Data Dump Alert",
  "Meeting Safe-House Vulnerability Analyzer",
  "AI Evaluator for Source Anonymity Index",
  "Audit/Dossier Access Log Generator",
  "Data Privacy/True Identity Scrubber",
  "Anti-Terrorism Squad (ATS) Sync",
  "Handling Officer Secure Token App",
  "Historical Source Compromise/Assassination Correlator",
  "ADG (Intelligence) Briefing AI",
  "New Handler Allocation/Vetting Task",
  "Blockchain Immutable Access/Audit Hash",
  "Anti-Tamper Alias Database Shield",
  "Mobile App for Secure Source Comms",
  "Handler-wise Source Longevity Benchmarker",
  "Automated Alert for Rogue Access Attempt",
  "Historical Safe-House/Tradecraft Cost Analyzer",
  "Source Handling/Tradecraft SOP Trainer",
  "Biometric/Hardware Security Key API Monitor",
  "Imminent Source Unmasking/Assassination Alert",
  "Compromised/Rogue Handler Profiler",
  "High-Value (Deep Cover/Mole) Source Classifier",
  "AI Assisted Burn-Notice/Relocation Drafter",
  "Source Yield/Lifespan Forecaster",
  "Secure Air-Gapped Master Database Protector",
  "Integration with Witness Protection Programs",
  "Financial Intelligence/Secret Fund Sync",
  "Election Deep-Cover Political Intel Access Modeler",
  "Disaster (Man-made) Syndicate Source Coordinator",
  "Source Protection/Relocation Budget Tracker",
  "Custom Workflow for Foreign/Cross-Border Assets",
  "AI Driven Source Defection Predictor",
  "Predictive Need for Immediate Extraction",
  "Custom Alert Trigger for DGP (Intel)",
  "Suspicious Access to Dossier Lockdown Timeline"
];
...
const ConfidentialSourceAccessControlDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CONFIDENTIAL SOURCE ACCESS CONTROL
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CONFIDENTIAL SOURCE ACCESS <span>CONTROL</span></h1>
...
export default ConfidentialSourceAccessControlDetailed;
