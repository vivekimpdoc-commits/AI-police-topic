...
const aiExperts = [
  "Stolen Vehicle Chassis/Engine No Matcher",
  "Copper/Cable Theft Anomaly Detector",
  "Scrap Inventory Digital Register AI",
  "Suspicious Volume/Bulk Seller Profiler",
  "License/Permit Expiry Alert Bot",
  "Environmental Compliance/Hazard Auditor",
  "Geo-Spatial Scrap Yard Mapper",
  "Chop-Shop Network Modeler AI",
  "Scrap Dealer Command Dashboard",
  "Voice-Command Scrap Query Bot",
  "Automated Weekly Audit Report",
  "Municipal Corporation/RTO Sync Bot",
  "CCTV Yard Feed Anomaly Detector",
  "Burnt/Melted Metal Origin Predictor",
  "Fake ID/Proxy Seller Detector",
  "Statutory (Form-4) Compliance AI",
  "AI Evaluator for Spot Checks",
  "Audit/Raid Log Generator",
  "Data Privacy/Legitimate Vendor Scrubber",
  "State Pollution Control Board Sync",
  "Field IO Yard Inspection App",
  "Historical Chop-Shop Precedent Matcher",
  "SHO/Supervisory Officer Briefing",
  "Task Force/Raid Allocator",
  "Blockchain Immutable Register Hash",
  "Anti-Tamper Inventory Shield",
  "Mobile App for Dealer (Daily Upload)",
  "Jurisdiction Boundary Matcher",
  "Multi-Lingual Compliance Translator",
  "Historical Theft/Recovery Analyzer",
  "Scrap Yard Audit SOP Trainer",
  "Scrap DB Server Health Monitor",
  "Imminent Bulk Dismantling Alert",
  "Organized Auto-Theft Syndicate Profiler",
  "High-Value/Govt Property Theft Classifier",
  "AI Assisted Closure Notice Drafter",
  "CCTV Video Storage Forecaster",
  "Secure Informant Identity Protector",
  "Integration with VAHAN/Sarathi DB",
  "Citizen/Corporate Theft Reporting Sync",
  "Inter-State Metal Smuggling Modeler",
  "Disaster Debris/Scavenging Coordinator",
  "Audit/Inspection Ops Expense Tracker",
  "Custom Workflow for Yard Sealing",
  "AI Driven Chop-Shop Predictor",
  "Predictive Need for Drone Surveillance",
  "Custom Alert Trigger for Nodal Officers",
  "Scrap Verification Lifecycle Tracker"
];
...
const ScrapDealerVerificationDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SCRAP DEALER VERIFICATION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SCRAP DEALER <span>VERIFICATION</span></h1>
...
export default ScrapDealerVerificationDetailed;
