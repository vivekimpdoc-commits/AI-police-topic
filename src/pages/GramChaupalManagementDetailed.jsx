...
const aiExperts = [
"Village Sarpanch/Pradhan Outreach Router",
  "Rural Grievance Live Sync AI",
  "Gram Chaupal Scheduling Optimizer Bot",
  "Panchayat Dispute Early Warning AI",
  "Rural Land Grab/Encroachment Flag Bot",
  "Village-Level Crime Trend Analytics",
  "Women's Safety 'Mahila Chaupal' Tracker",
  "Caste/Communal Tension Predictor AI",
  "Agriculture/Crop Theft Modus Operandi Modeler",
  "Tractor/Cattle Theft Sync to CCTNS",
  "Illegal Liquor/Desi Daru Raid Tracker AI",
  "Rural Youth Counseling Camp Planner",
  "Beat Constable Village Visit Logger AI",
  "Gram Chaupal Attendance/Participation Rater",
  "Public Sentiment Index in Rural Areas",
  "Multi-Lingual (Dialect) Grievance Translator",
  "Automated FIR Registration from Chaupal",
  "Senior Citizen Assistance Request Router",
  "Rural Health/Medical Camp Coordination AI",
  "Dowry/Domestic Violence Whisper Campaign Tracker",
  "Village Watchman (Chowkidar) Duty Sync",
  "Unverified Outsider/Stranger Alert Bot",
  "Rural Cyber Fraud/Scam Awareness Modeler",
  "Micro-Finance/Loan Shark Harassment Flag",
  "Local Dispute (Nali/Khadanja) Escalation AI",
  "Gram Chaupal Audio-to-Text Transcriber",
  "Panchayat Election Vulnerability Mapper",
  "Festival/Mela Crowd Prediction in Villages",
  "Rural Informant/Tip-Off ROI Analyzer",
  "Police Response Time (112) in Rural Areas AI",
  "Village Infrastructure (Streetlight/CCTV) Audit",
  "Wild Animal Attack/Man-Animal Conflict Router",
  "Village School/Youth Outreach Sync",
  "Substance Abuse/Drug Hotspot Mapper",
  "Water/Irrigation Dispute Tension Predictor",
  "Historical Village Rivalry/Feud Correlator",
  "Automated Gram Chaupal Feedback SMS Bot",
  "Action Item/Promise Fulfillment Tracker",
  "SP/SSP Dashboard for Rural Outreach",
  "Beat Book Digitization & Sync AI",
  "Rural Road/Accident Blackspot Modeler",
  "Inter-Village Gang/Mafia Link AI",
  "Panchayat Fund Fraud/Embezzlement Flag",
  "Rural Weapon/Arms License Audit Bot",
  "Village-Level Disaster Resilience Rater",
  "Chaupal Impact on Local Crime Rate AI",
  "NGO/Volunteer Sync for Village Upliftment",
  "Honor Killing/Khap Panchayat Threat Flag",
  "Missing Person/Child Village Broadcast Bot",
  "Rural Public Address (PA) System Trigger",
  "Voice-Command Chaupal Query Assistant",
  "Beat Officer Fatigue/Burnout Scorer",
  "Village Mapping/Geofencing Tool AI",
  "Automated Monthly Village Status Report Gen",
  "Cross-District Border Village Sync Bot",
  "Rural Comm Failure/Dead-Zone Tracker",
  "AI Generated Gram Chaupal Agenda",
  "Blockchain Immutable Log for Chaupal Promises",
  "Rural Police-Public Trust Index Scorer",
  "Village Level Suspect/BOLO Alerts Link"
];
...
const GramChaupalManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI GRAM CHAUPAL MANAGEMENT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI GRAM CHAUPAL MANAGEMENT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in village outreach, rural grievance logging & panchayat coordination.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI GRAM CHAUPAL <span>MANAGEMENT</span></h1>
            <p className="cyber-subtitle">Village Outreach, Rural Grievance Logging & Panchayat Coordination</p>
          </div>
        </div>
      </header>
...
export default GramChaupalManagementDetailed;
