...
const aiExperts = [
  "Drone Swarm Collision Avoidance Engine AI",
  "Automated Flight Path Optimizer Bot",
  "Drone Camera Human/Vehicle Tracker Engine",
  "Thermal Drone Night Patrol Searcher AI",
  "Anti-Drone Radar RF Intercept Classifier",
  "Drone Battery Charge/Base Station Allocator",
  "Aerial Crowd Density Estimation Algorithm",
  "Drone Speaker Public Broadcast Sync Bot",
  "Drone Operations Command Dashboard Portal",
  "Voice-Command Drone Video Feed Query Bot",
  "Automated Daily Drone Patrol Mission Report",
  "Cross-Force (Police/NDRF) Drone Intel Sync",
  "Drone Search & Rescue Path Finder AI",
  "Suspicious Object Drop (Contraband) Detector",
  "Aerial Smuggling Route Pattern Analyzer AI",
  "Forest Canopy Penetrating Wildlife Monitor",
  "AI Evaluator for Aerial Coverage Efficacy",
  "Audit/Drone Flight Permit Log Generator",
  "Data Privacy/Drone Feed Privacy Masker Bot",
  "Police-Civil Aviation Authority (DGCA) Sync",
  "Drone Pilot Mobile Navigation App Sync Portal",
  "Cold Case Drone Imagery Search & Matcher",
  "Senior Officer (DIG Air Wing) Briefing Bot",
  "Public Drone SOS Rescue Request Mobile Portal",
  "Blockchain Immutable Drone Flight Log Hasher",
  "Anti-GPS Spoofing Drone Navigation Shield",
  "Mobile App for Drone Feed Real-time View",
  "Drone Camera Facial Recognition Matcher AI",
  "Multi-Lingual Drone Megaphone Voice Text Bot",
  "Historical Drone Incident/Crash Trend Matcher",
  "Drone Maintenance & Component Health Predictor",
  "RF Jammer/Anti-Drone Hardware Health Monitor",
  "Urgent Drone Raid Backup Dispatch Alert AI",
  "Traffic Transit Convoy Aerial Escort Monitor",
  "Industrial Chimney Smoke Emission Drone Auditor",
  "VIP Air Space Security Perimeter Alert Bot",
  "AI Assisted Post-Drone Mission Inquiry Report",
  "Drone Dispatch Logistics/Ration Planner AI",
  "Poaching/Tree Felling Detection Drone Optimizer",
  "Integration with Digital Sky (No-Fly Zones) DB",
  "Citizen Lost Person Aerial Search Request Bot",
  "Extreme Wind/Rain Drone Safety Flight Modeler",
  "Disaster Drone Relief Supply Drop Coordinator",
  "Drone Fleet Upgrade/Purchase Budget Tracker",
  "Custom Workflow/Approval for Drone Weapon Launch",
  "AI Driven Emerging Border Infiltration Predictor",
  "Predictive Need for Drone Fleet Reinforcement",
  "Custom Alert Trigger for Drone Wing Commander"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DRONE MONITORING
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI DRONE MONITORING</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in aerial patrols, crowd flow analytics, automated flight paths & smuggling detection.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DRONE <span>MONITORING</span></h1>
            <p className="cyber-subtitle">Aerial Patrols, Crowd Flow Analytics, Automated Flight Paths & Smuggling Detection</p>
          </div>
        </div>
      </header>
...
export default DroneMonitoringDetailed;
