...
const aiExperts = [
  ...
  "Participant Skill/Team Matcher AI",
  "Automated Code/Syntax Evaluator",
  "Prototype/MVP Tracking Engine",
  "Plagiarism/GitHub Code Checker",
  "Judging Criteria/Score Aggregator",
  "Geo-Spatial Participant Demographics Mapper",
  "Sponsor/Prize Money Allocator",
  "Hackathon Management Dashboard",
  "Voice-Command Event Query Bot",
  "Automated Post-Event Impact Report",
  "State IT/Cyber Security Sync",
  "Team Dropout/Disengagement Predictor",
  "Unfair Means/Cheating Detector",
  "Hardware/Cloud Resource Provisioning AI",
  "Scalability/Feasibility Analyzer",
  "AI Evaluator for Solution Viability",
  "Audit/Judging Log Generator",
  "Data Privacy/Participant PII Scrubber",
  "University/Tech Institute Sync",
  "Participant/Mentor Mobile App",
  "Historical Problem-Solution Correlator",
  "DGP (Modernization) Briefing AI",
  "Mentor/Jury Task Allocator",
  "Blockchain Immutable Code Submission Hash",
  "Anti-Tamper Scorecard Shield",
  "Mobile App for Live Leaderboard",
  "Institute-wise Participation Benchmarker",
  "Automated Alert for Server/Cloud Exhaustion",
  "Historical Event Cost/ROI Analyzer",
  "Hackathon Logistics/SOP Trainer",
  "API/Cloud Sandbox Health Monitor",
  "Imminent Event Disruption/DDoS Alert",
  "Rule-Breaking/Spam Team Profiler",
  "High-Impact (CCTNS/Cyber) Solution Classifier",
  "AI Assisted Winner Certificate Drafter",
  "Code Repository Storage Forecaster",
  "Secure Intellectual Property Protector",
  "Integration with State Startup Nodal Agency",
  "Media/PR Promotion Sync",
  "Election Tech Challenge Modeler",
  "Disaster Tech Hackathon Coordinator",
  "Event/Sponsorship Budget Tracker",
  "Custom Workflow for Internal Police Hackathons",
  "AI Driven Solution Commercialization Predictor",
  "Predictive Need for Incubation Support",
  "Custom Alert Trigger for SP Cyber",
  "Problem Statement to MVP Delivery Timeline"
];
...
const HackathonManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI HACKATHON MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI HACKATHON <span>MANAGEMENT</span></h1>
...
export default HackathonManagementDetailed;
