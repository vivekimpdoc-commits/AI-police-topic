...
const aiExperts = [
  "Composite Station Readiness Scorer AI",
  "Live Manpower/Leave Availability Tracker",
  "Vehicle Fleet Health/Breakdown Predictor",
  "Weaponry/Ammo Stock Level Monitor",
  "Riot Gear/Tear Gas Expiry Auditor",
  "Communication Equipment (Radio) Health AI",
  "Geo-Spatial Readiness Deficit Mapper",
  "Cyber/Forensic Kit Availability Checker",
  "Resource Readiness Dashboard",
  "Voice-Command Readiness Query Bot",
  "Automated Daily Readiness Report",
  "Logistics/Procurement Department Sync",
  "CCTV/Surveillance Asset Operational Scorer",
  "Specialized Skill (SWAT/Sniper) Locator",
  "Fake Attendance/Availability Predictor",
  "Medical/First Aid Kit Expiry Tracker",
  "AI Evaluator for Emergency Response",
  "Audit/Inspection Log Generator",
  "Data Privacy/Classified Asset Scrubber",
  "State Police Headquarters Sync",
  "Field Commander Readiness App",
  "Historical Resource Shortage Correlator",
  "SHO/Supervisory Officer Briefing AI",
  "Deficit Reallocation/Transfer Optimizer",
  "Blockchain Immutable Readiness Hash",
  "Anti-Tamper Resource Record Shield",
  "Mobile App for Quartermaster Updates",
  "Jurisdiction/Zone Comparison Matcher",
  "Multi-Lingual Requisition Generator",
  "Historical Asset Utilization Analyzer",
  "Readiness/Audit SOP Trainer",
  "Readiness DB Server Health Monitor",
  "Imminent Critical Shortage Alert",
  "Election/Festival Surge Demand Profiler",
  "High-Risk Zone Preparedness Classifier",
  "AI Assisted Indent/Requisition Drafter",
  "Asset Audit Storage Forecaster",
  "Secure Strategic Vulnerability Protector",
  "Integration with CCTNS/HRMS",
  "Citizen Transparent Policing Score Sync",
  "Riot/Mass Violence Resource Modeler",
  "Disaster Equipment Readiness Coordinator",
  "Resource Replacement/Repair Budget Tracker",
  "Custom Workflow for Emergency Procurement",
  "AI Driven Breakdown Probability Predictor",
  "Predictive Need for Mutual Aid (Inter-District)",
  "Custom Alert Trigger for IG/ADG",
  "Readiness Metric Timeline Tracker"
];
...
const ResourceReadinessScoreDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI RESOURCE READINESS SCORE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI RESOURCE READINESS <span>SCORE</span></h1>
...
export default ResourceReadinessScoreDetailed;
