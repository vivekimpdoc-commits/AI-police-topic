...
const aiExperts = [
  "Inmate Gang Affiliation Mapping Engine AI",
  "Parole/Furlough Flight Risk Assessor Bot",
  "CCTV Prison Fight/Violence Detector AI",
  "Cell Phone/Contraband Smuggling Predictor",
  "Suicide Risk Assessment Profiler Engine AI",
  "Visitor Background Check/Flagging Bot",
  "Inmate Facial Recognition Headcount AI",
  "Prisoner Behavior & Rehabilitation Scorer",
  "Prison Management Command Dashboard",
  "Voice-Command Inmate Info Query Bot",
  "Automated Daily Prison Incident Report Gen",
  "Cross-Prison Inmate Transfer Sync Engine",
  "Diet/Ration Consumption Anomaly Detector",
  "Medical Emergency/Heart Rate Monitor Sync AI",
  "Parole Hearing Documentation Auto-Draft Bot",
  "Solitary Confinement Mental Health Monitor",
  "AI Evaluator for Prison Security Index %",
  "Audit/Contraband Seizure Log Generator",
  "Data Privacy/Inmate Medical Data Masker",
  "Police-Jail Department Intel Sync Bot",
  "Prison Guard Mobile App for Duty Log Sync",
  "Cold Case Jailhouse Confession Linker AI",
  "Senior Officer (DG Prisons) Briefing Bot",
  "Public Parole/Visitor E-Mulakat Scheduling Portal",
  "Blockchain Immutable Inmate Disciplinary Log",
  "Anti-Escape/Perimeter Breach Alert AI",
  "Mobile App for Undertrial Court Date Sync",
  "Inmate Call Interception Keyword Flagging Bot",
  "Multi-Lingual Inmate Grievance Translator",
  "Historical Prison Riot Pattern Matcher AI",
  "Staff/Warder Collusion with Inmate Detector",
  "Prison CCTV/Jammer Hardware Health Monitor",
  "Urgent Gang Rivalry Clash Predictor Alert AI",
  "Traffic/Transit Convoy Security for Inmates",
  "Cyber/Financial Fraud from Inside Prison Detector",
  "VIP/High-Profile Inmate Special Security AI",
  "AI Assisted Post-Riot Inquiry Report Drafter",
  "Prison Workshop/Labor Output Optimizer AI",
  "Recidivism (Re-Offense) Probability Calculator",
  "Integration with E-Prisons/ICJS Database",
  "Citizen Victim Notification of Inmate Release",
  "Extreme Overcrowding Resource Stress Modeler",
  "Disaster (Fire/Earthquake) Prison Evacuation AI",
  "Prison Budget/Food Expense Tracker AI",
  "Custom Workflow/Approval for Inmate Transfer",
  "AI Driven Prison Radicalization Predictor",
  "Predictive Need for Guard Reinforcement",
  "Custom Alert Trigger for Jail Superintendent"
];
...
const PrisonManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI PRISON MANAGEMENT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI PRISON MANAGEMENT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in inmate gang mapping, parole risk assessment, cctv violence detection & contraband search.
            </p>
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            ...
            <p className="cyber-subtitle">Inmate Gang Mapping, Parole Risk Assessment, CCTV Violence Detection & Contraband Search</p>
          </div>
        </div>
      </header>
...
export default PrisonManagementDetailed;
