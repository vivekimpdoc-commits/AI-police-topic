...
const aiExperts = [
  "NLP Subject/Topic Extractor AI",
  "Automated Desk Routing Engine",
  "Priority/Urgency Sorter",
  "Barcode/QR Dak Tracker",
  "Sender Verification Bot",
  "Physical-to-Digital Sync Engine",
  "Geo-Spatial Origin Mapper",
  "Duplicate Dak Detector",
  "Dak Management Dashboard",
  "Voice-Command Dak Query Bot",
  "Automated Daily Receipt Report",
  "Postal/Courier Service Sync",
  "Multi-Lingual Dak Translation",
  "Language/Sentiment Analyzer",
  "Fake/Phishing Letter Predictor",
  "Pending Action Extractor",
  "AI Evaluator for Processing Speed",
  "Audit/Receipt Log Generator",
  "Data Privacy/Confidential Dak Scrubber",
  "E-Office Sync",
  "Desk Officer Dak Mobile App",
  "Historical Delay Correlator",
  "Head Clerk Briefing AI",
  "Urgent Dak Allocator",
  "Blockchain Immutable Receipt Hash",
  "Anti-Tamper Dak Log Shield",
  "Mobile App for Dispatch Riders",
  "Desk-wise Pendency Benchmarker",
  "Automated Reminder for Unopened Dak",
  "Historical Volume Trend Analyzer",
  "Dak Handling SOP Trainer",
  "Dak Server Health Monitor",
  "Imminent Deadline Alert",
  "Habitual Hoarder Profiler",
  "High-Priority VIP Dak Classifier",
  "AI Assisted Acknowledgment Drafter",
  "Dak Image Storage Forecaster",
  "Secure Sensitive Dak Protector",
  "Integration with Secretariat",
  "Citizen Petition Portal Sync",
  "Election Commission Dak Modeler",
  "Disaster Relief Application Coordinator",
  "Postage/Courier Budget Tracker",
  "Custom Workflow for Registered Post",
  "AI Driven Processing Time Predictor",
  "Predictive Need for More Clerks",
  "Custom Alert Trigger for Superintendent",
  "Dak Lifecycle Timeline Tracker"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI DAK MANAGEMENT
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI DAK <span>MANAGEMENT</span></h1>
...
export default DakManagementDetailed;
