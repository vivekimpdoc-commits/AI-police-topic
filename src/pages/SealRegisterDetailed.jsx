...
const aiExperts = [
"Official Brass Seal Custody Tracker AI",
  "Sealing Wax Inventory & Burn-Rate Modeler",
  "Malkhana (Evidence) Seal Handover Log Bot",
  "Tamper-Evident Seal Breakage Alert AI",
  "Confidential File Sealing Protocol Sync",
  "Officer-Specific Seal Assignment Tracker",
  "Lost/Misplaced Seal Immediate Alert Bot",
  "Counterfeit/Duplicate Seal Detection AI",
  "Shift-Change Seal Handover Audit AI",
  "Digital Seal/Signature Equivalence Mapper",
  "Sealing Wax Procurement Forecaster Bot",
  "Seal Damage/Wear-and-Tear Image Analyzer",
  "Election Strong-Room Seal Logging AI",
  "Exam Paper/Confidential Document Seal Tracker",
  "Inter-State Extradition Seal Verification Bot",
  "Seal Impression Quality/Clarity Rater AI",
  "Historical Seal Archival & Surrender Log",
  "SHO/Supervisory Seal Override Audit Bot",
  "Seal Misuse/Unauthorized Access Predictor",
  "Automated Seal Return Reminder (Transfer/Retire)",
  "Multi-Lingual Seal Handover Transcriber",
  "VIP Security Seal Clearance Tracker AI",
  "Crime Scene (Forensic) Seal Issuance Bot",
  "Seal Registry Blockchain Immutable Ledger",
  "Voice-Command Seal Custody Search Bot",
  "Central PHQ Master Seal Database Sync",
  "AI Generated Seal Usage Anomaly Report",
  "Biometric/RFID Authentication for Seal Access",
  "Seal Impression Digitization & Storage",
  "Seal Procurement Vendor Vetting AI",
  "Old/Obsolete Seal Destruction Logger",
  "Cross-District Seal Verification Sync",
  "Seal Audit Discrepancy Flagging Engine",
  "Evidence Transport Tamper Check AI",
  "Seal/Stamp Confusion Resolution Bot",
  "Daily Seal Muster/Physical Check Sync",
  "AI Evaluator for Seal Protocol Compliance",
  "Night Officer/Duty Officer Seal Log Bot",
  "Judicial/Court Subpoena Seal Verifier",
  "Seal Repair/Replacement Request Tracker",
  "Anti-Corruption Vigilance Seal Monitor",
  "Cyber Cell Hard-Drive Sealing Protocol AI",
  "Narcotics (NDPS) Sample Sealing Log Bot",
  "Armory/Magazine Key Sealing Tracker AI",
  "Suspicious Activity Flag around Seal Locker",
  "Mobile App for Quick Seal Verification",
  "Officer Accountability Index for Seals",
  "Automated Handover/Takeover Certificate Gen",
  "Disaster/Fire Seal Recovery Protocol AI",
  "Interpol/International Seal Format Matcher",
  "Seal Defacement/Vandalism Recognition Bot",
  "AI Driven Security Audit for Seal Room",
  "Emergency Seal Breakage Justification AI",
  "Temporary Duty (TD) Seal Issuance Tracker",
  "Seal Impression Plagiarism/Forgery Alert",
  "Command Center Real-time Seal Dashboard",
  "Logbook Handwriting/Signature Matching AI",
  "RTI/Legal Query regarding Seal Usage Bot",
  "Historical Landmark Seal Preservation Tracker",
  "AI Assisted Seal Design/Security Feature Gen"
];
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI SEAL REGISTER
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI SEAL REGISTER</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in tracking official brass seals, sealing wax inventory & tamper-evident logging.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI SEAL <span>REGISTER</span></h1>
            <p className="cyber-subtitle">Tracking Official Brass Seals, Sealing Wax Inventory & Tamper-Evident Logging</p>
          </div>
        </div>
      </header>
...
export default SealRegisterDetailed;
