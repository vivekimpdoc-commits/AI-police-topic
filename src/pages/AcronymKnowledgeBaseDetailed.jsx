...
const aiExperts = [
  "Central/State Agency Abbreviation AI",
  "Military/Paramilitary Designation Decoder",
  "Automated Document Tagging/Hyperlinking Engine",
  "Contextual Acronym Disambiguation NLP",
  "Historical/Obsolete Acronym Archiver",
  "Cross-Departmental Hierarchy Mapper",
  "Geospatial Agency/Unit Location Mapper",
  "Inter-Agency Communication Smoother AI",
  "Acronym Knowledge Base Dashboard",
  "Voice-Command Acronym Query Bot",
  "Automated Weekly Database Update Report",
  "Ministry of Home Affairs (MHA) Sync",
  "Communication Breakdown/Confusion Predictor",
  "Wrong Agency Routing/Delay Alert",
  "Contextual Misinterpretation (e.g., IB vs IB) Analyzer",
  "Document Clarity/Readability Scorer",
  "AI Evaluator for Inter-Agency Communication Index",
  "Audit/Search Log Generator",
  "Data Privacy/Classified Unit Scrubber",
  "Central Armed Police Forces (CAPF) Sync",
  "Control Room/Dispatch Officer Mobile App",
  "Historical Routing Delay Correlator",
  "DGP (Administration) Briefing AI",
  "Database Curation/Update Task Allocator",
  "Blockchain Immutable Acronym Hash",
  "Anti-Tamper Designation Database Shield",
  "Mobile App for Quick Acronym Lookup",
  "Agency-wise Communication Clarity Benchmarker",
  "Automated Alert for Unrecognized/New Acronyms",
  "Historical Inter-Agency Delay Cost Analyzer",
  "Police Correspondence/Drafting SOP Trainer",
  "Search Engine/NLP API Health Monitor",
  "Imminent Dispatch Failure (Due to Confusion) Alert",
  "Habitual Jargon/Acronym Overuser Profiler",
  "High-Priority (Special Forces/Intelligence) Classifier",
  "AI Assisted Official Communication Drafter",
  "Designation/Agency Restructuring Forecaster",
  "Secure Covert Unit/Designation Protector",
  "Integration with E-Office/Dak System",
  "Military Intelligence/Defense Sync",
  "Election Paramilitary (CAPF/SAP) Deployment Modeler",
  "Disaster Multi-Agency (NDRF/SDRF) Comms Coordinator",
  "Administrative IT Systems Budget Tracker",
  "Custom Workflow for Foreign/Interpol Designations",
  "AI Driven Document Readability Score Predictor",
  "Predictive Need for Agency Restructuring Updates",
  "Custom Alert Trigger for SP Headquarters",
  "New Acronym Detection to Database Integration Timeline"
];
...
const AcronymKnowledgeBaseDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI ACRONYM KNOWLEDGE BASE
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI ACRONYM KNOWLEDGE <span>BASE</span></h1>
...
export default AcronymKnowledgeBaseDetailed;
