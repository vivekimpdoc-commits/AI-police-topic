...
const aiExperts = [
"Zero-Trust Access Control Engine AI",
  "Digital Watermark & Tracker Insertion Bot",
  "Classified Intelligence Report Vault",
  "Document Leak/Exfiltration Predictor AI",
  "Unauthorized View/Print Attempt Alert",
  "Biometric/MFA Authentication Gateway AI",
  "Dynamic Encryption/Decryption Key Manager",
  "Time-Bound Access Auto-Revoke Bot",
  "Confidential Informant (CI) File Scrubber",
  "Top Secret/Secret/Restricted Categorizer",
  "Screenshot/Screen-Recording Prevention AI",
  "Officer Clearance Level Verification Bot",
  "Audit Trail/Access Log Blockchain Ledger",
  "Geo-Fenced Document Access Enforcer AI",
  "Anti-Terror/ATS Dossier Sanitization Bot",
  "Rogue Insider Threat Behavioral Analyzer",
  "VIP Security Layout Blueprint Vault AI",
  "Red-Corner Notice/Interpol File Tracker",
  "Command Center Real-time Access Dashboard",
  "Voice-Command Classified Search (Authorized)",
  "Automated Redaction of Sensitive Names AI",
  "USB/External Drive Copy Prevention Bot",
  "Document Tamper/Modification Hash Checker",
  "Cross-Department (IB/RAW) Secure Sharer",
  "Historical Leak Impact/Damage Assessor",
  "AI Generated Security Audit & Compliance Report",
  "Phishing/Social Engineering Attack Defender",
  "Confidential File Weeding/Destruction Protocol",
  "Device Fingerprinting for Access AI",
  "Network Anomaly/Intrusion Detection Sync",
  "Suspicious After-Hours Access Alert Bot",
  "Automated Access Request/Approval Workflow",
  "Multi-Lingual Threat Translation/Scrubber",
  "Election Security/Vulnerability Plan Vault",
  "Undercover Officer Identity Masking AI",
  "Cyber Cell Forensic Report Secure Locker",
  "Court/In-Camera Proceeding Document Sync",
  "AI Protocol for Emergency Vault Lockdown",
  "Decoy/Honeypot Document Generator AI",
  "Data Loss Prevention (DLP) Policy Enforcer",
  "Physical Locker to Digital Twin Sync AI",
  "Biometric Locker Key Issuance Tracker",
  "Document Printing Physical Watermark AI",
  "Caste/Communal Tension Intel Secure Store",
  "AI Evaluator for Officer Trustworthiness",
  "Central PHQ Master Confidential Sync Bot",
  "Encrypted Communication Channel Router",
  "Legal/Subpoena Document Segregator AI",
  "Malware/Ransomware Quarantine Engine AI",
  "AI Driven Access Pattern Anomaly Detector",
  "Confidential Budget/Fund Allocation Vault",
  "Witness Protection Identity Secure Locker",
  "Extortion/Kidnap Negotiation Log Secure Room",
  "AI Protocol for Classified Handoffs",
  "Senior Officer (DGP/SP) Executive Access AI",
  "Secure Offline/Air-Gapped Backup Tracker",
  "Document Access Velocity/Frequency Analyzer",
  "AI Assisted Clearance Upgrade/Downgrade",
  "Historical Intelligence Declassification Bot",
  "Vulnerability/Zero-Day Patch Alert for Locker"
];
...
const ConfidentialDocumentLockerDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI CONFIDENTIAL DOCUMENT LOCKER
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI CONFIDENTIAL DOCUMENT LOCKER</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in classified intelligence reports, zero-trust access control & digital watermark tracing.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI CONFIDENTIAL <span>DOCUMENT LOCKER</span></h1>
            <p className="cyber-subtitle">Classified Intelligence Reports, Zero-Trust Access Control & Digital Watermark Tracing</p>
          </div>
        </div>
      </header>
...
export default ConfidentialDocumentLockerDetailed;
