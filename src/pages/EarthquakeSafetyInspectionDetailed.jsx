...
const aiExperts = [
  "Seismic Code Compliance AI",
  "Retrofitting Requirement Analyzer",
  "Soil/Foundation Stability Predictor",
  "Evacuation Route Obstruction Detector",
  "Real-time Tremor/Seismic Sensor Sync",
  "Aftershock Vulnerability Scorer",
  "Geo-Spatial Seismic Zone Mapper",
  "Building Resonance/Frequency Monitor",
  "Earthquake Readiness Dashboard",
  "Voice-Command Seismic Query Bot",
  "Automated Annual Seismic Audit Report",
  "Disaster Management Authority Sync",
  "Critical Weak Point Predictor",
  "Non-Structural Falling Hazard Alert",
  "Emergency Power Resilience Analyzer",
  "Evacuation Bottleneck Optimizer",
  "AI Evaluator for Seismic Readiness Index",
  "Audit/Inspection Log Generator",
  "Data Privacy/Base Isolation Scrubber",
  "State PWD/Structural Design Sync",
  "Seismic Auditor Mobile App",
  "Historical Quake Damage Correlator",
  "DGP (Disaster Response) Briefing AI",
  "Retrofitting Task Allocator",
  "Blockchain Immutable Seismic Audit Hash",
  "Anti-Tamper Inspection Record Shield",
  "Mobile App for Hazard Reporting",
  "District-wise Seismic Resilience Benchmarker",
  "Automated Alert for Non-Compliant Structures",
  "Historical Retrofitting Cost Analyzer",
  "Earthquake Evacuation SOP Trainer",
  "IoT Seismic Sensor Health Monitor",
  "Imminent Structural Failure (During Quake) Alert",
  "Substandard Construction Profiler",
  "High-Importance (Control Room) Resilience Classifier",
  "AI Assisted Retrofitting Tender Drafter",
  "Seismic Audit Data Forecaster",
  "Secure Structural Blueprint Protector",
  "Integration with National Seismological Center",
  "Civil Defence Portal Sync",
  "Election Polling Station Seismic Safety Modeler",
  "Disaster Post-Quake Damage Rapid Coordinator",
  "Seismic Retrofitting Budget Tracker",
  "Custom Workflow for High-Rise Police HQs",
  "AI Driven Next Audit Requirement Predictor",
  "Predictive Need for Base Isolation Upgrade",
  "Custom Alert Trigger for ADG Infrastructure",
  "Audit Recommendation to Implementation Timeline"
];
...
const EarthquakeSafetyInspectionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI EARTHQUAKE SAFETY INSPECTION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI EARTHQUAKE SAFETY <span>INSPECTION</span></h1>
...
export default EarthquakeSafetyInspectionDetailed;
