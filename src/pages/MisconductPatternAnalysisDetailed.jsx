...
const aiExperts = [
  "Station Misconduct Trend Spotter Engine AI",
  "Habitual Offender Profile Matching Engine AI",
  "Early Warning Incident Alert Notification Engine",
  "Misconduct System Audit Compliance Checker Bot",
  "Misconduct Severity Auto-Classifier Engine AI",
  "Officer Duty Log Misconduct Pattern Detector",
  "Misconduct Occurrence Heatmap Geographic Plotter",
  "System Audit Log Tamper Warning Alert Bot",
  "Misconduct Analysis Command Dashboard Portal",
  "Voice-Command Misconduct Pattern Query Bot",
  "Automated Daily Misconduct Trend Summary Report",
  "Cross-District Misconduct Database Sync Engine",
  "Misconduct Pass QR Verification Code Engine",
  "Suspicious Activity Pattern Analysis Alert Bot",
  "Public Misconduct Grievance Classifier Bot AI",
  "Staff Suspension Trigger Alert Generator Bot",
  "AI Evaluator for Station Misconduct Risk Score",
  "Audit/Misconduct Search Log History Generator",
  "Data Privacy/Incidental Officer Identity Masker",
  "Police-Vigilance Branch Database Joint Sync",
  "Misconduct Investigator Mobile App Status Portal",
  "Cold Case Misconduct MO Connection Linker AI",
  "Senior Officer (SP Vigilance) Briefing Assistant",
  "Public Police Misconduct Rating Board Portal",
  "Blockchain Immutable Misconduct Audit Registry",
  "Anti-Leak Misconduct Database Security Shield",
  "Mobile App for Field Misconduct Pattern Checker",
  "Bluetooth Beacon Mediation Room Queue Monitor",
  "Multi-Lingual Misconduct Report Translation Bot",
  "Historical Misconduct Trend Sorter Matcher AI",
  "Staff Code of Conduct Seminar Tracker Engine",
  "Misconduct Database Server Infrastructure Health",
  "Urgent Misconduct Spike Warning Notification AI",
  "Traffic/Transit Naka Misconduct Pattern Monitor",
  "Cyber-Financial Misconduct Audit System Bot AI",
  "VIP Escort Misconduct Risk Clearance Scheduler",
  "AI Assisted Post-Raid Misconduct Findings Report",
  "Misconduct Dashboard Queue Load Balancer Engine",
  "Anti-Misconduct Program Efficacy Scorer Engine",
  "Integration with National Judicial Database (ICJS)",
  "Citizen Police Misconduct Photo Upload App Bot",
  "Extreme System Stress Misconduct Sorter Modeler",
  "Disaster Relief Misconduct Compliance Tracker Bot",
  "Misconduct Wing Maintenance Budget Tracker AI",
  "Custom Workflow/Approval for Station Audit Raid",
  "AI Driven New Misconduct Pattern Trend Predictor",
  "Predictive Need for Preventative Force Training",
  "Custom Alert Trigger for Vigilance Director"
];
...
const MisconductPatternAnalysisDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI MISCONDUCT PATTERN ANALYSIS
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI MISCONDUCT PATTERN ANALYSIS</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in trend spotting in local stations, habitual offender profiling, early warning alerts & system audits.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI MISCONDUCT PATTERN <span>ANALYSIS</span></h1>
            <p className="cyber-subtitle">Trend Spotting in Local Stations, Habitual Offender Profiling, Early Warning Alerts & System Audits</p>
          </div>
        </div>
      </header>
...
export default MisconductPatternAnalysisDetailed;
