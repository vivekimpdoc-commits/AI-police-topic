...
const aiExperts = [
"Daily Crime Closure Rate Analyzer",
  "Force Deployment Evening Status AI",
  "SITREP Actionable Analytics Bot",
  "Daytime Protest/Riot Escalation Log",
  "Traffic Congestion Evening Peak AI",
  "VIP Movement Evening Wrap-up Bot",
  "Daytime Arrests & Seizures Summary",
  "E-Challan Revenue Evening Tally AI",
  "Jansunwai (Grievance) Evening Resolution",
  "Court Proceeding Evening Outcome Log",
  "Cyber Fraud Complaints Evening Tally",
  "Women/Child Helplines Evening Stats",
  "Missing Person Recovery Evening Log",
  "Stolen Property Recovery SITREP AI",
  "Daytime Media Coverage Sentiment Bot",
  "Intelligence Branch Evening Update AI",
  "Interstate Border Evening Crossing Stats",
  "Night Patrol Deployment Planner AI",
  "Evening SITREP Voice Briefing Gen",
  "Automated SITREP Chart/Graph Creator",
  "Officer Overtime/Fatigue Evening Alert",
  "Vehicle Fleet Fuel/Damage Evening Log",
  "Armoury Issue/Return Evening Audit",
  "Police Station Lock-up Evening Count",
  "SITREP Multi-Format (PDF/Doc) Gen",
  "Senior Officer (IG/ADG) Summary Sync",
  "Evening Weather/Visibility Forecast Alert",
  "Hospital Medico-Legal Evening Wrap",
  "RTI Query Evening Resolution Tally",
  "Social Media Trending Threats SITREP",
  "Election Rally Daytime Wrap-up AI",
  "Festival/Event Daytime Incident Log",
  "NGO/Activist Daytime Activity Sync",
  "Prison Visitor Evening Count Log",
  "Parole/Furlough Evening Reporting AI",
  "Pending Investigation Evening Alert",
  "SITREP Cross-District Comparison AI",
  "Evening SITREP Urgency/Red-Flag Bot",
  "Command Center Evening Handover Sync",
  "Daytime Drone/CCTV Surveillance Wrap",
  "Public Alert System Evening Status",
  "SITREP Action Item Tracker Bot",
  "Automated SITREP Distribution Router",
  "Evening SITREP Read-Receipt Analyzer",
  "Narcotics/Liquor Daytime Raid Tally",
  "Illegal Mining/Sand Theft SITREP AI",
  "Wildlife/Forest Crime Evening Log",
  "Daytime Fire/Disaster Relief Wrap",
  "Railway/Transport Police Evening Sync",
  "Tourist Police Daytime Assistance Log",
  "VIP Route Security Evening Debrief",
  "Informant Tip Evening Verification Log",
  "SITREP Historical Trend Correlator",
  "Evening SITREP NLP Keyword Search",
  "Departmental Meeting Evening Minutes",
  "Police Welfare/Health Camp Evening Wrap",
  "Daytime Cyber Attack/Breach Wrap-up",
  "SITREP Blockchain Verification Logger",
  "Evening SITREP Translation Engine AI",
  "Automated SITREP Approval Workflow"
];
...
const EveningSituationReportDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI EVENING SITUATION REPORT (SITREP)
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI EVENING SITUATION REPORT (SITREP)</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in daily crime closure rates, force deployment status & sitrep analytics.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI EVENING SITUATION <span>REPORT (SITREP)</span></h1>
            <p className="cyber-subtitle">Daily Crime Closure Rates, Force Deployment Status & SITREP Analytics</p>
          </div>
        </div>
      </header>
...
export default EveningSituationReportDetailed;
