...
const aiExperts = [
  "Digital Job Card Creation/Tracking Engine",
  "Mechanic Task Assignment Optimizer AI",
  "Workshop Bay/Lift Occupancy Scheduler",
  "Repair Turnaround Time (TAT) Monitor Bot",
  "Spare Parts Consumption per Job Tracker",
  "Quality Check Post-Repair Validation AI",
  "Warranty Repair vs Paid Repair Classifier",
  "Outsource vs In-House Repair Decision AI",
  "Workshop Management Command Dashboard",
  "Voice-Command Workshop Status Query Bot",
  "Automated Weekly Workshop Report Gen AI",
  "Cross-Workshop Performance Comparator",
  "Mechanic Skill/Certification Tracker AI",
  "Workshop Safety/Hazard Compliance Bot",
  "Tool/Equipment Inventory Manager AI",
  "Paint/Body Shop Job Queue Manager Bot",
  "AI Evaluator for Workshop Efficiency %",
  "Audit/Workshop Expense Log Generator",
  "Data Privacy/Mechanic Personal Data Masker",
  "Police-Vendor Workshop SLA Sync Bot",
  "Patrol Car Priority Repair Queue AI",
  "Armored Vehicle Specialized Repair Bay",
  "Senior Officer (Transport SP) Briefing",
  "Public Vehicle Repair Status Portal",
  "Blockchain Immutable Repair History Log",
  "Workshop CCTV Anti-Theft Monitor AI",
  "Mobile App for Mechanic Job Card Sync",
  "Electric Vehicle Charging Bay Manager",
  "Multi-Lingual Work Order Translator Bot",
  "Historical Repair Pattern Trend Analyzer",
  "Staff Mechanic Overtime Tracker AI",
  "Vendor Quote Comparison Engine",
  "Temporary Field Repair Kit Deployer Bot",
  "Traffic Vehicle Specialized Repair Bay",
  "Accident Damage Assessment Photo AI",
  "VIP Fleet Express Service Lane Manager",
  "AI Assisted Post-Repair Feedback Audit",
  "Workshop Cleanliness/5S Score Tracker",
  "Green Workshop (Waste Disposal) Compliance",
  "Integration with GST Invoice Portal",
  "Citizen Police Vehicle Condition Feedback",
  "Extreme Weather Workshop Drainage Alert",
  "Disaster Vehicle Rapid Repair Protocol",
  "Workshop Budget/Expense Tracker AI",
  "Custom Workflow/Approval for Major Overhaul",
  "AI Driven Workshop Bottleneck Predictor",
  "Predictive Need for New Workshop Bay",
  "Custom Alert Trigger for Workshop Foreman"
];
...
const WorkshopManagementDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI WORKSHOP MANAGEMENT
            </h2>
            
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2rem' }}>
              <strong>AI WORKSHOP MANAGEMENT</strong> provides advanced enterprise capabilities. By leveraging predictive analytics, real-time data sync, and multi-modal AI sensors, this module ensures total dominance in police garage operations, job card tracking & mechanic productivity analytics.
            </p>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI WORKSHOP <span>MANAGEMENT</span></h1>
            <p className="cyber-subtitle">Police Garage Operations, Job Card Tracking & Mechanic Productivity Analytics</p>
          </div>
        </div>
      </header>
...
export default WorkshopManagementDetailed;
