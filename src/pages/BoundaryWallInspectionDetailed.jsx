...
const aiExperts = [
  "Perimeter Intrusion Vulnerability AI",
  "Barbed Wire/Concertina Rust/Break Detector",
  "Drone-assisted Encroachment/Slum Mapper",
  "Vibration/Perimeter Fence Sensor Sync",
  "Structural Crack/Settlement Analyzer",
  "Blind-Spot/Lighting Deficit Mapper",
  "Geo-Spatial Property Boundary/Land Record Sync",
  "Overhanging Tree/Scaling Risk Predictor",
  "Boundary Security Dashboard",
  "Voice-Command Perimeter Status Bot",
  "Automated Quarterly Security Audit Report",
  "Revenue/Land Records Department Sync",
  "PTZ Camera Auto-Tracking Integrator",
  "Wild Animal Intrusion/Breach Filter",
  "Fake Land Claim/Encroachment Predictor",
  "Watchtower/Sentry Post Line-of-Sight Scorer",
  "AI Evaluator for Campus Security Index",
  "Audit/Repair Log Generator",
  "Data Privacy/Adjoining Property Scrubber",
  "State Police Housing/Estate Sync",
  "Guard/Sentry Patrol Mobile App",
  "Historical Jailbreak/Infiltration Correlator",
  "Base Commander/Estate Officer Briefing AI",
  "PWD/Fencing Vendor Task Allocator",
  "Blockchain Immutable Land Record Hash",
  "Anti-Tamper Boundary Shield",
  "Mobile App for Breach Reporting",
  "Armory/Prison Perimeter Benchmarker",
  "Automated Reminder for Fence Replacement",
  "Historical Encroachment Dispute Analyzer",
  "Perimeter Security SOP Trainer",
  "IoT Vibration Sensor Server Monitor",
  "Imminent Breach/Wall Collapse Alert",
  "Land Mafia/Encroacher Syndicate Profiler",
  "High-Security (Armory/Intel) Classifier",
  "AI Assisted Anti-Encroachment Notice Drafter",
  "Drone Survey/Map Storage Forecaster",
  "Secure Security Layout Protector",
  "Integration with Automated Access Control",
  "Local Civic Authority (for demolition) Sync",
  "Riot/Mob Breach Vulnerability Modeler",
  "Flood/Water-logging Wall Damage Coordinator",
  "Perimeter Upgrade/Maintenance Budget Tracker",
  "Custom Workflow for Electrified Fencing",
  "AI Driven Intrusion Predictor",
  "Predictive Need for Additional Sentry/Cameras",
  "Custom Alert Trigger for Base Commander",
  "Police Property Integrity Timeline Tracker"
];
...
const BoundaryWallInspectionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI BOUNDARY WALL INSPECTION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI BOUNDARY WALL <span>INSPECTION</span></h1>
...
export default BoundaryWallInspectionDetailed;
