...
const aiExperts = [
  "Bank Branch Vulnerability/Risk Scorer AI",
  "Strong-Room/Vault Standard Compliance Auditor",
  "Intrusion Alarm/Panic Button Tester Bot",
  "Armed Guard Roster & License Verifier",
  "Cyber-Physical Attack Threat Correlator",
  "CCTV/DVR Health & Coverage Analyzer",
  "Geo-Spatial High-Risk Branch Mapper",
  "Opening/Closing Time SOP Monitor",
  "Bank Security Command Dashboard",
  "Voice-Command Branch Query Bot",
  "Automated Quarterly Audit Report",
  "Emergency Response (Dial 112) Sync Bot",
  "Suspicious Recce/Loitering Detector (via CCTV)",
  "Fake Customer/Disguise Anomaly Predictor",
  "Private Security Agency (PSARA) Sync AI",
  "Fire/Hazard Safety Audit Tracker",
  "AI Evaluator for Branch Preparedness",
  "Audit/Inspection Log Generator",
  "Data Privacy/Customer Detail Scrubber",
  "State Lead Bank/RBI Guideline Sync",
  "Field IO Security Checklist App",
  "Historical Bank Heist Correlator AI",
  "SHO/Supervisory Officer Briefing",
  "Beat Officer/Armed Picket Allocator",
  "Blockchain Immutable Audit Hash",
  "Anti-Tamper Security Rating Shield",
  "Mobile App for Branch Managers (Panic)",
  "Jurisdiction/Commercial Zone Matcher",
  "Multi-Lingual Advisory Translator",
  "Historical Robbery/Burglary Trend Analyzer",
  "Bank Security SOP Trainer",
  "Inspection DB Server Health Monitor",
  "Imminent Threat/Tunneling Alert Bot",
  "Organized Bank Robbery Syndicate Profiler",
  "High-Cash Volume Target Classifier",
  "AI Assisted Security Advisory Drafter",
  "Audit Image/Video Storage Forecaster",
  "Secure Security Flaw Data Protector",
  "Integration with State Level Bankers Committee (SLBC)",
  "Citizen Suspicious Activity Reporting",
  "Festival/Holiday Season Heist Modeler",
  "Disaster/Riot Branch Security Coordinator",
  "Audit/Patrol Expense Budget Tracker",
  "Custom Workflow for Security Escalation",
  "AI Driven Heist Probability Predictor",
  "Predictive Need for QRT Deployment",
  "Custom Alert Trigger for SP/SSP",
  "Audit Rectification Timeline Tracker"
];
...
const BankSecurityInspectionDetailed = () => {
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="overview-panel premium-module-panel">
            <h2 style={{ color: '#06b6d4', marginBottom: '1.5rem', borderBottom: '1px solid rgba(6,182,212,0.3)', paddingBottom: '1rem' }}>
              <ShieldAlert className="inline-icon" size={28} /> AI BANK SECURITY INSPECTION
            </h2>
    ...
    <div className="hrms-detailed-page">
      ...
      <header className="hrms-header">
        ...
        <div className="header-titles">
          ...
          <div>
            <h1 className="cyber-title">AI BANK SECURITY <span>INSPECTION</span></h1>
...
export default BankSecurityInspectionDetailed;
