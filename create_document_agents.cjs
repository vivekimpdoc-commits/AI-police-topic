...
let procJsx = fs.readFileSync(path.join(__dirname, 'src', 'pages', 'DocumentDetailed.jsx'), 'utf8');
...
if (!procJsx.includes('isClickable')) {
    ...
    fs.writeFileSync(path.join(__dirname, 'src', 'pages', 'DocumentDetailed.jsx'), procJsx, 'utf8');
    console.log('DocumentDetailed.jsx updated.');
}
